...
function PrintPg() {
	...
	var pgLoc = "./subjects_print.jsp?sy_from_prev="+document.ems_stat.sy_from_prev.value+"&sy_to_prev="+document.ems_stat.sy_to_prev.value+
				"&sy_from="+document.ems_stat.sy_from.value+"&sy_to="+document.ems_stat.sy_to.value+"&semester="+
				document.ems_stat.semester[document.ems_stat.semester.selectedIndex].value+"&offering_status="+
				document.ems_stat.offering_status[document.ems_stat.offering_status.selectedIndex].value+ vExtraCon;
...
%>
<form method="post" name="ems_stat" action="./subjects.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#004488">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>::::
          SUBJECT OFFERING STATISTICS PAGE ::::</strong></font></div></td>
    </tr>
    <tr >
    ...
    <tr >
      <td height="25">&nbsp;</td>
      <td valign="bottom">Sub Offering Status</td>
    ...
    <tr >
      ...
      <td width="18%"><select name="offering_status">
          <option value="">All</option>
<%
strTemp = WI.fillTextValue("offering_status");
...
<%}if(strTemp.compareTo("Dissolved") ==0){%>

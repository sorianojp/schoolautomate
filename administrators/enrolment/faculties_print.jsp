...
<%
	...
	String strLoadRange = WI.fillTextValue("load_range");
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#97ABC1"> 
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF">FACULTY 
        ...
        <br>
        LOAD PARAMETER (<%=strLoadRange%>) </strong></font></div></td>
    </tr>
  </table>
<%if(WI.fillTextValue("showData").length() > 0 || 
  ...
  <table   width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="56%"><div align="center"><font size="1"><strong>NO OF FACULTIES</strong></font></div></td>
    </tr>
    <%

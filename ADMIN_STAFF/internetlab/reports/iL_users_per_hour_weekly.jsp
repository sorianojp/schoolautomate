...
<%
	...
	if(WI.fillTextValue("generate_report").length() > 0){
		vRetResult = cr.getWeeklyUsageReport(dbOP, request);
		if(vRetResult == null)
			strErrMsg = cr.getErrMsg();
	}
%>
<form action="iL_users_per_hour_weekly.jsp" method="post" name="form_">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A">
			<td height="25" colspan="3"><div align="center"><font color="#FFFFFF">
				<strong>:::: WEEKLY ::::</strong></font></div></td>
		</tr>
		<tr>

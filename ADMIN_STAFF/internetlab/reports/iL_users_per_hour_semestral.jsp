...
<%
	...
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								...
								"iL_users_per_hour_semestral.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(WI.fillTextValue("generate_report").length() > 0){
		vRetResult = cr.getSemestralUsageReport(dbOP, request);
		if(vRetResult == null)
			strErrMsg = cr.getErrMsg();
	}
%>
<form action="iL_users_per_hour_semestral.jsp" method="post" name="form_">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A">
			<td height="25" colspan="3"><div align="center"><font color="#FFFFFF">
				<strong>:::: SEMESTRAL ::::</strong></font></div></td>
		</tr>
		<tr>

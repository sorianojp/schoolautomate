  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myTable1">
	...
	<tr>
		...
		if(strTemp.equals("3"))
			...
			strErrMsg = "";		
		%>
			<input type="radio" name="show_unclaimed_cc" value="3" <%=strErrMsg%>> claimed/unclaimed classcards		
		</td>
	</tr>
    ...
    <tr>
      ...
      <td width="20%"><input name="stud_id" type="text" class="textbox" size="20" maxlength="20" value="<%=strTemp%>" 
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable2">
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
		<tr>
			...
			<td class="thinborder" width="11%"><strong>Course</strong></td>
			...
			<td class="thinborder" align="center" width="5%"><strong>No. Of Absences</strong></td>
		...
		<tr onClick="ViewStudent('<%=(String)vRetResult.elementAt(i + 9)%>','<%=(String)vRetResult.elementAt(i)%>')">
			...
			<td class="thinborder"><%=WI.getStrValue((String)vRetResult.elementAt(i+1),"&nbsp;")%></td>
		  	<td class="thinborder" align=""><%=(String)vRetResult.elementAt(i+2)%><%=WI.getStrValue((String)vRetResult.elementAt(i+3),"-","","")%></td>

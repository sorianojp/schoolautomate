...
function PrintLetter(strUserIndex){
	var pgLoc = "./format_letter_to_parent.jsp?user_index="+strUserIndex+"&sy_from="+document.form_.sy_from.value+
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			<tr>
				...
				<td valign="top"  width="48%">
					...
					<!---------------THIS IS FOR LIST OF CLASSCARD------------------->
					<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
						<tr>
							<td colspan="2" align="center" class="thinborder"><strong>List of unclaimed Class card</strong></td>
						</tr>
						<tr>
						...
						<tr bgcolor="#CCCCCC">
							...
							<td class="thinborder">
								<input type="button" name="update_cc" value="Claim" 
									onClick="UpdateStatusClaimed('6','1','1','<%=(String)vCCNotClaimed.elementAt(i)%>');">
							</td>
						</tr>
						<%}%>
				...
				<td valign="top" width="48%">				
				<!---------------THIS IS FOR LIST OF DROPPED SUBJECT------------------->
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"  class="thinborder">
					<tr>
						<td colspan="2" align="center" class="thinborder"><strong>List of dropped subject</strong></td>
					</tr>
					<tr>
						<td class="thinborder">Subj Code</td>						
						<td class="thinborder">Option</td>
					...
					<tr bgcolor="#999999">
						...
						<td class="thinborder">
							<input type="button" name="update_cc" value="Undropped" onClick="UpdateStatusDropped('7','0', '1', '<%=(String)vSubDropped.elementAt(i)%>');">
						</td>
					</tr>
					<%}%>
				</table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td colspan="2">
			...
			<font size="1">Click to show claimed classcard</font>
		</td>
	</tr>
	<tr>
      <td width="3%" height="25">&nbsp;</td>
      <td width="15%" height="25">Student Name </td>
      <td width="57%" height="25"><strong><%=(String)vStudDtls.elementAt(1)%></strong></td>
	  ...
	  <td width="25%"><font color="<%=strBGColor%>"><strong><%=strTemp%></strong></font>
	...
	<tr>
	  ...
	  <select name="enroll_index" onChange="document.form_.submit();">
	  <option value=""></option>
	...
	%>	
		...
		if(strTemp.equals("13"))
			...
			strErrMsg = "";
		%>
				<option value="13" <%=strErrMsg%>>Daily Class 13 absences</option>
		<%
		if(strTemp.equals("11"))
			...
			strErrMsg = "";
		%>
				<option value="11" <%=strErrMsg%>>MWF Class 11 absences</option>
		...
		if(strTemp.equals("7"))
			...
			strErrMsg = "";
		%>
				<option value="7" <%=strErrMsg%>>TTH Class 7 absences</option>
		...
		if(strTemp.equals("4"))
			...
			strErrMsg = "";
		%>
				<option value="4" <%=strErrMsg%>>Weekly Class 4 absences</option>
			</select>
		</td>
	</tr>
...
if (vRetResult!= null && vRetResult.size()>0){%>
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
		<tr>
			...
			<td class="thinborder" align="" width="10%"><strong>Option</strong></td>
		</tr>

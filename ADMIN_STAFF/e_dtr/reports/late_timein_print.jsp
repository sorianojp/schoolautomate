...
<table width="100%" border="1" cellpadding="3" cellspacing="0">
  <tr> 
    ...
    <td height="25"  colspan="5"><div align="center"><font color="#000000" size="2"><strong>SUMMARY 
        OF EMPLOYEES WITH LATE TIME-IN (<%=strTemp%>)</strong></font></div></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td width="31%" height="30" bgcolor="#EBEBEB"><div align="center"><font size="1"><strong><%if(bolIsSchool){%>COLLEGE<%}else{%>DIVISION<%}%>/OFFICE</strong></font></div></td>

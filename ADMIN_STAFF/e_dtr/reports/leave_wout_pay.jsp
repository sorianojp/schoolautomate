...
{ %>
	<jsp:forward page="./leave_wout_pay_print.jsp" />
<%}

	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Statistics & Reports-Leave Without pay","leave_summary_auf.jsp");
...
<form action="./leave_wout_pay.jsp" method="post" name="form_">
  ...
  <tr>
    ...
    <tr> 
      <td width="100%" height="25" colspan="4" align="center"  bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" size="2" ><strong>:::: 
        HR : LEAVE WITHOUT PAY SUMMARY ::::</strong></font></td>
    </tr>
  </table>	</td>
  </tr>
  <tr>
    <td><table width="100%" height="317" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    <tr> 
...
%>
    ...
    <tr> 
      <td height="19">&nbsp;</td>
      <td height="19"><a href="javascript:SearchEmployee();"><img src="../../../images/form_proceed.gif" border="0"></a></td>
      <td height="19">&nbsp;</td>
    </tr>
    <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" id="myADTable2">
		<tr>
			<td align="right"><font size="2">Number of Employees  Per 
        Page :</font>
      ...
      <a href="javascript:PrintPg();"><img src="../../../images/print.gif" border="0"><font size="1"></font></a>click to print</td>
		</tr>
		<tr>
		  <td align="right">
    <%		

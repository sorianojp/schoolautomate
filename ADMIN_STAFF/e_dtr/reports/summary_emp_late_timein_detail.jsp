...
Vector vRetTemp  = null;

if (WI.fillTextValue("viewRecords").compareTo("1") == 0){
	vRetTemp = RE.searchLateTimeIn(dbOP);	
	if (vRetTemp == null || vRetTemp.size() == 0){
		strErrMsg = RE.getErrMsg();
	}else{
		vRetResult = (Vector) vRetTemp.elementAt(10); 
	}
...
%>
    ...
    <tr> 
      ...
      <td width="29%" align="center" bgcolor="#EBEBEB" class="thinborder"><strong>EXPECTED 
        TIME IN</strong></td>
      <td width="29%" align="center" bgcolor="#EBEBEB" class="thinborder"><strong>ACTUAL 
        TIME IN</strong></td>
      <td width="20%" align="center" bgcolor="#EBEBEB" class="thinborder"><strong>TOTAL 
        MINUTES </strong></td>
    </tr>
<%  
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td width="31%" height="20"><strong>Number of Times Late : </strong></td>
      <td width="19%"><strong>&nbsp;<%=(String)vRetTemp.elementAt(9)%></strong></td>
      <td width="41%"><strong>&nbsp;Total Number of Minutes Late: </strong></td>
      <td width="9%"><strong><%=(String)vRetTemp.elementAt(8)%></strong></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" 
  		id="footer_">

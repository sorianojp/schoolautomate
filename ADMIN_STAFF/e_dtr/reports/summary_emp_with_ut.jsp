...
<html>
<head>
<title>Employees with Undertime</title>
...
{ %>
	<jsp:forward page="./summary_emp_with_ut_print.jsp" />
<%}
...
%>
<form action="./summary_emp_with_ut.jsp" name="dtr_op" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td height="25" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        SUMMARY OF EMPLOYEES WITH UNDERTIME PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
  <tr> 
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date &nbsp;&nbsp;&nbsp;&nbsp;:: 
        ...
        <input name="from_date" type="text" size="12" class="textbox"
          ...
          <a href="javascript:ViewRecords()"><img border="0" src="../../../images/form_proceed.gif"></a>
      </td>
  </tr>
</table>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="590" height="25"><select name="strMonth">
	  <% 
	  	for (int i = 0; i <= 12; ++i) {
	  ...
	  <%} 
        ...
        <input name="sy_" type="text" class="textbox" 
			onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyInteger('dtr_op','sy_')" value="<%=WI.fillTextValue("sy_")%>" size="4" maxlength="4"
			 onKeyUp="AllowOnlyInteger('dtr_op','sy_')"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td>&nbsp;</td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="22%" height="25"><select name="sort_by1">
        <option value="">N/A</option>
      ...
      <td width="18%"><select name="sort_by3">
        <option value="">N/A</option>
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#EBF2FA"> 
      <%  if (vRetResult != null) 
		  	...
		  	strTemp = "";	
  	%>
      <td height="25"  colspan="6" align="center" class="thinborder"><strong>SUMMARY 
      OF EMPLOYEES WITH UNDERTIME (<%=strTemp%>)</strong></td>
    </tr>
    <tr> 
      <td width="11%" height="25" align="center" bgcolor="#EBEBEB" class="thinborder"><strong><font size="1">EMPLOYEE 
        ID</font></strong></td>
      <td width="27%" height="25" align="center" bgcolor="#EBEBEB" class="thinborder"><font size="1"><strong>EMPLOYEE 
        NAME </strong></font></td>
      <td width="31%" align="center" bgcolor="#EBEBEB" class="thinborder"><font size="1"><strong>DEPT/OFFICE</strong></font></td>
      <td width="15%" height="25" align="center" bgcolor="#EBEBEB" class="thinborder"><strong><font size="1">POSITION</font></strong></td>
      <td width="8%" height="25" align="center" bgcolor="#EBEBEB" class="thinborder"><strong><font size="1">TOTAL 
      </font></strong></td>
      <td width="8%" height="25" align="center" bgcolor="#EBEBEB" class="thinborder"><strong><font size="1"> 
        DETAILS</font></strong></td>
    </tr>
    <%
	//System.out.println(vRetResult);
	for ( int i = 2 ; i< vRetResult.size(); i+=9){ 
%>
    <tr> 
...
%>
	  ...
	  '<%=(String)vRetResult.elementAt(0)%>','<%=(String)vRetResult.elementAt(1)%>','<%=(String)vRetResult.elementAt(i+1)%>')"%><img src="../../../images/view.gif" border="0" ></a></td>
    </tr>
    <%} // end for loop%>
  </table>
  <%}%>

...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td width="11%" height="25" bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>DATE 
          OF ABSENCE</strong></div></td>
      <td width="27%" height="25" bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>DAY 
          OF ABSENCE</strong></div></td>
    </tr>
    <% for (int i = 0; i < vRetResult.size() ; i+=2){%>
    <tr> 
      <td height="25" class="thinborder">&nbsp;<%=(String)vRetResult.elementAt(i)%></td>
      <td class="thinborder">&nbsp;<%=astrWeekDays[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(i+1),"7"))]%></td>
    </tr>
    <%} // end for loop%>
    <tr> 
      <td height="25" colspan="2" class="thinborder"><strong>TOTAL NUMBER OF ABSENCE(S) 
        : <%=(int)(vRetResult.size() /2)%></strong></td>
    </tr>
  </table>

...
{ %>
	<jsp:forward page="./undertime_summary_print.jsp" />
<%}
  ...
  Vector vRetEDTR = new Vector();
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Statistics & Reports-Late/Undertime Summary","undertime_summary.jsp");
...
<form name="dtr_op" action="./undertime_summary.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="header_">
     <tr bgcolor="#A49A6A">
      ...
      <td height="25" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" ><strong>::::
       DTR OPERATIONS - <%if(bolIsSchool){%> FACULTY'S <%}%> <%=strTemp%> PAGE ::::</strong></font></td>
    </tr>
     <tr bgcolor="#FFFFFF">
      <td height="25" >
			<%if(WI.fillTextValue("hide_back").length() == 0){%>
			<a href="./gov_reports_main.jsp"><img src="../../../../images/go_back.gif" width="50" height="27" border="0"></a>
			<%}%>
			<strong>
			<font color="#FF0000" size="3">&nbsp;<%=WI.getStrValue(strErrMsg)%></font></strong></td>
    </tr>
  </table>
 ...
 %>
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr >
			...
			%>
      <td height="25" colspan="2" align="center"  class="thinborder"><strong><%=strTemp%></strong></td>
    </tr>
	</table>	
    ...
    <tr >
      <td width="12%" height="25" align="center" class="thinborder"><strong>Name</strong></td>
			...
			%>
      <td colspan="2" align="center" class="thinborder"><%=strTemp%></td>			
			<%}%>
			<%
				if(bolUndertime){
      ...
      <td width="3%" align="center" class="thinborder"><%=strTemp2%></td>
    </tr>    
<%

...
<%
	...
	if (WI.fillTextValue("print_page").equals("1")){
		...
		%>
			<jsp:forward page="./cs_dtr_form_print_3b.jsp" />
			<!--<jsp:forward page="./cs_dtr_form_print_3.jsp" />-->	
		 <%}else{%>
		 <jsp:forward page="./cs_dtr_form_print2.jsp" />
		 <%}
		 return;
...
**/
%>
<form action="./cs_dtr_form.jsp" method="post" name="form_">
...
<%}else{ //else if not my home.sul01032012 
	strTemp = WI.getStrValue((String)request.getSession(false).getAttribute("userId"),""); %>	 
...
%>
    ...
    <tr>
      ...
      <td>Salary Cut-Off</td>
			...
			%>
      <td colspan="4"><select name="sal_period">
    ...
    <%}// end if strLateSetting.equals("1")%>
      ...
      <td>&nbsp;</td>
		  ...
		  %>		
      <td colspan="4">			
		<input type="checkbox" name="show_weekday" value="1" <%=strTemp%>>
		show weekday of attendance </td>
    </tr>
		<tr>
		  <td height="24">&nbsp;</td>
		  <td>&nbsp;</td>
	  	...
	  	if (WI.fillTextValue("show_schedule").equals("1"))
				...
				strTemp = "";
		  %>	
		  <td colspan="4"><input type="checkbox" name="show_schedule" value="1" <%=strTemp%>>
show work schedule </td>
	  </tr>
		<tr>
		  <td height="24">&nbsp;</td>
		  <td>&nbsp;</td>
		  ...
		  <td>&nbsp;</td>
			<%
				...
				if(strTemp.length() > 0)
					...
					strTemp = "";
			%>
		  <td colspan="4"><input type="checkbox" name="fixed_ampm" value="1" <%=strTemp%>> 
		    show AM login in first set and PM login in second set
</td>
	  </tr>
		<tr>
		  <td height="24">&nbsp;</td>
...
Vector vAWOLRecords = RE.getAWOLEmployee(dbOP, (String)vEmpDetails.elementAt(0),
									strDateFr, strDateTo, strSchCode); //there is mySQL error here
						
Vector vAWOLRecordsFormatted = null;
Vector vAwolType = null;
//if(strSchCode.startsWith("DEPED")){
//		//System.out.println("\n613 vAWOLRecords: " + vAWOLRecords);
...
//				//System.out.println("\n622Date: " + vAWOLRecords.elementAt(k));
...
//					iTotalLateAM += Integer.parseInt(strLateEntry);
//					
//					if(strLateEntry.equals("0"))
//						strLateEntry = "&nbsp;";
//						
...
//					iTotalUTPM += Integer.parseInt(strUTEntry);				
//					if(strUTEntry.equals("0"))
//						strUTEntry = "&nbsp;";					
//						
//				}
...
//	 }//end of if deped
	...
	if (vEmpLeave != null && vEmpLeave.size() > 0 &&
		...
		!bolDateRepeated){
		//System.out.println("\n999 vEmpLeave.elementAt(0)   : " + (String)vEmpLeave.elementAt(0));
		vEmpLeave.removeElementAt(0);
		strHoliday += " leave (" + (String)vEmpLeave.remove(0) +")";
...
//			vEmpLeave.remove(0);// remove free
//			vEmpLeave.remove(0);// remove free	
		//System.out.println("1008 vEmpLeave.elementAt(0)   : " + (String)vEmpLeave.elementAt(0));			
...
<% //Vector vLateUnderTime = RE.getMonthlyLateUTime(dbOP,request); %>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<%if(WI.fillTextValue("show_schedule").length() > 0){%>
...
<%}// end faculty load
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="33%" valign="bottom" bgcolor="#FFFFFF"><strong><font size="1">Verified by : </font></strong></td>
    ...
    <tr>
      ...
      <td height="30" valign="bottom" bgcolor="#FFFFFF">
			...
			onBlur="style.backgroundColor='white'" size="24"  value="<%=WI.fillTextValue("in_charge")%>"> </td>
    ...
    <tr>
      ...
      <td height="30" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
			...
			%>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF"><font size="1"><a href="javascript:PrintPg()"><img src="../../../../images/print.gif" border="0"></a>click
        to print list</font><select name="print_format">

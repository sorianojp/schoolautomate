...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="header_">
     <tr>
			...
			%>
      <td height="18" colspan="2" align="center"><strong><%=strTemp%> SUMMARY REPORT OF FACULTY'S ABSENCES </strong></td>
    </tr>
     <tr>
...
%>
    <tr>
      <td width="3%" height="21" align="right" nowrap class="thinborder"><%=iIncr%>&nbsp;</td>

...
<%}else{%>
    <tr>
      ...
      <td height="18" class="thinborderLeft">&nbsp;</td>
      <td height="18" class="thinborderLeft">&nbsp;</td>
      <td height="18" class="thinborderLeft"><font size="1"><%=WI.getStrValue(strHoliday,"&nbsp;")%></font></td>
    </tr>
  ...
  if(vDayInterval.size() > 0)  {
    ...
    <tr>
      ...
      <td height="18" nowrap class="thinborderLeft"> <font size="1">
      <%if(!bolDateRepeated){
      ...
      <td nowrap class="thinborderLeft">
	    <font size="1">
	  ...
	  %>
      <td align="right" nowrap class="thinborderLeft"><font size="1"><%=WI.getStrValue((String)vRetEDTR.elementAt(iIndex + 6))%>&nbsp;</font></td>
      <td nowrap class="thinborderLeft">
  			<font size="1">
	  ...
	  %>
      <td align="right" nowrap class="thinborderLeft"><font size="1"><%=WI.getStrValue((String)vRetEDTR.elementAt(iIndex + 7))%>&nbsp;</font></td>
      <td nowrap class="thinborderLeft"><font size="1">
	  ...
	  %>
      <td align="right" nowrap class="thinborderLeft"><font size="1"><%=strLatePMEntry%>&nbsp;</font></td>
      <td nowrap class="thinborderLeft"><font size="1">
    <%
	  if (!strTemp3.equals("&nbsp;")) {
	  ...
	  %>
      <td align="right" nowrap class="thinborderLeft"><font size="1"><%=strUTPMEntry%>&nbsp;</font></td>
...
%>
	...
	while(vDayInterval != null && vDayInterval.size() > 0) {
		...
		((String)vEmpOvertime.elementAt(0)).equals((String)vDayInterval.elementAt(0))
			...
			vEmpOvertime.removeElementAt(0); // date
			strHoliday += "OT 1(" + (String)vEmpOvertime.remove(0) +")";
		}
		strDateEntry = (String)vDayInterval.remove(0);
  %>
    <tr>

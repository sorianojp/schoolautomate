...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Reports & Statistics - Summary Emp with Absent","summary_emp_with_deductions_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
															...
															"summary_emp_with_deductions_print.jsp");	
...
<form>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">    
    <tr>
			...
			%>
      <td height="25" align="center"><strong>Employees with tardiness, undertime or absence for <%=strTemp%></strong></td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr> 
      <td  width="8%" height="25" align="center"  class="thinborder"><strong><font size="1">EMPLOYEE 
          ID</font></strong></td>
      <td width="25%" align="center" class="thinborder"><strong><font size="1">EMPLOYEE 
          NAME</font></strong></td>
<% if (!strSchCode.startsWith("AUF")) {%>
      ...
      <td width="13%" align="center" class="thinborder"><strong><font size="1">UNDERTIME</font></strong></td>
      <td width="10%" align="center" class="thinborder"><strong><font size="1">ABSENCES </font></strong>      </td>
<%if(bolShowTotal){%>
      <td width="8%" align="center" class="thinborder"><strong><font size="1">TOTAL HOURS</font></strong></td>
      <td width="8%" align="center" class="thinborder"><strong><font size="1">TOTAL MINS</font></strong></td>
<%}%>
    </tr>
    <%		

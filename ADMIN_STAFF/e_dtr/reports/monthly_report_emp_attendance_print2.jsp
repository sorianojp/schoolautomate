...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-STATISTICS & REPORTS-Individual Attendance","monthly_report_emp_attendance.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form action="./monthly_report_emp_attendance.jsp" method="post" name="form_">
   ...
   <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
      <tr>
        ...
        <td width="81%" height="25" colspan="2"  class="thinborder"><font size="2"><strong>&nbsp;<%=WI.formatName((String)vEmpDetails.elementAt(1),
...
%>
	  ...
	  <strong><%=astrMonth[Integer.parseInt(WI.getStrValue(strMonths,"1"))]%>&nbsp;<%=strYear%></strong></td>
    </tr>
  </table>
...
//									strDateFr, strDateTo, strSchCode);
 ...
 Vector vAWOLRecords = new Vector();
	if(!strSchCode.startsWith("PIT"))//Sir B said, this will fix PIT request. PIT don't want to display AWOL remarks
		vAWOLRecords = RE.getAWOLEmployee(dbOP, (String)vEmpDetails.elementAt(0),strDateFr, strDateTo, strSchCode);								
...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      <td height="20" class="thinborder">&nbsp;<strong>TARDINESS</strong></td>
    ...
    <tr>
      <td height="20" class="thinborder"><strong>&nbsp;UNDERTIME </strong></td>
      <td align="right" class="thinborder">
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#EEEDE6">
      <td height="20" colspan="5" align="center" class="thinborder"><strong>WORK
        SCHEDULE</strong></td>
    </tr>
...
%>
    <tr>
      <td height="20" colspan="5" align="center" class="thinborder"><strong><%=strErrMsg%></strong></td>
    </tr>
    <%}else{%>
    <tr align="center">
      <td width="20%" height="18" class="thinborder"><strong>WEEK DAY</strong></td>
    ...
    <% 	String strTimeIn0 = null;
	  ...
	  if (!bolFlexTime) {
			%>
	 <tr>
	  <td height="18" class="thinborder">&nbsp;<%=strWeekDay%></td>
...
<%}%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="1%" height="18" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF"><strong><font size="1">Certified
        Correct</font></strong></td>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF"><strong><font size="1">Verified
        and Attested Correct </font></strong></td>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF"> <strong><font size="1"><%=(!bolIsGovernment?"Noted":"")%></font></strong></td>
    </tr>
    <tr>
      <td height="29" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="25%" height="29" align="center" valign="bottom" bgcolor="#FFFFFF" class="thinborderBOTTOM"><strong><%=WI.fillTextValue("certified")%></strong></td>
      <td width="8%" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="25%" align="center" valign="bottom" bgcolor="#FFFFFF" class="thinborderBOTTOM"><strong><%=WI.fillTextValue("verified_attested")%></strong></td>
      <td width="9%" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
	  
	  <%if(!bolIsGovernment){%>
		  <td width="24%" align="center" valign="bottom" bgcolor="#FFFFFF" class="thinborderBOTTOM"><strong>
		  <%=WI.fillTextValue("verified")%>
		  </strong></td>
		<%}else{%>
			<td width="8%" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
		<%}%>
    ...
    <%if(strSchCode.startsWith("AUF")){%>
		<tr>
      <td height="18" valign="bottom" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" colspan="2" valign="bottom" bgcolor="#FFFFFF" class="thinborderNONE">Faculty/NTP</td>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF" class="thinborderNONE">Dean/Head</td>
      <td colspan="2" valign="bottom" bgcolor="#FFFFFF" class="thinborderNONE">HRDC</td>
    </tr>
		<%}%>
  </table>

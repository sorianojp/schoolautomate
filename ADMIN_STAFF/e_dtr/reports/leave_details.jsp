...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="25" colspan="2" valign="bottom" bgcolor="#FFFFFF"><div align="center">
        <hr width="95%" size="1" noshade>
    <strong><font size="2">DETAILS OF APPLICATION</font></strong></div></td> 
  </tr>
  <tr>
    <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
    <td width="98%" height="50" bgcolor="#FFFFFF"><strong>DATE 
      OF APPLICATION :  <%=WI.getStrValue((String)vEditResult.elementAt(3))%><br>
      </strong><br> <strong>
      LEAVE APPLIED FOR :  <font size="3" color="#FF0000"> 
      <%
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="bottom"> 
    <td width="43%" height="44"><%if(bolIsSchool){%>Dean/<%}%>Head: _________________________________</td>

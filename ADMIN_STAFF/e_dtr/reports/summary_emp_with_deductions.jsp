...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Reports & Statistics-Summary Emp with Deduction","summary_emp_with_deductions.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"summary_emp_with_deductions.jsp");	
...
if(WI.fillTextValue("searchEmployee").equals("1")){
	...
	request.setAttribute("use_min_equiv", "1");
	
	vRetResult = rD.viewDeductionsSummary(dbOP, strSchCode);
	if(vRetResult == null)
...
if(strSchCode.startsWith("NEU"))
	bolShowTotal = true;
%>
<form action="./summary_emp_with_deductions.jsp" method="post" name="form_">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="35%" align="left"><input type="text" name="id_number" value="<%=WI.fillTextValue("id_number")%>" class="textbox"
...
<select name="jumpto" onChange="SearchEmployee();">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr> 
      ...
      <td width="23%" align="center" class="thinborder"><strong><font size="1">EMPLOYEE NAME</font></strong></td>
      <td width="15%" align="center" class="thinborder"><strong><font size="1">EMP. STATUS</font></strong></td>
      <td width="17%" align="center" class="thinborder"><strong><font size="1">DEPT/OFFICE</font></strong></td>
      <td width="14%" align="center" class="thinborder"><strong><font size="1">TARDINESS</font></strong></td>
      <td width="12%" align="center" class="thinborder"><strong><font size="1">UNDERTIME</font></strong></td>
      <td width="11%" align="center" class="thinborder"><strong><font size="1">ABSENCES </font></strong></td>
<%if(bolShowTotal){%>
      <td width="10%" align="center" class="thinborder"><strong><font size="1">TOTAL HOURS</font></strong></td>
      <td width="10%" align="center" class="thinborder"><strong><font size="1">TOTAL MINS</font></strong></td>
<%}%>
    </tr>
    <%
    ...
    <tr> 
      ...
      <td class="thinborder"><%=strTemp%></td>
			<%
				...
				iMins = (int)Double.parseDouble(WI.getStrValue((String)vRetResult.elementAt(i + 10),"0")); //System.out.println(iMins);
			...
			%>	
      <td align="right" class="thinborder"><a href="javascript:viewLateDetails('<%=(String)vRetResult.elementAt(i+1)%>','<%=WI.fillTextValue("year_of")%>')"><%=WI.getStrValue(strTemp, "")%></a>&nbsp;</td>
			<%
      ...
      <td align="right" class="thinborder">
			...
			%>
      <td align="right" class="thinborder"><a href='javascript:ViewAwol("<%=(String)vRetResult.elementAt(i + 1)%>","<%=WI.fillTextValue("year_of")%>");'><%=WI.getStrValue(strTemp,"")%></a>&nbsp;</td>
<%if(bolShowTotal){
iTotalHrs = iTotalMins/60;
iTotalMins = iTotalMins%60;
%>
      <td align="right" class="thinborder"><%=iTotalHrs%></td>
      <td align="right" class="thinborder"><%=iTotalMins%></td>
<%}%>
    </tr>

...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Statistics and Reports - Employees with Extra Time Records",
								"emp_extra_time_records.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form action="./emp_extra_time_records.jsp" name="dtr_op" >
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          EMPLOYEE WITH EXTRA TIME RECORD ::::</strong></font></div></td>
    </tr>
  <tr> 
...
<%if (((String)request.getSession(false).getAttribute("school_code")).startsWith("AUF") {) %>
    <tr bgcolor="#FFFFFF"> 
      ...
      <td height="24"><select name="emp_catg">
    ...
    <tr> 
      <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr bgcolor="#006A6A"> 
            ...
            <td height="30"  colspan="5" align="center" bgcolor="#F2FAF1"><strong>LIST 
            OF EMPLOYEE WITH EXTRA TIME (<%=strTemp%>)</strong></td>
          </tr>
          <tr> 
            <td width="17%" height="25" bgcolor="#EBEBEB"><strong><font size="1">EMPLOYEE 
              ID</font></strong></td>
            <td width="16%" height="30" bgcolor="#EBEBEB"><font size="1"><strong>DATE</strong></font></td>
            <td width="17%" height="30" bgcolor="#EBEBEB"><font size="1"><strong>EXPECTED 
            ...
            <td width="13%" height="30" bgcolor="#EBEBEB"><strong><font size="1">EXTRA 

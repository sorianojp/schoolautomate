<%@ page language="java" import="utility.*,eDTR.ReportEDTR,java.util.Vector,payroll.PRSalary" %>
<%
...
<html>
<head>
<title>Employee With Leaves Not Credited</title>
...
function deleteLeave(userIndex, leave_date){
	document.form_.user_index.value = userIndex;
	document.form_.del_leave_date.value = leave_date;
	document.form_.delete_action.value = "1";
	document.form_.submit();
}
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"summary_emp_leaves_uncredited.jsp");	
...
String[] astrSortByName    = {"ID #","Lastname","Firstname","Gender","Emp. Status","Emp. Type","Leave date"};
String[] astrSortByVal     = {"id_number","lname","fname","gender","user_status.status","HR_EMPLOYMENT_TYPE.EMP_TYPE_NAME","c_name","d_name","leave_date"};

int iSearchResult = 0;


//if delete is click
if(WI.fillTextValue("delete_action").equals("1")){  	
  PRSalary prSalary = new PRSalary();
  String strLeaveDate = WI.fillTextValue("del_leave_date");		
  String strEmpIndex = WI.fillTextValue("user_index");		
	if(strLeaveDate != null && strLeaveDate.length() > 0 && strEmpIndex != null && strEmpIndex.length() > 0 ){		
		strLeaveDate = ConversionTable.convertTOSQLDateFormat(strLeaveDate);
		if(!prSalary.updateLeaveCreditStatus(dbOP, strEmpIndex,strLeaveDate, 2)) 
...
if(WI.fillTextValue("searchEmployee").equals("1")){
  vRetResult = rD.viewUncreditedLeavesSummary(dbOP, request);
  if(vRetResult == null)
...
%>
<form action="./summary_emp_leaves_uncredited.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="4" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF"><strong>:::: 
      SUMMARY OF EMPLOYEES WITH UNCREDITED LEAVES PAGE ::::</strong></font></td>
    </tr>
  </table>
		  ...
		  <td height="25">&nbsp;</td>
			<%
				...
				if(strTemp.length() > 0)
					...
					strTemp = "";
			%>			
		  <td colspan="2"><input type="checkbox" name="view_all" value="1" <%=strTemp%> onClick="SearchEmployee();">
view all</td>
	  </tr>		
    <tr> 
...
<select name="jumpto" onChange="SearchEmployee();">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
	...
	-->
      ...
      <td width="15%" align="center" class="thinborder"><strong>Leave Type</strong></td>
      <td width="13%" align="center" class="thinborder"><strong>Leave Date </strong></td>
      <td width="9%" align="center" class="thinborder"><strong>Duration</strong></td>
	  <td width="14%" align="center" class="thinborder"><strong>Option</strong></td>
    </tr>
    <%
    ...
    <tr> 
	  ...
	  %>	  
      <td class="thinborder" align="center"><%=WI.getStrValue(strTemp)%> day(s)</td>
	  <td class="thinborder" align="center">
	  	<a href="javascript:deleteLeave(<%=(String)vRetResult.elementAt(i)%>,'<%=(String)vRetResult.elementAt(i + 10)%>')"><img src="../../../images/delete.gif"></a>
	  </td>
    </tr>
...
<input type="hidden" name="del_leave_date">
<input type="hidden" name="delete_action" value="">

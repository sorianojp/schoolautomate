...
<%
	...
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Reports & Statistics-Summary Emp with Leaves","summary_emp_leaves.jsp");
...
%>
<form action="./summary_emp_leaves.jsp" method="post" name="form_">
...
<select name="jumpto" onChange="SearchEmployee();">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
	...
	-->
      ...
      <td width="10%" class="thinborder"><div align="center"><font size="1"><strong>VIEW 
      LEAVE DETAILS</strong></font></div></td>
    </tr>
    <%
    ...
    <tr> 
	  ...
	  <a href="javascript:ViewPrintDetails('<%=vRetResult.elementAt(i+14)%>','<%=vRetResult.elementAt(i+2)%>','<%=strSYFrom%>','<%=strSYTo%>','<%=WI.fillTextValue("semester")%>' ,'0')"><img src="../../../images/view.gif" width="40" height="31" border="0"></a></td>
    </tr>

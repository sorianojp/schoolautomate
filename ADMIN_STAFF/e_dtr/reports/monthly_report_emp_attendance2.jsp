...
<%}else{%>&nbsp;<%}%>	  </td>
      <td width="37%"><label id="coa_info"></label></td>
    </tr>
<%}%>
    <tr>
      <td height="24">&nbsp;</td>
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#EEEDE6" >
      <td height="25" colspan="7" class="thinborder"><div align="center"><strong><font color="#000000">DAILY
...
//System.out.println(vDayInterval);
	...
	//	strDateEntry = (String)vDayInterval.remove(0);
		...
		<tr bgcolor="#E6F0ED">
		  ...
		  <td height="20" colspan="6" align="center" class="thinborder">&nbsp;<strong><%=strHoliday%></strong></td>
		</tr>
		<%}else{%>
		<tr bgcolor="#E6F0ED">
		  <td height="20" class="thinborder"> &nbsp;<%=(String)vDayInterval.remove(0) + "::" +
											((String)vDayInterval.remove(0)).substring(0,3)%></td>
		  <td height="20" colspan="6" align="center" class="thinborder">&nbsp;</td>
	  </tr>
...
<% //Vector vLateUnderTime = RE.getMonthlyLateUTime(dbOP,request); %>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      <td width="15%" height="14" class="thinborder">&nbsp;</td>
      <td width="15%" align="center" class="thinborder"><div align="center"><strong>TOTAL MINUTES</strong></div></td>
      <td width="15%" class="thinborder"><div align="center"><strong>FREQUENCY</strong></div></td>
    </tr>
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#EEEDE6">
      <td height="25" colspan="3" align="center" class="thinborder"><strong>WORK
        SCHEDULE </strong></td>
    </tr>
...
%>
    <tr>
      <td height="25" colspan="3" align="center" class="thinborder"><strong><%=strErrMsg%></strong></td>
    </tr>
    <%}else{%>
    <tr align="center">
    ...
    <% 	String strTimeIn0 = null;
		...
		boolean bolFlexTime = false;
  		...
  		for(int i = 0 ; i< vWorkingHours.size(); i+=44){
			 bolFlexTime = false;
			 strTimeIn0 = null;
			 strTimeOut0 = null;
			 strTimeIn1 = null;
	 ...
	 <tr>
	  <td height="25" class="thinborder">&nbsp;<%=strWeekDay%></td>
      <td class="thinborder" colspan="2">&nbsp;<%=strTemp%></td>
	 </tr>
	 <%}%>
    <%}

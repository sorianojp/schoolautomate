  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          LATE TIME-IN EMPLOYEE LIST ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="25" >&nbsp;</td>
    </tr>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
  <tr> 
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td height="24"><input type="checkbox" name="checkbox" value="checkbox">
              ...
              Senior Staff <font color="#FF0000" size="1"> ( show this row for 
              AUF only)</font></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td>&nbsp;</td>
	...
	%>
          ...
          <tr bgcolor="#FFFFFF"> 
            <td>&nbsp;</td>
            <td height="25" colspan="2">Late Time-in Range</td>
            <td height="25">(in mins) <select name="select">
                <option>Equal to</option>
                <option>More than</option>
                <option>Less than</option>
                <option>Between </option>
              </select> <input name="textfield" type="text" size="3" maxlength="3">
              to 
              <input name="textfield2" type="text" size="3" maxlength="3"></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td height="10" colspan="4"><hr size="1"></td>
          </tr>
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td height="25" colspan="2"><select name="select2">
                ...
                <option>Late Time-in</option>
                <option><%if(bolIsSchool){%>College<%}else{%>Division<%}%></option>
          ...
          <tr bgcolor="#FFFFFF"> 
            <td>&nbsp;</td>
            <td height="25" colspan="2"><input name="proceed" type="image" id="proceed2" onClick="ViewRecords();" src="../../../images/form_proceed.gif"></td>
            <td height="25">&nbsp;</td>
          </tr>
        </table>
      </td>
      ...
      <td colspan="3"><table width="100%" border="1" cellpadding="3" cellspacing="0">
          <tr bgcolor="#006A6A"> 
            ...
            <td  colspan="5"><div align="center"><font color="#FFFFFF"><strong>LIST 
                OF EMPLOYEE WITH LATE TIME-IN (<%=strTemp%>)</strong></font></div></td>
          </tr>
          <tr> 

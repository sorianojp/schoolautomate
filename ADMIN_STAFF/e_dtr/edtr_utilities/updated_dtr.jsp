...
//add security here.
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-DTR Operations-View/Print DTR","updated_dtr.jsp");
...
{
//popup window here.
	var pgLoc = "./updated_dtr.jsp?DateDefaultSpecify=1&SummaryDetail=1" +
...
<form name="dtr_op" action="./updated_dtr.jsp" method="post">
      ...
      <td height="25">&nbsp;</td>
			<%
				if(WI.fillTextValue("show_actual").length() > 0)
					...
					strTemp = "";			
			%>
      <td colspan="3" height="25"><input type="checkbox" name="show_actual" value="1" <%=strTemp%>>

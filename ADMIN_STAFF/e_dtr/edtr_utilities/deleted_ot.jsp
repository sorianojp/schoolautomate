...
{ //System.out.println("hellow1");%>
	<jsp:forward page="./deleted_ot_print.jsp" />
<%}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-OVERTIME MANAGEMENT-View/Edit Overtime","deleted_ot.jsp");
...
int iAccessLevel = 	comUtil.isUserAuthorizedForURL(dbOP,
											...
											request.getRemoteAddr(),"deleted_ot.jsp");	
if(iAccessLevel == 0){
...
%>
<form action="./deleted_ot.jsp" method="post" name="dtr_op">
<input type="hidden" name="print_page">
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td colspan="3"><select name="c_index">
      ...
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
			 <% strTemp = WI.fillTextValue("show_division");
				if (strTemp.equals("1"))
					...
					strTemp = ""; 
				%>					
      <td bgcolor="#FFFFFF"><input type="checkbox" name="show_division" value="1" <%=strTemp%>>check to show Department/office </td>
    </tr>
    <tr>
      <td height="21" bgcolor="#FFFFFF">&nbsp;</td>
			<% strTemp = WI.fillTextValue("show_delete");
				if (strTemp.equals("1"))
					strTemp = "checked";
				else
					strTemp = ""; 
			%>
      <td bgcolor="#FFFFFF"><input type="checkbox" name="show_delete" value="1" <%=strTemp%>>
      show deletion details(deleted by and date)</td>
    </tr>
    <tr>
...
check to show all result </td>
  ...
  <tr>
    <td colspan="6" align="right" height="25">&nbsp;</td>
  </tr>
  <tr>

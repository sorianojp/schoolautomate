...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
  <tr> 
    <td colspan="4" bgcolor="#cccccc" height="25" class="thinborder"><div align="center"><strong>LIST 
        OF NON DTR EMPLOYEES</strong></div></td>
  </tr>
  <tr> 
    <td height="25" bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>EMPLOYEE 
        ID</strong></div></td>
    <td bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>NAME</strong></div></td>
    <td bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>COLLEGE 
        / OFFICE</strong></div></td>
    <td bgcolor="#EBEBEB" class="thinborder"><div align="center"><strong>EMPLOYEE 
        TYPE </strong></div></td>
  </tr>
<% 	for (int i = 0; i < vRetResult.size(); i+=8){%>
  <tr> 
    <td width="14%" height="25" class="thinborder"><%=(String)vRetResult.elementAt(i+1)%></td>

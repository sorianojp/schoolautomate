  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          EMPLOYEE WITH EXTRA TIME OUT RECORD ::::</strong></font></div></td>
    </tr>
	    <tr>
      <td height="25">&nbsp;</td>
    </tr>
...
<%}%>
			  ...
			  <input name="extra_time" type="text"  id="extra_time" size="12" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("extra_time")%>" onKeypress=" if(event.keyCode<48 || event.keyCode > 57) event.returnValue=false;">
              (in minutes)</td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td width="4%">&nbsp;</td>
      ...
      <td colspan="3"><table width="100%" border="1" cellpadding="3" cellspacing="0">
          <tr bgcolor="#006A6A"> 
            ...
            <td  colspan="5"><div align="center"><font color="#FFFFFF"><strong>LIST 
                OF EMPLOYEE WITH EXTRA TIME (<%=strTemp%>)</strong></font></div></td>
          </tr>
          <tr> 

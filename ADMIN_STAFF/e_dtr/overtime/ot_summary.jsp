...
{ %>
	<jsp:forward page="./ot_summary_print.jsp" />
<%}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record--Statistics & Reports-Details OT Rendered","ot_summary.jsp");
...
if (WI.fillTextValue("viewAll").equals("1")){
	...
	if (vRetResult == null){
		...
		//System.out.println("vDates " + vDates);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <% strTemp = WI.fillTextValue("show_division");
 	if (strTemp.equals("1"))
		...
		strTemp = ""; %>		
    <td colspan="3"> <input type="checkbox" name="show_all" value="1" <%=strTemp%>>

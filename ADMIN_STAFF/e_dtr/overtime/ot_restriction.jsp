...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-OVERTIME MANAGEMENT-View/Edit Overtime","ot_restriction.jsp");
...
if(strPageAction.length() > 0){
	if(OT.operateOnOTRestriction(dbOP, request, Integer.parseInt(strPageAction)) == null){
		strErrMsg = OT.getErrMsg();
	} else {
		if(strPageAction.equals("1"))
			strErrMsg = "Restriction successfully posted.";
		if(strPageAction.equals("0")){
			strErrMsg = "Restriction successfully removed.";
		}
	}
}

  if(WI.fillTextValue("searchEmployee").equals("1")){
		vRetResult = OT.operateOnOTRestriction(dbOP, request, 4);
	  if(vRetResult == null)
			strErrMsg = OT.getErrMsg();
	  else
...
<form name="form_" method="post" action="./ot_restriction.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      OVERTIME REQUEST RESTRICTION PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="23" colspan="3"><a href='javascript:ShowHideLabel("1")' title="click to see help">
			...
			<div id="note" style="position:absolute; visibility:hidden; width:550px; overflow:auto;">
				...
				<tr>
					<td width="90%">NOTE : This page is for limiting the clerks/timekeepers to request OT for employees from his/her own Division/Department only<br>
					</td>
					<td width="10%" align="center"><a href="javascript:ShowHideLabel('0');"><strong><font size="2" color="#FF0000">HIDE</font></strong></a></td>
				</tr>
				</table>
			</div><strong><%=strErrMsg%></strong></td>
    </tr>
...
View Employees without resctriction</td>
    </tr>
    <tr>
      <td height="11" colspan="3"><%
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">    
    <tr bgcolor="#B9B292" class="thinborder"> 
      <td height="23" colspan="5" align="center"><strong>OVERTIME RESTRICTIONS</strong></td>	  
    </tr>
    <tr bgcolor="#ffff99" class="thinborder">
      ...
      <td width="13%" align="center" class="thinborder"><strong>RESTRICTION</strong></td>
      <%}%>
	...
	<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="25" colspan="2" bgcolor="#FFFFFF"><strong>Note:</strong> <br>
        OR - can only process employees from the same division or department.<br>
      AND - can only process employees from the same division and department. </td>
    </tr>
    <tr>
      <td width="25%" height="25" bgcolor="#FFFFFF"><strong>Restriction type </strong></td>
			<%
				if(bolIsSchool)
					strTemp = "College";
				else
      ...
      <td width="75%" height="25" bgcolor="#FFFFFF">
			<select name="restrict_type">
        <option value="0">Restricted to Employees from the same <%=strTemp%> OR Department</option>
				<%if(WI.fillTextValue("restrict_type").equals("1")){%>
				<option value="1">Restricted to Employees from the same <%=strTemp%> AND Department</option>
				<%}else{%>
				<option value="1">Restricted to Employees from the same <%=strTemp%> AND Department</option>
				<%}%>
      </select>			</td>

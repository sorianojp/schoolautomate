...
int iCols = 0;
  ...
  String[] astrConverAMPM = {"AM","PM"};
	...
	/**
	System.out.println(adFacultyRate[0]);
	System.out.println(adFacultyRate[1]);
	System.out.println(adFacultyRate[2]);
	System.out.println(adFacultyRate[3]);
	System.out.println(adFacultyRate[4]);
	**/
%>

<form action="./faculty_sched_detail.jsp" method="post" name="form_">

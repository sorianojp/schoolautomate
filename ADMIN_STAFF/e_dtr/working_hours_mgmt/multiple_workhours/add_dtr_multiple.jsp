...
function SaveData() {
	...
	function CancelRecord(){
		location = "./add_dtr_multiple.jsp?emp_id=" + document.form_.emp_id.value + 
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-Edit Time-in Time-out","add_dtr_multiple.jsp");
...
<form action="./add_dtr_multiple.jsp" method="post" name="form_">
...
<!--
    ...
    <tr>
      ...
      <td height="25" colspan="4"><label id="coa_info"></label>
        ...
        <font size="1">Save manually entered tardiness and undertime</font></td>
    </tr>
  </table>
 ...
 <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
   <tr>
     <td height="25" colspan="7" align="center" bgcolor="#B9B292" class="thinborder">LIST OF 
   ...
   <tr>
     ...
     <td width="11%" align="center" class="thinborder">&nbsp;</td>
   ...
   <tr>
     ...
     <td width="10%" class="thinborder">&nbsp;Time In</td>
...
:
  ...
  <select name="ampm_from_<%=iCount%>">
   ...
   <tr>
     <td height="25" class="thinborder">&nbsp;Time Out</td>
     <td class="thinborder">&nbsp;

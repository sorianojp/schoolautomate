...
function CancelRecord(){
	location ="./set_subject_type.jsp";
}

function checkAllSave() {
	var maxDisp = document.form_.sub_count.value;
...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Subject Allowances","set_subject_type.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form action="./set_subject_type.jsp" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
       SUBJECT TYPE IMPLEMENTATION PAGE ::::</strong></font></td>
    </tr>
</table>
...
<%				
			  ...
			  String[] astrSelected = request.getParameterValues("sub_type");
				...
				if(request.getParameterValues("sub_type") == null || astrSelected[0].length() == 0)
					strTemp = "selected";
				else
					strTemp = "";
			%>				
      <td>
        <select name="sub_type" multiple size="4">
				<option value="">ALL</option>
				<%for(i = 1; i < astrSubType.length;i++){
				 strSelected = "";
				 if(astrSubType[i].equals("-1"))//do not show for specific school..
				 	continue;
				...
				%>
				  <option value="<%=i%>" <%=strSelected%>><%=astrSubType[i]%></option>				
				<%}%>
      </select> 
      </td>
    </tr>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td>SORT BY :</td>
      <td width="40%" height="29"><select name="sort_by1">
        <option value="">N/A</option>
        <%=rptMultiple.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
      </select></td>

      <td width="46%" height="29"><select name="sort_by2">
        <option value="">N/A</option>
        <%=rptMultiple.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%>
      </select></td>
    </tr>
    <tr> 
      <td height="15">&nbsp;</td>

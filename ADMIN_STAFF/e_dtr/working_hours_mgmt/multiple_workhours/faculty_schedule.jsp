...
if(strPageAction.length() > 0){
 	vFacSchedule = mWHour.operateOnFacultySchedule(dbOP, request, Integer.parseInt(strPageAction));
...
if(strSchCode == null)
	strSchCode = "";
%>
<form name="form_" action="./faculty_schedule.jsp" method="post">
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">		
		<tr>
			...
			<td width="81%"><input name="date_from" type="text" size="12" maxlength="12" readonly="yes" value="<%=WI.fillTextValue("date_from")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
...
<%
 for(i = 0; i < vRetResult.size(); i += 25){%>
   <tr> 
      <td height="25" class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(i + 2))%>&nbsp;<%=astrWeekday[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(i + 17)))]%></td>
			<%

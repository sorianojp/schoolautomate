...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record-WORKING HOURS MGMT","post_faculty_deduction.jsp");
...
//end of authenticaion code.
	...
	if(strPageAction.length() > 0){
 		if(WHour.operateOnFacultyOffensesBySubjType(dbOP, request, Integer.parseInt(strPageAction)) == null){
	...
	if(WI.fillTextValue("searchEmployee").equals("1")){
		vRetResult = WHour.operateOnFacultyOffensesBySubjType(dbOP, request,4);
		if(vRetResult == null)
			strErrMsg = WHour.getErrMsg();
		else
...
%>	
<form action="post_faculty_deduction.jsp" method="post" name="form_">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
    ...
    <tr> 
      <td height="20" colspan="12" align="center" bgcolor="#B9B292" class="thinborder"><strong>LIST OF EMPLOYEES</strong></td>
    </tr>
    <tr>
      ...
      <td width="22%" align="center" class="thinborder"><strong><font size="1">DEPARTMENT/OFFICE</font></strong></td>
			<td width="7%" align="center" class="thinborder"><strong><font size="1">LEC</font></strong></td>
			<td width="7%" align="center" class="thinborder"><strong><font size="1">LAB</font></strong></td>
			<td width="7%" align="center" class="thinborder"><strong><font size="1">RLE</font></strong></td>
			<td width="7%" align="center" class="thinborder"><strong><font size="1">NSTP</font></strong></td>
			<td width="7%" align="center" class="thinborder"><strong><font size="1">GRAD</font></strong></td>
			<td width="7%" align="center" class="thinborder">DETAILS</td>
			<!--
    ...
    <tr>
      ...
      <td class="thinborder">&nbsp; <%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"")%><%=strTemp%><%=WI.getStrValue((String)vRetResult.elementAt(i + 6),"")%> </td>
  		...
  		%>			<td align="center" class="thinborder"><strong>
			  <input name="lec_<%=iCount%>" type="text" size="5" maxlength="6" class="textbox"
			value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'"
			onBlur="AllowOnlyInteger('form_','lec_<%=iCount%>');style.backgroundColor='white'"
	    onKeyUp="AllowOnlyInteger('form_','lec_<%=iCount%>');" style="text-align : right">
			</strong></td>
			<%
  		...
  		%>
			<td align="center" class="thinborder"><strong>
			  <input name="lab_<%=iCount%>" type="text" size="5" maxlength="6" class="textbox"
			value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'"
			onBlur="AllowOnlyInteger('form_','lab_<%=iCount%>');style.backgroundColor='white'"
	    onKeyUp="AllowOnlyInteger('form_','lab_<%=iCount%>');" style="text-align : right">
			</strong></td>
			<%
  		...
  		%>
      <td align="center" class="thinborder"><strong>
        <input name="rle_<%=iCount%>" type="text" size="5" maxlength="6" class="textbox"
			value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'"
			onBlur="AllowOnlyInteger('form_','rle_<%=iCount%>');style.backgroundColor='white'"
	    onKeyUp="AllowOnlyInteger('form_','rle_<%=iCount%>');" style="text-align : right">
      </strong></td>
			<%
  		...
  		%>		
      <td align="center" class="thinborder"><strong>
        <input name="nstp_<%=iCount%>" type="text" size="5" maxlength="6" class="textbox"
			value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'"
			onBlur="AllowOnlyInteger('form_','nstp_<%=iCount%>');style.backgroundColor='white'"
	    onKeyUp="AllowOnlyInteger('form_','nstp_<%=iCount%>');" style="text-align : right">
      </strong></td>
			<%
  		...
  		%>
      <td align="center" class="thinborder"><strong>
        <input name="grad_<%=iCount%>" type="text" size="5" maxlength="6" class="textbox"
			value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'"
			onBlur="AllowOnlyInteger('form_','grad_<%=iCount%>');style.backgroundColor='white'"
	    onKeyUp="AllowOnlyInteger('form_','grad_<%=iCount%>');" style="text-align : right">
      </strong></td>
    ...
    <%} //end for loop%>
    <tr>
      <td height="25" colspan="12">Note : All units are in minutes. </td>
    </tr>
    <tr>

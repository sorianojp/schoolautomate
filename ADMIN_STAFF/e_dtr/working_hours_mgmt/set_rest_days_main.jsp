...
<body bgcolor="#D2AE72" class="bgDynamic">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      ...
      REST DAYS MANAGEMENT MAIN PAGE ::::</strong></font></td>
    </tr>
	</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="71%"><a href="./rest_days.jsp">Set Rest Days (per employee) </a></td>
  </tr>
<%if(!bolIsRestricted) {%>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./batch_rest_day.jsp">Set Rest Days (Batch) </a></td>
  </tr>
<%}%>
  <tr> 
    <td width="12%" height="25">&nbsp;</td>
    ...
    <td width="2%" align="center">&nbsp;</td>
    <td width="71%"><a href="./rest_days_search.jsp">Search Employee Rest Days</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>

...
<%
	...
	<jsp:forward page="./adhoc_working_hours_print.jsp" />
<%  return;}
//add security here.
	try
	{
...
%>
<form action="./adhoc_working_hours.jsp" method="post" name="dtr_op">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#A49A6A">
      ...
      <td width="80%" height="25" bgcolor="#FFFFFF"><p>
        <input name="specific_date" type="text"  class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("specific_date")%>"  size="10" maxlength="10" readonly="true">
          <a href="javascript:show_calendar('dtr_op.specific_date');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a>&nbsp;</td>
    </tr>
    <tr bgcolor="#A49A6A">
...
<%
		...
		if (wHour.defSearchSize > 0){ 
			iPageCount = iSearchResult/wHour.defSearchSize;
...
<% if (!WI.fillTextValue("show_all").equals("1")) {%>
		- Showing(<%=wHour.getDisplayRange()%>) <%}%></b></td>
        <td width="32%">
<%
...
<%}//show only if iPageCount > 0%>				  </td>
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr>
	    <td height="25" colspan="3" align="center" bgcolor="#B9B292" class="thinborder">

...
<%
	...
	if (vRetResult != null) {		
		...
		int iNumRec = 0;
		int iPageNo = 1;
		int iTotalPages = vRetResult.size()/(6*iMaxRecPerPage);
		if(vRetResult.size()%(6*iMaxRecPerPage) > 0)
			iTotalPages++;	
		for (;iNumRec < vRetResult.size();iPageNo++){%>		
		
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    	<tr>
      		<td height="25" colspan="3"><div align="center"><strong>:::: UPLOAD  HISTORY ::::</strong></div></td>
    	</tr>
		<tr>
		...
		<tr>
			<td height="25">&nbsp;</td>
			<td>Date: </td>
			<td>Within the last <%=WI.fillTextValue("day_count")%> day(s).</td>
		</tr>
		<tr>
			<td height="15" colspan="3">&nbsp;</td>
		</tr>
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
		<tr>
      		<td height="20" colspan="9" class="thinborder">
		...
		<% 
			...
			for(iCount = 1; iNumRec<vRetResult.size(); iNumRec+=6, ++iCount, ++iResultCount){
				i = iNumRec;

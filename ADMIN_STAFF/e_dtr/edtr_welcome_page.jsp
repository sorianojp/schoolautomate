...
<body bgcolor="#D2AE72" class="bgDynamic">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="3" align="center" class="footerDynamic"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
      electronic DAILY TIME RECORD PAGE ::::</strong></font></td>
    </tr>
    <tr > 
...
<%}else{%>
    <tr > 
      <td height="25" colspan="3" align="center"><strong><font size="3" face="Verdana, Arial, Helvetica, sans-serif">WELCOME 
      <%=strName%> TO THE ELECTRONIC DAILY TIME RECORD PAGE!</font></strong></td>
    </tr>
    <tr > 
      <td height="25" colspan="3">&nbsp;</td>
    </tr>
    <tr > 
      ...
      <td width="84%" height="25"> <div align="justify"> 
          <font size="2" face="Verdana, Arial, Helvetica, sans-serif">Please 
            ...
            the logout button everytime you leave your PC.</font>

...
<html>
<head>
<title>Convert AWOL to Late/UT</title>
...
if (WI.fillTextValue("recompute").equals("1")) { 
	if (RE.operateOnConvertAwolToLateUT(dbOP, request, 1) == null) 
		strErrMsg = RE.getErrMsg();
	else
		strErrMsg  = "Operation Successful";
}
if (WI.fillTextValue("viewRecords").equals("1")) { 
	vRetResult = RE.operateOnConvertAwolToLateUT(dbOP,request, 4);
	if(vRetResult == null)
		strErrMsg = RE.getErrMsg();
	else
...
<form name="form_" action="./convert_awol_to_late_ut.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td height="25" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        DTR OPERATIONS - CONVERT AWOL TO LATE OR UNDERTIME ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="25"  bgcolor="#FFFFFF">
			<%if(iAccessLevel == 2){%>
			<input type="button" name="compute_btn" value=" Move AWOL " style="font-size:11px; height:28px;border: 1px solid #FF0000;" onClick="javascript:Recompute();"><label id="loading_" style="position:fixed"></label>
			<%}else{%>

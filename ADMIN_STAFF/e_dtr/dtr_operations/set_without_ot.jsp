...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDTR-DTR Operations-Set without overtime","set_without_ot.jsp");		
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		...
		if(OT_.operateOnDtrRestrictions(dbOP, request, Integer.parseInt(strPageAction), 0) == null){
	...
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = OT_.operateOnDtrRestrictions(dbOP,request, 4, 0);
		if(vRetResult == null)
			strErrMsg = OT_.getErrMsg();
		else
...
<form action="set_without_ot.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        eDTR : SET EMPLOYEES WITH OVERTIME RESTRICTION ::::</strong></font></td>
    </tr>
</table>
    ...
    <tr> 
      <td height="23" colspan="5">
			...
			<div id="note" style="position:absolute; visibility:hidden; width:550px; overflow:auto;">
				...
				<tr>
					<td width="90%">NOTE : Employees listed here are those not allowed to have any overtime applications</td>
...
View with overtime restriction
<%
	if(strTemp.length() == 0) 
		strTemp = " checked";
	else

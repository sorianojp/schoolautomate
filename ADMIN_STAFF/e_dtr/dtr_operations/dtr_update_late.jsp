...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eDaily Time Record--Statistics & Reports-Recompute Old DTR(late)","dtr_update_old.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if (WI.fillTextValue("update_records").equals("1")) { 
	iResult = RE.recalculateLateTimeIn(dbOP,request);
...
<form name="form_" action="./dtr_update_late.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td height="25" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        DTR OPERATIONS - UPDATE OLD RECORDS (LATE)::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 

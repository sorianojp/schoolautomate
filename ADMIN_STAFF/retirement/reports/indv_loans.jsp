...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-RETIREMENT-ENCODE_LOADNS-Create Loans","indv_loans.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./indv_loans.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::RETIREMENT 
          - REPORTS - INDIVIDUAL LOANS PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="2%">&nbsp;</td>
      <td height="27" colspan="2">From School Year : <font size="1"> 
        ...
        <input name="textfield22" type="text" size="4" maxlength="4">
        </font></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
	  ...
	  %>	  
      <td height="27" width="41%">Loan Type : 
      ...
      <td height="27" width="57%"><font size="1"><a href="javascript:ReloadPage()"><img src="../../../images/form_proceed.gif" border="0"></a></font></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="3%">&nbsp;</td>
      <td width="97%" height="27">OUTSTANDING $LOAN_TYPE LOANS FROM SY ($from 
        - $from_of_end_year)</td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25"><div align="right">Number of employees per page 
	...
	if(iPageCount > 1){%>
    <tr> 
      <td height="25"><div align="right">Jump To page: 
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="4%" height="25"><div align="center"><strong><font size="1">COUNT</font></strong></div></td>
      <td width="23%"><div align="center"><strong><font size="1">EMPLOYEE NAME</font></strong></div></td>
      <td width="11%"><div align="center"><strong><font size="1">LOAN CODE</font></strong></div></td>
      <td width="17%"><div align="center"><font size="1"><strong><font size="1">TOTAL 
          LOAN </font></strong></font></div></td>
      <td width="11%"><div align="center"><font size="1"><strong>2006-2007 </strong></font></div></td>
      <td width="12%"><div align="center"><font size="1"><strong>2007-2008</strong></font></div></td>
      <td width="11%"><div align="center"><font size="1"><strong>2008-2009</strong></font></div></td>
      <td width="11%"><div align="center"><strong><font size="1"><strong>2009-2010</strong></font></strong></div></td>
    </tr>
    <tr> 
      <td height="24">&nbsp;</td>
      <td height="24">&nbsp;</td>
    ...
    <tr> 
      ...
      <td height="24"><div align="right">TOTALS :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></td>
      <td height="24">&nbsp;</td>
      <td height="24">&nbsp;</td>
      <td height="24">&nbsp;</td>
      <td height="24">&nbsp;</td>

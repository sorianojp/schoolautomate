...
//add security here.
	...
	String[] astrLoanType= {"Regular Retirement Fund","Emergency","Regular Loan"};
...
<form name="form_" method="post" action="./sched_ind_payments.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: REPORTS - SCHEDULE OF INDIVIDUAL PAYMENTS PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
    <tr> 
      <td width="3%">&nbsp;</td>
      <td width="16%" height="27">Loan Type</td>
      <td width="31%" height="27"><strong><%=astrLoanType[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(4),"0"))]%></strong></td>
    ...
    <tr> 
      ...
      <td width="33%" height="27"><strong><%=WI.getStrValue((String)vRetResult.elementAt(10),"")%></strong></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#99CCFF"> 
      <td height="25" colspan="6" class="BorderAll"><div align="center"><strong>:: 
          SCHEDULE OF SALARY DEDUCTIONS FOR LOAN PAYMENTS ::</strong></div></td>
    </tr>
    <tr> 
      <td width="14%" height="25" class="BorderBottomLeft"><div align="center"><strong><font size="1">PAYROLL 
          PERIOD</font></strong></div></td>
      <td width="17%" height="25" class="BorderBottomLeft"><div align="center"><strong><font size="1">TOTAL 
          PAYMENT</font></strong></div></td>
      <td height="25" colspan="2" class="BorderBottomLeft"><div align="center"><strong><font size="1">PAYMENT 
          ON PRINCIPAL</font></strong></div></td>
      <td width="24%" class="BorderBottomLeft"><div align="center"><strong><font size="1">PAYMENT 
          ON INTEREST</font></strong></div></td>
      <td width="23%" class="BorderBottomLeftRight"><div align="center"><strong><font size="1">PRINCIPAL 
    ...
    <tr> 
      ...
      <td width="13%"><div align="right"><strong><%=CommonUtil.formatFloat(WI.getStrValue((String)vRetResult.elementAt(i+4),"0"),true)%></strong></div></td>

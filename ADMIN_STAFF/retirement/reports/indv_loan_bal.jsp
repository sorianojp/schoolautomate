...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-RETIREMENT-ENCODE_LOADNS-Create Loans","indv_loan_bal.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./indv_loan_bal.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::RETIREMENT 
          - REPORTS - INDIVIDUAL LOAN BALANCES PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="3"><div align="right">Number of employees per page 
	...
	if(iPageCount > 1){%>
    <tr> 
      <td height="25" colspan="3"><div align="right">Jump To page: 
    ...
    <%}%>
    <tr> 
      <td width="9%" height="25" class="BorderAll"><div align="center"><strong><font size="1">COUNT</font></strong></div></td>
      <td width="49%" height="25" class="BorderAll"><div align="center"><strong><font size="1">EMPLOYEE 
          NAME </font></strong></div></td>
      <td width="42%" class="BorderAll"><div align="center"><strong><font size="1">LOAN 
    ...
    <%}%>
    <tr> 
      <td height="24" colspan="2" class="BorderBottomLeft"><div align="right">TOTAL 
          :&nbsp;&nbsp;&nbsp;</div></td>

...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-RETIREMENT-ENCODE_LOADNS-Create Loans","indv_active_loan_bal.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if (WI.fillTextValue("proceed").length() > 0) {
		vRetResult = PRRetLoan.getIndActiveLoanBal(dbOP,request);		
		if(vRetResult == null)
...
%>
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./indv_active_loan_bal.jsp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="3%">&nbsp;</td>
      <td width="97%" height="27">OUTSTANDING ACATIVE <font color="#000000"><%=astrLoanType[Integer.parseInt(WI.getStrValue(strLoanType,"0"))]%></font> BALANCES OF THE <%=astrFSType[Integer.parseInt(strFSType)]%> </td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td height="27"> AS OF <%=WI.fillTextValue("end_date")%><font color="#FF0000"><strong> TO BE CONTINUED</strong></font></td>
    </tr>
    <tr> 

...
<form name="form_" method="post" action="./sched_total_monthly_payments.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::RETIREMENT 
          - REPORTS - SCHEDULE OF TOTAL MONTHLY PAYMENTS PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td>&nbsp;</td>
      <td height="27" colspan="2">Show Fund Loans Released on : School Year : 
        <%
    ...
    <tr> 
	  ...
	  %>
      <td width="37%" height="27">Released date : <strong> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td><div align="right"><strong><%=(String)vRetResult.elementAt(0)%></strong></div></td>
      <td height="27">&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td height="27"> Total amount of released loans :</td>
      <td width="24%"><div align="right"><strong><%=(String)vRetResult.elementAt(2)%></strong></div></td>
      <td width="40%" height="27"><strong> </strong></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td height="27">Effective interest rate (per annum) :</td>
      <td><div align="right"><strong><%=(String)vRetResult.elementAt(1)%></strong></div></td>
      <td height="27">&nbsp;</td>
    </tr>
    <tr> 

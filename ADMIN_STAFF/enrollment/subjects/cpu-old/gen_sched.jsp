...
if (bIsDupe) 
	...
	if (vRetResult.elementAt(i+17)!=null)
		strTemp = WI.formatName((String)vRetResult.elementAt(i+18),(String)vRetResult.elementAt(i+19),
								(String)vRetResult.elementAt(i+20),7);
	else
		strTemp = "c/o";
%>
      <td width="21%"><font size="1"><%=strTemp%></font></td>
	  <%if (bIsDupe) 
		  	strTemp = "&nbsp;";
		else
	  ...
	  <%if (bIsDupe) 
	 		...
	 		strTemp =  "<a href=\"javascript:EditStubCode(" + 
							...
							(String)vRetResult.elementAt(i+6) + "</a>";
	  %>	  
      <td width="6%"><font style="font-size:11px"><strong><%=strTemp%></strong></font></td>
	  <%if (bIsDupe) 
		  	strTemp = "&nbsp;";
		else

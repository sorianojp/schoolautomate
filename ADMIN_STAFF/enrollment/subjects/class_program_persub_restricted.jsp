...
strSYFrom = strTemp;
%> <input name="sy_from" type="text" id="sy_from"
...
if(strTemp.length() ==0)
	...
	%> <input name="sy_to" type="text" id="sy_to" style='font-size:20px;'
...
strSem = strTemp;
	%>
			<select name="semester" style="font-size:20px; font-weight:bold; color:#000000">

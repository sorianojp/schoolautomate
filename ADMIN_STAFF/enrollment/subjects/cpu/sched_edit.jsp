...
function showBranch(branch,strWeekDay){
	...
	if(objBranch.display=="block"){
		...
		document.ssection.sub_sel124.value="";
		 document.ssection.week_day_label.value ="";
		...
		var iWeekDay = Number(strWeekDay);
		
		switch(iWeekDay){
			case 0 : document.ssection.week_day_label.value ="SUNDAY"; break;
			case 1 : document.ssection.week_day_label.value ="MONDAY"; break;			
			case 2 : document.ssection.week_day_label.value ="TUESDAY"; break;
			case 3 : document.ssection.week_day_label.value ="WEDNESDAY"; break;			
			case 4 : document.ssection.week_day_label.value ="THURSDAY"; break;
			case 5 : document.ssection.week_day_label.value ="FRIDAY"; break;			
			case 6 : document.ssection.week_day_label.value ="SATURDAY"; break;
		}
	}
}
...
<% } %>	 </td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td height="25" align="left" width="3%"> &nbsp;
	  <%	
          ...
          <tr> 
            <td height="25" colspan="5" bgcolor="#FDF7F7"> 
				<strong>&nbsp;&nbsp;&nbsp;Add new Time / Room :  </strong>
						<input type="text" class="textbox_noborder" readonly="yes" name="week_day_label" size="10">
            </td>
          </tr>
          <tr> 
            <td width="12%">&nbsp; </td>

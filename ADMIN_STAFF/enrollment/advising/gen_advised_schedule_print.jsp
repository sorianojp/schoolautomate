...
if(strSchoolCode.startsWith("CIT")){%>
	<jsp:forward page="./gen_advised_schedule_print_cit.jsp" />
<%}if(strSchoolCode.startsWith("DLSHSI")){%>
	<jsp:forward page="./gen_advised_schedule_print_dlshsi.jsp" />
<%}if(strSchoolCode.startsWith("HTC")){%>
	<jsp:forward page="./gen_advised_schedule_print_htc.jsp" />
<%}if(strSchoolCode.startsWith("SPC")){%>
	<jsp:forward page="./gen_advised_schedule_print_spc.jsp" />
<%}

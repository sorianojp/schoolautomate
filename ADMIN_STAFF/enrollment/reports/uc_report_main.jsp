...
<body bgcolor="#D2AE72">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="2" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: UC ENROLMENT REPORT ::::</strong></font></div></td>
		</tr>
	</table>
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
		...
		<tr>
		    ...
		    <td width="2%">&nbsp;</td>
		    <td width="68%"><a href="./enrollment_status_uc.jsp">Enrollment Status</a></td>
		</tr>
		
		<tr>
		    <td height="25" width="30%" align="right">&nbsp;</td>
		    <td width="2%">&nbsp;</td>
		    <td width="68%"><a href="./master_list_uc.jsp">Master List</a></td>
		</tr>
		<tr>

...
<%if(i == 1 || WI.fillTextValue("summary_of_roe").compareTo("1") != 0) {%>
    <tr align="center" style="font-weight:bold"> 
      <td width="46%" rowspan="2" class="thinborder"><font size="1">COURSE</font></td>
...
i = j;
    ...
    <tr> 
      ...
      <td width="3%" class="thinborder" align="center"><%=i1stYrTotal%></td>
      ...
      <td width="3%" class="thinborder" align="center"><%=i2ndYrTotal%></td>
      ...
      <td width="3%" class="thinborder" align="center"><%=i3rdYrTotal%></td>
      ...
      <td width="3%" class="thinborder" align="center"><%=i4thYrTotal%></td>
      ...
      <td width="3%" class="thinborder" align="center"><%=i5thYrTotal%></td>
      <td width="3%" class="thinborder" align="right"><%=iSubTotalM%></td>
      <td width="3%" class="thinborder" align="right"><%=iSubTotalF%></td>
      <td width="3%" class="thinborder" align="right"><font size="1"><%=iSubTotal%></font></td>
    </tr>
<%} %>
    <tr>
      ...
      <td class="thinborder" align="center"><%=ariMFperYear[0] + ariMFperYear[1]%></td>
      <td class="thinborder"><%=ariMFperYear[2]%></td>
      <td class="thinborder"><%=ariMFperYear[3]%></td>
      <td class="thinborder" align="center"><%=ariMFperYear[2] + ariMFperYear[3]%></td>
      <td class="thinborder"><%=ariMFperYear[4]%></td>
      <td class="thinborder"><%=ariMFperYear[5]%></td>
      <td class="thinborder" align="center"><%=ariMFperYear[4] + ariMFperYear[5]%></td>
      <td class="thinborder"><%=ariMFperYear[6]%></td>
      <td class="thinborder"><%=ariMFperYear[7]%></td>
      <td class="thinborder" align="center"><%=ariMFperYear[6] + ariMFperYear[7]%></td>
      <td class="thinborder"><%=ariMFperYear[8]%></td>
      <td class="thinborder"><%=ariMFperYear[9]%></td>
      <td class="thinborder" align="center"><%=ariMFperYear[8] + ariMFperYear[9]%></td>

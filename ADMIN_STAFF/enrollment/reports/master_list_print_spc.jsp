...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" id="myTable3">		
	<tr><td colspan="3" align="center"><font size="+1" color="#00CC33"><strong><%=strSchName%></strong></font></td></tr>
	<tr>
		<td width="30%">&nbsp;</td>
		<td align="center"><font size="1"><strong>
		Student Master Listing </strong><br>
			<%=astrConvertSem[Integer.parseInt(WI.getStrValue(WI.fillTextValue("offering_sem")))]%> 
			<%=WI.getStrValue(WI.fillTextValue("sy_from"))%>-<%=WI.getStrValue(WI.fillTextValue("sy_to"))%></font></td>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">	
	<tr>
		<td height="18" align="center" width="5%" class="thinborderTOPBOTTOM"><strong>Count</strong></td>
		<td width="12%" align="center" class="thinborderTOPBOTTOM"><strong>Student ID</strong></td>
		<td width="38%" align="center" class="thinborderTOPBOTTOM"><strong>Student Name </strong></td>
		<td width="25%" align="center" class="thinborderTOPBOTTOM"><strong>Remarks</strong></td>
		<td width="5%" align="center" class="thinborderTOPBOTTOM"><strong>Gender</strong></td>
		<td width="10%" align="center" class="thinborderTOPBOTTOM"><strong>Course</strong></td>
		<td width="5%" align="center" class="thinborderTOPBOTTOM"><strong>Year</strong></td>
	</tr>
	...
	<tr>
		<td height="25" align="" class="thinborderNONE"><%=iCount%>.</td>
		<td height="25" align="" class="thinborderNONE"><%=(String)vRetResult.elementAt(i)%></td>
		<td height="25" align="left" class="thinborderNONE"><%=WI.formatName((String)vRetResult.elementAt(i+1),(String)vRetResult.elementAt(i+2),(String)vRetResult.elementAt(i+3),5)%></td>
		<td align="center" class="thinborderBOTTOMDOTTED">&nbsp;</td>
		<td height="25" align="center" class="thinborderNONE"><%=WI.getStrValue((String)vRetResult.elementAt(i+8))%></td>
		<td height="25" align="left" class="thinborderNONE">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(i + 4))%>
		<%=WI.getStrValue((String)vRetResult.elementAt(i+5),"- ","","")%></td>
		<td height="25" align="center" class="thinborderNONE">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(i + 6))%></td>
	</tr>

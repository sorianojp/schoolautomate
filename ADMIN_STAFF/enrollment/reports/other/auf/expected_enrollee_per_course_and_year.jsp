...
if(WI.fillTextValue("show_report").length() > 0){
	rprtEnrl.setCIndexExMajor("8, 5");
	vRetResult = rprtEnrl.generateExpectedEnrolleesPerCourseAndYear(dbOP, request);
...
%>
<form name="form_" action="expected_enrollee_per_course_and_year.jsp" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable1">
<tr bgcolor="#A49A6A">
	<td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>::::
		EXPECTED ENROLLEES PER COURSE/YEAR LEVEL REPORT PAGE ::::</strong></font></div></td>
</tr>   
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable2">
	...
	<%=SchoolInformation.getAddressLine1(dbOP, false, false)%><br><font style="font-size:14px;">EXPECTED ENROLLEES PER COURSE/YEAR LEVEL</font>
	<br>&nbsp;
	</td></tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	...
	<tr>
		...
		if(!strSemester.equals("1"))
			strErrMsg = astrConvertSem[Integer.parseInt(WI.fillTextValue("prev_semester"))]+" "+
				WI.fillTextValue("prev_sy_from").substring(2)+"-"+WI.fillTextValue("prev_sy_to").substring(2);
	...
	<tr>
		...
		<%
		String[] astrYearLevel = {"Actual","First Yr.","Second Yr.","Third Yr.","Fourth Yr.","Fifth Yr.","Sixth Yr.","Seventh Yr."};
		for(int i = 0; i < vHeaderList.size(); ++i){
		
		if(strSemester.equals("1"))
			strTemp = astrYearLevel[i];
		else
			strTemp = "Total Enrollees";
		%>
	    <td align="center" class="thinborder" style="font-size:10px;"><%=strTemp%></td>
	    <td style="font-size:10px;" align="center" class="thinborder"><%=astrYearLevel[i+1]%></td>
	    <td style="font-size:10px;" align="center" class="thinborder">&nbsp;</td><%}%>
	    </tr>
	<tr>
	    <td align="center" class="thinborder">&nbsp;</td>
		<%for(int i = 0; i < vHeaderList.size(); ++i){
		...
		%>
	    <td align="center" class="thinborder" style="font-size:10px;"><%=strTemp%></td>
	    <td style="font-size:10px;" align="center" class="thinborder"><%=strErrMsg%></td>
	    <td style="font-size:10px;" align="center" class="thinborder">&nbsp;</td>
		<%}%>
	    </tr>
...
%>
	<tr>
	    <td class="thinborder" style="padding-left:30px;"><%=(String)vRetResult.elementAt(i+1)%><%=WI.getStrValue((String)vRetResult.elementAt(i+2),"-","","")%></td>

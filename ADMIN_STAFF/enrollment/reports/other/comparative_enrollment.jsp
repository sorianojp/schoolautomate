...
if(strSchCode != null && strSchCode.startsWith("UB")){
	response.sendRedirect("./comparative_enrollment_UB.jsp");
	return;
}%>
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Enrollment-Other report-Comparative Enrollment","comparative_enrollment.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(WI.fillTextValue("sy_from").length() > 0 && WI.fillTextValue("sy_from2").length() > 0) {
	vRetResult = reportE.comparitiveEnrollmentData(dbOP, request);
	if(vRetResult == null)
		strErrMsg = reportE.getErrMsg();
}
%>
<form action="./comparative_enrollment.jsp" method="post" name="form_">
...
iSYF = 0; iSYT = 0;
if(vSY1.size() > 0)
	iSYF = Integer.parseInt((String)vSY1.remove(1));
if(vSY2.size() > 0)
	iSYT = Integer.parseInt((String)vSY2.remove(1));
iDiff = iSYF - iSYT;
if(iSYT > 0)
	dPercentDiff = (iDiff * 100d/iSYT);
else	
...
%>
	<tr>
	  <td class="thinborder" height="25">Integrated School</td>
	  <td class="thinborder" align="right"><%=iSYF%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td class="thinborder" align="right"><%=iSYT%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td class="thinborder" align="right"><%if(iDiff > 0){%><%=iDiff%><%}else{%>(<%=iDiff * -1%>)<%}%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td class="thinborder" align="right"><%if(dPercentDiff > 0){%><%=CommonUtil.formatFloat(dPercentDiff,false)%><%}else{%>(<%=CommonUtil.formatFloat(dPercentDiff * -1, false)%>)<%}%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
iSYF = 0; iSYT = 0;
if(vSY1New.size() > 0)
	iSYF = Integer.parseInt((String)vSY1New.remove(1));
if(vSY2New.size() > 0)
	iSYT = Integer.parseInt((String)vSY2New.remove(1));
iDiff = iSYF - iSYT;
if(iSYT > 0)
	dPercentDiff = (iDiff * 100d/iSYT);
else	

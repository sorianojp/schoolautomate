...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td colspan="4"><div align="center"><font style="font-size:13px; font-weight:bold;"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></font><br>
		 ...
		 Student Master List ( New Students Per College )<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td width="26%" align="center" class="thinborderTOPBOTTOM">Name</td>		
		<td width="12%" class="thinborderTOPBOTTOM">Course</td>
		<td width="6%" align="center" class="thinborderTOPBOTTOM">Year</td>		
		<td width="39%" align="center" class="thinborderTOPBOTTOM">Mailing Address/Zipcode</td>	
	</tr>

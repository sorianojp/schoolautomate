...
vRetResult = reportEnrl.getMailingListSWU(dbOP, request);
if(vRetResult == null)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td colspan="4"><div align="center"><font style="font-size:13px; font-weight:bold;"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></font><br>
		 ...
		 Student Master List ( Per College with Parents Name )<br>
...
int iStudCount = 1;
int iPageCount = 1;
int iTotalStud = (vRetResult.size()/24);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td width="5%" height="22" align="center" class="thinborderTOPBOTTOM">Seq #</td>
		<td width="9%" class="thinborderTOPBOTTOM">Student No</td>
		<td width="28%" align="center" class="thinborderTOPBOTTOM">Name</td>		
		<td width="9%" class="thinborderTOPBOTTOM">Course</td>
		<td width="5%" align="center" class="thinborderTOPBOTTOM">Year</td>
		 <td width="17%" align="center" class="thinborderTOPBOTTOM">Mother/Father</td>
		<td width="27%" align="center" class="thinborderTOPBOTTOM">Mailing Address/Zipcode</td>	
	</tr>
	...
	<tr>
	    ...
	    <td>
			...
			<%=WI.getStrValue((String)vRetResult.elementAt(i+18),"<br>","","")%> 
		</td>
		<td>&nbsp; 
		...
		<%=WI.getStrValue((String)vRetResult.elementAt(i+16),", &nbsp; &nbsp;","","")%>		</td>
	</tr>
	<%
	...
	<tr><td align="right" colspan="11" height="22">Page <%=iPageCount++%> of <%=iTotalPageCount%></td></tr>
</table>

...
if(WI.fillTextValue("course_index").length() > 0){
	strTemp = "select course_code, course_name from course_offered where course_index = "+WI.fillTextValue("course_index");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td colspan="4"><div align="center"><font style="font-size:13px; font-weight:bold;"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></font><br>
		 ...
		 Student Master List ( By Course and Year Level )<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td width="54%"> : <%=strCCode%></td>
	    <td width="33%">No. of Years : </td>
	</tr>
	<tr>
		<td width="3%" height="25">&nbsp;</td>

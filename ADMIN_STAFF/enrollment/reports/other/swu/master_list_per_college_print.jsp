...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td colspan="4"><div align="center"><font style="font-size:13px; font-weight:bold;"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></font><br>
		 ...
		 General Student Master List<br>
		  ...
		  Printed Date and Time : <%=WI.getTodaysDateTime()%><br>&nbsp;
	  </div></td>
    </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		<td width="7%" height="20" align="center" class="thinborderTOPBOTTOM">Seq #</td>
		...
		<td width="7%" align="center" class="thinborderTOPBOTTOM">Year</td>
		<td width="15%" align="center" class="thinborderTOPBOTTOM">Date Enrolled</td>		
	</tr>
	...
	%>
	<tr>
		<td height="17" align="center"><%=iStudCount++%>.</td>
	...
	<tr><td colspan="9"  height="17">&nbsp;</td></tr>
	<%}
	
	%>
	
	<tr><td align="right" colspan="9" height="22">Page <%=iPageCount++%> of <%=iTotalPageCount%></td></tr>
</table>

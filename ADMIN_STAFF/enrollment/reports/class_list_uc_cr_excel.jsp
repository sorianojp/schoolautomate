...
String strTemplateToUse = null;
	strTemplateToUse = "class_list_uc.xls";
	iRowsPerPg = 300;

	File fCopy = new File(strInstallDir+"uc/"+strTemplateToUse);
...
WTE.WriteClose();
%>
To Get the files go to C:/ApacheTomcat5.0.28/schoolautomate/download/

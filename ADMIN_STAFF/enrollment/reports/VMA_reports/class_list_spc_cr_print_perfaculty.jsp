...
while(vFacultySection.size() > 0) {
	...
	%>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			<tr>
				<td width="5%" class="" >&nbsp;</td>
				<td width="15%"  class=""><font color="#000000" size="1"><strong>ID Number </strong></font></td>
				<td width="15%"  class=""><font color="#000000" size="1"><strong>Student Name </strong></font></td>
				<td width="10%"  class=""><div align="center"><font color="#000000" size="1"><strong>Section</strong></font></div></td>
				<td width="12%" class="" align="center"><font color="#000000" size="1"><strong>Course-Yr</strong></font></td>
		    </tr>
		...
		<%}}%>
		 <tr>
			...
			<td class="" style="font-size:9px;"><%=(String)vRetResult.elementAt(i+1)%></td>
			...
			<td valign="bottom" align="center"><%=(String)vRetResult.elementAt(i+8)%><%=WI.getStrValue((String)vRetResult.elementAt(i+9), " - ", "","")%></td>
		</tr> 

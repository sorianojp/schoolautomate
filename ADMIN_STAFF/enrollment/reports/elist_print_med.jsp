...
Vector vRetResult = enrlReport.getEnrollmentListMed(dbOP,request);
...
int iCountSubj = 1;
	for (; i<vRetResult.size();){
		...
		if (vEnrlInfo != null && strCurrentGender == null){
			strCurrentGender = (String)vEnrlInfo.elementAt(2);
		}
%>
  ...
  <tr> 
    <td width="100%"><div align="center"> 
        <p><strong><%=SchoolInformation.getSchoolName(dbOP,true,false)%> </strong><br>
          ...
          <%}%>
          <br>
          Year level : <strong><%=astrConvertYr[Integer.parseInt(WI.getStrValue(WI.fillTextValue("year_level"),"0"))]%></strong>   
<% if (strCurrentGender!=null){%> - <%=WI.getStrValue(strCurrentGender,"")%><%}%>
...
<table width="100%" border="0" cellpadding="3" cellspacing="0">
  <tr valign="top"> 
	...
	if (strCurrentGender.compareTo((String)vEnrlInfo.elementAt(2)) != 0){
		--i;
		strCurrentGender = (String)vEnrlInfo.elementAt(2);
		bolChangeGender = true;
		break;
	}
...
%> 
	...
	<%=iStudCount++%>. <%=(String)vEnrlInfo.elementAt(1)%>  <br> 
	  ...
	  <%; }else{ bolShowPageBreak = true;break; } // // if iRequireRows > AvailableRows
	  } // vEnrlInfo !=null
	  } // upper for loop 
	  } // change Gender%>	
	 </td>
...
<%}//break oly if not at the last page.

...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Enrollment-Faculty","faculty_subj_list_load_update_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"faculty_subj_list_load_update_print.jsp");
if(iAccessLevel == -1)//for fatal error.
{
	dbOP.cleanUP();
	request.getSession(false).setAttribute("go_home","../ADMIN_STAFF/main%20files/admin_staff_home_button_content.htm");
...
<table width="100%" border="0" bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <td width="35%"><strong>&nbsp;<%=WI.getStrValue((String)vPersonalDetails.elementAt(16),"N/A")%></strong></td>
    </tr>
    <tr > 
      <td height="25">&nbsp;</td>  
      <td>College</td>
      
    <td><strong>&nbsp;<%=WI.getStrValue((String)vPersonalDetails.elementAt(13),"N/A")%></strong></td>
      <td>Employment Type</td>
      
    <td><strong>&nbsp;<%=WI.getStrValue((String)vPersonalDetails.elementAt(15),"N/A")%></strong></td>
    </tr>
    <tr > 
      <td height="24">&nbsp;</td>
      <td>Department</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    <td height="25" colspan="2"><div align="center"><strong>LIST OF SUBJECTS FACULTY 
        CAN TEACH FOR SEM <%=astrConvSem[Integer.parseInt(strSemester)]%>, SY <%=strSyFrom%> - <%=strSyTo%></strong></div></td>
  </tr>
  <tr> 

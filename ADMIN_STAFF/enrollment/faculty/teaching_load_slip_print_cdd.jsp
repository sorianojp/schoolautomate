...
if(strEmployeeIndex != null) {
	...
	if(vUserDetail == null)
		...
		if(vRetResult == null)
			...
			adWeekDayHour = FM.getFacultyLoadPerDay(dbOP, strEmployeeIndex,WI.fillTextValue("sy_from"),WI.fillTextValue("semester") );
		}
...
<%} 
 ...
 if(vRetResult != null && vRetResult.size() > 0){
	  for (int i = 0, k  =0; i< vRetResult.size();) { %>
			...
			<div style="border-bottom:1px solid #000000; border-top:1px solid #000000; font-weight:bold; padding:3px 0px 3px 0px;">	
			  ...
			  for(; i < vRetResult.size() ; i +=12, k++){
				...
				while(vTemp.size() > 0){
					...
					if(vDays.indexOf(strTemp) == -1)
						vDays.addElement(strTemp);				
				}*/
				...
				/*if(vDays.size() > 0)
					dTotalHour = dTotalHour/(double)vDays.size();
			 ...
			 //System.out.println(WI.fillTextValue("subj_sel_"+k));
...
<!----------------FOOTER------------------------->
<div style="padding:0px; width:100%; margin-bottom:20px;" align="center"><strong><font size="2">- RECOMMENDING APPROVALS -</font></strong></div>

<div style="padding:0px; width:100%;  margin-bottom:20px;">
					<div style="width:5%; float:left">&nbsp;</div>
					<div style="width:21%; float:left; border-top: solid 1px #000000;">Dean/Department Head</div>
					<div style="width:8%; float:left">&nbsp;</div>
					<div style="width:21%; float:left; border-top: solid 1px #000000;">Director for Academics</div>
					<div style="width:8%; float:left">&nbsp;</div>
					<div style="width:22%; float:left; border-top: solid 1px #000000;">MIS Administrator</div>
					<div style="width:5%; float:left">&nbsp;</div>
                  <div style="clear:both;"></div>    
</div>
...
<div style="margin:0px; padding:0px; width:100%; ">
					<div style="width:5%; float:left">&nbsp;</div>                    
					<div style="width:40%; float:left">Noted By: <strong>FELIZA ARZADON-SUA, Ed.D</strong><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; VP-Administration/Student Affairs</div>
                    <div style="width:40%; float:left">Approved By: <strong>VOLTAIRE P. ARZADON, Ph.D, ScD</strong>
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; President
                    </div>
                   <div style="clear:both;"></div>    

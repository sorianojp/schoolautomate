...
if(WI.fillTextValue("show_instructor").length() > 0) {
	bolShowInstructor = true;
	
}
if(WI.fillTextValue("show_subunit").length() > 0) {
	bolShowSubUnit = true;
...
<%}%>	  </td>
    ...
    <tr>
      <td height="25"></td>
      <td colspan="3">
	  <input type="checkbox" name="show_instructor" value="checked"<%=WI.fillTextValue("show_instructor")%>> Show Instructor 
	  <input type="checkbox" name="show_subunit" value="checked"<%=WI.fillTextValue("show_subunit")%>> Show Subject Unit </td>
    </tr>
    <tr> 
      <td height="25"></td>
      <td></td>
...
<%}%>
      <td class="thinborder"><%=(String)vTemp.elementAt(i+1)%>(<%=(String)vTemp.elementAt(i+2)%>)</td>
      <td class="thinborder"><%=WI.getStrValue(vTemp.elementAt(i+3),"&nbsp;")%>
	  <%if(WI.fillTextValue("remove_schedule").compareTo("1") != 0) {%>
...
<%}%>
      <td class="thinborder"><%=(String)vTemp.elementAt(i+1)%>(<%=(String)vTemp.elementAt(i+2)%>)</td>
      <td class="thinborder"><%=WI.getStrValue(vTemp.elementAt(i+3),"&nbsp;")%><font size="1"><strong>
        <%if(WI.fillTextValue("remove_schedule").compareTo("1") != 0) {%>
...
<%}%>
      <td class="thinborder"><%=(String)vTemp.elementAt(i+1)%>(<%=(String)vTemp.elementAt(i+2)%>)</td>
      <td class="thinborder" height="25"><%=WI.getStrValue(vTemp.elementAt(i+3),"&nbsp;")%><font size="1"><strong> 
        <%if(WI.fillTextValue("remove_schedule").compareTo("1") != 0) {%>
        </strong></font>:::<%=WI.getStrValue(vTemp.elementAt(i+7),"&nbsp;")%><font size="1"><strong> 
        <%}%>
        </strong></font></td>

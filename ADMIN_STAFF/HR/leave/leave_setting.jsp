...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR-leave-Leave Setting","leave_setting.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														"HR","LEAVE APPLICATION",request.getRemoteAddr(),
														"leave_setting.jsp");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborderALL">
    ...
    <tr>
      <td width="28%" height="18" nowrap class="thinborderLEFT">&nbsp;Allow update approved leaves </td>
      ...
      <td width="57%" height="18" class="thinborderRIGHT">
    	...
    	frameborder="0" id="iframetop" style="position:absolute"> </iframe>
			...
			<font size="1"><a href='javascript:UpdateProp("EDIT_APPROVED_LEAVE")'>			
      ...
      <td height="18" colspan="2" nowrap>
			<div id="3" style="position:absolute; visibility:hidden; width:auto;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFF99">
				<tr>
					<td width="90%"><strong>Leave crediting schedule options</strong></td>
					<td width="10%" align="center"><a href="javascript:ShowHideLabel('0');"><strong><font size="2" color="#FF0000">CLOSE</font></strong></a></td>
				</tr>
				</table>
			</div>	
        ...
        <select name="LEAVE_SCHEDULER">
          ...
          <%}%>
					<%if(strNextRundate == null || strNextRundate.length() == 0){%>
						...
						<option value="1" selected>Work Anniversary</option>
						<%}else{%>
						<option value="1">Work Anniversary</option>
						<%}
						}%>
					<%if(bolIsSchool){%>
						<%if (strLeaveCreditSched.equals("3")){%>
        ...
        <a href='javascript:ShowHideLabel("3")'><img src="../../../images/online_help.gif" width="34" height="26" border="0"></a>			  <font size="1"><a href='javascript:UpdateProp("LEAVE_SCHEDULER")'><img src="../../../images/update.gif" width="60" height="26" border="0">
			  </a></font></td>
    </tr>
		<tr>		
		...
		<%}%>
	 <tr>
      <td width="28%" height="18" class="thinborderLEFT">&nbsp;Has Leave interval</td>
      <td width="15%" nowrap>
				<% if (vRetResult != null) 
	 ...
	 <tr>
	   <td height="18" class="thinborderLEFT">&nbsp;Minimum leave hours </td>
	   <td nowrap><% if (vRetResult != null) 
						iIndex= vRetResult.indexOf("MINIMUM_LEAVE");
			   else 
				 		iIndex = -1;//System.out.println(vRetResult);
				 ...
				 if (iIndex != -1) {
						...
						vRetResult.removeElementAt(iIndex);
				 		...
				 		strTemp = WI.fillTextValue("MINIMUM_LEAVE");
				%>
	     <input name="MINIMUM_LEAVE" type= "text"  class="textbox" value="<%=strTemp%>"
		   onFocus="style.backgroundColor='#D3EBFF'" 
		   onBlur="style.backgroundColor='white';AllowOnlyIntegerExtn('form_','MINIMUM_LEAVE','.')" 
		   onKeyUp="AllowOnlyIntegerExtn('form_','MINIMUM_LEAVE','.')" size="5" maxlength="5">
      <a href='javascript:ShowHideLabel("2")'><img src="../../../images/online_help.gif" width="34" height="26" border="0"></a></td>
	   <td height="18" class="thinborderRIGHT"><font size="1"><a href='javascript:UpdateProp("MINIMUM_LEAVE")'><img src="../../../images/update.gif" width="60" height="26" border="0"></a></font></td>
	   </tr>		
  </table>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">

...
<form name="form_">
		...
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="thinborder">
			<tr> 
				<td height="21" colspan="4" align="center" class="thinborder"><strong>SUMMARY OF LEAVE </strong></td>
			</tr>
			<tr>
				<td width="32%" class="thinborder">&nbsp;</td> 
				<td width="38%" height="25" class="thinborder"><strong> &nbsp;Type 
					of Leave</strong></td>
				<td width="10%" align="center" class="thinborder"><strong>Available</strong></td>
				<td width="10%" align="center" class="thinborder"><strong>Consumed</strong></td>
			</tr>
	<%

...
Vector vAllowedLeave = hrPx.getAllSemestralAvailLeave(dbOP, request);
...
String[] astrNatureLeave = {"Sick Leave", "Maternity Leave", "Vacation Leave", 
							"Emergency Leave", "Paternity Leave", "Bereavement Leave",
							"Others"};							 
...
%>
    <td width="53%" valign="middle">COLLEGE/OFFICE : <strong><%=strTemp%> </strong></td>
  </tr>
  <tr bgcolor="#FFFFFF"> 
    <td valign="middle">&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    ...
    <td width="46%" rowspan="2" bgcolor="#FFFFFF"><strong>DATE 
      ...
      LEAVE APPLIED FOR : <br> <font size="3" color="#FF0000"> 
	  	...
	  	<%=astrNatureLeave[Integer.parseInt(WI.getStrValue((String)vEditResult.elementAt(45),"0"))]%>
  ...
  <tr> 
    ...
    <td width="49%" valign="top"> <% if (vAllowedLeave != null && vAllowedLeave.size() > 0) {
				String[] astrSemester = {"Summer", "1st Sem", "2nd Sem","3rd Sem",
										 "4th Sem"," WHOLE SY"};
			%> 
			<table width="85%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
                <% for(int i = 2 ; i < vAllowedLeave.size(); i+=2) {%>
                <tr> 
                  <td width="60%" class="thinborder">&nbsp;&nbsp;<strong>
			  			<%=astrSemester[Integer.parseInt(WI.getStrValue((String)vAllowedLeave.elementAt(i),"5"))]%>
				   </strong></td>
                  <td width="40%" height="25" align="right" class="thinborder"><strong><%=(String)vAllowedLeave.elementAt(i+1)%> hour(s)&nbsp;</strong></td>
                </tr>
                <%}%>
      </table>
              <%}else{%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="bottom"> 
    <td width="43%" height="44">Dean/Head: _________________________________</td>
  ...
  <tr valign="bottom"> 
    <td height="30"> Vice-President: _______________________________</td>
  ...
  <tr valign="bottom"> 
    <td height="25"> <p>President : __________________________________</p></td>
...
<table width="100%" border="0" cellpadding="5" cellspacing="0" class="thinborderALL">
		...
		if (WI.getStrValue((String)vEditResult.elementAt(32)).length() != 0) 
			strTemp = WI.getStrValue((String)vEditResult.elementAt(32)) + " : " +
					...
					astrConvertAMPM[Integer.parseInt(WI.getStrValue((String)vEditResult.elementAt(34),"0"))];
		else strTemp = "";
%>

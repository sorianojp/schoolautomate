...
//add security hehol.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR Management-Personnel","leave_schedule_update.jsp");
...
String strWithSchedule = WI.getStrValue(WI.fillTextValue("with_schedule"), "1");
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <td>
	   <select name="employee_category" onChange="ReloadPage();">          
		...
		<!--
		<%//if(strWithSchedule.equals("1") && strLeaveCreditSched.equals("3")){%>		
		<tr>
		  <td height="24">&nbsp;</td>
		  <td>Year of Leave </td>
			<%
				strTemp = WI.fillTextValue("search_year_default");
			%>
		  <td><select name="search_year_default">
				<option value="">ALL</option>
				<% if (strTemp.equals("0")){%>				
...
(enter office/dept's first few characters)</td>
    ...
    <tr>
      <td height="10">&nbsp;</td>
      <td colspan="2"><%
	if(strWithSchedule.compareTo("1") == 0) 
		strTemp = " checked";
	else	
		strTemp = "";	
%>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <%} //end for loop%>
    <!--
		<%//if(bolIsSchool && strLeaveCreditSched.equals("3")){%>
    <tr>
      <td height="32" colspan="7">Year of Leave(Default) : 
        <select name="year_of_leave">
          <option value="0">School Year</option>
          <%// if (strTemp.equals("1")){%>
          <option value="1" selected>Current Year</option>
          <%//}else{%>
		...
		-->
    <tr>
      <td height="32" colspan="7"><div id="1" style="position:absolute; visibility:hidden; width:auto;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFF99">
				<tr>
					<%
						strTemp = WI.getTodaysDate(12);
						strTemp = "01/01/" + (Integer.parseInt(strTemp) + 1);
					%>
					<td width="90%"><strong>1. If you are setting for employees whose leave crediting has already passed, set the Next Run Date for next year.<br>
					  <font size="1">
						Ex. Scheduled Leave Crediting : Every Jan 1 of the year.<br>
					    Date Today : <%=WI.getTodaysDate(1)%>
							<br>
							Next Run Date should be <%=strTemp%>
					    <br>
					  </font>
					2. If the scheduled leave crediting has not yet passed, just set the date when the leave credit will be updated next.<br>
					</strong></td>
					<td width="10%" align="center" valign="top"><a href="javascript:ShowHideLabel('0');"><strong><font size="2" color="#FF0000">CLOSE</font></strong></a></td>
				</tr>
				</table>
			</div>		
			<strong><a href="javascript:ShowHideLabel('1')">View Notes</a></strong></td>
    </tr>
    <tr>
      <td height="51" colspan="7"><strong><font color="#FF0000">
					Take caution in setting the dates in this page. This is a 1-time only setting for each employee. <br>
				Edit/delete is not made available.</font></strong></td>
    </tr>
    <tr>
      <td height="32" colspan="7" align="center">
				<%if(iAccessLevel > 1){
				if(!strWithSchedule.equals("1")){%>
				<!--

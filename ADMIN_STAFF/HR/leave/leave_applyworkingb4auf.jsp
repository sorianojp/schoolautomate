...
// with this combination this block will be run... otherwise skip.
  if((strTemp.equals("01245-08") || strTemp.equals("007")) 
	...
	//hrAuto.autoForwardInsertLeaves(dbOP, null, null);		
	}
...
vUsableLeaves = hrPx.getUsableLeavesForYear(dbOP, request);
...
%>
              <select name="avail_leave_index" onChange="ChangeLeave()" style="font-size:11px;">

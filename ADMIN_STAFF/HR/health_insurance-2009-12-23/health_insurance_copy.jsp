...
<form action="health_insurance_copy.jsp" method="post" name="form_">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr> 
			<td width="3%">&nbsp;</td>
			<td width="57%"><font size="2" color="#FF0000"><strong><%=WI.getStrValue(strErrMsg)%></strong></font></td>
			<td width="30%"><a href="health_insurance_tracking.jsp" ><img src="../../../../images/go_back.gif" border="0" align="right"></a></td>
			<td width="10%">&nbsp;</td>
		</tr>
		<tr>
			<td colspan="3">&nbsp;</td>
	...
	<table bgcolor="FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			...
			<%
				strTemp =  " from hr_health_insurance where is_valid = 1 order by year";

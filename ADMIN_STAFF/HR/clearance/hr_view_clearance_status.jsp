...
<%} if (vClearances != null &&  vClearances.size() > 0) {%>
  	...
  	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    	...
    	<tr bgcolor="<%=strTableColor%>">
			...
			<td class="thinborder"><font color="<%=strTextColor%>"><%=WI.getStrValue((String)vClearances.elementAt(i+1), "&nbsp;")%></font></td>
	...
	%>
	<tr> 
	  	<td height="20" colspan="8" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>LIST OF <%=strTemp%> ISSUED ITEMS</strong></div></td>
	</tr>
    <tr>
		<td width="7%"  height="23" class="thinborder">&nbsp;</td>

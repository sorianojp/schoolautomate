...
function GoOtherFormat() {
	location = "./hr_leave_summary2.jsp";
}
...
<form action="./hr_leave_summary.jsp" method="post" name="form_">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="5" align="center"  bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF" size="2" ><strong>:::: 
        HR : LEAVE SUMMARY ::::</strong></font></td>
    </tr>
    <tr> 
      <td height="25" colspan="5">&nbsp;&nbsp;<strong><%=WI.getStrValue(strErrMsg,"<font size=\"3\" color=\"#FF0000\">","</font>","")%></strong></td>
    </tr>
    <tr> 
      ...
      <td width="20%" align="right"><a href="javascript:GoOtherFormat()">Go to Other Format</a></td>
    </tr>
    <tr>
      <td height="25">&nbsp;Leave Type</td>
      <td height="25" colspan="4"><select name="leave_index">
      ...
      <img src="../../../images/print.gif" width="58" height="26" border="0"></a> 
        <font size="1">click to print result</font>&nbsp;</td>
			...
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="thinborder">
				<tr> 
					<td height="21" colspan="6" align="center" bgcolor="#F2EDE6" class="thinborder"><strong>SUMMARY OF LEAVE </strong></td>
				</tr>
				<tr style="font-weight:bold">
				  <td width="32%" class="thinborder">&nbsp;</td> 
					<td width="34%" height="25" class="thinborder"><strong> &nbsp;Type of Leave</strong></td>
					<td width="12%" align="center" class="thinborder">Leave Credit </td>
					<td width="12%" align="center" class="thinborder">Consumed</td>
					<td width="12%" align="center" class="thinborder">Available</td>
					<td width="10%" align="center" class="thinborder">View / Print</td>
				</tr>
				<% 
		...
		%>
				<tr> 
				 <td height="25" colspan="6" bgcolor="#E2EDF3" class="thinborder">

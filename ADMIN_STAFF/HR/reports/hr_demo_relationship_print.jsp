...
<br>
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      ...
      <td width="26%" align="center" class="thinborder"><font size="1"><strong>NAME</strong></font></td>
			<td width="11%" align="center" class="thinborder"><strong><font size="1">RELATION</font></strong> </td>			
      <%iIndex = 1;
				if (abolShowList[iIndex++]){%>	  
      <td width="11%" align="center" class="thinborder"><font size="1"><strong>BIRTHDATE</strong></font></td>
      <%}if (abolShowList[iIndex]){%>
      <td width="8%" align="center" class="thinborder"><strong><font size="1">AGE</font></strong></td>
      <%}%>
    </tr>
    <% 

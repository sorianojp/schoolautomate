...
if (WI.fillTextValue("show_results").compareTo("1") == 0){
	vRetResult = hrStat.getJrSrYrsInPostService(dbOP);
	if(vRetResult == null)
...
%>
<form action="./hr_jr_sr_demo_13_present_post.jsp" method="post" name="form_" >
...
<!--
      ...
      <a href="javascript:show_calendar('form_.cut_off_date');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../../images/calendar_new.gif" width="20" height="16" border="0"></a> !-->
...
<% if (vRetResult != null && vRetResult.size() > 0) {%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td height="25" colspan="2" bgcolor="#B9B292"><div align="center"><strong><font color="#FFFFFF">YEARS IN SERVICE </font></strong></div></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="2" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <% 	int k = 0;
       ...
       strTemp = WI.fillTextValue("cut_off_date");
		...
		if (i == 0 || !strCurrentHeadOffice.equals((String)vRetResult.elementAt(i+7))) {
		strCurrentHeadOffice = (String)vRetResult.elementAt(i+7);
	%> 
    <tr>
      <td height="25" colspan="5"  class="thinborder"><strong><%=strCurrentHeadOffice%></strong></td>
    </tr>
    <tr> 
      <td width="25%" height="25"  class="thinborder"> <div align="center"><strong>Name</strong></div></td>
      <td width="9%"  class="thinborder"><strong>Unit </strong></td>
      <td width="27%"  class="thinborder"><div align="center"><strong>Present Position</strong></div></td>
      <td width="19%"  class="thinborder"><div align="center"><strong>Years in <br>
      Present Position</strong> </div></td>
	  
      <td width="20%" class="thinborder"><div align="center"><strong>Years  of Service <br>
      at AUF </strong></div></td>
    </tr>
 <%}%> 
    <tr> 
      <td height="25" class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(i+1))%>
	  </td>

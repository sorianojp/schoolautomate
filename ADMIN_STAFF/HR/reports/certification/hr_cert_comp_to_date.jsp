...
<form name="form_" method="post" action="./hr_cert_comp_to_date.jsp">
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="header">
  ...
  <tr>
    ...
    <td width="17%" height="25">
		<input name="emp_id" type="text" value="<%=WI.fillTextValue("emp_id")%>" size="16" class="textbox" 
    ...
    <td width="61%"><input type="image" src="../../../../images/form_proceed.gif" width="81" height="21" border="0" onClick="ReloadPage()"><label id="coa_info"></label></td>
  </tr>
  <tr>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2"><font size="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to certify that <strong>
        ...
        </strong> is employed with <%=SchoolInformation.getSchoolName(dbOP,true,false)%> since
<% if ((String)vEmpRec.elementAt(6) != null) 
  ...
  <tr>
    ...
    <td align="center"><br />
        ...
        <strong><font size="3">
				...
				%>
<label id="signatory" 
		onclick="setLabelText('signatory','Signatory Name')"> 
		<%=WI.getStrValue(strTemp, "(Signatory Name)")%></label></font>
<font size="3"><br />
     <label id="position_" 

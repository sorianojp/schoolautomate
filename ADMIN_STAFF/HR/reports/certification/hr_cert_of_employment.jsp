...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
 ...
 <!--
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="../c_rank/hr_faculty_profile_acad_qualification.jsp">D.11a Certificate of Employment</a><a href="../c_rank/hr_list_licensure.jsp?show_all=1"> (With Service Record) </a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><p><a href="./hr_certification.jsp">D.11b Certificate of Employment</a></p>    </td>
  </tr>
 <!--
  <tr>
    <td height="25">&nbsp;</td>

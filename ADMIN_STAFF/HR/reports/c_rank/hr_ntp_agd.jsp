...
<%
	...
	<jsp:forward page="./hr_ntp_agd_print.jsp" />
<%	return;}	
try
	{
...
%>
<form action="./hr_ntp_agd.jsp" method="post" name="form_" >
...
if(strTemp.length() ==0)
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2" class="fontsize11">Department&nbsp; 
        <select name="d_index" >
          <option value=""> </option>
          <%=dbOP.loadCombo("d_index","d_name"," FROM department where IS_DEL = 0 and  " + 
                         "(c_index is null or c_index = 0) order by d_name",WI.fillTextValue("d_index"),false)%>
        </select></td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="25" colspan="5" align="center"><strong>LIST OF FULL-TIME NON-TEACHING PERSONNEL WITH MA's/Ph.D.'s<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr>
      ...
      <td width="15%" class="thinborder"> <div align="center">POSITION</div></td>
      <% 
	int iEduLeveIndex = 0;

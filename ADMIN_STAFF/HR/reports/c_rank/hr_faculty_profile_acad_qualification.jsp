...
<%
	...
	<jsp:forward page="./hr_faculty_profile_acad_qual_print.jsp" />
<%	return;}	
try
	{
...
%>
<form action="./hr_faculty_profile_acad_qualification.jsp" method="post" name="form_" >
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A" class="footerDynamic">
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF"><strong>:::: 
          FACULTY PROFILE ::::: </strong></font></div></td>
    </tr>
  </table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr>
      <td width="16%" height="25" class="thinborder"><div align="center">NAME OF FACULTY </div></td>
      <td width="10%" height="25" class="thinborder"><div align="center">STATUS </div></td>
...
%>
  ...
  <%}%>  
      <td width="12%" class="thinborder"><div align="center">RANK</div></td>
    </tr>	

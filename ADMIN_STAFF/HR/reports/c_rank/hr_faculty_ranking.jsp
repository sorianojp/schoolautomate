...
<%
	...
	<jsp:forward page="./hr_faculty_ranking_print.jsp" />
<%	return;}	
try
	{
...
if(strTemp.length() ==0)
	strTemp = (String)request.getSession(false).getAttribute("cur_sem");
      ...
      <td width="48%"><a href="javascript:showList()"%><img src="../../../../images/form_proceed.gif" width="81" height="21" border="0"></a></td>
    </tr>
  </table>
...
%> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr>
      <td width="22%" rowspan="2" class="thinborder"><div align="center"><strong><font size="2">COLLEGE</font></strong></div></td>
<% for (iIndex = 0; iIndex < iNumRanks ; iIndex++){ %> 
      ...
      <%}%> 
      <td width="10%" class="thinborder"><div align="center"><strong>TOTAL </strong></div></td>
    </tr>
    <tr>
<% for (iIndex = 0; iIndex < iNumRanks ; iIndex++){ %> 

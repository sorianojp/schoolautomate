...
<form name="form_" method="post" action="./hr_benefit_faculty_change_status_pres.jsp">
  ...
  <tr>
	...
	, a Faculty Member of 
     <label id="emp_position" 
			onclick="setLabelText('emp_position','Employee Position')"></label>
     <% 
...
%>
			<label id="office" 
				...
				<%=strTemp%></label>
			, has satisfactorily met the requirements prescribed by the University and by the Commision on Higher Education.<br /> <br />
       ...
       <label id="change_status" 
		onclick="setLabelText('change_status','Effective Semester of Change of Status')"> 
	  **set semester**</label>
       , Academic Year  
       <label id="acad_year" 
		onclick="setLabelText('acad_year','Effective Academic Year of Change of Status')"> 
  ...
  <tr>
    <td height="20"><em>      Faculty Screening Committee</em> </td>
...
&amp; Management Systems (Member) </strong></td>
  ...
  <tr>
    <td height="60" valign="bottom"><strong>VP for Academic Affairs (Chairman) </strong></td>
    <td valign="bottom" class="thinborderBOTTOM"><font size="2">
      <label id="vp_odms" 
		onclick="setLabelText('vp_odms','VP for Organizational Devt')">
			<%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"VP, Academic",7 ),"-click here-").toUpperCase()%></label>
    </font></td>
    <td>&nbsp;</td>
    <td class="thinborderBOTTOM">&nbsp;</td>
  </tr>

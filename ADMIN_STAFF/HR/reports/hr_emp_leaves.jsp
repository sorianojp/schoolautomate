...
function ViewPrintDetails(strInfoIndex, strEmpID, strSYFrom, strSYTo, strSemester, strMyHome){
	var pgLoc = "leave_details.jsp?info_index="+strInfoIndex+"&emp_id="+escape(strEmpID)+
	"&sy_from="+strSYFrom+"&sy_to="+strSYTo+"&semester="+strSemester+"&format_date=6&my_home="+strMyHome;
...
<%
	...
	if(WI.fillTextValue("print_page").equals("1")) {%>
		<jsp:forward page="./hr_emp_leaves_print.jsp" />		
	<%return;}
...
String[] astrSortByName    = {"ID #","Gender","Emp. Status","Emp. Type", strDivision, "Department"};
String[] astrSortByVal     = {"id_number","gender","user_status.status","HR_EMPLOYMENT_TYPE.EMP_TYPE_NAME","c_name","d_name"};
...
if(WI.fillTextValue("searchEmployee").equals("1")){
  ...
  if(vRetResult == null)
    strErrMsg = hrLeave.getErrMsg();
  else
    iSearchResult = hrLeave.getSearchCount();
}

String[] astrMonth = {" Select Month"," January"," February", " March", " April", " May", " June",
					  " July", " August", " September"," October", " November", " December"};

String strApplStat = null;
%>
<form action="./hr_emp_leaves.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="4" align="center" bgcolor="#A49A6A" class="footerDynamic"><font color="#FFFFFF"><strong>:::: 
      SUMMARY OF EMPLOYEES WITH LEAVES PAGE ::::</strong></font></td>
    </tr>
  </table>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    </select> <font size="1">(selecting a month will overwrite date(s) entry)</font>
	
	Leave Application Status: 
	<select name="leave_appl_status">
              <option value="1" selected>Approved</option>
<%
strApplStat = "Approved";
...
if(strTemp.equals("2")) {
	...
	strErrMsg = "";
%>
              <option value="2"<%=strErrMsg%>>Pending/On-process</option>
<%
if(strTemp.equals("0")) {
	strErrMsg = " selected";
	strApplStat = "Disapproved";
}
else	
	strErrMsg = "";
%>
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td class="fontsize11">Leave Type </td>
	  <%
	  	strTemp = WI.fillTextValue("leave_index");
	  %>
      <td>
	  <select name="leave_index" onChange="ReloadPage();">
		<option value="">ALL</option>	
		<%if(strTemp.equals("0")){%>		
	  	  <option value="0" selected>Leave Without Pay</option>		
		<%}else{%>
    ...
    <tr>
      ...
      <td width="80%">
				...
				<%=hrLeave.constructGenericDropList(WI.fillTextValue("id_number_con"),astrDropListEqual,astrDropListValEqual)%> 
				</select>
    ...
    <tr>
      ...
      <td><select name="lname_con">
          <%=hrLeave.constructGenericDropList(WI.fillTextValue("lname_con"),astrDropListEqual,astrDropListValEqual)%> </select>
    ...
    <tr> 
      ...
      <td><select name="fname_con">
          <%=hrLeave.constructGenericDropList(WI.fillTextValue("fname_con"),astrDropListEqual,astrDropListValEqual)%> </select>
		  ...
		  <td height="25">&nbsp;</td>
			<%
				...
				if(strTemp.length() > 0)
					...
					strTemp = "";
			%>
		  <td colspan="2"><input type="checkbox" name="view_all" value="1" <%=strTemp%> onClick="SearchEmployee();"> view all</td>
	  </tr>				
    <tr> 
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td width="25%"><select name="sort_by1">
          <option value="">N/A</option>
          <%=hrLeave.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by1_con">
...
if(WI.fillTextValue("sort_by1_con").compareTo("desc") ==0){%>
      ...
      <td width="24%"><select name="sort_by2">
          <option value="">N/A</option>
          <%=hrLeave.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by2_con">
          <option value="asc">Ascending</option>
          <%
if(WI.fillTextValue("sort_by2_con").compareTo("desc") ==0){%>
      ...
      <td width="40%"><select name="sort_by3">
          <option value="">N/A</option>
          <%=hrLeave.constructSortByDropList(WI.fillTextValue("sort_by3"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by3_con">
          <option value="asc">Ascending</option>
          <%
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  //if more than one page , constuct page count list here.  - 20 default display per page)
		int iPageCount = iSearchResult/hrLeave.defSearchSize;
		if(iSearchResult % hrLeave.defSearchSize > 0) ++iPageCount;
...
<select name="jumpto" onChange="SearchEmployee();">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr>
      ...
      <td width="18%" align="center" class="thinborder"><strong>Reason</strong></td>
      ...
      <td  width="9%" align="center"  class="thinborder"><font size="1"><strong>Date Filed</strong></font></td> 
      <td  width="9%" align="center"  class="thinborder"><font size="1"><strong>Application Status</strong></font></td>
    </tr>
    <%
    ...
    <tr>      
      ...
      <td class="thinborder">&nbsp;<%=strTemp%></td>
			<%
 			...
 			%>			
      <td class="thinborder"><%=strTemp%></td>			
      <td class="thinborder"><%=(String)vRetResult.elementAt(i + 19)%></td>
...
//			strTemp3 += strTemp2 + " day(s)";
	  ...
	  <td class="thinborder"><%=strTemp%><br><%=WI.getStrValue(strTemp3)%></td>
        ...
        <td class="thinborder"><%=strApplStat%></td>
    </tr>
    <%

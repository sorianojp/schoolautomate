...
<%
	...
	if(strTemp.length() > 0){
		if(eval.operateOnReviewPeriod(dbOP, request, Integer.parseInt(strTemp)) == null){
			strErrMsg = eval.getErrMsg();

		} else {
			if(strTemp.equals("0"))
				strErrMsg = "Rating period removed successfully";
			if(strTemp.equals("1"))
				strErrMsg = "Rating period recorded successfully";
			if(strTemp.equals("2"))
				strErrMsg = "Rating period updated successfully";
				
			strPrepareToEdit = "0";
		}
	}
	
	vRetResult = eval.operateOnReviewPeriod(dbOP, request, 4);
	if(strPrepareToEdit.equals("1")) {
		vEditInfo = eval.operateOnReviewPeriod(dbOP, request,3);
		if(vEditInfo == null)
			strErrMsg = eval.getErrMsg();
	}
%>
	...
	<table width="100%" bgcolor="FFFFFF" border="0" cellpadding="0" cellspacing="0">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="5" align="center" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: RATING PERIOD MANAGEMENT PAGE ::::</strong></font>			</td>
		</tr>
	</table>
	...
	<table width="100%" bgcolor="FFFFFF" border="0" cellpadding="0" cellspacing="0" class="thinborder">
		<tr bgcolor="#B9B292">
			<td height="28" colspan="4" align="center" class="thinborder">
				<strong>::: LIST OF RATING PERIODS CREATED ::: </strong></td>
		</tr>
		<tr>
			<td height="25" width="5%" align="center" class="thinborder"><strong>Count</strong></td>
			<td width="55%" align="center" class="thinborder"><strong>Title</strong></td>

...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR-Personnel Asset Management-Issued Asset Status","issued_asset_status.jsp");
	...
	int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,
													...
													"HR Management","Personnel Asset Management",request.getRemoteAddr(),
													"issued_asset_status.jsp");

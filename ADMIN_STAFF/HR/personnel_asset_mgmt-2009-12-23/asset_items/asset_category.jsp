...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR-Personnel Asset Management-Asset Category","asset_category.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(strPageAction.length() > 0){
		if(pam.operateOnAssetCategory(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
%>
<body bgcolor="#D2AE72" onLoad="document.form_.cat_code.focus()" onUnload="ReloadParentWnd();">

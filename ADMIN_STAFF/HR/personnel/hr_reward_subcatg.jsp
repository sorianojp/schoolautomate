...
<%	
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PERSONNEL-Education","hr_reward_subcatg.jsp.jsp");		
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	String strAwardIndex = WI.fillTextValue("awardIndex");
	if(strAwardIndex.length() == 0){%>
		<p align="center"> <font face="Verdana, Arial, Helvetica, sans-serif" size="3">Award type reference not found. Please close this window and click update button from main page.</font></p>
	<%
		return;
	}
	...
	if(strTemp.length() > 0){
		if(hrIRW.operateOnRewardSubCategory(dbOP, request, Integer.parseInt(strTemp)) == null)
			strErrMsg = hrIRW.getErrMsg();
		else{
			if(strTemp.equals("0"))
				strErrMsg = "Sub-category successfully removed.";
			else if(strTemp.equals("1"))
				strErrMsg = "Sub-category successfully recorded.";
			else if(strTemp.equals("2"))
				strErrMsg = "Sub-category successfully edited.";
			
			strPrepareToEdit = "0";
		}
	}
	
	vRetResult = hrIRW.operateOnRewardSubCategory(dbOP, request, 4);
	if(vRetResult == null)
		strErrMsg = hrIRW.getErrMsg();
	
	if(strPrepareToEdit.equals("1")){
		vEditInfo = hrIRW.operateOnRewardSubCategory(dbOP, request, 3);
		if(vEditInfo == null)
			strErrMsg = hrIRW.getErrMsg();
	}	
%>
<body bgcolor="#663300" onLoad="FocusID();" class="bgDynamic">
<form name="staff_profile" method="post" action="./hr_reward_subcatg.jsp">
	
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr> 
			<td height="25" colspan="3" align="center" bgcolor="#A49A6A" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: REWARD TYPE SUB-CATEGORY ::::</strong></font></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
		...
		<tr>
			...
			<td height="25">
				...
				<%}else{%>
					Not authorized to save reward type sub-category.
				<%}%></td>
		</tr>
		<tr>
			<td height="15" colspan="3">&nbsp;</td>
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
		<tr bgcolor="#B9B292">
			<td height="20" colspan="3" class="thinborder"><div align="center"><strong>::: LIST OF SUB-CATEGORIES :::</strong></div></td>
		</tr>
		<tr>
			<td height="25" width="5%" align="center" class="thinborder"><strong>Count</strong></td>
			<td width="75%" align="center" class="thinborder"><strong>Sub-Category Name</strong></td>
...
<%}%>
	...
	<input type="hidden" name="awardIndex" value="<%=strAwardIndex%>">

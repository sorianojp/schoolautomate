...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Personnel-Performance Evaluation","hr_personnel_perf_appraisal_tsuneishi_print.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
%>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			<td height="20">PREFORMANCE EVALUATION REPORT (TECHNICAL)</td>
		</tr>
	</table>
...
%>	
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td height="20" width="30%">Skill Level (start of evaluation): </td>
			<td width="7%" class="thinborderBOTTOM"><%=(String)vEditInfo.elementAt(3)%></td>
			<td width="34%">&nbsp;Target skill level (end of evaluation): </td>
			<td width="7%" class="thinborderBOTTOM"><%=(String)vEditInfo.elementAt(4)%></td>
			<td width="15%">&nbsp;Actual result: </td>
			<td width="7%" class="thinborderBOTTOM"><%=(String)vEditInfo.elementAt(5)%></td>
		</tr>
	</table>

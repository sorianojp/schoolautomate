...
<div align="center"><strong><%=SchoolInformation.getSchoolName(dbOP,true,false)%> </strong> <br>
	...
	<font size ="1"><%=WI.getStrValue(SchoolInformation.getInfo1(dbOP,false,false),"","<br>","")%></font><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="10%" height="25" valign="bottom">Name:      </td>
...
%>
          <tr> 
            <td height="25" class="thinBorder"><%=WI.getStrValue(strTemp)%><br> <%=WI.getStrValue(strTemp2)%><br> </td>
            <td align="center" class="thinBorder">&nbsp;<%=WI.getStrValue(strTemp3)%></td>
            <%
...
%>
            ...
            <td align="center" class="thinBorder"><%=WI.getStrValue(strTemp2,"&nbsp;")%></td>
            <td align="center" class="thinBorder"><%=WI.getStrValue(strTemp3,"&nbsp;")%></td>
          </tr>
          <% } // end for loop %>
  </table>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="thinBorder">
          ...
          <tr>
			...
			<td width="19%" align="center"  class="thinBorder">Relation</td>
			<td width="19%" align="center" class="thinBorder">Date of Birth </td>
			<td width="15%" align="center" class="thinBorder">Age</td>
			<td width="16%" align="center" class="thinBorder">Gender</td>
          </tr>
<%  for (int i = 0; i < vDependent.size(); i +=iDepSize){ 
...
<% for (int i = 0; i < vEmpHist.size() ; i+=16) { %>
          <tr>
            <td class="thinBorder"> <%=WI.getStrValue((String)vEmpHist.elementAt(i),"&nbsp;")%><br>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="thinBorder">
          ...
          <tr> 
            ...
            <td width="18%" align="center" class="thinBorder">Type / Budget </td>
            <td width="26%" align="center" class="thinBorder">Venue / Place </td>
            <td width="12%" align="center" class="thinBorder">Date</td>
          </tr>
          ...
          <tr> 
            ...
            <td class="thinBorder"><%=WI.getStrValue((String)vTrainings.elementAt(i+7),"&nbsp;") + 
				WI.getStrValue((String)vTrainings.elementAt(i+8)," to ", "","")%></td>
          </tr>
          <%} // end for loop %>
  </table>
<%} %>

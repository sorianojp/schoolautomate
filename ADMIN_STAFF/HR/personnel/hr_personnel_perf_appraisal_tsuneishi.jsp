...
<script language="javascript">
	...
	function ReloadTotal(){
		if(document.form_.factor_1){
			...
			var vFactor10 = document.form_.factor_10.value;
			if(vFactor10.length == 0)
				vFactor10 = 0;
			
			vTotal = eval(vFactor1) + eval(vFactor2) + eval(vFactor3) + eval(vFactor4) + eval(vFactor5) + 
					 eval(vFactor6) + eval(vFactor7) + eval(vFactor8) + eval(vFactor9) + eval(vFactor10);
	...
	function ViewDetails(strEvalIndex){
		var pgLoc = "./hr_personnel_technial_details.jsp?is_technical=1&is_view=1&info_index="+strEvalIndex;	
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Personnel-Notice of Action","hr_personnel_perf_appraisal_tsuneishi.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if (WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./hr_personnel_perf_appraisal_tsuneishi_print.jsp" />
	<% 
		return;}
...
<form action="hr_personnel_perf_appraisal_tsuneishi.jsp" method="post" name="form_">
...
<%if(vEmpRec != null && vEmpRec.size() > 0){%>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td align="center" class="thinborderBOTTOM" width="5%">20%</td>
			<td align="center" class="thinborderBOTTOM" width="5%">&nbsp;</td>
			<td align="center" class="thinborder" width="10%">Points</td>
			<td align="center" class="thinborder" width="10%">Rating</td>
		</tr>
			...
			<td class="thinborder" align="center">
				<%
					if(vEditInfo != null && vEditInfo.size() > 0)
						...
						strTemp = WI.fillTextValue("factor_10");
				%>
				<input type="text" name="factor_10" class="textbox" onFocus="style.backgroundColor='#D3EBFF'"
					onBlur="AllowOnlyFloat('form_','factor_10');ReloadTotal();style.backgroundColor='white'" value="<%=strTemp%>"
					onkeyup="AllowOnlyFloat('form_','factor_10')" size="5" maxlength="10" /></td>
			<td class="thinborder" align="center">
				<%
					if(vEditInfo != null && vEditInfo.size() > 0)
						strTemp = (String)vEditInfo.elementAt(26);
					else
						strTemp = WI.fillTextValue("rating_10");
				%>
				<input type="text" name="rating_10" class="textbox" value="<%=strTemp%>" size="5" maxlength="10"
					onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"/></td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td height="25" width="80%" align="right">Total Points: &nbsp;</td>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="6" bgcolor="#B9B292" class="thinborder" align="center">
				<div><strong>::: LIST OF TECHNICAL PERSONNEL EVALUATIONS ::: </strong></div></td>
		</tr>
		<tr> 
			...
			<td class="thinborderBOTTOM" colspan="2" height="25">&nbsp;
			<%

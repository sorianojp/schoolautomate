...
function CopyBenefitName(){
	if(document.form_.benefit_index.value)
	document.form_.benefit_name.value = document.form_.benefit_index[document.form_.benefit_index.selectedIndex].text;
}
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./sal_benefit_encode_restrict_print.jsp" />
	<% 
return;}
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(hrAuto.manageBenefitRestriction(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
<form action="sal_benefit_encode_restrict.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        HR: BENEFIT RESTRICTION PAGE ::::</strong></font></td>
    </tr>
</table>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="20%">Benefit Name </td>
			<%
				strTemp = WI.fillTextValue("benefit_index");
			%>
      <td width="77%" colspan="3">			
			<select name="benefit_index" onChange="CopyBenefitName();SearchEmployee();">
        ...
        <%=dbOP.loadCombo("BENEFIT_INDEX","BENEFIT_NAME,sub_type", " from hr_benefit_incentive " + 
			...
			" where is_del = 0 order by BENEFIT_NAME",
			strTemp,false)%>
      </select></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10">Civil Status</td>
			<%
			strTemp = WI.fillTextValue("cstatus");
			%>
      <td height="10" colspan="3"><select name="cstatus">
        <option value="">ALL</option>
        <% if (strTemp.equals("1")) {%>
    ...
    <tr>
      ...
      <td height="10">Gender</td>
			...
			%>
      <td height="10" colspan="3"><select name="gender">
        <option value="">ALL</option>
        <% if(strTemp.equals("0")){%>
...
View Employees not restricted from getting benefit </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="4">
...
<%} // end if pages > 1
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
			...
			%>
      <td height="20" colspan="4" bgcolor="#B9B292" class="thinborder"><div align="center"><strong><%=strTemp%></strong></div></td>
    </tr>
    <tr>
      <td width="7%" class="thinborder">&nbsp;</td>
      <td width="12%" class="thinborder">&nbsp;</td> 
      <td width="63%" height="23" align="center" class="thinborder"><strong><font size="1">EMPLOYEE NAME </font></strong></td>
      <td width="18%" align="center" class="thinborder"><font size="1"><strong>SELECT ALL<br>
        </strong>
...
<% } // end vRetResult != null && vRetResult.size() > 0 %>
  ...
  <input type="hidden" name="page_action">	
	<input type="hidden" name="benefit_name" value="<%=WI.fillTextValue("benefit_name")%>">	
</form>
</body>
</html>
<%

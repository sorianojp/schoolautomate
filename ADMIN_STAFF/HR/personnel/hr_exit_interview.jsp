<%@ page language="java" import="utility.*,java.util.Vector,hr.HRInfoExitInterview,hr.HRInfoServiceRecord,hr.HRLighthouse"%>
<%
...
function UpdateList(){
	var sT = "../exit_interview/update_notify_list.jsp?opner_form_name=staff_profile";
...
function UpdateExitIntvChecklist(strChecklistIndex){
	var sT = "../exit_interview/update_exit_intv_checklist.jsp?opner_form_name=staff_profile&checklist_index="+strChecklistIndex;
	var win=window.open(sT,"UploadPicture",'dependent=yes,width=700,height=700,top=200,left=100,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();
}
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr valign="top">
			...
			<td width="57%">
				<a href="javascript:viewInfo()"><img src="../../../images/form_proceed.gif" border="0"></a>&nbsp;
        ...
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <% if (vEditInfo != null)  
				...
				strTemp = WI.fillTextValue("effective"); %>
            <td>              
            <input name="effective" type="text" value="<%=strTemp%>" size="15" 
			onKeyUp="AllowOnlyIntegerExtn('staff_profile','effective','/')" class="textbox"  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" >
            <a href="javascript:show_calendar('staff_profile.effective');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a></td>
          </tr>
          <tr bgcolor="#DDDDDD"> 
            <td class="thinborderTOPLEFT">&nbsp;</td>
            <td class="thinborderTOPRIGHT"> <input type="text" name="starts_with2" value="<%=WI.fillTextValue("starts_with2")%>" size="16" class="textbox"
          ...
          <tr>
			...
			<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
              <tr bgcolor="#DDDDDD">
                <td width="26%" class="thinborderLEFT">Interviewed by </td>
...
if(vTemp != null && vTemp.size() > 0){
	...
	%>
		<tr bgcolor="#DDDDDD">
			<td height="15" class="thinborderBOTTOMLEFT">Date of Interview </td>
			<td width="25%" height="15" class="thinborderBOTTOM">
				<input name="date_interview" type="text" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
					onBlur="style.backgroundColor='white'" value="<%=strTemp%>" size="15"
					onKeyUP="AllowOnlyIntegerExtn('staff_profile','date_interview','/')" >
				<a href="javascript:show_calendar('staff_profile.date_interview');" title="Click to select date" 
					onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;">
				<img src="../../../images/calendar_new.gif" border="0"></a></td>
			<td width="49%" class="thinborderBOTTOMRIGHT">
<%if(iAccessLevel > 1) {%>
				<a href="javascript:AddInterviewer();">
					<img src="../../../images/add.gif" border="1"></a>
				<font size="1">Click to add  interviewer</font>
<%}%>
				</td>
		</tr>
		<%if(strSchCode.startsWith("LHS")){%>
		...
		<% if (vEditInfo != null) 
              ...
              <select name="nature_separation">
				<%for (int i = 0; i < astrNature.length; i++){
					if (astrNature[i].equals(strTemp)){ %>
          ...
          <tr> 
            ...
            <td width="97%" colspan="2" valign="bottom">Reason for Separation <br> 
              <% if (vEditInfo != null) strTemp = (String)vRetResult.elementAt(0);
                ...
                <%=dbOP.loadCombo("REASON_INDEX","EXIT_INTV_REASON"," FROM HR_PRELOAD_EXIT_INTV_REASON ",strTemp,false)%> </select> <strong> 
<%if(iAccessLevel > 1) {%>
				<a href='javascript:viewList("HR_PRELOAD_EXIT_INTV_REASON","REASON_INDEX","EXIT_INTV_REASON","MAJOR REASON",
              ...
              </strong><font size="1">click to update list</font> 
<%}%>
			  </td>
            <td width="1%" valign="bottom">&nbsp;</td>
          </tr>

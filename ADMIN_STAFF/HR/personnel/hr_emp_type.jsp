...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A" class="footerDynamic"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          EMPLOYMENT TYPES RECORDS PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
 ...
 %>
      <td width="3%">&nbsp;</td>
      <td width="20%" valign="middle">Employment Type</td>
      <td width="77%" valign="top">
	  	<%
			if (strSchCode.startsWith("AUF"))
				...
				strErrMsg = "40";
		%>		
	  	<input name="emp_type" type="text" class="textbox" value="<%=strTemp%>" size="<%=strErrMsg%>"
			onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <% if (strSchCode.startsWith("AUF")){%>
    <tr>
      <td>&nbsp;</td>
      <td valign="top">Employment Category </td>
      <td valign="top"><select name="emp_type_catg">
	...
	if(strTemp.compareTo("1") == 0) {%>
          ...
          <option value="3" selected> MANCOM</option>
		  <%}else{%>
          <option value="3"> MANCOM</option>
		  <%} if (strTemp.compareTo("4") == 0) {%>		  
		  <option value="4" selected> Consultant</option>
		  <%}else{%>
...
%>
      <td valign="top"><input name="position_order" type="text" class="textbox" id="position_order" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=strTemp%>" size="2">
        <font size="1">(set 1 as the highest..)</font></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2"> <% 
...
<table width="100%" height="25" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td colspan="5" bgcolor="#666666"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF EMPLOYMENT TYPES</font></strong></div></td>
    </tr>
</table>
...
<% if (strSchCode.startsWith("AUF")){%>
      <td width="23%"><font size="1"><strong>CATEGORY</strong></font></td>
<%}%>

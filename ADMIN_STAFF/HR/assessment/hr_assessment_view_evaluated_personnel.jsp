...
function ViewFormat(){
	var strEvaluationType     = document.form_.evaluation_type.value;
	...
	if(strEvaluationType == '2')
		loadPg = "hr_staff_peer_evaluation_print_sample.jsp";
	...
	function EvaluateStaff(strUserIndex, strIDNumber, strIsPrint, strEvalPersonnelIndex){
		...
		var strCriteriaIndex 	  = document.form_.criteria_index.value;
		var strSYFrom             = document.form_.sy_from.value;
		var strSYTo 			  = document.form_.sy_to.value;	
		var strEvalPeriodIndex 	  = document.form_.eval_period_index.value;
		...
		loadPg = loadPg+"?is_forwarded=1&cIndex="+strCriteriaIndex+
...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR-Assessment and Evaluation","hr_assessment_view_evaluated_personnel.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"hr_assessment_view_evaluated_personnel.jsp");
...
String[] astrSortByName    = {"ID #","Lastname","Firstname","Gender","Tenureship","Salary","Emp. Status","Emp. Type","AVG. RATING"};
String[] astrSortByVal     = {"id_number","lname","fname","gender","doe","SALARY_AMT","user_status.status",
								"HR_EMPLOYMENT_TYPE.EMP_TYPE_NAME","avg_point"};
...
if(WI.fillTextValue("searchEmployee").compareTo("1") == 0 && vEvalPeriod != null){
	vRetResult = ESExtn.getSummaryEvaluatedPersonnel(dbOP, request);
	if(vRetResult == null)
		strErrMsg = ESExtn.getErrMsg();
	else	{
		iSearchResult = ESExtn.getSearchCount();
		iElemCount = ESExtn.getElemCount();
	}
}

%>
<form action="./hr_assessment_view_evaluated_personnel.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="4" bgcolor="#A49A6A" class="footerDynamic"><div align="center"><font color="#FFFFFF"><strong>:::: 
          SEARCH DETAIL EVALUATION PAGE ::::</strong></font></div></td>
    </tr>
	</table>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td colspan="4"><select name="criteria_index" onChange="ReloadPage2();">
...
if(vEvalPeriod != null && vEvalPeriod.size() > 0) {%>
	<tr>
        ...
        <td colspan="4">
			<select name="evaluation_type" onChange='ReloadPage2();'>
			...
			<a href="javascript:ViewFormat();"><img src="../../../images/view.gif" border="0" height="25" width="40" align="absmiddle"></a>		</td>
    </tr>
    ...
    <tr> 
      ...
      <td width="9%"><select name="id_number_con">
          <%=ESExtn.constructGenericDropList(WI.fillTextValue("id_number_con"),astrDropListEqual,astrDropListValEqual)%> </select> </td>
...
if(WI.fillTextValue("gender").compareTo("1") == 0){%>
    ...
    <tr> 
      ...
      <td><select name="lname_con">
          <%=ESExtn.constructGenericDropList(WI.fillTextValue("lname_con"),astrDropListEqual,astrDropListValEqual)%> </select></td>
    ...
    <tr> 
      ...
      <td><select name="fname_con">
          <%=ESExtn.constructGenericDropList(WI.fillTextValue("fname_con"),astrDropListEqual,astrDropListValEqual)%> </select></td>
    ...
    <tr> 
      ...
      <td colspan="4"><select name="c_index" onChange="ReloadPage2();">
          <option value="">N/A</option>
          <%
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      ...
      <td width="25%"><select name="sort_by1">
          <option value="">N/A</option>
          <%=ESExtn.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by1_con">
...
if(WI.fillTextValue("sort_by1_con").compareTo("desc") ==0){%>
      ...
      <td width="24%"><select name="sort_by2">
          <option value="">N/A</option>
          <%=ESExtn.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by2_con">
          <option value="asc">Ascending</option>
          <%
if(WI.fillTextValue("sort_by2_con").compareTo("desc") ==0){%>
      ...
      <td width="40%"><select name="sort_by3">
          <option value="">N/A</option>
          <%=ESExtn.constructSortByDropList(WI.fillTextValue("sort_by3"),astrSortByName,astrSortByVal)%> </select> <br> <select name="sort_by3_con">
          <option value="asc">Ascending</option>
          <%
...
if(vRetResult != null && vRetResult.size() > 0){%>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="66%" ><b> TOTAL RESULT: <%=iSearchResult%> - Showing(<%=ESExtn.getDisplayRange()%>)</b></td>
      <td width="34%">
        <%
	  //if more than one page , constuct page count list here.  - 20 default display per page
		int iPageCount = iSearchResult/ESExtn.defSearchSize;
		if(iSearchResult % ESExtn.defSearchSize > 0) ++iPageCount;
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr> 
      ...
      <td width="5%" class="thinborder" align="center"><strong><font size="1">AVG. POINT</font></strong></td>
      <td width="5%" class="thinborder" align="center"><font size="1"><strong>VIEW DETAIL</strong></font></td>
    </tr>
    <%
...
for(int i = 0 ; i < vRetResult.size(); i +=iElemCount){%>
    <tr> 
      ...
      <td class="thinborder" align="center"><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i + 12),false)%></td>
      <td class="thinborder" align="center">
	  	<a href="javascript:EvaluateStaff('<%=vRetResult.elementAt(i)%>','<%=vRetResult.elementAt(i+1)%>',
			'1','<%=vRetResult.elementAt(i+13)%>');"><img src="../../../images/view.gif" border="0"></a>
	  </td>
    </tr>

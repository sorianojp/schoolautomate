...
<%
	...
	if(WI.fillTextValue("print_page").compareTo("1") == 0) {%>
		<jsp:forward page="./hr_assessment_viewall_summary_print.jsp" />		
	<%return;}
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR-Assessment and Evaluation","hr_assessment_viewall_summary.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"hr_assessment_viewall_summary.jsp");
...
if(WI.fillTextValue("searchEmployee").compareTo("1") == 0 && vEvalPeriod != null){
	vRetResult = hrES.operateOnEvalPersonnelDtls(dbOP, request, 5);
	if(vRetResult == null)
		strErrMsg = hrES.getErrMsg();
	else	
...
%>
<form action="./hr_assessment_viewall_summary.jsp" method="post" name="form_">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td colspan="4"><select name="criteria_index" onChange="ReloadPage();">
...
if(WI.fillTextValue("gender").compareTo("1") == 0){%>
    ...
    <tr> 
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" size="16"></td>
      <td>Avg. Points</td>
      <td><select name="avg_point" onChange='ShowHideOthers("avg_point","avg_pt_to","avg_pt_to_");'>
          <%=hrES.constructGenericDropList(WI.fillTextValue("avg_point"),astrDropListBetween,astrDropListValBetween)%> </select> 
		  <input type="text" name="avg_pt_fr" value="<%=WI.fillTextValue("avg_pt_fr")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" size="5"> 
        &nbsp;&nbsp;&nbsp; <input type="text" name="avg_pt_to" value="<%=WI.fillTextValue("avg_pt_to")%>" class="textbox" id="avg_pt_to_"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" size="5"></td>
    </tr>
    <script language="JavaScript">
ShowHideOthers("avg_point","avg_pt_to","avg_pt_to_");
</script>
    <tr> 
      <td height="24">&nbsp;</td>
...
if(vRetResult != null && vRetResult.size() > 0){%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr> 
      ...
      <%if(false){%><td width="5%" class="thinborder"><font size="1"><strong>VIEW DETAIL</strong></font></td><%}%>
    </tr>
    <%
...
for(int i = 0 ; i < vRetResult.size(); i +=13){%>
    <tr> 
      ...
      <%if(false){%><td class="thinborder">&nbsp;</td><%}%>
    </tr>

 ...
 if (vRetResult != null && vRetResult.size() > 0) { %>
  <table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      ...
      <td width="57%" class="thinborder">&nbsp;<%=strTemp%></td>
      <td width="5%" class="thinborder">&nbsp;
	  <input type="checkbox" value="1" name="checkbox<%=iCtr%>">	  </td>
    </tr>
    <%}%>
  </table>
...
<table width="100%" border="0" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#DBEEE0"> 
      <td height="25" colspan="4" align="center" class="thinborder"><strong>PERSONNEL MANDATORY  TRAINING ATTENDANCE </strong></td>
    </tr>
    <% 	String strCurrentTrainingIndex = "";

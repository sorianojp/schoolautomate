...
//System.out.println("strAdminID " + strAdminID);
  if(((strTemp.equals("01245-08") || strTemp.equals("007")) 
		...
		WI.getStrValue(strAdminID).equals("1770")){
...
<form action="./leave_apply.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <%}%>
		<%if(strLeaveScheduler.equals("0") || strLeaveScheduler.equals("2")){%>
    <tr> 
...
%> <select name="substitute">
          ...
          <tr> 
            <td height="25">&nbsp;</td>
						...
						%>
            <td colspan="2"><select name="leave_appl_status" onChange="UpdateReqStatus();">
...
Ignore Overlapping Dates </font></strong></td>
        ...
        <table width="100%" border="0" cellpadding="5" cellspacing="0">
          ...
          <tr> 
            <td height="25">&nbsp;</td>
            <td width="36%" height="25">
			<select name="head_approved" onChange="UpdateReqStatus();ToggleLayerVisibility();">
                <option value="2">Pending</option>
<% if (vEditResult != null)
		strTemp = WI.getStrValue((String)vEditResult.elementAt(28),"3");
	else
...
Not Authorized </td>
          ...
          <tr> 
            <td height="25">&nbsp;</td>
            <td height="25"> <select name="vp_approved" onChange="UpdateReqStatus();ToggleLayerVisibility();">
                <option value="3">Not Required</option>
<% if (vEditResult != null)
		...
		if (strTemp.equals("1")) {%>
          ...
          <tr> 
            ...
            <td height="25" valign="bottom"> 
						<select name="pres_approved"  onChange="UpdateReqStatus();ToggleLayerVisibility();">
                <option value="3">Not Required</option>
                <% if (vEditResult != null)

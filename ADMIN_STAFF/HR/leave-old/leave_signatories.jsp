...
function CancelRecord(){
	...
	location = "leave_signatories.jsp";
//	ClearFields();
//	document.form_.donot_call_close_wnd.value = "1";
//	document.form_.prepareToEdit.value = "";
//	document.form_.print_page.value="";
...
function ClearFields(){
	document.form_.donot_call_close_wnd.value = 1;
	location = "./leave_signatories.jsp?close_wnd_called=0&donot_call_close_wnd=1";
}
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR-LEAVE","leave_signatories.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	vRetResult = hrSignatories.operateOnLeaveSignatories(dbOP,request,4);
	if (vRetResult != null && strErrMsg == null){
		strErrMsg = hrSignatories.getErrMsg();	
	}	
%>
<form name="form_" method="post" action="./leave_signatories.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td width="100%" height="25" align="center" class="footerDynamic"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
        HR : LEAVE SIGNATORIES MANAGEMENT PAGE ::::</strong></font></td>
    </tr>    
    ...
    <tr>
      ...
      <td colspan="2">
        ...
        <%=dbOP.loadCombo("CATG_INDEX","CATG_NAME"," from manage_system_signatory_catg " +
				 " where CATG_INDEX in(101, 102, 100) order by CATG_NAME", strTemp, false)%>
      </select>
			</td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr bgcolor="#B9B292"> 
      ...
      LIST OF LEAVE SIGNATORIES ::</strong></font></td>
    </tr>
    <tr> 

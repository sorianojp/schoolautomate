...
<html>
<head>
<title>Leave Request Preload</title>
...
function CancelRecord(){
	...
	location = "leave_remarks_preload.jsp";
//	ClearFields();
//	document.form_.donot_call_close_wnd.value = "1";
//	document.form_.prepareToEdit.value = "";
//	document.form_.print_page.value="";
...
function ClearFields(){
	document.form_.donot_call_close_wnd.value = 1;
	location = "./leave_remarks_preload.jsp?close_wnd_called=0&donot_call_close_wnd=1";
}
...
function ReloadParentWnd() {
	...
	if(document.form_.close_wnd_called.value == "0") {
		window.opener.ChangeLeave();
		//window.opener.document.form_.ChangeLeave();
		//window.opener.document.form_.submit();
		window.opener.focus();
	}
}
...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-HR Management-LEAVE APPLICATION-Application","leave_remarks_preload.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if (strPrepareToEdit.length() > 0){
		vEditInfo = hrInfo.operateOnLeaveRemarks(dbOP,request,3);
		if (vEditInfo == null)
			strErrMsg = hrInfo.getErrMsg();
	}
	
	vRetResult = hrInfo.operateOnLeaveRemarks(dbOP,request,4);
	if (vRetResult != null && strErrMsg == null){
		strErrMsg = hrInfo.getErrMsg();	
	}	
%>
<form name="form_" method="post" action="./leave_remarks_preload.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td width="100%" height="25" align="center" class="footerDynamic"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
        HR : LEAVE REQUEST REMARKS MANAGEMENT PAGE ::::</strong></font></td>
    </tr>    
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <%
	  	if(vEditInfo != null && vEditInfo.size() > 0)
			...
			%>
      <td width="80%"><input name="request_remarks" type="text" size="32" maxlength="64" value="<%=WI.getStrValue(strTemp,"")%>" class="textbox"
	   onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <tr>
      <td height="24">&nbsp;</td>
      <td height="24">Leave type  </td>
      <%
	  	if(vEditInfo != null && vEditInfo.size() > 0)
				strTemp = ((Long)vEditInfo.elementAt(2)).toString();
			else
					strTemp = WI.fillTextValue("benefit_index");
			%>
      <td height="24"><select name="benefit_index">
	...
	<%if (iAccessLevel > 1) { %>
    <tr> 
      <td height="38" colspan="3" align="center"><%if(strPrepareToEdit.compareTo("1") != 0) {%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr bgcolor="#B9B292"> 
      ...
      LIST OF LEAVE REQUEST REMARKS ::</strong></font></td>
    </tr>
    <tr> 
      <td width="39%" height="25" align="center" class="BorderBottomLeft"><strong><font size="1">REMARKS</font></strong></td>
      <td width="34%" align="center" class="BorderBottomLeft"><strong><font size="1">APPLICABLE LEAVE TYPE </font></strong></td>
    ...
    <tr> 
      ...
      <td height="25" class="BorderBottomLeft">&nbsp;<%=strTemp%></td>
			<%
				...
				strTemp = WI.getStrValue(strTemp,"Leave w/out pay");

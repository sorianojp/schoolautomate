...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    ...
    <td width="49%" valign="top"> <% if (vAllowedLeave != null && vAllowedLeave.size() > 0) {%> <table width="80%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
        <% for(int i = 0 ; i < vAllowedLeave.size(); i+=3) {%>
        <tr> 
          <td width="70%" class="thinborder">&nbsp;<%=(String)vAllowedLeave.elementAt(i+1)%></td>
          <td width="30%" height="20" align="right" class="thinborder">&nbsp;<strong><%=CommonUtil.formatFloat(((Double)vAllowedLeave.elementAt(i+2)).doubleValue(),false)%> day(s)&nbsp;</strong></td>
        </tr>
        <%}%>
      </table>
      <%}else{%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr valign="bottom"> 
    <td width="43%" height="44">Dept Head: _________________________________</td>

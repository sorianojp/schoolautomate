...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Clearance-Clearance Status Print","hr_view_clearance_status_print.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<%} if (vClearances != null &&  vClearances.size() > 0) {%>
  	...
  	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
    	...
    	<tr>
			...
			<td class="thinborder"><%=(String)vClearances.elementAt(i+1)%></td>
			<td class="thinborder">
	...
	%>
	<tr> 
	  	<td height="20" colspan="9" class="thinborder"><div align="center"><strong>LIST OF <%=strTemp%> ISSUED ITEMS</strong></div></td>
	</tr>
    <tr>

...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Clearance-Post Clearance","hr_clearance_post.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<%if(vRetResult!=null && vRetResult.size() > 0 && 
	...
	<tr>
		...
		<input name="posted_by" type="text" size="16" value="<%=WI.fillTextValue("posted_by")%>" class="textbox"
			...
			<a href="javascript:OpenSearch();"><img src="../../../images/search.gif" width="37" height="30" border="0"></a>		</td>
	    <td>&nbsp;<label id="posted_by_"></label></td>
	</tr>
	<tr>
		<td height="25">&nbsp;</td>
		<td>Date Posted*</td>
		...
		%>
		<td colspan="3"><input name="date_posted" type="text" size="16" maxlength="10" readonly="yes" value="<%=strTemp%>" 
			class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">		  &nbsp; <a href="javascript:show_calendar('form_.date_posted');" title="Click to select date" 

...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Clearance-Clear Clearance","hr_clearance_clear.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(vUserInfo == null)
		...
		if(strPageAction.length() > 0){
			if(hrc.OperateOnClearClearance(dbOP, request, Integer.parseInt(strPageAction), (String)vUserInfo.elementAt(0)) == null){

...
<body bgcolor="#D2AE72" class="bgDynamic">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr bgcolor="#A49A6A" class="footerDynamic">
			<td height="25" colspan="2" bgcolor="#A49A6A" class="footerDynamic"><div align="center"><font color="#FFFFFF" >
				<strong>:::: PERSONNEL ASSET MANAGEMENT PAGE ::::</strong></font></div>
			</td>
		</tr>
	</table>	
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
		  ...
		  <td>&nbsp;</td>
		  <td height="25"  align="center">&nbsp;</td>
		  <td><a href="issued_assets_status/employee_history.jsp">Employee History </a></td>
	  </tr>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td height="25"  align="center">&nbsp;</td>
		  <td><a href="search_item.jsp">Search Item </a></td>
	  </tr>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td height="25"  align="center">&nbsp;</td>
		  <td><a href="update_item_status.jsp">Update Item Status </a></td>
	  </tr>
	</table>

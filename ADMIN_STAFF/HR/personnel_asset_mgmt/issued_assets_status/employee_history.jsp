...
<%
	...
	if (WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./employee_history_print.jsp" />
	<% 
		return;}
...
<form action="./employee_history.jsp" method="post" name="form_">
  <table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="3" bgcolor="#A49A6A" class="footerDynamic" align="center">
	  	<font color="#FFFFFF" ><strong>:::: VIEW EMPLOYEE ISSUED ITEM HISTORY ::::</strong></font></td>
    </tr>
    <tr>
      <td width="3%">&nbsp;</td>
      <td width="74%"><strong><font size="2" color="#FF0000"><%=WI.getStrValue(strErrMsg)%></font></strong></td>
      <td width="23%"><a href="../pam_main.jsp" ><img src="../../../../images/go_back.gif" border="0" align="right"></a></td>
    </tr>
  </table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
	<tr> 
	  	<td height="20" colspan="8" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>EMPLOYEE ISSUED ITEM HISTORY </strong></div></td>
	</tr>
    <tr>
    ...
    <tr bgcolor="<%=strTableColor%>">
    	...
    	<td class="thinborder"><font color="<%=strTextColor%>"><%=(String)vRetResult.elementAt(i)%></font></td>
     	<td class="thinborder"><font color="<%=strTextColor%>"><%=vRetResult.elementAt(i+6)%></font></td>
      	<td class="thinborder"><font color="<%=strTextColor%>">
		<%=WebInterface.formatName((String)vRetResult.elementAt(i+2),(String)vRetResult.elementAt(i+3),(String)vRetResult.elementAt(i+4),7)%></font></td>
		<%					
				strErrMsg = (String)vRetResult.elementAt(i+1);

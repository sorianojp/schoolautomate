...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Personnel Asset Management-Asset Brand","asset_brand.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(strTemp.length() > 0){
		if(pam.operateOnAssetBrand(dbOP, request, Integer.parseInt(strTemp)) == null){
...
%>
<body bgcolor="#D2AE72" class="bgDynamic" onLoad="document.form_.brand_name.focus()" onUnload="ReloadParentWnd();">
<form action="./asset_brand.jsp" method="post" name="form_">
	<table width="100%" bgcolor="FFFFFF" border="0" cellpadding="0" cellspacing="0">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="5" align="center" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: PERSONNEL ASSET MANAGEMENT: BRAND REGISTRY PAGE ::::</strong></font>
			</td>
		</tr>
		<tr>

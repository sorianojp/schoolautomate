...
<html>
<head>
<title>Human Resource Welcome Page</title>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#999966" class="footerDynamic"> 
      <td height="25" colspan="3"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          HUMAN RESOURCE MANAGEMENT PAGE::::</strong></font></div></td>
    </tr>
    <tr > 
...
<%}else{%>
    <tr > 
      <td height="25" colspan="3"><div align="center"><strong><font size="3" face="Verdana, Arial, Helvetica, sans-serif">WELCOME 
          <%=strName.toUpperCase()%> TO THE HUMAN RESOURCE MANAGEMENT PAGE!</font></strong></div></td>
    </tr>
    <tr > 
      <td height="25" colspan="3">&nbsp;</td>
    </tr>

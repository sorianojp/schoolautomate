...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Health Insurance Management-Health Insurance Application","health_insurance_application.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(strTemp.length() > 0){
		if(hriTracker.operateOnHealthInsuranceTracking(dbOP, request, Integer.parseInt(strTemp)) == null){
...
<form action="health_insurance_application.jsp" method="post" name="form_">
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="25">&nbsp;</td>
		    <td height="25" colspan="4"><font size="2" color="#FF0000"><strong><%=WI.getStrValue(strErrMsg)%></strong></font></td>
		    <td width="17%"><a href="health_insurance_tracking.jsp" ><img src="../../../images/go_back.gif" border="0" align="right"></a></td>
		</tr>
		<tr> 
			<td height="25">&nbsp;</td>
			<td>Year</td>
		...
		<tr> 
		    ...
		    <td height="10" colspan="3" valign="middle"><label id="coa_info"></label>&nbsp;</td>
	    </tr>
		<tr> 
		...
		<tr>
			...
			<td height="10" colspan="5">
				...
				<input type="text" name="check_balance_field" value="<%=strTemp%>" class="textbox" size="16" 
					...
					onBlur="AllowOnlyFloat('form_','check_balance_field');style.backgroundColor='white'">			</td>
		</tr>
		<tr>
			<td height="10">&nbsp;</td>
			<td height="10" colspan="5">&nbsp;</td>

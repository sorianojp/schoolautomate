...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Health Insurance Management-Health Insurance Details","health_insurance_details.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<form action="health_insurance_details.jsp" method="post" name="form_">
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr> 
			...
			<td width="7%"><a href="health_insurance_tracking.jsp"><img src="../../../images/go_back.gif" border="0" align="right"></a></td>
		</tr>
	</table>

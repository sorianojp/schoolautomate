...
<body bgcolor="#D2AE72" class="bgDynamic" onLoad="document.form_.amount.focus()" onUnload="ReloadParentWnd();">
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
			"Admin/staff-HR Management-Health Insurance Management-Health Insurance Details Update","health_insurance_dtls_update.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<form name="form_" method="post" action="health_insurance_dtls_update.jsp">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A">
		  	<td height="25" colspan="5" bgcolor="#A49A6A" align="center" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: HEALTH INSURANCE DETAILS PAGE ::::</strong></font></td>
		</tr>
	</table>

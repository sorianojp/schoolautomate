...
<%
	...
	String strTemp = null;
	try {
		dbOP = new DBOperation(strUserID,"SMS-inquiry-Keywords","inquiry_keyword.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(systemSetup.operateOnAllowedCommand(dbOP, request, Integer.parseInt(strTemp)) == null) 
...
if(strPreparedToEdit.equals("1"))
	vEditInfo = systemSetup.operateOnAllowedCommand(dbOP, request, 3);
vRetResult = systemSetup.operateOnAllowedCommand(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null) 
	strErrMsg = systemSetup.getErrMsg();
%>
<form action="./inquiry_keyword.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
    <tr>
      <td height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>:::: Inquiry Keyword Listing::::</strong></font></div></td>
    </tr>
    <tr> 
...
<%if(false){%>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2" style="font-weight:bold; color:#FF0000; font-size:15px">Must Read  : Only System provider of SMS Service should Add Inquiry Keyword. </td>
    </tr>
    <tr>
...
%>
	  <input type="text" name="code" value="<%=strTemp%>" class="textbox" style="font-size:11px;" size="64"
...
%>
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td>Inquiry Sample </td>
      <td>
<%
if(vEditInfo != null) 
	strTemp = (String)vEditInfo.elementAt(3);
else
	strTemp = WI.fillTextValue("command_sample");
%>
      <input type="text" name="command_sample" value="<%=strTemp%>" class="textbox" style="font-size:11px;" size="124"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" maxlength="256"></td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
...
if(vRetResult != null && vRetResult.size() > 0){%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="15%" height="25" align="center" style="font-size:9px; font-weight:bold;">Inquiry Code </td>
      <td width="30%" align="center" style="font-size:9px; font-weight:bold;">Description </td>
      <td width="40%" style="font-size:9px; font-weight:bold;" align="center">Sample Inquiry </td>
<%if(false){%>
      <td width="7%" style="font-size:9px; font-weight:bold;" align="center">Edit</td>
      <td width="8%" style="font-size:9px; font-weight:bold;" align="center">Delete</td>
<%}%>
    </tr>

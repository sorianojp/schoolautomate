...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="29"><div align="center"><strong>BUILDINGS AND BUILDING IMPROVEMENTS</strong></div></td>
    </tr>
  </table>
	<%if(vBuildings != null && vBuildings.size() > 0){%>	
  <table width="100%" border="0" cellpadding="1" cellspacing="0"  bgcolor="#FFFFFF">
    <tr bgcolor="#FFFFFF">
      <td height="25" colspan="4" ><strong><font size="2">A. </font>BUILDINGS</strong></td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td ><%=WI.getStrValue((String)vBuildings.elementAt(i),""," - ","")%> <%=WI.getStrValue((String)vBuildings.elementAt(i+1),"")%></td>
      <%
  ...
  <table width="100%" border="0" cellpadding="1" cellspacing="0"  bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td width="61%" height="20" >&nbsp;<%=WI.getStrValue((String)vAdditional.elementAt(i),"","-","")%> 
        <%=WI.getStrValue((String)vAdditional.elementAt(i+1),"")%></td>
	  <%

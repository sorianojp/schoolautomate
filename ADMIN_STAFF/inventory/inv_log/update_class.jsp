...
function FocusID() {
	document.form_.classification.select();
	//alert("I am here.");
	document.form_.classification.focus();	
}
</script>
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-INVENTORY-INV_LOG-Update Item","update_class.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(WI.fillTextValue("pageAction").length() > 0){
		vRetItem = InvLog.operateOnPreloadClass(dbOP,request,Integer.parseInt(WI.fillTextValue("pageAction")));
		if(vRetItem == null){
	...
	vRetResult = InvLog.operateOnPreloadClass(dbOP,request,4);
%>
<form action="./update_class.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: UPDATE  CLASSIFICATION PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="2%">&nbsp;</td> 
      <td valign="top">Classification Name</td>
      <td valign="top"> 
	  <%if(WI.fillTextValue("pageAction").equals("3"))
		  	strTemp = (String)vRetItem.elementAt(1);
		else if(WI.fillTextValue("classification").length() > 0)
			strTemp = WI.fillTextValue("classification");	
		else
			strTemp = "";
	  %> 
	  <input name="classification" type="text" value="<%=strTemp%>" size="32" maxlength="32" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onblur='style.backgroundColor="white"'></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	<tr> 
      <td colspan="4" bgcolor="#666666" class="thinborder"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF  </font><font color="#FFFFFF">CLASSIFICATIONS</font></strong></div></td>
    </tr>
    <tr align="center"> 
      <td width="10%" class="thinborder"><strong>COUNT</strong></td>
      <td width="70%" class="thinborder"><strong>CLASSIFICATION</strong></td>

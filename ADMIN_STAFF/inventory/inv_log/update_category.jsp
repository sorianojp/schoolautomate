...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-INVENTORY-INV_LOG-Update Item","update_category.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(WI.fillTextValue("pageAction").length() > 0){
		vRetItem = InvLog.operateOnPreloadCategory(dbOP,request,Integer.parseInt(WI.fillTextValue("pageAction")));
		if(vRetItem == null){
	...
	vRetResult = InvLog.operateOnPreloadCategory(dbOP,request,4);
%>
<form action="./update_category.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          ...
          CATEGORY PAGE ::::</strong></font></div></td>
    </tr>
	<%}else if(WI.fillTextValue("is_supply").equals("1")) {%>
	<tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          UPDATE SUPPLY CATEGORY PAGE ::::</strong></font></div></td>
    </tr>
	<%}else if(WI.fillTextValue("is_supply").equals("2")) {%>
	<tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: UPDATE CHEMICALS CATEGORY PAGE ::::</strong></font></div></td>
    </tr>
	<%}%>
    <tr> 
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
	  ...
	  <%if(WI.fillTextValue("pageAction").equals("3"))
		...
		else if(WI.fillTextValue("category").length() > 0)
			strTemp = WI.fillTextValue("category");	
		else
			strTemp = "";
	  %> 
	  <input name="category" type="text" value="<%=strTemp%>" size="32" maxlength="32" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onblur='style.backgroundColor="white"'></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	...
	<tr> 
      <td colspan="4" bgcolor="#666666" class="thinborder"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF NON-SUPPLY CATEGORIES</font></strong></div></td>
    </tr>
	<%}else{%>
	<tr> 
      <td colspan="4" bgcolor="#666666" class="thinborder"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF SUPPLY </font></strong><strong><font color="#FFFFFF">CA</font></strong><strong><font color="#FFFFFF">TEGORIES</font></strong></div></td>
    </tr>
	<%}%>
    <tr align="center"> 
      <td width="10%" class="thinborder"><strong>COUNT</strong></td>
      <td width="70%" class="thinborder"><strong>CATEGORY</strong></td>
      <td colspan="2" class="thinborder"><strong>OPTION</strong><strong></strong></td>
    </tr>
    <% for (int iLoop =0; iLoop < vRetResult.size() ; iLoop+=3){ %>
    <tr> 
      <td height="25" class="thinborder"><div align="center"><%=(iLoop+3)/3%></div></td>
      <td class="thinborder"><%=(String)vRetResult.elementAt(iLoop+1)%></td>
      <td colspan="2" class="thinborder">
			<%if(((String)vRetResult.elementAt(iLoop+2)).equals("0")){%>
	      <div align="center"><a href = "javascript:PageAction(3,<%=(String)vRetResult.elementAt(iLoop)%>,'');"> 
	        <img src="../../../images/edit.gif" border="0"></a> 
					<a href="javascript:PageAction(0,<%=(String)vRetResult.elementAt(iLoop)%>,
																					'<%=(String)vRetResult.elementAt(iLoop+1)%>');">

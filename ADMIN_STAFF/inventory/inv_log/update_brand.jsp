...
function FocusID() {
	document.form_.brand.select();
	//alert("I am here.");
	document.form_.brand.focus();	
}
</script>
...
//add security here.
	...
	if(WI.fillTextValue("pageAction").length() > 0){
		vRetItem = InvLog.operateOnPreloadBrand(dbOP,request,Integer.parseInt(WI.fillTextValue("pageAction")));
		if(vRetItem == null){
	...
	vRetResult = InvLog.operateOnPreloadBrand(dbOP,request,4);
%>
<form action="./update_brand.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: UPDATE  BRAND PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
      <td height="50"><font size="3">&nbsp;&nbsp;&nbsp;<strong><%=WI.getStrValue(strErrMsg)%>
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
	  ...
	  <%if(WI.fillTextValue("pageAction").equals("3"))
		...
		else if(WI.fillTextValue("brand").length() > 0)
			strTemp = WI.fillTextValue("brand");	
		else
			strTemp = "";
	  %> 
	  <input name="brand" type="text" value="<%=strTemp%>" size="32" maxlength="32" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onblur='style.backgroundColor="white"'></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	<tr> 
      <td colspan="4" bgcolor="#666666" class="thinborder"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF  </font><font color="#FFFFFF">BRANDS</font></strong></div></td>
    </tr>
    <tr align="center"> 
      <td width="10%" class="thinborder"><strong>COUNT</strong></td>
      <td width="70%" class="thinborder"><strong>BRAND</strong></td>

...
<%
	...
	DBOperation dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"INVENTORY-INVENTORY LOG","search_component.jsp");
	...
	String[] astrSortByName    = {"Property Number","College","Department","Building","Room"};
	String[] astrSortByVal     = {"prop_num", "c_code", "d_name","bldg_name","room_number"};

	if(WI.fillTextValue("executeSearch").compareTo("1") == 0){
	vRetResult = InvSearch.searchComponent(dbOP, request);
	if(vRetResult == null)
...
<body bgcolor="#D2AE72">
<form action="./search_component.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          COMPONENT MAINTENANCE: PROPERTY SEARCH PAGE::::</strong></font></div></td>
    </tr>
</table>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="25%"> <select name="sort_by1">
          <option value="">N/A</option>
          <%=InvSearch.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%> </select> <select name="sort_by1_con">
      ...
      <td width="24%"><select name="sort_by2">
          <option value="">N/A</option>
          <%=InvSearch.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%> </select> <select name="sort_by2_con">
          <option value="asc">Ascending</option>
      ...
      <td width="29%"><select name="sort_by3">
          <option value="">N/A</option>
          <%=InvSearch.constructSortByDropList(WI.fillTextValue("sort_by3"),astrSortByName,astrSortByVal)%> </select> <br/> <select name="sort_by3_con">
          <option value="asc">Ascending</option>
    ...
    <tr> 
      <td height="25" colspan="6"><div align="center"><a href="javascript:SearchNow();"><img src="../../../images/form_proceed.gif" border="0"></a></div></td>
    </tr>
  </table>
<%if(vRetResult!=null && vRetResult.size()>0){%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"  class="thinborder">
    ...
    <tr> 
      ...
      <td width="22%" class="thinborder" align="center"><font size="1"><strong>ITEM 
        DETAILS</strong></font></td>
      <td width="20%" class="thinborder" align="center"><font size="1"><strong>OWNERSHIP</strong></font></td>
      <td width="20%" class="thinborder" align="center"><font size="1"><strong>LOCATION</strong></font></td>
      <td width="14%" class="thinborder" align="center"><font size="1"><strong>ITEM 
        STATUS </strong></font></td>
      <td width="16%" class="thinborder" align="center"><font size="1"><strong>OTHER 
        DETAILS</strong></font></td>
    </tr>
    ...
    <tr> 
      ...
      <td class="thinborder"><font size="1">
	      <%=WI.getStrValue((String)vRetResult.elementAt(i+14),"CPU Prop #: ","<br>","")%>
		  <%=WI.getStrValue((String)vRetResult.elementAt(i+3),"Building: ","<br>","")%>
		  <%=WI.getStrValue((String)vRetResult.elementAt(i+4),"Room: ","<br>","")%>
		  <%=WI.getStrValue((String)vRetResult.elementAt(i+9),"Description: ","","&nbsp;")%> 
		  </font></td>

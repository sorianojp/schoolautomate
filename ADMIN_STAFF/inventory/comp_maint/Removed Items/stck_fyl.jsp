...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::COMPUTER COMPONENTS INVENTORY-STOCK FILING::::</strong></font></div></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="21%"><strong>Property # </strong></td>
    ...
    <tr>
      ...
      <td height="30" valign="middle"><font size="1"></font></td>
      <td>Entered  by </td>
    ...
    <tr>
      <td height="27">&nbsp;</td>
      <td>Model</td>
      <td height="27" valign="middle"><label><font size="1"></font></label></td>
    ...
    <tr>
      ...
      <td height="18" valign="middle">&nbsp;</td>
      <td height="18" valign="middle">&nbsp;</td>
      <td height="18" valign="middle"><font size="1"><a href="lab_mgmt.jsp" target="_self"><img src="../../../images/save.gif" alt="save" width="48" height="28" border="0"></a>click to save entry</font></td>
    </tr>
    <tr>
      <td height="30">&nbsp;</td>
      <td>&nbsp;</td>
      ...
      <td height="30" valign="middle">&nbsp;</td>
      <td height="30" valign="middle">&nbsp;</td>
      <td height="30" valign="middle"><font size="1"><a href="lab_mgmt.jsp" target="_self"><img src="../../../images/cancel.gif" width="51" height="26" border="0"></a>click to cancel entry</font></td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>

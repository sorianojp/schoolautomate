...
<%
	...
	if(strTemp.length() > 0) {
		vBorrow =  InvMaint.operateOnBorrowItems(dbOP, request, Integer.parseInt(strTemp));
		if(vBorrow != null ){
	...
	if(vBorrow != null && vBorrow.size() > 0){
		vRetResult = InvMaint.operateOnBorrowItems(dbOP, request, 4,(String)vBorrow.elementAt(0));
	}else{
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="21%" >
      <%
	  if(WI.fillTextValue("page_action").equals("1") && vBorrow != null && vBorrow.size() > 0)
		   strTemp = (String)vBorrow.elementAt(0);
	  else	
    ...
    <tr bgcolor="#C78D8D"> 
      <td height="24">&nbsp;</td>
      <td height="24" colspan="4"><strong><font color="#FFFFFF">BORROWING DETAILS</font></strong></td>
    </tr>
    <tr> 

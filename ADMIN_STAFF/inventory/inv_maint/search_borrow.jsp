...
<%
	...
	DBOperation dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"INVENTORY-INVENTORY MAINTENANCE","search_borrow.jsp");
	...
	if (WI.fillTextValue("searchlist").length() > 0){
		vRetResult = InvSearch.searchBorrow(dbOP, request);
		if (vRetResult != null)
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="search_borrow.jsp" method="post" >
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td valign="middle"> <select name="borrow_con">
          <%=InvSearch.constructGenericDropList(WI.fillTextValue("borrow_con"),astrDropListEqual,astrDropListValEqual)%> </select>

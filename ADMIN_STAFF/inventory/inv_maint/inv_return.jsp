...
<%
	...
	<jsp:forward page="./inv_return_print.jsp" />
<% return;}	
	int iAccessLevel = -1;
	...
	DBOperation dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"INVENTORY-INVENTORY MAINTENANCE","inv_return.jsp");
	...
	if (vRetResult != null)
		...
		strErrMsg = InvMaint.getErrMsg();
%><body bgcolor="#D2AE72">
<form name="form_" action="inv_return.jsp" method="post" >
	...
	%>
 	<tr>
      ...
      <td align="center" width="25%" height="25"><div align="left"><font color="#000000" size="1"> 
		...
		" from inv_preload_status where is_default = 0 order by inv_status", strTemp, false)%>
    </select></td>	
...
<%if (vRetResult != null && vRetResult.size()>0) {%>
  <table width="100%" border="0" cellpadding="1" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#FFFFFF">
      <td height="25" colspan="7" class="thinborder" align="center"><a href="javascript:PrintPg()"><img src="../../../images/print.gif" border="0"></a> 
        <font size="1">click to print list</font></td>
    </tr>
    <tr bgcolor="#ABA37C"> 
      <td height="25" colspan="7" class="thinborder" align="center"><strong> <font size="2" color="#FFFFFF">RETURNED 

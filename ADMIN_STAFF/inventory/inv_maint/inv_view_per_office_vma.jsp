...
function SearchNow()
{
	if(document.form_.stat_index.value.length > 0)
...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./inv_view_per_office_print_vma.jsp" />
<% return;}
	int iAccessLevel = -1;
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="inv_view_per_office_vma.jsp" method="post" >
...
%> <input name="sy_to" type="text" size="4" maxlength="4" value="<%=strTemp%>" class="textbox"
  ...
  <%strTemp = WI.fillTextValue("bldg_index");%>
  <%if (vRetResult != null && vRetResult.size() > 0){%>
  <table width="100%" border="0" cellpadding="" class="thinborder" cellspacing="0"  bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="10" align="center" class="thinborder"><font color="#FFFFFF"><strong>INVENTORY PER OFFICE</strong></font> </td>
    </tr>
    <tr bgcolor="#FFFFFF">
      <td height="20" colspan="10" class="thinborder"><div align="right"><span class="thinborderBOTTOM">
        <%
  ...
  <input type="hidden" name="show_property" value="1">
</form>
</body>
</html>
<%

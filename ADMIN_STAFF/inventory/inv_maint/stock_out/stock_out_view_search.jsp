...
function ViewItem(strIndex){
	var pgLoc = "stock_out_view.jsp?req_no="+strIndex;
...
<%
	...
	if(WI.fillTextValue("printPage").equals("1")){%>
		<jsp:forward page="stock_out_view_search_print.jsp"/>
	<%return;}
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-REQUISITION-Requisition Search","stock_out_view_search.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form name="form_" method="post" action="stock_out_view_search.jsp">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr>
      <td width="100%" height="25" bgcolor="#B9B292" class="thinborderTOPLEFTRIGHT"><div align="center"><font color="#FFFFFF"><strong>LIST 
          OF STOCK OUT REQUISITIONS</strong></font></div></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"  class="thinborder">
    <tr> 
      <td  height="25"  class="thinborder"><div align="center"><strong> OFFICE/DEPT</strong></div></td>
      <td width="16%" class="thinborder"><div align="center"><strong>REQUISITION NO.</strong></div></td>
      <td width="11%" class="thinborder"><div align="center"><strong>DATE REQUESTED</strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong>REQUESTED BY</strong></div></td>
      <td width="13%" class="thinborder"><div align="center"><strong>STATUS</strong></div></td>
      <td width="8%" class="thinborder"><div align="center"><strong>TOTAL ITEMS </strong></div></td>
      <td width="8%" class="thinborder"><div align="center"><strong>VIEW</strong></div></td>
    </tr>
    <%for(int i = 0;i < vRetResult.size();i+=8){%>
    <tr> 
      <td width="26%" height="25" class="thinborder"> 
        &nbsp;
	...
	<%if(WI.fillTextValue("opner_info").length() < 1) {%> 
    <tr> 
      <td height="25" colspan="5" align="right" class="thinborder"> <strong>PAGE TOTAL :&nbsp;&nbsp;&nbsp;</strong></td>

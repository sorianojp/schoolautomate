...
<form name="form_">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
     <tr> 
      ...
      <td width="46%" height="25" align="center"><div align="left">&nbsp;</div>
		...
		STOCK OUT REQUEST FORM</font></strong><br> 
		<br> </td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="18%" class="NoBorder">Request Type</td>
      <td width="31%" class="NoBorder"><strong><%=astrReqType[Integer.parseInt((String)vReqInfo.elementAt(3))]%></strong></td>
    ...
    <tr> 
      ...
      <td class="NoBorder"><strong><%=astrReqStatus[Integer.parseInt((String)vReqInfo.elementAt(10))]%></strong></td>
      <td class="NoBorder">Requisition Date</td>
      <td class="NoBorder"><strong><%=(String)vReqInfo.elementAt(2)%></strong></td>
    </tr>
    <%if(((String)vReqInfo.elementAt(5)).equals("0")){%> 
    <tr> 
      <td height="17">&nbsp;</td>
      <td class="NoBorder">Non-Acad. Office/Dept</td>
    ...
    <tr> 
      <td height="17">&nbsp;</td>
      <td class="NoBorder">College/Dept</td>

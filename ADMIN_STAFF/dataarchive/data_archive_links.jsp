...
if(bolGrantAll || comUtil.IsAuthorizedModule(dbOP,strUserId,"Data Archive")){%>
 <div> <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
  ...
  <a href="./record_newentry.jsp" target="daMainFrame">NEW ARCHIVE ENTRY</a> </font></strong></div>

 <div> <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
  <a href="./record_viewprint.jsp" target="daMainFrame">ARCHIVE DETAILS</a> </font></strong></div>


<div> <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
  <a href="./record_viewprint.jsp" target="daMainFrame">RETRIEVE
  ARCHIVE FILE</a> </font></strong></div>

<div> <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
  <a href="./search_record.jsp" target="daMainFrame">SEARCH
  ARCHIVE FILES</a> </font></strong></div>

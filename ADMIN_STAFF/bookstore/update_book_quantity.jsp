...
<%
	...
	if(svhAuth == null)
		...
		if(iAccessLevel == 0) {
			iAccessLevel = Integer.parseInt(WI.getStrValue(svhAuth.get("BOOKSTORE-BOOK MANAGEMENT-SET QUANTITY"),"0"));
		}
	}
	...
	if(WI.fillTextValue("save_quantity").length() > 0){
		if(!bp.changeBookQuantity(dbOP, request))
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./update_book_quantity.jsp" method="post">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
		<tr>
			<td height="25" align="right">
				<a href="javascript:SaveQuantity();"><img src="../../images/save.gif" border="0" /></a>
				<font size="1">Click to save book quantity.</font></td>
		</tr>
	</table>
<%}%>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="10%" align="center" class="thinborder"><strong>Available Qty </strong></td>
	...
	%>
		<tr>
			...
			<td class="thinborder" align="center">
				<input type="text" name="quantity_<%=iCount%>" class="textbox" onfocus="style.backgroundColor='#D3EBFF'" 
					onblur="AllowOnlyFloat('form_','quantity_<%=iCount%>');style.backgroundColor='white';toggleSel(document.form_.quantity_<%=iCount%>, document.form_.save_<%=iCount%>)" 
					onkeyup="AllowOnlyFloat('form_','quantity_<%=iCount%>')" size="12" maxlength="12" 
					value="<%=(String)vRetResult.elementAt(i+9)%>"/></td>
			<td class="thinborder" align="center">
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="25" align="center">
				<%if(iAccessLevel > 1){%>
					<a href="javascript:SaveQuantity();"><img src="../../images/save.gif" border="0" /></a>
					<font size="1">Click to save book quantity.</font>
				<%}else{%>

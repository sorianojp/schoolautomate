...
<%if(strSchCode.startsWith("FATIMA")){%>
	<%if(bolGrantAll || comUtil.IsAuthorizedSubModule(dbOP,strUserId,"Bookstore","BOOK MANAGEMENT-Management")!=0){isAuthorized=true;%>
		<img src="../../images/broken_lines.gif"><a href="book_management.jsp" target="accountingmainFrame"> Book Management </a><br>
	<%}if(bolGrantAll || comUtil.IsAuthorizedSubModule(dbOP,strUserId,"Bookstore","BOOK MANAGEMENT-Supply Log")!=0){isAuthorized=true;%>
		<img src="../../images/broken_lines.gif"><a href="book_supply_log_main.jsp" target="accountingmainFrame"> Book Supply Log </a><br>
	<%}if(bolGrantAll || comUtil.IsAuthorizedSubModule(dbOP,strUserId,"Bookstore","BOOK MANAGEMENT-Set Quantity")!=0){isAuthorized=true;%>
...
<span class="branch" id="branch3">  
	<img src="../../images/broken_lines.gif"><a href="ordering.jsp" target="accountingmainFrame"> Order Items</a><br>
	<img src="../../images/broken_lines.gif"><a href="for_releasing.jsp" target="accountingmainFrame"> For Releasing</a><br>
	<img src="../../images/broken_lines.gif"><a href="release_items.jsp" target="accountingmainFrame"> Release Order Items</a><br>
</span>
...
<span class="branch" id="branch4">  
	...
	<img src="../../images/broken_lines.gif"><a href="reports/stocks_ordered.jsp" target="accountingmainFrame"> Stocks Ordered </a><br>

...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Health Monitoring-Report","parent_consent_for_high_school_print.jsp");		
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"parent_consent_for_high_school_print.jsp");
...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable2">
    <tr bgcolor="#FFFFFF">
      ...
      <td height="25" valign="top">
		<p ALIGN="CENTER"><strong><font size="3"><%=strSchoolName%></font><br>
      BASIC EDUCATION DEPARTMENT</strong><br>
       <%=strSchoolAdd%><br>Tel. No. 295-1454</p><br>
	   <p align="center"><strong>SCHOOL CLINIC</strong></p><br><strong><p align="center"><font size="3">PARENT'S CONSENT</font><br>
		  <font size="2">HIGH SCHOOL DEPARTMENT</font></p></strong><br><br>
	...
	<tr><td colspan="3"><strong style="font-size:15px;">Dear PARENT/GUARDIAN,</strong></td></tr>
	<tr><td colspan="3" height="70"></td></tr>
	<tr>
		<td style="text-indent:40px; text-align:justify;" colspan="3">
			As part of the Enrolment Process the School Physician will do <strong>PHYSICAL EXAMINATION</strong> 
			on your SON/DAUGHTER (BREAST Examination shall be done on Female Patients). The School Dentist will also do <strong>DENTAL EXAMINATION</strong> to your child.		</td>
	</tr>
	<tr><td colspan="3" height="70"></td></tr>
	<tr>
		<td style="text-indent:40px; text-align:justify;" colspan="3">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
	<tr>
	<td width="44%" align="left" valign="bottom"><div style="border-bottom:solid 1px #000000; width:80%;"><%=WI.getStrValue(strParentname,"&nbsp;")%></div></td>
	<%
	...
	%>
	<td width="23%" valign="bottom" align="center"><div style="border-bottom:solid 1px #000000; width:80%;"><%=WI.getStrValue(strTemp,"N/A")%></div></td>
	</tr>
	<tr>

...
<form action="listings_main.jsp" method="post" name="form_">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr> 
			...
			CLINIC VISIT LOG - LISTING PAGE ::::</strong></font></div></td>
		</tr>
		<tr> 
		...
		<tr> 
			...
			<td width="50%" height="28"><div align="center"><a href="./visit_listings.jsp">EMPLOYEE/STUDENT VISIT LOG LISTING </a></div></td>
			<td width="25%" height="28">&nbsp;</td>
		</tr>
		<tr> 
			<td height="28">&nbsp;</td>

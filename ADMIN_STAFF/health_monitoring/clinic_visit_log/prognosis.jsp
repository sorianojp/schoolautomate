...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Health Monitoring-Clinic Visit Log","prognosis.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0) {
		if(CVLog.operateOnPrognosis(dbOP, request, Integer.parseInt(strTemp)) != null ) {
	...
	vRetResult = CVLog.operateOnPrognosis(dbOP, request, 4);
	if (strErrMsg == null)
		strErrMsg = CVLog.getErrMsg();
...
<form action="prognosis.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td width="15%" height="28">Prognosis :</td>
      <%strTemp = WI.fillTextValue("prog_index");%>
      <td width="25%" height="28"><select name="prog_index">
          <option value="">Select Prognosis</option>
			<%=dbOP.loadCombo("PROGNOSIS_TYPE_INDEX","PROGNOSIS_TYPE"," FROM HM_PRELOAD_PROGNOSIS ORDER BY PROGNOSIS_TYPE", strTemp, false)%>
        </select></td>
      <td width="57%" height="28">
      <a href='javascript:viewList("HM_PRELOAD_PROGNOSIS","PROGNOSIS_TYPE_INDEX","PROGNOSIS_TYPE","PROGNOSIS",
	"HM_CV_PROGNOSIS","PROGNOSIS_TYPE_INDEX"," AND VISIT_LOG_INDEX IS NOT NULL ","")'><img src="../../../images/update.gif" border="0"></a><font size="1">click 
        to update list of prognosis</font>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <%if (vRetResult != null && vRetResult.size()>0){%>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="#697A8F" class="footerDynamic"><div align="center"><font color="#FFFFFF" ><strong>:::: PROGNOSIS ::::</strong></font></div></td>
    </tr>
    <tr>
    <td width="14%">&nbsp;</td>
    <td width="64%" height="25"><div align="center"><font size="2"><strong>Prognosis</strong></font></div></td>
    <td width="10%">&nbsp;</td>
    <td width="12%">&nbsp;</td>
    </tr>
...
<input type="hidden" name="is_final" value="<%=WI.fillTextValue("is_final")%>">
</form>
</body>
</html>

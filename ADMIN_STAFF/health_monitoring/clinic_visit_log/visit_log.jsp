...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Health Monitoring-Clinic Visit Log","visit_log.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form action="./visit_log.jsp" method="post" name="form_">
...
<%if (vRetResult!=null && vRetResult.size()>0){%>
 <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr>
      <td height="25" colspan="10" bgcolor="#FFFF9F"><div align="center"><strong>LIST
          OF VISITS</strong></div></td>
    </tr>
<tr>
<td colspan="8" class="thinborder"><div align="right"><font size="1">
      <%
...
<tr>
	...
	<td width="8%" class="thinborder"><div align="center"><font size="1"><strong>Case #</strong></font></div></td>
	<td width="13%" class="thinborder"><div align="center"><font size="1"><strong>Doctor/Nurse</strong></font></div></td>
	<td width="24%" class="thinborder"><div align="center"><font size="1"><strong>Diagnosis</strong></font></div></td>
	<td width="24%" class="thinborder"><div align="center"><font size="1"><strong>Recommendation<br>/Action</strong></font></div></td>
	<td width="5%" class="thinborder"><div align="center"><font size="1"><strong>Rx Given</strong></font></div></td>
	<td width="8%" class="thinborder"><div align="center"><font size="1"><strong>Closed</strong></font></div></td>
...
<td class="thinborder"><%=WI.formatName((String)vRetResult.elementAt(i+3), (String)vRetResult.elementAt(i+4), (String)vRetResult.elementAt(i+5),7)%></td>
...
<td class="thinborder"><%=astrYN[Integer.parseInt((String)vRetResult.elementAt(i+10))]%></td>

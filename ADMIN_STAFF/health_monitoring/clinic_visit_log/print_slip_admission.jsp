...
<%
	...
	Vector vRetResult = hp.getAdmissionSlipDetails(dbOP, request);
	if(vRetResult == null)
...
<body onLoad="window.print();">
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
		...
		<tr>
			<td height="20">&nbsp;</td>
			<td align="center"><u>AUTHORIZATION FOR ADMISSION</u></td>
		</tr>
	</table>
			
<%if(vRetResult != null && vRetResult.size() > 0){
	boolean bolIsDependent = ((String)vRetResult.elementAt(3)).equals("1");
%>
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
		<tr>
		...
		<tr>
			...
			<td width="35%">
				<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
					<tr>
						<td height="20" width="60%">Date of Membership : </td>
						<td width="40%" class="thinborderBOTTOM">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(1))%></td>
					</tr>
					<tr>
		...
		<tr>
			<td height="20" colspan="2">Type of Admission Allowed: 
				<%
					if(WI.fillTextValue("print_admission").equals("0")){
						strTemp = "X";
						strErrMsg = "&nbsp;";
					}
					else{
				...
				%>
				[<%=strTemp%>] Medical only
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				[<%=strErrMsg%>] Both Medical or Surgical</td>
		</tr>
		<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
					<tr>
						...
						if(bolIsDependent){
							...
							strErrMsg = WI.getStrValue((String)vRetResult.elementAt(5));
		...
		<tr>
			<td>
				<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">					
					<tr>
						<td height="20" width="30%">Attending Physician: </td>
						<td width="65%" class="thinborderBOTTOM">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(3), "&nbsp;")%></td>
						<td width="5%">&nbsp;</td>
					</tr>
				</table>
			</td>
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
		...
		<tr>
			<td height="20" width="25%" class="thinborderBOTTOM">&nbsp;VINCENT P. SARMIENTO, M.D.</td>
			<td width="35%">&nbsp;</td>
			<td width="25%" class="thinborderBOTTOM">&nbsp;ANNE ROSE L. REYES</td>
			<td width="15%">&nbsp;</td>
		</tr>
		<tr>
			<td height="20" colspan="2">Director, University Health Services</td>
			<td colspan="2">Director, HRDC</td>
		</tr>
		<tr>
		...
		<tr>
			<td height="15" colspan="2">Noted by: </td>
		...
		<tr>
			<td height="20" class="thinborderBOTTOM">CYNTHIA S. MONIENO</td>
			<td>&nbsp;</td>
			<td class="thinborderBOTTOM">ANDREW L. ANGELES, M.D.</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td height="20" colspan="2">Asst. Vice President for Finance</td>
			<td>AUFHP-Coordinator</td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		...
		<tr>
			<td height="15" colspan="2"><font style="font-size:10px">AUF-Form-UHS-12 </td>

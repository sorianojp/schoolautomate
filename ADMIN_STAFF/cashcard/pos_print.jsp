	...
	<table cellpadding="0" cellspacing="0" width="100%">
	 <tr>
		...
		<tr>
			...
			<td>Name:</td>
			<%
			strTemp = WebInterface.formatName((String)vEditInfo.elementAt(7), (String)vEditInfo.elementAt(8), (String)vEditInfo.elementAt(9), 4);
			if(WI.getStrValue(vEditInfo.elementAt(11),"0").equals("1"))
				strTemp = WI.getStrValue(vEditInfo.elementAt(12));
			%>
			<td><%=strTemp%></td>
		</tr>
			...
			<td colspan="3" valign="top">
				...
				<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
					<tr>
						...
						<td class="thinborderNONE" width="36%" align="right" style="font-weight:bold">TOTAL: &nbsp;<%=CommonUtil.formatFloat(dTotal, true)%></td>
					</tr>		
			</table>			</td>
		</tr>	
		<%}%>
		...
		<tr>
			<td colspan="4">
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr>
						<td width="50%" align="center"><br/><br/>		      ___________________________</td>		   
						<td width="10%">&nbsp;</td>		   
						<td width="40%" colspan="2" align="center" valign="bottom" class="thinborderBOTTOM"><%=(String) request.getSession(false).getAttribute("first_name")%></td>		    
					</tr>
					<tr align="center">
		...
		<td width="4%">&nbsp;</td>
		<td width="48%"><table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td colspan="4" align="center" class="thinborderBOTTOM"><strong>::::
				<%=(String)vIPResult.elementAt(3)%> ::::</strong></td>
		</tr>

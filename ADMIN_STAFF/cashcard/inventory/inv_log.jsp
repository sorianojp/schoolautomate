...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Cash Card-Inventory-Inventory Logs","inv_log.jsp");
	}
catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(WI.fillTextValue("page_action").length() > 0){
		vRetResult = restItems.operateOnItemStockIn(dbOP, request, Integer.parseInt(WI.fillTextValue("page_action")));
		if(vRetResult == null)
...
<form action="inv_log.jsp" method="post" name="form_">
...
<tr>
    <td height="25" align="right"><b><font color="#000066">Stock in  Date : </font></b></td>
		<%
			strTemp = WI.getTodaysDate(1);
		%>
    <td width="83%" height="25"><font color="#000066">
      <input name="stockin_date" type="text" size="10" maxlength="10"  value="<%=strTemp%>"/>
      <strong><a href="javascript:show_calendar('form_.stockin_date');" 
		  ...
		  <td height="25" align="right">&nbsp;</td>
			<%
				...
				if(strTemp.equals("1"))
					...
					strTemp = "";
			%>			
		  <td><input type="checkbox" name="view_all" value="1" <%=strTemp%> />view all results</td>
	  </tr>
</table>
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
 <table width="100%" border="0" cellpadding="0" cellspacing="0">  
  ...
  <tr>
    ...
    <td width="30%" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><b><font color="#000066" size="1">ITEM NAME </font></b></td>
    <td width="10%" height="25" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><b><font color="#000066" size="1">DATE OF LAST STOCK IN </font></b></td>
    <td width="10%" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><b><font color="#000066" size="1">QTY ON HAND<br />
      (in Selling Unit ) </font></b></td>
    <td width="19%" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><b><font color="#000066" size="1">REMARKS</font></b></td>
    <td width="7%" align="center" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT"><strong><font color="#000066" size="1">STOCK IN </font></strong></td>
    <td width="8%" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><strong><font color="#000066" size="1">PRICE</font></strong></td>
    <td width="6%" height="25" bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center"><b><font color="#000066" size="1">SELECT<br />
  ...
  <tr>
    ...
    <td bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center">
		<input name="particulars_<%=iCount%>" type="text" size="22" maxlength="128" value="<%=strTemp%>"
		onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'" /></td>
		<%
			strTemp = WI.fillTextValue("stock_in_qty_"+iCount);
		%>
    <td bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center">
		<input name="stock_in_qty_<%=iCount%>" type="text" size="5" maxlength="5" 
		...
		<%
			strTemp = WI.fillTextValue("price_"+iCount);
		%>
    <td bgcolor="#D3D3D3" class="thinborderBOTTOMLEFT" align="center">
		<input name="price_<%=iCount%>" type="text" size="8" maxlength="10" 
		style="text-align:right" onfocus="style.backgroundColor='#D3EBFF'" value="<%=strTemp%>"
		onblur="style.backgroundColor='white'; AllowOnlyIntegerExtn('form_','price_<%=iCount%>','.');"
		onkeyup="checkKeyPress('form_','price_<%=iCount%>','.',event.keyCode);"/></td>

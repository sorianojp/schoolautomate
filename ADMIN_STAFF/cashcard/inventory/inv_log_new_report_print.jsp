...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Cash Card-Inventory-Inventory Logs","inv_log_new_report.jsp");
	}
catch(Exception exp)
	{
		exp.printStackTrace();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr><td align="center" height="20"><strong>DISTRIBUTION INVENTORY LOG REPORT <br><%=WI.getStrValue(WI.fillTextValue("date_fr"))%><%=WI.getStrValue(WI.fillTextValue("date_to"),"-","","")%></strong><br></td></tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
  <tr>
    <td width="7%" height="25" class="thinborder" align="center"><b>CATEGORY</b></td>
    <td width="7%" class="thinborder" align="center"><b>ITEM CODE </b></td>
    <td width="" class="thinborder" align="center"><b>ITEM NAME </b></td>
    <td width="7%" class="thinborder" align="center"><b>PURCHASE UNIT </b></td>
    <td width="7%" class="thinborder" align="center"><b>SELLING  UNIT </b></td>
	...
	<td width="15%"  class="thinborder" align="center"><b>REMARKS</b></td>

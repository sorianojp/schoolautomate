...
<script language="javascript">
	...
	function GenerateReport(){
		document.form_.terminal_name.value = document.form_.terminal_ip_index[document.form_.terminal_ip_index.selectedIndex].text;
...
<%
	...
	if(WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./terminal_report_print.jsp"></jsp:forward>	
<%	return;}
...
%>		
<body bgcolor="#D2AE72">
<form name="form_" action="./terminal_report.jsp" method="post">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" id="myADTable1">
		<tr bgcolor="#A49A6A">
			<td height="25" colspan="3" align="center"><font color="#FFFFFF">
				<strong>:::: GENERATE TERMINAL REPORT ::::</strong></font></td>
		</tr>		
		<tr>
		...
		<tr>
			...
			<td width="17%">Terminal:</td>
		  	<td width="80%">
				<%
					strTemp = WI.fillTextValue("terminal_ip_index");
					strErrMsg = 
						" from cc_terminal_dept "+
						" join cc_terminal_catg on (cc_terminal_catg.catg_index = cc_terminal_dept.catg_index) "+
						" join cc_terminal_ip on (cc_terminal_ip.terminal_dept_index = cc_terminal_dept.terminal_dept_index) "+
						" where cc_terminal_ip.is_valid = 1 and is_canteen = 1 ";
				%>
				<select name="terminal_ip_index">
					<option value="">Select Terminal</option>
					<%=dbOP.loadCombo("terminal_ip_index","dept_name + ' (' + ip_addr + ')'", strErrMsg, strTemp, false)%>
			  	</select></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
		...
		<tr>
			...
			<td><a href="javascript:GenerateReport();"><img src="../../../images/form_proceed.gif" border="0" /></a>
				<font size="1">Click to generate terminal report.</font></td>
		</tr>
		<tr>
			<td height="15" colspan="3">&nbsp;</td>
		</tr>
...
<%}%>
	...
	<input type="hidden" name="terminal_name" value="<%=WI.fillTextValue("terminal_name")%>"  />

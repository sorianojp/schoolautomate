...
<title>Allergy Management Page</title>
...
<script language="javascript">
	...
	function RefreshPage(){
		...
		document.form_.allergy_group.value = "";
		this.SearchStudent();
	}
	
	function PageAction(strAction,strInfoIndex){
		if(strAction == '0') {
			if(!confirm('Are you sure you want to delete this user allergy information?'))
				return;
		}
...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Cash Card-User Allergy Management","allergy_management.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(vStudInfo != null) {
		...
		if(strTemp.length() > 0) {
			if(fpdm.operateOnUserAllergy(dbOP, request, Integer.parseInt(strTemp), strUserIndex) == null)
				strErrMsg = fpdm.getErrMsg();
			else {
				if(strTemp.equals("0"))
					strErrMsg = "User allergy successfully removed.";
				else if(strTemp.equals("1"))
					strErrMsg = "User allergy successfully added.";
				else if(strTemp.equals("2"))
					strErrMsg = "User allergy successfully edited.";
		...
		if(strPrepareToEdit.equals("1")) {
			vEditInfo = fpdm.operateOnUserAllergy(dbOP, request,3, strUserIndex);
			if(vEditInfo == null)
				strErrMsg = fpdm.getErrMsg();
		}
		
		vRetResult = fpdm.operateOnUserAllergy(dbOP, request, 4, strUserIndex);
		if (vRetResult == null && strTemp.length() == 0)
			strErrMsg = fpdm.getErrMsg();
	}
%>		
<body bgcolor="#D2AE72" onLoad="FocusField();">
<form name="form_" action="./allergy_management.jsp" method="post">

	<table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr bgcolor="#A49A6A">
			<td height="25" colspan="3" align="center"><font color="#FFFFFF">
				<strong>:::: USER ALLERGY MANAGEMENT PAGE ::::</strong></font></td>
		</tr>
		<tr>
			<td height="25" >&nbsp;</td>
...
<%if(vStudInfo != null) {%>
	...
	<table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td height="25" width="3%">&nbsp;</td>
			<td width="17%">Allergy Name:</td>
			<td width="80%">
				<%
					if(vEditInfo != null && vEditInfo.size() > 0) 
						strTemp = (String)vEditInfo.elementAt(1);
					else	
						strTemp = WI.fillTextValue("allergy_group");
				%>	  
			  	<select name="allergy_group">
					<option value="">Select Allergy Group</option>
					<%=dbOP.loadCombo("allergy_index","allergy_name"," from cc_preload_allergy order by allergy_name",strTemp, false)%>
			  	</select>
			  	<!-- Allergy Update List -->
				<a href='javascript:viewList("cc_preload_allergy","allergy_index","allergy_name","Allergy Name",
					"cc_user_allergy","user_allergy_index", " and cc_user_allergy.is_valid = 1","","allergy_group")'>
				<img src="../../../images/update.gif" border="0"></a><font size="1">click to update list of Allergy</font></td>
		</tr>
		<tr>
			<td height="25"></td>
		...
		<tr>
			...
			<td>
				<%if(strPrepareToEdit.equals("0")) {%>
					...
					<font size="1">Click to save user allergy.</font>
				<%}else {
					if(vEditInfo!=null){%>
						<a href="javascript:PageAction('2', '<%=(String)vEditInfo.elementAt(0)%>');">
						<img src="../../../images/edit.gif" border="0"></a>
						<font size="1">Click to edit user allergy.</font>
					    <%}
				}%>
	...
	<table width="100%" cellspacing="0" cellpadding="0" class="thinborder" bgcolor="#FFFFFF">
		<tr> 
		  	<td height="20" colspan="3" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: USER ALLERGY LIST ::: </strong></div></td>
		</tr>
	  	<tr> 
		  	<td height="25" width="45%" align="center" class="thinborder"><strong>Allergy Name </strong></td> 
			<td width="40%" align="center" class="thinborder"><strong>Additional Note</strong></td> 

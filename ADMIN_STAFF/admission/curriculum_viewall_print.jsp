...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Admission-Courses Curriculum","curriculum_viewall.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(((String)vRetResult.elementAt(k+2)).indexOf("RLE") > 0) {
  ...
  <tr> 
    ...
    <td rowspan="2"><div align="left"><strong>SUBJECT TITLE </strong></div></td>
<%if(true || !bolShowRLE){%>
...
<%}%>
    <td width="7%" align="center"><%if(strCreditUnitLec != null) {%>
	  	<%=strCreditUnitLec%>
	  <%}else{%>
...
<%}%>
    ...
    <td bgcolor="#FFFFFF" class="thinborderTOP"><div align="center"><font size="1"><strong><%=iNoOfLABUnitPerSem%></strong></font></div></td>
<%if(bolShowRLE){%>
      <td class="thinborderTOP"><div align="center"><font size="1"><strong><%=dNoOfRLEUnitPerSem%></strong></font></div></td>
<%}if(!bolViewLabFee){%>
      <td>&nbsp;</td>

...
if(strSchCode.startsWith("CIT")){%>
	<jsp:forward page="./admission_registration_new_com_cit.jsp" />
<%return;}
%>
...
<form action="./admission_registration_new_com.jsp" method="post" name="offlineRegd">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="89%" height="25" rowspan="2"> <strong><font size="3"><%=WI.getStrValue(strErrMsg,"&nbsp;")%></font></strong> </td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="14%" height="25">Student Status </td>
...
if (strTemp.equals("New (HS Grad)")) {%>
		   <option value="New (HS Grad)" selected>New (HS Grad)</option>
<%}else{%>
		   <option value="New (HS Grad)">New (HS Grad)</option>
<%}%>
...
<%}%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2"> <%
	strTemp = WI.fillTextValue("auto_sched");
	if(strTemp.compareTo("1") ==0)
		strTemp = " checked";
	else
		strTemp = "";
	%> <input type="checkbox" name="auto_sched" value="1"<%=strTemp%>>
        <font color="#6600FF" size="2"><strong> Check to schedule placement exams
        automatically</strong></font></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2"> <%
    ...
    <tr>
      <td  width="2%" height="25">&nbsp;</td>
      <td colspan="2">Course Program(Optional to select)</td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="61%">Course : <font size="1">
        <input type="text" name="scroll_course" size="16" style="font-size:14px"
	  onKeyUp="AutoScrollList('offlineRegd.scroll_course','offlineRegd.course_index',true);"
	   onBlur="ReloadCourseIndex()" class="textbox">
...
%>
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2" valign="middle"> <select name="course_index" onChange="ReloadCourseIndex();" style="font-size:10px;font-weight:bold">
...
%>
          <%=dbOP.loadCombo("course_index","course_code+' ::: '+course_name",strTemp,strCourseIndex, false)%> </select> </td>
    </tr>
    <tr>
      <td height="25" width="2%">&nbsp;</td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="16%" height="24"> Year level entry</td>
      <td height="24" colspan="4">
<%
strTemp = WI.fillTextValue("stud_status");
if(strTemp.startsWith("N")){%>
	  <font color="#FF0000"><strong>1</strong> </font>
...
<%}%>
    ...
    <tr>
      ...
      <td width="56%" colspan="2"><select name="semester">
...
<%if(vStudBasicInfo != null && vStudBasicInfo.size() > 16 && vStudBasicInfo.elementAt(16) != null) {%>
	Gender: <strong><%=(String)vStudBasicInfo.elementAt(16)%></strong> 
...
<%}%>
      ...
      <td width="15%" valign="bottom"><font color="#0000FF"><strong>HS AVERAGE</strong></font>
        :</td>
      <td width="52%" valign="bottom">
        <%if(bolClearEntry) strTemp = "";
	  else strTemp = WI.fillTextValue("hs_ave"); %>
        <input name="hs_ave" type="text" size="6" maxlength="6" class="textbox" value="<%=strTemp%>"
...
if(bolIsHSGrad) 
	strTemp = "2";
%>
	  <select name="sch_index" <%if(bolIsHSGrad) {%> style="font-size:11px; border:hidden; background:#FFFFFF; font-weight:bold;color: #000000"  disabled="disabled"<%}else{%>style="font-size:11px;"<%}%>>

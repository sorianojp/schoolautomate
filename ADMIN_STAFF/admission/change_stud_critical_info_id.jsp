...
function OpenSearch(strIDInfo) {
	var pgLoc = "../../search/srch_stud.jsp?prevent_reload=1&opner_info=offlineRegd.";
	if(strIDInfo == '0')
		pgLoc +="prev_id";
	else	
		pgLoc += "new_id";
...
if(WI.fillTextValue("addRecord").compareTo("1") ==0)
{
	if(!changeInfo.changeStudID(dbOP,WI.fillTextValue("prev_id"),WI.fillTextValue("new_id"),
		...
		strErrMsg = "Student ID"+WI.fillTextValue("prev_id")+" is changed to new ID : "+WI.fillTextValue("new_id");
}
%>
<form action="./change_stud_critical_info_id.jsp" method="post" name="offlineRegd">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          STUDENT ID UPDATE PAGE::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
	  ...
	  <input name="image" type="image" onClick="AddRecord();" src="../../images/save.gif">
        <font size="1" >click to change student's ID</font>
		<%}else{%>

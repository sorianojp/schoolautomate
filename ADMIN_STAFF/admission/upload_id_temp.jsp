...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Admission-Student Info Mgmt","upload_id_temp.jsp");
...
if(request.getParameter("deleteFile") != null && request.getParameter("deleteFile").compareTo("1") ==0)
{
	...
	else
	{
		...
		System.out.println("../../upload_img/"+strStudId+"."+strImgFileExt);
		if(file.exists())
		{
			file.delete();
...
%>
<form method="post" name="upload_file" action="./upload_id_temp.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="15%"><input type="text" name="temp_id" size="16" maxlength="32" value="<%=WI.fillTextValue("temp_id").toUpperCase()%>" class="textbox"
...
{
	if(document.upload_file.temp_id.value.length ==0)
		if (strIsEmp == 1) 
	...
	{
		var sT = "./upload_id_step2.jsp?temp_id="+escape(document.upload_file.temp_id.value)+"&img_ext=<%=strImgFileExt%>";

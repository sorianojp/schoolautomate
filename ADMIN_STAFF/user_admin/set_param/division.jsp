...
{
	location = "./division.jsp";
}
function PrintPg() {
	var win=window.open("./division_print.jsp","PrintWindow",'width=800,height=400,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();

}
function Validate() {
	if(document.ccollege.c_code.value.length == 0) {
		alert("Division code can't be empty.");
		return;
	}
	if(document.ccollege.c_name.value.length == 0) {
...
if(strTemp != null && strTemp.compareTo("1") == 0)
{
	...
	{
		strErrMsg = "Division added successfully.";
		bolIsSuccess = true;
	}
	else
	{
...
else //either it is edit or delete -- this page handles add/edit/delete/viewall :-)
{
	...
	if(strTemp != null && strTemp.compareTo("1") == 0)
	{
		...
		{
			strErrMsg = "Division edited successfully.";
			strPrepareToEdit="0";
			bolIsSuccess = true;
		}
		else
	...
	else
	{
		...
		if(strTemp != null && strTemp.compareTo("1") == 0)
		{
			...
			{
				strErrMsg = "Division deleted successfully.";
			}
			else
			{
				dbOP.cleanUP();
...
<form name="ccollege" method="post" action="./division.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="3"><div align="center"><font color="#FFFFFF"><strong>:::: 
          MANAGE DIVISION ::::</strong></font></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td height="25" width="40%">Division code 
        <%
	if(vEditInfo != null)
...
{%>
    <tr> 
      <td height="28">&nbsp;</td>
      <td height="28" colspan="2">Division Head &nbsp; 
        <%
	if(vEditInfo != null)
	...
	if(	bolIsSuccess )
		strTemp = "";
%>
        <input name="dean_name" type="text" size="56" class="textbox"
...
{%>
    <tr bgcolor="#B9B292">
      <td height="25" colspan="7"><div align="center">LIST
          OF EXISTING DIVISIONS </div></td>
    </tr>
    <tr>
      <td><div align="center"><font size="1"><strong>DIV. CODE</strong></font></div></td>
      <td height="25"><div align="center"><font size="1"><strong>DIVISION  NAME</strong></font></div></td>
      <td><div align="center"><font size="1"><strong>DIVISION HEAD </strong></font></div></td>

...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-System Administrator-Override Parameters","class_program_su.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(SP.operateOnCPSuperUser(dbOP,request, Integer.parseInt(strTemp)) != null )
		strErrMsg = "Successful";
	else
		strErrMsg = SP.getErrMsg();
}

Vector vRetResult = SP.operateOnCPSuperUser(dbOP, request, 4);
...
if(strErrMsg == null) 
	strErrMsg = "";
%>
<form name="form_" action="./class_program_su.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>::::
          CLASS PROGRAM SUPER USER ::::</strong></font></div></td>
    </tr>
  </table>
 ...
 <%if(vRetResult != null) {%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#CCCCCC">
      <td height="25" colspan="4" align="center" class="thinborder" style="font-weight:bold; font-size:9px;">LIST OF CLASS PROGRAM SUPER USERS</td>
    </tr>

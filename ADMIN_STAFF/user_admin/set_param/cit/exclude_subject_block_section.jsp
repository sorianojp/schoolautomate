...
//add security here.
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-FEE MAINTENANCE-setup ojt","exclude_subject_block_section.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"exclude_subject_block_section.jsp");
...
if(strTemp.length() > 0) {
	if(advising.operateOnExcludeBlockSectionList(dbOP, request, Integer.parseInt(strTemp)) == null)
		strErrMsg = advising.getErrMsg();
	else 
		strErrMsg = "Operation Successful.";		
}

Vector vRetResult = advising.operateOnExcludeBlockSectionList(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null)
	strErrMsg = advising.getErrMsg();

%>
<form name="form_" action="./exclude_subject_block_section.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25"><div align="center"><font color="#FFFFFF"><strong>:::: Define Subjects not part of Block Section ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">  
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>  
      ...
      <td colspan="2">Exclude Subject: 
	  	<select name="sub_index" style="width:600px; font-size:11px;">
  <%
strTemp = " from subject where is_del = 0 and IS_EXCLUDED_BLOCK_SECTION = 0 order by sub_code";
%>					

...
%>
<body >
<form action="./migrate_rooms.jsp" method="post" name="form_">
<%=WI.getStrValue(strErrMsg,"<font size=\"3\" color=\"#DD0000\"><strong>","</strong></font>","")%><br>

  <font size="3">NOTE : To migrate, <br>
  1. Create a database SB_DataMigrate (if does not exist)<br>
  2. Transfer the rooms table to be migrated.<br>
  4. Provide sql login user name and password to access SB_DataMigrate. For example 
  : user = sa, password = 123<br>
  ...
  <strong>7. After rooms are migrated, please check/edit room information.<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size="2">FOLLOW THIS LINK : <font color="#660000">HOME 
  &gt;&gt; ENROLLMENT &gt;&gt; ROOMS MONITORING &gt;&gt; MAINTENANCE</font></font></strong><font color="#660000"><br>
  </font></font><br>
...
<br>
  <table width="100%" border="0" cellpadding="1" cellspacing="0" class="thinborder">
    <tr bgcolor="#FFFFAF"> 
      <td height="27" class="thinborder"><div align="center"><strong>FIELD NAME 
    ...
    <tr> 
      <td width="50%" height="25" class="thinborder"> <div align="center"> 
          <input name="rm_no" type="text" class="textbox" id="rm_no" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_no")%>" size="32">
          <font size="3"><font size="3"><font color="#FF0000"><strong>*</strong></font></font><font color="#FF0000"></font></font></div></td>
      <td width="50%" class="thinborder">ROOM NUMBER<font size="3"><font color="#FF0000"></font></font></td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"> <div align="center"> 
          <input name="rm_type" type="text" class="textbox" id="rm_type" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_type")%>" size="32">
          <font size="3"><font color="#FF0000"> </font></font></div></td>
      <td class="thinborder">TYPE OF ROOM</td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"><div align="center"> 
          <input name="rm_level" type="text" class="textbox" id="rm_level" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_level")%>" size="32">
        </div></td>
      <td class="thinborder">FLOOR (LEVEL)</td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"><div align="center"> 
          <input name="rm_bldg" type="text" class="textbox" id="rm_bldg" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_bldg")%>" size="32">
        </div></td>
      <td class="thinborder"> BUILDING </td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"><div align="center"> 
          <input name="rm_desc" type="text" class="textbox" id="rm_desc" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_desc")%>" size="32">
        </div></td>
      <td class="thinborder"> DESCRIPTION</td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"><div align="center"> 
          <input name="rm_cond" type="text" class="textbox" id="rm_cond" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_cond")%>" size="32">
        </div></td>
      <td class="thinborder">REMARKS (CONDITION)</td>
    </tr>
    <tr> 
      <td height="25" class="thinborder"><div align="center"> 
          <input name="rm_cap" type="text" class="textbox" id="rm_cap" style="font-size:14px"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("rm_cap")%>" size="32">
        </div></td>
      <td class="thinborder">CAPACITY</td>
    </tr>
  </table>
<br>

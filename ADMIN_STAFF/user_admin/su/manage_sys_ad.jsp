...
if(strTemp.length() > 0) {
	if(auth.operateOnSUUserRestriction(dbOP,request, Integer.parseInt(strTemp)) != null )
		strErrMsg = "Successful";
	else
		strErrMsg = auth.getErrMsg();
}

vRetResult = auth.operateOnSUUserRestriction(dbOP, request, 4);
...
%>
<form name="form_" action="./manage_sys_ad.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>::::
          SYSTEM ADMIN USER MANAGEMENT ::::</strong></font></div></td>
    </tr>
  </table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    ...
    <tr valign="top">
      ...
      <td width="22%"><input type="text" name="sys_id" value="<%=WI.fillTextValue("sys_id")%>" class="textbox"
    ...
    <tr valign="top">
      <td height="25">&nbsp;</td>
      <td>User To Manage </td>
      <td><input type="text" name="uid_manage" value="<%=WI.fillTextValue("uid_manage")%>" class="textbox"
 ...
 <%if(vRetResult != null) {%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#CCCCCC">
      <td height="25" colspan="4" align="center" class="thinborder" style="font-weight:bold; font-size:9px;">LIST OF USERS : <font color="#FF0000"><%=WI.fillTextValue("sys_id")%></font> CAN MANAGE</td>
    </tr>
...
<%for(int i = 0; i < vRetResult.size(); i += 3){%>
    <tr>
      ...
      <td class="thinborder" style="font-size:9px;">&nbsp;<%=WI.getStrValue(vRetResult.elementAt(i + 2))%></td>

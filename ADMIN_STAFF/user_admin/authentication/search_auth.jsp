...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-System Administrator-User Management","search_auth.jsp");
...
if(WI.fillTextValue("show_list").length() > 0) {
	vRetResult = auth.operateOnBatchProcessAuth(dbOP, request, 11);
	//System.out.println(auth.getErrMsg());
	if(vRetResult == null) 
		strErrMsg = auth.getErrMsg();
}
%>
<form name="form_" action="search_auth.jsp" method="post" onSubmit="SubmitOnceButton(this);">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable1">
    <tr bgcolor="#A49A6A">
      <td height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>::::
          AUTHENTICATION - SEARCH ::::</strong></font></div></td>
    </tr>
    <tr>
      <td width="100%" height="25" style="font-size:13px; font-weight:bold; color:#FF0000">&nbsp;&nbsp;&nbsp;&nbsp;<%=WI.getStrValue(strErrMsg)%></td>
    </tr>
 </table>
...
<%//}//end of show_new.%>
    <tr>
      <td width="3%" height="20" bgcolor="#0099FF" style="font-size:11px; font-weight:bold;">&nbsp;</td>
      <td colspan="2" bgcolor="#0099FF" style="font-size:11px; font-weight:bold;">Authentication Search </td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      ...
      <td><input type="checkbox" name="show_superuser" value="checked" <%=WI.fillTextValue("show_superuser")%>>
      <font style="font-size:11px; color:#0000FF; font-weight:bold">Show all super users &nbsp;&nbsp;
	  <input type="checkbox" name="remove_new" value="checked" <%=WI.fillTextValue("remove_new")%>>
	  Remove users do not have authentication
	  </font></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
...
if(strTemp.compareTo("0") ==0)
	...
	strErrMsg = "";
%>
          <option value="0"<%=strErrMsg%>>Read Only</option>
...
<%}%>
      ...
      <td><input type="submit" name="1" value="Show List of employees" style="font-size:11px; height:28px;border: 1px solid #FF0000;" onClick="document.form_.show_list.value='1'"></td>
    </tr>
<%
if( iAccessLevel >1){%>
    <tr>
...
<%if(vRetResult != null && vRetResult.size() > 0) {%>
  ...
  <tr>
  	<td align="right" style="font-size:9px;">Date and Time generated : <%=WI.getTodaysDateTime()%></td>
  </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    <tr>
      <td height="25" colspan="6" bgcolor="#B9B292" align="center" style="font-size:11px; font-weight:bold;" class="thinborder">List Of Employees</td>
    </tr>
    <tr>
      ...
      <td width="45%" class="thinborder" align="center" style="font-size:9px;font-weight:bold">Authentication List </td>
    </tr>
<%int iTotListCount = 0;
for(int i = 0; i < vRetResult.size(); i += 6){%>
    <tr>
      <td class="thinborder" valign="top"><%=++iTotListCount%>.</td>

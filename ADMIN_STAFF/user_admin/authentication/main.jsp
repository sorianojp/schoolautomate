...
//add security here.
	...
	//if wnu restricted user, do not let the search or batch process.
	boolean bolIsWNURestrictedUser = false;//a restricted System admin
	String strSQLQuery = "select MANAGE_USER_INDEX from SYSAD_MANAGE_USER where USER_INDEX_TO_MANAGE is not null " +
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" bgcolor="#A49A6A" align="center"><font color="#FFFFFF" ><strong>::::
        AUTHENTICATION MAIN PAGE ::::</strong></font></td>
    </tr>
<%
if(strErrMsg != null) {%>
    <tr bgcolor="#FFFFFF">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="4%">&nbsp;</td>
    <td width="76%"><a href="./authentication.jsp">Assign authentication (per employee) - Old way</a></td>
  </tr>
<%if(!bolIsWNURestrictedUser){%>
  <tr> 
    ...
    <td width="4%">&nbsp;</td>
    <td width="76%"><a href="./authentication_batch.jsp">Assign authentication (Batch process) - New </a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
    <td>&nbsp;</td>
    <td><a href="./search_auth.jsp">Search Authentication</a></td>
  </tr>
<%}%>
</table>

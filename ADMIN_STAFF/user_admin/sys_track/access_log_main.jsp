...
<table border="0" cellspacing="0" cellpadding="0" >
  <tr>
    ...
    <td width="160" bgcolor="#A9B9D1" align="center"  class="tabFont">Todays Visit Log Summary</td>
    <td width="10" background=".././../../images/tabright_selected.gif" bgcolor="#A9B9D1">&nbsp;</td>

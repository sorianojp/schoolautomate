...
%>
<form name="form_" action="./execute_query_new.jsp" method="post">
...
<%}%>    <tr>
      ...
      <td width="73%"><input type="password" name="password" value="<%=WI.fillTextValue("password")%>"></td>
    </tr>
    <tr>
...
for(int i = 0; i < astrSQLQuery.length; ++ i){
	...
	vRetResult =
		ESQ.executeSQLQuery(dbOP, WI.fillTextValue("password"),WI.fillTextValue("query_"+Integer.toString(i + 1)),bolIsSQL5);
	if(vRetResult == null) {

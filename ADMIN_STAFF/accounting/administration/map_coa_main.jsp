  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A" align="center">
      <td height="25" colspan="2" bgcolor="#A49A6A"><div><font color="#FFFFFF" ><strong>:::: 
        LINKING OF CHART OF ACCOUNTS ::::</strong></font></div></td>
    </tr>
</table>
...
<%if(!bolIsFatalErr) {%>
  ...
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map_coa_college.jsp">Link AR Tuition</a> </td>
  </tr>
  
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_scholarship.jsp">Link Scholarship/Discounts</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_misc_oc.jsp?is_oc=0">Link Miscellaneous Fee</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_misc_oc.jsp?is_oc=1">Link Other Charges (Lab Fee)</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_misc_oc.jsp?is_oc=2">Link Computer Handson Fee</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_othsch_tuition.jsp">Link Other School Fee (Tuition Fee Type)</a></td>
  </tr>
   <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_othsch_nontuition.jsp">Link Other School Fee (Non-Tuition Fee Type)</a></td>
  </tr>
   <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_cash_receipt.jsp">Link Cash Receipt</a></td>
  </tr>
   <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_advance_enrollment.jsp">Link Advanced Enrollment</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td>&nbsp;</td>
   ...
   <tr>
    <td height="25">&nbsp;</td>
    <td colspan="2"><a href="./map/map_bank.jsp">Link Bank (for cash in bank)</a></td>
  </tr>
<%}%>
  <tr>
    <td height="25">&nbsp;</td>

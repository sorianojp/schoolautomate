...
<script language="javascript">
	...
	function PageAction(strAction, strInfoIndex) {
		if(strAction == '0') {
			if(!confirm('Are you sure you want to remove restriction for this employee?'))
				return;
		}
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"ACCOUNTING-ADMINISTRATION","restricted_user.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(strTemp.length() > 0){
		if(administration.operateOnJVCDAuth(dbOP, request, Integer.parseInt(strTemp))  == null)
			strErrMsg = administration.getErrMsg();
		else	
			strErrMsg ="Operation Successful.";
	}
		
	vRetResult = administration.operateOnJVCDAuth(dbOP, request, 4);
%>
<body bgcolor="#D2AE72" onLoad="FocusField();">
<form name="form_" action="./restricted_user.jsp" method="post">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: AUTHENTICATION RESTRICTION PAGE ::::</strong></font></div></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
...
-->
<input type="hidden" name="jv_cd_type" value="0">
	</table>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="6" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: RESTRICTED USER LIST ::: </strong></div></td>
		</tr>
		<tr>

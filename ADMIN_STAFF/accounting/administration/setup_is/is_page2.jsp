...
<form name="form_" method="post" action="is_page2.jsp" onSubmit="SubmitOnceButton(this);">
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="2">Chart of account(header) : 
        <%
if(vEditInfo != null) 
...
strErrMsg = " (select * from AC_SET_IS_SUB "+
			"join AC_SET_IS_MAIN on (AC_SET_IS_MAIN.is_main_index = AC_SET_IS_SUB.is_main_index) "+
			"where COA_INDEX = COA_HEADER and is_title_index = "+strISTitle+")";
 %>
	  <select name="coa_ref" style="font-size:11px; width:415">
		<%=dbOP.loadCombo("COA_INDEX","COMPLETE_CODE, ACCOUNT_NAME"," from AC_COA where account_type = 0 " +
											" and COA_CF = "+strCF + 
											" and IS_ACTIVE = 1 and is_valid = 1 and not exists " +strErrMsg+

...
if(strSchCode == null) 
	strSchCode = "";
boolean bolIsPIT = strSchCode.startsWith("PIT");
%>
...
%>	  <input name="opening_bal" type="text" size="16" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="AllowOnlyFloat('form_','opening_bal');style.backgroundColor='white'"
	  onKeyUp="AllowOnlyFloat('form_','opening_bal');"></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
...
<%if(bolIsPIT){%><br>
    <tr bgcolor="#DDDDDD"> 
      ...
      <td style="font-size:9px; font-weight:bold" class="thinborderTOP">COA equiv Account Code</td>
      <td colspan="2" class="thinborderTOPRIGHT">
<%
if(vEditInfo != null && vEditInfo.size() > 0)
	strTemp = (String)vEditInfo.elementAt(15);
else	
	strTemp = WI.fillTextValue("govt_account_code");
%>	  
	<input name="govt_account_code" type="text" size="12" maxlength="6" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="AllowOnlyInteger('form_','govt_account_code');style.backgroundColor='white'"
	  onKeyUp="AllowOnlyInteger('form_','govt_account_code');">
	  </td>
    </tr>
    <tr bgcolor="#DDDDDD"> 
      <td class="thinborderBOTTOMLEFT">&nbsp;</td>
      <td style="font-size:9px; font-weight:bold" class="thinborderBOTTOM">COA equiv Account Name</td>
      <td colspan="2" class="thinborderBOTTOMRIGHT">
<%
if(vEditInfo != null && vEditInfo.size() > 0)
	strTemp = (String)vEditInfo.elementAt(16);
else	
	strTemp = WI.fillTextValue("govt_account_name");
%>	  
	<input name="govt_account_name" type="text" size="80" maxlength="256" value="<%=strTemp%>" class="textbox"
...
<input type="button" name="Cancel" value=" Cancel " style="font-size:11px; height:28px;border: 1px solid #FF0000;"
 ...
 <% if (vRetResult !=null){ %>  
  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td colspan="7" bgcolor="#666666" height="25" class="thinborder"><div align="center"><strong><font color="#FFFFFF">LIST 
...
<%if(bolIsPIT){%>
      <td class="thinborder" align="center" style="font-size:9px; font-weight:bold">GOVT EQUIV ACCOUNT # </td>
      <td class="thinborder" align="center" style="font-size:9px; font-weight:bold">GOVT EQUIV ACCOUNT NAME </td>
      <%}%>
      <td width="15%" class="thinborder" align="center"><font size="1"><strong>TYPE </strong></font></td>
      <td width="10%" class="thinborder" align="center"><font size="1"><strong>BALANCE</strong></font></td>
...
<%if(bolIsPIT){%>
      <td width="19%" class="thinborder"><%=WI.getStrValue(vRetResult.elementAt(i + 15),"&nbsp;")%></td>
      <td width="19%" class="thinborder"><%=WI.getStrValue(vRetResult.elementAt(i + 16),"&nbsp;")%></td>
<%}%>

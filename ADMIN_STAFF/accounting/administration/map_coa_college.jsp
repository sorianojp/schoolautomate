...
<%if(bolIsBasic) {%>
    <tr>
	  ...
	  <select name="yr_level">
          <%=dbOP.loadCombo("G_LEVEL","EDU_LEVEL_NAME +' - '+ LEVEL_NAME"," from BED_LEVEL_INFO where not exists (select * from fa_college_coa where yr_level = g_level) order by G_LEVEL",WI.fillTextValue("yr_level"),false)%>
      </select>  	  
	  </td>
    </tr>
...
%>
    ...
    <tr> 
      ...
      <td width="16%">TF Credit Account</td>
      <td colspan="2">
<%
if(vEditInfo != null && vEditInfo.size() > 0) 
...
%>
	  <input name="tfc_coa" type="text" size="26" maxlength="32" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" 
	  onkeyUP="MapCOAAjax('tfc_coa', 'coa_info_c');">	  </td>
    </tr>
    <tr> 
      <td></td>
      <td></td>
...
<%}%>
      <td width="35%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">TF DEBIT ACCOUNT  </td>
      <td width="35%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">TF CREDIT ACCOUNT </td>

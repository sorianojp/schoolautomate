...
<%if(vRetResult != null){%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder">
    ...
    <tr> 
      ...
      <td width="41%" height="25" align="center" style="font-size:9px; font-weight:bold" class="thinborder"><span class="thinborder" style="font-size:9px; font-weight:bold">NAME TO APPEAR ON BALANCE SHEET</span></td>
      <td width="24%" align="center" style="font-size:9px; font-weight:bold" class="thinborder"><span class="thinborder" style="font-size:9px; font-weight:bold">ACCOUNT #</span></td>
      <td width="7%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">OPERATION</td>
      <td width="6%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">&nbsp;</td>

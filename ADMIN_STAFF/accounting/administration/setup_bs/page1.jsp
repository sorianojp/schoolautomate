...
<%if(vRetResult != null){%>  
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="5" bgcolor="#B9B292" class="thinborder"><div align="center"><font color="#FFFFFF"><strong>:: TITLES/NAME TO APPEAR IN BALANCE SHEET :: </strong></font></div></td>
    </tr>
    <tr> 
      <td width="14%" class="thinborder"><div align="center"><font size="1"><strong>GROUP TITLE</strong></font></div></td>
      <td width="6%" height="25" class="thinborder"><div align="center"><font size="1"><strong>SUB-GROUP ORDER </strong></font></div></td>
      <td width="30%" class="thinborder"><div align="center"><strong><font size="1">SUB-GROUP NAME</font></strong></div></td>
      <td width="7%" class="thinborder" style="font-weight:bold; font-size:9px;">UPDATE</td>

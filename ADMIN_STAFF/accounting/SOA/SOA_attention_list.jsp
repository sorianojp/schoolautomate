...
<title>SOA Attention List</title>
</head>
...
<script language="javascript">
	...
	function RefreshPage(){
		...
		document.form_.position.value = "";
		document.form_.department.value = "";
		document.form_.submit();
	}
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"ACCOUNTING-BILLING","SOA_attention_list.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(strTemp.length() > 0){
		if(soa.operateOnSOAAttentionList(dbOP, request, Integer.parseInt(strTemp)) == null)
	...
	vRetResult = soa.operateOnSOAAttentionList(dbOP, request, 4);

	if(strPrepareToEdit.equals("1")){
		vEditInfo = soa.operateOnSOAAttentionList(dbOP, request, 3);
		if(vEditInfo == null)
			strErrMsg = soa.getErrMsg();
	}
%>
<body bgcolor="#D2AE72" onload="FocusField();" onUnload="ReloadParentWnd();">
<form name="form_" action="./SOA_attention_list.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>::::  SOA ATTENTION LIST ::::</strong></font></div></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<td width="80%">
				...
				%>
				<input type="text" name="name" value="<%=strTemp%>" class="textbox" 
		...
		<tr>
			...
			<td>
				...
				%>
				<input type="text" name="position" value="<%=strTemp%>" class="textbox" 
					onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
					size="64" maxlength="128"></td>
		</tr>
		<tr>
			...
			<td>
				...
				%>
				<input type="text" name="department" value="<%=strTemp%>" class="textbox" 
					onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
					size="64" maxlength="128"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<%if(strPrepareToEdit.equals("0")) {%>
					...
					<font size="1">Click to save attention list information.</font>
				    <%}else {
					if(vEditInfo!=null){%>
						<a href="javascript:PageAction('2', '<%=(String)vEditInfo.elementAt(0)%>');">
						<img src="../../../images/edit.gif" border="0"></a>
						<font size="1">Click to edit attention list information.</font>
					    <%}
				}%>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="5" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: SOA ATTENTION LIST::: </strong></div></td>
		</tr>
		<tr>
			<td height="25" width="5%" align="center" class="thinborder"><strong>Count</strong></td>
			<td width="30%" align="center" class="thinborder"><strong>Name</strong></td>
			<td width="23%" align="center" class="thinborder"><strong>Position</strong></td>
			<td width="23%" align="center" class="thinborder"><strong>Department</strong></td>

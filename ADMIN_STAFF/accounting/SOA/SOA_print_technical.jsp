...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"ACCOUNTING-BUDGET","SOA_print_technical.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
			<td colspan="2"><p>
			This is to bill you the amount <b><u><%=strErrMsg.toUpperCase()%> (<%=(String)vSOAInfo.elementAt(18)%><%=CommonUtil.formatFloat(strTemp, false)%>)</u></b> 
			as payment for Technical Support Fee (<u>for the month of <%=WI.formatDate((String)vSOAInfo.elementAt(2), 11)%></u>) 
			of the following employees.</p></td>
		</tr>
		<tr>
			<td height="15" colspan="2">&nbsp;</td>
		</tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
			<%
				...
				strErrMsg += " ONLY";
			%>
			<td colspan="3"><p>Please remit total amount <u><strong><%=strErrMsg.toUpperCase()%></strong></u> 

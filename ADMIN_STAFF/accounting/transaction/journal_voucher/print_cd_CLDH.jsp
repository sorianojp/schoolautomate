...
<%}%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr >
      ...
      <td width="33%" valign="top"><br><br><br><br>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  	<%=WI.formatDate((String)vJVInfo.elementAt(1), 6)%>
	  </td>
    </tr>
</table>
...
if(iVoucherType > 0){%>
    <tr>
      ...
      <td height="20" style="font-size:11px; font-weight:bold"><label id='cd_amount'><%=CommonUtil.formatFloat((String)vJVInfo.elementAt(6), true)%></label></td>
	  ...
	  <%while(vExplanation.size() > 0) {
		  ...
		  <%for(int p = 0; p < iNoOfColumn; ++p){
		  	if(p%2 == 1) 
				...
				strTemp = "";%>
			<td<%=strTemp%>>&nbsp;<%if(vTemp.size() > 0) {%><%=vTemp.remove(0)%><%}%>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		  <%}//end of for.. %>
	   </tr>
	   <%}//end of while.%>
	  </table>
...
<!-- this is shown only if cldh.. -->
	<tr>
      ...
      <td height="20" style="font-size:13px; font-weight:bold" width="64%"><u>DEBIT</u></td>
      <td style="font-size:13px; font-weight:bold" width="11%">&nbsp;</td>
      <td style="font-size:11px;" width="11%" align="right">Amount&nbsp;&nbsp;</td>
      <td style="font-size:11px;" width="10%" align="right">&nbsp;</td>
	</tr>
<%strErrMsg = null;

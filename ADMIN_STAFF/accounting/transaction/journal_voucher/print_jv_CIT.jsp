...
<table width="100%" border="0">
  <tr>
    <td width="15%" height="111"><div align="right">
	<img src="../../../../images/logo/CIT_CEBU.gif" width="98" height="98">
	</div></td>
    <td width="66%"><div align="center"><font size="2">CEBU INSTITUTE OF TECHNOLOGY-UNIVERSITY </font><font size="5"><br>
        <font size="2">Cebu City<br>  
          <br>  
...
<table width="100%" border="0">
  <tr>
    <td width="15%">&nbsp;</td>
    <td width="66%" align="center"><font size="2"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></font><br>
        <font size="1"><%=SchoolInformation.getAddressLine1(dbOP,false,false)%></font><br>  
          <br>  
    <font size="2"><strong>ACCOUNTING AND FINANCE</strong></font></td>
    <td width="19%" style="font-size:9px;" valign="bottom">
		Voucher No.: <u><b><%=WI.fillTextValue("jv_number")%></b></u><br>
		Voucher Date: <u><b><%=vJVInfo.elementAt(1)%></b></u>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" colspan="3" class="thinborderTOPLEFTBOTTOM"><div align="center"><b><font size="2">JOURNAL VOUCHER </font></b></div></td>
        </tr>
        <tr>
...
bolAddLine  = true;
	strTemp = (String)vGroupInfo.elementAt(i);//group number;%>
			...
			q = q - 5;
				...
				<tr>
					<td class="thinborderLEFT"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=vGroupInfo.elementAt(i + 1)%><br>&nbsp;</td>

      ...
      <td height="10" colspan="4">
	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
			  ...
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">RECEIVED PAYMENT</td>
		  	</tr>
			<tr align="center" valign="bottom">
			  <td height="40" style="font-size:10px; font-weight:bold">__________________</td>
			  <td style="font-size:10px; font-weight:bold">__________________</td>
			  <td style="font-size:10px; font-weight:bold">__________________</td>
			  <td style="font-size:10px; font-weight:bold">__________________</td>
		  	</tr>
			<tr align="center" valign="top">
			  <td width="25%"><%=(String)request.getSession(false).getAttribute("first_name")%></td>
			  <td width="25%">ANGELES A. RESTAURO<br>Admin Head</td>
			  <td width="25%">JUNICHI KANDA<br>General Manager</td>
			  <td width="25%">Payee<br><%=vJVInfo.elementAt(5)%>
			  </td>
			</tr>
		</table>	  
	</td>

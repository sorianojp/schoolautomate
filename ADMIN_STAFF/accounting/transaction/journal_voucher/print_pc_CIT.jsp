...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3" align="center"><font size="2">CEBU INSTITUTE OF TECHNOLOGY-UNIVERSITY<br>
	<font size="1">Cebu City<br>  
          <br>  
    <strong>ACCOUNTING AND FINANCE</strong></font></td>
  </tr>
  <tr>
    <td width="11%">Pay To </td>
    <td height="18" width="62%"><u><%=vJVInfo.elementAt(5)%></u></td>
    <td style="font-size:12px;" width="27%">Voucher No.: <u><b><%=WI.fillTextValue("jv_number")%></b></u></td>
  </tr>
  <tr>
    <td>Amount </td>
    <td height="18"><u><label id="sum_1"></label></u></td>
    <td style="font-size:12px;">Voucher Date: <u><b><%=vJVInfo.elementAt(1)%></b></u></td>
  </tr>
</table>
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25"><div align="center"><b><font size="2">PETTY CASH  VOUCHER </font></b></div></td>
        </tr>
	</table>
...
int iLinePrinted = 0;
 ...
 <%}%>
        <tr>
          <td height="180" colspan="3" class="thinborderALL" valign="top">
<%

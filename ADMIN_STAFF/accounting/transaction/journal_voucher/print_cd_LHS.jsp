...
<%
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr >
      <td width="11%" align="center"><img src="../../../../images/logo/LHS.jpg" width="170" height="80"></td>
      <td width="55%" height="25" align="center"><font size="2">
...
<%if(!bolIsCLDH && !strSchCode.startsWith("AUF") && !strSchCode.startsWith("UDMC")){%>	
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" valign="bottom" style="font-size:16px; font-weight:bold" align="center"> DISBURSEMENT VOUCHER</tr>
    <tr> 
    ...
    <tr>
      <td height="10" colspan="4">
	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td width="25%" height="35" align="center" valign="bottom"><u><%=(String)request.getSession(false).getAttribute("first_name")%></u></td>
				<td width="25%">&nbsp;</td>
			  <td width="25%" valign="top" align="center" style="font-size:10px; font-weight:bold">&nbsp;</td>
				<td width="25%" valign="top" align="center" style="font-size:10px; font-weight:bold">APPROVED FOR PAYMENT<BR><BR>
				<%
			...
			<tr>
			  ...
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">&nbsp;</td>
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">FINANCE MANAGER </td>
		  </tr>
		</table>	  </td>
    </tr>
<%}%>

...
if(strSchCode.startsWith("UPH")) {
	strVerifiedBy = "Chief Accountant";	
	strApprovedBy = "Chief Finance Officer";	
}
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="66%"><div align="center"><font size="2"> <strong><%=SchoolInformation.getSchoolName(dbOP,true,false)%></strong><br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr align="center" valign="top">
          ...
          <td class="thinborderNONE">&nbsp;</td>
          <td class="thinborderNONE"><%=strVerifiedBy%></td>
          <td class="thinborderNONE">&nbsp;</td>
          <td class="thinborderNONE"><%=strApprovedBy%></td>
        </tr>
</table>        
<table width="100%">
<tr>

  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr >
	  ...
	  <%if(!bolIsCLDH && !strSchCode.startsWith("UDMC")){%>
			...
			<%if(!strSchCode.startsWith("AUF") && !strSchCode.startsWith("UDMC")){%>Date & time Printed :<%}%>
...
<%if(!bolIsCLDH && !strSchCode.startsWith("AUF") && !strSchCode.startsWith("UDMC")){%>	
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
	  ...
	  <%if(iVoucherType == 2){%>PETTY CASH VOUCHER<%}else if(iVoucherType == 0){%>JOURNAL VOUCHER <%}else{%>
	   DISBURSEMENT
VOUCHER	   
<%}%>
    </tr>
      ...
      <td height="10" colspan="4">
	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
			  ...
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">PAYMENT RECEIVED BY</td>
		  	</tr>
			<tr align="center" valign="bottom">
			  <td height="40" style="font-size:10px; font-weight:bold"><u><%=(String)request.getSession(false).getAttribute("first_name")%></u></td>
			  <td style="font-size:10px; font-weight:bold">__________________</td>
			  <td style="font-size:10px; font-weight:bold"><u><%=vJVInfo.elementAt(5)%></u></td>
		  	</tr>
			<tr align="center" valign="top">
			  <td width="25%">&nbsp;</td>
			  <td width="25%">Admin Head</td>
			  <td width="25%">Payee
			  <br></td>
			</tr>
		</table>	  

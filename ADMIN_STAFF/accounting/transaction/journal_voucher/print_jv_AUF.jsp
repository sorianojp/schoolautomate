...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td height="25" colspan="2" class="thinborderTOPLEFTBOTTOM"><div align="center"><b><font size="3">JOURNAL VOUCHER </font></b></div></td>
          <td width="19%" height="25"  class="thinborderALL"><div align="right">JV No.: <u><b><%=WI.fillTextValue("jv_number")%></b></u>&nbsp;&nbsp;</div></td>
        </tr>
        <tr>
...
<%}%>		  
        ...
        <tr>
          ...
          <td height="25" colspan="2" class="thinborderBOTTOMRIGHT">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=CommonUtil.getNameForAMemberType(dbOP, "Chief Accountant & Budget Offi",4)%></td>
          </tr>
      </table>        
<table width="100%">
<tr>

...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Accounting-Transaction","edit_explanation.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
String strGroupNo  = WI.fillTextValue("group_no");

if(WI.fillTextValue("page_action").length() > 0) {//edit explanation..


}

%>
<form action="./edit_explanation.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
...
<%=dbOP.loadCombo("distinct payee_name","PAYEE_NAME"," from AC_JV where IS_CD = "+strIsCD+" order by AC_JV.payee_name", null, false)%>
        </select>
	  </td>
	</tr>
      <td height="25">&nbsp;</td>
...
if(strIsCD.equals("1") && strSchCode.startsWith("AUF") && strJVType.equals("10")){%>
    <tr>
      <td height="25">&nbsp;</td>
...
%>
	  <textarea name="explanation" rows="12" cols="90" class="textbox" style="font-size:10px;"

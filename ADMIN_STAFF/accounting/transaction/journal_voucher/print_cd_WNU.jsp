...
<%if(iVoucherType > 0){%>
    ...
    <tr>
      ...
      <td height="25" colspan="2" style="font-size:12px; font-weight:bold">
	  	<%if(!bolIsCLDH){%>Amount :
		 <%=new ConversionTable().convertAmoutToFigure(Double.parseDouble((String)vJVInfo.elementAt(8)),"Pesos","Centavos")%>
		(<%=CommonUtil.formatFloat((String)vJVInfo.elementAt(8), true)%>)<%}%></td>
      <td height="25" style="font-size:12px; font-weight:bold"><%if(bolIsCLDH){%>
        <%=CommonUtil.formatFloat((String)vJVInfo.elementAt(8), true)%>
      <%}%></td>
    </tr>
      ...
      <td height="10" colspan="4">
	  	<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				...
				<td width="25%" valign="top" align="center" style="font-size:10px; font-weight:bold">CHECKED BY </td>
			...
			<tr>
			  ...
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">BUDGET OFFICER </td>
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">COMPTROLLER</td>
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold"><%if(iVoucherType == 2){%>CASHIER<%}else{%>
			  VPF
			    <%}%></td>
		  </tr>
			<tr>
			...
			<tr>
			  ...
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">&nbsp;</td>
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">&nbsp;</td>
			  <td valign="bottom" align="center" style="font-size:10px; font-weight:bold">PAYEE</td>
		  </tr>
		</table>	  </td>
    </tr>
<%}%>

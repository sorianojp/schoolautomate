...
<%if(!bolIsPrintCalled){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable2">
    <tr> 
      ...
      <td width="15%"><%if(bolIsSchool){%>School<%}else{%>Fiscal<%}%> Year</td>
      <td width="79%">
<%
...
<input type="submit" name="1232" value=" Refresh " style="font-size:11px; height:22px;border: 1px solid #FF0000;"
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable3">
    <tr> 
      ...
      <td width="15%"><%if(bolIsSchool){%>College<%}else{%>Division<%}%></td>
      <td width="79%">
...
<%}%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td width="15%" height="25" class="thinborder" align="center" style="font-size:9px; font-weight:bold"><%if(bolIsSchool){%>College<%}else{%>Division<%}%>/DEPT</td>
...
%>
    <tr> 
      ...
      <td class="thinborder" align="right"><%=CommonUtil.formatFloat(((Double)vRetResult.elementAt(i + 12)).doubleValue(), true)%></td>
      <td class="thinborder" align="right" style="color: #FF0000; font-weight:bold">
	  <%=vRetResult.elementAt(i + 11)%></td>
<%if(!bolIsPrintCalled){%>

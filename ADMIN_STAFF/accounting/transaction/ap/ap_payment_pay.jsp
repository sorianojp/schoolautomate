...
<form name="form_" method="post" action="ap_payment_scheduled_not_paid.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
	  ...
	  <strong>:::: PAYMENT RECORDING PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr bgcolor="#FFFFFF">
      <td width="3%">&nbsp;</td>
      <td width="22%" height="25">Supplier</td>
      <td width="75%">&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
<%if(vRetResult != null) {%>
  ...
  <tr bgcolor="#B4C5D6"> 
    <td width="35%" align="center" class="thinborder" style="font-size:9px; font-weight:bold">Item Name </td>
    <td width="20%" align="center" class="thinborder" style="font-size:9px; font-weight:bold">Amount requested for Releasing </td>
    <td width="20%" align="center" class="thinborder" style="font-size:9px; font-weight:bold">To be paid </td>
    <td width="20%" align="center" class="thinborder" style="font-size:9px; font-weight:bold">To be Paid on or before </td>

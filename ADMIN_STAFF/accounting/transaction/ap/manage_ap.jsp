...
<body bgcolor="#D2AE72">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" align="center"><font color="#FFFFFF" ><strong>:::: MANAGE A/P INFORMATION ::::</strong></font></td>
    </tr>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="2%">&nbsp;</td>
    <td width="71%"><a href="./manage_ap_type.jsp">Manage AP Payee Type</a></td>
  </tr>
  <tr> 
    <td width="12%" height="25">&nbsp;</td>
    <td width="15%" height="25">&nbsp;</td>
    <td width="2%" align="center">&nbsp;</td>
    <td width="71%"><a href="./manage_ap_basic_info.jsp">Manage AP Basic Information</a> </td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
  ...
  <tr>
    ...
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./encode_debit_credit.jsp">Debit/Credit/Adjustment</a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./ledger.jsp">View Ledger(Only Debit credit encoded information) </a></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./ledger_detail.jsp">View Ledger Detail</a></td>
  </tr>
</table>

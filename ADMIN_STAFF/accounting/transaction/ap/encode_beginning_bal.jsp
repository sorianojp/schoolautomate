...
//end of authenticaion code.
	...
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),"Admin/staff-Accounting-Transaction-A/P Encode Begining Balance","encode_beginning_bal.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//authenticate this user.
	...
	if(strTemp.length() > 0) {
		if(AP.operateOnStartingBalance(dbOP, request, Integer.parseInt(strTemp), "1") == null)
	...
	vRetResult = AP.operateOnStartingBalance(dbOP, request,4, "1");	
	if(vRetResult == null && strErrMsg == null)
		strErrMsg = AP.getErrMsg();
	
	//get vEditInfoIf it is called.
	if(strPrepareToEdit.compareTo("1") == 0) {
		vEditInfo = AP.operateOnStartingBalance(dbOP, request,3, "1");
		if(vEditInfo == null)
			strErrMsg = AP.getErrMsg();
	}
...
function CancelOperation() {
	...
	location = "./encode_beginning_bal.jsp"+strPayeeType;
}
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./encode_beginning_bal.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" align="center" bgcolor="#A49A6A"><font color="#FFFFFF">
	  <strong>:::: ENCODE BEGINNING BALANCE PAGE ::::</strong></font></td>
    </tr>
    <tr>
...
if(vRetResult != null && vRetResult.size() > 0) {%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr>
      <td height="25" colspan="7" align="center" bgcolor="#B4C5D6" class="thinborder"><strong><font color="#000000">:: Old Accounts Encoded :: </font></strong></td>
    </tr>
    <tr>
      ...
      <td width="12%" class="thinborder"><strong>Debit</strong></td>
      <td width="13%" class="thinborder"><strong>Credit</strong></td>

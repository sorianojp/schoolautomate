...
<body bgcolor="#D2AE72">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td width="100%" height="25" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: BUDGET REPORTS ::::</strong></font></div></td>
		</tr>
	</table>
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
		...
		<tr>
		    ...
		    <td width="2%">&nbsp;</td>
		    <td width="68%"><a href="budget_status.jsp">Budget Status </a></td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		    <td height="25"><a href="budget_status_comparison.jsp">Budget Status Comparison </a></td>
		</tr>
		<tr>
			<td colspan="3" height="25">&nbsp;</td>
		</tr>

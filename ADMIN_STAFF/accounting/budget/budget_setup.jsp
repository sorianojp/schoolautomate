...
//I have to make sure AC_BUDGET_SETUP_CATG_INV_LINK is already set up.
strTemp = "select count(*) from AC_BUDGET_SETUP_CATG_INV_LINK where is_valid =1 ";
strTemp = dbOP.getResultOfAQuery(strTemp, 0);
if(strTemp == null || strTemp.equals("0")) {
	strErrMsg = "Budget Category is not yet linked to Inventory Category/Classification.";
	bolFatalErr = true;
}
%>
...
<form name="form_" action="./budget_setup.jsp" method="post">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		...
		<tr>
			...
			<td colspan="2"><strong><font size="4" color="#FF0000"><%=WI.getStrValue(strErrMsg)%></font></strong></td>
		</tr>
<%if(!bolFatalErr){%>
		<tr>
			<td height="25" width="3%">&nbsp;</td>
		...
		<tr>
			...
			<td>
				<%
					...
					strErrMsg = " from ac_budget_setup_catg where is_valid = 1 and exists (select CATG_INV_LINK_INDEX from "+
					"AC_BUDGET_SETUP_CATG_INV_LINK where ac_budget_setup_catg.catg_index =BUDGET_CATG_INDEX) order by catg_name ";
				%>
...
<%}//do not show if inventory category is not linked%>
		<tr>

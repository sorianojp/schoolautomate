...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-System Administrator-Override Parameters","budget_entry_super_user.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(SP.operateOnETO(dbOP,request, Integer.parseInt(strTemp), 1) != null )
		strErrMsg = "Successful";
	else
		strErrMsg = SP.getErrMsg();
}

Vector vRetResult = SP.operateOnETO(dbOP, request, 4, 1);
...
if(strErrMsg == null) 
	strErrMsg = "";
%>
<form name="form_" action="./budget_entry_super_user.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>::::
          BUDGET SUPER USER  ::::</strong></font></div></td>
    </tr>
  </table>
 ...
 <%if(vRetResult != null) {%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#CCCCCC">
      <td height="25" colspan="4" align="center" class="thinborder" style="font-weight:bold; font-size:9px;">LIST OF BUDGET SUPER USER </td>
    </tr>

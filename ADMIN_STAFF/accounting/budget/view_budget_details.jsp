...
<%if(vBudgetInfo != null && vBudgetInfo.size() > 0){%>
	<table width="100%" bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			...
			<td><%=CommonUtil.formatFloat((String)vBudgetInfo.elementAt(3), true)%></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
			<td>Charge to: </td>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="12%" align="center" class="thinborder"><strong>Voucher Date </strong></td>
			<td width="23%" align="center" class="thinborder"><strong>Voucher No. </strong></td>
	...
	<input type="hidden" name="is_locked" value="<%=WI.fillTextValue("is_locked")%>">
</form>
</body>
</html>
<%

...
%>
	...
	%>
		...
		%>		
			<td class="thinborder"><%=CommonUtil.formatFloat(strTemp, true)%></td>
		<%}
		
			dGrandTotal += dRowTotal;
		%>
			<td class="thinborder"><%=CommonUtil.formatFloat(dRowTotal, true)%></td>
		</tr>
	<%}%>
		<tr>
			<td height="25" class="thinborder">TOTAL</td>
		<%for(int i = 0; i < dTotal.length; i++){%>
			<td class="thinborder"><%=CommonUtil.formatFloat(dTotal[i], true)%></td>
		<%}%>
			<td class="thinborder"><%=CommonUtil.formatFloat(dGrandTotal, true)%></td>
		</tr>
	</table>
<%}

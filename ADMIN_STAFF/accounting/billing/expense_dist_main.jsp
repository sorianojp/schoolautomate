...
<title>Expense Distribution Management</title>
<style type="text/css">
	a{
...
<body bgcolor="#D2AE72">
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
		...
		<tr>
		    ...
		    <td width="2%">&nbsp;</td>
		    <td width="68%"><a href="./expense_account.jsp">Expense Account </a></td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		    <td height="25"><a href="./expense_amount.jsp">Expense Amount</a></td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		    <td height="25"><a href="./expense_distribution_report.jsp">Expense Distribution Report</a></td>
		</tr>
		<tr>
			<td colspan="3" height="25">&nbsp;</td>
		</tr>

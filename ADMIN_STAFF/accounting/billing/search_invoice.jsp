...
<script language="javascript">
	...
	function PrintPg(){
		if(document.form_.catg_index.value.length > 0)
			document.form_.category_name.value = document.form_.catg_index[document.form_.catg_index.selectedIndex].text;
		else
			document.form_.category_name.value = "All";
			
		if(document.form_.invoice_no.value.length > 0)
			document.form_.invoice_no_name.value = document.form_.invoice_no_con[document.form_.invoice_no_con.selectedIndex].text + 
				' ' + document.form_.invoice_no.value;
		else
			document.form_.invoice_no_name.value = "All";
		
		if(document.form_.chargeto.value.length > 0)
			document.form_.chargeto_name.value = document.form_.chargeto_con[document.form_.chargeto_con.selectedIndex].text + 
				' ' + document.form_.chargeto.value;
		else
			document.form_.chargeto_name.value = "All";
...
<%
	...
	String[] astrSortByName    = {"Invoice No","Invoice Date","Charge To"};
	String[] astrSortByVal     = {"invoice_no","invoice_date","chargeto_name"};
		...
		<tr>
		    ...
		    <td>
				<select name="catg_index">
          			...
          			<%=dbOP.loadCombo("catg_index","catg_code + ' ' + catg_name", " from ac_tun_invoice_catg where is_valid = 1", WI.fillTextValue("catg_index"),false)%> 
        		</select></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
		    ...
		    <td>
				<select name="invoice_no_con">
					<%=billTsu.constructGenericDropList(WI.fillTextValue("invoice_no_con"),astrDropListEqual,astrDropListValEqual)%> 
    			</select>
				<input type="text" name="invoice_no" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
					onBlur="style.backgroundColor='white'" size="32" maxlength="32" value="<%=WI.fillTextValue("invoice_no")%>"></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
		    <td>Charge To: </td>
		    <td>
				<select name="chargeto_con">
					<%=billTsu.constructGenericDropList(WI.fillTextValue("chargeto_con"),astrDropListEqual,astrDropListValEqual)%> 
    			</select>
				<input type="text" name="chargeto" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
					onBlur="style.backgroundColor='white'" size="48" maxlength="128" value="<%=WI.fillTextValue("chargeto")%>"></td>
		</tr>
		<tr>

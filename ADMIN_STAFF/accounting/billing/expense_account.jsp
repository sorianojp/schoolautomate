...
<script language="javascript">
	...
	function UpdateTeams(strExpenseIndex){
		var pgLoc = "./expense_distribution.jsp?expense_index="+strExpenseIndex;	
		var win=window.open(pgLoc,"UpdateTeams",'width=900,height=350,top=110,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=yes,menubar=no');
		win.focus();
	}
...
<%
	...
	if (WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./expense_account_print.jsp" />
	<% 
		return;}
	...
	if(strTemp.length() > 0){
		if(billTsu.operateOnExpenseAccount(dbOP, request, Integer.parseInt(strTemp)) == null)
			strErrMsg = billTsu.getErrMsg();
		else{
			if(strTemp.equals("0"))
				strErrMsg = "Expense account information successfully removed.";
			if(strTemp.equals("1"))
				strErrMsg = "Expense account information successfully recorded.";
			if(strTemp.equals("2"))
				strErrMsg = "Expense account information successfully edited.";
	...
	if(strPrepareToEdit.equals("1")){
		vEditInfo = billTsu.operateOnExpenseAccount(dbOP, request, 3);
		if(vEditInfo == null)
			strErrMsg = billTsu.getErrMsg();
	}
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./expense_account.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: EXPENSE ACCOUNT ::::</strong></font></div></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td height="25" width="3%">&nbsp;</td>
			<td width="22%">Expense Account  Name: </td>
			<td width="75%">
				<%
		...
		<tr>
			...
			<td>
				...
				%>
				<textarea name="remarks" style="font-size:12px" cols="40" rows="3" class="textbox" 
			...
			<td height="25" colspan="2">&nbsp;</td>
		  	<td>
				<%if(strPrepareToEdit.equals("0")) {%>
					...
					<font size="1">Click to save expense account.</font>
				    <%}else {
					if(vEditInfo!=null){%>
						<a href="javascript:PageAction('2', '<%=(String)vEditInfo.elementAt(0)%>');">
							<img src="../../../images/edit.gif" border="0"></a>
						<font size="1">Click to edit  expense account info.</font>
					    <%}
				}%>
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="25%" align="center" class="thinborder"><strong>Expense Acct. Name</strong></td>
			<td width="15%" align="center" class="thinborder"><strong>Effectivity Period</strong></td>
			<td width="28%" align="center" class="thinborder"><strong>Expense Distribution</strong></td>
	...
	%>
		<tr>
			...
			<td align="center" class="thinborder">
				<a href="javascript:UpdateTeams('<%=(String)vRetResult.elementAt(i)%>');">

...
<script language="javascript">
	...
	function RefreshPage() {
		...
		document.form_.proj_detail.value = "";
...
<%
	...
	if (WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./project_mgmt_print.jsp" />
	<% 
		return;}
	...
	if(strTemp.length() > 0){
		if(billTsu.operateOnProjects(dbOP, request, Integer.parseInt(strTemp)) == null)
			strErrMsg = billTsu.getErrMsg();
		else{
			if(strTemp.equals("0"))
				strErrMsg = "Project information successfully removed.";
			if(strTemp.equals("1"))
				strErrMsg = "Project information successfully recorded.";
			if(strTemp.equals("2"))
				strErrMsg = "Project information successfully edited.";
	...
	if(strPrepareToEdit.equals("1")){
		vEditInfo = billTsu.operateOnProjects(dbOP, request, 3);
		if(vEditInfo == null)
			strErrMsg = billTsu.getErrMsg();
	}
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./project_mgmt.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: PROJECT MANAGEMENT ::::</strong></font></div></td>
		</tr>
		<tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<td colspan="2">
				...
				%>
				<input type="text" name="project_name" value="<%=strTemp%>" class="textbox" 
		...
		<tr>
			...
			<td colspan="2">
				...
				%>
				<textarea name="proj_detail" style="font-size:12px" cols="40" rows="3" class="textbox" 
		...
		<tr>
			...
			<td colspan="2">
				<%if(strPrepareToEdit.equals("0")) {%>
					...
					<font size="1">Click to save proj information.</font>
				    <%}else {
					if(vEditInfo!=null){%>
						<a href="javascript:PageAction('2', '<%=(String)vEditInfo.elementAt(0)%>');">
						<img src="../../../images/edit.gif" border="0"></a>
						<font size="1">Click to edit proj information.</font>
					    <%}
				}%>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
		<tr>
			<td height="25" align="right">
				...
				<font size="1">Click to print projects list.</font></td>
		</tr>
	</table>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="6" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: PROJECT LISTING ::: </strong></div></td>
		</tr>
		<tr>

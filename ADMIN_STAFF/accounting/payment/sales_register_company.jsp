...
<%
	...
	if (WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./sales_register_company_print.jsp" />
	<% 
		return;}
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"ACCOUNTING-BUDGET","sales_register_company.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="sales_register_company.jsp" method="post">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="4" bgcolor="#A49A6A"><div align="center">

				<font color="#FFFFFF"><strong>:::: PER COMPANY ::::</strong></font></div></td>
		</tr>
		<tr>
...
%>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<%for(int i = 0; i < vActivities.size(); i += 3){%>
			<td width="<%=iWidth%>%" align="center" class="thinborder"><strong><%=(String)vActivities.elementAt(i+1)%></strong></td>
		<%}%>
		</tr>

...
for(; i < vRetResult.size(); i += 8){
	...
	if(WI.getStrValue(vRetResult.elementAt(i + 6),"0.00").equals("0.00") && 
		WI.getStrValue(vRetResult.elementAt(i + 7),"0.00").equals("0.00"))
			continue;
...
%>
    <tr> 
      <td height="21"><%=vRetResult.elementAt(i + 2)%></td>

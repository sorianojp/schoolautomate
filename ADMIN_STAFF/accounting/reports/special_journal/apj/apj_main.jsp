...
utility.DBOperation dbOP = new utility.DBOperation(-1);
	...
	if(WI.fillTextValue("print_pg").length() > 0) {%>
		<jsp:forward page="./apj_print.jsp"/>
	<%}
%>
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./apj_main.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A" align="center"><font color="#FFFFFF">
	  <strong>:::: AP JOURNAL  ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td><select name="report_format" onChange="document.form_.print_stat.value='';document.form_.print_pg.value='';document.form_.submit();">
...
%>
    ...
    <tr> 
      ...
      <td width="86%">
<%
if(strReportType.equals("0") || strReportType.length() == 0){%>
...
<%}else if(strReportType.equals("1") || strReportType.equals("4")){//monthly or yearly..
	if(strReportType.equals("1")){%>
...
<%}%>      </td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
	  ...
	  <!--<input type="checkbox" name="show_not_locked" value="checked" <%=WI.fillTextValue("show_not_locked")%>>
	  Show Not yet Locked --></td>
    </tr>
    <tr> 

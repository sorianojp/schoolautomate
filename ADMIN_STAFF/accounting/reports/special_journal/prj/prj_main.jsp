...
utility.DBOperation dbOP = new utility.DBOperation(-1);
	...
	if(WI.fillTextValue("print_pg").length() > 0) {
		...
		<%}else{%>
			<jsp:forward page="./prj_print.jsp"/>
		<%}
	}
%>
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./prj_main.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A" align="center"><font color="#FFFFFF">
	  <strong>:::: PR JOURNAL  ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td><select name="report_format" onChange="document.form_.print_pg.value='';document.form_.submit();">
...
%>
  ...
  <input type="hidden" name="jv_type" value="5">
</form>
</body>
</html>

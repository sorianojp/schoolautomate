...
utility.DBOperation dbOP = new utility.DBOperation(-1);
	...
	if(WI.fillTextValue("print_pg").length() > 0) {
		...
		<%}else{%>
			<jsp:forward page="./crj_print.jsp"/>
		<%}
	}
%>
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./crj_main.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A" align="center"><font color="#FFFFFF">
	  <strong>:::: CASH RECEIPT JOURNAL  ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
%>
  ...
  <input type="hidden" name="jv_type" value="4">
</form>
</body>
</html>

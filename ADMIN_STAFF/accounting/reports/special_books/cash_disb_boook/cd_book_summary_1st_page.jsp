...
function ShowDetail(strPrintStat) {
	...
	location = "./cd_book_summary.jsp?show_detail="+strPrintStat+strDateCon+
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./cd_book_summary_1st_page.jsp">
<%if(strErrMsg != null) {%>
...
<%dbOP.cleanUP();return;}%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
	  ...
	  <strong>:::: DISBURSEMENT BOOK - SUMMARY ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">

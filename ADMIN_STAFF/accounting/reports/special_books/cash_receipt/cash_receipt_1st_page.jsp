...
if(WI.fillTextValue("print_pg").equals("1")){
	...
	if(strSchCode.startsWith("CIT")){%>
		<jsp:forward page="./cash_receipts_print_cit.jsp" />
	<%}else{%>
		<jsp:forward page="./cash_receipts_print_auf.jsp" />
	<%}
...
<body bgcolor="#D2AE72">
<form name="form_" method="post" action="./cash_receipt_1st_page.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A" align="center"><font color="#FFFFFF">
	  <strong>:::: CASH RECEIPT BOOK  ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">

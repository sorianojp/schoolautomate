...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#A77A81" class="thinborder" >
    <tr> 
      <td height="25" colspan="6" style="font-weight:bold; font-size:14px; color:#FF0000" align="center" bgcolor="#cccccc" class="thinborder">Cash Receipt Not Yet Encoded</td>
    </tr>
...
double dShort      = 0d;%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFCC" class="thinborder">
    <tr> 
      <td height="25" colspan="7" style="font-weight:bold; font-size:14px; color:#0000FF" align="center" bgcolor="#cccccc" class="thinborder">Cash Receipt Already Encoded</td>
    </tr>
		<tr align="center" style="font-weight:bold"> 
	...
	%>
		<tr> 
		  ...
		  <td class="thinborder"><%=CommonUtil.formatFloat(-1 * dShort, true)%></td>

...
<%
	...
	if(WI.fillTextValue("csv_").length() > 0) {%>
		<jsp:forward page="./general_ledger_csv.jsp"/>
	<%return;
	}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Accounting-Reports-Bir Reports-AR Students","general_ledger.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(WI.fillTextValue("generate_").length() > 0) {
	vRetResult = reportBIR.generateGeneralLedger(dbOP, request);
	if(vRetResult == null)
		strErrMsg = reportBIR.getErrMsg();
}
%>

<form name="form_" action="./general_ledger.jsp" method="post" onSubmit="SubmitOnceButton(this);return ShowProcessing();">
<input type="hidden" name="generate_">
<input type="hidden" name="csv_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>:::: GENERAL LEDGER ::::</strong></font></div></td>
    </tr>
  </table>
...
-
    ...
    <tr>
	  ...
	  <input type="submit" name="122" value="Generate General Ledger" style="font-size:11px; height:24px;border: 1px solid #FF0000;" 

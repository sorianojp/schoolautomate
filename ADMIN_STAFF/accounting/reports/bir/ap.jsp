...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Accounting-Reports-Bir Reports-AR Students","ap.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(WI.fillTextValue("generate_").length() > 0) {
	vRetResult = reportBIR.generateAP(dbOP, request);
	if(vRetResult == null)
		strErrMsg = reportBIR.getErrMsg();
}
%>

<form name="form_" action="./ap.jsp" method="post" onSubmit="SubmitOnceButton(this);return ShowProcessing();">
<input type="hidden" name="generate_">
<input type="hidden" name="csv_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6"><div align="center"><font color="#FFFFFF"><strong>:::: Accounts Payable ::::</strong></font></div></td>
    </tr>
  </table>
...
-
    ...
    <tr>
	  ...
	  <input type="submit" name="122" value="Generate AP" style="font-size:11px; height:24px;border: 1px solid #FF0000;" 
...
<%if(vRetResult != null && vRetResult.size() > 0) {%>
  	...
  	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder" bgcolor="#FFFFFF" >
		<tr style="font-weight:bold" bgcolor="#FFFFCC">
			...
			<td class="thinborder" width="10%"> Particular </td>
			<td class="thinborder" width="20%">Supplier Name </td>

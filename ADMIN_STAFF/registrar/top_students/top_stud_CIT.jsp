...
function UpdateSubExcluded() {
	window.open("./gwa_sub_excluded.jsp","PrintWindow",'width=800,height=600,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
}
function UpdateGWA() {
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-TOP STUDENTS","top_stud_CIT.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form name="form_" action="./top_stud_CIT.jsp" method="post" onSubmit="SubmitOnceButton(this);">
...
%>
    ...
    <tr>
	  ...
	  <table width="75%" cellpadding="0" cellspacing="0" border="0" class="thinborder">
	  <%if(false){
	  rs = dbOP.executeQuery("select sub_code, sub_name from subject join GWA_EXCLUDED on (GWA_EXCLUDED.sub_index = subject.sub_index) order by sub_code");
	  while(rs.next()){%>
	  	<tr bgcolor="#EEFEFF">
...
%>
<%=strTemp%></strong></td>
      <td width="51%" align="right" class="thinborderNONE">Date &amp; time printed: <%=WI.getTodaysDateTime()%>&nbsp;</td>
    </tr>
  </table>

  <table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborder" id="myADTableContent">
    <tr style="font-weight:bold">
      <td width="2%" rowspan="2" align="center" class="thinborder" style="font-size:9px">#</td>
      <td width="15%" height="25" rowspan="2" align="center" class="thinborder" style="font-size:9px">STUDENT ID</td>
      <td width="30%" colspan="3" align="center" class="thinborder" style="font-size:9px">STUDENT NAME</td>
      <td width="8%" rowspan="2" align="center" class="thinborder" style="font-size:9px">COURSE</td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">YEAR</td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">TOTAL  UNITS</td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">PE UNITS </td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">NSTP UNITS </td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">BRACKETED</td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">ACAD UNITS </td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">GWA</td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">MIN GRADE </td>
      <td width="5%" rowspan="2" align="center" class="thinborder" style="font-size:9px">SUM OF PRODUCTS </td>
    </tr>
    <tr style="font-weight:bold">
      <td align="center" class="thinborder" style="font-size:9px" width="10%">First Name </td>
      <td align="center" class="thinborder" style="font-size:9px" width="10%">Middle Name </td>
      <td align="center" class="thinborder" style="font-size:9px" width="10%">Last Name </td>
    </tr>
<%int iIndexOf = 0;
...
if(vCITInfo != null) {
	...
	if(iIndexOf > -1) {
		strFName  = (String)vCITInfo.elementAt(iIndexOf + 1);
		strMName  = (String)vCITInfo.elementAt(iIndexOf + 2);
		strLName  = (String)vCITInfo.elementAt(iIndexOf + 3);


		vOthInfo = (Vector)vCITInfo.elementAt(iIndexOf + 4);//System.out.println(vOthInfo);

		strCourseYr = (String)vOthInfo.elementAt(0);
		strYear = (String)vOthInfo.elementAt(1);
		strPEUnits  = (String)vOthInfo.elementAt(2);
		strNSTPUnits = (String)vOthInfo.elementAt(3);
		strBracketed = (String)vOthInfo.elementAt(4);
		strAcadUnits = (String)vOthInfo.elementAt(5);
		strMinGrade  = (String)vOthInfo.elementAt(6);
		strSumOfProd = (String)vOthInfo.elementAt(7);	
		
		dTotalUnits += Double.parseDouble((String)vOthInfo.elementAt(3));//if(vTopStudInfo.elementAt(i).equals("2011-00884")) System.out.println(dTotalUnits);
		//because bracketed is not part of GWA computation.. 
		dTotalUnits += Double.parseDouble((String)vOthInfo.elementAt(4));//if(vTopStudInfo.elementAt(i).equals("2011-00884")) System.out.println(dTotalUnits);
	}
}
//dTotalUnits += Double.parseDouble((String)vTopStudInfo.elementAt(i+2));if(vTopStudInfo.elementAt(i).equals("2011-00884")) System.out.println(dTotalUnits);
dTotalUnits += Double.parseDouble((String)vTopStudInfo.elementAt(i+2));//if(vTopStudInfo.elementAt(i).equals("2011-00884")) System.out.println(dTotalUnits);
%>
    <tr>
      ...
      <td class="thinborder"><%=WI.getStrValue(strFName, "&nbsp;")%></td>
      <td class="thinborder"><%=WI.getStrValue(strMName, "&nbsp;")%></td>
      <td class="thinborder"><%=WI.getStrValue(strLName, "&nbsp;")%></td>
      <td class="thinborder"><%=WI.getStrValue(strCourseYr,"&nbsp;")%></td>
      <td class="thinborder"><%=WI.getStrValue(strYear,"&nbsp;")%></td>
      <td align="center" class="thinborder"><%=dTotalUnits%></td>

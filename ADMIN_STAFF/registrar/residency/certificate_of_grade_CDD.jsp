...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<tr><td height="60px;" align="right" valign="bottom"><%=WI.getTodaysDate(6)%></td></tr>
	<tr><td height="40px;" valign="bottom">TO WHOM IT MAY CONCERN:</td></tr>
	<tr>
		<td style="text-indent:50px;" height="40px" valign="bottom">This is to certify that <strong><%=WI.formatName((String)vResSummary.elementAt(1),(String)vResSummary.elementAt(2),(String)vResSummary.elementAt(3),7)%></strong> took the following subjects 
in <strong><%=(String)vResSummary.elementAt(6)%></strong>:</td>
	</tr>
...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <tr>
	...
	This certification is issued upon request of <strong><%=WI.formatName((String)vResSummary.elementAt(1),(String)vResSummary.elementAt(2),(String)vResSummary.elementAt(3),7)%></strong> for <%=WI.fillTextValue("remarks")%> purposes only.
     </td>
  </tr>
  <%}%>
...
&nbsp;
	...
	<div align="center">
		<strong><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"Registrar",7))%></strong><br>
        Registrar
	</div>		
	</td>
  </tr>

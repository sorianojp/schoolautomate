...
<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage()">
	...
	<tr>
	    <td height="22" colspan="5" align="center" class="thinborder">Program Profile</td>
    </tr>
	<tr>
		<td height="22" class="thinborder" width="21%" align="center"><strong>Full Qualification (WTR)</strong></td>
		<td class="thinborder" width="17%" align="center"><strong>Qualification (Clustered)</strong></td>
		<td class="thinborder" width="20%" align="center"><strong>Qualification (NTR)</strong></td>
		<td class="thinborder" width="18%" align="center"><strong>CoPR Number</strong></td>
		<td class="thinborder" width="24%" align="center"><strong>Delivery Mode</strong></td>		
	</tr>
	...
	<tr>
		...
		if(vRetResult != null && vRetResult.size() > 0){
			...
			if(iIndexOf > -1)
				strTemp = (String)vRetResult.elementAt(iIndexOf+2);
		...
		if(vRetResult != null && vRetResult.size() > 0){
			iIndexOf = vRetResult.indexOf(vGradList.elementAt(i));
			if(iIndexOf > -1)
				strTemp = (String)vRetResult.elementAt(iIndexOf+3);
		...
		if(vRetResult != null && vRetResult.size() > 0){
			iIndexOf = vRetResult.indexOf(vGradList.elementAt(i));
			if(iIndexOf > -1)
				strTemp = (String)vRetResult.elementAt(iIndexOf+5);
		...
		if(vRetResult != null && vRetResult.size() > 0){
			iIndexOf = vRetResult.indexOf(vGradList.elementAt(i));
			if(iIndexOf > -1)
				strTemp = (String)vRetResult.elementAt(iIndexOf+6);
...
function PrintNextPage() {	
	if(!confirm("Click Ok to print next page and Cancel to stay in this page."))
		return;	
	location = "./terminal_report_print_page3.jsp?sy_from="+<%=WI.fillTextValue("sy_from")%>+

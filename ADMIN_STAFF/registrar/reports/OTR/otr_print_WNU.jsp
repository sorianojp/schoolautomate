...
//hardcoded to degree type.. 
if(WI.fillTextValue("stud_id").equals("06-90004"))
	strDegreeType = "0";
...
<%if(strDegreeType.equals("1")) {///different for masteral%>
...
%>
  ...
  <tr>
    <td colspan="4" align="center" style="font-size:14px; font-weight:bold"><br>OTHER RECORD OF GRADUATION&nbsp;</td>
    </tr>
  <tr>
    <td colspan="4" align="center">
		<table width="65%" cellpadding="0" cellspacing="0" >
			<tr>
				...
				<td width="66%" align="center">SCHOOL</td>
...
%>			<%=strTemp%>		  </td>
  ...
  <tr>
    <td height="25" colspan="4" class="thinborderBottom">Degree: <%=strStudCourseName.toUpperCase()%></td>
  </tr>
  <tr>
...
%><%=strTemp%>	</td>
    <td>Major</td>
    <td><%if(bolRemoveMajor){%>&nbsp;<%}else{%><%=WI.getStrValue(strStudMajorToDisp)%><%}%></td>
  </tr>
  <tr>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Secondary</td>
    <td>
...
for(int i = 0 ; i < vRetResult.size(); i += 11){
	...
	if(iIndexOf > -1){	
		...
		/*
		for some reason, if this data will come out before the list of subjects all shown there will be problem with the multiple remarks
		for it will be showing not according  to the specified place in multiple remarks encoding.,
		*/
		strTemp = WI.getStrValue(vApprenticeInfo.elementAt(iIndexOf + 12));
		/*if(strTemp.length() > 0){
			vMulRemark.addElement();
		}*/
		
		for(int x = 0; x < vMulRemark.size(); x+=2){			
			iMulRemarkIndex = ((Integer)vMulRemark.elementAt(x)).intValue();
			iMulRemarkIndex = iMulRemarkIndex + 22;
			
			vMulRemark.setElementAt(new Integer(iMulRemarkIndex), x);
		}
...
String strSeaferingInfo = null; 
Vector vSeafering = new Vector();
...
if(strTemp.indexOf("WEST NEGROS UNIVERSITY") > -1) {
	if(vRetResult.elementAt(i+ 1) != null) {
		int iSY = Integer.parseInt((String)vRetResult.elementAt(i+ 1));
		if(iSY < 2008)
			strTemp = strTemp.substring(0,strTemp.indexOf("UNIVERSITY"))+" COLLEGE"+
							strTemp.substring(strTemp.indexOf("UNIVERSITY")+10);	
	}
...
else if(strTemp2.startsWith("4TH"))
	strTemp2 = "FOURTH "+strTemp2.substring(4);
...
%>
  <tr bgcolor="#FFFFFF"> 
    <td height="17" colspan="6"><strong><u><i><label id="000<%=i%>" onClick="Update('000<%=i%>')"><%=WI.getStrValue(strSeaferingInfo, "","&nbsp;","")%><%=WI.getStrValue(strTemp2,"",", ","").toUpperCase()%><%=strTemp%></label>
    </i></u></strong></td>
  </tr>
...
if(strSYSemToDisp.indexOf("WEST NEGROS UNIVERSITY") > 0) {
	if(vRetResult.elementAt(i+ 1) != null) {
		int iSY = Integer.parseInt((String)vRetResult.elementAt(i+ 1));
		if(iSY < 2008)
			strSYSemToDisp = strSYSemToDisp.substring(0,strSYSemToDisp.indexOf("UNIVERSITY"))+" COLLEGE"+
							strSYSemToDisp.substring(strSYSemToDisp.indexOf("UNIVERSITY")+10);	
	}
...
%>
   <tr bgcolor="#FFFFFF"> 
	   <td colspan="6"><strong><u><i><label id="000<%=i%>" onClick="Update('000<%=i%>')"><%=WI.getStrValue(strSeaferingInfo, "","&nbsp;","")%><%=strTemp%></label></i></u></strong></td>
   </tr>
<%strSYSemToDisp = null;}
...
%>   <td valign="top" class="thinborderNONE">
		...
		<%=WI.getStrValue(strThesisType, "<br><b>","</b>","")%></label>
	</td>
    <td valign="top" class="thinborderNONE">
		<label id="01<%=i%>" onClick="updateSubjectRow('01<%=i%>')"><%=WI.getStrValue((String)vRetResult.elementAt(i + 7),"&nbsp;")%>
...
%>
	...
	vRetResult.elementAt(i + 6) != null  && vRetResult.elementAt(i + 6 + 11) != null && 
		...
		strTemp = (String)vRetResult.elementAt(i + 9 + 11);
		strErrMsg = (String)vRetResult.elementAt(i + 8 + 11);
		i += 11;
	}else
		strErrMsg = "&nbsp;";
    ...
    <td width="15%" valign="top" class="thinborderNONE" align="center"><label id="04<%=i%>" onClick="updateSubjectRow('04<%=i%>')"><div align="center" style="width:100%; text-align:center;"><%=strErrMsg%></div></label></td>
    <%
...
if(vMulRemark != null && vMulRemark.size() > 0) {	
		...
		Vector vTempRemark = CommonUtil.convertCSVToVector((String)vMulRemark.remove(0), "##", true);
		while(vTempRemark.size() > 0) {//for wnu more remark column in one remark.. 
		strTemp = WI.getStrValue((String)vTempRemark.remove(0));
		iIndexOf = strTemp.indexOf(": ");
		if(iIndexOf == -1) {
			strCol1 = "Graduated: ";
			strCol2 = strTemp;
...
<%if(iLastPage != 1){
  ...
  <tr>
    <td width="9%" height="20"><font size="2">REMARKS:</font></td> 
    <td width="91%" class="thinborderBottom" align="center" valign="bottom" style="font-weight:bold"><font style="font-size:12px;"><%=strTemp%></font></td> 
  </tr>
<%}else{%>
  <tr>
    <td height="20"><font size="2">REMARKS:</font></td> 
    <td width="91%" class="thinborderBottom" valign="bottom"><font size="2"><%=WI.fillTextValue("addl_remark")%></font>&nbsp;</td> 
  </tr>
<%}%>  
</table>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="22%" height="23" valign="bottom" style="font-size:12px;">(NOT VALID WITHOUT</td>
    <td width="14%" valign="bottom" style="font-size:12px;">Prepared By :</td>
    <td width="21%" valign="bottom" style="font-size:12px;" class="thinborderBottom" align="left"><%=(String)request.getSession(false).getAttribute("first_name")%>&nbsp;</td>
    <td width="14%" valign="bottom" style="font-size:12px;">&nbsp;&nbsp;&nbsp;Reviewed By : </td>
    <td width="29%" valign="bottom" class="thinborderBottom" style="font-size:12px;">&nbsp;</td>
  </tr>
  <tr>
    <td height="20" valign="bottom" style="font-size:12px;"> UNIVERSITY SEAL)</td>
    <td valign="bottom" style="font-size:12px;">&nbsp;</td>
    <td valign="bottom" style="font-size:12px;" align="left">&nbsp;</td>
    <td valign="bottom" style="font-size:12px;">&nbsp;</td>
    <td valign="bottom" style="font-size:12px;">&nbsp;</td>
  </tr>
  <tr> 
    <td height="23" colspan="5" valign="bottom" align="center" style="font-weight:bold; font-size:12px;"><br><u><%=WI.fillTextValue("registrar_name")%></u><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr align="center">
    <td height="17" valign="bottom" style="font-size:8px;" width="30%">GRADING SYTEM UNTIL SUMMER 1999</td>
    <td valign="bottom" style="font-size:9px;" width="1%">&nbsp;</td>
    <td valign="bottom" style="font-size:8px;" width="30%">GRADING SYTEM UNTIL SUMMER 2007</td>
    <td valign="bottom" style="font-size:9px;" width="1%">&nbsp;</td>
    <td valign="bottom" style="font-size:8px;" width="38%">GRADING SYSTEM EFFECTIVE FIRST SEMESTER
      2007-2008</td>
  </tr>
  <tr>
    <td height="17" style="font-size:8px;" valign="top">(97-100)=1.0; (94-96)=1.25; (91-93)=1.5; (88-90)=1.75; (85-87)=2.0; (82-84)=2.25; (79-81)=2.5; (77-78)=2.75; (75-76)=3.0; (BELOW 75)=5.0</td>
    <td valign="bottom" style="font-size:8px;">&nbsp;</td>
    <td valign="bottom" style="font-size:8px;">(100)=1.0; (99)=1.1; (98)=1.2; (97)=1.3; (96)=1.4; (95)=1.5; (94)=1.6; (93)=1.7; (92)=1.8; (91)=1.9; (90)=2.0; (89)=2.1; (88)=2.2; (87)=2.3; (86)=2.4; (85)=2.5; (84)=2.6; (83)=2.7; (82)=2.8; (81)=2.9; (80)=3.0; (79)=3.1; (78)=3.2; (77)=3.3; (76)=3.4; (75)=3.5; (BELOW 75)=5.0</td>
    <td valign="bottom" style="font-size:8px;">&nbsp;</td>
    <td valign="top" style="font-size:8px;">(100)=1.0; (99)=1.1; (98)=1.2; (97)=1.3; (96)=1.4; (95)=1.5; (94)=1.6; (93)=1.7; (92)=1.8; (91)=1.9; (90)=2.0; (89)=2.1; (88)=2.2; (87)=2.3; (86)=2.4; (85)=2.5; (84)=2.6; (83)=2.7; (82)=2.8; (81)=2.9; (80)=3.0; (79)=3.1; (78)=3.2; (77)=3.3; (76)=3.4; (75)=3.5; (BELOW 75)=5.0; INC.	</td>
  </tr>
  <tr>
    <td height="17" colspan="5" valign="top" style="font-size:9px;">
	...
	<br>
	No incomplete (INC) mark effective Summer 2010.
	<br>
	WNU-REG-F07<br>
	REV 8(04-01-13)</td>
    </tr>

...
<body topmargin="0">
<form action="./otr_print_MARINERN.jsp" method="post" name="form_">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborderALL" onClick="PrintNextPage();">
  <tr> 
    <td height="15" colspan="9" class="fontsize9">&nbsp;</td>
  </tr>
  
  <tr> 
    <td height="15" colspan="3" class="fontsize9">&nbsp;GRADING SYSTEM</td>
    <td width="5%" class="fontsize9">1.75</td>
    <td width="8%" class="fontsize9">89 - 91</td>
    <td width="21%" class="fontsize9">Good </td>
    <td width="5%" class="fontsize9">2.75</td>
    <td width="8%" class="fontsize9">77 - 79</td>
    <td width="22%" class="fontsize9">Passing</td>
    </tr>
  <tr> 
    <td width="5%" height="15" class="fontsize9">&nbsp;1.00</td>
    <td width="8%" class="fontsize9">98 - 100</td>
    <td width="18%" class="fontsize9">Excellent</td>
    <td class="fontsize9">2.00</td>
    <td class="fontsize9">86 - 88</td>
    <td class="fontsize9">Very Satisfactory </td>
    <td class="fontsize9">3.00</td>
    <td class="fontsize9">74 - 76</td>
    <td class="fontsize9">Passing</td>
    </tr>
  <tr> 
    <td height="15" class="fontsize9">&nbsp;1.25</td>
    <td class="fontsize9">95 - 97</td>
    <td class="fontsize9">Superior </td>
    <td class="fontsize9">2.25</td>
    <td class="fontsize9">83 - 85</td>
    <td class="fontsize9">Satisfactory</td>
    <td class="fontsize9">4.00</td>
    <td class="fontsize9">71 - 73 </td>
    <td class="fontsize9">Conditioned</td>
    </tr>
  <tr> 
    <td height="15" class="fontsize9">&nbsp;1.50</td>
    <td class="fontsize9">92 - 94</td>
    <td class="fontsize9">Very Good</td>
    <td class="fontsize9">2.5</td>
    <td class="fontsize9">80 - 82</td>
    <td class="fontsize9">Fair</td>
    <td class="fontsize9">5.00</td>
    <td class="fontsize9">70 and below</td>
    <td class="fontsize9">Failed</td>
    </tr>
  <!--<tr> 
    <td height="10" colspan="9" class="fontsize9">&nbsp;&nbsp;For Graduate School 
  ...
  <tr> 
    <td height="10" colspan="9" class="fontsize9"><div align="center">ONE UNIT 
  ...
  <tr> 
    <td height="10" colspan="9"><hr width="90%" size="1"></td>
  </tr>
  <tr valign="top"> 
    <td height="20" colspan="9" class="fontsize9"><div align="center">Any erasure 
        or alteration on this transcript renders the whole document invalid unless 
        authenticated by the signature of the College Registrar.</div></td>
  </tr>
</table>
<%} %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
	...
	(NOT VALID WITHOUT COLLEGE SEAL) </font></td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr> 
    <td height="10" valign="bottom" class="fontsize9"><%if(false){%><br>

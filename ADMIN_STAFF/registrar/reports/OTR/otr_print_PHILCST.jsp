...
<html>
<head>
<title>PHILCST OFFICIAL TRANSCRIPT OF RECORD</title>
...
<form action="./otr_print_PHILCST.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage();">
	<tr><td height="62px">&nbsp;</td></tr>
</table>
...
<tr>
	...
	<td width="10%">&nbsp;</td>
	<td width="50%">&nbsp;</td>
	<td width="17%" align="center" valign="bottom">&nbsp;<i><%=WI.getStrValue(WI.getTodaysDate(9),"",",","")%></i></td>
	...
	<%
		...
		for(int i=2;i<strTemp.length();i++){
			strDate += strTemp.charAt(i);
		}
	%>
	
	<td width="7%" align="center" valign="bottom">&nbsp;<i><%=strDate%></i></td>
</tr>		

<tr>
	<td height="30">&nbsp;</td>
	<td valign="bottom" colspan="2" style="font-size:12px;"><strong>&nbsp;<%=((String)vStudInfo.elementAt(2)).toUpperCase()%>, 
		<%=WI.getStrValue((String)vStudInfo.elementAt(0)).toUpperCase()%> 
		<%=WI.getStrValue(vStudInfo.elementAt(1)," ").toUpperCase()%></strong></td>
	
	<td colspan="3" align="center" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i><%=WI.fillTextValue("stud_id")%></i></td>
</tr>		

<tr>
	<td height="30">&nbsp;</td>
	<td valign="bottom" colspan="2">&nbsp;<font size="1"><i><%=WI.getStrValue((String)vAdditionalInfo.elementAt(3))%>
		...
		<%=WI.getStrValue((String)vAdditionalInfo.elementAt(6),", ","","")%></i></font></td>
	...
	if (vAdditionalInfo != null) 
		...
		strTemp = "&nbsp;";
	%>
	<td align="center" valign="bottom">&nbsp;<i><%=strTemp%></i></td>
	<td colspan="2">&nbsp;</td>	
</tr>

<tr>
	<td height="35px">&nbsp;</td>
	<td colspan="2">&nbsp;<i><%=strStudCourseToDisp/**(String)vStudInfo.elementAt(7)**/%></i></td>
	
	<td colspan="3" align="center">
	<%if(vEntranceData != null){%>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i><%=WI.getStrValue((String)vEntranceData.elementAt(23),"&nbsp;")%></i> 
	<%}else{%> 
		&nbsp; 
	<%}%>
	</td>
...
<tr>
	<td height="30">&nbsp;</td>
	<td height="30">&nbsp;</td>
	<td>&nbsp; <i><%=WI.fillTextValue("entrance_data")%></i></td>
	<%if(vGraduationData != null)
		strTemp = (String)vGraduationData.elementAt(8);
	  else
		strTemp = "";				  
	%>	
	<td colspan="3" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <i><%=strTemp%></i></td>
</tr>	
</table>

<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="66%" height="680px" valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage();">
			<!---------------    HEADER--                       -----------------------------   ------------------>
				<tr>
					<td height="50px" width="18%">&nbsp;</td>
					<td width="54%">&nbsp;</td>
					<td width="9%">&nbsp;</td>
					<td width="9%">&nbsp;</td>
					<td width="10%">&nbsp;</td>
...
//	System.out.println("iRowsPrinted 3:" + iRowsPrinted + "; strSchNameToDisp"+ strSchNameToDisp );		
  ...
  <tr bgcolor="#FFFFFF"> 
    <td>&nbsp;</td> 
    <td height="17" colspan="4"><strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strSchNameToDisp.toUpperCase()%></label>
    </strong></td>
  </tr>
...
%>
  ...
  <tr bgcolor="#FFFFFF">  
	<td>&nbsp;</td>    	
  	<td colspan="4"><strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label></strong>
	</td>
  </tr>
...
if(bolIsCareGiver && strCE.length() > 0) 
	strCE = strCE + "hrs";
if(strCE.length() > 0 && strCE.indexOf(".") == -1 && !strCE.equals("-"))
	strCE = strCE + ".0";	
...
%>
  ...
  <tr bgcolor="#FFFFFF">      
  	<td height="14" style="font-size:10px;">&nbsp;<%=WI.getStrValue(vRetResult.elementAt(i + 6),"&nbsp;")%></td>  
    <td style="font-size:10px;"><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=WI.getStrValue(vRetResult.elementAt(i + 7),"&nbsp;")%></label></td>
    <td align="center" style="font-size:10px;">&nbsp;&nbsp;&nbsp;<label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strGrade%></label></td>
	<td align="center" style="font-size:10px;">&nbsp;&nbsp;<label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label></td>
    <td align="center" style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%=strCE%></td>
  </tr>
...
<% if (iLastPage == 1){%>
	...
	<tr><td colspan="5" class="thinborderTOP">
		<table width="100%">
			<%
			...
			%>   	
			<tr>
				<td width="14%" valign="top"><strong>&nbsp;REMARKS:</strong></td>
...
<%}else{%>
  <tr><td height="18" colspan="2" align="center"><i>Continue to next page...</i></td></tr>
<%}%>
		</table>
	...
	<td width="17%" valign="top">
		<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage();">
			<tr><td width="15%">&nbsp;</td><td height="415px" colspan="2" valign="top">&nbsp;</td></tr>
			<tr><td width="15%">&nbsp;</td><td height="55px" colspan="2" align="center" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=WI.getStrValue(WI.fillTextValue("special_order_remark"),"&nbsp;")%></td></tr>
			<tr><td width="15%">&nbsp;</td><td height="30px" colspan="2" valign="top">&nbsp;</td></tr>
			...
			if(strTemp.length() > 10)
				strTemp = strTemp.substring(0,10)+"<br>"+strTemp.substring(10);
				
			%>
			<tr><td width="15%">&nbsp;</td><td width="38%" height="40px" align="center" valign="bottom"></td>
			  <td width="47%" height="40px" valign="bottom"><%=strTemp%></td>
			</tr>
			<%
			if(vGraduationData != null && vGraduationData.size()!=0)
				...
				strTemp = "&nbsp;";
			%>
			<tr><td width="15%">&nbsp;</td><td height="20px" align="center" valign="bottom">&nbsp;&nbsp;&nbsp;</td>
			  <td valign="bottom"><%=strTemp%></td>
			</tr>
			<%
			if(vGraduationData != null && vGraduationData.size()!=0){
			...
			<tr><td width="15%">&nbsp;</td><td colspan="2" align="center" valign="middle">&nbsp;&nbsp;&nbsp;&nbsp; <%=strTemp%></td></tr>			
			<tr><td width="15%">&nbsp;</td><td height="85px" colspan="2">&nbsp;</td></tr>
			<tr><td colspan="3" height="30px" valign="top" align="right"><%=WI.fillTextValue("prep_by1").toUpperCase()%></td></tr>
			<tr><td width="15%">&nbsp;</td><td height="40px" colspan="2" align="right" valign="top"><%=WI.getTodaysDate(1)%></td></tr>
		</table>

...
<form action="./otr_print_UPHS.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage();">
	<tr>
		<td height="60px" width="80%">&nbsp;</td>
		<td width="12%" align="right"><%=iPageNumber%></td>
		<td align="right"><%=strTotalPageNumber%></td>
	</tr>
</table>
...
<tr>
	<td height="30">&nbsp;</td>
	<td height="30">&nbsp;</td>
	<td valign="top"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font size="2"><%=((String)vStudInfo.elementAt(2)).toUpperCase()%>, 
		<%=WI.getStrValue((String)vStudInfo.elementAt(0)).toUpperCase()%> 
		<%=WI.getStrValue(vStudInfo.elementAt(1)," ").toUpperCase()%></font></strong></td>
	
	<td colspan="3" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font size="2"><%=WI.fillTextValue("stud_id")%></font></td>
</tr>		
...
<tr>
	<td height="25">&nbsp;</td>
	<td height="">&nbsp;</td>
	<td colspan="5">&nbsp;&nbsp;&nbsp;&nbsp; <font size="2"><%=WI.fillTextValue("entrance_data")%></font></td>		
</tr>	
</table>
...
//	System.out.println("iRowsPrinted 3:" + iRowsPrinted + "; strSchNameToDisp"+ strSchNameToDisp );		
  ...
  <tr bgcolor="#FFFFFF"> 
    <td>&nbsp;</td> 
    <td height="17" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><font size="2"><%=strSchNameToDisp.toUpperCase()%></font></label>
    </strong></td>
  </tr>
...
%>
  ...
  <tr bgcolor="#FFFFFF">  
	<td>&nbsp;</td>    	
  	<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><font size="2"><%=strTemp%></font></label></strong>
	</td>
  </tr>
...
if(strGrade.equals("on going")) {
	...
	try {
		double dG = Double.parseDouble(strGrade);
		strGrade = CommonUtil.formatFloat(dG, true);
	}
	catch(Exception e) {}
}
...
<% if (iLastPage == 1){%>
		<tr><td height="18" colspan="2" align="center">***** NOTHING FOLLOWS *****</td></tr>	
<%}else{%>
				...
				<tr>
					...
					// iMaxRowToDisp = iMaxRowToDisp - 2;
						...
						if (strTemp.length()/100 > 0) {
						 ...
						 iRowsPrinted += iTemp; 
					%>  									
						<td height="100px" valign="bottom"><strong><font size="2"><%=strTemp.toUpperCase()%></font></strong></td>
						...
						<%}
						  if(WI.fillTextValue("addl_remark").length() > 0)
								...
								strTemp = "";
						%>   	
						<!--<tr><td colspan="2" height="18" align="center" style="text-align:justify">&nbsp;</td></tr>
						<tr><td colspan="2" height="18" align="center" style="text-align:justify">&nbsp;</td></tr>
						<tr><td width="14%">&nbsp;</td><td height="18" align="left"><strong>&nbsp;<font size="2"><%=strTemp.toUpperCase()%></font></strong></td></tr>-->
					</table>	
				</td>

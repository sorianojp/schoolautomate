...
//	System.out.println("strDegreeType : " + strDegreeType);
	if(vCourseSelected.size() > 0) {
		...
		strTemp = "select course_name, major_name,course_offered.course_code, major.course_code,course_offered.course_index, c_name "+
		...
		if(rs.next()) {
			...
			vStudInfo.setElementAt(rs.getString(6), 26);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="18" width="82%">
        ...
        <tr> 
          <td width="14%">Name :</td>
          <td class="thinborderBOTTOM"><strong>&nbsp;<%=((String)vStudInfo.elementAt(2)).toUpperCase()%>, 
    ...
    <td width="18%" rowspan="6" valign="bottom">
		...
		strTemp = "&nbsp;";
			...
			%>
				<td colspan="2" valign="top"><%=strTemp%></td>
			</tr>
			<tr> 
			  <td height="18" width="21%">ID#</td>
  ...
  <tr> 
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="18" width="14%">Address :</td>
  ...
  <tr> 
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="18" width="14%">Date of Birth:</td>
          <td width="31%" class="thinborderBOTTOM">&nbsp;<%=WI.getStrValue(vAdditionalInfo.elementAt(1))%></td>
          <td width="21%">&nbsp;&nbsp;Place of Birth: </td>
          <td width="34%" class="thinborderBOTTOM"><%=WI.getStrValue(vAdditionalInfo.elementAt(2),"&nbsp;")%></td>
        </tr>
      </table></td>
  </tr>
  ...
  <tr> 
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
           <td height="18">College of :</td>
			  <%
			  strTemp = (String)vStudInfo.elementAt(26);
			  if(strTemp.toLowerCase().startsWith("college of"))
			  		strTemp = strTemp.substring(11);
			  %>
           <td width="31%" class="thinborderBOTTOM">&nbsp;<%=strTemp%></td>
           <td height="18" width="21%" >&nbsp;&nbsp;Admission Date :</td>
          <td  width="34%" class="thinborderBOTTOM"> &nbsp; 
...
<%}%></td>
        ...
        <%if(WI.getStrValue(strStudMajorToDisp).length() > 0){%>
		  <tr> 
          <td height="18" width="14%">Course :</td>
          <td width="31%" class="thinborderBOTTOM">&nbsp;<%=strStudCourseToDisp/**(String)vStudInfo.elementAt(7)**/%></td>
          
			 <td width="21%">&nbsp;&nbsp;Major :</td>
          <td width="34%" class="thinborderBOTTOM">&nbsp;<%=WI.getStrValue(strStudMajorToDisp/**(String)vStudInfo.elementAt(8)**/)%></td>
        </tr>
		  <%}else{%>
		  <tr> 
          <td height="18" width="14%">Course :</td>
  ...
  <tr> 
    <td valign="top"><table width="98%" border="0" cellpadding="0" cellspacing="0">        
		  <tr> 
          <td height="18" width="21%">Date of Graduation :</td>
...
<%}%></td>
          ...
          <td width="21%">&nbsp;&nbsp;Date OTR Printed: </td>
          <td width="34%" class="thinborderBOTTOM">&nbsp;<%=WI.getTodaysDate(6)%></td>
        </tr>
      </table></td>
  </tr>
  <tr> 
    <td><table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
          <td height="18" width="21%">Secondary School :</td>
	...
	<tr>
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage();" class="thinborder">			 
			  ...
			  <tr bgcolor="#FFFFFF"> 
					<td width="14%" height="25" class="thinborder" align="center"><strong>COURSE NO.</strong></td>
					<td align="center" class="thinborder"> <strong>DESCRIPTIVE TITLE </strong></td>
					<%if(bolShowLecLabHr){%>
					<td width="4%" class="thinborder" align="center"><strong>LEC<br>(HRS) </strong></td>
					<td width="4%" class="thinborder" align="center"><strong>LAB (HRS)</strong></td>
					<%}if(bolIsRLEHrs){%>
					<td width="4%" class="thinborder" align="center"><strong> RLE (HRS)</strong></td>
					<%}%>
					<td width="9%" class="thinborder" align="center"> <strong>FINAL<br>GRADES</strong></td>
					<td width="9%" class="thinborder" align="center"><strong>RE-EXAM</strong></td>
					<td width="9%" class="thinborder" align="center"><strong>CREDITS<br>EARNED</strong></td>
			  </tr>
	...
	break;
			...
			if(vMulRemark != null && vMulRemark.size() > 0 ) {
			  ...
			  <tr valign="top" bgcolor="#FFFFFF"> 
				<td class="thinborderLEFT" height="<%=iMulRemarkHeight%>" colspan="<%=iColspan+3%>"> &nbsp;&nbsp;
			...
			%>
			  <tr valign="top">
				<td class="thinborderLEFTBOTTOM" height="16" colspan="<%=iColspan+3%>">&nbsp; 
					<label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label></td>
			  </tr>
			<%}
			...
			%>
			  <tr valign="top" bgcolor="#FFFFFF"> 
				<td  class="thinborderLEFT" height="16">&nbsp;</td>
				<td class="thinborderLEFT" height="16" style="padding-left:10px;">
				<strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strSchNameToDisp.toUpperCase()%></label>
				</strong></td>
				<%if(bolShowLecLabHr){%>
			...
			%>
			  <tr valign="top" bgcolor="#FFFFFF"> 
				<td class="thinborderLEFT" height="16">&nbsp;</td>
				<td class="thinborderLEFT" height="16" style="padding-left:10px;"><strong><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label>
				</strong></td>
			...
			%>
			  <tr valign="top" bgcolor="#FFFFFF"> 
				...
				if(strTemp.length() > 20)	
					strTemp = strTemp.substring(0, 20);// + " " + strTemp.substring(9, strTemp.length());		
				
				%>
				<td class="thinborderLEFT10px" height="<%=iSubjHeight%>" style="padding-left:25px;"><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label>&nbsp;</td>
				<%
				if(iSubjHeight > 20)
				...
				//strTemp = WI.getStrValue(WI.getStrValue(vRetResult.elementAt(i + 7)).toUpperCase(),"&nbsp;");
				%>
				<td class="thinborderLEFT10px" style="padding-left:10px;"><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label>
...
/*if(strCE.length() > 0 && strCE.indexOf(".") == -1)
	strCE=strCE.trim()+".00";	*/			
%>
				<td width="3%" align="center" class="thinborderLEFT">
				   <label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=WI.getStrValue(strGrade, "&nbsp;")%></label></td>
				<%
				strTemp = null;
				...
				%>
				<td width="3%" align="center" class="thinborderLEFT"><%=WI.getStrValue(strTemp,"&nbsp;")%></td>
				<%
				try{
					if(strCE.indexOf(".0") > -1)
						strCE = Integer.toString((int)Double.parseDouble(strCE));
				}catch(Exception e){}
				%>
				<td width="5%" align="center" class="thinborderLEFT"><%=WI.getStrValue(strCE,"&nbsp;")%></td>
				
			  </tr>
			  
				<%if(strMulRemarkAtEndOfSYTerm != null){%>	
				  <tr bgcolor="#FFFFFF"> 
					<td class="thinborderLEFT" height="16" colspan="<%=iColspan+3%>"><label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')">
						<%=strMulRemarkAtEndOfSYTerm%></label></td>
				  </tr>
		...
		if (i+11 > vRetResult.size()){
			...
			%>  
			  <tr>
				<td class="thinborderLEFTTOP" height="16"  colspan="<%=iColspan+3%>" align="center">&nbsp; <label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strTemp%></label></td>
			  </tr>
			<%} iRowsPrinted++; 
			...
			%>
			 <!-- <tr>
			  ...
			  <tr bgcolor="#FFFFFF"> 
					<td class="<%=strTemp%>">&nbsp;</td>
					<td class="<%=strTemp%>" height="16"  align="center">***** NOTHING FOLLOWS  ******</td>
					<%if(bolShowLecLabHr){%>
					<td class="<%=strTemp%>">&nbsp;</td>
					<td class="<%=strTemp%>">&nbsp;</td>
					<%}if(bolIsRLEHrs){%>
			...
			if(vGraduationData != null && vGraduationData.elementAt(14) != null && false) {%>
			  <tr>
				<td class="thinborder" height="16"  colspan="<%=iColspan+3%>" align="center">GRANTED TRANSFER CREDENTIAL EFFECTIVE 
				<%=WI.formatDate((String)vGraduationData.elementAt(14),6).toUpperCase()%></td>
			  </tr>
			<%}
			
			if(WI.fillTextValue("endof_tor_remark").length() > 0 && false) {%>
			  <tr>
				<td class="thinborderLEFT" height="16"  colspan="<%=iColspan+3%>" align="center"><%=WI.fillTextValue("endof_tor_remark")%></td>
			  </tr>
			<%}
			...
			<%}
				...
				<tr bgcolor="#FFFFFF"> 
					...
					<td class="thinborder" align="center">*****  more on page <%=++iPageNumber%> ******</td>
					<%if(bolShowLecLabHr){%>
					<td class="thinborder">&nbsp;</td>
					<td class="thinborder">&nbsp;</td>
					<%}if(bolIsRLEHrs){%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr> 
    <td height="19" colspan="3"> 
		<table width="100%" height="80px" cellpadding="0" cellspacing="0">
			<tr valign="top">
  ...
  <tr> 
  <%
  strTemp = WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"Vice President",7)).toUpperCase();
  if(WI.fillTextValue("vp_desig_name").length() > 0)
  	strTemp = WI.fillTextValue("vp_desig_name");
  %>
    <td width="35%" height="18" class="thinborderBOTTOM" align="center"><%=strTemp%></td>
    <td width="41%" height="18">&nbsp;</td>
	 <%
  strTemp = WI.fillTextValue("registrar_name");
  if(WI.fillTextValue("registrar_desig_name").length() > 0)
  	strTemp = WI.fillTextValue("registrar_desig_name");
  %>
    <td width="24%" class="thinborderBOTTOM" align="center"><%=strTemp%></td>
  </tr>
  <tr> 
  <%
  strTemp  = "Vice President for Academic Affairs";
  if(WI.fillTextValue("vp_desig").length() > 0)
  	strTemp = WI.fillTextValue("vp_desig");
  %>
    <td height="18" align="center"><%=strTemp%></td>
    <td height="18">&nbsp;</td>
	 <%
  strTemp  = "University Registrar";
  if(WI.fillTextValue("registrar_desig").length() > 0)
  	strTemp = WI.fillTextValue("registrar_desig");
  %>
...
strTemp = "";//do not show for now, bec. it is print all already. the page will not be submitted
//strTemp = ConversionTable.replaceString(strTemp, "\"","\"");
//strTemp = ConversionTable.replaceString(strTemp, "'","");
%>
<input type="hidden" name="endof_tor_remark" value='<%=strTemp%>'>
<%
strTemp = WI.fillTextValue("prep_by1");
strTemp = "";
%>
<input type="hidden" name="prep_by1" value="<%=strTemp%>">
<%
strTemp = WI.fillTextValue("check_by1");
strTemp = "";
%>
<input type="hidden" name="check_by1" value="<%=strTemp%>">
<%
strTemp = WI.fillTextValue("check_by2");
strTemp = "";
%>
<input type="hidden" name="check_by2" value="<%=strTemp%>">
<%
strTemp = WI.fillTextValue("registrar_name");
strTemp = "";
%>
<input type="hidden" name="registrar_name" value="<%=strTemp%>">

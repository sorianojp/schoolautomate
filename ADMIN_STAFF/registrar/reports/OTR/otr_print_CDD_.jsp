...
//System.out.println(vRetResult.elementAt(i + 8));
	...
	if(WI.fillTextValue("stud_id").equals("12-0933-251")) {
		System.out.println("School Name: "+vRetResult.elementAt(i));
...
// uncomment this if school name apprears once.//
	if(strSchoolName != null) {
		if(strPrevSchName == null) {
			...
			if(false && WI.fillTextValue("stud_id").equals("12-0933-251")) {
				System.out.println("Start of printing: "+strSchoolName);
				System.out.println(strSchNameToDisp);
				System.out.println(strPrevSchName);
				System.out.println("End of printing: "+vRetResult.elementAt(i+ 1));
			}
		}
	}
...
/*	if(false && WI.fillTextValue("stud_id").equals("12-0933-251")) {
		System.out.println(strSchoolName);
		System.out.println(strSchNameToDisp);
		System.out.println(strPrevSchName);

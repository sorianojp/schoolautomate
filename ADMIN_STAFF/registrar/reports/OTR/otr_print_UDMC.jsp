  ...
  <tr>
    <td height="18" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td align="center" valign="top"><strong>Maternal Name </strong></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td height="18" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="17%"><strong>&nbsp;Date of Graduation:</strong></td>
        <td width="15%" class="thinborderBOTTOM"><strong>
...
%>
        ...
        <td width="13%"><strong> &nbsp;Special Order: </strong></td>
        <td width="24%" class="thinborderBOTTOM">
          <strong>
          <%
if(vGraduationData != null)
	strTemp = WI.getStrValue((String)vGraduationData.elementAt(6));
else
	strTemp = "";
bolShrink = false;
if(strTemp.length() > 23)
	bolShrink = true;
%>
		&nbsp;<font style="font-size:<%if(bolShrink){%>9px;<%}else{%>11px;<%}%>"><label id="aShrink-10" onClick="autoShrink('aShrink-10');"><%=strTemp%></label></font></strong></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td height="18" colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="6%">&nbsp;</td>
        <td width="26%" class="thinborderBOTTOM"><strong>&nbsp;<label id="aShrink-11" onClick="autoShrink('aShrink-11');"><%=WI.fillTextValue("address2")%></label></strong></td>
        <td width="12%">
&nbsp;
<%
	if (vAdditionalInfo != null && vAdditionalInfo.size() > 0){
		...
		if (strTemp == null) {
			...
			strTemp =  strTemp.substring(strTemp.indexOf("of"));
		}
	}else{
		strTemp = "&nbsp;";
	}
%>
        ...
        <td width="19%" class="thinborderBOTTOM"><strong>&nbsp;<label id="aShrink-12" onClick="autoShrink('aShrink-12');"><%=strTemp%></label></strong></td>
...
%>
  ...
  <tr>
    <td height="18" colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="15%"><strong>Entrance Data: </strong></td>
<% strTemp ="";
...
%>
        ...
        <td width="34%" class="thinborderBOTTOM"><strong>&nbsp;<label id="aShrink-14" onClick="autoShrink('aShrink-14');"><%=strTemp%></label></strong></td>
        <td width="7%">&nbsp;</td>
        <td width="20%">&nbsp;</td>
        <td width="24%" class="thinborderBOTTOM"><div align="center"><strong>
            <% if (iLastIndex != -1){%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="#FFFFFF">
    <td width="18%" rowspan="2" align="center" class="thinborderBOTTOM2RIGHT"><strong>SUBJECT</strong></td>
    <td width="43%" rowspan="2" class="thinborderBOTTOM2"><div align="center"><strong>DESCRIPTIVE TITLE </strong></div></td>
    <td colspan="2" class="thinborderLEFTRIGHTBOTTOM"><div align="center"><strong>RATINGS</strong></div>
        <div align="center"></div></td>
    <td width="9%" rowspan="2" class="thinborderBOTTOM2" align="center"><strong>CREDIT</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF">
...
if(vRetResult.elementAt(i+ 3) != null) {//null only if accredited subject - foreign stud.
	if(((String)vRetResult.elementAt(i+ 3)) != null && ((String)vRetResult.elementAt(i+ 3)).length() == 1) {
		...
		if(strCurSYSem.equals("1ST Semester"))
			strCurSYSem = "1st Semester";
		else if(strCurSYSem.equals("2ND Semester"))
			strCurSYSem = "2nd Semester";
		else if(strCurSYSem.equals("3RD Semester"))
			strCurSYSem = "3rd Semester";
...
if(strSYSemToDisp != null){%>
  <tr bgcolor="#FFFFFF">
    <td height="17"><strong> <label id="<%=++iLevelID%>" onClick="UpdateLabel('<%=iLevelID%>')"><%=strSYSemToDisp%></label>
    </strong></td>
    <td height="17" class="thinborderLEFT"><div align="center"><strong>&nbsp;<u><%=WI.getStrValue(strSchNameToDisp).toUpperCase()%></u></strong></div></td>
...
%>
  <tr bgcolor="#FFFFFF">
    ...
    <td class="thinborderLEFT"><%=vRetResult.elementAt(i + 7)%></td>
    <%
if(WI.getStrValue(vRetResult.elementAt(i + 8), "&nbsp;").compareTo("on going") == 0){%>
    <td colspan="3">&nbsp;&nbsp;Grade not ready</td>
    <%}else{
    ...
    <td width="2%" align="center" class="thinborderLEFTRIGHT"><%=strTemp%></td>
    <td width="2%" align="center" class="thinborderRIGHT"><%
...
<tr>
	<td class=>&nbsp;</td>
	<td height="17" class="thinborderLEFT" ><div align="center">****  NOTHING FOLLOWS ****</div></td>
	<td class="thinborderLEFTRIGHT" >&nbsp;</td>
	<td class="thinborderRIGHT" >&nbsp;</td>
	<td >&nbsp;</td>
</tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="30%" class="thinborderBOTTOM">
	  <div align="center"><strong><%=WI.fillTextValue("prep_by2")%></strong></div>	</td>
    <td width="35%">&nbsp;&nbsp;&nbsp;&nbsp;Verified  by :
			<strong><u>&nbsp;&nbsp;<%=WI.fillTextValue("check_by1")%>&nbsp;&nbsp;</u></strong>	</td>
  </tr>
  <tr>
    <td width="35%" height="15">&nbsp;</td>
    <td width="30%"><div align="center">Assistant Comptroller </div></td>
    <td width="35%">&nbsp;</td>
  </tr>
  <tr>
    <td width="35%" height="15">&nbsp;</td>

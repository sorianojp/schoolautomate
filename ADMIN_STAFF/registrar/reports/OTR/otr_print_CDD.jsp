...
if(vRetResult.elementAt(i+ 3) != null) {//null only if accredited subject - foreign stud.	
	...
	if(/*vRetResult.elementAt(i) != null && bolIsSchNameNull &&*/ vCrossEnrollSYTerm.size() > 0) {//display will be schooo name<br>sy/term (cross enrolled)
		//strSYToDisp = null;
		//strSemToDisp = null;		
		if(vCrossEnrollSYTerm.indexOf((String)vRetResult.elementAt(i + 1) +"-"+(String)vRetResult.elementAt(i + 3)) > -1 && strSchNameToDisp != null 
			&& !strSchNameToDisp.equals(strCurrentSchoolName))
...
%>
		<tr bgcolor="#FFFFFF">
		  <td height="14" style="padding-left:40px;">&nbsp;</td>
		  <td>NSTP Serial No. (<%=strNSTPSerial%>)</td>
		  <td align="center">&nbsp;</td>
		  <td align="center">&nbsp;</td>
		  <td align="center">&nbsp;</td>
	  </tr>		

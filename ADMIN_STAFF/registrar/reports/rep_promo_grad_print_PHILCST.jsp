...
Vector vRetResult = regReport.getPromoForGrad(dbOP,request,8);//8 subjects in one row -- change it for different no of subjects per row
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	...
	<tr style="font-weight:bold">
	  <td align="center" style="font-size:11px;"><u><%=WI.fillTextValue("printed_by")%></u></td>
	  <td align="center" style="font-size:11px;"><u><%=CommonUtil.getNameForAMemberType(dbOP,"University Registrar",7)%></u></td>
  </tr>
	<tr>
	  <td align="center" style="font-size:11px;"><%=WI.fillTextValue("printed_by_designation")%></td>
	  <td align="center" style="font-size:11px;">Registrar</td>
  </tr>
</table>

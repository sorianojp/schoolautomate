...
<table width="100%" border="0" cellpadding="0" cellspacing="0" onClick="PrintNextPage()">
	<tr>
	  <td height="500" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
        <tr>
            <td height="22" colspan="10" align="center" class="thinborder">Students Profile</td>
            </tr>
        <tr>
          <td height="22" class="thinborder" width="12%" align="center"><strong>e-mail</strong></td>
          <td class="thinborder" width="14%" align="center"><strong>Street No. and Street address</strong></td>
          <td class="thinborder" width="12%" align="center"><strong>Barangay</strong></td>
          <td class="thinborder" width="14%" align="center"><strong>Municipality/City</strong></td>
          <td class="thinborder" width="9%" align="center"><strong>District</strong></td>
          <td class="thinborder" width="13%" align="center"><strong>Province</strong></td>
          <td class="thinborder" width="6%" align="center"><strong>Sex</strong></td>
          <td class="thinborder" width="10%" align="center"><strong>Date of Birth<br>
          (mm-dd-yy)</strong></td>
          <td class="thinborder" width="4%" align="center"><strong>Age</strong></td>
          <td class="thinborder" width="6%" align="center"><strong>Civil Status</strong></td>
        </tr>
        <%
	for(int i = 0; i < vGradList.size(); i+=iElemCount){
	%>
        <tr>          
          <td class="thinborder" height="22">&nbsp;<%=WI.getStrValue((String)vGradList.elementAt(i+14))%></td>
          <td class="thinborder" height="22">&nbsp;<%=WI.getStrValue((String)vGradList.elementAt(i+7))%></td>
          <td align="center" class="thinborder" height="22">&nbsp;</td>
          <td align="center" class="thinborder" height="22">&nbsp;<%=WI.getStrValue((String)vGradList.elementAt(i+8))%></td>
          <td align="center" class="thinborder" height="22">&nbsp;</td>          
          <td align="center" class="thinborder" height="22">&nbsp;<%=WI.getStrValue((String)vGradList.elementAt(i+9))%></td>
		  <%
		  strTemp = WI.getStrValue((String)vGradList.elementAt(i+10),"M");
		  ...
		  <td align="center" class="thinborder" height="22">&nbsp;<%=WI.getStrValue(vGradList.elementAt(i+11))%></td>
		  <td align="center" class="thinborder" height="22">&nbsp;<%=WI.getStrValue(vGradList.elementAt(i+12))%></td>
		  <td align="center" class="thinborder" height="22">&nbsp;<%=WI.getStrValue(vGradList.elementAt(i+13))%></td>
        </tr>
        <%}%>
      </table></td>
	</tr>
...
function PrintNextPage() {	
	if(!confirm("Click Ok to print next page and Cancel to stay in this page."))
		return;	
	location = "./terminal_report_print_page5.jsp?sy_from="+<%=WI.fillTextValue("sy_from")%>+

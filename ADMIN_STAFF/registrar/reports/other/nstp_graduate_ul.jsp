...
if(strSchCode == null)
	...
	//System.out.println("printing schCode: "+strSchCode);
%>
...
<body >
<form name="form_" action="./nstp_graduate_ul.jsp" method="post">
...
NATIONAL SERVICE TRAINING <br>
CIVIC WELFARE TRAINING SERVICE/LITERACY TRAINING SERVICE <br>
<br>
...
<%=SchoolInformation.getSchoolName(dbOP,true,false)%><br>
    ...
    <tr>
      <td height="30"><div align="center">
        <strong>NSTP-CWTS Enrollment List<br>
        </strong>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="thinborder">
    ...
    <tr>
      <td width="3%" align="center" class="thinborder" style="font-size:11px; font-weight:bold">&nbsp;</td>
<!--
...
<%if(!bolHideSpecializedCol){%>
    <td width="7%" align="center" class="thinborder" style="font-size:11px; font-weight:bold">Specialized<br>(Based on Dimensions)</td>
<%}%>
    </tr>
  <%
...
<%if(!bolHideSpecializedCol){%>
    <td class="thinborder" align="center"><%=WI.getStrValue(strSpecializedDim)%></td>
<%}%>
  </tr>
  <%
i = i+12;
    ...
    <td height="18" colspan="2" valign="top">
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			<tr align="center" valign="bottom">
				<td width="12%">Submitted by:</td>
				<td width="25%" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"Director/NSTP Coordinator",7)).toUpperCase()%></td>
				<td width="1%"></td>
				<td width="6%">Noted: </td>
				<td width="20%" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"University Registrar",7)).toUpperCase()%></td>
				<td width="1%"></td>
				<td width="12%">Approved by:</td>
				<td width="22%" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"President",7)).toUpperCase()%></td>
			</tr>
			<tr align="center">
			  <td>&nbsp;</td>
...
CIVIC WELFARE TRAINING SERVICE/LITERACY TRAINING SERVICE <br>
    ...
    <tr>
      <td height="30" valign="bottom">Name of Institution: <u>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC" class="thinborder">
    ...
    <tr>
      <td width="4%" rowspan="2" align="center" class="thinborder" style="font-size:11px; font-weight:bold">&nbsp;</td>
...
%>
  <tr>
    ...
    <%if(!bolHideSpecializedCol){%>
	    <td align="center" class="thinborder"><%=WI.getStrValue(strSpecializedDim)%></td>
    <%}%>
	</tr>
  <%
i = i+12;
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="73%" height="40" valign="top">&nbsp;</td>
    <td width="24%" valign="top"><div align="right">page <strong><%=strDispPageNo%></strong></div></td>
  </tr>
  <tr>
    <td height="18" colspan="2" valign="top"><table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr align="center" valign="bottom">
        <td width="12%">Submitted by:</td>
        <td width="25%" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"Director/NSTP Coordinator",7)).toUpperCase()%></td>
        <td width="1%"></td>

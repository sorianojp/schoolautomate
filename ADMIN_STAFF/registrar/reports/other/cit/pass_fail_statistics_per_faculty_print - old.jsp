...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
   <tr>
		<td height="25" colspan="6" align="center" style="font-weight:bold; " class="thinborder">
		:::: FACULTY PASS-FAIL STATISTICS ::::</td>
   </tr>  
   <tr>
		<td width="13%" class="thinborder" height="25" align=""><strong>Subject Code</strong></td>
		<td width="43%" class="thinborder" height="25" align=""><strong>Subject Title</strong></td>
		<td width="17%" class="thinborder" align=""><strong>Section</strong></td>	
		<td width="11%" class="thinborder" align="center"><strong>No. of students</strong></td>
		<td width="8%" class="thinborder" align="center"><strong>Pass</strong></td>
		<td width="8%" class="thinborder" align="center"><strong>Fail</strong></td>
   </tr>

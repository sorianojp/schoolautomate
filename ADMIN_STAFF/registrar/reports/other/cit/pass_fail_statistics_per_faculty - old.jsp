...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strCIndex.length() >0){
		strTemp =" select c_name from COLLEGE where is_college =1 and IS_DEL =0 and  C_INDEX ="+strCIndex;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<%  String strDepartment = null;
			...
			strTemp = " select d_name from DEPARTMENT "
					+ " where IS_DEL= 0 AND IS_COLLEGE_DEPT = 1 "
		...
		<%=dbOP.loadCombo(" D_INDEX "," D_NAME "," from DEPARTMENT where IS_DEL= 0 AND IS_COLLEGE_DEPT = 1 AND C_INDEX ="+strCIndex+" order by D_NAME asc",request.getParameter("department"), false)%>
		</select>
		<%	}%>
		</td>
	</tr>	
	<tr>
		...
		<%=dbOP.loadCombo("INFO_FACULTY_BASIC.user_index","fname+ ' ' +lname",strFacultyList,request.getParameter("faculty"), false)%></select>
		</td>
	</tr>
	<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
   <tr bgcolor="#A49A6A">
		<td height="25" colspan="6" align="center" style="font-weight:bold; color:#FFFFFF" class="thinborder">
		:::: Faculty Pass-Fail Statistics ::::</td>
   </tr>  
   <tr>
		<td width="13%" class="thinborder" height="25" align="center"><strong>Subject Code</strong></td>
		<td width="37%" class="thinborder" height="25" align="center"><strong>Subject Title</strong></td>
		<td width="12%" class="thinborder" align="center"><strong>Section</strong></td>	
		<td width="15%" class="thinborder" align="center"><strong>No. of students</strong></td>
		<td width="12%" class="thinborder" align="center"><strong>Pass</strong></td>
		<td width="11%" class="thinborder" align="center"><strong>Fail</strong></td>
   </tr>
   ...
   <tr>
	   ...
	   <td class="thinborder"><%=WI.getStrValue((String)vRetSubject.elementAt(i+4),"0")%></td>
	   <td class="thinborder"><%=WI.getStrValue((String)vRetSubject.elementAt(i+5),"0")%></td>
	   <td class="thinborder"><%=WI.getStrValue((String)vRetSubject.elementAt(i+6),"0")%></td>
   </tr>
   <%}//end of vRetSubject%>
</table>
<%}

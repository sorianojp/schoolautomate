...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"enrollment_per_subject_offering.jsp");
...
if(WI.fillTextValue("sy_from").length() > 0) {
	vRetResult = reportE.getPerSubjectEnrollmentCountPerOffering(dbOP, request);
	if(vRetResult == null)
		strErrMsg = reportE.getErrMsg();
}
%>
<form action="./enrollment_per_subject_offering.jsp" method="post" name="form_">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	%>	
		<tr>
			...
			<td class="thinborderNONE"><%=WI.getStrValue(vRetResult.elementAt(4), "0")%></td>
		</tr>
	<%

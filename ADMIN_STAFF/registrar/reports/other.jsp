...
<%}else if(strSchCode.startsWith("DLSHSI")){%>
  <tr> 
    <td width="12%" height="25">&nbsp;</td>
    <td width="15%" height="25" align="right">Operation : </td>
    <td width="2%" align="center">&nbsp;</td>
...
<%}else if(strSchCode.startsWith("HTC")){%>
  <tr> 
    ...
    <td width="15%" height="25" align="right">Operation : </td>
    <td width="2%" align="center">&nbsp;</td>
    <td><a href="./nstp_graduate_htc.jsp?ched=1">NSTP Graduate - CHED</a></td>
  </tr>
<%}else if(strSchCode.startsWith("EAC")){%>
  <tr> 
    ...
    <td width="15%" height="25" align="right">Operation : </td>
    <td width="2%" align="center">&nbsp;</td>
    <td><a href="./stud_subject_with_permit_EAC.jsp">List of Enrolled Students</a></td>
  </tr>
...
<%}else if(strSchCode.startsWith("PNTC")){%>
  <tr> 
    <td width="12%" height="25">&nbsp;</td>
    <td width="15%" height="25" align="right">&nbsp;</td>
    <td width="2%" align="center">&nbsp;</td>
    <td><a href="pntc/mortality_of_enrollees.jsp">Mortality of Enrollees Report</a></td>
  </tr>  
  <tr> 
    <td width="12%" height="25">&nbsp;</td>
    <td width="15%" height="25" align="right">&nbsp;</td>
    <td width="2%" align="center">&nbsp;</td>
    <td><a href="pntc/summary_of_grades.jsp">Summary of Grades</a></td>
  </tr>
<%}else{

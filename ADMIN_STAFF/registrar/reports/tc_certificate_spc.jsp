...
<form name="form_" action="./tc_certificate_spc.jsp" method="post" >
  ...
  <table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable2">
    <tr bgcolor="#FFFFFF">
      <td width="5%" height="25" valign="top">
          <p ALIGN="CENTER">&nbsp;</p>        </td>
      <td height="25" valign="top"><br><br><br><br><br><br><br><p  ALIGN="CENTER"><strong> OFFICE OF THE REGISTRAR</strong></p>
        <p  ALIGN="CENTER"><br>CERTIFICATE OF TRANSFER CREDENTIAL</p>
        <p ><br>To  Whom It May Concern:</p>
		  
        <p  style="text-align:justify; text-indent:50px;">This  certifies that
        ...
        <table width="100%" border="0"  cellpadding="0" cellspacing="0">
          <tr>
            <td width="65%"><font size="1">NOT VALID WITHOUT<br>
        ...
        <p >THE REGISTRAR<br><%=SchoolInformation.getSchoolName(dbOP,true,false)%>
       <br>
        <%=SchoolInformation.getAddressLine1(dbOP,false,false)%></p>
       
        <p  style="text-align:justify; text-indent:50px;"><%=strGender%> <%=(String)vRetResult.elementAt(0) +  " " +
			    (String)vRetResult.elementAt(1)  +  " " +

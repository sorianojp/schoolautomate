			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="150px" align="justify" style="word-spacing:2px;">							
							...
							<%=WebInterface.formatName((String)vRetResult.elementAt(2),(String)vRetResult.elementAt(3),(String)vRetResult.elementAt(4),7)%></strong> graduated from this
							University with the degree of <%=((String)vRetResult.elementAt(15)).toUpperCase()%>
							on <%=WI.formatDate((String)vRetResult.elementAt(23),6)%> with Special Order No. <%=(String)vRetResult.elementAt(21)%> dated <%=WI.formatDate((String)vRetResult.elementAt(22),6)%>.
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 

			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="150px" align="justify" style="word-spacing:2px;">							
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This is to certify that <strong><%=strGender%> <%=WebInterface.formatName((String)vRetResult.elementAt(2),(String)vRetResult.elementAt(3),(String)vRetResult.elementAt(4),7)%></strong> graduated from
							this University with the degree of <%=((String)vRetResult.elementAt(15)).toUpperCase()%> on <%=WI.formatDate((String)vRetResult.elementAt(23),6)%> with 
							Special Order No. <%=(String)vRetResult.elementAt(21)%> dated <%=WI.formatDate((String)vRetResult.elementAt(22),6)%>.							
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This is to further certify that <%=strshehe%> is of good moral character and has
							never been the subject of any disciplinary action for the entire duration of 
							<%=strhisher%> stay in this institution.
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This certification is issued this <%=WI.getTodaysDate(14)%> upon
							the request of <strong><%=strGender%> <%=(String)vRetResult.elementAt(4)%></strong> for whatever legal purpose(s) this may serve.
					</td>
				</tr>

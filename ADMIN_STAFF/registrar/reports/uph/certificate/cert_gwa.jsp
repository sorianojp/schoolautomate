			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="150px" align="justify" style="word-spacing:2px;">							
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This is to certify that <strong><%=strGender%> 
							<%=WebInterface.formatName((String)vRetResult.elementAt(2),(String)vRetResult.elementAt(3),(String)vRetResult.elementAt(4),7)%></strong> graduated in
							this University with a Degree in <%=((String)vRetResult.elementAt(15)).toUpperCase()%>
							on <%=WI.formatDate((String)vRetResult.elementAt(23),6)%> with Special Order No. <%=(String)vRetResult.elementAt(21)%>
							dated <%=WI.formatDate((String)vRetResult.elementAt(22),6)%> has earned a General Weighted Average (G.W.A)
							of <%=(String)vRetResult.elementAt(24)%>.
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This certification is issued this <%=WI.getTodaysDate(14)%> upon
							the request of <strong><%=strGender%> <%=(String)vRetResult.elementAt(4)%></strong> for whatever legal purpose(s) 
							this may serve.
					</td>
				</tr>

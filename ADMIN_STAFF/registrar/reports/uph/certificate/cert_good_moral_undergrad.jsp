			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="150px" align="justify" style="word-spacing:2px;">
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This is to certify that <strong><%=strGender%> <%=WebInterface.formatName((String)vRetResult.elementAt(2),(String)vRetResult.elementAt(3),(String)vRetResult.elementAt(4),7)%></strong> was
							as student in the <%=(String)vRetResult.elementAt(8)%> of this University from SY
							<%=(String)vRetResult.elementAt(9)%>-<%=(String)vRetResult.elementAt(10)%>.
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							This is to certify further that <%=strshehe%> is of good moral character and 

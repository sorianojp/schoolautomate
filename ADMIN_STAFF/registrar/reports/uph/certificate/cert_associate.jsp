			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td height="150px" align="justify" style="word-spacing:2px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
							...
							<strong><%=strGender%> <%=WebInterface.formatName((String)vRetResult.elementAt(2),(String)vRetResult.elementAt(3),(String)vRetResult.elementAt(4),7)%></strong> completed the 2-Year program in
							<%=((String)vRetResult.elementAt(15)).toUpperCase()%> (<%=((String)vRetResult.elementAt(14)).toUpperCase()%>) leading to the degree of
							BACHELOR OF SCIENCE IN NURSING (BSN) during the <%=astrConvertSem[Integer.parseInt((String)vRetResult.elementAt(27))]%> SY
							<%=(String)vRetResult.elementAt(25)%>-<%=(String)vRetResult.elementAt(26)%> under CHED Memorandum Order No. <%=(String)vRetResult.elementAt(21)%>.
							<br><br>
							&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; This certification is issued this <%=WI.getTodaysDate(14)%> upon the
							request of <strong><%=strGender%> <%=(String)vRetResult.elementAt(4)%></strong> for whatever legal purpose(s) this may
							serve.
					</td>
				</tr>

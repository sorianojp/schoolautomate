...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-GRADES-Grade Sheets","grade_sheet_uploadCSV_EAC.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./grade_sheet_uploadCSV_EAC.jsp" method="post" onSubmit="SubmitOnceButton(this);">
...
<input type="hidden" name="show_save">
    ...
    <tr>
      ...
      <td colspan="2" align="right"><a href="./grade_sheet_uploadCSV_EAC_delete.jsp">Go to Delete Grade</a></td>
    </tr>
    <tr>

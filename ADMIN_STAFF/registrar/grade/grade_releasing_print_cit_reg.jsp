...
<%
	...
	String strStudInfoList = WI.fillTextValue("stud_id");//(String)request.getSession(false).getAttribute("stud_list");
...
Vector vSubSecIndexLocked = gsEx.getSubSecIndexLocked(dbOP, strSYFrom, strSemester, WI.fillTextValue("grade_for"));
...
%>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
		<td>&nbsp;</td>
		<td ><%=strStudID%>&nbsp;&nbsp;&nbsp;
		<%=(String)vStudInfo.elementAt(2)%> <%=WI.getStrValue((String)vStudInfo.elementAt(3),"/","","")%>
		&nbsp;&nbsp;
	...
	<table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0" class="thinborderNONE">
	  <tr>
		...
		<td width="26%"><font size="2"><strong> SUBJECT </strong></font></td>
		<td width="56%"><font size="2"><strong>DESCRIPTIVE TITLE</strong></font></td>

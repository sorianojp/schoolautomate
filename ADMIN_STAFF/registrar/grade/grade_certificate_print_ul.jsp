...
System.out.println("Error Msg: "+strErrMsg);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="45%" height="18" align="center" ><font size="3"><strong><%=SchoolInformation.getSchoolName(dbOP,true,false)%></strong></font><br>      <font size=1><%=SchoolInformation.getAddressLine1(dbOP,false,false)%><br>
      ...
      <%}else{%> OFFICE OF THE <%if(false && !bolIsCollege){%>UNIVERSITY <%}%>REGISTRAR <%}%>
      </strong></font><br><br><br></td>
  </tr>
  <tr>
    <td height="18" ><font size="3"><strong><%=strAddressee%></strong></font></td>
  </tr>
  <tr>
    <td height="18" ><font size="3"><strong><%=strLine1%></strong></font></td>
  </tr>
  <tr>
    <td height="18" ><font size="3"><strong><%=strLine2%></strong></font></td>
  </tr>
  <tr>
    <td height="20" valign="bottom" >
	<br>
	<br>
	<strong>Dear <%=strAddressee%> :</strong></td>
  </tr>
  <tr>
    <td height="25" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In
	  ...
	  who was enrolled at the <strong> <%if(bolIsSACI){%><%=vStudInfo.elementAt(16)%><%}else{%><%=((String)vStudInfo.elementAt(18)).toUpperCase()+WI.getStrValue(WI.getStrValue((String)vStudInfo.elementAt(19)).toUpperCase(), " - ", ""," ")%><%}%></strong> during the <strong> <%=astrConvertSem[Integer.parseInt((String)vSemester.elementAt(0))]%>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="12%" height="18" ><strong><%=WI.getStrValue(strYrLevel)%><%//=WI.getStrValue(vStudInfo.elementAt(4))%></strong></td>
    <td width="28%" height="18" >
	<%if(WI.fillTextValue("show_gwa").equals("1") && fGWA > 0f
		&& !strSchCode.startsWith("UDMC")){%>
		GWA : <strong><%=CommonUtil.formatFloat(fGWA,2)%></strong>
	<%}%></td>
  </tr>
  <tr>
...
<%}else if(!bolIsSACI){%>
  <tr align="right">
	...
	<br>
	<br>
	<%if (!strSchCode.startsWith("UI")) {%><font size="2"><%=CommonUtil.getNameForAMemberType(dbOP,"University Registrar",iFormat)%></font><%}%>&nbsp;&nbsp;</td>
  </tr>
  <tr align="right">
    <td  height="12" >&nbsp;</td>
    <td height="12" colspan="2" valign="top"><% if (!strSchCode.startsWith("UI")){%>
      <%if(!bolIsCollege){%>University<%}%> Registrar<%}%>&nbsp;</td>
  </tr>
<%}
if(bolIsSACI){%>
	<tr><td width="63">&nbsp;</td>

...
strTemp = " select  sub_code, GRADE_SHEET.grade, GRADE_NAME from GRADE_SHEET "+
...
System.out.println(vGradeDetailPreMid);

Vector vGradeDetailFinal = new Vector();
strTemp = "select  sub_code, GRADE2, GRADE_CGH, GRADE from G_SHEET_FINAL "+
...
<%	}
		...
		<%}else{%>
			<%if(!strSchCode.startsWith("CLDH") && false){%><%=request.getParameter("grade_for").toUpperCase()%><%}%></strong> GRADES FOR <strong><%=request.getParameter("sem_name").toUpperCase()%></strong>
...
<%if(!bolIsCGH){%>
    <td width="16%" align="center" class="thinborder"><font size="1"><strong>INSTRUCTOR</strong></font></td>
<%}%>

	<%
	for(int j = 0; j < vGradeNameList.size(); j++){
	%>
	<td width="9%" align="center" class="thinborder"><font size="1"><strong><%=vGradeNameList.elementAt(j)%></strong></font></td>
	<%}%>
	
	<td width="9%" align="center" class="thinborder"><font size="1"><strong>Finals</strong></font></td>
	<td width="9%" align="center" class="thinborder"><font size="1"><strong>Average</strong></font></td>
	<td width="9%" align="center" class="thinborder"><font size="1"><strong>%ge Grade</strong></font></td>	
...
%>
<td valign="top" class="thinborder"><div align="center"><%=strTemp%></div></td>
...
if(iIndexOf > -1)
	strTemp = (String)vGradeDetailFinal.elementAt(iIndexOf + 1);
...
<%}else if(!strSchCode.startsWith("DBTC")){
	...
	<%}%><br>
	otherwise they will be marked as
	<%if(strSchCode.startsWith("CSA")){%>No Credit<%}else{%>
	Failed.
	<%}%>
<%}%>    </td>
<%if(strSchCode.startsWith("AUF")){%>

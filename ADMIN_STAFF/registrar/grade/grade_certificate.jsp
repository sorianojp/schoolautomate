...
function goGradeCert() {
	location="./grade_release_main.jsp?grade_cert=1&print_by=1";//&sy_from=<%=strSYFrom%>&sy_to=<%=strSYTo%>&semester=<%=strSemester%>&pmt_schedule="+document.form_.pmt_sch_index.value;
}
...
//add security here.
	 if(WI.fillTextValue("print_page").compareTo("1") == 0) {
		...
		<%}
	 	if(strSchCode.startsWith("WUP")){%>
			<jsp:forward page="./grade_certificate_print_wup.jsp" />
		<%}
	...
	<%}else{
		...
		}else{if (true){// (WI.fillTextValue("addressee").length() != 0 && WI.fillTextValue("addr1").length()!=0
...
if(vStudInfo != null && vStudInfo.size() > 0) {
	strTemp = new enrollment.SetParameter().bolStudentIsOnHold(dbOP, (String)vStudInfo.elementAt(0));
	if(strTemp != null) {
...
<form name="form_" action="./grade_certificate.jsp" method="post">
  <table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="2%" height="25" >&nbsp;</td>
      <td width="29%" height="25" >Student ID: &nbsp;
      ...
      <td width="9%" ><a href="javascript:ReloadPage()"><img src="../../../images/form_proceed.gif" border="0"></a></td>
      <td width="31%" ><label id="coa_info" style="font-size:11px; font-weight:bold; color:#0000FF"></label></td>
      <td width="25%" >
	  <%if(strSchCode.startsWith("UL") || strSchCode.startsWith("CDD")){%>
	  	<a href="javascript:goGradeCert()">Go to Grade Cert (Batch)</a>
	  <%}%>
	  </td>
    </tr>
<%if(strLastPrintedDate != null) {%>
    <tr>
      <td height="25" >&nbsp;</td>
      <td height="25" colspan="4" style="font-size:14px; color:#FF0000; font-weight:bold">
...
<%} if(vStudInfo != null && vStudInfo.size() > 0 && !bolIsStudOnHold){%>
  <table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="25" >&nbsp;</td>
	...
	{strTemp = "checked";
     ...
     <input name="sy_from" type="text" size="4" maxlength="4" value="<%=strSYFrom%>" class="textbox"
      ...
      <td >
	<%if(!strSchCode.startsWith("WUP")){%>	  
	  	<a href="javascript:ReloadPage()"><img src="../../../images/view.gif" width="40" height="31" border="0"></a>
	<%}%>
	  </td>
    </tr>
    <tr>
...
<%if(strSchCode.startsWith("WUP")){%>
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25" colspan="3">Printing Font Size :  <select name="font_size" onChange="ChangeFontSize();" onkeyUp="ChangeFontSize();">
          <%
...
<% if (WI.fillTextValue("sy_from").length() == 4 && vSemester.size()!=0 && !strSchCode.startsWith("WUP") ){ %>
  <table bgcolor="#FFFFFF"  width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr >
...
<%if(!strSchCode.startsWith("FATIMA")){%>
    <tr>
      ...
      <td height="25" colspan="2"><strong><u>Send to :</u></strong></td>
...
%>
    <tr>
      <td height="25">&nbsp;</td>
      <td width="2%" height="25">&nbsp;</td>
      <td width="18%" height="25">Addresse :</td>
      <td height="25" colspan="2"><input name="addressee" type="text" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" class="textbox" id="addressee" size="64" value="<%=strTemp%>"></td>
    </tr>
    <% 	if (vRetResult !=null  && vRetResult.size()!=0)
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>
      <td height="25">Address Line 1 </td>
      <td height="25" colspan="2"><input name="addr1" type="text" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" class="textbox" id="addr1" size="64" value="<%=strTemp%>"></td>
    </tr>
    <% 	if (vRetResult !=null && vRetResult.size()!=0)
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>
      <td height="25">Address Line 2</td>
      <td height="25" colspan="2"><input name="addr2" type="text" class="textbox" id="addr2" size="64" value="<%=strTemp%>" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <tr>
      <td height="18">&nbsp;</td>
    ...
    <tr>
	  ...
	  <input type="hidden" name="prep_by" value="<%=CommonUtil.getName(dbOP,(String)request.getSession(false).getAttribute("userId"),1)%>">
	  </td>
    </tr>
    <% if (!strSchCode.startsWith("UI")){%>
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>
      <td height="25">Checked by: </td>
      <td height="25" colspan="2">
<%
strTemp = (String)request.getSession(false).getAttribute("checker");
if(strTemp == null)
	strTemp = CommonUtil.getName(dbOP,(String)request.getSession(false).getAttribute("userId"),1);
%>
	  <input name="checker" type="text" class="textbox" id="checker" size="32" value="<%=WI.getStrValue(strTemp)%>" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        &nbsp;&nbsp;Designation : &nbsp;&nbsp; <input name="designation" type="text" value="<%=WI.getStrValue(request.getSession(false).getAttribute("designation"))%>" class="textbox" id="designation" size="16" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <%}%>
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>
      <td height="25"><%=WI.getStrValue(CommonUtil.getRegistrarLabel(dbOP))%> </td>
      <td height="25" colspan="2"><input name="registrar" type="text" value="<%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"University Registrar",1))%>" class="textbox_noborder" size="48" ></td>
    </tr>
    <tr>
      <td colspan="5" height="25">&nbsp;</td>
    </tr>
...
<%
	String strFinalPmtSch = "0";//"select pmt_sch_index from fa_pmt_schedule where is_valid = 1 and exam_name like 'final%'";
	//strFinalPmtSch = dbOP.getResultOfAQuery(strFinalPmtSch, 0);
%>
<input type="hidden" name="pmt_sch_index" value="<%=strFinalPmtSch%>">

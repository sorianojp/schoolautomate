...
if ((vEmpRec!=null && vEmpRec.size()>0) && !strSchCode.startsWith("AUF")) {
		...
		strDeanName = WI.getStrValue(dbOP.mapOneToOther("COLLEGE","c_index",strOfferedByCollege,"dean_name",null));
...
%>
      ...
      <td width="25%">SEMESTER: <strong><%=astrConvSemester[Integer.parseInt(WI.fillTextValue("offering_sem"))]%></strong></td>
    </tr>
    <tr> 
...
<table width="100%" cellpadding="1" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
  <tr>
    ...
    <% if (strSchCode.startsWith("AUF"))
		...
		strTemp = " COURSE";
%>
    <td width="15%"  class="thinborder"><div align="center"><font color="#000099" size="1"><strong><%=strTemp%></strong></font></div></td>
    <% Vector vPMTSchedule = (Vector)vRetResult.elementAt(0); 
		...
		for (i = 0; i < iNumGrading; ++i){
				...
				if(strTemp.toLowerCase().startsWith("m"))
					...
					strTemp = "Final";
		%>
    <td  class="thinborder" width="5%"><div align="center"><font color="#000099" size="1"><%=strTemp%></font></div></td>
    <%} // end for loop%>
  ...
  <%	String strFontColor = null;//red if failed.
	...
	%>
  <tr>
    <td height="16"  class="thinborder"<%=strFontColor%>><font size="1">&nbsp;<%=iIncr%></font></td>
	...
	<tr>
		<td width="32%">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<%
				strTemp = WI.getStrValue(dbOP.mapOneToOther("COLLEGE","C_INDEX",(String)vEmpRec.elementAt(11),"DEAN_NAME"," and is_del = 0")).toUpperCase();
				if(strTemp.length() > 0 && !strTemp.equals(strDeanName)){
				%>
				<tr> 
				  <td height="45" valign="bottom" align="center">				  
				  <div style="width:90%; border-bottom:solid 1px #000000; font-weight:bold;" align="center"><%=strTemp%></div>DEAN</td>
			    </tr>
				...
				<tr> 
				  <td width="35%" valign="bottom"><div align="center"> <strong> </strong>
					  <table width="90%" border="0" cellspacing="0" cellpadding="0">
						<tr>
						  <td height="19" class="thinborderBottom"><div align="center"><strong> 
							  <%=WI.getStrValue(strDeanName).toUpperCase()%> 
							  </strong></div></td>
						</tr>
					  </table>
				  </div></td>

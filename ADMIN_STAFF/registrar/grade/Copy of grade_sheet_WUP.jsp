...
//String strNCRemark = strBlockedRemark;
strTemp = "";
...
<%if(bolIsCGH && !bolRemovePercentGrade){%>
      ...
      <td align="center">
	  <%if(strFontColor.length() ==0){%>
        <input name="grade_percent<%=j%>" type="text" size="3" class="textbox" <%if(bolIsCGH && !bolRemovePercentGrade){%>readonly='yes'  tabindex="-1"<%}%>
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';
...
<%}%>      
	<td align="center">
	  	<%if(strFontColor.length() ==0){
			...
			bolIsCIT || strSchCode.startsWith("FATIMA") || strSchCode.startsWith("CDD") || strSchCode.startsWith("UPH") || strSchCode.startsWith("WUP"))

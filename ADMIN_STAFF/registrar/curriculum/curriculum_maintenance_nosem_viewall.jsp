...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-CURRICULUM-Courses curriculum - nosem view all","curriculum_maintenance_nosem_viewall.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"curriculum_maintenance_nosem_viewall.jsp");
...
%>
<form action="./curriculum_maintenance_nosem_viewall_print.jsp" method="post" target="_blank" onSubmit="return PrintPage();">

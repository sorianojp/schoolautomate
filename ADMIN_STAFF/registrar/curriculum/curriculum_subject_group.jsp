...
{
	document.sgroup.page_action.value = strAction;
//	document.sgroup.submit();
}
function PrepareToEdit(strInfoIndex)
{
	document.sgroup.page_action.value ="";
	document.sgroup.prepareToEdit.value = 1;
	document.sgroup.info_index.value = strInfoIndex;
	document.sgroup.submit();
}

function DeleteRecord(strInfoIndex)
{
	document.sgroup.page_action.value="0";
	document.sgroup.info_index.value=strInfoIndex;
	document.sgroup.submit();
}
function CancelRecord()
{
	location = "./curriculum_subject_group.jsp";
}

</script>

<body bgcolor="#D2AE72" onLoad="document.sgroup.group_name.focus();">
...
if(strTemp.length() > 0)
{
	vRetResult = SM.operateOnSubGroup(dbOP,request,Integer.parseInt(strTemp));
	if(vRetResult != null)
		strPrepareToEdit = "0";
...
vRetResult =	SM.operateOnSubGroup(dbOP,request,4);
...
{
	vEditInfo = SM.operateOnSubGroup(dbOP,request,3);
	if(vEditInfo == null)
		strErrMsg = SM.getErrMsg();
}
dbOP.cleanUP();
...
<form name="sgroup" method="post" action="./curriculum_subject_group.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="8"><div align="center"><font color="#FFFFFF"><strong>::::
          SUBJECT GROUP MAINTENANCE PAGE::::</strong></font></div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td colspan="3" height="25"><a href="./curriculum_subject.jsp"><img src="../../../images/go_back.gif" width="50" height="27" border="0"></a></td>
      <td width="28%">&nbsp;</td>
      <td width="11%">&nbsp;</td>
      <td width="11%">&nbsp;</td>
      <td width="16%">&nbsp;</td>
    ...
    <tr>
      ...
      <td colspan="3" height="25">Subject group
<%
	...
	%>
	        <input name="group_name" type="text" size="16" value="<%=strTemp%>" class="textbox"
  ...
  <table width="100%" border=0 bgcolor="#FFFFFF">
    <tr bgcolor="#B9B292">
      <td height="25" colspan="8"><div align="center">LIST
          OF EXISTING SUBJECT GROUPS</div></td>
    </tr>
  </table>
<%

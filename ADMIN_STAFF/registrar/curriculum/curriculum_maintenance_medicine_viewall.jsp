...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-CURRICULUM-Courses curriculum - medicine -view all","curriculum_maintenance_medicine_viewall.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"curriculum_maintenance_medicine_viewall.jsp");
...
%>
<form action="./curriculum_maintenance_medicine_print.jsp" method="post" target="_blank" onSubmit="return PrintPage();">
...
<%}%>  </td>
    ...
    <%//check here if the main subject is having sub subject entries, if so, run this loop,

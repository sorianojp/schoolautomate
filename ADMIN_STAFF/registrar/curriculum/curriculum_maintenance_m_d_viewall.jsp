...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-CURRICULUM-Courses curriculum - masteral view all","curriculum_maintenance_m_d_viewall.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form action="./curriculum_maintenance_m_d_viewall_print.jsp" method="post" target="_blank" onSubmit="return PrintPage();">

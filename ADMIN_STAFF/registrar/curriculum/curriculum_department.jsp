...
{
	location = "./curriculum_department.jsp";
}
function PrintPg() {
	var win=window.open("./curriculum_department_print.jsp","PrintWindow",'width=800,height=400,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();

}
</script>

<body bgcolor="#D2AE72" onLoad="document.cdept.d_code.focus();">
...
<form name="cdept" action="./curriculum_department.jsp" method="post">
...
<!--
    <tr>
      ...
      <td colspan="3" style="font-size:11px; color:#0000FF; font-weight:bold">
	  	<input type="checkbox" name="show_only_dept" value="checked" <%=WI.fillTextValue("show_only_dept")%> onClick="document.cdept.submit();">
      Show Department without college </td>
      <td>&nbsp;</td>
    </tr>
-->
    <tr> 
...
<%if(WI.fillTextValue("show_only_dept").length() == 0) {%>
    <tr> 
      <td height="25">&nbsp;</td>
      <td>Under college of</td>
...
<%}//show only if show_only_dept is not checked.%>
    <%if(iAccessLevel > 1){%>
    <tr> 
      <td height="25">&nbsp;</td>
      <td>&nbsp; </td>
...
{%>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="30%"><div align="center"><font size="1"><b>COLLEGE NAME </b></font></div></td>
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr >
      <td height="25" colspan="8"><div align="center"><a href="javascript:PrintPg();"><img src="../../../images/print.gif" border="0"></a>&nbsp;<font size="1">click 
          to print list </font></div></td>
    </tr>
    <tr >
      <td height="25" colspan="8">&nbsp;</td>

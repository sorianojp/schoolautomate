...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-CHED Scholar-manage Scholarship Type","assign_student.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
String strAwardNo = null;
if(vRetResult == null && strStudIndex != null) {
	strAwardNo = "select award_no from CIT_CHED_SCHOLAR where stud_index = "+strStudIndex+" order by scholar_index desc";
	strAwardNo = dbOP.getResultOfAQuery(strAwardNo, 0);
}
...
if(bolIsFailed)
	...
	strTemp = "";
if(strAwardNo != null && strTemp.length() == 0) 
	strTemp = strAwardNo;

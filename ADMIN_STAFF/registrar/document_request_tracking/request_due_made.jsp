...
<%
	...
	String strTemp = WI.fillTextValue("print_page");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		<tr> 
			<%
				...
				if(WI.fillTextValue("show_in").equals("1"))
					strTemp = "DUE REQUEST";
			%>
		  	<td height="20" colspan="13" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>::: TODAY'S <%=strTemp%> ::: </strong></div></td>
		</tr>
		...
		<tr>
		    ...
		    <td class="thinborder" align="center" width="5%"><strong>PRINT</strong></td>
		</tr>
	<%	int iCount = 1;
		...
		<tr>
			...
			<td class="thinborder" align="center">
				...
				<%}%>			</td>
		    <td class="thinborder" align="center"><a href="javascript:PrintOne('<%=(String)vRetResult.elementAt(i + 8)%>', '<%=(String)vRetResult.elementAt(i)%>');"><img src="../../../images/print.gif" border="0"></a></td>
		</tr>
		<%}%>
	</table>
<%}%>	

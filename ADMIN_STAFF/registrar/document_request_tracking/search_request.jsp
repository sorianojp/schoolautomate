...
<script language="javascript">
	...
	function PrintOne(strIDNumber, strPrintIndex){
		var strPrintRemark = prompt('Print Remark','');
		if(strPrintRemark == null ||  strPrintRemark.length == 0) 
			strPrintRemark = '';
		//popup print page here.
		var pgLoc = "unrelease_form_print.jsp";
		<%if(WI.fillTextValue("release_unrelease").equals("1")){%>
			pgLoc = "release_form_print.jsp";
		<%}%>
		
		pgLoc += "?id_number="+strIDNumber+"&print_page=2&print_index="+
		strPrintIndex+"&print_remark="+escape(strPrintRemark);
		var win=window.open(pgLoc,"AddRequirement",'width=800,height=400,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
		win.focus();
...
String[] astrSortByName    = {"ID Number ","Lastname","Firstname","Request Date","Release Date"};
String[] astrSortByVal     = {"id_number","lname","fname","request_date","release_date"};
  ...
  <tr>
		...
		<td colspan="10"><font size="1">Click to view</font> &nbsp;  &nbsp; 
			...
			if(strTemp.length() == 0 || strTemp.equals("0")){
				...
				strErrMsg = "";
			%>
			<input type="radio" value="0" name="release_unrelease" <%=strErrMsg%>>
			...
			if(strTemp.equals("1")){
				...
				strErrMsg = "";
			%>
			<input type="radio" value="1" name="release_unrelease" <%=strErrMsg%>>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		<tr> 
			<%
				...
				if(WI.fillTextValue("show_in").equals("1"))
					strTemp = "DUE REQUEST";
			%>
		  	<td height="20" colspan="13" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>DOCUMENT REQUEST LIST</strong></div></td>
		</tr>	
		...
		<tr>
			...
			<td class="thinborder" width="8%"><strong>Date Requested</strong></td>
			<td class="thinborder" width="8%" align="center"><strong>Excpected Release Date </strong></td>
			<td class="thinborder" width="8%" align="center"><strong>Released Date </strong></td>
			<td class="thinborder" ><strong>Requirement</strong></td>
			<td class="thinborder" ><strong>Request Remark</strong> </td>
			<td class="thinborder" width="10%"><strong>Release Remark </strong></td>
			<td class="thinborder" align="center" width="12%"><strong>OPTION</strong></td>
		    <td class="thinborder" align="center" width="12%"><strong>PRINT</strong></td>
		</tr>
	<%	int iCount = 1;
		...
		<tr>
			...
			<td class="thinborder" align="center">
				...
				<%}%>			</td>
		    <td class="thinborder" align="center"><a href="javascript:PrintOne('<%=(String)vRetResult.elementAt(i + 1)%>', '<%=(String)vRetResult.elementAt(i)%>');"><img src="../../../images/print.gif" border="0"></a></td>
		</tr>
		<%}%>
	</table>
<%}%>

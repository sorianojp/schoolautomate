...
<%
	...
	if(vStudInfo == null)
		...
		vRetResult = docReq.getItemUnreleaseForPrint(dbOP, request);
		if(vRetResult == null)
			strErrMsg = docReq.getErrMsg();
	}
...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td width="17%">Requester ID:</td>
		<td width="58%"><%=WI.fillTextValue("id_number")%></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td height="23" width="3%">&nbsp;</td>
	...
	<%}%>
	<tr><td colspan="10" align="center"><strong>LIST OF DOCUMENT REQUESTED</strong></td></tr>
	<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	...
	<tr>
		...
		<td class="thinborder" width="20%"><strong>EXPECTED RELEASE DATE </strong></td>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td height="30" colspan="4">&nbsp;
		<br>Remark: <%=WI.getStrValue(strTemp)%><br><br>
	</td></tr>
	<tr>

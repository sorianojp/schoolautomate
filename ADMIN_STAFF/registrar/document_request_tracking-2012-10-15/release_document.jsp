...
<script language="javascript">
	...
	function PrintForm(){
		var pgLoc = "release_form_print.jsp?transaction_no="+document.form_.transaction_no.value;
	...
	<tr>
		...
		<td width="80%">				
			<input name="id_number" type="text" class="textbox"
	  			...
	  			onKeyUp="AjaxMapName();" value="<%=WI.fillTextValue("id_number")%>" size="22">				
...
<%if(WI.fillTextValue("get_ajax").length() > 0 && bolShowData){%>	
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
<tr><td height="15" colspan="7"><hr size="1" /></td></tr>		
<tr>
	<td width="30%">&nbsp;</td>
	<td height="25" colspan="5" align="center">	  
		<%=docReq.ajaxSearchRequest(dbOP, request)%>	  
	</td>
<td width="30%">&nbsp;</td>
</tr>

...
String[] astrSortByName    = {"School Code","School Name"};
String[] astrSortByVal     = {"sch_code","sch_name"};

Accredited accredited = new Accredited();
utility.ConstructSearch csearch = new utility.ConstructSearch();
...
<%if(bolIsDBTC || true){%>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
		  <td>&nbsp;</td>
		  <td colspan="2" style="font-weight:bold; font-size:11px;"><u>Search Condition:</u></td>
	  </tr>
		<tr>
			<td width="3%" height="25">&nbsp;</td>
			<td>School Code:</td>
			<td>
				<select name="sch_code_con">
					<%=csearch.constructGenericDropList(WI.fillTextValue("sch_code_con"),astrDropListEqual,astrDropListValEqual)%> 
    			</select>
				<input type="text" name="sch_code_search" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
					onblur="style.backgroundColor='white'" size="64" maxlength="256" value="<%=WI.fillTextValue("sch_code_search")%>"/></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
			<td>School Name:</td>
			<td>
				<select name="sch_name_con">
					<%=csearch.constructGenericDropList(WI.fillTextValue("sch_name_con"),astrDropListEqual,astrDropListValEqual)%> 
    			</select>
				<input type="text" name="sch_name_search" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
					onblur="style.backgroundColor='white'" size="64" maxlength="128" value="<%=WI.fillTextValue("sch_name_search")%>"/></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
			<td>School Type:</td>
			<td>
				<select name="sch_type_search">
					<option value="">ALL</option>
					<%
					strTemp = WI.fillTextValue("sch_type_search");
					if(strTemp.equals("1"))
						strErrMsg = "selected";
					else
						strErrMsg = "";
					%><option value="1" <%=strErrMsg%>>Private</option>
					<%					
					if(strTemp.equals("0"))
						strErrMsg = "selected";
					else
						strErrMsg = "";
					%><option value="0" <%=strErrMsg%>>Public</option>
					...
					if(strTemp.equals("2"))
						...
						strErrMsg = "";
					%><option value="2" <%=strErrMsg%>>Semi Private/public</option>					
    			</select>			</td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
		  	...
		  	<td width="23%">
				<select name="sort_by1">
					...
					<%=csearch.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
		  </select></td>
		    <td width="20%">
				<select name="sort_by2">
              		<option value="">N/A</option>
             		<%=csearch.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%>
				</select></td>
		    <td width="40%">&nbsp;
		  </td>
		</tr>
		...
		<tr>
			...
			<td colspan="4">
				<a href="javascript:SearchSchool();"><img src="../../../images/form_proceed.gif" border="0" /></a></td>
		</tr>
		<tr>
			<td height="10" colspan="5"></td>
		</tr>

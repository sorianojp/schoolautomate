...
function UploadImage(strInfoIndex){
	...
	var sT = "./upload_file.jsp?first_load=1&opner_form_name=form_&info_index_image="+strInfoIndex;
...
%>
<form action="./upload_parent_picture.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF"  class="thinborder">
	<tr><td align="center" height="25" colspan="7"  class="thinborder"><strong>SEARCH RESULT</strong></td></tr>
	<tr> 
	...
	<tr>
		...
		<td align="center" class="thinborder"><strong>UPLOAD PICTURE </strong><strong></strong></td>
    </tr>  
	...
	<tr>
	  ...
	  if(strTemp != null && strTemp.length() > 0)
	  	strTemp = "<a href=\"javascript:UploadImage('"+(String)vRetResult.elementAt(i)+"');\"><img src='../../upload_img/parent/"+strTemp+"."+strImgFileExt+"' height='100' width='100'></a>";

...
<form name="form_" method="post" action="./petty_cash_create_req.jsp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="4" class="borderAll"><div align="center"><strong>PETTY 
          CASH VOUCHERS NOT YET REPLENISHED</strong></div></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="18"><font size="1">Note: shaded rows indicate that fund is not 
        yet given to payee</font></td>
    </tr>
    <tr>
      <td height="18">&nbsp;</td>
    </tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="4" class="borderAll"><div align="center"><strong>PETTY 
          CASH FOR REPLENISHMENT</strong></div></td>
    </tr>
    <tr> 

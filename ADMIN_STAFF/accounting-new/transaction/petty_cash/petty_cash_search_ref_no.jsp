...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-ACCOUNTING-TRANSACTION-Petty Cash","petty_cash_search_ref_no.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	String[] astrSortByName    = {"Voucher No.","Voucher Date"};
	String[] astrSortByVal     = {"voucher_no","voucher_date"};
	String[] astrDateOption = {"Specific Date","Date Range","Year"};
	String[] astrConvertMonth = {"January","February","March","April","May","June","July","August",
								"September","October","November","December"};
	if (WI.fillTextValue("proceedClicked").length() > 0){
	  vRetResult = PCV.searchReferenceNo(dbOP,request);
...
%>
<form name="form_" method="post" action="petty_cash_search_ref_no.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::
          SEARCH REFERENCE # PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="25%" height="26">Voucher No.</td>
      <td colspan="2"> <select name="voucher_no_select">
          <%=PCV.constructGenericDropList(WI.fillTextValue("voucher_no_select"),astrDropListEqual,astrDropListValEqual)%> </select> <input type="text" name="voucher_no" class="textbox" value="<%=WI.fillTextValue("voucher_no")%>"
	  	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <tr>
      <td height="26">&nbsp;</td>
      <td>Reference No.</td>
      <td colspan="2"> <select name="ref_no_select">
          <%=PCV.constructGenericDropList(WI.fillTextValue("ref_no_select"),astrDropListEqual,astrDropListValEqual)%> </select> <input type="text" name="ref_no" class="textbox" value="<%=WI.fillTextValue("ref_no")%>"
	      onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <tr>
      <td height="26">&nbsp;</td>
      <td>Disbursement Status</td>
      <td colspan="2"> <select name="cd_status">
          <option value="">All</option>
          <%if(WI.fillTextValue("cd_status").equals("0")){%>
          <option value="0" selected>Not yet released</option>
          <option value="1">Released</option>
          <%}else if(WI.fillTextValue("cd_status").equals("1")){%>
    ...
    <tr>
      ...
      <td height="18" colspan="2" valign="bottom">&nbsp;</td>
    </tr>
    <tr>
      <td height="24">&nbsp;</td>
      <td height="24" colspan="2"> <div align="left">
          <select name="sort_by1">
            ...
            <%=PCV.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
          </select>
        </div></td>
      <td width="63%" height="24"> <div align="left">
          <select name="sort_by2">
            <option value="">N/A</option>
            <%=PCV.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%>
          </select>
        </div></td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" colspan="4"><div align="center"><font size="1"></font></div>
        <div align="center"><font size="1"> <a href="javascript:ProceedClicked();"><img src="../../../../images/form_proceed.gif" border="0" ></a></font></div></td>
    </tr>
    <tr>
  ...
  <%if(vRetResult != null && vRetResult.size() > 0){%>
  <table width="100%" height="117" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td height="25" colspan="4" bgcolor="#B9B292"><div align="center"><font color="#FFFFFF"><strong>::
          SEARCH RESULT :: </strong></font></div></td>
    </tr>
    <tr>
      <td height="23" colspan="3"><font size="1"><strong>TOTAL VOUCHER(S) : </strong></font><strong><%=vRetResult.size()/5%></strong></td>
      <%
    ...
    <tr>
      <td width="25%"><div align="center"><font size="1"><strong>REFERENCE NO.</strong></font></div></td>
      <td width="24%" height="26"><div align="center"><font size="1"><strong>VOUCHER
          NO.</strong></font></div></td>
      <td width="24%"><div align="center"><font size="1"><strong>VOUCHER DATE</strong></font></div></td>
      <td width="27%"><div align="center"><strong><font size="1">AMOUNT</font></strong></div></td>
      <%if(WI.fillTextValue("opner_info").length() == 0) {%>
      <%}%>
    </tr>
    ...
    <tr>
      <td><font size="1">&nbsp;
        <%if (bolLooped && ((String)vRetResult.elementAt(i + 1)).equals((String)vRetResult.elementAt(i-4))){%>
        &nbsp;
        <%}else{%>
        <%if(WI.fillTextValue("opner_info").length() > 0) {%>
      ...
      <td height="20"><font size="1">&nbsp;<%=(String)vRetResult.elementAt(i+2)%></font></td>
      <td height="20"><div align="left"><font size="1">&nbsp;<%=(String)vRetResult.elementAt(i+3)%></font></div></td>
      <td height="20"><div align="right"><font size="1">&nbsp;<%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+4),true)%>&nbsp;</font></div></td>
    </tr>
    <%bolLooped = true;
	}%>
  </table>

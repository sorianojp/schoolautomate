...
<form name="report_income" action="./income.jsp" method="post">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="23%"><select name="gross_net_stat" onChange="ReloadPage();">
          <option value="0">Gross</option>
<%
if(WI.fillTextValue("gross_net_stat").compareTo("1") ==0){%>
...
<%}%>
      ...
      <td width="62%">Show
        <select name="report_for" onChange="ReloadPage();">
...
if(WI.fillTextValue("report_for").compareTo("1") ==0){%>
        ...
        <select name="summary_specific_val" onChange="ReloadPage();">
...
}//only if report_for is academic.%>
        </select>
      </td>
    </tr>
<%
...
<%}//only if report for is academic
    ...
    <tr>
      <td height="26">&nbsp;</td>
      <td>Non Acad Dept</td>
      <td colspan="2"><select name="d_index" onChange="ReloadPage();">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('report_income.date_from');" title="Click to select date" onmouseover="window.status='Select date';return true;" onmouseout="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a>&nbsp;to
        <input name="date_to" type="text" size="12" maxlength="12" readonly="yes" value="<%=WI.fillTextValue("date_to")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('report_income.date_to');" title="Click to select date" onmouseover="window.status='Select date';return true;" onmouseout="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a></td>
    </tr>
    <tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr>
      <td height="25" colspan="3" bgcolor="#B9B292" align="center"><font color="#FFFFFF">
        <%=astrGrosNet[Integer.parseInt(WI.fillTextValue("gross_net_stat"))]%>
        INCOME FOR <%=WI.fillTextValue("date_from")%>
        <%
    ...
    <tr>
<%
strTemp = WI.fillTextValue("is_show_expense");
if(strTemp.compareTo("1") ==0)
	strTemp = "checked";
else
	strTemp = "";
%>
      <td width="24%" height="25"><input type="checkbox" name="is_show_expense" value="1" <%=strTemp%> onClick="javascript:ReloadPage();">
        Show Expenses </td>
      <td width="51%"><strong>Note:</strong> <font color="#0000FF">Click
          VIEW button to see income details</font></td>
      <td width="25%"><font size="1"><a href="../../fee_assess_pay/reports/statement_of_account_print.htm" target="_blank"><img src="../../../images/print.gif" border="0"></a>click
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td align="center"><font size="1"><strong><%=astrGrosNet[Integer.parseInt(WI.fillTextValue("gross_net_stat"))]%>
          INCOME</strong></font></td>
<%
if(WI.fillTextValue("is_show_expense").compareTo("1") ==0){%>
      <td align="center"><font size="1"><strong>EXPENSES</strong></font></td>
<%}%>
...
%>
    <tr>
      <td  height="25"><font size="1">&nbsp;<%=WI.getStrValue(vSummary.elementAt(i+2))%></font></td>
      <td><font size="1">&nbsp;<%=WI.getStrValue((String)vSummary.elementAt(i+3))%></font></td>
...
<%}%>
      <td><a href="#" target="_blank"><img src="../../../images/view.gif" border="0"></a></td>
    </tr>
<%
i = i+5;
}%>    <tr>

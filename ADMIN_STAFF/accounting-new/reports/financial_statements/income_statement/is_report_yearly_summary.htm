...
<form>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr bgcolor="#A49A6A"> 
      <td height="25" bgcolor="#FFFFFF" align="center"> INCOME STATEMENT  </td>
    </tr>
    <tr bgcolor="#A49A6A"> 
      <td width="4%" height="25" bgcolor="#FFFFFF">YEAR-ENDED : <strong>$enddate_of_the_set_fiscal_year</strong></td>
    </tr>
  </table>

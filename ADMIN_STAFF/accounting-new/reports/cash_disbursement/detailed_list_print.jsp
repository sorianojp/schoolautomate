...
iCurRow = 0; %>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
    <tr>
      ...
      <td rowspan="2" class="thinborder"><div align="center"><font size="1"><strong>CHARGED <br>ACCOUNT # </strong></font></div></td>
      <td rowspan="2" class="thinborder"><div align="center"><strong><font size="1">ACCOUNT NAME (DEBITED)</font></strong></div></td>
    </tr>
    <tr>
...
for(; i < vRetResult.size(); i += 10){
	...
	dTotal    += Double.parseDouble((String)vRetResult.elementAt(i + 6));
    ...
    <tr>
      ...
      <td width="9%" class="thinborder" align="right"><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i + 6), true)%></td>
      <td width="6%" class="thinborder"><%=vRetResult.elementAt(i + 8)%></td>
      <td width="25%" class="thinborder"><%=vRetResult.elementAt(i + 9)%></td>
    </tr>
...
<%dSubTotal=0d;}//end of if.
    ...
    <tr style="font-weight:bold">
      <td height="21" colspan="7" class="thinborder" align="right">
	  	Grand Total : <%=CommonUtil.formatFloat(dTotal,true)%></td>
      <td colspan="2" class="thinborder">&nbsp;</td>
    </tr>
  </table>
<%if(!bolEndOfPrinting) {%>

...
if(strTemp.length() > 0) {
	if(adm.operateOnCollegeTFCOAMapping(dbOP, request, Integer.parseInt(strTemp)) == null)
...
vRetResult = adm.operateOnCollegeTFCOAMapping(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null)
	strErrMsg = adm.getErrMsg();
	
if(strPreparedToEdit.equals("1"))
	vEditInfo = adm.operateOnCollegeTFCOAMapping(dbOP, request, 3);
...
%>
	  ...
	  <%=dbOP.loadCombo("C_index","c_name", " from college " + strTemp,
...
%>
    ...
    <tr> 
      ...
      <td width="19%">TF Increment Account #</td>
      <td>
<%
if(vEditInfo != null && vEditInfo.size() > 0) 
...
if(vRetResult != null && vRetResult.size() > 0) {%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      <td width="42%" height="25" align="center" style="font-size:9px; font-weight:bold" class="thinborder">COLLEGE</td>
      <td width="27%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">TUITION FEE </td>
      <td width="23%" align="center" style="font-size:9px; font-weight:bold" class="thinborder">TUITION FEE INCREMENT </td>

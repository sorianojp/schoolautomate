...
%>     <input name="cf_name" type="text" size="12" maxlength="32" value="<%=strTemp%>" class="textbox"
...
for (int i =0; i < vRetResult.size() ; i+=4){ %>
  <tr> 
    <td height="25" width="3%" class="thinborderBOTTOMLEFT">&nbsp;</td>
    <td width="32%" class="thinborderBOTTOMRIGHT"><%=vRetResult.elementAt(i + 1)%></td>
	...
	&nbsp;&nbsp;
	<a href="./chart_of_account_search_print.jsp?print_pg=1&ac_coa_cf=<%=vRetResult.elementAt(i)%>"><img src="../../../../images/print.gif" border="0"></a>	</td>
  </tr>
  <%}//end of for loop.

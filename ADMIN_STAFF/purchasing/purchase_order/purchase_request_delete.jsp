...
function DeleteClicked(strPO){
	var vProceed = confirm('Delete '+strPO+' ?');
	if(vProceed){
...
function CancelClicked(){
	location = "./purchase_request_delete.jsp";
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Purchasing-Purchase Order","purchase_request_delete.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
		...
		if(vReqInfo == null){					
			...
			strReqIndex = (String)vReqInfo.elementAt(1);
				if(WI.fillTextValue("deleteClicked").equals("1"))
					vReqInfo = PO.operateOnReqInfoPO(dbOP,request,0,(String)vReqInfo.elementAt(0));
					if(vReqInfo == null)
						strErrMsg = PO.getErrMsg();						
		}
...
%>
<form name="form_" method="post" action="./purchase_request_delete.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>:::: 
          ...
          - DELETE PO PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr> 
	  ...
	  <a href="javascript:DeleteClicked('<%=(String)vReqPO.elementAt(1)%>');">
	  <img src="../../../images/delete.gif" border="0">
	  </a>
	  <font size="1">click to delete this PO</font>

...
<form name="form_" method="post" action="./purchase_request_new.jsp">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="10" class="thinborder">Requested by : <strong><%=(String)vReqInfo.elementAt(3)%></strong></td>
    </tr>
    <tr> 
      ...
      <td width="9%" class="thinborder"><div align="center"><strong>SELECT<br>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	...
	%>
      <td height="25">PURCHASING OFFICER: 
    ...
    <tr> 
      <td height="25"><div align="center"> <a href="javascript:SavePO();"> <img src="../../../images/save.gif" border="0"></a> 
    ...
    <tr>
      <td height="25">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Payment Term (optional) : 
    ...
    <tr> 
      <td height="25"><div align="center"><a href="javascript:PrintPg();"> <img src="../../../images/print.gif" border="0"></a> 

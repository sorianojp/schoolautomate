...
<%
	...
	if(WI.fillTextValue("printPage").equals("1")){%>
		<jsp:forward page="./purchase_approved_requests_print.jsp"/>
	<%}
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-PURCHASE ORDER-Approved Requests","purchase_approved_requests.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form name="form_" method="post" action="purchase_approved_requests.jsp">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td width="5%" height="25" class="thinborder"><div align="center"><font size="1"><strong>PO 
          DATE</strong></font></div></td>
      <td width="10%" class="thinborder"><div align="center"><font size="1"><strong>REQUESTING 
          DEPARTMENT </strong></font></div></td>
      <td width="22%" class="thinborder"><div align="center"><font size="1"><strong>DESCRIPTION</strong></font></div></td>
      <td width="7%" class="thinborder"><div align="center"><font size="1"><strong>DATE 
          PO UPDATED</strong></font></div></td>
      <td width="8%" class="thinborder"><div align="center"><font size="1"><strong>DATE 
          BUDGET</strong></font></div></td>
      <td width="9%" class="thinborder"><font size="1"><strong><strong>PO NO.</strong></strong></font></td>
      <td width="11%" class="thinborder"><div align="center"><font size="1"><strong><strong>DATE 
      ...
      <td width="16%" class="thinborder"><div align="center"><font size="1"><strong>RECEIVED 
          BY </strong></font></div></td>
    </tr>
    <% 
	for(int iLoop = 0;iLoop < vRetResult.size();iLoop+=9){

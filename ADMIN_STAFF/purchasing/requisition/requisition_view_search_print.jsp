...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-REQUISITION-Requisition Print","requisition_view_search_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	String[] astrUrgency = {"Low","Normal","High"};
	int iSearch = 0;
	...
	if(vRetResult != null && vRetResult.size() < 5){
		strErrMsg = "wrong";
		//System.out.println("wrong also");
	}
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="26%"><font size="1"><strong>
        <%if(WI.fillTextValue("req").length() > 0){%>
        <%=astrReqType[Integer.parseInt(WI.fillTextValue("req"))]%>
        <%}else{%>
        All
        <%}%>
        </strong></font></td>
    ...
    <tr>
      <td height="30">&nbsp;</td>
      <td><font size="1">Date Requested</font></td>
      <td><strong><font size="1"><%=WI.getStrValue(WI.fillTextValue("date_req_fr"),"-")+WI.getStrValue(WI.fillTextValue("date_req_to")," - ","","")%></font></strong></td>
      <td><font size="1">Level of Urgency</font></td>
      <td><strong><font size="1">
        <%if(WI.fillTextValue("urgency").length() > 0){%>
        <%=astrUrgency[Integer.parseInt(WI.fillTextValue("urgency"))]%>
        <%}else{%>
        All
        <%}%>
        </font></strong></td>
    ...
    <tr>
      ...
      <td><font size="1">Request For</font></td>
      <td><font size="1"><strong>
	  <%if(WI.fillTextValue("supply").equals("1") && !WI.fillTextValue("non-supply").equals("0")){%>
	  		Supply
	  <%}else if(!WI.fillTextValue("supply").equals("1") && WI.fillTextValue("non-supply").equals("0")){%>
	  		Non-Supply
	  <%}else{%>
	  		Supply & Non-Supply
	  <%}%></strong></font>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="18%"  class="thinborder"><div align="center"><strong>REQUISITION
          NO.</strong></div></td>
      <td width="10%"  class="thinborder"><div align="center"><strong>DATE
          REQUESTED</strong></div></td>
      <td width="15%"  class="thinborder"><div align="center"><strong>REQUESTED
          BY</strong></div></td>
    ...
    <tr>
	  <td  class="thinborder"><div align="center"><%=(iLoop+11)/11%></div></td>

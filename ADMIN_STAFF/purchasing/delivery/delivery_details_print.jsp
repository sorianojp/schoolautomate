...
<%	
	...
	if(strSchCode.startsWith("VMA")){%>
		<jsp:forward page="./delivery_details_print_vma.jsp"></jsp:forward>
	<%return;}
...
<%=SchoolInformation.getAddressLine1(dbOP,false,false)%><br></td>
    ...
    <tr>
	  ...
	  %>
      <td width="14%" valign="bottom" class=<%=strBorderBottom%>><strong>&nbsp;<%=strTemp%></strong></td>
    </tr>
	</table>	
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">		
    <tr> 
...
<%}%>
	...
	<%if(strSchCode.startsWith("WNU")){
				strTemp = "<br>Form No. : OP-BAF-02F07";

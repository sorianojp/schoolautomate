...
<form name="form_" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">    
	  ...
	  <td height="25" colspan="2" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
        ISSUANCE MAIN PAGE ::::</strong></font></div></td>
	  </tr>
  </table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td width="71%"> <a href="issuance_mgmt.jsp"> Create/modify Issuance Form</a></td>
    </tr>
    <tr> 
      <td height="25" colspan="3">&nbsp;</td>
      <td width="71%"> <a href="issuance_view_search.jsp">View/Search Issuance Form</a></td>
    </tr>
    <tr> 

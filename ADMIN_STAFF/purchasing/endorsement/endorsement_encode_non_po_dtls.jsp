...
<%
	...
	if(WI.fillTextValue("printPage").equals("1")){%>
		<jsp:forward page="endorsement_dtls_non_po_print.jsp"/>
	<%}
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-ENDORSEMENT-Delete Endorsement details","endorsement_encode_non_po_dtls.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(WI.fillTextValue("proceedClicked").equals("1")){
		...
		if(vReqInfo == null)
			...
			if(WI.fillTextValue("pageAction").length() > 0){
				vRetResult = EN.operateOnNonPOItemsEn(dbOP,request,Integer.parseInt(WI.fillTextValue("pageAction")),(String)vReqInfo.elementAt(0));
				if(vRetResult == null)
...
%>
<form name="form_" method="post" action="endorsement_encode_non_po_dtls.jsp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="50%"><a href="javascript:OpenSearch();"><img src="../../../images/search.gif" border="0"></a><font size="1">click 
  ...
  <table bgcolor="#FFFFFF" width="100%">
  	<tr>		
      <td height="25" colspan="8"> <div align="right"><a href="javascript:PrintPage();"> 
          <img src="../../../images/print.gif" border="0"></a> <font size="1">click 
          to PRINT this endorsment record</font></div></td>
	</tr>  
  </table>  
  <%}if(vReqItems != null && vReqItems.size() > 3){%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      ...
      <td width="9%" class="thinborder"><div align="center"><strong>ENDORSE<br>
          <input type="checkbox" name="selAll" value="0" onClick="CheckAll();">          
          </strong></div></td>
    </tr>
	<%for(iLoop = 1,iCount = 1;iLoop < vReqItems.size();iLoop+=9,++iCount,++iItems){%>
    <tr> 
	  ...
	  <%if ((((String)vReqItems.elementAt(iLoop+5)).equals("0")) 
	        || (((String)vReqItems.elementAt(iLoop+5)).equals("3"))){%>
	  		N/A
			<input type="hidden" name="endorse_<%=iCount%>" value="0">
	  <%}else{%>
	  		<input type="checkbox" name="endorse_<%=iCount%>" value="1">
	  <%}%>
	  <input type="hidden" name="strPOItemIndex_<%=iCount%>" value="<%=vReqItems.elementAt(iLoop)%>">
	  </div></td>
    </tr>
	<%}%>
    <tr> 
      <td height="25" colspan="4" class="thinborder"><div align="left"><strong>TOTAL 
          ITEM(S) : <%=iCount-1%><input type="hidden" name="numOfItems" value="<%=iCount-1%>"></strong></div>		  </td>
      ...
      <td class="thinborder">&nbsp;</td>
	    ...
	    <tr> 
      <td height="25" colspan="99"><div align="center"></div></td>
    </tr>
  </table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#B9B292"> 
      <td height="25" colspan="8" class="thinborder"><div align="center"><font color="#FFFFFF"><strong>LIST 
          OF ENDORSED ITEM(S) </strong></font></div></td>
    </tr>
    <tr> 
      <td width="7%" height="27" class="thinborder"><div align="center"><strong>ITEM#</strong></div></td>
      <td width="7%" class="thinborder"><div align="center"><strong>QTY</strong></div></td>
      <td width="7%" class="thinborder"><div align="center"><strong>UNIT</strong></div></td>
      <td width="24%" class="thinborder"><div align="center"><strong>ITEM / PARTICULARS / DESCRIPTION</strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong>RECEIVE STATUS</strong></div></td>
    ...
    <tr> 
      <td height="26" class="thinborder"><div align="center"><%=iCount%></div></td>
      <td class="thinborder"><div align="center"><%=vReqItemsEn.elementAt(iLoop+1)%></div></td>
      <td class="thinborder"><div align="center"><%=vReqItemsEn.elementAt(iLoop+2)%></div></td>
      <td class="thinborder"><div align="left"><%=vReqItemsEn.elementAt(iLoop+3)%> / <%=vReqItemsEn.elementAt(iLoop+4)%><%=WI.getStrValue((String)vReqItemsEn.elementAt(iLoop+8),"(",")","")%> 
        </div></td>

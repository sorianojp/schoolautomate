...
<%
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-ENDORSEMENT-Endorsement details","endorsement_view_search_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td><strong><font size="1">
	  <%=WI.getStrValue(dbOP.mapOneToOther("COLLEGE","C_INDEX",WI.fillTextValue("c_index"),"C_NAME",""),"All")+"/"+WI.getStrValue(dbOP.mapOneToOther("DEPARTMENT","D_INDEX",WI.fillTextValue("d_index"),"D_NAME",""),"All")%></font></strong></td>
      <td><font size="1">Requested By</font></td>
      <td><strong><font size="1"> 
        <%if(WI.fillTextValue("req_by_select").equals("equals")){%>
        <%=WI.getStrValue(WI.fillTextValue("req_by"),"-")%> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="7" class="thinborder"><div align="center"><strong>LIST 
          OF ENDORSEMENTS</strong></div></td>
    </tr>
    <tr> 
      <td colspan="7" class="thinborder"><strong>TOTAL RESULT 
        : <%=iSearch%></strong></td>
    </tr>
    <tr> 
      <td width="8%" height="25" class="thinborder"><div align="center"><strong>COUNT NO.</strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong>PO NO. </strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong>REQUISITION NO.</strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong><%if(bolIsSchool){%>COLLEGE<%}else{%>DIVISION<%}%>/DEPT</strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong>OFFICE</strong></div></td>
      <td width="8%" class="thinborder"><div align="center"><strong>TOTAL ITEMS </strong></div></td>
      <td width="12%" class="thinborder"><div align="center"><strong>TOTAL AMOUNT</strong></div></td>
    </tr>
    <% 
 	for(int iCount = 0; iCount <= iMaxStudPerPage; iLoop += 9,++iCount){
    ...
    <tr> 
      <td height="25" class="thinborder"><div align="center"><%=(iLoop+9)/9%></div></td>
      <td class="thinborder"><div align="center"><%=(String)vRetResult.elementAt(iLoop+2)%></div></td>
    ...
    <tr> 
	  ...
	  <%=CommonUtil.formatFloat(dTotalAmount,true)%></div></td>
    </tr>
    <%
    ...
    <tr> 
      <td class="thinborder" height="25" colspan="5"><div align="left"></div>
        <div align="right"><strong>OVERALL SEARCH TOTAL :&nbsp; 
          &nbsp;&nbsp;</strong></div></td>
      <td height="25" colspan="2" class="thinborder"><div align="right">
	  <%=CommonUtil.formatFloat((String)vRetResult.elementAt(0),true)%></div></td>
    </tr>
    <tr> 
      <td class="thinborder" colspan="7" ><div align="center"> *****************NOTHING 
          FOLLOWS *******************</div></td>
    </tr>
    <%}else{%>
    <tr> 
      <td class="thinborder" colspan="7" ><div align="center"> ************** 

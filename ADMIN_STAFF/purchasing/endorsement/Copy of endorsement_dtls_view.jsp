...
//add security here.
	...
	if(vReqInfo == null)
		...
		if(WI.fillTextValue("pageAction").length() > 0){
			vRetResult = EN.operateOnReqItemsEn(dbOP,request,Integer.parseInt(WI.fillTextValue("pageAction")),(String)vReqInfo.elementAt(0));
			if(vRetResult == null)
				strErrMsg = EN.getErrMsg();
		}
...
<form name="form_" method="post" action="endorsement_dtls_view.jsp">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      ...
      <td class="thinborder"><div align="left"><%=vReqItemsPO.elementAt(iLoop+3)%> / <%=vReqItemsPO.elementAt(iLoop+4)%><%=WI.getStrValue((String)vReqItemsPO.elementAt(iLoop+8),"(",")","")%>
        </div></td>
      <td class="thinborder"><div align="left"><%=astrReceiveStat[Integer.parseInt((String)vReqItemsPO.elementAt(iLoop+5))]%></div></td>

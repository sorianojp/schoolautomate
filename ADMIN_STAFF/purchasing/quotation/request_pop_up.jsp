...
function QuoteItem(strReqItemIndex,strReqIndex){	
	var pgLoc = "../quotation/quotation_encode_pop_up.jsp?is_credited=0&req_item_index="+strReqItemIndex+"&opner_form_name=form_1&encode_pop=1&req_index="+strReqIndex;
...
function SupplierSelected(){	
	...
	document.form_1.non_acc_supplier.value = eval('document.form_1.supplier['+selectedIndex+'].text');	
}
</script>
<%
...
//authenticate user access level	
	...
	vReqItems = REQ.getNonPOReqItems(dbOP,request, strReqItemIndex);
	vReqItemsQtn = REQ.showQuotedNonPOItems(dbOP, request, strReqIndex);
	if(vReqItemsQtn == null || vReqItems == null)
		strErrMsg = REQ.getErrMsg();
	vRetResult = REQ.getUncreditedQuote(dbOP, strReqItemIndex);
...
<form name="form_1" method="post" action="./request_pop_up.jsp">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      <td width="5%" height="26" class="thinborder"><div align="center"><strong>QTY</strong></div></td>
      <td width="5%" class="thinborder"><div align="center"><strong>UNIT</strong></div></td>
      <td width="23%" class="thinborder"><div align="center"><strong>ITEM / PARTICULARS 
          / DESCRIPTION </strong></div></td>
      <td width="13%" class="thinborder"><div align="center"><strong>SUPPLIER 
          CODE </strong></div></td>
      <td width="26%" class="thinborder"><div align="center"><strong>PRICE QUOTED</strong></div></td>
      <td width="11%" class="thinborder"><div align="center"><strong>DISCOUNT</strong></div></td>
      <td width="17%" class="thinborder"><div align="center"><strong>FINAL PRICE</strong></div></td>
    </tr>
    ...
    <tr> 
          ...
          <%		  	
			...
			for(; (iLoop + 12) < vReqItemsQtn.size() ;){
			 ...
			 strErrMsg += (String)vReqItemsQtn.elementAt(iLoop+5) + 
			 			   astrQuoteUnit[Integer.parseInt((String)vReqItemsQtn.elementAt(iLoop+9))]+ "<br>&nbsp;";
      ...
      <td class="thinborder"><div align="right"><%=strErrMsg + (String)vReqItemsQtn.elementAt(iLoop+5)+
	  		astrQuoteUnit[Integer.parseInt((String)vReqItemsQtn.elementAt(iLoop+9))]%></div></td>
...
<%if(vReqItems != null && vReqItems.size() > 0){%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <%for(iLoop = 0;iLoop < vReqItems.size();iLoop+=9){%>
    <tr> 
      ...
      <td class="thinborder"><div align="left"><%=(String)vReqItems.elementAt(iLoop+3)%> 
          / <%=(String)vReqItems.elementAt(iLoop+4)%></div></td>
      ...
      <td class="thinborder"><div align="right"><%=WI.getStrValue((String)vReqItems.elementAt(iLoop+8),"&nbsp;")%>&nbsp;</div></td>
    </tr>
    <%}%>
  </table>
  <%}%>
    ...
    <tr> 
      ...
      <td><div align="right">Supplier : 
		...
		for(int i = 0;i < vRetResult.size();i+=8){%>
		  <input type="hidden" name="supplier_<%=(i+8)/8%>" value="<%=vRetResult.elementAt(i+1)%>">
  ...
  <input type="hidden" name="non_acc_supplier">

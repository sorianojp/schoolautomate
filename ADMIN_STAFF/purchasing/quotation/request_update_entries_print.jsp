...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="22%"><font size="1">Requisition No. :</font></td>
      <td width="28%"><font size="1"><strong><%=(String)vReqInfo.elementAt(12)%></strong></font></td>
      <td width="20%"><font size="1">Requested by :</font></td>
      <td width="28%"> <font size="1"><strong><%=(String)vReqInfo.elementAt(2)%></strong></font></td>
    </tr>
    <tr> 
      <td height="26"><font size="1">&nbsp;</font></td>
      <td><font size="1">Request Type :</font></td>
      <td><font size="1"><strong><%=astrReqType[Integer.parseInt((String)vReqInfo.elementAt(1))]%></strong></font></td>
      <td><font size="1">Purpose/Job :</font></td>
      <td><font size="1"><strong><%=(String)vReqInfo.elementAt(5)%></strong></font></td>
    </tr>
    <tr> 
      <td height="26"><font size="1">&nbsp;</font></td>
      <td><font size="1">Requisition Status :</font></td>
      <td><font size="1"><strong><%=astrReqStatus[Integer.parseInt((String)vReqInfo.elementAt(10))]%></strong></font></td>
      <td><font size="1">Requisition Date :</font></td>
      <td><font size="1"><strong><%=(String)vReqInfo.elementAt(7)%></strong></font></td>
    </tr>
    <%if(((String)vReqInfo.elementAt(3)).equals("0")){%>
    <tr> 
      <td height="26"><font size="1">&nbsp;</font></td>
      <td><font size="1">Office :</font></td>
      <td><font size="1"><strong><%=(String)vReqInfo.elementAt(9)%></strong></font></td>
      <td><font size="1">Date Needed :</font></td>
      <td><font size="1"><strong><%=WI.getStrValue((String)vReqInfo.elementAt(6),"&nbsp;")%></strong></font></td>
    </tr>
    <%}else{%>
    <tr> 
      <td height="26"><font size="1">&nbsp;</font></td>
      <td><font size="1">College/Dept :</font></td>
      <td><font size="1"><strong><%=(String)vReqInfo.elementAt(8)+"/"+WI.getStrValue((String)vReqInfo.elementAt(9),"All")%></strong></font></td>
      <td><font size="1">Date Needed :</font></td>
      <td><font size="1"><strong><%=WI.getStrValue((String)vReqInfo.elementAt(6),"&nbsp;")%></strong></font></td>
    </tr>
    <%}%>
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="25" colspan="8" class="thinborder"><div align="center"><font color="#000000"><strong>REQUISITION 
    ...
    <tr> 
      ...
      <td width="36%" class="thinborder"><div align="center"><strong>ITEM/PARTICULARS/DESCRIPTION 
          </strong></div></td>
      ...
      <td width="13%" class="thinborder"><div align="center"><strong>AMOUNT</strong></div></td>
    </tr>
    <% iRowCount = 0;
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      ...
      <td class="thinborder"><div align="right"> 
		  ...
		  <%dTotalAmount += Double.parseDouble(ConversionTable.replaceString((String)vSelItems.elementAt(iLoop+7),",",""));%>
          <%}%>
        </div></td>
    </tr>
    <%}%>

...
function PageAction(strAction,strIndex,strState){
	if(strAction == 0){	
		if(confirm('Delete '+strState+'?')){
...
function FocusID() {
	document.form_.state.select();
	//alert("I am here.");
	document.form_.state.focus();	
}
</script>
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-PURCHASING-SUPPLIERS-Update States","update_states.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	Vector vRetState = new Vector();
	vRetState = null;
	boolean bolErr = false;
	String strLastEntry = WI.getStrValue(WI.fillTextValue("opner_form_field_value"),null);	
	
	if(WI.fillTextValue("pageAction").length() > 0){
		vRetState = SUP.operateOnState(dbOP,request,
	...
	if(WI.fillTextValue("country").length() > 0)
		vRetResult = SUP.operateOnState(dbOP,request,4,WI.fillTextValue("country"));	
%>
<form action="./update_states.jsp" method="post" name="form_">
<%if(WI.fillTextValue("country").length() <= 0){%>
<table>
	<tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          PURCHASING - SUPPLIERS : UPDATE PROVINCES PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td valign="top"><strong><%=dbOP.mapOneToOther("COUNTRY","COUNTRY_INDEX",WI.fillTextValue("country"),"COUNTRY_NAME","")%></strong></td>
    </tr>
    <tr>
	  ...
	  <%if(WI.fillTextValue("pageAction").equals("3"))
			...
			strTemp = "";	  
	  %>
	  <input name="state" type="text" size="32" maxlength="32" value="<%=strTemp%>" class="textbox" 
    ...
    <tr> 
      ...
      <td width="14%">&nbsp;</td>
      <td width="82%"> 
	   <%if(WI.fillTextValue("pageAction").equals("3") || bolErr == true){%>
       ...
       <font size="1">click to save changes</font> 
		...
		<%}else{%>
		<a href="javascript:PageAction(1,<%=WI.fillTextValue("country")%>,'');">
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td colspan="5" bgcolor="#666666"><div align="center"><strong><font color="#FFFFFF">LIST 
          OF </font><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>PROVINCES</strong></font></strong></div></td>
    </tr>
    <tr align="center"> 
      <td width="10%" class="thinborder"><strong>COUNT</strong></td>
      <td width="70%" colspan="2" class="thinborder"><font color="#000000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>PROVINCE</strong></font></td>
    ...
    <tr> 
      ...
      <td colspan="2" class="thinborder"><%=(String)vRetResult.elementAt(iLoop+1)%></td>

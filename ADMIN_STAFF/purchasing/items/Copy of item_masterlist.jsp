...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td width="17%" height="30">&nbsp; Item Name </td>
      <td width="83%" align="left" valign="middle"> <input type="text" name="starts_with" value="<%=WI.fillTextValue("starts_with")%>" size="3" class="textbox"
	   ...
	   if (vEditInfo !=null && vEditInfo.size()>0)
        ...
        <select name="item_idx">
          ...
          <%=dbOP.loadCombo("item_index","item_name"," from pur_preload_item where is_Supply = "+strInvType+"order by item_name", strTemp, false)%> 
        </select> <font size="1"><a href="javascript:UpdateItem(<%=WI.getStrValue(WI.fillTextValue("inventory_type"),"0")%>)";><img src="../../../images/update.gif" width="60" height="25" border="0"></a>click 
        to update Item List </font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="25" valign="bottom" class="style1 bodystyle">&nbsp; Attributes:</td>

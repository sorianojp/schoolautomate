...
<form name="form_" method="post">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
	...
	<tr>
      <td colspan="8"  class="thinborder"><strong>TOTAL RESULT : <%=iSearch%></strong></td>
    </tr>
    <tr>
	  <td width="6%" align="center"  class="thinborder"><strong> COUNT NO.</strong></td>
      <td width="20%"  height="25" align="center"  class="thinborder"><strong><%if(bolIsSchool){%>COLLEGE<%}else{%>DIVISION<%}%>
      / DEPT</strong></td>
      <td width="18%" align="center"  class="thinborder"><strong>OFFICE</strong></td>
      <td width="15%" align="center"  class="thinborder"><strong>REQUISITION
      NO.</strong></td>
      <td width="13%" align="center"  class="thinborder"><strong>DATE
      REQUESTED</strong></td>
      <td width="16%" align="center"  class="thinborder"><strong>REQUESTED
      BY</strong></td>
      <td width="7%" align="center"  class="thinborder"><strong>STATUS</strong></td>
      <td width="5%" align="center"  class="thinborder"><strong>TOTAL
      ITEMS </strong></td>
    </tr>
	<%
...
<%}%>
      ...
      <td  class="thinborder"><div align="center"><%=astrReqStatus[Integer.parseInt((String)vRetResult.elementAt(i+2))]%></div></td>
  ...
  <tr>
    <td class="thinborder" colspan="8" ><div align="center"> *****************NOTHING FOLLOWS *******************</div></td>
  </tr>
   <%}else{%>
  <tr>
    <td class="thinborder" colspan="8" ><div align="center"> ************** CONTINUED ON NEXT PAGE ****************</div></td>
  </tr>
  <%}%>
</table>
  <%

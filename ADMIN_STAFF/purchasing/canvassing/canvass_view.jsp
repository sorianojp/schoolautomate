...
function Forward(){	
	location = "canvass_view2.jsp?req_no="+document.form_.req_no.value+
...
<%if(vReqInfo != null && vReqInfo.size() > 0) {%>
 <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#C78D8D"> 
      ...
      <td colspan="4"><div align="center"><strong>REQUISITION DETAILS for CANVASS NO. <%=WI.fillTextValue("canvass_no")%></strong></div></td>
    </tr>
    <tr> 
    ...
    <tr>
      <td height="21">&nbsp;</td>
      <td height="21" colspan="2"><a href="javascript:Forward();">Click here for other format</a></td>
      <td height="21">&nbsp;</td>
      <td height="21">&nbsp;</td>
    </tr>
  </table>  

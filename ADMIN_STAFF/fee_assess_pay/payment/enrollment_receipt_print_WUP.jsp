...
<%
	...
	String[] astrConvertYear = {"","1st Year","2nd Year","3rd Year", "4th Year","5th Year","6th Year"};
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<td rowspan="2" align="right">&nbsp; <font size="3"><strong><%=(String)vStudInfo.elementAt(16)%></strong></font></td>
	</tr>
	...
	<tr>
		<td>Course:</td>
		<td colspan="2">&nbsp; <%=((String)vStudInfo.elementAt(2)).toUpperCase()%> (<%=(String)vStudInfo.elementAt(16)%>), <%=astrConvertYear[Integer.parseInt(WI.getStrValue((String)vStudInfo.elementAt(4), "0"))]%></td>
	</tr>
</table>
<!--
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="">
	...
	<tr ><td colspan="7" align="center" height="35"><strong><font size="1"><u>SUBJECTS ENROLLED</u></font></strong></td>	</tr>
...
strSchedule = null;
  ...
  <tr >
	  ...
	  <td align="center" style="border-top: solid 1px #000000; border-bottom: solid 1px #000000;">&nbsp;<%=fUnitsTaken%></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
	...
	<tr>
		...
		<td>&nbsp;&nbsp;&nbsp; TUITION FEE</td>
		<td>&nbsp;</td>
		<td align="right">&nbsp;<strong><%=CommonUtil.formatFloat(fTutionFee,true)%></strong></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>&nbsp;&nbsp;&nbsp; MISCELLANEOUS</td>
...
<%}%>
	...
	<tr>
		...
		<td>&nbsp;</td>
		<td align="right" style="border-bottom: solid 1px #000000;border-top: solid 1px #000000;">&nbsp;<strong><%=CommonUtil.formatFloat(fTutionFee+fCompLabFee+fMiscFee,true)%></strong></td>
	</tr>
</table>
...
<%
 ...
 %>
	...
	<tr>
       ...
       <tr>
	   		<td width="25%">&nbsp;</td>
          	<td width="25%">&nbsp;&nbsp;<%=((String)vInstallmentDtls.elementAt(5)).toUpperCase()%> 
		  	<td width="10%">&nbsp;
			  <%if(bolShowExamDate){%>(<%=vInstallmentDtls.elementAt(6)%>)<%}%> : 
			  <%//=CommonUtil.formatFloat(Double.parseDouble((String)vInstallmentDtls.elementAt(7)) + dAddToInstallationFee,true)%>
			  <%=CommonUtil.formatFloat(dInstallmentAmt, true)%>
		   	</td>		  
			<td width="10%">&nbsp;</td>
			<td width="">&nbsp;</td>
  </tr>
        ...
        <tr>
          	<td width="25%">&nbsp;</td>
          	<td width="25%">&nbsp;<%if(vInstallmentDtls != null && vInstallmentDtls.size() > 5 + 3*1) //prelim
				{%> <%=((String)vInstallmentDtls.elementAt(5+3*1)).toUpperCase()%> 
			<td width="10%">&nbsp;
        ...
        <tr>		
          	<td width="25%">&nbsp;</td>
          	<td width="25%">&nbsp;&nbsp;<%=((String)vInstallmentDtls.elementAt(5+ 3*2)).toUpperCase()%>  
		  	<td width="10%">&nbsp;
			  <%if(bolShowExamDate){%>(<%=vInstallmentDtls.elementAt(5+3*2 + 1)%>)<%}%>: 
			  <%//=CommonUtil.formatFloat(Double.parseDouble((String)vInstallmentDtls.elementAt(5+ 3*2+2)) + dAddToInstallationFee,true)%> 
			  <%=CommonUtil.formatFloat(dInstallmentAmt, true)%>
		  	</td>
		  	<td width="10%">&nbsp;</td>
			<td width="">&nbsp;</td>
        ...
        <tr>
          	<td width="25%">&nbsp;</td>
          	<td width="25%">&nbsp;&nbsp;<%=((String)vInstallmentDtls.elementAt(5+ 3*3)).toUpperCase()%> 
		  	<td width="10%">&nbsp;
			  <%if(bolShowExamDate){%>(<%=vInstallmentDtls.elementAt(5+3*3 + 1)%>)<%}%>: 
			  <%//=CommonUtil.formatFloat(Double.parseDouble((String)vInstallmentDtls.elementAt(5+ 3*3+2)) + dAddToInstallationFee,true)%>
			  <%=CommonUtil.formatFloat(dInstallmentAmt, true)%> 
		  	</td>
			<td width="10%">&nbsp;</td>
			<td width="">&nbsp;</td>
	...
	<tr>
		<td width="100%">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" >
				<tr>
					<td width="60%" style="border-top: solid 1px #000000;" class="fontSize6"><font size="1">
						Note: This assessment form is not valid unless marked enrolled and signed by the teller/cashier.</font></td>
					<td align="right" width="25%" style="border-top: solid 1px #000000;" valign="top">Print Date: <%=WI.getTodaysDate(16)%> <%=WI.getTodaysDate(15)%></td>
					<td width="15%" align="right" style="border-top: solid 1px #000000;" valign="top"><strong>ASSESSMENT FORM</strong></td>
				</tr>
			</table>
		</td>
	</tr>

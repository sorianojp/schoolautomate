...
function UpdateSection(strSection){
	if(document.getElementById('section_id').innerHTML == "")
		document.getElementById('section_id').innerHTML = strSection;
}
</script>
...
if(false && vORInfo.elementAt(19) == null) {//basic.. 
	dbOP.cleanUP();
	///forward the page.. 
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td valign="bottom" height="70" align="center"><strong><!--<%=astrConvertSem[Integer.parseInt(astrSchYrInfo[2])]%>, -->AY <%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%></strong></td>
	</tr>
    <tr >
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td>Grade / Section</td>
    <td colspan="2"><strong><%=dbOP.getBasicEducationLevel(Integer.parseInt(WI.getStrValue(vStudInfo.elementAt(4),"0")))%> 
	/ <label id="section_id" style="position:absolute;"></label> </strong></td>
  </tr>
  <tr>
    ...
    <td width="20%"><strong><%=WI.getStrValue(vStudInfo.elementAt(13),"")%></strong></td>
...
%>
<script>UpdateSection('<%=WI.getStrValue(strSection)%>')</script>
  <tr >

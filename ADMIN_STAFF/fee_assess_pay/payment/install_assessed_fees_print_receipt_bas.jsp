...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-PAYMENT-installment fees print","install_assessed_fees_print_receipt.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
  <tr >
    <td height="25" colspan="2" ><div align="<%=strTemp%>">PAYMENT
        FOR <%=((String)vRetResult.elementAt(28)).toUpperCase()%>&nbsp;&nbsp;&nbsp;</div></td>
  </tr>
  <tr >
    <td width="48%" height="25" >Date and time printed : <strong><%=WI.getTodaysDate()%></strong></td>
  ...
  <tr >
    ...
    <td height="25" >Year : <strong> <%=dbOP.getBasicEducationLevel(Integer.parseInt(WI.getStrValue(vRetResult.elementAt(21),"0")))%></strong></td>
  </tr>
  <tr >
    <td height="25" colspan="2" class="thinborderBOTTOM">Student name :<strong>
      <%

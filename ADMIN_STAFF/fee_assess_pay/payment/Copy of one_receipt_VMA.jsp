...
String[] astrConvertSem = {"SU","1S","2S","3S"};
			...
			<td width="50%">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
					...
					<tr valign="top" height="20">
					  <td colspan="2" valign="bottom"><%=strStudName%></td>
					  <td valign="bottom"><%=strStudID%></td>
				  </tr>
					<tr valign="top">
					  <td colspan="3">
					  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<tr valign="top">
					  <td width="54%"><%=strCourse%> <%=WI.getStrValue((String)vRetResult.elementAt(21))%></td>
					  <td width="12%">
						<%=astrConvertSem[Integer.parseInt((String)vRetResult.elementAt(22))]%>
					  </td>
					  <td><%=(String)vRetResult.elementAt(23) +"-"+ ((String)vRetResult.elementAt(24))%></td>
				  </tr>
					<tr valign="top">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
					<tr valign="bottom">
					  ...
					  <td width="34%" style="font-size:14px; font-weight:bold"><%=CommonUtil.formatFloat((String)vRetResult.elementAt(11),true)%></td>
				  </tr>
					<tr valign="bottom">
					  <td height="25" colspan="4"><%=new ConversionTable().convertAmoutToFigure(Double.parseDouble(strAmount),"Pesos","Centavos")%></td>
				  </tr>
					<tr valign="bottom">

...
if(strErrMsg == null) //collect fee details here.
{
	...
	if(fTutionFee > 0f)
	{
		...
		vAssessedSubDetail = FA.getAssessSubDetailAfterOrBeforeEnrl(dbOP,(String)vStudInfo.elementAt(0),paymentUtil.isTempStud(),
					...
					(String)vORInfo.elementAt(22),"1","0");//pass degree type as 0 by default.. 
...
if(vStudInfo != null) {
	...
	if(rs.next()) {
	  ...
	  double dAmtPaidDurEnrl = Double.parseDouble((String)vORInfo.elementAt(11));
	  double dTotalPayableAmt = fTutionFee+fCompLabFee+fMiscFee + fOutstanding  - fEnrollmentDiscount;
...
%>	
  ...
  <tr>
    <td height="18">&nbsp;</td>
    <td colspan="4">&nbsp;<strong><%=dbOP.getBasicEducationLevelNew(Integer.parseInt((String)vStudInfo.elementAt(4)))%></strong><!-- Grade Lvl --></td>
...
strSchedule = null;
  ...
  <tr >
    ...
    <td><strong> <%=CommonUtil.formatFloat((double)fUnitsTaken, true)%></strong></td>
    <td width="21%">&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
...
%>	
  ...
  <tr>
    <td height="18">&nbsp;</td>
    <td colspan="4">&nbsp;<strong><%=dbOP.getBasicEducationLevelNew(Integer.parseInt((String)vStudInfo.elementAt(4)))%></strong><!-- Course - Year Lvl --></td>
    <td><%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%><!-- Acad Year --></td>
  </tr>
  <tr>
    <td height="22" colspan="6">&nbsp;</td>
...
<table width="265" border="0" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<!--<table border="0" cellpadding="0" cellspacing="4" class="thinborderALL">
			<tr>
	...
	<tr>
	  <td height="14">Less Initial Payment </td>
	  <td height="14" align="right"><%=CommonUtil.formatFloat(dAmtPaidDurEnrl,true)%></td>
  </tr>
	<tr style="font-weight:bold">
	  <td height="14">Total Balance Due </td>
	  <td height="14" align="right"><%=CommonUtil.formatFloat(dTotalPayableAmt - dAmtPaidDurEnrl ,true)%></td>
  </tr>
	<%
		...
		double dInstalmentPmt = (fTutionFee+fCompLabFee+fMiscFee - dAmtPaidDurEnrl)/iCount;
...
<tr>
	...
	<br/><br/><br/><br/><br/><br/><br/><br/>
		<table border="0" width="425" cellpadding="0" cellspacing="0" class="thinborder">
			<tr style="font-weight:bold" class="thinborder">
				<td class="thinborder">DATE DUE</td>
				<td class="thinborder">AMOUNT</td>
				<td class="thinborder">OR NUMBER</td>
				<td class="thinborder">DATE</td>
				<td class="thinborder">RECEIVED BY</td>
			</tr>
	<%	
		for(int i = 5; i < vInstallmentDtls.size(); i+=3){%>
		<tr>	
			<td height="18" width="150" class="thinborder"><%=vInstallmentDtls.elementAt(i)%></td>		
			<td class="thinborder">
			<%
			if(i == 5)
				dInstalmentPmt = dInstalmentPmt + (double) fOutstanding;
				...
				dInstalmentPmt = dInstalmentPmt - (double) fOutstanding;
			%>
			<%=CommonUtil.formatFloat(dInstalmentPmt, true)%></td>

		...
		<td width="70%" valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				...
				<tr><td width="53%" height="25" valign="bottom" style="padding-left:200px;"><!--stud id--><%=strStudID%></td>
				    <td height="25" valign="bottom" align="right" style="padding-right:40px;">&nbsp;</td>
				    <td height="25" valign="bottom" align="right" style="padding-right:40px;"><!--date paid--><%=strDatePaid%></td>
				</tr>
				
				<tr><td height="22" colspan="2"><!--stud name--><%=strStudName%></td>
				...
				<tr>
				    <td colspan="3" style="padding-left:70px;"><%=new ConversionTable().convertAmoutToFigure(Double.parseDouble(strAmount),"Pesos","Centavos")%></td>
			    </tr>
				<tr>
				    <td height="25" colspan="3" style="padding-left:50px;">&nbsp;</td>
			    </tr>
				
				
				
				<tr>
				    <td style="padding-left:50px;" height="16" colspan="3"><!--CASH--><%=WI.getStrValue(strCash)%></td>
			    </tr>
				<tr>
				    <td style="padding-left:50px;" height="16"><!--CHECK--><%=WI.getStrValue(strCheck)%></td>
			        <td width="26%" style="padding-left:50px;">&nbsp;</td>
					<%
					if(strCash == null)
						strCash = strCheck;
					%>
				...
				<tr>
					...
					<td valign="bottom" colspan="2"><%=request.getSession(false).getAttribute("first_name")%>

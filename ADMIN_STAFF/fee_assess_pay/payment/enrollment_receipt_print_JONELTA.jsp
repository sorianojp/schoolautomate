...
if(vORInfo.elementAt(19) == null) {//basic.. 
	dbOP.cleanUP();
	///forward the page.. 
	strORNumber += "&prevent_forward="+WI.fillTextValue("prevent_forward");
	//System.out.println(strORNumber);
...
if(WI.fillTextValue("prevent_forward").length() > 0) {
	bolShowMiscDtls = true;
	bolShowOthChargeDtls = true;
}
  ...
  <tr>
    <td width="45%" height="14" valign="top">&nbsp;
     ...
     <%}if(bolShowMiscDtls) {%>
       ...
       <%if(strSchoolCode.startsWith("AUF") || strSchoolCode.startsWith("UDMC") || true){%>
        ...
        <tr>
          <td height="14"><font size="1">TOTAL OTHER CHARGE<%if(strSchoolCode.startsWith("CSA")){%>S<%}%></font></td>
...
<%}%>
        <tr>
		  ...
		  <%if(true) {//check here if there is any plan taken by student.. 

...
function StatusChanged(strIndex){
	eval("document.form_.status_changed_"+strIndex+".value = 1");
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								...
								"check_payment_update_status.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();%>
...
%>
<form name="form_" action="./check_payment_update_status.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
          UPDATE CHECK PAYMENT STATUS PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td height="25"> <select name="exam_sched">
          <option value="">All</option>
          <%=dbOP.loadCombo("PMT_SCH_INDEX","EXAM_NAME"," from FA_PMT_SCHEDULE where IS_DEL=0",
		  WI.fillTextValue("exam_sched"), false)%> </select></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="5%"  height="25"><div align="center"><font size="1"><strong>NO.</strong></font></div></td>
      <td width="10%"><div align="center"><font size="1"><strong>STUDENT ID</strong></font></div></td>
      <td width="20%"><div align="center"><strong><font size="1">PAYEE NAME </font></strong></div></td>
      ...
      <td width="10%"><div align="center"><font size="1"><strong>CHECK STATUS</strong></font></div>
    ...
    <tr>
      ...
      <td><div align="left"><font size="1"><%=WI.getStrValue(vRetResult.elementAt(iLoop), "&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=strName%></font></div></td>
      <td><div align="left"><font size="1"><%=WI.getStrValue((String)vRetResult.elementAt(iLoop+4),"&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=(String)vRetResult.elementAt(iLoop+5)%></font></div></td>
      ...
      <td><div align="left"><font size="1"><%=(String)vRetResult.elementAt(iLoop+8)+WI.getStrValue((String)vRetResult.elementAt(iLoop+9)," / ","","")%></font></div></td>
      <td><div align="center">
          <select name="check_status_<%=(iLoop+13)/13%>" onChange="StatusChanged('<%=(iLoop+13)/13%>')" style="font-size:10px; color:#0000FF">
            <option value="1">Cleared</option>
            <%if((vRetResult.elementAt(iLoop+10) != null )&&((String)vRetResult.elementAt(iLoop+10)).equals("1")){%>
            <option value="0" selected>For Clearing</option>
            <option value="2">Bounced</option>
            <%}else if((vRetResult.elementAt(iLoop+10) != null )&&((String)vRetResult.elementAt(iLoop+10)).equals("2")){%>
            <option value="0">For Clearing</option>
            <option value="2" selected>Bounced</option>
            <%}else{%>
            <option value="0">For Clearing</option>
          ...
          <input type="hidden" name="status_changed_<%=(iLoop+13)/13%>" value="">

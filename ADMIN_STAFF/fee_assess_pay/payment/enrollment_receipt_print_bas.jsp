...
<%
	...
	if(strSchoolCode.startsWith("NEU")){%>
		<jsp:forward page="./enrollment_receipt_print_bas_neu.jsp" />
	<%}
	...
	if(strSchoolCode.startsWith("UB")){
		...
		<jsp:forward page="./enrollment_receipt_print_bas_ub.jsp" />
	<%}
	}
%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <td>Grade Level</td>
    <td colspan="2"><strong><%=dbOP.getBasicEducationLevelNew(Integer.parseInt(WI.getStrValue(vStudInfo.elementAt(4),"0")))%></strong></td> 
  </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr >
    <td colspan="5" height="18">Note: Above schedule may change after enrolment adjustments</td>
  </tr>
</table>
<%}%>
    ...
    <td width="45%" height="14" valign="top">&nbsp;
       ...
       <%}%>
		   ...
		   <%if(strSchoolCode.startsWith("AUF") || !bolShowMisc){%>
			...
			<%}%>
			 ...
			 if(!strSchoolCode.startsWith("AUF") && bolShowMisc){
				...
				<%}%>
			<tr> 
			  <td height="14"><strong>TOTAL MISCELLANEOUS</strong></td>
		...
		<tr> 
          ...
          <td height="14" style="font-weight:bold"><div align="right"><%if(!bolShowOC){%><%=CommonUtil.formatFloat(fMiscOtherFee,true)%><%}%></div></td>
        </tr>
		<%if(bolShowOC){%>
			 <%
			for(int i = 0; i< vMiscFeeInfo.size(); i +=3){
        ...
        <tr>
          <td height="14" colspan="2" style="border-top:solid 1px #000000;border-bottom:solid 1px #000000;border-left:solid 1px #000000;border-right:solid 1px #000000;">
			  ...
			  <%if(strSchoolCode.startsWith("DBTC")){%>
				  ...
				  <br><br>
				  1. Withdrawal within the enrolment period up to the 1st week of classes: 10% of the total charges will be charged.
				  <br>
				  2. Withdrawal within the enrolment period up to the 2nd week of classes: 20% of the total charges will be charged.
				  <br>
...
if(strSchoolCode.startsWith("VMUF")){%>
 ...
 <%}
 if(!strSchoolCode.startsWith("AUF") && !strSchoolCode.startsWith("WNU") && !bolIsSPC){%>  
 <tr >
  ...
  <tr >
    ...
    <td align="center"><em><strong>Registrar</strong></em></td>
    <td colspan="2" >&nbsp;</td>
  </tr>
<%}
 if(bolIsSPC){%>

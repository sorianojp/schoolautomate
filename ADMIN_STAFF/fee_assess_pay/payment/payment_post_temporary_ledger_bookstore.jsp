...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-PAYMENT-Pre enrollment fee","payment_post_temporary_ledger_bookstore.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strSchoolCode.startsWith("FATIMA")) {
	iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
															"Fee Assessment & Payments","BOOKSTORE BANK POSTING",request.getRemoteAddr(),
															null);
}
else {
	iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
...
if(strTemp.length() > 0 && strStudIndex != null) {
	if(faPayment.operateOnPaymentPostingToLedgerBookStore(dbOP, request, Integer.parseInt(strTemp), strStudIndex) == null)
		strErrMsg = faPayment.getErrMsg();
	else
		strErrMsg = "Operation Successful";
}
if(strStudIndex != null) {
	vRetResult = faPayment.operateOnPaymentPostingToLedgerBookStore(dbOP, request, 4, strStudIndex);
}
...
<form name="form_" action="./payment_post_temporary_ledger_bookstore.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" bgcolor="#A49A6A"><div align="center"> <font color="#FFFFFF"><strong>::::
          BANK POSTING FOR BOOK STORE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
if(strTemp.equals("1")){%>
    ...
    <tr >
      ...
      <td width="39%">
	  <input type="button" name="view_" value="VIEW ALL" onClick="document.form_.view_all.value='1';document.form_.page_action.value='';document.form_.submit();">
...
%>
    ...
    <tr>
	  ...
	  <select name="bank_index">
      	<%=dbOP.loadCombo("BANK_INDEX","BANK_NAME, BRANCH", " from FA_BANK_LIST where is_valid = 1 order by bank_code", request.getParameter("bank_index"), false)%>
      </select>	  </td>
    </tr>
    <tr>
...
<%if(vRetResult != null && vRetResult.size() > 0) {%>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr>
      <td height="25" colspan="8" bgcolor="#cccccc" class="thinborder" align="center" style="font-weight:bold; font-size:12px;">List of Bank Posting for BookStore </td>
    </tr>
    <tr align="center" style="font-weight:bold">
      ...
      <td class="thinborder" width="10%">Refernce Number </td>
      <td class="thinborder" width="10%">Payment Note </td>
...
for(int i = 0; i < vRetResult.size(); i += 8) {%>
    <tr>
      ...
      <td class="thinborder" height="25"><%=(String)vRetResult.elementAt(i + 4)%></td>

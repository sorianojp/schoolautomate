...
<%
	...
	if(strSchoolCode.startsWith("DLSHSI")) {
		if(WI.fillTextValue("prevent_forward").length() == 0) {%>
			<jsp:forward page="./enrollment_receipt_print_dlshsi.jsp" />
	<%}
	}
	if(strSchoolCode.startsWith("HTC")){%>
		<jsp:forward page="./enrollment_receipt_print_htc.jsp" />
	<%}
	if(strSchoolCode.startsWith("NEU")){%>
		<jsp:forward page="./enrollment_receipt_print_neu.jsp" />
	<%}
	if(strSchoolCode.startsWith("SPC")){%>
		<jsp:forward page="./enrollment_receipt_print_spc.jsp" />
	<%}
	...
	<%}
	if(strSchoolCode.startsWith("UPH10_")){//Jonelta - Isabella%>
		<jsp:forward page="./enrollment_receipt_print_UPHS_Isabella.jsp" />
	<%}
	if(strSchoolCode.startsWith("UPH") && !strSchoolCode.startsWith("UPH07")){%>
		<jsp:forward page="./enrollment_receipt_print_UPHS.jsp" />
	<%}
	if(strSchoolCode.startsWith("WUP") && WI.fillTextValue("prevent_forward").length() == 0){%>
		<jsp:forward page="./enrollment_receipt_print_WUP.jsp" />
	<%}
	if(strSchoolCode.startsWith("UPH07")){//Jonelta- Manila branch%>
		<jsp:forward page="./enrollment_receipt_print_JONELTA.jsp" />
	<%}
	if(strSchoolCode.startsWith("VMA")){%>
		<jsp:forward page="./enrollment_receipt_print_vma.jsp" />
	<%}
	if(strSchoolCode.startsWith("UB")){
		if(WI.fillTextValue("prevent_forward").length() == 0) {%>
		<jsp:forward page="./enrollment_receipt_print_ub.jsp" />
	<%}
	}
	if(strSchoolCode.startsWith("PWC")){%>
		<jsp:forward page="./enrollment_receipt_print_pwc.jsp" />
	<%}
	if(strSchoolCode.startsWith("SWU")){
		if(WI.fillTextValue("prevent_forward").length() == 0) {%>
		<jsp:forward page="./enrollment_receipt_print_swu.jsp" />
	<%}else{%>
		<jsp:forward page="./enrollment_receipt_print_swu2.jsp" />
	<%}
	}
...
if(strSchoolCode.startsWith("WNU") || strSchoolCode.startsWith("CSA"))
	...
	strTemp = "CERTIFICATION OF ENROLMENT AND BILLING";
else	
...
if(strSchoolCode.startsWith("VMUF") && (vStudInfo.elementAt(15) != null && ((String)vStudInfo.elementAt(15)).toLowerCase().startsWith("o"))){%>
 ...
 if(!strSchoolCode.startsWith("AUF") && !strSchoolCode.startsWith("CGH") && !strSchoolCode.startsWith("WNU") 
	...
	&& !strSchoolCode.startsWith("SPC")  && !strSchoolCode.startsWith("CDD")){%>
 <tr >
...
<tr>
  <td valign="bottom">Prepared by:</td>
  <td valign="bottom">&nbsp;</td>
</tr>
<tr><td valign="bottom" height="30"><strong>CATHERINE A. SOLOMON</strong></td>
    <td valign="bottom">&nbsp;</td>
</tr>
<tr><td valign="top">College Registrar</td>
    <td valign="top">&nbsp;</td>
</tr>
<tr><td height="25"></td>
    <td></td>
...
<tr><td valign="bottom" height="30"><strong>RENATO L. ABRIGO</strong></td>
    <td valign="bottom"></td>
</tr>
<tr><td valign="top">Chief Accountant</td>
    <td valign="top"></td>
</tr>
</table>
<%}

...
<tr>
  <td width="67%" height="95" valign="top">
  <br><br><br><br><br>
  	<table border="0" cellspacing="0" cellpadding="0" width="100%">
		<tr valign="top" align="center">		
			<td height="2" colspan="3" align="right" style="font-size:10px; padding-right:50px;"><%if(!bolIsCavite){%><%=request.getParameter("or_number")%><%}%></td>
		</tr>
		<tr valign="top">
		   <td style="font-size:10px;" height="2">&nbsp;</td>
		   <td width="65%" style="font-size:10px;">&nbsp;</td>
		   <td style="font-size:10px;">&nbsp;</td>
		   </tr>
		<tr valign="top">
			<td style="font-size:10px; padding-left:15px;" height="2" width="20%"><%=strStudID%></td>		
			<td style="font-size:10px;"><%=strStudName%></td>
			<td style="font-size:10px;" width="15%"><%=strCourse%></td>
		</tr>
		<tr valign="top">
		  <td height="5">&nbsp;</td>
		  <td colspan="2">&nbsp;</td>
		...
		<tr valign="top">
		  <td height="2" style="font-size:10px; padding-left:15px;"><%=CommonUtil.formatFloat(strAmount,true)%></td>
		  <td colspan="2" style="font-size:10px;"><%=new ConversionTable().convertAmoutToFigure(Double.parseDouble(strAmount),"Pesos","Centavos")%></td>
	  </tr>
	  <tr valign="top">
		  <td height="25">&nbsp;</td>
		  <td colspan="2">&nbsp;</td>
	...
	<table border=0 cellspacing=0 cellpadding=0 width="100%">
		<tr valign="top">
		  <td width="59%" height="25" style="padding-left:65px; font-size:10px;"><br>
		     <%=strPaymentFor%></td>
		  <td width="10%" style="font-size:10px;">
				<br>
			  <%=astrConvertSem[Integer.parseInt((String)vRetResult.elementAt(22))]%>
			  <br>
			  <%=(String)vRetResult.elementAt(23) + "-"+((String)vRetResult.elementAt(24)).substring(2)%>	      </td>
	  		<td width="31%" valign="top">
				<table width="100%" cellpadding="0" cellspacing="0" border="0" class="thinborderALL">
				<tr>
					<td width="69%">VATABLE</td>
					<td width="31%" align="right">0.00</td>
				</tr>
				<tr>
					<td>NON-VAT/EXEMPT SALE</td>
					<td align="right"><%=CommonUtil.formatFloat(strAmount,true)%></td>
				</tr>
				<tr>
...
%>
	...
	<table border=0 cellspacing=0 cellpadding=0 width="100%">
		<tr valign="top" align="center">
			<td width="16%">&nbsp;</td>
			<td style="font-size:10px;" width="18%" align="left"><%=strAmtTendered%>
			<br>
			<%		
			...
			<td width="21%" style="font-size:10px;" valign="top"><br>
			   <%=(String)request.getSession(false).getAttribute("first_name")%></td>
			<td width="12%" style="font-size:10px;" valign="top"><br>
			   <%=strDatePaid%></td>
			...
			<br>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0">
					<tr align="center">
						<td width="50%" style="font-size:10px;"><%=request.getParameter("or_number")%></td>
						<td width="50%" align="right" style="font-size:10px;"><%=CommonUtil.formatFloat(strAmount,true)%></td>
					</tr>
				</table>
			</td>
		</tr>
...
<td width="33%" valign="top"  align="right">
	...
	<table border="0" cellspacing="0" cellpadding="0" width="98%">
		<tr>
			<td width="42%"><strong><font style="font-size:12px;"><%=WI.getStrValue(WI.getStrValue(strPmtSchName).toUpperCase(),"<u>","</u>","&nbsp;")%></font></strong></td>
			<td width="58%" align="right"><font style="font-size:12px;"><%=WI.getStrValue(strAdmSlipNumber)%></font></td>
		</tr>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="98%">		
		<tr>
			<td colspan="2" style="padding-left:20px;"><font style="font-size:12px;"><%=strStudName%></font></td>
		</tr>
		<tr>
			<td width="37%" align="right" valign="middle"><font style="font-size:12px;"><%=strCourse%></font></td>
		    <td width="63%" align="right" valign="middle"><font style="font-size:12px;"><% if(vRetResult.elementAt(22) != null){%>

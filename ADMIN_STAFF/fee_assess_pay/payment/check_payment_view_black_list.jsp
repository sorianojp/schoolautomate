...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								...
								"check_payment_view_black_list.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();%>
	...
	String[] astrSortByName = {"Check No.","OR No.","Bank","ID No.","Lastname","Firstname","Exam Schedule"};
	String[] astrSortByVal = {"CHECK_NO","OR_NUMBER","CHECK_FR_BANK_INDEX","ID_NUMBER","LNAME","FNAME","FA_STUD_PAYMENT.PMT_SCH_INDEX"};

	if(WI.fillTextValue("proceedClicked").equals("1")){
		if(WI.fillTextValue("saveClicked").equals("1")){
			if(CP.updateCheckStatus(dbOP,request))
...
%>
<form name="form_" action="./check_payment_view_black_list.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
          VIEW/SEARCH BLOCKED CHECK PAYMENTS PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td height="25"> <select name="check_no_select">
          <%=CP.constructGenericDropList(WI.fillTextValue("check_no_select"),astrDropListEqual,astrDropListValEqual)%> </select> <input type="text" name="check_no" class="textbox" value="<%=WI.fillTextValue("check_no")%>"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
      </td>
    </tr>
    <tr>
      ...
      <td height="25"> <select name="bank" style="font-size:11px">
          <option value="">All</option>
      <%=dbOP.loadCombo("BANK_INDEX","BANK_CODE +':::'+BRANCH"," from FA_BANK_LIST where is_valid =1 order by bank_code", request.getParameter("bank"),
	  		false)%>
		 </select></td>
    </tr>
    <tr>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td width="4%"  height="25"><div align="center"><font size="1"><strong>
          NO. </strong></font></div></td>
      <td width="8%"><div align="center"><font size="1"><strong>STUDENT ID</strong></font></div></td>
      <td width="16%"><div align="center"><font size="1"><strong>STUDENT NAME</strong></font></div></td>
      <td width="14%"><div align="center"><font size="1"><strong>COURSE</strong></font></div></td>
      <td width="9%"><div align="center"><font size="1"><strong>BANK</strong></font></div></td>
      <td width="17%"><div align="center"><font size="1"><strong>CHECK NO.</strong></font></div></td>
      <td width="15%"><div align="center"><font size="1"><strong>OR NO.</strong></font></div></td>
      <td width="12%"><div align="center"><font size="1"><strong>AMOUNT</strong></font></div></td>
      <td width="5%"><div align="center"><font size="1"><strong>REMOVE</strong></font></div>
        <div align="center"><font size="1"></font></div></td>
    </tr>
	<% int iLoop = 0;
	for(;iLoop < vRetResult.size();iLoop+=13){%>
    <tr>
      <td  height="25"><div align="center"><font size="1"><%=(iLoop+13)/13%></font></div></td>
      <td><div align="left"><font size="1"><%=WI.getStrValue((String)vRetResult.elementAt(iLoop),"&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=WI.formatName((String)vRetResult.elementAt(iLoop+1),(String)vRetResult.elementAt(iLoop+2),
	  (String)vRetResult.elementAt(iLoop+3),4)%></font>&nbsp;</div></td>
      <td><div align="left"><font size="1"><%=WI.getStrValue((String)vRetResult.elementAt(iLoop+11),"&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=WI.getStrValue((String)vRetResult.elementAt(iLoop+4),"&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=WI.getStrValue((String)vRetResult.elementAt(iLoop+5),"&nbsp;")%></font></div></td>
      <td><div align="left"><font size="1"><%=(String)vRetResult.elementAt(iLoop+6)%></font></div></td>
      <td><div align="right"><font size="1"><%=CommonUtil.formatFloat(Double.parseDouble((String)vRetResult.elementAt(iLoop+7)),true)%></font></div></td>
      <td><div align="center">
          <input type="checkbox" name="remove_<%=(iLoop+13)/13%>" value="1">
		  <input type="hidden" name="payment_index_<%=(iLoop+13)/13%>" value="<%=(String)vRetResult.elementAt(iLoop+12)%>">
        </div></td>
    </tr>
	<%}%>
	<input type="hidden" name="num_checks" value="<%=((iLoop+13)/13)-1%>">
  </table>
  ...
  <input type="hidden" name="removeStud" value="1">
</form>
</body>
</html>
<%

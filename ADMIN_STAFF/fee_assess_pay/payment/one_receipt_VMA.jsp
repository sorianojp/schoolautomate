...
<body leftmargin="30" rightmargin="0" topmargin="30" bottommargin="0" onLoad="window.print();">
...
if(vRetResult == null) {
	...
	if(!vRetResult.elementAt(45).equals("0")) {
		...
		if(vRetResult.elementAt(33) != null)
			...
			if(vRetResult.elementAt(54).equals("1"))
				strPaymentFor = "Tuition Fee-Unearned";
		}
		else {
			...
			if(vRetResult.elementAt(42) != null)
				...
				strPaymentFor = "A/R STUDENT";
			else
				strPaymentFor = (String)vRetResult.elementAt(5);
		}
		if(strPaymentFor != null)
			strPaymentFor = strPaymentFor.toUpperCase();
//System.out.println(vRetResult);
		...
		if(strDatePaid.length() > 0) 
			strDatePaid = WI.formatDate(strDatePaid, 6);
		...
		if(vRetResult.elementAt(33) == null) 
			strPaymentFor = strPaymentFor+": "+CommonUtil.formatFloat((String)vRetResult.elementAt(11),true);
		...
		<tr>
			<td width="49%">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
					...
					<tr valign="top" height="20">
					  <td colspan="2" valign="bottom"><%=strStudName%> &nbsp;&nbsp;&nbsp;<%=strStudID%></td>
					  <td valign="middle" class="thinborderTOPLEFTRIGHT" style="font-size:9px;">Form ID: Acctg.0025</td>
				      <td>&nbsp;</td>
				  </tr>
					<tr>
					  <td></td>
				      <td>&nbsp;</td>
				      <td class="thinborderLEFTRIGHT" style="font-size:9px;">Rev. No.: 02</td>
				      <td>&nbsp;</td>
				  </tr>
					<tr>
					  <td width="54%"><%=strCourse%> <%=WI.getStrValue((String)vRetResult.elementAt(21))%>
					  &nbsp;&nbsp;&nbsp;&nbsp;
					  <%if(vRetResult.elementAt(22) != null){%>
					  	<%=astrConvertSem[Integer.parseInt((String)vRetResult.elementAt(22))]%>, <%=((String)vRetResult.elementAt(23)).substring(2) +"-"+ ((String)vRetResult.elementAt(24)).substring(2)%>					  
					  <%}%>
					  </td>
					  <td width="12%">					  </td>
					  <td class="thinborderLEFTRIGHTBOTTOM" style="font-size:9px;">Rev. Date: 3/16/09</td>
				      <td>&nbsp;</td>
				  </tr>
					<tr valign="top">
					  <td colspan="4"><%=strDatePaid%></td>
				  </tr>
					<tr valign="top">
					  <td colspan="4">&nbsp;</td>
				  </tr>
					...
					<tr valign="bottom">
					  <td height="80" colspan="4" valign="top"><%=strPaymentFor%></td>
					</tr>
					<tr valign="top">
					  <td colspan="2"></td>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
					<tr valign="bottom">
					  <td width="22%" height="18"><%=strPmtMode%></td>
					  <td width="27%"><%=(String)request.getSession(false).getAttribute("userId")%></td>
					  <td width="17%" style="font-size:14px; font-weight:bold">&nbsp;</td>
					  <td width="34%" style="font-size:14px;"><%=CommonUtil.formatFloat((String)vRetResult.elementAt(11),true)%></td>
				  </tr>
					<tr valign="bottom">
					  <td height="25" colspan="4"><%=new ConversionTable().convertAmoutToFigure(Double.parseDouble(strAmount),"Pesos","&nbsp;")%></td>
				  </tr>
					<tr valign="bottom">
					  ...
					  <%}//show only if check.
							...
							BANK: <%=WI.getStrValue(strBankName)%>, 
							CHECK NO: <%=WI.getStrValue(strCheckNo)%>
						<%}%>					  </td>
					  <td><%=vRetResult.elementAt(52)%></td>
				  </tr>
				</table>
			</td>
			<td width="10%">&nbsp;</td>
			<td width="41%">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
					...
					<tr>
					  <td width="53%"><%=strCourse%> <%=WI.getStrValue((String)vRetResult.elementAt(21))%>
					  &nbsp;&nbsp;&nbsp;&nbsp;
					  	<%if(vRetResult.elementAt(22) != null){%>
					  		<%=astrConvertSem[Integer.parseInt((String)vRetResult.elementAt(22))]%>, <%=((String)vRetResult.elementAt(23)).substring(2) +"-"+ ((String)vRetResult.elementAt(24)).substring(2)%>					  
						<%}%>	
					...
					<tr valign="bottom">
					  <td height="80" colspan="3" valign="top"><%=strPaymentFor%></td>
					</tr>
					<tr valign="top">
					  <td colspan="2"></td>
					  <td width="32%">&nbsp;</td>

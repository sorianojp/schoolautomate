...
<!-- Notes-->
<% if (!((String)vStudInfo.elementAt(16)=="PHD" || (String)vStudInfo.elementAt(16)=="MED" || (String)vStudInfo.elementAt(16)=="MBA" || (String)vStudInfo.elementAt(16)=="MIT")){ %>
<p style="font-size:10pt;">	
	<!-- <strong>*** FREE MISC FEE (for College Only)***</strong>-->
</p>
<% } %>

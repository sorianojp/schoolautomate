...
///added code to get lab fee for Isabella.. 
if(fMiscFee > 1f && vMiscFeeInfo != null && vMiscFeeInfo.size() > 0) {
	String strSYIndex = "select sy_index from fa_schyr where sy_from = "+(String)vORInfo.elementAt(23);
	strSYIndex = dbOP.getResultOfAQuery(strSYIndex, 0);
	
	String strSQLQuery = "select distinct fee_name from fa_misc_fee where catg_index > 0 and is_valid = 1 and sy_index = "+strSYIndex;
	rs = dbOP.executeQuery(strSQLQuery);
	while(rs.next()) {
		iIndexOf = vMiscFeeInfo.indexOf(rs.getString(1));
		if(iIndexOf == -1)
			continue;
		if(((String)vMiscFeeInfo.elementAt(iIndexOf + 2)).equals("1"))
			continue;
			
		dLabFee += Double.parseDouble((String)vMiscFeeInfo.elementAt(iIndexOf + 1));
		
		vLabFeeDtls.addElement(rs.getString(1));
		vLabFeeDtls.addElement(CommonUtil.formatFloat(Double.parseDouble((String)vMiscFeeInfo.elementAt(iIndexOf + 1)), true));
		vMiscFeeInfo.remove(iIndexOf);vMiscFeeInfo.remove(iIndexOf);vMiscFeeInfo.remove(iIndexOf);
	}
	rs.close();
...
<%
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" >
   <tr >
   	...
   	<td width="50%" height="19" valign="top">Student load verified &amp; confirmed by :</td>     
    </tr>
    <tr >
    	<td align="center"><%if(bolIsFatima){%>___________________________________________________<%}%></td> 
      	<td height="10" align="center"><strong><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CLARICEL P. ORATA &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></strong> </td>
    </tr>
    <tr >
      <td align="center"><%if(bolIsFatima) {%><em><strong>Student</strong></em><%}%></td>
      <td height="10" align="center"><em><strong>Registrar</strong></em></td>
    </tr>
</table><br><br><br>
  <%}%>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    <td width="45%" height="14" valign="top">&nbsp;
       ...
       <%}%>
	    <tr>
          <td height="14"><strong>TUITION FEE<font size="1"><%=WI.getStrValue(fOperation.getRebateCon())%> </font></strong></td>
     ...
     <%}if(dLabFee > 0d) {%>
	    <tr>
          <td height="14">LABORATORY FEES</td>
          <td height="14">&nbsp;</td>
        </tr>
		 <%for(int i =0; i < vLabFeeDtls.size(); i += 2) {%>
 		<tr>
          <td height="14">&nbsp;&nbsp;<font size="1"><%=(String)vLabFeeDtls.elementAt(i)%></font></td>
          <td height="14"><div align="right"><font size="1"><%=vLabFeeDtls.elementAt(i + 1)%></font></div></td>
        </tr>
		<%}
		}%>
        <tr>
          <td height="14"><strong>MISCELLANEOUS FEES</strong></td>
          <td height="14"><div align="right"><font size="1"><strong><%=CommonUtil.formatFloat(fMiscFee - fMiscOtherFee - dLabFee,true)%></strong></font></div></td>
        </tr>
        <%
...
if(strSchoolCode.startsWith("VMUF") && (vStudInfo.elementAt(15) != null && ((String)vStudInfo.elementAt(15)).toLowerCase().startsWith("o"))){%>
 ...
 if(!strSchoolCode.startsWith("AUF")){%>
 <tr >
    <td height="19" width="75%" valign="top"><br><br>Fees verified &amp; confirmed by :</td>
    <td valign="bottom" >&nbsp;</td>
  </tr>
  <tr >
    
    <td align="center"><strong><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;VIDA E. ARIOS&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u></strong></td>
    <td height="10" align="center">&nbsp;</td>
  </tr>
  <tr >
    <td height="10" align="center"><em><strong>BOU</strong></em></td>
    <td align="center"><!--em><strong>BOU</strong></em--></td>
  </tr>
<%}%>
</table>

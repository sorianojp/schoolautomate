...
if(vRetResult == null) {
	...
	if(!vRetResult.elementAt(45).equals("0")) {
		...
		if(strCourse.length() > 0) {
			strCourse = WI.getStrValue((String)vRetResult.elementAt(19),"") +  WI.getStrValue((String)vRetResult.elementAt(21)," - YR ","","");
		}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td colspan="2" height="130px" align="right" style="padding-right:200px;"><br><br><br><br><br>&nbsp; <%=WI.fillTextValue("or_number")%></td></tr>
	<tr>
		<!-- this is for the left side details -->
		<td width="72%" height="233" valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				<tr><td height="30" align="right"><%=strDatePaid%></td></tr>
				<tr><td height="35" style="padding-left:50px;" valign="bottom"><%=strStudName%></td></tr>
				<tr><td height="40" style="text-indent:70px;" valign="bottom"><%=new ConversionTable().convertAmoutToFigure(Double.parseDouble(strAmount),"Pesos","Centavos")%></td></tr>
				<tr><td height="44" align="right" style="padding-right:30px;" valign="bottom"><%=CommonUtil.formatFloat(strAmount,true)%></td></tr>
				<tr><td height="61" style="text-indent:130px;"><%=strCourse%><%//=strPaymentFor.replaceAll("<br>", ", ")%></td></tr>				
				<tr><td height="71" style="padding-left:200px;" valign="bottom"><%=request.getSession(false).getAttribute("first_name")%></td></tr>				
		  </table>
	  </td>
		
		<!-- this is for the right side details -->
		<td width="28%" valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
				...
				if(vRetResult.elementAt(14) == null)
					...
					strCheck += "<br>"+ WI.getStrValue(strBankName) + "<br>" + WI.getStrValue(strCheckNo);
				
				}
				
				%>				
				<tr><td height="60" align="right" style="padding-right:10px;" valign="bottom"><%=strCash%></td></tr>
				<tr><td height="91" align="right" style="padding-right:10px;" valign="bottom"><%=strCheck%></td></tr>
				<tr><td height="52" align="right" style="padding-right:10px;" valign="bottom"><%=CommonUtil.formatFloat(strAmount,true)%></td></tr>
			</table>
	  </td>
	</tr>
</table>

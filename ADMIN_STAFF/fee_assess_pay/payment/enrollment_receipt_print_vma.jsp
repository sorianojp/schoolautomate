...
<%
	...
	if(strSchoolCode.startsWith("EAC")){%>
		<jsp:forward page="./enrollment_receipt_print_eac.jsp" />
	<%}
	if(strSchoolCode.startsWith("CDD")){%>
		<jsp:forward page="./enrollment_receipt_print_3Copies_CDD.jsp" />
	<%}
	if(strSchoolCode.startsWith("UC")){%>
		<jsp:forward page="./enrollment_receipt_print_uc.jsp" />
	<%}
	if(strSchoolCode.startsWith("UPH") && !strInfo5.equals("jonelta")){%>
		<jsp:forward page="./enrollment_receipt_print_UPHSD.jsp" />
	<%}
	if(strSchoolCode.startsWith("WUP")){%>
		<jsp:forward page="./enrollment_receipt_print_WUP.jsp" />
	<%}
	if(false && strInfo5.equals("jonelta")){%>
		<jsp:forward page="./enrollment_receipt_print_JONELTA.jsp" />
	<%}
...
float fUnitsTaken = 0f; double dTotalNonAcadUnit = 0d;
...
{//System.out.println(vStudInfo);
	...
	strTemp = "select DATE_ENROLLED, SECTION_NAME from stud_curriculum_hist where is_valid =1 and user_index = "+(String)vStudInfo.elementAt(0)+
		" and semester = "+(String)vORInfo.elementAt(22)+
		" and sy_from = "+(String)vORInfo.elementAt(23);
	rs = dbOP.executeQuery(strTemp);
	if(rs.next()){
		strDateEnrolled = ConversionTable.convertMMDDYYYY(rs.getDate(1));
		strSectionName = rs.getString(2);
	}rs.close();
...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr >
      ...
      <td width="28%" height="25">
	  	<table cellpadding="2" cellspacing="2" width="90%">
			<tr>
				<td style="font-size:11px;"><!--Form ID. : EDP 0004--><br>
				<!--Rev. No. : 03--><br>
				<!--Rev. Date: 05/14/2012-->&nbsp;</td>
			</tr>
		</table>
    ...
    <tr >
      <td>&nbsp;</td>
      <td height="25" style="font-size:14px; font-weight:bold">Student's Copy </td>
    </tr>
    <tr >
      <td height="20" colspan="2" align="center" style="font-size:11px;">
	  	<%=astrConvertSem[Integer.parseInt(astrSchYrInfo[2])]%> AY <%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%>      </td>
    </tr>
    <tr >
      <td height="20" align="right" colspan="2">Date and time printed: <%=strDateTimePrinted%></td>
    </tr>
</table>
...
%>
  <tr>
    ...
    <td><strong><font size="2"><%=strTemp%></font></strong></td>
    <td>Section</td>
    <td colspan="2"><%=WI.getStrValue(strSectionName)%></td>
    </tr>
</table>
<%
if(vAssessedSubDetail != null && vAssessedSubDetail.size() > 0)
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
  <tr >
    ...
    <td width="21%" class="thinborder"><strong>
	S&nbsp;&nbsp;C&nbsp;&nbsp;H&nbsp;&nbsp;E&nbsp;&nbsp;D&nbsp;&nbsp;U&nbsp;&nbsp;L&nbsp;&nbsp;E</strong></td>
...
********************************************************************************************************************************/
		...
		if(strRatePerUnit != null && strRatePerUnit.startsWith("E") || strRatePerUnit.equals("0.00"))
			dTotalNonAcadUnit += Double.parseDouble((String)vAssessedSubDetail.elementAt(i+9));
/**
  ...
  <tr>
    <td width="45%" height="14" valign="top">&nbsp;
       ...
       <%if(!strSchoolCode.startsWith("AUF") && !strSchoolCode.startsWith("UDMC") && !bolIsFatima){%>
	    <tr>
          <td width="65%"><div align="right"><strong>:: FEE DETAILS ::</strong></div></td>
          <td width="35%">&nbsp;</td>
        </tr>
       <%}%>
	    <tr>
          <td style="font-size:9px">TUITION FEE<strong><%=WI.getStrValue(fOperation.getRebateCon())%></strong></td>
          <td style="font-size:9px"><div align="right"><strong><%=CommonUtil.formatFloat(fTutionFee,true)%></strong></div></td>
        </tr>
     <%if(fCompLabFee > 0f){%>
       <tr>
          <td style="font-size:9px">COMP. LAB. FEE</td>
          <td style="font-size:9px"><div align="right"><strong><%=CommonUtil.formatFloat(fCompLabFee,true)%></strong></div></td>
        </tr>
     <%}if(bolShowMiscDtls) {%>
	    <tr>
          <td style="font-size:9px">MISCELLANEOUS FEES</td>
          <td style="font-size:8px"><div align="right"></div></td>
        </tr>
         <%}
		 if(!strSchoolCode.startsWith("AUF") && !strSchoolCode.startsWith("UDMC")){
		...
		%>
 		<tr>
          <td style="font-size:8px">&nbsp;&nbsp;<%=(String)vMiscFeeInfo.elementAt(i)%></td>
          <td style="font-size:8px"><div align="right"><%=CommonUtil.formatFloat((String)vMiscFeeInfo.elementAt(i+1),true)%></div></td>
        </tr>
		<%}%>
        <tr>
          <td style="font-size:9px"><strong>TOTAL MISC</strong></td>
          <td style="font-size:9px"><div align="right"><strong><%=CommonUtil.formatFloat(fMiscFee - fMiscOtherFee,true)%></strong></div></td>
        </tr>
        <%}
		if(!strSchoolCode.startsWith("UDMC") && !strSchoolCode.startsWith("CSA") && bolShowOthChargeDtls){%>
		<tr>
		  <td style="font-size:9px">OTHER CHARGES</td>
          <td style="font-size:9px"><div align="right"></div></td>
        </tr>
         <%}
		for(int i = 0; i< vMiscFeeInfo.size(); i +=3){
        ...
        <tr>
          <td style="font-size:9px"><strong>TOTAL OTHER CHARGE<%if(strSchoolCode.startsWith("CSA")){%>S<%}%></strong></td>
          <td style="font-size:9px"><div align="right"><strong><%=CommonUtil.formatFloat(fMiscOtherFee,true)%></strong></div></td>
        </tr>
<%}%>
        <tr>
        ...
        <tr>
          <td style="font-size:9px"><strong>TOTAL ASSESSMENT</strong></td>
          <td style="font-size:9px"><div align="right"><strong>Php <%=CommonUtil.formatFloat(fTutionFee+fCompLabFee+fMiscFee + dFatimaInstallmentFee,true)%></strong></div></td>
        </tr>
        <tr>
          <td style="font-size:9px">OLD ACCOUNTS</td>
          <td style="font-size:9px"><div align="right">Php <%=CommonUtil.formatFloat(fOutstanding,true)%></div></td>
        </tr>
<%if(!strSchoolCode.startsWith("AUF")){%>
		<tr>
          <td style="font-size:9px">TOTAL AMOUNT DUE</td>
          <td style="font-size:9px"><div align="right">Php <%=CommonUtil.formatFloat(fTutionFee+fCompLabFee+fMiscFee + fOutstanding,true)%></div></td>
        </tr>
...
%>
        <tr style="font-weight:bold;">
          <td style="font-size:8px"><%=strEnrolmentDiscDetail.toUpperCase()%></td>
          <td style="font-size:8px" align="right"><%=strTemp%></td>
        </tr>
<%}%>
        <tr>
          <td style="font-size:9px"><strong>TOTAL BALANCE DUE</strong></td>
          <td style="font-size:9px"><div align="right"><font size="1"><strong>Php <%=CommonUtil.formatFloat(fTotalPayableAmt + dDPFineCGH + dFatimaInstallmentFee - fAmtPaidDurEnrl ,true)%></strong></font></div></td>
        </tr>
        <tr>
          <td height="14">&nbsp;</td>
        ...
        <tr>
		  ...
		  <%
		  if(strDateEnrolled != null && strDateEnrolled.length() > 0){
		  %>
		  
		  <strong style="font-size:10px;"><div align="left">NOTE: </strong>
		  <strong style="font-size:10px;"><div align="left"> *FEES SUBJECT FOR ADJUSTMENT</strong>
		  <strong style="font-size:10px;"><div align="left">*NOT VALID WITHOUT REGISTRAR'S OFFICIALIZATION</strong>
		  <br><br><br>
...
<%}%>
       <tr>
        ...
        <tr>
          <td height="14" colspan="2" style="font-weight:bold">OTHER INFORMATION: </td>
        </tr>
        <tr>
          <td height="14">ACADEMIC LOAD </td>
          <td height="14"><%=fUnitsTaken-dTotalNonAcadUnit%></td>
        </tr>
        <tr>
          <td height="14">NON-ACADEMIC LOAD </td>
          <td height="14"><%=dTotalNonAcadUnit%></td>
        </tr>
        <tr>
          <td height="14">TOTAL ASSESSMENT UNITS </td>
          <td height="14"><%=fUnitsTaken-dTotalNonAcadUnit%></td>
        </tr>
        <tr>
          <td height="14" colspan="2">&nbsp;</td>
        ...
        <tr>
          <td height="14" align="left">
		  	<img src="./edp.jpg" border="0" height="30" width="185"></td>
		<td>&nbsp;</td>
        </tr>
        <tr>
          <td height="14" colspan="2">
		  	<table cellpadding="0" cellspacing="0" width="100%">
				<tr align="center">
					<td width="49%" class="thinborderTOP" style="font-size:11px;">Prepared/Verified</td>
					<td width="2%">&nbsp;</td>
					<td width="49%" class="thinborderTOP" style="font-size:11px;">Student's Signature</td>
				</tr>
			</table>		  </td>
          <!--<td height="14">Student's Signature </td>-->
        </tr>
        <tr>
          <td height="14" colspan="2">&nbsp;</td>
        </tr>
        ...
        <tr>
          <td height="14" colspan="2" valign="bottom" align="center"><img src="./registrar.jpg" border="0" height="30" width="190"></td>
        </tr>
        <tr>
          <td height="14" colspan="2" align="center">
		  		  	<table cellpadding="0" cellspacing="0" width="50%">
						<tr align="center">
							<td width="100%" class="thinborderTOP" style="font-size:11px;">Registrar</td>
						</tr>
					</table>		  </td>
        </tr>
      </table>
...
<!-------------------------------------------------------------------------------------------->
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr >
      <td>&nbsp;</td>
      <td height="25" style="font-size:14px; font-weight:bold">Comptroller's Copy </td>
    </tr>
    <tr >
      <td height="20" colspan="2" align="center" style="font-size:11px;">
	  	<%=astrConvertSem[Integer.parseInt(astrSchYrInfo[2])]%> AY <%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%>      </td>
...
<label id="comptroller_copy"></label>
<DIV style="page-break-before:always" >&nbsp;</DIV>
...
<!-------------------------------------------------------------------------------------------->
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr >
      <td>&nbsp;</td>
      <td height="25" style="font-size:14px; font-weight:bold">Registrar's Copy </td>
    </tr>
    <tr >
      <td height="20" colspan="2" align="center" style="font-size:11px;">
	  	<%=astrConvertSem[Integer.parseInt(astrSchYrInfo[2])]%> AY <%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%>      </td>
...
<!-------------------------------------------------------------------------------------------->
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr >
      <td>&nbsp;</td>
      <td height="25" style="font-size:14px; font-weight:bold">Dean's Copy </td>
    </tr>
    <tr >
      <td height="20" colspan="2" align="center" style="font-size:11px;">
	  	<%=astrConvertSem[Integer.parseInt(astrSchYrInfo[2])]%> AY <%=astrSchYrInfo[0]+" - "+astrSchYrInfo[1]%>      </td>
...
<label id="dean_copy"></label>



<script language="JavaScript">
document.getElementById("comptroller_copy").innerHTML = document.getElementById("student_copy").innerHTML;
document.getElementById("registrar_copy").innerHTML = document.getElementById("student_copy").innerHTML;
document.getElementById("dean_copy").innerHTML = document.getElementById("student_copy").innerHTML;
</script>

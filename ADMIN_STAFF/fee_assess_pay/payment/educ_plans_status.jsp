...
FAEducPlans faEP = new FAEducPlans();
	...
	if (WI.fillTextValue("educ_plan").length() != 0){
		if (iPageAction == 2 || iPageAction == 3 ){
...
%>
<form name="form_" action="./educ_plans_status.jsp" method="post">
...
<% if (vRetResult != null && vRetResult.size() > 0){ %>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="78%" height="24"><input name="appl_no" type="text" readonly= "true" class="textbox_noborder" value="<%=(String)vRetResult.elementAt(6)%>" size="16" maxlength="16"></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25"> Amount Applied</td>
      <td height="25"><font size="1"> 
        <input name="appl_amt" type="text" readonly= "true" class="textbox_noborder" id="appl_amt" value="<%=(String)vRetResult.elementAt(7)%>" size="16" maxlength="16">
        </font></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25">Date of Application </td>
      <td height="25"> 
        <input name="date_application" type="text" class="textbox_noborder"  readonly= "true" id="date_application" value="<%=(String)vRetResult.elementAt(10)%>" size="16" maxlength="16"></td>
    </tr>
 <%
...
%>
 ...
 <%
	if (iPageAction == 3 && vRetResult!=null  && vRetResult.size() > 0){
		...
		strTemp = WI.fillTextValue("amount_paid");
	}	
%>
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25">Amount Paid</td>
      <td height="25"><input name="amount_paid" type="text" class="textbox" value="<%=strTemp%>"  onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'" size="16" maxlength="32"></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('form_.date_of_payment');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" width="20" height="16" border="0"></a> 
        </font></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25"> Approval No. </td>
      <td height="25"><font size="1"> 
...
%>
 ...
 <%if(iAccessLevel > 1){%>
    <tr>
      ...
      <td width="80%" height="25"> <a href="javascript:AddRecord();"><img src="../../../images/save.gif" name="hide_save" width="48" height="28" border="0"></a> 
...
<%} // if vStudInfo  not found
 ...
 } // vRetResult != null and vRetResult.size() > 0
%>
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>

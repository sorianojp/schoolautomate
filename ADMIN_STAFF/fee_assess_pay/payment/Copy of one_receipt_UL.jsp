...
double dAmountTendered = Double.parseDouble(WI.getStrValue(WI.fillTextValue("sukli"), "0")) + Double.parseDouble(ConversionTable.replaceString(strAmount, ",","")) ;
 ...
 <td>
    ...
    <table width="408" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
		<tr>
			...
			<%=CommonUtil.formatFloat(dAmountTendered, true)%>
			</td>

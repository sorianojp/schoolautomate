...
if (WI.fillTextValue("sy_from").length()>0 && WI.fillTextValue("semester").length()>0 && WI.fillTextValue("course_index").length() > 0) {	
	vRetResult = FASLedg.getEnrollmentData(dbOP, request);
	if (vRetResult == null)
		strErrMsg = FASLedg.getErrMsg();
}
%>
<form action="./enrollment_data_detail.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="tHeader1">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          ENROLLMENT DATA DETAIL ::::</strong></font></div></td>
    </tr>
    <tr >
    ...
    <tr>
      ...
      <td colspan="2">
		<select name="course_index">
          <%=dbOP.loadCombo("course_index","course_name"," from course_offered where is_valid=1 and is_offered = 1 order by course_name asc", WI.fillTextValue("course_index"), false)%> 
		</select>
	  </td>
    </tr>
    <tr>
...
-->
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" >
    ...
    <tr>
      <td height="20" colspan="3" valign="top"><div align="center"><strong>COURSE : <%=dbOP.getResultOfAQuery("select course_name from course_offered where course_index = "+WI.fillTextValue("course_index"), 0)%> <%=astrConvertYrLevel[Integer.parseInt(WI.getStrValue(WI.fillTextValue("yr_lvl"), "0"))]%>
	  <br>
...
--><%**/%>
	<table bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
		<tr>
		  <td width="5%" class="thinborder"><font size="1"><strong>SL No</strong></font></td>
			<td width="15%" height="25" class="thinborder"><font size="1"><strong>ID Number</strong></font></td>
			<td width="20%" class="thinborder"><font size="1"><strong>Student Name</strong></font></td>
			<td width="5%" class="thinborder"><font size="1"><strong>Units Enrolled</strong></font></td>
			<td width="15%" class="thinborder"><font size="1"><strong>Total Tuition Fee </strong></font></td>
			<td width="15%" class="thinborder"><font size="1"><strong> Payment </strong></font></td>
			<td width="10%" class="thinborder"><font size="1"><strong> Discount </strong></font></td>
		    <td width="15%" class="thinborder"><font size="1"><strong> Balance</strong></font></td>
	    </tr>
<%

for(int i = 8; i < vRetResult.size(); i += 9) {%>
		<tr>
...
if(strTotUnit.endsWith(".00"))
	strTotUnit = strTotUnit.substring(0,strTotUnit.length() - 3);%> 
		<tr>
		  <td align="right" class="thinborder"><%=iTotalStud%></td>
		  <td height="25" class="thinborder"><strong>&nbsp;&nbsp;</strong></td>
		  <td class="thinborder">&nbsp;</td>
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr >
      <td width="10%" height="25" class="thinborderNONE">&nbsp;</td>
...
<%}//end of displaying report.. %>
  ...
  <input type="hidden" name="get_detail" value="1">
</form>
</body>
</html>
<%

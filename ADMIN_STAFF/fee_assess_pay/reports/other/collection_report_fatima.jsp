  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="myADTable1">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>:::: 
          COLLECTION REPORT ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
<%}%>    <tr>
    ...
    <tr>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
	  value="<%=WI.fillTextValue("date_from")%>" size="12"> <a href="javascript:show_calendar('form_.date_from');"><img src="../../../../images/calendar_new.gif" width="20" height="16" border="0"></a> 
        to 
        <input name="date_to" type="text" class="textbox" id="date_to"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("date_to")%>" size="12"
	  readonly="yes">
      <a href="javascript:show_calendar('form_.date_to');"><img src="../../../../images/calendar_new.gif" width="20" height="16" border="0"></a>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <font size="1" style="font-weight:bold; color:#0000FF"><input type="checkbox" name="inc_old_account" value="checked" <%=WI.fillTextValue("inc_old_account")%>> Include Old Account </font>	  
<%if(strSchCode.startsWith("CDD")){%>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	  <font size="1" style="font-weight:bold; color:#0000FF"><input type="checkbox" name="split_assessment" value="checked" <%=WI.fillTextValue("split_assessment")%>>
	  Split Total Assessment </font>	  
<%}%>
<%if(strSchCode.startsWith("FATIMA")){%>
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<%}%>
    ...
    <tr>
      ...
      <td>As Of </td>
      <td colspan="2">
        <input name="as_of" type="text" class="textbox" id="as_of" readonly="yes"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
	  value="<%=WI.fillTextValue("as_of")%>" size="12"> 
        <a href="javascript:show_calendar('form_.as_of');"><img src="../../../../images/calendar_new.gif" width="20" height="16" border="0"></a>	  
		<font size="1">(Payment cutoff date)</font>	  </td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      <td>&nbsp;</td>
...
if(WI.fillTextValue("split_assessment").length() > 0) 
...
String[] astrConvertTerm = {"Summer","1st Semester","2nd Semester","3rd Semester"};%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="20" colspan="2" valign="top"><div align="center"><strong>COLLECTION REPORT <%=strReportTitle.toUpperCase()%><br>
...
<%}if(bolIncAssessmentDtls){%>
	    <td width="8%" style="font-size:9px;" class="thinborder">Assessment<br>Tuition </td>
	    <td width="8%" style="font-size:9px;" class="thinborder">Assessment<br>Misc</td>
	    <td width="8%" style="font-size:9px;" class="thinborder">Assessment<br>OC</td>
<%}%>
	...
	for(int i = 0; i < vRetResult.size(); i += 7){
		...
		if(vInfo.size() > 4) {
			...
			dTuition   = ((Double)vInfo.elementAt(6)).doubleValue();
			dMisc      = ((Double)vInfo.elementAt(7)).doubleValue();
			dOC        = ((Double)vInfo.elementAt(8)).doubleValue();
...
<%}if(bolIncAssessmentDtls){%>
	      <td class="thinborder"><%=CommonUtil.formatFloat(dTuition, true)%></td>
	      <td class="thinborder"><%=CommonUtil.formatFloat(dMisc, true)%></td>
	      <td class="thinborder"><%=CommonUtil.formatFloat(dOC, true)%></td>
<%}%>

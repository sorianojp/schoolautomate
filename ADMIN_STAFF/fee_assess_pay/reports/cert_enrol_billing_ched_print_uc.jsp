...
<body onLoad="window.print()" bottommargin="0">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="100%" height="25" colspan="4"><div align="center"><font size="2"><strong> 
        UNIVERSITY OF THE CORDILLERAS<br><font size="2" style="font-weight:normal">Baguio City</font>
		<br>
        </strong>
		</font></div></td>
    </tr>
    <tr>
      <td width="100%" height="25" colspan="4"><div align="center"><font size="2"><strong> 
        CERTIFICATE OF ENROLMENT AND BILLING (CHED)
		<br>
        </strong>
...
{%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="23%" height="18">Scholarship Program: </td>
      <td colspan="3">
	  <strong>
    ...
    <tr>
      <td height="18">&nbsp;</td>
      <td height="18">1. Grantee Slot Number : </td>
      
    <td height="18" colspan="3">&nbsp;<%=WI.getStrValue(WI.fillTextValue("grant_award_no"))%></td>
    </tr>
    <tr>
      <td height="18">&nbsp;</td>
      <td height="18">2. Student's Name : </td>
      <td width="23%" height="18"><strong><%=(String)vStudInfo.elementAt(12)%></strong></td>
    ...
    <tr>
      <td height="18">&nbsp;</td>
      <td height="18">3. Sex : <strong><u><%=(String)vStudInfo.elementAt(13)%></u></strong></td>
      <td height="18" colspan="3">4. Course : <u><strong><%=(String)vStudInfo.elementAt(2)%>
        <%
    ...
    <tr>
      <td height="18">&nbsp;</td>
      <td height="18" colspan="4">5. Year Level : <u><strong><%=astrConvertYrLevel[Integer.parseInt(WI.getStrValue((String)vStudInfo.elementAt(4),"0"))]%></strong></u></td>
    </tr>
  </table>
	...
	for(int i = 0; i< vMiscFeeInfo.size(); i +=3){
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
		  ...
		  <td width="3%" height="18">&nbsp;</td>
		  <td height="18" colspan="2"><hr size="1" width="100%" align="left"></td>
		</tr>
		<tr>
		  <td height="18">&nbsp;</td>
		  ...
		  <td height="18">&nbsp;</td>
		  <td height="18">&nbsp;</td>
		  <td width="32%" height="18">Gross Total</td>
		  <td width="18%" height="18" align="right"><strong>Php <%=CommonUtil.formatFloat(fTutionFee+fCompLabFee+fMiscFee,true)%></strong></td>
		</tr>
	  </table>
  </td></tr></table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="25" align="center">__________________________</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td height="25" align="center"> <%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"Scholarship Coordinator",1))%><br>Scholarship Coordinator<br>Accounting</td>
      <td>&nbsp;</td>
    </tr>
   <tr>
      <td height="18" colspan="2">&nbsp;</td>
    ...
    <tr>
      <td height="25"><div align="center"> <%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"University Registrar",1))%><br>Registrar</div></td>
      <td><div align="center"><%=WI.getStrValue(CommonUtil.getNameForAMemberType(dbOP,"School Accountant",1))%><br>Accountant</div></td>
    </tr>
  </table>

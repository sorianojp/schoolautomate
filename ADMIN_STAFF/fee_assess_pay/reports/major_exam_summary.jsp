...
if(WI.fillTextValue("pmt_schedule").length() > 0) {
	vRetResult = feeEx.getMajorExamPmtSummary(dbOP, request);
	if(vRetResult == null)
...
<form name="form_" method="post" action="./major_exam_summary.jsp">
...
%>
    ...
    <tr> 
      ...
      <td height="25" colspan="2" class="thinborderBOTTOM"> <input type="checkbox" name="cleanup" value="1"> 
...
%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td width="20%" height="24"><div align="center"><strong><font size="1">DEPT/COURSE</font></strong></div></td>
      <td width="16%"><div align="right"><strong><font size="1">EXPECTED</font></strong></div></td>
      <td width="16%"><div align="right"><strong><font size="1">COLLECTED</font></strong></div></td>
      <td width="16%"><div align="right"><strong><font size="1">UNCOLLECTED</font></strong></div></td>
      <td width="16%"><div align="right"><strong><font size="1">PN</font></strong></div></td>
      <td width="16%"><div align="right"><strong><font size="1">UNCLAIMED PERMITS</font></strong></div></td>
    </tr>
    <%int i = 0; 
for(;i < vRetResult.size() - 9; i += 7) {//9 elements are added at the bottom for total and percentage.
	if(vRetResult.elementAt(i) != null){%>
    <tr> 
      <td height="24"><%=(String)vRetResult.elementAt(i)%></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <%}%>
    <tr> 
      <td height="24">&nbsp;&nbsp;&nbsp;&nbsp;<%=(String)vRetResult.elementAt(i + 1)%></td>
      <td><div align="right"><%=(String)vRetResult.elementAt(i + 2)%>&nbsp;</div></td>
      <td><div align="right"><%=(String)vRetResult.elementAt(i + 3)%>&nbsp;</div></td>
      <td><div align="right"><%=(String)vRetResult.elementAt(i + 4)%>&nbsp;</div></td>
      <td><div align="right"><%=(String)vRetResult.elementAt(i + 5)%>&nbsp;</div></td>
      <td><div align="right"><%=(String)vRetResult.elementAt(i + 6)%>&nbsp;</div></td>
    </tr>
    <%}%>
    <tr> 
      <td height="24"><strong>T O T A L</strong></td>
      <td class="thinborderTOP"><div align="right"><%=(String)vRetResult.elementAt(i)%>&nbsp;<br><img src="doubleline.jpg" width="100"></div></td>
      <td class="thinborderTOP"><div align="right"><%=(String)vRetResult.elementAt(i + 1)%>&nbsp;<br><img src="doubleline.jpg" width="100"></div></td>
      <td class="thinborderTOP"><div align="right"><%=(String)vRetResult.elementAt(i + 3)%>&nbsp;<br><img src="doubleline.jpg" width="100"></div></td>
      <td class="thinborderTOP"><div align="right"><%=(String)vRetResult.elementAt(i + 5)%>&nbsp;<br><img src="doubleline.jpg" width="100"></div></td>
      <td class="thinborderTOP"><div align="right"><%=(String)vRetResult.elementAt(i + 7)%>&nbsp;<br><img src="doubleline.jpg" width="100"></div></td>
    </tr>
    <tr> 
      <td height="24">&nbsp;</td>
      <td class="thinborderNONE"><div align="right">&nbsp;</div></td>
      <td class="thinborderNONE"><div align="right"><u><%=(String)vRetResult.elementAt(i + 2)%>%&nbsp;</u></div></td>
      <td class="thinborderNONE"><div align="right"><u><%=(String)vRetResult.elementAt(i + 4)%>%&nbsp;</u></div></td>
      <td class="thinborderNONE"><div align="right"><u><%=(String)vRetResult.elementAt(i + 6)%>%&nbsp;</u></div></td>
      <td class="thinborderNONE"><div align="right"><u><%=(String)vRetResult.elementAt(i + 8)%>%&nbsp;</u></div></td>
    </tr>

...
<body onLoad="CloseWnd();" topmargin="0">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="4"><%=WI.getTodaysDate(6)%></td>
  </tr>
  <tr>
    <td colspan="4"><font size="2">&nbsp;</font></td>
  </tr>
  <tr>
    <td colspan="4"><font size="3">STATEMENT OF TUITION FEES &amp; PAYMENT</font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><font size="3"><%=(String)vStudInfo.elementAt(16)%> <%
	  if(vStudInfo.elementAt(3) != null){%>
      - <%=(String)vStudInfo.elementAt(3)%> <%}%> </font></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="4"> Breakdown of Tuition &amp; Other Misc Fees <%=astrConvertSem[Integer.parseInt(request.getParameter("semester"))]%>, <%=WI.fillTextValue("sy_from")+" - "+WI.fillTextValue("sy_to")%></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
...
for(int i = 1; i< vOthSchFine.size(); i +=3) {%>
  ...
  <tr>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
    <td width="72%"><hr size="1" align="left" width="15%"></td>
  </tr>
  <tr>
    <td height="10" colspan="2">Total Assessment</td>
    <td height="10">&nbsp;</td>
    <td height="10"><%=CommonUtil.formatFloat((float)dBalance,true)%></td>
  </tr>
  <tr>
...
%>
  ...
  <tr>
    <td colspan="2"><font size="3">TOTAL CHARGES</font></td>
    <td><font size="3">P</font></td>
    <td><font size="3"><%=CommonUtil.formatFloat((float)dBalance,true)%></font></td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
...
dTemp += dDebit;
  ...
  <tr>
    <td width="2%">&nbsp;</td>
    <td width="24%"><%=ConversionTable.convertMMDDYYYY((java.util.Date)vPayment.elementAt(i + 2))%>&nbsp;&nbsp;&nbsp; <%
...
<%}//end of displaying refund.%>
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><hr size="1" width="15%" align="left"></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td colspan="2"><font size="3">BALANCE</font></td>
    <td><font size="3">P</font></td>
    <td><font size="3"><%=CommonUtil.formatFloat((float)dBalance,true)%></font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4">Mr. Rudy J Cruz</td>
  </tr>
  <tr>
    <td colspan="4"></td>
  </tr>
  <tr>
    <td colspan="4"><div align="left">Head, Accounts Management</div></td>
  </tr>
</table>
<script language="JavaScript">

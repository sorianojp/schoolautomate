...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-REPORTS","cashier_report_summary_UB_Without_Course.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form name="daily_cash" method="post" action="./cashier_report_summary_UB_Without_Course.jsp">
...
<%if(strSchCode.startsWith("CGH") || strSchCode.startsWith("UDMC") || strSchCode.startsWith("CLDH")  || 
	...
	strSchCode.startsWith("EAC") || strSchCode.startsWith("UC") || strSchCode.startsWith("UB")) {%>
        to
<%

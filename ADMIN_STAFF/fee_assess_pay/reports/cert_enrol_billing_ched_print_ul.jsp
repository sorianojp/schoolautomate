...
%> 
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr >
	  ...
	  <font size="1">Republic of the Philippines</font><br>
	  OFFICE OF THE PRESIDENT<br>
	  COMMISSION ON HIGHER EDUCATION<br>
	  <font size="1">Region I<br>
	  City of San Fernando, (La Union)</font><br><br>
	  
	  <font size="3"><u>UNIVERSITY OF LUZON</u></font><br>
	  <font size="1">(Name of Private/State/College/University)</font><br><br>
	  
	  <u>Perez Blvd., Dagupan City</u><br>
	  <font size="1">(Address)</font><br>&nbsp; </td>
    </tr>
    <tr >
      <td height="20" ><div align="center"><strong>
	  <font size="3">CERTIFICATE OF ENROLMENT AND BILLING (CHED)</font></strong><br>
      <font size="3"><%=astrConvertSem[Integer.parseInt(WI.fillTextValue("semester"))]%>, <%=WI.fillTextValue("sy_from")+" - "+WI.fillTextValue("sy_to")%></font>
    ...
    <tr >
      <td height="20" align="center" valign="bottom" style="font-size:13px;"><u>&nbsp;&nbsp;<%=WI.fillTextValue("scholarship_name")%>&nbsp;&nbsp;</u></td>
    </tr>
    <tr >
      <td height="20" align="center" valign="top" style="font-size:13px;">Scholarship Program</td>
    </tr>
</table>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="23%" height="20">1. Grantee Slot Number : </td>
...
for(int i = 0; i< vMiscFeeInfo.size(); i +=3){
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="20">&nbsp;</td>
      <td colspan="2" valign="top"><div align="center"></td>
      <td height="20">&nbsp;</td>
      <td height="20">&nbsp;</td>
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="50%" height="20">Approved By: </td>
      <td width="50%" height="20">Prepared By: </td>
    </tr>
    <tr>
    ...
    <tr>
      <td height="25" align="center">(University Registrar)</td>

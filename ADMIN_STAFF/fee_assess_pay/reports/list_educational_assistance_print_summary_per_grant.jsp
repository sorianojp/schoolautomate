...
ReportFeeAssessment rFA = new ReportFeeAssessment();
	vRetResult = rFA.getStudListAssistanceSummaryPerGrant(dbOP,request);
	if(vRetResult == null) {
...
Vector vDiscountDetail = null;%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="25"><div align="center"><font size="2"><strong> SUMMARY PER GRANT </strong></font><br>
...
for(int i = 1; i < vRetResult.size(); i += 4){
	vDiscountDetail = (Vector)vRetResult.elementAt(i + 3);
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    <tr style="font-weight:bold"> 
      <td><%=vRetResult.elementAt(i)%> :: <%=vRetResult.elementAt(i + 1)%></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
	<tr align="center" style="font-weight:bold"> 
		<td width="55%" class="thinborder"><%//=%></td>
		<td width="15%" class="thinborder"><%//=%></td>
		<td width="30%" class="thinborder"><%//=%></td>
	</tr>
    <%while(vDiscountDetail.size() > 0) {%>
	    <tr> 
    	  	<td class="thinborder"><%=vDiscountDetail.remove(0)%></td>
      		<td class="thinborder"><%=vDiscountDetail.remove(0)%></td>
      		<td class="thinborder" align="right"><%=CommonUtil.formatFloat(((Double)vDiscountDetail.remove(0)).doubleValue(), true)%></td>
    	</tr>
	<%}%>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">

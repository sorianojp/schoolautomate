...
response.sendRedirect("rec_projection_dlshsi.jsp");
return;}
%>
...
function PrintPgNew() {
	...
	if(document.form_.remove_header){
		if(document.form_.remove_header.checked)
			pgLoc += "&remove_header=1";
	}
	//alert(pgLoc);
...
<input name="report_name" type="text" size="32" value="<%=WI.fillTextValue("report_name")%>" class="textbox"
      ...
      <td width="31%" height="25"> <font size="1"><a href="javascript:SaveReport();"><img src="../../../images/save.gif" border="0"></a>click 

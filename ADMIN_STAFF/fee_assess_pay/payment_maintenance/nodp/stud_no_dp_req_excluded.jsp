...
<%
	...
	if(WI.fillTextValue("print_page").length() > 0){%>
			<jsp:forward page="./stud_no_dp_req_excluded_print.jsp" />	
<%	return;}
...
if(strTemp.length() > 0){
	if(faPmt.operateOnExcludeDP(dbOP, request, Integer.parseInt(strTemp)) == null)	
...
%>
<form name="form_" action="./stud_no_dp_req_excluded.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
         LIST OF STUDENT EXCLUDED FROM DOWNPAYMENT ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">    
    <tr>
       <td height="25">&nbsp;</td>
       <%
		 strTemp = WI.fillTextValue("for_all_sy_term");
		 if(strTemp.equals("1"))
		 	strTemp = "checked";
		else
			strTemp = "";
		 %>
       <td height="25" colspan="4"><input  type="checkbox" value="1" <%=strTemp%> name="for_all_sy_term">
       	Show List of Student for ALL school year and term
       </td>
      </tr>
    <tr>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
   	<td width="54%" height="20">Search Option <font size="1">(starts with)</font>: <input type="text" name="search_input" value="<%=WI.fillTextValue("search_input")%>">
      	<font size="1">(ID Number or Student Last Name)</font></td>
   	<td width="18%">
      	<a href="javascript:ReloadPage()"><img src="../../../images/refresh.gif" border="0"></a>
      </td>
   	<td width="28%"><a href="javascript:PrintPage()"><img src="../../../images/print.gif" border="0"></a>
      	<font size="1">Click to print report (this will disregard the search option)</font>
      </td>
   </tr>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td align="center"><a href="javascript:PageAction('0')"><img src="../../../images/delete.gif" border="0"></a>
   	<font size="1">Click to delete entry</font>
   </td></tr>
</table>
<%}%>
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">

...
{
	location = "./payment_sched_specificCourse.jsp";
}
function ReloadPage() {
	document.form_.submit();
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-PAYMENT MAINTENANCE-Payment schedule","payment_sched_specificCourse.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"payment_sched_specificCourse.jsp");
...
if(strTemp.length() > 0) {
	if(FA.operateOnPmtSchWithSpecifiCourse(dbOP, request,Integer.parseInt(strTemp)) == null)
		strErrMsg = FA.getErrMsg();
	else	
		strErrMsg = "Operation successful.";
}

	vRetResult  = FA.operateOnPmtSchWithSpecifiCourse(dbOP, request,4);

%>


<form name="form_" action="./payment_sched_specificCourse.jsp" method="post">
...
{%>
    ...
    <tr> 
      <td width="3%" height="25">&nbsp;</td>
      <td width="31%">Course Name</td>
      <td width="66%">
	  <select name="course_index">
	  <option value="">ALL</option>
<%=dbOP.loadCombo("course_index","course_name"," from course_offered where is_del=0 and is_valid=1 order by course_name asc", WI.fillTextValue("course_index"), false)%> </select> </td>
    </tr>
    <%if(iAccessLevel > 1){%>
    <tr> 
      <td height="25">&nbsp;</td>
...
{%>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      <td width="19%"><div align="center"><strong><font size="1">COURSE NAME</font></strong></div></td>
      <td width="19%" align="center"><font size="1"><strong>SEMESTER</strong></font></td>
...
{%>
    <tr > 
      ...
      <td align="center"><%=WI.getStrValue(vRetResult.elementAt(i+4),"ALL")%></td>

...
<form name="form_" action="./bank_list_for_check.jsp" method="post" onSubmit="SubmitOnceButton(this);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" align="center"><font color="#FFFFFF"><strong>:::: BANK LIST 
        (for check payment) ::::</strong></font></td>
    </tr>
	</table>
...
if(vRetResult != null && vRetResult.size() > 0){%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr bgcolor="#97ABC1"> 
      <td height="25" colspan="7" class="thinborder" align="center"><strong>LIST 
    ...
    <tr> 
      ...
      <td width="8%" class="thinborder"><div align="center"><font size="1"> <strong>CHECK(s) 
          COLLECTED</strong></font></div></td>
    ...
    <%
boolean bolChecksCollected = false;
for(int i = 0 ; i< vRetResult.size() ; i += 6) {%>
    <tr> 
	  ...
	  <%if( ((String)vRetResult.elementAt(i + 5)).compareTo("0") == 0) {bolChecksCollected = true;%>
	  <img src="../../../images/x.gif">
	  <%}else{bolChecksCollected = false;%>
      ...
      <input type="submit" name="1" value="Edit Info" style="font-size:11px; height:28px;border: 1px solid #FF0000;" onClick='PrepareToEdit("<%=(String)vRetResult.elementAt(i)%>");'>
        ...
        Not authorized 
        <%}%></td>
      <td align="center" class="thinborder"> <%if(iAccessLevel ==2 && bolChecksCollected){%> 

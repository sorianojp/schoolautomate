...
{
	location = "./payment_sched_specificSY.jsp";
}
function ReloadPage() {
	document.form_.submit();
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-PAYMENT MAINTENANCE-Payment schedule","payment_sched_specificSY.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(FA.operateOnPmtSchWithSY(dbOP, request,Integer.parseInt(strTemp)) == null)
...
if(WI.fillTextValue("sy_from").length() > 0) 
	vRetResult  = FA.operateOnPmtSchWithSY(dbOP, request,4);

%>


<form name="form_" action="./payment_sched_specificSY.jsp" method="post">
...
if(strTemp.compareTo("0") ==0){%>
    ...
    <tr> 
      ...
      <td><select name="exam_period_order">
          ...
          <%
strTemp = WI.fillTextValue("exam_period_order");
if(strTemp.compareTo("2") == 0)
{%>
...
{%>
    ...
    <tr> 
      ...
      <td><font size="1"> From 
        <input name="exam_sch_date_fr" type="text" size="12" maxlength="12" readonly="yes" value="<%=WI.fillTextValue("exam_sch_date_fr")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('form_.exam_sch_date_fr');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a> 
        (Optional ) to 
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        ...
        (to date must be filled up)</font></td>
    </tr>
    <tr> 
...
{%>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      ...
      <td width="23%" height="25"><div align="center"><font size="1"><strong>PERIOD 
          NAME</strong></font></div></td>
      <td width="30%" align="center"><strong><font size="1">EXAM SCH DATE</font></strong></td>
      <td width="20%" align="center"><font size="1"><strong>DELETE</strong></font></td>

...
if(strTemp != null && strTemp.compareTo("1") == 0)
{
	...
	if(FA.addMiscFee(dbOP,request))
		strErrMsg = "Miscellaneous Fee added successfully.";
	else
	{
		bolProceed = false;
...
boolean bolIsUC     = false;//rmeove attcnb strSchoolCode.startsWith("UC");
...
%> 
<form name="oth_miscfee" action="./fm_misc_fee.jsp" method="post">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="5" style="font-weight:bold; font-size:14px; color:#FF0000">&nbsp;&nbsp;&nbsp;<%=strErrMsg%></td>
    </tr>
...
<%}%>
   <tr> 
	...
	if(vEditInfo != null && vEditInfo.size() > 1 && (request.getParameter("reloadPage") == null || 
		...
		strErrMsg = WI.fillTextValue("is_for_new_stat");
	}//System.out.println(strTemp);
	if(strTemp == null || strTemp.compareTo("0") ==0) strTemp = "";
	else
		strTemp = " checked";
	%> <input type="checkbox" name="is_for_new" value="1"<%=strTemp%>>
...
<%
if(strSchoolCode.startsWith("AUF") || strSchoolCode.startsWith("VMA") || strSchoolCode.startsWith("WUP") || strSchoolCode.startsWith("PWC") || true){%> 
    <tr> 
      <td height="25">&nbsp;</td>
      <td colspan="4"> <%
	if(vEditInfo != null && vEditInfo.size() > 1 && (request.getParameter("reloadPage") == null || request.getParameter("reloadPage").compareTo("0") == 0))
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td  colspan="3"><select name="fee_name_reference" onChange="CopyMiscFeeName();" >
          ...
          <%=dbOP.loadCombo("distinct FEE_NAME","fee_name"," from FA_MISC_FEE where IS_DEL=0 and is_valid=1 AND MISC_OTHER_CHARGE=0 order by FA_MISC_FEE.fee_name asc", null, false)%> </select>
        <a href="javascript:UpdateMiscFeeName();"><img src="../../../images/update.gif" border="0"></a> 
	...
	if(strTemp == null) strTemp = "";//System.out.println(strTemp);
	%> <input type="text" name="amount" value="<%=strTemp%>" class="textbox" size="6"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"> 
        <%
//	if(vEditInfo != null && vEditInfo.size() > 1 && (request.getParameter("reloadPage") == null || request.getParameter("reloadPage").compareTo("0") == 0))
...
//	if(strTemp == null) strTemp = "";
	%> <!--<select name="currency">
          ...
          <%//}%>
        </select>--><input type="hidden" name="currency" value="Php"> <%
...
// if(bolHandsOn)
 {
	...
	%> <select name="amt_per_unit" style="font-size:11px;">
...
<%}if(strTemp.equals("3") && strSchoolCode.startsWith("NU")){%>
		   <option value="3" selected="selected">Amount * Units Enrolled</option>
<%}else if(strSchoolCode.startsWith("NU")){%>
          <option value="3">Amount * Units Enrolled</option>
<%}%>
          <!--<option>per subject</option> NOT USED NOW -->
        </select> 
<%}//show if bolHandsOn is true;%> </td>
...
%>    <tr> 
      <td height="19">&nbsp;</td>
      <td align="right"><input type="checkbox" name="misc_other_charge" value="1">&nbsp;</td>
      <td colspan="3">Click to move this fee to Other Charges</td>
    </tr>
<%}	
   if(iAccessLevel > 1){%>
    <tr> 
...
%>
    <tr bgcolor="#B9B292"> 
      <td height="25" colspan="13"><div align="center">LIST OF MISCELLANEOUS FEES</div></td>
    </tr>
  </table>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="16%"><div align="center"><font size="1"><strong>ONLY FOR NEW 
          </strong></font></div></td>
      <td width="7%" align="center"><font size="1"><strong>ONLY FOR OLD</strong></font></td>
      <td width="7%" align="center"><font size="1"><strong><font size="1">YEARLY 
        FEE</font></strong></font></td>
<%if(bolIsVMUF){%>
...
//System.out.println("Printing optional :"+(String)vRetResult.elementAt(i+3));
	...
	//for total
	dTotal += Double.parseDouble(ConversionTable.replaceString((String)vRetResult.elementAt(i+6), ",",""));
...
%>
    <tr> 
      ...
      <td align="center"> <%
	  if(WI.getStrValue((String)vRetResult.elementAt(i+12)).compareTo("1") ==0){%> <img src="../../../images/tick.gif"> <%}else{%> &nbsp; <%}%> </td>
      <td align="center"> <%
	  if(WI.getStrValue((String)vRetResult.elementAt(i+11)).compareTo("1") ==0){%> <img src="../../../images/tick.gif"> <%=WI.getStrValue((String)vRetResult.elementAt(i+14),"(",")","")%> <%}else{%> &nbsp; <%}%> </td>
...
<%if(dTotal > 0d) {%>
  <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr style="font-weight:bold">
      <td height="25">Page Total: &nbsp;<%=CommonUtil.formatFloat(dTotal, true)%></td>
    </tr>
  </table>
<%}%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0">

...
//add security here.
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-FEE MAINTENANCE-map oth sch fee as supplies fee","fm_misc_fee_multiple_labfee_tagged.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(feeM.operateOnPhilcstSupplies(dbOP, request, Integer.parseInt(strTemp)) == null)
		strErrMsg = feeM.getErrMsg();
	else 
		strErrMsg = "Operation Successful.";		
}

Vector vRetResult = feeM.operateOnPhilcstSupplies(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null)
	strErrMsg = feeM.getErrMsg();

%>
<form name="form_" action="./set_supplies_fee_philcst.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25"><div align="center"><font color="#FFFFFF"><strong>:::: Define Other School Fee As Supplies Fee ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">  
...
<%
strTemp = " from fa_oth_sch_fee where is_valid = 1 and not exists (select * from FA_OTH_SCH_FEE_SUPPLIES where supply_fee_name = fee_name) order by fa_oth_sch_fee.fee_name";
%>					
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="25" colspan="2" bgcolor="#dddddd"><div align="center"><strong>::: List of Supplies Fee::: </strong></div></td>
    </tr>
  </table>

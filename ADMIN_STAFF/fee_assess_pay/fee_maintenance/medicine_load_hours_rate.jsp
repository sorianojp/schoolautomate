...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Fee Assessment & Payments-medicine load hour rate","medicine_load_hours_rate.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form name="fm_variable" action="./medicine_load_hours_rate.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF"><strong>:::: 
          VARIABLE LOAD RATE PERCENTAGE PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="7%" height="25">&nbsp;</td>
      <td width="20%" height="25">Load UNIT/ HOUR</td>
      <td width="13%" height="25"><select name="load_hour_con" onChange="ShowHideLoadHrTo();">
          <option value="0">Equal to</option>
          <%
strTemp = WI.fillTextValue("load_hour_con");
if(strTemp.compareTo("1") ==0){%>
      ...
      <td width="60%" height="25" colspan="3"> <input name="load_range_fr" type="text" size="6" maxlength="6" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'" value="<%=WI.fillTextValue("load_range_fr")%>"
	  onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;">
        <input name="load_range_to" type="text" size="6" maxlength="6" class="textbox" id="rangeTo_"
	  onfocus="style.backgroundColor='#D3EBFF'" onblur="style.backgroundColor='white'" value="<%=WI.fillTextValue("load_range_to")%>"
...
ShowHideLoadHrTo();
    ...
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25">Rate Percent</td>
      <td height="25" colspan="4"><input name="rate_percent" type="text" size="4" maxlength="4" 
...
%>
    <tr bgcolor="#B9B292"> 
      <td height="25" colspan="6"><div align="center">LIST OF EXISTING LOAD HOURS 
          &amp; RATE PERCENTAGE FOR SY <%=request.getParameter("sy_from")+" - "+request.getParameter("sy_to")%>, 
		  <%=strTemp%></div></td>
    </tr>
<%}%>
  </table>
...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="31%" height="25"><font size="1"><strong>LOAD HOURS</strong></font></td>
      <td width="16%" height="25"><font size="1"><strong>PERCENTAGE</strong></font></td>
      <td width="11%"><font size="1"><strong>YEAR LEVEL</strong></font></td>
      <td height="25">&nbsp;</td>
    </tr>
    <%
...
{%>
    <tr> 
      <td height="25">&nbsp;</td>
      <td height="25"><%=astrConvertToLoadCon[Integer.parseInt((String)vRetResult.elementAt(i+1))]%><%=(String)vRetResult.elementAt(i+2)%></td>

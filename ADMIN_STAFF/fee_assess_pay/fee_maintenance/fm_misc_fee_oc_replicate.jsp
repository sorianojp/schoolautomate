...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Fee Assessment & Payments-FEE MAINTENANCE-misc fee","fm_misc_fee_oc_replicate.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<form name="oth_miscfee" action="./fm_misc_fee_oc_replicate.jsp" method="post">
...
-->
    <tr>
      ...
      <td>
	  	<select name="cc_index" onChange="ReloadPage();">
          <option></option>
          <%=dbOP.loadCombo("c_index","c_name"," from college where IS_DEL=0 order by c_name asc", request.getParameter("cc_index"), false)%>
        </select></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
  ...
  <%
	...
	if(vEditInfo != null && vEditInfo.size() > 1 && (request.getParameter("reloadPage") == null || request.getParameter("reloadPage").compareTo("0") == 0))
		...
		strTemp = " from course_offered where C_INDEX = "+WI.fillTextValue("c_index")+" and IS_DEL=0 AND IS_VALID=1 order by cname asc";
	else
...
strSchCode.startsWith("UB") || strSchCode.startsWith("SWU")){%>
    <tr>
      <td height="25">&nbsp;</td>
...
{%>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      <td width="47%" height="25"><div align="center"><font size="1"><strong>FEE

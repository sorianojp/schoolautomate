...
function ViewAll() {
	var loadPg = "./basic_old_stud_ledger_viewall.jsp?stud_id="+
		document.ledger_old.stud_id.value;
	var win=window.open(loadPg,"myfile",'dependent=yes,width=800,height=450,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();
}
</script>
...
vStudInfo = basicUserInfo.operateOnBasicInfo(dbOP, request, 4);
...
else
{
	...
	if(WI.fillTextValue("addRecord").compareTo("1") ==0)
	{
		...
		if(!studLedger.operateOnOldLedger(dbOP,request,1))
		{
			...
			strErrMsg = "Record saved successfully.";
	}
...
%>
<form name="ledger_old" action="./basic_old_stud_ledger_mgmt.jsp" method="post">
<input type="hidden" name="focus_mm">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td width="100%" height="25" colspan="4" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>:::: 
          OLD ACCOUNT MANAGEMENT PAGE (BASIC EDUCATION)::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="25%" height="25"><input name="stud_id" type="text" size="16" value="<%=WI.fillTextValue("stud_id")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"> 
      </td>
      <script language="JavaScript">
document.ledger_old.focus_mm.value = "1";
</script>
      <td width="23%"> <input name="image2" type="image" src="../../../images/form_proceed.gif"></td>
      <td width="32%">
	  <a href="javascript:ViewAll();"><img src="../../../images/view.gif" border="0"></a> Click to view complete old ledger encoding.</td>
    </tr>
  </table>
<%
if(vStudInfo != null && vStudInfo.size() > 0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td colspan="4" height="10"><hr size="1"> 
    ...
    <tr> 
      ...
      <td height="20" colspan="2">Student name :<strong> <font size="1"><%=WebInterface.formatName((String)vStudInfo.elementAt(3),(String)vStudInfo.elementAt(4),
				(String)vStudInfo.elementAt(5),4)%></font></strong></td>
      <td width="45%">Education : <font size="1"><strong><%=(String)vStudInfo.elementAt(14) + " - "+
	  	(String)vStudInfo.elementAt(15)%></strong></font></td>
    </tr>
    <tr> 
    ...
    <tr> 
      <td height="25">&nbsp;</td>
      <td width="39%" height="25">School Year : 
...
<%}else{%>
 ...
 <%}%>
      ...
      <td colspan="2"><input name="image" type="image" onClick="ShowLedgerDetail()" src="../../../images/form_proceed.gif"></td>
      <script language="JavaScript">

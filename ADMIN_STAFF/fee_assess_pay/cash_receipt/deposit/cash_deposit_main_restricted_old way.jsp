...
if(strInfoIndex == null && strTellerIndex != null) {//get details if there are any.. 
	strSQLQuery = "select DEPOSIT_MAIN_INDEX, create_time, DEPOSITED_IN_BANK,is_completed from CASH_DEPOSIT_MAIN where is_valid = 1 and teller_index = "+strTellerIndex+
			...
			<td width="60%" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
					...
					<tr>
					  ...
					  Next Day Begining Balance = Begining Balance + (Cash + Check Remitted) - Amount deposited					  </td>
				  </tr>
					<tr>
					  <td height="25"></td>

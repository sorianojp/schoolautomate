...
<META HTTP-EQUIV="REFRESH" CONTENT="300; URL=./esec_mp3.jsp" >
...
if(strErrMsg != null){//removed because it does not work in debian.. needs plugin :O.. %>
	<EMBED SRC="../../jscript/error_attendance.mp3" autostart="true" LOOP="false" HIDDEN="true"></EMBED>
<%}%>

<form name="esec_record" method="post" action="./esec_mp3.jsp">

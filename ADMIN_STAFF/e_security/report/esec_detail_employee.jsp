...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-eSecurity Check-Campus Query","esec_detail_employee.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(WI.fillTextValue("search_page").compareTo("1") == 0){
	vRetResult = CQ.getAttendanceDetailEmployee(dbOP,request);
	if(vRetResult == null)
...
strReportToDisp = "EMPLOYEE ATTENDANCE REPORT ";//WI.fillTextValue("report_name").toUpperCase();
...
<body>
<form action="./esec_detail_employee.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable1">
    <tr bgcolor="#A49A6A"> 
      <td width="88%" height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          EMPLOYEE CAMPUS ATTENDANCE QUERY PAGE ::::</strong></font></div></td>
    </tr>
    <tr > 
...
<%}%> 
 <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr style="font-weight:bold;" bgcolor="#EEEEEE"> 
      ...
      <td width="12%" align="center" class="thinborder">Employee ID </td>
      <td width="18%" align="center" class="thinborder">Employee Name </td>
      <td width="20%" align="center" class="thinborder"><%if(bolIsSchool){%>College<%}else{%>Division/Office<%}%></td>
      <%if(bolShowTimeInOut){%>

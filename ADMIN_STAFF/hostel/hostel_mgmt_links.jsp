...
if(bolGrantAll || comUtil.IsAuthorizedModule(dbOP,strUserId,"Hostel Management")){isAuthorized=true;%>
...
<div class="trigger" onClick="showBranch('branch1');swapFolder('folder1')"> <img src="../../images/box_with_plus.gif" width="7" height="7" border="0" id="folder1">
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">HOSTEL MAINTENANCE</font></strong></div>

<span class="branch" id="branch1"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"></font>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="hostel_maintenance/hm_add.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">
Add/Edit/Delete</font></a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="hostel_maintenance/hm_view.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">View/Print</font></a><br>
</span>

<!-- <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif"><a href="../user_admin/set_param.jsp" target="useradminmainFrame">SET PARAMETERS
 </a> </font></strong> -->
...
<div class="trigger" onClick="showBranch('branch3');swapFolder('folder3')"> <img src="../../images/box_with_plus.gif" width="7" height="7" border="0" id="folder3">
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">OCCUPANCY MAINTENANCE </font></strong></div>
<span class="branch" id="branch3"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"></font>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="occ_maintenance/reservation.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Reservation</font></a><br>

<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="occ_maintenance/occ_maintenance_add_create.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Add/Create</font></a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"><a href="occ_maintenance/view_delete.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">
View/Delete</font></a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="occ_maintenance/change_room.htm" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Change
Room </font></a><br>
</span>
...
<div class="trigger" onClick="showBranch('branch4');swapFolder('folder4')"> <img src="../../images/box_with_plus.gif" width="7" height="7" border="0" id="folder4">
  <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">CHARGES
  </font></strong></div>

<span class="branch" id="branch4"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF"></font>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="charges/fm_schl_fees_post_charges.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Post
Charges(Individual)</font></a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="charges/post_charges_per_room.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Post
Charges(Per room)</font></a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="charges/obs.jsp" target="hostelmainFrame"><font size="2" face="Geneva, Arial, Helvetica, sans-serif">Occupant's
Billing Statement </font></a><br>
	</span>
<!--
 <img src="../../images/small_white_box.gif" width="7" height="7" border="0" >
...
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="../enrollment/change_subjects/reg_change_subject_drop.htm" target="enrolmainFrame">Drop/Withdraw</a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="../enrollment/change_subjects/reg_change_subject_add.htm" target="enrolmainFrame">Add</a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="../enrollment/change_subjects/reg_change_subject_schedules.htm" target="enrolmainFrame">Schedules</a><br>
<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="../enrollment/change_subjects/reg_change_subject_print.htm" target="enrolmainFrame">Print
...
<div class="trigger" onClick="showBranch('branch6');swapFolder('folder6')"> <img src="../../images/box_with_plus.gif" width="7" height="7" border="0" id="folder6"> <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">STATISTICS</font></strong></div>
  <span class="branch" id="branch6"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">
  	<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="#"><font face="Geneva, Arial, Helvetica, sans-serif">Enrollees</font></a><br>
  	<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="#"><font face="Geneva, Arial, Helvetica, sans-serif">Subjects</font></a><br>
   </font>
 </span>
...
<div class="trigger" onClick="showBranch('branch7');swapFolder('folder7')"> <img src="../../images/box_with_plus.gif" width="7" height="7" border="0" id="folder7"> <strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">REPORTS</font></strong></div>
  <span class="branch" id="branch7"><font size="2" face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">
  	<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="#"><font face="Geneva, Arial, Helvetica, sans-serif">Class Lists</font></a><br>
  	<img src="../../images/broken_lines.gif" width="15" height="15"> <a href="#"><font face="Geneva, Arial, Helvetica, sans-serif">Students' Schedules</font></a><br>
 	</font>
 </span>-->
<%}

...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/Hostel Management-OCCUPANCY MAINTENANCE- Delete occupancy","occ_delete.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="6" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
        OCCUPANCY MAINTENANCE - OCCUPANT'S DETAILS PAGE ::::<br>
        </strong></font></div></td>
    </tr>
	</table>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="35">&nbsp;</td>
    <td height="25" valign="bottom">Outstanding Balance/Refund : <strong><u>Php
      $outstanding_bal</u></strong></td>
  </tr>
  <tr>
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
  ...
  <tr>
	...
	<img src="../../../images/form_proceed.gif" width="81" height="21">
        <font size="1">click to confirm delete of occupant</font>

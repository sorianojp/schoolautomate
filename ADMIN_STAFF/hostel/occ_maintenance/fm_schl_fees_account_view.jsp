...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/Hostel Management-OCCUPANCY MAINTENANCE- view occupancy account","fm_schl_fees_account_view.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="100%" height="25"><a href="javascript:history.back();"><img src="../../../images/go_back.gif" width="50" height="27" border="0"></a>

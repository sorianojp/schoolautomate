...
function loadDept() {
		var objCOA=document.getElementById("load_dept");
 		var objLoanType = document.form_.c_index[document.form_.c_index.selectedIndex].value;
		...
		var strURL = "../../../../Ajax/AjaxInterface.jsp?methodRef=112&col_ref="+objLoanType+
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-LOANS-Reports-Period Loans Reconciliation","loan_period_recon.jsp");

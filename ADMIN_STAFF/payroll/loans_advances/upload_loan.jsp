...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-LOANS-Reports-Upload Existing Loans","upload_loan.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(WI.fillTextValue("upload_loan").length() > 0){
		if(!PRRetLoan.uploadExistingLoans(dbOP,request))
...
<form name="form_" method="post" action="./upload_loan.jsp">
<input type="hidden" name="loan_type" value="2">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="22%"><strong><%=WI.getStrValue(strTemp,"")%></strong></td>
      <td width="16%" height="26">&nbsp;Interest</td>
      <%
	  	if(vLoanInfo != null && vLoanInfo.size() > 0){
			...
			strTemp = WI.getStrValue(strTemp,"","% " +astrInterestUnit[Integer.parseInt((String)vLoanInfo.elementAt(7))],"");			
				...
				strTemp = "";
	  %>
      <td width="37%"><strong><%=strTemp%></strong></td>
    </tr>
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td><p>1. Emp ID - Employee ID <br>
        2. loaned amount - original amount loaned<br>
        3. payable amount - payable balance<br>
      4. monthly amount - monthly amortization<br>
      ...
      7. frequency of deduction - (0 - every salary period, 1 - first salary period, 2 - second salary period) </p>      </td>
    </tr>
    <tr>

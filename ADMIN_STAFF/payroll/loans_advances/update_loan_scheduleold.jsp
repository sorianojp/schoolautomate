...
//add security here.
	...
	if (strPageAction.length() > 0){
		if (strPageAction.compareTo("0")==0) {
			if (PRRetLoan.operateOnLoadSchedule(dbOP,request,0) != null){
				strErrMsg = "Loan schedule deleted successfully";
			}else{
				strErrMsg = PRRetLoan.getErrMsg();
			}
		}else if(strPageAction.compareTo("1") == 0){
			if (PRRetLoan.operateOnLoadSchedule(dbOP,request,1) != null){
				strErrMsg = " Loan schedule successfully";
			}else{
				strErrMsg = PRRetLoan.getErrMsg();
			}
		}else if(strPageAction.compareTo("2") == 0){
			if (PRRetLoan.operateOnLoadSchedule(dbOP,request,2) != null){
				strErrMsg = " Loan schedule updated successfully";
				strPrepareToEdit = "";
			}else{
				strErrMsg = PRRetLoan.getErrMsg();
			}
	...
	if (strPrepareToEdit.length() > 0){
		vEditInfo = PRRetLoan.operateOnLoadSchedule(dbOP,request,3);
		if (vEditInfo == null)
			strErrMsg = PRRetLoan.getErrMsg();
	}
    ...
    <tr> 
      <td height="31" colspan="4"><div align="center"><font size="1"></font></div>
        <div align="center">
          ...
          <font size="1" face="Verdana, Arial, Helvetica, sans-serif"> click to          </font><font size="1" face="Verdana, Arial, Helvetica, sans-serif">clear 
          fields </font></div></td>
    </tr>
  </table>	  
 <%if(vRetResult != null && vRetResult.size() > 0){%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td width="18%" align="center" class="BorderBottomLeft"><strong><font size="1">OLD PRINCIPAL</font></strong></td>
      <td width="16%" align="center" class="BorderBottomLeft"><strong><font size="1">OLD INTEREST</font></strong></td>
      <td width="18%" align="center" class="BorderBottomLeft"><strong><font size="1">NEW PRINCIPAL</font></strong></td>
      <td width="18%" height="24" align="center" class="BorderBottomLeft"><strong><font size="1">NEW INTEREST</font></strong></td>
      <!--
	  ...
	  -->
      <td width="17%" align="center" class="BorderBottomLeftRight">
		   <strong>
    ...
    <tr> 
      ...
      <td align="right" class="BorderBottomLeft"><%=strTemp%>&nbsp;</td>
			<%
				...
				dNewInterest += dTemp;
			%>
      <td height="29" align="right" class="BorderBottomLeft"><%=strTemp%>&nbsp;</td>
      <!--
	  ...
	  -->
      <td align="center" class="BorderBottomLeftRight"><font size="1"><a href="javascript:PrepareToEdit('<%=(String)vRetResult.elementAt(i)%>')"> 
      <img src="../../../images/edit.gif" border=0 > </a></font></td>
    </tr>
    <%}%>
    <tr> 

...
<form action="by_loan_print.jsp" method="post">
<%
...
// if this page is calling print page, i have to forward page to print page.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-LOANS/ADVANCES-Search","by_loan_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td height="25" class="thinborderBottomLeftRight">&nbsp;<%=WI.formatName((String)vRetResult.elementAt(j+2),(String)vRetResult.elementAt(j+4),(String)vRetResult.elementAt(j+3),4).toUpperCase()%></td>
    </tr>
    <%}// end for loop%>
    <%if ( iNumRec >= vRetResult.size()) {%>
    <tr> 
      <td colspan="12"  class="thinborder"><div align="center">***************** 

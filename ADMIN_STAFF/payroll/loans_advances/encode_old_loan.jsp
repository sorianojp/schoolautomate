...
<%}// if (vEmpList != null && vEmpList.size() > 0)%></td>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<%if(strPrepareToEdit.compareTo("1") == 0) {%>
    <tr>
      <td height="10" align="center"><font size="1"><a href="javascript:DeleteLoan();"><img src="../../../images/delete.gif" width="55" height="28" border="0"></a>click to DELETE LOAN</font></td>
    </tr>
    <tr>

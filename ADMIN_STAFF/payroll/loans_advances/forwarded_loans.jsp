...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./forwarded_loans_print.jsp" />
<% return;}
//add security here.
	...
	if(vRetResult != null)
		iSearchResult = rptLoans.getSearchCount();				
	else
		strErrMsg = rptLoans.getErrMsg();
%>
<body bgcolor="#D2AE72" class="bgDynamic">
<form name="form_" method="post" action="forwarded_loans.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      ...
      FORWARDED LOANS  PAGE ::::</strong></font></td>
    </tr>
     <tr bgcolor="#FFFFFF">
...
View ALL </td>
    ...
    <tr>
      ...
      <td height="18"><select name="sort_by1">
        ...
        <%=rptLoans.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
      </select></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
if(WI.fillTextValue("sort_by1_con").compareTo("desc") ==0){%>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="10" align="right"><a href="javascript:PrintPg();"> <img src="../../../images/print.gif" width="58" height="26" border="0"></a> 
        <font size="1">click to print list</font></td>
    </tr>
    <%		
		if(WI.fillTextValue("view_all").length() == 0){
	int iPageCount = iSearchResult/rptLoans.defSearchSize;		
	if(iSearchResult % rptLoans.defSearchSize > 0) ++iPageCount;
	if(iPageCount > 1){%>
    <tr> 
      <td height="25" colspan="10" align="right">Jump To page: 
    ...
    <tr>
      <td height="15" colspan="10" class="BorderBottom">&nbsp;</td>
    </tr>
    <tr> 

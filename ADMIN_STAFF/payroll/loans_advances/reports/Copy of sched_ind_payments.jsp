...
<form name="form_" method="post" action="./sched_ind_payments.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" align="center" bgcolor="#A49A6A"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: REPORTS - SCHEDULE OF INDIVIDUAL PAYMENTS PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">

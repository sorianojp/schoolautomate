...
<html>
<head>
<title>Signature for loans balances</title>
...
<form name="form_" method="post" action="../../../retirement/reports/signatures_list_loan_bal.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" align="center" bgcolor="#A49A6A"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: SIGNATURES LIST FOR LOAN BALANCES PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
    <tr> 
      <td height="28" colspan="2" align="right">Number of employees per page 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    <tr>
      <td width="100%" height="25" bgcolor="#E2EAEB" class="BorderAll"><font color="#000000">&nbsp;<%=astrLoanType[Integer.parseInt(WI.getStrValue(strLoanType,"0"))]%>, Released on <%=WI.fillTextValue("release_date")%></font></td>
    </tr>
  </table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF"  class="thinborder">
    <tr> 
      <td width="9%"  height="25" align="center"  class="BorderBottomLeft"><strong><font size="1">COUNT</font></strong>      </td>
      <td width="40%" align="center" class="BorderBottomLeft"><strong><font size="1">NAME 
      OF EMPLOYEE</font></strong></td>
      <td width="22%" align="center" class="BorderBottomLeft"><strong><font size="1">AMOUNT</font></strong></td>
      <td width="29%" align="center" class="BorderBottomLeftRight"><strong><font size="1">SIGNATURE 
      / DATE</font></strong></td>
    </tr>    
	<%iCount = 1;
	for (i = 0; i < vRetResult.size(); i+=5, iCount++){%>
    <tr> 
      <td height="25" class="BorderBottomLeft"> &nbsp;<%=iCount%> </td>
      <td class="BorderBottomLeft"> <strong><%=WI.formatName((String)vRetResult.elementAt(i+1), (String)vRetResult.elementAt(i+2),
							(String)vRetResult.elementAt(i+3), 4)%></strong></td>
      <td align="center" class="BorderBottomLeft">      <%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+4),true)%> </td>

...
<%if(vRetResult != null && vRetResult.size() > 0){%>  
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="7" align="right">Number of employees per page 
	...
	if(iPageCount > 1){%>
    <tr> 
      <td height="25" colspan="7" align="right">Jump To page: 
    ...
    <tr>
      <td height="15" colspan="7" class="BorderBottom">&nbsp;</td>
    </tr>
    <tr> 
      <td width="5%" height="25" align="center" class="BorderBottomLeft"><strong><font size="1">COUNT</font></strong></td>
      <td width="39%" height="25" align="center" class="BorderBottomLeft"><strong><font size="1">EMPLOYEE 
      NAME </font></strong></td>
      <td width="15%" align="center" class="BorderBottomLeft"><strong><font size="1">REFERENCE</font></strong></td>
      <td width="15%" align="center" class="BorderBottomLeft"><strong><font size="1">LOAN NAME </font></strong></td>
      <td width="11%" height="25" align="center" class="BorderBottomLeft"><strong><font size="1">TOTAL 
      LOAN </font></strong></td>
      <!--
			<td width="12%" align="center" class="BorderBottomLeft"><strong><font size="1">TOTAL PAYMENT</font></strong></td>
			-->
      <td width="15%" align="center" class="BorderBottomLeftRight"><strong><font size="1">LOAN BALANCE</font></strong></td>
    </tr>
    <%
	int iCount = 1;
	strPrevEmp = "";

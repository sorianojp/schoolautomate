...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-LOANS-Reports-Individual Total balances","indv_total_loan_bal.jsp");
...
<form name="form_" method="post" action="indv_total_loan_bal.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" align="center" class="footerDynamic"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: INDIVIDUAL TOTAL LOAN BALANCES PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      Date availed </td>
      <td width="41%">
			<%if (abolShowList[iIndex+2])  
					strTemp = "checked";
		  	else 
					strTemp = "";
			%>
          <input type="checkbox" name="checkbox2" value="1" <%=strTemp%>>
      Monthly Amortization &nbsp;&nbsp; </td>
    </tr>
    <tr>
      <td height="21">
			<%if (abolShowList[iIndex+3])  
					strTemp = "checked";	
				else 
				strTemp = "";%>
...
<%if(vRetResult != null && vRetResult.size() > 0){%>  
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="25" colspan="12" align="right">Number of records per page 
	...
	if(iPageCount > 1){%>
    <tr> 
      <td height="25" colspan="12" align="right">Jump To page: 
    ...
    <tr>
      <td height="15" colspan="12" class="BorderBottom">&nbsp;</td>
    </tr>
    <tr> 

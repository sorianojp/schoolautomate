...
<form action="search_by_loan_print.jsp" method="post">
<%
...
// if this page is calling print page, i have to forward page to print page.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-LOANS/ADVANCES-Search","search_by_loan_print.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="14" colspan="3"><div align="center"></div></td>
    </tr>
    <tr>
      <td height="30" colspan="3" align="center" class="thinborderBottom"><strong>EMPLOYEES 
      WHO AVAILED <%=WI.fillTextValue("benefit_name")%></strong></td>
    </tr>
    <tr> 
      <td width="6%" class="thinborder">&nbsp;</td>
      <td width="16%" height="28" align="center" class="thinborder"><font size="1"><strong>EMPLOYEE 
      ID </strong></font></td>
      <td width="78%" align="center" class="thinborderBottomLeftRight"><font size="1"><strong>EMPLOYEE 
      NAME</strong></font></td>
    </tr>
    <% 
    ...
    <tr> 
      ...
      <td height="25" class="thinborderBottomLeftRight">&nbsp;<%=WI.formatName((String)vRetResult.elementAt(j+4),(String)vRetResult.elementAt(j+4),(String)vRetResult.elementAt(j+2),4).toUpperCase()%></td>
    </tr>
    <%}// end for loop%>
    <%if ( iNumRec >= vRetResult.size()) {%>
    <tr> 
      <td colspan="12" align="center"  class="thinborder">***************** 
          NOTHING FOLLOWS *******************</td>
    </tr>
    <%}else{// end iNumStud >= vRetResult.size()%>
    <tr> 
      <td colspan="12" align="center"  class="thinborder">************** CONTINUED ON NEXT PAGE ****************</td>
    </tr>
    <%}//end else%>
  </table>
  <%if (bolPageBreak){%>

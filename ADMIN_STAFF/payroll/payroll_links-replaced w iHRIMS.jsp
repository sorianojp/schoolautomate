...
<img src="../../images/arrow_blue.gif" border="0" ><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif"> <a href="dtr/leave/leave_conversion_doe.jsp" target="payrollmainFrame">Leave Conversion(batch2)</a></font></strong><br>
<%if(bolShowAllLinks){%>
...
<%}%>
<%if(strSchCode.startsWith("UC") || bolShowAllLinks){%>
...
<%}%>
<%if (strSchCode.startsWith("DEPED") || bolShowAllLinks || true){%> 

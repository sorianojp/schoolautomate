...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./encode_hours_overload_print.jsp" />
	<% 
return;}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Overload Encoding","encode_hours_overload.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(Overload.operateOnManualOverloadHours(dbOP, request, Integer.parseInt(strPageAction)) == null){
			strErrMsg = Overload.getErrMsg();
		} else {
			if(strPageAction.equals("1"))
				strErrMsg = "Overload successfully posted.";		
			if(strPageAction.equals("0")){
				strErrMsg = "Overload successfully removed.";		
			}			
		}
	}
...
<form action="encode_hours_overload.jsp" method="post" name="form_">

...
<html>
<head>
<title>Encode Manual adjustments</title>
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./encode_manual_adjust_print.jsp" />
	<% 
return;}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Manual Adjustment","encode_manual_adjust.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prEdtrME.operateOnBatchAdjustment(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
<form action="encode_manual_adjust.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: MANUAL ADJUSTMENT PAGE ::::</strong></font></td>
    </tr>
</table>
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
    ...
    <tr>
      ...
      <td>Adjustment type </td>
			<%
				strTemp = WI.fillTextValue("ot_type");
			%>
      <td><select name="ot_type" onChange="ReloadPage();">
				<%if(WI.fillTextValue("all_adjustment").length() == 0){%>
        <option value="">Select Adjustment Type</option>
        <%=dbOP.loadCombo("ot_type_index","code", " from pr_ot_mgmt " +
		  " where is_valid = 1 and is_for_ot = 0", strTemp,false)%>
			<%}%>
      </select>
			<%strTemp = WI.fillTextValue("with_schedule");
				if(WI.getStrValue(strTemp,"1").equals("1")){
					if(WI.fillTextValue("all_adjustment").length() > 0){
						strTemp = " checked";				
					}else{
						strTemp = "";
        ...
        <input name="all_adjustment" type="checkbox" value="1"<%=strTemp%> onClick="ReloadPage();">
        <font size="1">Ignore Type </font>
        <%}%>				</td>
    </tr>
    <tr>
      <td height="24">&nbsp;</td>
...
View/save encoded work duration
<%
	if(strTemp.length() == 0) 
		strTemp = " checked";
	else
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="22%" height="23" align="center" class="thinborder"><strong><font size="1">EMPLOYEE NAME </font></strong></td>
      <td width="20%" align="center" class="thinborder"><strong><font size="1">DEPARTMENT/OFFICE</font></strong></td>
      <td width="12%" align="center" class="thinborder"><strong><font size="1">SALARY BASIS </font></strong></td>
			<%if(WI.fillTextValue("with_schedule").equals("1")){%>
			<td width="8%" align="center" valign="bottom" class="thinborder"><strong><font size="1">CODE</font></strong></td>
			<%}%>
			<%if(WI.fillTextValue("viewOption").equals("1")){%>
      <td width="13%" align="center" valign="bottom" class="thinborder"><strong><font size="1">WORK DURATION<br>
      <a href="javascript:CopyDuration();">Copy all</a></font></strong></td>
			<%}else{%>
      <td width="10%" align="center" valign="bottom" class="thinborder"><strong><font size="1">AMOUNT</font><font size="1"> <br>
    ...
    <tr>
      ...
      <td height="25" class="thinborder"><font size="1"><strong>&nbsp;&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),
			...
			<input type="hidden" name="sal_base_<%=iCount%>" value="<%=(String)vRetResult.elementAt(i+10)%>">
      ...
      <td class="thinborder">&nbsp; <%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"")%><%=strTemp%><%=WI.getStrValue((String)vRetResult.elementAt(i + 6),"")%> </td>
		  <td class="thinborder">&nbsp;<%=astrSalaryBase[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(i + 10),"0"))]%></td>
		  <%if(WI.fillTextValue("with_schedule").equals("1")){%>
		  ...
		  <%
			...
			if(WI.fillTextValue("with_schedule").equals("1") && !WI.fillTextValue("copy_all").equals("1"))
				...
				if(WI.fillTextValue("copy_all").equals("1"))
					strTemp = WI.fillTextValue("worked_dur_1");
			}
		...
		%>	
		  ...
		  <td align="center" class="thinborder"><strong>
		    <input name="worked_dur_<%=iCount%>" type="text" class="textbox" size="10" maxlength="10" 
		  ...
		  <%}else{%>
			...
			if(WI.fillTextValue("with_schedule").equals("1") && !WI.fillTextValue("copy_all").equals("1"))
				...
				if(WI.fillTextValue("copy_all").equals("1"))
					strTemp = WI.fillTextValue("adj_amount_1");
			}
			strTemp = WI.getStrValue(strTemp,"0");
			dTemp = Double.parseDouble(strTemp);
			strTemp = CommonUtil.formatFloat(dTemp,2);
      ...
      <td align="center" class="thinborder"><strong> 
        <input name="adj_amount_<%=iCount%>" type="text" class="textbox" size="10" maxlength="10" 
				onfocus="style.backgroundColor='#D3EBFF'"
				onblur="AllowOnlyFloat('form_','adj_amount_<%=iCount%>');style.backgroundColor='white'" 
				onKeyUp="AllowOnlyFloat('form_','adj_amount_<%=iCount%>');"
				value="<%=strTemp%>" style="text-align:right">
      </strong></td>
			<%}%>
			<%if (WI.fillTextValue("with_schedule").equals("1")){
    ...
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25" colspan="8" style="font-size: 10px"> <br>
        Note: 1. Percentage setting of the adjustment type will be disregarded if <strong>View/save amount </strong>is selected. <br> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. If salary basis is daily rate, work duration should be in days. <br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3. If salary basis is hourly rate, work duration should be in hours.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;4.  
      For monthly basis and other adjustments use the <strong>View/Save amount.</strong><br>      
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5. Employees with &quot;n/a&quot; option already has saved payroll. Adding/updating adjustment not allowed anymore. <br></td>
    </tr>
		<%if(WI.fillTextValue("all_adjustment").length() == 0){%>
    <tr>

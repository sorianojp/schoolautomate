...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Encode Faculty Hours","encode_hours_worked.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prEdtrME.operateOnManualFacHours(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
<form action="encode_hours_worked.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: ENCODE FACULTY HOURS WORKED PAGE ::::</strong></font></td>
    </tr>
</table>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="6%" rowspan="2" class="thinborder">&nbsp;</td> 
      <td width="36%" height="23" rowspan="2" align="center" class="thinborder"><strong><font size="1">EMPLOYEE NAME </font></strong></td>
      <td width="35%" rowspan="2" align="center" class="thinborder"><strong><font size="1">DEPARTMENT/OFFICE</font></strong></td>
      <td colspan="2" align="center" class="thinborder"><strong><font size="1">DURATION</font><font size="1"><br>
            <a href="javascript:CopyHour();"></a></font></strong></td>
      <td width="6%" rowspan="2" align="center" class="thinborder"><font size="1"><strong>SELECT ALL<br>
        </strong>
    ...
    <tr>
      ...
      <td width="7%" align="center" class="thinborder"><strong><font size="1">Minutes <br>
            <a href="javascript:CopyMin();">Copy all</a></font></strong></td>
    </tr>
    <% int iCount = 1;

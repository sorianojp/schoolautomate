...
<html>
<head>
<title>Print Manually encoded overload</title>
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	vRetResult = Overload.operateOnManualOverloadHours(dbOP,request, 4);
	if (vRetResult != null) {			
		int iCount = 0;
		int iTemp  = 0;
...
<form name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td width="19%" align="center" class="thinborderBOTTOMLEFTRIGHT"><strong><font size="1">HOURS WORKED</font></strong></td>
    </tr>
		<% 

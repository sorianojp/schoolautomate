...
function loadDept() {
		...
		document.getElementById("content_display").innerHTML="";
		var objCourseInput = document.form_.c_index[document.form_.c_index.selectedIndex].value;
		...
		var strURL = "../../../../Ajax/AjaxInterface.jsp?methodRef=112&col_ref="+objCourseInput+"&sel_name=d_index&onchange=ReloadPage&all=1";
		this.processRequest(strURL);
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: MANUAL ABSENCES ENCODING  PAGE ::::</strong></font></td>
    </tr>
</table>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="20" colspan="8" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>LIST OF EMPLOYEES</strong></div></td>
    </tr>
    <tr>
      ...
      <td width="9%" align="center" class="thinborder"><strong><font size="1">DAYS ABSENT <br>
    ...
    <tr>
      ...
      <td class="thinborder">&nbsp; <%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"")%><%=strTemp%><%=WI.getStrValue((String)vRetResult.elementAt(i + 6),"")%> </td>
		...
		%>				
		  <td align="center" class="thinborder"><strong>
		    <input name="days_<%=iCount%>" type="text" class="textbox" size="4" maxlength="6" 
      ...
      <td class="thinborder"><div align="center"><strong> 
        <input name="amount_<%=iCount%>" type="text" class="textbox" size="4" maxlength="8" 
	      onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;"
				value="<%=strTemp%>" style="text-align:right">
      </strong></div></td>
			<%}%>

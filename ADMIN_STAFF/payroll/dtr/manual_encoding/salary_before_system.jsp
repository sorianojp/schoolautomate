<%@ page language="java" import="utility.*,java.util.Vector,payroll.PRMiscDeduction,payroll.ReportPayroll" %>
<%
...
<html>
<head>
<title>Salary Encoding before system</title>
...
function CancelRecord(){
	location = "salary_before_system.jsp?emp_id="+document.form_.emp_id.value+
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","salary_before_system.jsp");
...
<form action="salary_before_system.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  onKeyUp="AllowOnlyFloat('form_','non_tax_bonus');"	 
	  onBlur="AllowOnlyFloat('form_','non_tax_bonus');style.backgroundColor='white';UpdateToZero('non_tax_bonus')">
        </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td>
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','de_minimis');"	 
	  onBlur="AllowOnlyFloat('form_','de_minimis');style.backgroundColor='white';UpdateToZero('de_minimis')">
      </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td> 
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','non_tax_sal');"	 
	  onBlur="AllowOnlyFloat('form_','non_tax_sal');style.backgroundColor='white';UpdateToZero('non_tax_sal')">
        </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td> 
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','contributions');"	 
	  onBlur="AllowOnlyFloat('form_','contributions');style.backgroundColor='white';UpdateToZero('contributions')">
        </strong></td>
    </tr>
    <tr> 
      <td height="24" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','taxable_bonus');"	 
	  onBlur="AllowOnlyFloat('form_','taxable_bonus');style.backgroundColor='white';UpdateToZero('taxable_bonus')">
        </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td> 
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','taxable_salary');"	 
	  onBlur="AllowOnlyFloat('form_','taxable_salary');style.backgroundColor='white';UpdateToZero('taxable_salary')">
        </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td> 
    ...
    <tr> 
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" colspan="2" bgcolor="#FFFFFF">Tax Withheld for the year </td>
      <td bgcolor="#FFFFFF"><strong>
        <% if (vEditInfo != null && vEditInfo.size() > 0)
    ...
    <tr>
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" colspan="2" bgcolor="#FFFFFF">Tax Refunded for the year </td>
      <td bgcolor="#FFFFFF"><strong>
			<% 
			 if (vEditInfo != null && vEditInfo.size() > 0)
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','tax_refund');"
	  onBlur="AllowOnlyFloat('form_','tax_refund');style.backgroundColor='white';UpdateToZero('tax_refund')">
    </strong></td>
    </tr>
    <tr>
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" colspan="2" bgcolor="#FFFFFF">Salary</td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    ...
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" bgcolor="#FFFFFF">Basic Salary</td>
      <td bgcolor="#FFFFFF">
			<% 
			 if (vEditInfo != null && vEditInfo.size() > 0)
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','basic_salary');"	 
		onBlur="AllowOnlyFloat('form_','basic_salary');style.backgroundColor='white';UpdateToZero('basic_salary')">      </td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" bgcolor="#FFFFFF">Gross Basic </td>
			<% 
			 if (vEditInfo != null && vEditInfo.size() > 0)
			...
			%>			
      <td bgcolor="#FFFFFF"><strong>
        <input name="gross_salary" type="text" size="10" maxlength="10"  class="textbox"
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','gross_salary');"	 
		onBlur="AllowOnlyFloat('form_','gross_salary');style.backgroundColor='white';UpdateToZero('gross_salary')">
      </strong></td>
    </tr>
    <tr>
      <td bgcolor="#FFFFFF">&nbsp;</td> 
      <td height="18" bgcolor="#FFFFFF">&nbsp;</td>
      <td height="18" bgcolor="#FFFFFF">Net Salary </td>
			<% 
			 if (vEditInfo != null && vEditInfo.size() > 0)
					strTemp = (String) vEditInfo.elementAt(9);
			 else
					strTemp = WI.fillTextValue("net_salary");
			%>			
      <td bgcolor="#FFFFFF"><strong>
        <input name="net_salary" type="text" size="10" maxlength="10"  class="textbox"
	  onFocus="style.backgroundColor='#D3EBFF'" value="<%=WI.getStrValue(strTemp,"0")%>"		
	  onKeyUp="AllowOnlyFloat('form_','net_salary');"	 
		onBlur="AllowOnlyFloat('form_','net_salary');style.backgroundColor='white';UpdateToZero('net_salary')">
      </strong></td>
    </tr>
  </table>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="100%" height="25" bgcolor="#FFFFFF"><div align="center"> 
          ...
          to save changes
					<%if (iAccessLevel == 2) {%>
						<a href="javascript:DeleteRecord()"><img src="../../../../images/delete.gif" border=0></a>click to delete </font> 
          <%}
					}%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="22" colspan="7" bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
    <tr> 

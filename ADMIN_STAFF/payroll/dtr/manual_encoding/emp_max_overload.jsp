...
<html>
<head>
<title>Manual Overload Hours encoding</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Overload Encoding","emp_max_overload.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(Overload.operateOnMaxEmpOverload(dbOP, request, Integer.parseInt(strPageAction)) == null){
			strErrMsg = Overload.getErrMsg();
		} else {
			if(strPageAction.equals("1"))
				strErrMsg = "Max overload successfully set";		
			if(strPageAction.equals("0")){
				strErrMsg = "Max overload successfully removed";		
			}			
		}
	}
	
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = Overload.operateOnMaxEmpOverload(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = Overload.getErrMsg();
		else
...
<form action="emp_max_overload.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: ENCODE MAX OVERLOAD HOURS PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="28" colspan="3"><font size="2" color="#FF0000"><strong><%=WI.getStrValue(strErrMsg)%></strong></font></td>
    </tr>
      ...
      <td width="78%"><select name="pt_ft" onChange="ReloadPage();">
        ...
        <%}%>
 		...
 		<tr>
 		  ...
 		  <td>Position</td>
			<%
				strTemp2 = WI.fillTextValue("emp_type_index");			
			%>
 		  <td>
...
View Employees w/out max overload hours </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="2">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td height="25" class="thinborder"><font size="1"><strong>&nbsp;&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+3), (String)vRetResult.elementAt(i+4),
			...
			<input type="hidden" name="max_index_<%=iCount%>" value="<%=(String)vRetResult.elementAt(i)%>">
      ...
      <td class="thinborder"><div align="center"><strong> 
        <input name="max_overload_<%=iCount%>" type="text" class="textbox" size="4" maxlength="6" 

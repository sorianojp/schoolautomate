...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./overtime_batch_print.jsp" />
	<% 
return;}
...
{	
	...
	if(bolIsSchool)
		...
		strTemp = "Division";	
	String[] astrSortByName  = {"Employee ID","Firstname","Lastname",strTemp,"Department", "OT Code"};
	String[] astrSortByVal   = {"id_number","user_table.fname","lname","c_name","d_name","pr_ot_encoding.ot_type_index" };
...
<form action="overtime_batch.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: OVERTIME PAGE ::::</strong></font></td>
    </tr>
</table>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="23" colspan="3"><font size="2" color="#FF0000"><strong><font size="1"><a href="./overtime_main.jsp"><img src="../../../../../images/go_back.gif" width="50" height="27" border="0"></a></font><%=WI.getStrValue(strErrMsg)%></strong></font></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>

...
<html>
<head>
<title>Alloances manual enroding</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Manual Allowance Encoding","allowances_manual.jsp");
...
<form action="allowances_manual.jsp" method="post" name="form_">
    ...
    <tr>
      ...
      <td colspan="3"><select name="cola_ecola_index">
        ...
        <%=dbOP.loadCombo("cola_ecola_index","allowance_name, sub_type", " from pr_cola_ecola " +
		  " where is_valid = 1 and is_del = 0 and is_cola = 0 order by allowance_name", strTemp,false)%>
      </select></td>
    </tr>
    <tr> 
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="43%" align="center" class="thinborder"><strong>DEPARTMENT/OFFICE</strong></td>
      <td width="7%" align="center" class="thinborder"><strong><font size="1">AMOUNT</font><font size="1"> <br>

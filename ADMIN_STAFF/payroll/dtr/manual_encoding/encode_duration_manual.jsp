...
<html>
<head>
<title>Manual work duration encoding</title>
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./encode_duration_manual_print.jsp" />
	<% 
return;}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Manual Encoding days/hours","encode_duration_manual.jsp");
...
//	String[] astrSortByVal1     = {"id_number","user_table.fname","lname","c_name","d_name", "entry_type"};
	if(strWithSched.equals("1"))
		astrSortByVal[5] = "entry_type";
	else
		astrSortByVal[5] = "salary_base";	
		
	String[] astrSalaryBase    = {"Monthly rate", "Daily rate", "Hourly rate"};
	String strPageAction = WI.fillTextValue("page_action");
	if(strPageAction.length() > 0){
		if(prEdtrME.operateOnManualEncodeWork(dbOP, request, Integer.parseInt(strPageAction)) == null){
	...
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prEdtrME.operateOnManualEncodeWork(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = prEdtrME.getErrMsg();
		else
...
<form action="encode_duration_manual.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: MANUAL ENCODING WORKED DURATION PAGE ::::</strong></font></td>
    </tr>
</table>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="9%" align="center" class="thinborder"><strong><font size="1">HOURS / DAYS WORKED <br>
    ...
    <tr>
      ...
      <td height="25" class="thinborder"><font size="1"><strong>&nbsp;&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),
			...
			<input type="hidden" name="sal_base_<%=iCount%>" value="<%=(String)vRetResult.elementAt(i+8)%>">
      ...
      <td class="thinborder">&nbsp; <%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"")%><%=strTemp%><%=WI.getStrValue((String)vRetResult.elementAt(i + 6),"")%> </td>
		  <td class="thinborder">&nbsp;<%=astrSalaryBase[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(i + 8),"0"))]%></td>
		  <%
			strTemp = "";
    ...
    <tr>
      ...
      <td height="25" colspan="7"> If the salary basis is hourly rate, saved value is in hours. <br>
If the salary basis is daily rate, saved value is in days.<br>
Monthly rate salary basis are ignored. <br>
Employees without any valid salary rate will not be included in the list. </td>
    </tr>
    <tr>

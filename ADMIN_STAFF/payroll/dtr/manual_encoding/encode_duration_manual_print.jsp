...
<html>
<head>
<title>Print manually encoded work hours</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Post Deductions","encode_duration_manual.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"encode_duration_manual_print.jsp");
...
<form name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		...
		%>
    <tr> 
      <td height="20" colspan="6" class="thinborder"><div align="center"><strong>LIST OF EMPLOYEES <%=strTemp%> MANUALLY ENCODED WORK FOR <%=strPayrollPeriod%> </strong> </div></td>
    </tr>
    <tr>
      ...
      <td width="29%" align="center" class="thinborder"><strong>DEPARTMENT/OFFICE</strong></td>
      <td width="12%" align="center" class="thinborder"><strong>Salary Basis </strong></td>
			<%if(WI.fillTextValue("with_schedule").equals("1")){%>
      <td width="9%" align="center" class="thinborder"><strong><font size="1">HOURS / DAYS WORKED</font></strong></td>
			<%}%>		
    </tr>
		<%

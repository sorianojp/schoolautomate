   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
		<%if(WI.fillTextValue("with_schedule").equals("1"))
				...
				strTemp = "WITHOUT";
		%>			
      <td height="20" colspan="6" align="center" class="thinborder"><strong>LIST OF EMPLOYEES <%=strTemp%> ENCODED SUBSTITUTIONS FOR <%=strPayrollPeriod%></strong></td>
    </tr>
    <tr>
      ...
      <td height="16" colspan="2" align="center" class="thinborder"><strong><font size="1">DURATION</font></strong></td>
    </tr>
    <tr>
      <td width="7%" height="15" align="center" class="thinborder"><strong><font size="1">Hours</font></strong></td>

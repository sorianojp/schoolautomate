...
function CopyHour(){
	...
	for (var i = 1 ; i < eval(vItems);++i)
		eval('document.form_.day_credit_'+i+'.value=document.form_.day_credit_1.value');			
}
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./commendation_print.jsp" />
	<% 
return;}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Encode Commendations","commendation.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prCommend.operateOnCommendation(dbOP, request, Integer.parseInt(strPageAction)) == null){
			strErrMsg = prCommend.getErrMsg();
		} else {
			if(strPageAction.equals("1"))
				strErrMsg = "Commendation successfully posted.";		
			if(strPageAction.equals("0")){
				strErrMsg = "Commendation successfully removed.";		
			}			
		}
	}
	...
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prCommend.operateOnCommendation(dbOP,request, 4);
		if(vRetResult == null)
			...
			iSearchResult = prCommend.getSearchCount();
	}	

%>
<body bgcolor="#D2AE72" class="bgDynamic">
<form action="commendation.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: ENCODE COMMENDATION PAGE ::::</strong></font></td>
    </tr>
</table>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="22%">Month and year </td>
      <td width="75%" colspan="3"> <select name="month_of" onChange="ReloadPage();">
...
View Employees without commendation</td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="4">
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td height="29"><select name="sort_by1">
        <option value="">N/A</option>
        <%=prCommend.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
      </select></td>

      <td height="29"><select name="sort_by2">
        <option value="">N/A</option>
        <%=prCommend.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%>
      </select></td>

      <td height="29"><select name="sort_by3">
        <option value="">N/A</option>
        <%=prCommend.constructSortByDropList(WI.fillTextValue("sort_by3"),astrSortByName,astrSortByVal)%>
      </select></td>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <%if(WI.fillTextValue("view_all").length() == 0){
			int iPageCount = iSearchResult/prCommend.defSearchSize;		
			if(iSearchResult % prCommend.defSearchSize > 0) ++iPageCount;
			if(iPageCount > 1){%>
    <tr>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="8%" align="center" class="thinborder"><strong><font size="1">Credit leave days <br>
    ...
    <tr>
      ...
      <td class="thinborder"><div align="center"><strong> 
        <input name="old_value_<%=iCount%>" type="hidden" value="<%=strTemp%>">
        <input name="day_credit_<%=iCount%>" type="text" class="textbox" size="4" maxlength="6" 
    ...
    <tr>
      <td height="25" colspan="6" align="center">
        ...
        click to save entries
          ...
          <a href='javascript:DeleteRecord();'></a>

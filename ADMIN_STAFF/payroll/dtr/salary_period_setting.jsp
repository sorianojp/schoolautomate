...
<html>
<head>
<title>Employee Salary Schedule</title>
...
<%@ page language="java" import="utility.*,java.util.Vector,payroll.ReportPayroll, payroll.ReportPayrollExtn" %>
<%
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Salary Schedule","salary_period_setting.jsp");
...
if(strPageAction.length() > 0){
	if(RptPayExtn.operateOnUserSalSchedule(dbOP, Integer.parseInt(strPageAction)) == null){
  ...
  if(WI.fillTextValue("searchEmployee").equals("1")){
	vRetResult = RptPayExtn.operateOnUserSalSchedule(dbOP, 4);
	  if(vRetResult == null)
			strErrMsg = RptPayExtn.getErrMsg();
	  else
...
<body  class="bgDynamic" onLoad="UpdatePeriod();">
<form name="form_" method="post" action="./salary_period_setting.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      <td height="25" colspan="5" align="center"><font color="#000000" ><strong>:::: 
      PAYROLL: SALARY SCHEDULE SETTING PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td height="25">&nbsp;</td>
      <td width="20%">Salary Period name </td>
	  <%
		  	strTemp = WI.fillTextValue("period_index");
	  %>
      <td><select name="period_index" onChange="UpdatePeriod();">   
      ...
      <font size="1">(for filtering. Ignored if searching employees without schedule)</font></td>
    </tr>
    <tr> 
      <td height="24">&nbsp;</td>
      <td>Position</td>
...
View Employees without schedule </td>
    </tr>
    <tr>
      <td height="11" colspan="3"><%
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">    
    <tr bgcolor="#B9B292" class="thinborder"> 
	  ...
	  if((WI.fillTextValue("with_schedule")).equals("1"))
	    strTemp = "EMPLOYEES WITH SALARY SCHEDULE ";
	  else
	    strTemp = "EMPLOYEES WITHOUT SALARY SCHEDULE ";
    ...
    <tr bgcolor="#ffff99" class="thinborder">
      ...
      <td width="44%" height="25" align="center" class="thinborder"><strong><strong>EMPLOYEE NAME </strong></strong></td>
      <td class="thinborder" width="22%" align="center"><strong><strong>OFFICE</strong></strong></td>
	  <%
	  if((WI.fillTextValue("with_schedule")).equals("1")){
	  %>
      <td class="thinborder" width="11%" align="center"><strong><strong>SALARY PERIOD NAME </strong></strong></td>
    <%}%>
	...
	<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="25%" height="25" bgcolor="#FFFFFF"><strong>New Salary Period name </strong></td>
      <td width="75%" height="25" bgcolor="#FFFFFF">
			<select name="new_period_index">
        <option value="">Select Period Name</option>
        <%=dbOP.loadCombo("PERIOD_INDEX","PERIOD_NAME", " from pr_preload_period order by period_name",strTemp,false)%>
      </select></td>
    </tr>

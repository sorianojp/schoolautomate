 ...
 <body bgcolor="#D2AE72" class="bgDynamic">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      ...
      LEAVE MONETIZATION MAIN PAGE::::</strong></font></td>
    </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./leave_monetization.jsp">Encode Leave Monetization</a></td>
  </tr>	
  <tr> 
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="../../reports/leave_monetization_report.jsp">View Leave Monetization Report</a></td>
  </tr>	
</table>

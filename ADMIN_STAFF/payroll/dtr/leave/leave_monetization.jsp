...
<html>
<head>
<title>Leave Monetization</title>
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prConversion.operateOnLeaveMonetization(dbOP, request, Integer.parseInt(strPageAction)) == null){
			strErrMsg = prConversion.getErrMsg();
		} else {
			if(strPageAction.equals("1")){
				strErrMsg = "Schedule successfully posted.";
				strErrMsg += "<br />" + WI.getStrValue(prConversion.getErrMsg(),"");		
			}			
		}
	}
	
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prConversion.operateOnLeaveMonetization(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = prConversion.getErrMsg();
		else
...
//for(int k = 0; k < 20; k++)
//System.out.println("K : " + k + " :"  +WI.getTodaysDate(k)); 
%>
<body bgcolor="#D2AE72" class="bgDynamic">
<form action="leave_monetization.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        LEAVE MONETIZATION PAGE ::::</strong></font></td>
    </tr>
</table>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="10%" align="center" class="thinborder"><strong><font size="1">LEAVE BALANCE</font></strong></td>
      <td width="14%" align="center" class="thinborder"><strong><font size="1">DAYS TO CONVERT</font></strong></td>
	  <td width="23%" align="center" class="thinborder"><strong><font size="1">REMARKS</font></strong></td>
    ...
    <tr>     	
      ...
      <td class="thinborder">			
		<div align="center"><strong>
		 ...
		 <input name="conv_days_<%=iCount%>" type="text" class="textbox" size="5" maxlength="6" 
	      onKeyPress="AllowOnlyFloat('form_','conv_days_<%=iCount%>');"
				value="<%=strTemp%>" style="text-align:right">		
	 ...
	 <td align="right" class="thinborder">
	 	<input type="text"  size="45" name="remarks_<%=iCount%>" value="<%=WI.getStrValue(WI.fillTextValue("remark_" + iCount),"")%>" />&nbsp;
	 </td>

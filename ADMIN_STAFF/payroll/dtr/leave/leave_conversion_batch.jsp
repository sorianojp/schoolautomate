...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prConversion.operateOnBatchLeaveConversion(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="19%">Year</td>
      <td width="78%"><select name="year_of" onChange="loadSalPeriods();">
...
View Employees w/out converted leave </td>
    ...
    <tr>
      <td height="10">&nbsp;</td>
			...
			%>
      <td height="10" colspan="2">
			<input name="percent_" type="text" size="6" value="<%=strTemp%>" 
	    onfocus="style.backgroundColor='#D3EBFF'" 
			onBlur="style.backgroundColor='white'; AllowOnlyFloat('form_','percent_');"
			class="textbox" maxlength="5" onKeyUp="AllowOnlyFloat('form_','percent_');"> 
      percentage of the leave to convert </td>
    </tr>		
  </table>
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="12%" align="center" class="thinborder"><strong><font size="1">AVAILABLE LEAVE</font></strong></td>
			...
			%>			
      <td width="12%" align="center" class="thinborder"><strong><font size="1"><%=strTemp%></font></strong></td>
    ...
    <tr>
      ...
      <td class="thinborder">			
        ...
        <input name="conv_days_<%=iCount%>" type="text" class="textbox" size="5" maxlength="6" 

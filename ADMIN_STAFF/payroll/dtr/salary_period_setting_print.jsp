...
<html>
<head>
<title>Employee Salary Schedule Printing</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Payroll Slip main","salary_period_setting.jsp");
...
<form name="form_" method="post" action="./salary_period_setting_print.jsp">
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr class="thinborder">
      ...
      <td width="14%" align="center" class="thinborder"><strong><strong>EMPLOYEE ID </strong></strong></td> 
      <td width="46%" height="25" align="center" class="thinborder"><strong><strong>EMPLOYEE NAME </strong></strong></td>
      <td class="thinborder" width="22%" align="center"><strong><strong>OFFICE</strong></strong></td>
	  <%
	  if((WI.fillTextValue("with_schedule")).equals("1")){
	  %>
      <td class="thinborder" width="13%" align="center"><strong><strong>SALARY PERIOD NAME </strong></strong></td>
      <%}%>
    </tr>

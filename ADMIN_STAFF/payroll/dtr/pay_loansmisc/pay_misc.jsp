...
<html>
<head>
<title>Pay Misc Deductions</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","pay_misc.jsp");
...
if (strAddMisc.equals("1")){
	...
	vRetResult = prd.getMiscWithPayable(dbOP, strEmpIndex, WI.fillTextValue("index"), WI.fillTextValue("index_name"));
%>
<body bgcolor="#D2AE72" onUnload="ReloadMain();" class="bgDynamic">
<form action="pay_misc.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: MISC. DEDUCTIONS : POST DEDUCTIONS PAGE ::::</strong></font></td>
    </tr>
</table>
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="26" colspan="5" align="center" bgcolor="#B9B292" class="thinborder">        <strong>LIST 
            OF POSTED MISCELLANEOUS DEDUCTIONS</strong>      </td>
    </tr>
    <tr> 
      <td width="38%" height="28" align="center" class="thinborder">        <strong><font size="1">DEDUCTION 
            NAME</font></strong>      </td>
      <td width="13%" align="center" class="thinborder">        <font size="1"><strong>AMOUNT</strong></font>      </td>
      <td width="17%" align="center" class="thinborder">        <font size="1"><strong>AMOUNT 
            PAYABLE</strong></font>      </td>
      <td width="18%" align="center" class="thinborder">        <font size="1"><strong>AMOUNT 
            TO PAY</strong></font>      </td>
    ...
    <tr> 
      ...
      <td align="right" class="thinborder"><font size="1"> <%=(String)vRetResult.elementAt(i+2)%>&nbsp;</font>      </td>
      <td align="right" class="thinborder"><font size="1"><%=(String)vRetResult.elementAt(i+3)%> 
      ...
      <td align="center" class="thinborder"><font size="1"><a href='javascript:AddMisc("<%=vRetResult.elementAt(i)%>");'><img src="../../../../images/add.gif" width="42" height="32" border="0"></a></font></td>
    </tr>
    <%} //end for loop%>

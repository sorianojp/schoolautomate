<%@ page language="java" import="utility.*,java.util.Vector,payroll.PRMiscDeduction,payroll.PRSalaryExtn" %>
<%
...
function AddIncentive(strIncentiveIndex){
	document.form_.donot_call_close_wnd.value = "1";
	document.form_.add_incentive.value = "1";
	document.form_.incentive_index.value = strIncentiveIndex;
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","edit_incentives.jsp");
...
String strAddIncentive = WI.fillTextValue("add_incentive");
String strIncentiveIndex = WI.fillTextValue("incentive_index");

if (strAddIncentive.equals("1")){
	if(SalaryExtn.operateOnLateIncentives(dbOP,request,strIncentiveIndex, 1) == false)
		strErrMsg = "Operation not successful";
}

vRetResult = SalaryExtn.getLateEncodedIncentives(dbOP,request,WI.fillTextValue("sal_index"));
if(vRetResult == null && strErrMsg == null)
	strErrMsg = SalaryExtn.getErrMsg();

%>
<body bgcolor="#D2AE72" onUnload="ReloadMain();" class="bgDynamic">
<form action="edit_incentives.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      PAYROLL: INCENTIVES PAGE ::::</strong></font></td>
    </tr>
</table>
...
%>
      <td height="29" colspan="2"><%if(bolIsSchool){%>College <%}else{%>Division <%}%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="26" colspan="3" align="center" bgcolor="#B9B292" class="thinborder"><strong>LIST 
      OF POSTED INCENTIVES EARNINGS</strong></td>
    </tr>
    <tr> 
      <td width="36%" height="28" align="center" class="thinborder"><strong><font size="1">EARNING 
        NAME</font></strong></td>
      <td width="17%" align="center" class="thinborder"><font size="1"><strong>AMOUNT</strong></font></td>
      <td width="14%" align="center" class="thinborder"><font size="1"><strong>OPTION</strong></font></td>
    </tr>
    <% int iRow = 0;
    ...
    <tr> 
      <td height="25" class="thinborder"><font size="1">&nbsp;<%=(String)vRetResult.elementAt(i+2)%></font></td>
		<input name="amount<%=iRow%>" type="hidden" value="<%=WI.getStrValue(strTemp,"0")%>">
      <td align="center" class="thinborder">      <font size="1"> <%=(String)vRetResult.elementAt(i+4)%>&nbsp;</font></td>
      <td align="center" class="thinborder"><font size="1"><a href='javascript:AddIncentive("<%=(String)vRetResult.elementAt(i)%>");'><img src="../../../images/add.gif" width="42" height="32" border="0"></a></font></td>
    </tr>
    <%} //end for loop%>
  </table>
...
<% } // end vRetResult != null && vRetResult.size() > 0
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td colspan="3" bgcolor="#A49A6A" class="footerDynamic">&nbsp;</td>
    </tr>
  </table>
<input type="hidden" name="add_incentive">
<input type="hidden" name="incentive_index">

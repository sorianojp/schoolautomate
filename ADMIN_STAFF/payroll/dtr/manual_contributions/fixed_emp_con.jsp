...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Fixed Contributions","fixed_emp_con.jsp");
...
//end of authenticaion code.
	...
	if(strPageAction.length() > 0) {
		if(prd.operateOnFixedContribution(dbOP, request, Integer.parseInt(strPageAction)) == null){	
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      ...
      PAYROLL : MANUAL ENTRY OF <%=astrType[Integer.parseInt(WI.fillTextValue("d_type"))]%> CONTRIBUTION ::::</strong></font></td>
    </tr>
	</table>
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="23" colspan="5">&nbsp;<a href="./manual_contribution_main.jsp"><img src="../../../../images/go_back.gif" width="50" height="27" border="0"></a><font size="2" color="#FF0000"><strong><%=WI.getStrValue(strErrMsg)%></strong></font></td>
    </tr>
	...
	<%if((vContributionTable != null && vContributionTable.size() > 1) && WI.fillTextValue("d_type").equals("0")){%>
    <tr>
      <td height="25" colspan="6"><div onClick="showBranch('ssstable');swapFolder('sssFolder')">
		...
		<%}%>
	<%if((vContributionTable != null && vContributionTable.size() > 1) && WI.fillTextValue("d_type").equals("2")){%>
    <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
  ...
  <tr>
    ...
    <td width="25%" align="center" class="thinborder"><strong><font size="1">DEPARTMENT/OFFICE</font></strong></td>
		<!--
			...
			d_type 4 = gsis
		-->		
    <td width="8%" align="center" valign="bottom" class="thinborder"><strong><font size="1">EMPLOYEE SHARE </font><font size="1"><br>
      <a href="javascript:CopyAll();">Copy all</a> </font></strong></td>
		<%if(!WI.fillTextValue("d_type").equals("3")){%>				
    <td width="8%" align="center" valign="bottom" class="thinborder"><strong><font size="1">EMPLOYER SHARE <br>
      <a href="javascript:CopyEmployerShare();">Copy all</a> </font></strong></td>
		<%if(!WI.fillTextValue("d_type").equals("1") && !WI.fillTextValue("d_type").equals("2")){%>
    <td width="11%" align="center" valign="bottom" class="thinborder"><strong><font size="1">EMPLOYEE COMPENSATION<br>
      <a href="javascript:CopyEC();">Copy all</a> </font></strong></td>
		<%}%>
		<%}%>
		<%if(WI.fillTextValue("d_type").equals("2")){%>
		<td width="8%" align="center" valign="bottom" class="thinborder"><strong><font size="1"><strong>SALARY BRACKET</strong><br>
  ...
  <tr>
    ...
    <%
		...
		%>		
    <td align="center" class="thinborder"><strong>
      <input name="employer_share_<%=iCount%>" type="text" class="textbox" size="6" maxlength="10" 
	      onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;"
				value="<%=strTemp%>" style="text-align:right" >
    </strong></td>
		<%if(!WI.fillTextValue("d_type").equals("1") && !WI.fillTextValue("d_type").equals("2")){%>
    <%
		...
		%>		
    <td align="center" class="thinborder"><strong>
      <input name="ec_<%=iCount%>" type="text" class="textbox" size="6" maxlength="8" 
	      onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;"
				value="<%=strTemp%>" style="text-align:right" >
    </strong></td>
		<%}
...
<%}%>	
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr>
	...
	<input type="hidden" name="d_type" value="<%=WI.fillTextValue("d_type")%>">			

...
<html>
<head>
<title>Contribution Adjustments</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-DTR-Manual Encoding Absences","adjust_contribution.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	PRManContribution prManual = new PRManContribution ();
	int iSearchResult = 0;
	int i = 0;
	String[] astrConType = {"GSIS", "Pag-Ibig/HDMF","PERAA","Philhealth", "SSS"};
	...
	if(strPageAction.length() > 0){
		if(prManual.operateOnContributionAdjustments(dbOP, request, Integer.parseInt(strPageAction)) == null)
			strErrMsg = prManual.getErrMsg();
		else
			strErrMsg = "Operation success!";				
	}
	
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prManual.operateOnContributionAdjustments(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = prManual.getErrMsg();
		else
			iSearchResult = prManual.getSearchCount();
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor="#A49A6A"> 
		...
		<font color="#FFFFFF"><strong>:::: PAYROLL: ADJUST CONTRIBUTION PAGE ::::</strong></font>		</td>
	</tr>
</table>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td>Contribution</td>
			...
			%>
      <td colspan="3">
			<select name="d_type" onChange="ReloadPage();">
				<%for(i = 0; i < astrConType.length; i++){
					if(Integer.toString(i).equals(strTemp)){%>
    ...
    <tr> 
      ...
      <td width="19%">Month/ Year </td>
      <td width="78%" colspan="3"> <select name="month_of" onChange="loadSalPeriods();">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="13%" align="center" class="thinborder"><strong><font size="1">ADJUSTMENT</font><font size="1"> <br>
    ...
    <tr>
      ...
      <td class="thinborder"><div align="center"><strong> 
        ...
        <input name="amount_<%=iCount%>" type="text" class="textbox" size="8" maxlength="8" 

<%@ page language="java" import="utility.*,payroll.PReDTRME, payroll.PRSalaryRate, payroll.PRSalary,
	...
	payroll.PRSalaryExtn,	payroll.PRConfidential, payroll.PRFaculty, java.util.Vector, java.util.Date" buffer="24kb"%>
<%
...
//	vUserDetail = FM.viewFacBasicWithLoadStat(dbOP, strEmployeeIndex, strSYFr, strSYTo, strCurSem);  
	if(new payroll.PRBuiltInCI().checkIfEmployeeIsCI(dbOP, strEmployeeIndex)){
		...
		if (vDTRDetails == null){
			...
			//System.out.println("vDTRDetails.elementAt(39) " + vDTRDetails.elementAt(39));
			//System.out.println("vDTRDetails.elementAt(3) " + vDTRDetails.elementAt(3));
			//System.out.println("vDTRDetails.elementAt(5) " + vDTRDetails.elementAt(5));

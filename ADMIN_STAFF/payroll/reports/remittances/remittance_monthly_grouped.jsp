...
function PrintPg() {	
	...
	document.getElementById("table_header").style.display = "table"; //header
	document.getElementById("print_tr").style.display = "none";	
...
<%
	...
	String strRemittanceType = WI.fillTextValue("remittance_type");
	strRemittanceType = WI.fillTextValue("remittance_type");
				if(strRemittanceType.length() == 0)
					strRemittanceType = "0";	
	String []arrStrRemittanceType = {"SSS" , "PhilHealth", "Pag-ibig", "PERAA"};					
	String strTemp = null;
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
										"Admin/staff-Payroll-Reports-Remittances-SSS Premium","remittance_monthly_grouped.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"remittance_monthly_grouped.jsp");
...
<form name="form_" method="post" action="./remittance_monthly_grouped.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="table1">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: <%=(arrStrRemittanceType[Integer.parseInt(strRemittanceType)]).toUpperCase()%> PREMIUM MONTHLY REMITTANCES PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" id="table2">
	...
	<tr>
		...
		<td>					
			<select name="remittance_type" onChange="ReloadPage();">
				<option value="0" <%=strRemittanceType.equals("0")?"selected":"" %> >SSS Premium</option>
				<option value="1" <%=strRemittanceType.equals("1")?"selected":"" %> >PhilHealth Premium</option>
				<option value="2" <%=strRemittanceType.equals("2")?"selected":"" %> >Pag-ibig Premium</option>
				<option value="3" <%=strRemittanceType.equals("3")?"selected":"" %> >PERAA Premium</option>
			</select>
		</td>
	</tr>
...
show adjusted contribution </td>
  ...
  <tr>
  	<td colspan="<%=strRemittanceType.equals("0")?"6":"5"%>">
			...
			<tr>
				...
				<td width="50%"  align="center">
					<div style=" width:500px">
					  <div style="position: relative; width: 70px;  height: 70px; right: 210px;"> <img src="../../../../images/logo/<%=strSchCode%>.gif" width="100%" height="100%" style="text-align:left"> </div>
  ...
  <tr>
    <td colspan="<%=strRemittanceType.equals("0")?"6":"5"%>"><div align="center"><strong><%=(arrStrRemittanceType[Integer.parseInt(strRemittanceType)]).toUpperCase()%> PREMIUM REMITTANCE <BR/>
  ...
  <tr>
    ...
    <td width="14%">&nbsp;</td>
    <td width="14%">&nbsp;</td>
	<%if(strRemittanceType.equals("0")){ //sss only has ec%>
    <td width="12%">&nbsp;</td>
	<%}%>
    <td width="14%">&nbsp;</td>
  </tr>  
   ...
   <tr>
  	<td class="thinborderTOPLEFT">&nbsp;</td>
	<td align="center" class="thinborderTOPRIGHT"><strong>NAME OF MEMBER</strong></td>
	<td align="center" colspan="<%=strRemittanceType.equals("0")?"4":"3"%>" class="thinborderTOPRIGHT">
	<strong><%=(arrStrRemittanceType[Integer.parseInt(strRemittanceType)]).toUpperCase()%> PREMIUM</strong></td>
  </tr>
  
  <tr>
  	<td align="center" class="thinborderBOTTOMLEFT"><strong>Department</strong></td>
	<td align="center" class="thinborderTOPBOTTOMRIGHT"><strong>Surname, Given Name</strong></td>
	<td align="center" class="thinborderTOPBOTTOMRIGHT"><strong>EMPLOYEE</strong></td>
	<td align="center" class="thinborderTOPBOTTOMRIGHT"><strong>EMPLOYER</strong></td>
	<%if(strRemittanceType.equals("0")){ //sss only has ec%>
	<td align="center" class="thinborderTOPBOTTOMRIGHT"><strong>EC</strong></td>
	<%}%>
	<td align="center" class="thinborderTOPBOTTOMRIGHT"><strong>TOTAL</strong></td>
  </tr>   
  ...
  <tr>
    <td align="center" class="thinborderRIGHT" height="15"><strong><%=WI.getStrValue((String)vRetResult.elementAt(i+7),"","",(String)vRetResult.elementAt(i+8))%></strong></td>
    <td class="thinborderRIGHT"><font size="1">&nbsp;<%=WI.formatName(((String)vRetResult.elementAt(i+4)).toUpperCase(), (String)vRetResult.elementAt(i+5),
  ...
  <tr>
    ...
    <td class="thinborderTOPRIGHT"><div align="left"><strong>Sub-total </strong></div></td>
    <td class="thinborderTOPRIGHT"><div align="right"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dEEStatusTotal,true),"")%></strong>&nbsp;</div></td>
    <td class="thinborderTOPRIGHT"><div align="right"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dERStatusTotal,true),"")%></strong>&nbsp;</div></td>
	<%if(strRemittanceType.equals("0")){ //sss only has ec%>
    <td class="thinborderTOPRIGHT"><div align="right"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dECStatusTotal,true),"")%></strong>&nbsp;</div></td>
	<%}%>
    <td class="thinborderTOPRIGHT"><div align="right"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dStatusTotal,true),"")%></strong>&nbsp;</div></td>
  </tr>
  
   <%if(i < vRetResult.size()){
  	strTemp = "thinborderRIGHT";
  }else{//end of if i < vRetResult.size() 
  	strTemp = "thinborderTOP";
  }
  %>
    <tr>
      <td class="<%=strTemp%>">&nbsp;</td>

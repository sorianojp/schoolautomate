...
<html>
<head>
<title>PERAA Loan Remmitance Report</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
										"Admin/staff-Payroll-Reports-Remittances-SSS Premium","peraa_loans_remittance_wup.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"peraa_loans_remittance_wup.jsp");
...
<form name="form_" method="post" action="./peraa_loans_remittance_wup.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="table1">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: PERAA LOAN REMITTANCE LIST ::::</strong></font></td>
    </tr>
</table>
...
show adjusted contribution </td>
  ...
  <tr>
    <td colspan="<%=strRemittanceType.equals("0")?"6":"5"%>"><div align="center"><strong>PERAA LOAN Remittance List <BR/>
  ...
  <tr>
   ...
   <tr>
  	<td class="thinborderTOPLEFTBOTTOM" rowspan="2" align="center"><strong>Department</strong></td>
	<td align="center" class="thinborderTOPRIGHT" height="30"><strong>NAME OF MEMBER</strong></td>
	<td width="23%" rowspan="2"="33%" align="center" class="thinborderTOPBOTTOMRIGHT"><strong>TOTAL</strong></td>	
  </tr>
  ...
  for(; i < vRetResult.size();){
	...
	if(i+14 < vRetResult.size()){
		...
		strNextColl = WI.getStrValue((String)vRetResult.elementAt(i+20),"0");		
		strNextDept = WI.getStrValue((String)vRetResult.elementAt(i+21),"0");		
  ...
  <tr>
    <td align="center" class="thinborderRIGHT" height="20"><%=WI.getStrValue((String)vRetResult.elementAt(i+7),"","",(String)vRetResult.elementAt(i+8))%></td>
  ...
  <%
	if(bolShowHeader || i >= vRetResult.size()){
  		bolShowHeader = false;
  %> 
  <tr>
  ...
  <tr>
    ...
    <td><div align="right"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dGrandTotal,true),"")%></strong>&nbsp;</div></td>
  </tr>
</table>
<%} // if (vRetResult != null && vRetResult.size() > 0 )%>

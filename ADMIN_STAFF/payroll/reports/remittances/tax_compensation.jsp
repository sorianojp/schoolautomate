...
<form name="form_" method="post" action="./tax_compensation.jsp">
<%
...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./tax_compensation_print.jsp" />
<% return;}

try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Reports-Remittances-Tax Compensation","tax_compensation.jsp");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL : WITHHOLDING TAX PAGE ::::</strong></font></td>
    </tr>
</table>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td height="19" align="center" class="thinborderBOTTOMLEFT">EMPLOYEE NAME </td>
    <td align="center" class="thinborderBOTTOMLEFT">15</td>
    <td align="center" class="thinborderBOTTOMLEFT">31</td>
		<%if(WI.fillTextValue("show_total").equals("1")){%>
	...
	<%  //System.out.println(vRetResult);
	  ...
	  <% 
		if(i < vRetResult.size()){
 	    if(i > 2 && !((String)vRetResult.elementAt(i)).equals((String)vRetResult.elementAt(i-8)))
	  	  bolNextEmp = true;
	  ...
	  <td align="right" class="thinborderBOTTOMLEFT"><%=CommonUtil.formatFloat(strTemp,true)%>&nbsp;</td>	  
		<%if(WI.fillTextValue("show_total").equals("1")){%>
	  <td align="right" class="thinborderBOTTOMLEFT"><%=CommonUtil.formatFloat(dTemp,true)%>&nbsp;</td>
		<%}%>
	  <%
	  	 break;
	  }// inner for loop%>	  

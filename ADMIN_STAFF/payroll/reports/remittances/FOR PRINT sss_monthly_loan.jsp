...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Payroll Slip main","sss_monthly_loan.jsp");
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      <td height="25" colspan="5"><div align="center"><font color="#000000" ><strong>:::: 
          PAYROLL: SSS PREMIUM MONTHLY REMITTANCES PAGE ::::</strong></font></div></td>
    </tr>
</table>
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="3"><div align="center"><strong>SSS LOANS<br><%=astrMonth[Integer.parseInt(WI.fillTextValue("month_of"))]%> <%=WI.fillTextValue("year_of")%></strong></div></td>
  </tr>
  <tr>
  ...
  <%for(; i < vRetResult.size();){
	...
	if(i+12 < vRetResult.size()){
		...
		if(!((String)vRetResult.elementAt(i+9)).equals((String)vRetResult.elementAt(i+20))){
			bolPtFtTotal = true;
		}
	}
  %>
  ...
  <tr>
    ...
    <%	dTemp = 0d;
		...
		dGrandTotal += dTemp;
	%>	  
    <td><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dTemp,true),"")%>&nbsp;</div></td>
  </tr>
  <% 
  i = i + 11;  	
  	if(bolPtFtTotal)
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="right"><strong>TOTAL <%=astrPtFt[Integer.parseInt((String)vRetResult.elementAt(i-2))]%></strong></div></td>
    <td class="thinborderTOP"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dStatusTotal,true),"")%>&nbsp;</div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>

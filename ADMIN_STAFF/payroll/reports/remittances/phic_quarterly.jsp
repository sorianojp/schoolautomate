...
<html>
<head>
<title>Philhealth Quarterly Report</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Reports-Remittances-Philhealth Quarterly","phic_quarterly.jsp");
...
<form name="form_" method="post" action="./phic_quarterly.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      PAYROLL: PHILHEALTH PREMIUM QUARTERLY REMITTANCES PAGE ::::</strong></font></td>
    </tr>
</table>
...
%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="20%">Designation :</td>
			...
			%>			
      <td width="78%"><input type="text" name="designation" class="textbox" value="<%=strTemp%>" size="32"
				 onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
    <tr> 
      <td height="18" colspan="3"><div align="right"><font size="2"> Number of Employees Per 
          Page : 
  ...
  <tr>
    ...
    <td width="10%" class="thinborderBOTTOMLEFT">&nbsp;GIVEN NAME </td>
    <td width="10%" class="thinborderBOTTOMLEFT">&nbsp;<%=(strSchCode.startsWith("WUP")?"MIDDLE NAME" : "MI")%></td>

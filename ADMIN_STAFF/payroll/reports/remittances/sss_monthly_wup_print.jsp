...
<html>
<head>
<title>SSS Monthly Remmitance</title>
...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="sss_monthly_wup_print.jsp" />
<% return;}
...
if(WI.fillTextValue("searchEmployee").equals("1")){
  vRetResult = PRRemit.SSSMonthlyPremium(dbOP,false,false);
	if(vRetResult == null){
...
<form name="form_" method="post" action="./sss_monthly_wup.jsp">
...
show adjusted contribution </td>
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="6"><div align="center"><strong>SSS PREMIUM REMITTANCE <BR/>
  ...
  <tr>
   ...
   <tr>
	...
	<td align="center" colspan="4" class="thinborderTOPRIGHT"><strong>SSS PREMIUM</strong></td>
  </tr>
  
  <tr>
  	<td align="center" class="thinborderBOTTOMLEFT"><strong>Department</strong></td>
	<td align="center" class="thinborderALL"><strong>Surname, Given Name</strong></td>
  ...
  <tr>
    <td align="center" class="thinborderRIGHT"><strong><%=WI.getStrValue((String)vRetResult.elementAt(i+7),"","",(String)vRetResult.elementAt(i+8))%></strong></td>
  ...
  <tr>
    ...
    <td class="thinborderTOPBOTTOMRIGHT"><div align="left"><strong>Sub-total </strong></div></td>
    <td class="thinborderTOPBOTTOMRIGHT"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dEEStatusTotal,true),"")%>&nbsp;</div></td>
    <td class="thinborderTOPBOTTOMRIGHT"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dERStatusTotal,true),"")%>&nbsp;</div></td>
    <td class="thinborderTOPBOTTOMRIGHT"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dECStatusTotal,true),"")%>&nbsp;</div></td>
    <td class="thinborderTOPBOTTOMRIGHT"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dStatusTotal,true),"")%>&nbsp;</div></td>
  </tr>
  <%if(i < vRetResult.size()){%>
  <tr>

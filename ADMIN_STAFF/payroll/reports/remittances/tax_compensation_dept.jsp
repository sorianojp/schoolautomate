...
<form name="form_" method="post" action="./tax_compensation_dept.jsp">
<%
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Reports-Remittances-Tax Compensation","tax_compensation_dept.jsp");
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="14%" align="right" >30th&nbsp;&nbsp;&nbsp;</td>

...
//end of authenticaion code.
	...
	String[] astrWorkType = {"","BUILT IN CI","SCHOOL PHYSICIAN"};
...
%>
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	%>
    <% 
	  	if(i > 1 && (!((String)vRetResult.elementAt(i+6)).equals((String)vRetResult.elementAt(i-3))
				  || !((String)vRetResult.elementAt(i+7)).equals((String)vRetResult.elementAt(i-2))
					|| !((String)vRetResult.elementAt(i+8)).equals((String)vRetResult.elementAt(i-1)) ) ){
			bolShowHeader = true;
		}
	  %>
    <%
	...
	%>
    <tr> 
      <td colspan="4"><strong><u><%=astrWorkType[Integer.parseInt((String)vRetResult.elementAt(i+8))]%>
			<%=astrPtFt[Integer.parseInt((String)vRetResult.elementAt(i+6))]%>
			<%=astrCategory[Integer.parseInt((String)vRetResult.elementAt(i+7))]%></u></strong></td>
    </tr>
    <%}%>
    <tr> 
    ...
    <% 
	  	if((i + 9 < vRetResult.size() && (!((String)vRetResult.elementAt(i+6)).equals((String)vRetResult.elementAt(i+15))
				  || !((String)vRetResult.elementAt(i+7)).equals((String)vRetResult.elementAt(i+16)) 
					|| !((String)vRetResult.elementAt(i+8)).equals((String)vRetResult.elementAt(i+17)) )) 
		    || i + 10 > vRetResult.size())
				  {
    ...
    <tr> 
      <td  class="thinborder"><strong>NO OF RECORDS : <%=iIncr-1%></strong></td>
      <td  class="thinborder">&nbsp;</td>
    ...
    <tr> 
      <td colspan="4"  class="thinborder"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <td>IRIS CHUA SO, RN, MAN</td>
            <td>TAN KING KING, MD </td>
          </tr>
          <tr> 
            <td>&nbsp;</td>

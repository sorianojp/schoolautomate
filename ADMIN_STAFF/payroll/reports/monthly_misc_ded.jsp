...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./monthly_misc_ded_print.jsp" />
<% return;}

try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Monthly Misc. Deductions","monthly_misc_ded.jsp");
...
//end of authenticaion code.
	...
	if(WI.fillTextValue("searchEmployee").equals("1")){
		vRetResult = RptPay.gePeriodMiscDeduction(dbOP);
		if(vRetResult == null){
...
<form name="form_" method="post" action="./monthly_misc_ded.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr  bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      PAYROLL : MONTHLY SUMMARY MISCELLANEOUS DEDUCTIONS PAGE ::::</strong></font></td>
    </tr>
</table>
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
    ...
    <tr>
      ...
      <td>
		...
		<%}%>
		<%
		if(strSchCode.startsWith("TSUNE")){
		%>
    <tr>
      <td height="25">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("show_staggered");
				if(strTemp.equals("1"))
					strTemp = "checked";
				else
					strTemp = "";
			%>
      <td colspan="4">&nbsp;<input type="checkbox" name="show_staggered" value="1" onClick="SearchEmployee();" <%=strTemp%>>
        show only deductions with staggered payments(with max deduction) </td>
    </tr>
  ...
  <tr>
		...
		%>
    <td colspan="5"><div align="center"><strong><%=(WI.getStrValue(strDedName,"")).toUpperCase()%> DEDUCTIONS<br>

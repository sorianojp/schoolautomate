...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      <td height="24" align="center"><strong><font> ALLOWANCES PER EMPLOYEE <br /></font></strong><font size="1"> PAYROLL - <%=WI.getStrValue(strPayrollPeriod,"")%></font></td>
    </tr>
  </table>
  
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  	<tr> <td colspan="5" class="BOTTOM"  align="right" height="30">Date and time printed : <%=WI.getTodaysDateTime()%></td> 
  	</tr>
    <tr>      
    ...
    <tr>
	 ...
	 <%if( ((i+8) < vRetResult.size() && !strCurrentId.equals(WI.getStrValue((String)vRetResult.elementAt(i+8),""))) || (i+8) >= vRetResult.size() ){ %>
	 <tr>
	 	<td colspan="4">&nbsp;</td>
		<td align="right" class="NoBorder" height="25"><strong> Total : &nbsp; &nbsp;<u><%=CommonUtil.formatFloat(dEmpTotal,true)%></u></strong>&nbsp;&nbsp;&nbsp;</td>
	 </tr>
		 <%if(!( iCount >= iMaxRecPerPage) && (i+8) < vRetResult.size() ){%>
		 <tr>
	...
	%>
		<tr>
	 	<td colspan="4">&nbsp;</td>
		<td align="right" style="border-bottom:double #000000 3px" height="25"><strong>Grand Total : &nbsp; &nbsp;<%=CommonUtil.formatFloat(dGrandTotal,true)%></strong>&nbsp;</td>
	 </tr>
	<%

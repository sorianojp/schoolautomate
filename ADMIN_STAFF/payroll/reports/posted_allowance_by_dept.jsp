...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./posted_allowance_by_dept_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","posted_allowance_by_dept.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="posted_allowance_by_dept.jsp">
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" colspan="23"> <%
		int iPageCount = iSearchResult/prAllowances.defSearchSize;
		if(iSearchResult % prAllowances.defSearchSize > 0) ++iPageCount;		
		if(iPageCount > 1)
  ...
  <table  bgcolor="#FFFFFF" width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>      
     <td width="11%" height="33" align="center" class="headerBOTTOMLEFT"><strong>EMP. ID # </strong></td>
	 <td width="22%" height="33"  align="center" class="headerBOTTOMLEFT"><strong>EMPLOYEE NAME</strong></td> 
	 <td width="12%" height="33"  align="center" class="headerBOTTOMLEFT"><strong>DATE</strong></td>  
	 <td width="16%" height="33" align="center" class="headerBOTTOMLEFT"><strong>INCOME CODE </strong></td>	
	 <td width="14%" height="33" align="center" class="headerBOTTOMLEFT"><strong>MONTHLY AMOUNT </strong></td>	
	 <td width="13%" height="33" align="center" class="headerBOTTOMLEFT"><strong>DEDUCTIONS </strong></td>
	 <td width="12%" height="33" align="center" class="headerBOTTOMLEFT" ><strong>AMOUNT</strong></td>	  
      ...
      for(i = 0; i < vRetResult.size(); i += 14){
			...
			<tr>
			  ...
			  <td height="30" colspan="54" valign="bottom" class='BOTTOM' >
			  	<strong><%=(WI.getStrValue((String)vRetResult.elementAt(i+9),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> 
				</td>
			</tr>
			<%}	
    ...
    <tr>
	  ...
	  <%		
			dTemp = Double.parseDouble(WI.getStrValue(vNetPay.elementAt(4)+"","0"));
			dNetPayTotal += dTemp;
		%>
	 ...
	 <tr>
	 	<td colspan="6">&nbsp;</td>
		<td align="right" class="NoBorder" height="25"><strong><u><%=CommonUtil.formatFloat(dEmpTotal,true)%></u></strong>&nbsp;&nbsp;</td>

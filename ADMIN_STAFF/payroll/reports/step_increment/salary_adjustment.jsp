...
function CopyPositionName(){
  if(document.form_.emp_type.value)
		document.form_.position_name.value = document.form_.emp_type[document.form_.emp_type.selectedIndex].text;
  else
  	document.form_.position_name.value = "";
}
</script>
<%
	...
	if(WI.fillTextValue("print_page").length() > 0){%>
		<jsp:forward page="./step_inc_details_print.jsp" />
	<%return;}	
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-SALARY RATE-SALARY RATE","step_inc_details.jsp");
...
%>
<body bgcolor="#D2AE72" class="bgDynamic" onLoad="CopyPositionName();">
<form action="./step_inc_details.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>::::
      NOTICE OF STEP INCREMENT ::::</strong></font></td>
    </tr>
  </table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td>Position </td>
		...
		%> 			
      <td><select name="emp_type" onChange="CopyPositionName();">
	...
	onBlur="style.backgroundColor='white';ComputeRates();"></td>
    </tr>
    <tr>
      <td height="22">&nbsp;</td>
    ...
    <tr>
     ...
     <tr>
      <td height="28">&nbsp;</td>
      <td height="28">&nbsp;</td>
      <td width="75%" height="28" valign="bottom"><font size="1"><a href="javascript:PrintPg()"><img src="../../../../images/print.gif" border="0"></a> <font size="1">click to print</font> </font></td>
    </tr>
     <tr>
      <td height="25">&nbsp;</td>
      <td height="25">&nbsp;</td>

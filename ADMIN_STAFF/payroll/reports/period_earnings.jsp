...
boolean bolIsMonthly = false;
if(WI.fillTextValue("_month_range").length() > 0)
	bolIsMonthly = true;
%>
...
<%if(bolIsMonthly) {%>
    <tr>
      <td height="18">&nbsp;</td>
      <td>Year</td>
      <td colspan="3"><select name="year_of">
	 ...
	 <select name="month_to">
	  ...
	  &nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox" name="_month_range" value="1" onClick="ReloadPage();" checked="checked"> View Monly Range
	  </td>
    </tr>
<%}else{%>
    <tr> 
      ...
      <td colspan="3" style="font-size:11px;"> <select name="month_of" onChange="loadSalPeriods();">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="checkbox" name="_month_range" value="1" onClick="ReloadPage();"> View Monly Range
  ...
  <tr>
		<%
			if(WI.fillTextValue("sal_period_index").length() > 0)
				...
				if(WI.fillTextValue("month_fr").length() > 0) {
					if(WI.fillTextValue("month_to").length() > 0)
						strTemp = astrMonth[Integer.parseInt(WI.fillTextValue("month_fr"))] +" - "+astrMonth[Integer.parseInt(WI.fillTextValue("month_to"))]+" "+ WI.fillTextValue("year_of");
					else
						strTemp = astrMonth[Integer.parseInt(WI.fillTextValue("month_fr"))] +" "+ WI.fillTextValue("year_of");
				}
				else

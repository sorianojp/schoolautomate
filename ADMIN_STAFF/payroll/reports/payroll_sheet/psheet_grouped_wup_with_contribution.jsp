...
hide contribution column without value </td>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="18" colspan="28" align="center" ><strong><font color="#0000FF"> <%=WI.fillTextValue("report_title")%> FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>
    </tr>
    <tr>     
      <td width="14%" height="33"  align="center" class="thinborderBOTTOM">NAME 
        OF EMPLOYEE </td>
      <td width="8%" align="center" class="thinborderBOTTOM">Late/UT / Absence</td>               
      <td width="9%"  align="center" class="thinborderBOTTOM">TOTAL GROSS PAY</td>
      <td width="5%"  align="center" class="thinborderBOTTOM">TAX</td>
      <%if(astrContributions[0].equals("1")){%>
   	  <td width="6%"  align="center" class="thinborderBOTTOM">SSS</td>
      <%} if(astrContributions[1].equals("1")){%>
   	  <td width="5%"  align="center" class="thinborderBOTTOM">PHIC</td>
      <%}if(astrContributions[2].equals("1")){%>
   	  <td width="5%"  align="center" class="thinborderBOTTOM">HDMF</td>
      <%}if(astrContributions[4].equals("1") && bolIsSchool){%>
   	  <td width="6%"  align="center" class="thinborderBOTTOM">PERAA</td>
      <%}%>
			<%		 
			//grouped ded
			...
			%>
      			<td width="7%"  align="center" class="thinborderBOTTOM"><%=strTemp%></td>
      		<%}//end of for loop%>			
      <td width="23%"  align="center" class="thinborderBOTTOM">OTHER DED.</td>
      <td width="12%"  align="center" class="thinborderBOTTOM">NET PAY</td>
    </tr>   
    ...
    <tr>
      <%
			...
			%>
      <td height="26" colspan="40" valign="bottom" <%=strBorder%>><strong>&nbsp;<%=(WI.getStrValue((String)vRows.elementAt(i+62),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> </td>
    </tr>
    <%}%>
    ...
    <tr bgcolor="<%=strBgColor%>">
      ...
      <%
			...
			if(dOtherDed == 0d)
				strTemp = "";
	  %>
      <td width="23%" align="right" valign="bottom" <%=strBorder%>><%=strTemp%>&nbsp;</td><!-- oehter ded -->
      <%				
				if(bolShowBorder)
					strBorder =  "class='thinborderBottomLeftRight'";
				else
			...
			%>			
      <td width="12%" align="right" valign="bottom" <%=strBorder%>><%=CommonUtil.formatFloat(strTemp,true)%></td><!-- net here -->
    </tr>
    <% 
     i = i + iFieldCount;  	
	 if(i < vRows.size()){

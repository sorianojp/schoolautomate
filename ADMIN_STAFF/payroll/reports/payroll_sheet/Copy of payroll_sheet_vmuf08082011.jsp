...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Payroll Sheet(VMUF)","payroll_sheet_vmuf.jsp");
...
&nbsp;&nbsp;&nbsp;Number of Employees / rows Per 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="TOPRIGHT">
    <tr> 
      <td height="24" colspan="<%= iEarnColCount + (iDedColCount/2) + iEarnDedCount + 20%>" align="center" class="BOTTOMLEFT"><strong>PAYROLL 
      SHEET FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></strong></td>			
			<!--
      <td height="24" colspan="24" align="center" class="BOTTOMLEFT"><strong><font color="#0000FF">PAYROLL 
      SHEET FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>			
			-->
    </tr>
    <tr> 
			<td colspan="<%=iEarnColCount + iEarnDedCount + 14%>" class="headerBOTTOMLEFT">&nbsp; </td>
			<td colspan="<%=(iDedColCount/2) + 5%>" align="center" class="BOTTOMLEFT"><strong>D E D U C T I O N S </strong></td>
			<!--
			<td colspan="14" class="headerBOTTOMLEFT">&nbsp; </td>
    ...
    <tr> 
      ...
      <td colspan="7" align="center" class="BOTTOMLEFT"><strong><font size="1">PART TIME / 
        EXTRA LOAD</font></strong></td>
			...
			<td colspan="<%=(iEarnColCount + iEarnDedCount + 5)%>" class="BOTTOMLEFT">&nbsp;</td>
			<td colspan="<%=((iDedColCount/2) + 5)%>" class="BOTTOMLEFT">&nbsp;</td>
			<!--
			<td colspan="5" class="BOTTOMLEFT">&nbsp;</td>
    ...
    <tr> 
      ...
      <td width="3%" align="center" class="headerBOTTOMLEFT">OTHERS</td>
			<td width="3%" align="center" class="headerBOTTOMLEFT">ADJUST</td>
    ...
    <%
      ...
      <%
		...
		dTotalAdjust += dTemp;
	  %>	  
	 <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(CommonUtil.formatFloat(dTemp,true),"&nbsp;")%></td>
			<%for(iCols = 1;iCols <= iEarnDedCount; iCols ++){
...
//		System.out.println("Tax " +dTemp);
    ...
    <tr> 
      ...
      <td class="BOTTOMLEFT"><div align="right"><font size="1"><%=CommonUtil.formatFloat(dOtherTotal,true)%></font></div></td>
  		<td align="right" class="BOTTOMLEFT"><font size="1"><%=CommonUtil.formatFloat(dTotalAdjust,true)%></font></td>
  		<%for(iCols = 1;iCols <= iEarnDedCount; iCols++){%> 

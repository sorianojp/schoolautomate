...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./payroll_register_cl_wup_one_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","payroll_register_cl_wup_one.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"payroll_register_cl_wup_one.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="payroll_register_cl_wup_one.jsp">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="19" colspan="54" class="BOTTOM">part 1 </td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>      
      <td width="6%" height="33" rowspan="2" align="center" class="headerBOTTOMLEFT">NAME 
          OF EMPLOYEE </td>
	 <!-- <td width="13%" rowspan="2" align="center" class="headerBOTTOMLEFT">DEPARTMENT/COLLEGE </td>				-->
    ...
    <tr>
     ...
     <!-- <td height="18" class="BOTTOMLEFT">&nbsp;<%=WI.getStrValue((String)vRows.elementAt(i + 62),"")%><%=strTemp%><%=WI.getStrValue((String)vRows.elementAt(i + 63),"")%></td>						-->
	  ...
	  %>			
			<!--hide because assume all ded have group.ingon si gretchen jose. 01242013.. need to unhide again. they simply changed their mind sul03132013-->

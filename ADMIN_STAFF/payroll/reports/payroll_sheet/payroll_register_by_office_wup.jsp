...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./payroll_register_by_office_wup_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","payroll_register_by_office_wup.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"payroll_register_by_office_wup.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="payroll_register_by_office_wup.jsp">
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
    ...
    <tr>
      ...
      <td>
		...
		<tr>
		  <td height="20">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("hide_sss");
				if(strTemp.length() > 0)
					strTemp = "checked";
				else
					strTemp = "0.00";					
			%>			
		  <td height="10" colspan="2"><input type="checkbox" name="hide_sss" value="1" <%=strTemp%>>
		    hide SSS column </td>
		</tr>
		<tr>
		  <td height="20">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("hide_ph");
				if(strTemp.length() > 0)
					strTemp = "checked";
				else
					strTemp = "0.00";					
			%>			
		  <td height="10" colspan="2"><input type="checkbox" name="hide_ph" value="1" <%=strTemp%>>
		    hide PhilHealth column </td>
		</tr>
		<!--
		<tr>
		  <td height="20">&nbsp;</td>
		...
		<tr>
		  <td height="20">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("hide_pgbig");
				if(strTemp.length() > 0)
					strTemp = "checked";
				else
					strTemp = "0.00";					
			%>							
		  <td height="10" colspan="2"><input type="checkbox" name="hide_pgbig" value="1" <%=strTemp%>>
		    hide Pag-ibig column </td>
		</tr>
		<tr>
		  <td height="20">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("hide_peraa");
				if(strTemp.length() > 0)
					strTemp = "checked";
				else
					strTemp = "0.00";					
			%>							
		  <td height="10" colspan="2"><input type="checkbox" name="hide_peraa" value="1" <%=strTemp%>>
		    hide PERAA column </td>
		</tr>
			<tr>
		  <td height="20">&nbsp;</td>
			<%
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="20%" height="29"><select name="sort_by2">
          <option value="">N/A</option>
      ...
      <td width="34%" height="29"><select name="sort_by3">
          <option value="">N/A</option>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
	  ...
	  <td align="right">
			<%
				...
				if(strTemp.length() == 0)
					strTemp = "9";
			%>
			<font size="2">Font size of header:
		 ...
		 <td align="right">
			<%
				...
				if(strTemp.length() == 0)
					strTemp = "9";
			%>
			<font size="2">Font size of details:
   ...
   <!--
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10">Cheked by: </td>	
	  <%
	  	strTemp = WI.fillTextValue("checked_by");
	  %>				
      <td height="10"><input type="text" name="checked_by" maxlength="128" size="32" value="<%=strTemp%>"></td>
      <td height="10">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("font_size");
				if(strTemp.length() == 0)
	 ...
	 <tr>
      <td height="10">&nbsp;</td>
      <td height="10">Audited by: </td>
			<%
				strTemp = WI.fillTextValue("audited_by");						
			%>			
      <td height="10"><input type="text" name="audited_by" maxlength="128" size="32" value="<%=strTemp%>"></td>
      <td height="10">&nbsp;</td>				
	 ...
	 <tr>
      <td height="10">&nbsp;</td>
      <td height="10">Approved for payment: </td>
			<%
				strTemp = WI.fillTextValue("approved_by");						
			%>			
      <td height="10"><input type="text" name="approved_by" maxlength="128" size="32" value="<%=strTemp%>"></td>
      <td height="10">&nbsp;</td>				
      <td height="10" align="right">&nbsp;</td>
    </tr>
	-->
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" colspan="54" align="center"><strong><font color="#0000FF">PAYROLL 
      SHEET FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>
    </tr>    
    <tr>
      <td height="19" colspan="54" class="BOTTOM">&nbsp;</td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
  	<tr>
   ...
   <!-- <tr>-->
     ...
     <!-- <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>	-->	
	  ...
	  %>			
			<!--assume all ded have group.ingon si gretchen jose. 01242013..need to unhide again. they simply changed their mind sul03132013-->
   ...
   <!-- </tr>-->
	...
	if( bolShowHeader ||  i > iFieldCount){								
				bolShowHeader = false;
			  %>
			<tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dDeptTotalOthersDed,true)%></td>
			...
			}// end of if(bolShowHeader &&  i > iFieldCount)	

...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./payroll_register_cl_wup_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","payroll_register_cl_wup.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="payroll_register_cl_wup.jsp">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" colspan="15" align="center"><strong><font color="#0000FF">PAYROLL 
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>      
      ...
      (hours)      </td>
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT">Night Diff. (Amount).      </td>
	  -->
	  
      <td width="7%" rowspan="2" align="center" class="headerBOTTOMLEFT">

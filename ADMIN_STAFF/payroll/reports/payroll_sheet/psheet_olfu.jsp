...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./psheet_olfu_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Payroll Sheet (By Office)","psheet_olfu.jsp");
...
<form name="form_" 	method="post" action="psheet_olfu.jsp">
...
show Employee ID </td>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <!--
			<td height="24" colspan="24" align="center" ><strong><font color="#0000FF"> <%=WI.fillTextValue("report_title")%> FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>
			-->
    ...
    <tr>      
      ...
      <td width="34%" align="center" <%=strBorder%>>Amount</td>
      <%}%>      
    ...
    <tr>
      <%
			...
			<td height="26" colspan="<%= iEarnColCount + (iDedColCount/2) + iEarnDedCount + 8 + (iOTType*2) + iContCount + iOptionalCols%>" valign="bottom" <%=strBorder%>><strong> <%=(WI.getStrValue((String)vRows.elementAt(i+62),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> </td>
			<!--
			<td height="26" colspan="24" valign="bottom" <%=strBorder%>><strong> <%=(WI.getStrValue((String)vRows.elementAt(i+62),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> </td>
			-->
    </tr>
    <%}%>

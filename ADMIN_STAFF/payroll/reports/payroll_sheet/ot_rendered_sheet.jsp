...
%>
<form action="./ot_rendered_sheet.jsp" method="post" name="form_">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="2%" bgcolor="#FFFFFF">&nbsp;</td>
			<%
				strTemp = WI.fillTextValue("include_ot");
				if(strTemp.length() > 0)
					strTemp = "checked";
				else
					strTemp = "";
			...
			%>
      <td colspan="2" bgcolor="#FFFFFF"><input type="checkbox" name="include_ot" value="1" <%=strTemp%>>Include OT in Computing tax</td>
    </tr>
    <tr>
    ...
    <td colspan="6"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
      ...
      <tr>
        ...
        <%
			...
			for (i=0 ; i < vRetResult.size(); i+= 30, iCtr++){ 
      ...
      <tr>
        ...
        <td height="19" nowrap class="thinborder">&nbsp;<%=strTemp%></td>
				...
				%>
        <td align="right" nowrap class="thinborder"><%=WI.getStrValue(strTemp)%>&nbsp;</td>
        <%for(j = 0; j < vOtTypes.size(); j+=7){
					strTemp = null;
					strTemp2 = null;

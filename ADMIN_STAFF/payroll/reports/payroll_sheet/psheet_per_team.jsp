...
show Employee ID</td>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="24" colspan="27" align="center" ><strong><font color="#0000FF"> <%=WI.fillTextValue("report_title")%> FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <%				
			...
			%>
      <td height="26" colspan="53" valign="bottom" <%=strBorder%>><strong> <%=(WI.getStrValue((String)vRows.elementAt(i+62),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> </td>
    </tr>
    <%}%>
    <%for(; i < vRows.size();){
  ...
  vEarnings = (Vector)vRows.elementAt(i+53);
    ...
    <tr bgcolor="<%=strBgColor%>">
      ...
      <%			
			...
			if(strSchCode.startsWith("FOODA"))

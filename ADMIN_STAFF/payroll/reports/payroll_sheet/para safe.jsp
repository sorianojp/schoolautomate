  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="4%" rowspan="2" align="center" class="thinborderBOTTOM">BASIC</td>
			-->
      <td width="4%" rowspan="2" align="center" class="thinborderBOTTOM">SEMI-MO</td>
      <td width="4%" rowspan="2" align="center" class="thinborderBOTTOM">RATE PER HOUR</td>
      <td width="4%" rowspan="2" align="center" class="thinborderBOTTOM">Late/UT</td>
    ...
    <tr>
      ...
      <%				
			...
			%>
      <td height="26" colspan="51" valign="bottom" <%=strBorder%>><strong> <%=(WI.getStrValue((String)vRows.elementAt(i+62),strTemp, strTemp2, strTemp2)).toUpperCase()%></strong> </td>
    </tr>
    <%}%>
    <%for(; i < vRows.size();){

...
<%}%>
    ...
    <tr>
      ...
      <td width="4%" colspan="2" align="center" class="headerNoBorder">OVERLOAD</td>
			<%}%>
	...
	<tr>
		<td width="4%" colspan="2" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>TAX Status</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>E-COLA</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>PI-SHARE</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>SSS SHARE</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>TARDINESS</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>RT SHARE</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>C OVL</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>C SUB</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>TOTAL SHARE</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>TOTAL NON TAX</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>PI PREM</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
		<td width="4%" style="font-size:9px;" align="center" <%=strBorderRight%>><strong>&nbsp;</strong></td>
	</tr>

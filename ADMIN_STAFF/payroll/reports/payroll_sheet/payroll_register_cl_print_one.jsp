  ...
  // 4 = peraa
	...
	if((vRows.size() % (iFieldCount*iMaxRecPerPage)) > 0) 
	 ...
	 for (;iNumRec < vRows.size();iPage++){
		 ...
		 for(iCols = 2;iCols <= iEarnColCount + 1; iCols++){//updated Oct 27, 2014.. as it was not resetting all values to 0
...
<form name="form_">
  ...
  <table  bgcolor="#FFFFFF" width="150%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>
	 <%if(bolShowAccountNo){%>	

...
<style type="text/css">
    ...
    border-bottom: solid 1px #000000;
		...
		font-size: <%=WI.getStrValue(WI.fillTextValue("font_size"),"12")%>px;
    }
...
if (WI.fillTextValue("print_pg").length() > 0){ %>	
		<jsp:forward page="./payroll_register_cl_pit_print.jsp" />	
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","payroll_register_cl_pit.jsp");
...
//end of authenticaion code.
	...
	boolean bolShowAccountNo = true;
	if(strSchCode.startsWith("WUP"))
		bolShowAccountNo = false;
...
%>
<body>
<form name="form_" 	method="post" action="payroll_register_cl_pit.jsp">
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
    ...
    <tr>
      ...
      <td>
		...
		<%}%>
		<%//if(bolShowALL){ //this should be open for all%>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>	
      <td width="29" rowspan="2" class="headerBOTTOMLEFT">&nbsp; </td>	
	 ...
	 <td width="8%" height="33" rowspan="2" align="center" class="headerBOTTOMLEFT">POSITION </td>
	  ...
	  <%if(WI.fillTextValue("show_hourly").length() > 0){%>
      		<td width="32" rowspan="2" align="center" class="headerBOTTOMLEFT">RATE PER HOUR</td> 
			<td width="58" height="33" rowspan="2" align="center" class="headerBOTTOMLEFT">HOURS RENDERED</td>	
		<%}%>
      ...
      <td width="55" rowspan="2" align="center" class="headerBOTTOMLEFT">AMOUNT ACCURED FOR THE PERIOD </td>
      <td width="28" rowspan="2" align="center" class="headerBOTTOMLEFT">ADJ. </td>
			<%for(iCols = 2;iCols <= iEarnColCount + 1; iCols ++){%>
      <td width="22" rowspan="2" align="center" class="headerBOTTOMLEFT"><span class="headerBOTTOMLEFT"><%=(String)vEarnCols.elementAt(iCols)%></span></td>
			<%}%>
			<%if(WI.fillTextValue("employee_category").equals("1")){%>
      <td width="41" rowspan="2" align="center" class="headerBOTTOMLEFT">rate/hr<br>
      overload</td>
      <td width="30" rowspan="2" align="center" class="headerBOTTOMLEFT"># of hours of o/l </td>
      <td width="39" rowspan="2" align="center" class="headerBOTTOMLEFT">amount of o/l </td>
			<%}%>  			
		  
      <td width="61" rowspan="2" align="center" class="headerBOTTOMLEFT">
			<%if(WI.fillTextValue("employee_category").equals("1")){%>
			OVERLOAD / 
			<%}%>
	  OVERTIME </td>
      <td width="43" rowspan="2" align="center" class="headerBOTTOMLEFT"><span class="BOTTOMLEFT">OTHERS</span></td>
      <td align="center" class="headerBOTTOMLEFT">DEDUCTIONS</td>
      <td width="58" rowspan="2" align="center" class="headerBOTTOMLEFT"><span class="BOTTOMLEFT">GROSS EARNINGS </span></td>
	  
	  <%  
	   	
	  	 
		   if(iContributions > 1){%>
				<td  width="123" colspan="<%=iContributions-1%>" align="center" class="headerBOTTOMLEFT">CONTRIBUTIONS</td>
			<%}%>
		  <td width="45" rowspan="2" align="center" class="headerBOTTOMLEFT">WITHTAX</td>
				<%			
				for(iCols = 1;iCols <= iDedColCount; iCols +=2){
					strTemp = (String)vDedCols.elementAt(iCols);
					
				%>			
	  <td width="22" rowspan="2" align="center" class="headerBOTTOMLEFT"><%=strTemp%>&nbsp;</td>
				<%}%>
			<td width="43" rowspan="2" align="center" class="headerBOTTOMLEFT">OTHERS</td>
			<td width="69" rowspan="2" align="center" class="headerBOTTOMLEFT">TOTAL DEDUCTIONS</td>
			<!--<td width="19" rowspan="2" align="center" class="headerBOTTOMLEFT">&nbsp;</td>-->
			<td width="36" rowspan="2" align="center" class="headerBOTTOMLEFT">&nbsp;NO.&nbsp;</td>
			<td width="139" rowspan="2" align="center" class="headerBOTTOMLEFT">NET AMOUNT RECEIVED</td>	
			<td width="139" rowspan="2" align="center" class="headerBOTTOMLEFT"><span class="BOTTOMLEFTRIGHT">SIGNATURE OF PAYEE </span></td>	
	</tr>
	  ...
	  <%	  	
			...
			if(astrContributions[0].equals("1")){%>
			  ...
			  <td width="63" align="center" class="headerBOTTOMLEFT">PHILHEALTH</td>
					<%}if(astrContributions[2].equals("1")){%>
			  <td width="55" align="center" class="headerBOTTOMLEFT">HDMF PREM </td>
					<%} if(bolIsSchool && astrContributions[4].equals("1")){%>
					<td width="70" align="center" class="headerBOTTOMLEFT">PERAA</td>			
			<%} 
    ...
    <tr>
      ...
      <td height="18" class="BOTTOMLEFT"><strong>&nbsp;<%=WI.formatName((String)vRows.elementAt(i+4), (String)vRows.elementAt(i+5),
		...
		<td align="left" class="BOTTOMLEFT" style="font-size:9px">&nbsp;  <%=WI.getStrValue((String)vRows.elementAt(i+74),"")%>&nbsp;</td>		
     <%if(WI.fillTextValue("show_hourly").length() > 0){%>
      <%				
				//rate per hour
      ...
      <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
			<%for(iCols = 1;iCols <= iEarnDedCount; iCols ++){
				...
				if(strTemp.equals("0"))
					strTemp = "";			
			%>   			
      <td width="69" align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
			<%}%>
      <%
				dTemp = 0d;
				...
				if(dTemp == 0d)
					strTemp = "--";
			%>				
      <td width="58" align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTemp,true)%>&nbsp;</td>
			<%
  ...
  <input type="hidden" name="print_pg" value="">
   <%if(!bolShowAccountNo)
	  	...
	  	strTemp = "";	
   %>
  <input type="hidden" name="skip_account_no" value="<%=strTemp%>">

<%@ 
	page language="java" import="utility.*, java.util.Vector, payroll.PRTaxStatus,payroll.PayrollSheet, eDTR.ReportEDTRExtn, payroll.ReportPayroll,payroll.PReDTRME, payroll.OvertimeMgmt, eDTR.OverTime" buffer="16kb"%>
<%
	...
	//	System.out.println("COLA " + strTemp);
      ...
      <%				
			...
			<%
				...
				//System.out.println((String)vRows.elementAt(i+52));
				//System.out.println(((String)vSalaryInfo.elementAt(6)));
				//System.out.println(dTemp);
			%>

...
<form name="form_" 	method="post" action="psheet_grouped.jsp">
   <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" class="thinborderBOTTOM">
			<strong><%=WI.fillTextValue("report_title")%> FOR SALARY SCHEDULE : <%=WI.getStrValue(strPayrollPeriod,"")%>
			<%if(WI.fillTextValue("team_index").length() > 0){%><br>
    ...
    <tr>
      ...
      <td width="13%" height="33" align="center" <%=strBorderRight%>>NAME OF EMPLOYEE </td>
      <td width="4%" align="center" <%=strBorderRight%>><span class="thinborderBOTTOM">&nbsp;BASIC SALARY </span></td>
      <td width="4%" align="center" <%=strBorderRight%>>BASIC PAY </td>
      <td width="4%" align="center" <%=strBorderRight%>>RATE PER DAY </td>
      <td width="4%" align="center" <%=strBorderRight%>>RATE PER HOUR</td>
      <td width="4%" align="center" <%=strBorderRight%>>Late/UT/ Absence</td>
      <td width="4%" align="center" <%=strBorderRight%>>Leave w/ pay</td>
			
      <td align="center" <%=strBorderRight%>><%=strTemp%>*</td> 
      ...
      <td width="4%" align="center" <%=strBorderRight%>>AMT</td>
			...
			<td align="center" <%=strBorderRight%>><%=strTemp%>*</td>
			<td  width="3%" align="center" <%=strBorderRight%>>NP</td>
			<%if(WI.fillTextValue("employee_category").equals("1")){%>
      <td width="4%" align="center" <%=strBorderRight%>>Rate</td>
      <td width="4%" align="center" <%=strBorderRight%>>Amount </td>
			<td align="center" <%=strBorderRight%>><%=(String)vEarnCols.elementAt(iCols)%></td>
			<td align="center" <%=strBorderRight%>><%=(String)vEarnDedCols.elementAt(iCols)%></td>
			<td width="4%" align="center" <%=strBorderRight%>>OTHER INC. </td>
			<td width="5%" align="center" <%=strBorderRight%>>TOTAL GROSS PAY</td>
			<td width="4%" align="center" <%=strBorderRight%>>TAX</td>
			<td width="4%" align="center" <%=strBorderRight%>>SSS</td>
			<td width="4%" align="center" <%=strBorderRight%>>PHIC.</td>
			<td width="4%" align="center" <%=strBorderRight%>>HDMF</td>
			<td width="4%" align="center" <%=strBorderRight%>>PERAA</td>
			<td align="center" <%=strBorderRight%>><%=strTemp%></td>
			<td width="5%" align="center" <%=strBorderRight%>>OTHER DED.</td>
			<td width="5%" align="center" <%=strTemp%>>NET PAY</td>
			<%}%>
    </tr>
    <% 

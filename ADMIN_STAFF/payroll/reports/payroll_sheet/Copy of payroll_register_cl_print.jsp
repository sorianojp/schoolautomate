	...
	if((vRows.size() % (iFieldCount*iMaxRecPerPage)) > 0) 
	 ...
	 for (;iNumRec < vRows.size();iPage++){
		 ...
		 for(iCols = 1;iCols < iDedColCount; iCols++){
			 adDeductTotal[iCols] = 0d;
		 }
		 dTotalOtherDed = 0d;
		 dTotalDeductions = 0d;
		 dTotalNetPay = 0d;
		 for(iCols = 1;iCols < iEarnDedCount; iCols++){
			 adEarnDedTotal[iCols] = 0d;
		 }
...
<form name="form_">
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>
      ...
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT">OVERLOAD / OVERTIME </td>
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT"><span class="BOTTOMLEFT">OTHERS</span></td>
      <td colspan="<%=iEarnDedCount %>" align="center" class="headerBOTTOMLEFT">DEDUCTIONS</td>
...
UNDERTIME</td>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%></td>
		<%for(iCols = 2;iCols < iEarnColCount; iCols++){
			...
			dLineTotal += dTemp;
			adEarningTotal[iCols] = adEarningTotal[iCols] + dTemp;
			if(strTemp.equals("0"))
				strTemp = "";			
		%>          
      <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%></td>
      ...
      <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
			<%for(iCols = 1;iCols < iEarnDedCount; iCols ++){
				...
				dTemp = Double.parseDouble(strTemp);
				dLineTotal -= dTemp;
				adEarnDedTotal[iCols] = adEarnDedTotal[iCols] + dTemp;				
				if(strTemp.equals("0"))
					strTemp = "";			
			%>			
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalAdjust,true)%></td>
  		<%for(iCols = 2;iCols < iEarnColCount; iCols++){
			adGEarningTotal[iCols] = adEarningTotal[iCols];	
			%> 
      <td class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adEarningTotal[iCols],true)%></td>
      <%}%>
      <td align="right" class="BOTTOMLEFT">&nbsp;</td>
	  ...
	  %>	  
      <!--<td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalRestOtHr,true)%>&nbsp;</td>-->
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalOtherEarn,true)%>&nbsp;</td>
  		<%for(iCols = 1;iCols < iEarnDedCount; iCols++){
			adGEarnDedTotal[iCols] = adEarnDedTotal[iCols];	
			%> 
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adEarnDedTotal[iCols],true)%></td>
      <%}%>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalAdjust,true)%></td>
			<%for(iCols = 2;iCols < iEarnColCount; iCols++){%> 
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adGEarningTotal[iCols],true)%></td>
			<%}%>
      <td align="right" class="BOTTOMLEFT">&nbsp;</td>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalOtherEarn,true)%></td>
			<%for(iCols = 1;iCols < iEarnDedCount; iCols++){%> 
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adGEarnDedTotal[iCols],true)%></td>
			<%}%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="15%" height="33" rowspan="2" align="center" class="headerBOTTOMLEFT">NAME 
          OF EMPLOYEE </td>
      <td colspan="4" align="center" class="headerBOTTOMLEFT"> C O N T R I B U T I O N S </td>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"&nbsp;")%></td>
			...
			<%for(iCols = 1;iCols < iDedColCount; iCols++){
				...
				dTemp = Double.parseDouble(strTemp);
				adDeductTotal[iCols] = adDeductTotal[iCols] + dTemp;	
				dEmpDeduct += dTemp;
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalTax,true)%></td>
			...
			%> 
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adDeductTotal[iCols],true)%></td>
			<%}%>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalTax,true)%></td>
			<%for(iCols = 1;iCols < iDedColCount; iCols++){%> 
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(adGDeductTotal[iCols],true)%></td>
			<%}%>

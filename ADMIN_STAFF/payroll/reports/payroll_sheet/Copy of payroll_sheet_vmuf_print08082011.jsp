...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      ...
      SHEET FOR SALARY SCHEDULE : <%//=WI.getStrValue(strPayrollPeriod,"")%></font></strong></td>			
          ...
          <tr>
            <td colspan="<%=iEarnColCount + iEarnDedCount + 14%>" class="headerBOTTOMLEFT">&nbsp;<%=WI.fillTextValue("college_name")%> <%=WI.getStrValue(WI.fillTextValue("dept_name"),"(",")","")%></td>
	  ...
	  %>
          ...
          <tr>
            ...
            <td class="BOTTOMLEFT"><div align="right"><font size="1"><%=CommonUtil.formatFloat(dTotalCola,true)%></font></div></td>
              ...
              <td class="BOTTOMLEFT"><div align="right"><font size="1"><%=CommonUtil.formatFloat(dTotalAdjust,true)%></font></div></td>
              <%for(iCols = 1;iCols <= iEarnDedCount; iCols++){%>

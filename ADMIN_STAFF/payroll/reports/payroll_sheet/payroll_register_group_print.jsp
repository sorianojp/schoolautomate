...
/////////////////// start of OT names \\\\\\\\\\\\\\\\\\\	
	 ...
	 for (;iNumRec < vRows.size();iPage++){
		 ...
		 for(iCols = 2;iCols <= iEarnColCount + 1; iCols++){//updated Oct 27, 2014 as it was not resetting all values.
    ...
    <tr>
	  ...
	  /////////////////// start of OT total \\\\\\\\\\\\\\\\\\\	
		if(vOTGroupList != null && vOTGroupList.size() > 0){			
			...
			<%
				arrDGroupGrandTotal[iCols3] += arrDGroupTotal[iCols3]; 
				arrDGroupTotal[iCols3] = 0d;
			}//end of for loop	 
		...
		if(vOTNoGroupList != null && vOTNoGroupList.size() > 0){
			...
			<%
				arrDNoGroupGrandTotal[iCols3] += arrDNoGroupTotal[iCols3]; 
				arrDNoGroupTotal[iCols3] = 0d;
			}//end of for loop
		}//end of if nogroup

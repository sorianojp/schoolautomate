...
//end of authenticaion code.
	...
	double dTotalSSSER = 0d;
	double dTotalSSSEC = 0d;
	...
	double dGTotalSSSER = 0d;
	double dGTotalSSSEC = 0d;
...
<form name="form_">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="85%"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></td>
      <td width="15%" align="right">Page: <%=(iPage*2)-1%> of <%=(iTotalPages*2)%>&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2">Payroll Register</td>
    </tr>
		<%
			if(bolIsSchool)
		...
		%>
    <tr>
      <td><%=strPayrollPeriod%></td>
      <td align="right">&nbsp;<%=WI.fillTextValue("group_name")%></td>
    </tr>
    ...
    <%}%>
    <tr>
      <td height="19" colspan="2" class="thinborderBOTTOM">&nbsp;</td>
    </tr>
  </table>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" class="TOPRIGHT">
    <tr>
      ...
      <td width="5%" rowspan="2" align="center" class="headerBOTTOMLEFT">Night Diff./ Overtime </td>
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT">Substitution</td>
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT">OTHERS</td>
      <td colspan="<%=iEarnDedCount+1%>" align="center" class="headerBOTTOMLEFT">DEDUCTIONS</td>
      <td width="6%" rowspan="2" align="center" class="headerBOTTOMLEFT">GROSS EARNINGS</td>
    </tr>
    <tr>
			<%for(iCols = 1;iCols <= iEarnDedCount; iCols ++){%>
      <td align="center" class="headerBOTTOMLEFT"><%=(String)vEarnDedCols.elementAt(iCols)%></td>
			<%}%>
      <td height="33" align="center" class="headerBOTTOMLEFT">TARDINESS/<br>
UNDERTIME</td>
    </tr>
	  <% 
    ...
    <tr>
      ...
      <td class="BOTTOMLEFT"><%=WI.getStrValue(strTemp,"&nbsp;")%></td> 
			<%}%>
      <td height="19" nowrap class="BOTTOMLEFT"><strong><%=WI.formatName((String)vRows.elementAt(i+4), (String)vRows.elementAt(i+5),
    ...
    <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalOverLoad,true)%>&nbsp;</td>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalSub,true)%>&nbsp;</td>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalSub,true)%>&nbsp;</td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="76%"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></td>
      <td width="24%" align="right">Page: <%=(iPage*2)%> of <%=(iTotalPages*2)%>&nbsp;&nbsp;&nbsp;</td>
    </tr>
    <tr>
      <td colspan="2">Payroll Register</td>
    </tr> 
    <tr>
      ...
      <td align="right">&nbsp;<%=WI.fillTextValue("group_name")%></td>
		...
		<%if(strEmpCatg.length() > 0){%>
		<tr>		
		  <td colspan="2"><%=strEmpCatg%> Staff</td>
	  </tr>
		<%}%>		
    <tr>
      <td height="19" colspan="2" class="thinborderBOTTOM">&nbsp;</td>
    ...
    <tr>
      ...
      <td width="8%" align="center" class="headerBOTTOMLEFT">SSS PREM </td>
			<td width="8%" align="center" class="headerBOTTOMLEFT">SSS(ER)</td>
			<td width="8%" align="center" class="headerBOTTOMLEFT">SSS(EC)</td>
    ...
    <tr>
	  ...
	  %>			
		...
		<%
			...
			dGTotalSSSER += dTotalSSSER;
			dGTotalSSSEC += dTotalSSSEC;
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalSSS,true)%></td>
			<td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalSSSER,true)%></td>
			<td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dTotalSSSEC,true)%></td>
			<%}if(astrContributions[1].equals("1")){%>
    ...
    <tr>
      ...
      <td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalSSS,true)%></td>
			<td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalSSSER,true)%></td>
			<td align="right" class="BOTTOMLEFT"><%=CommonUtil.formatFloat(dGTotalSSSEC,true)%></td>
			<%} if(astrContributions[1].equals("1")){%>

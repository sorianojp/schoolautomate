...
<tr>
      <%				
				if(bolShowBorder)
					...
					strBorder = "class='NoBorder'";
			%>
      <td height="24" align="right" valign="bottom" nowrap <%=strBorder%>><strong>DEPT TOTAL</strong></td>
...
<tr>
	<%				
		if(bolShowBorder)
			...
			strBorder = "class='thinborderBottom'";
	%>
  <td height="24" align="right" valign="bottom" nowrap <%=strBorder%>><strong>PAGE TOTAL</strong></td>
  <td align="right" valign="bottom" <%=strBorder%>>&nbsp;</td>
  <td align="right" valign="bottom" <%=strBorder%>>&nbsp;</td>
  <td align="right" valign="bottom" <%=strBorder%>>&nbsp;</td>
  <td align="right" valign="bottom" <%=strBorder%>>&nbsp;</td>
...
<%}%>	 
    ...
    <tr>
		<%				
			if(bolShowBorder)
				...
				strBorder = "class='NoBorder'";
		%>		
      <td height="20" align="right" nowrap <%=strBorder%>><strong>GRAND TOTAL</strong></td>
    ...
    <tr> 
      ...
      <td rowspan="7" valign="top">
			<%if(WI.fillTextValue("show_page_sum").length() > 0){%>
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr> 

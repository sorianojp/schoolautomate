...
%>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td height="18">&nbsp;</td>
      <td height="18" class="thinborderNONE"><strong>Pay Class : <%=astrPtFt[Integer.parseInt((String)vRetResult.elementAt(iNumRec+10))]%></strong></td>
    </tr>
    <tr>
      <td height="18">&nbsp;</td>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <% bolLooped = false;
	  ...
	  %>
			...
			if(bolLooped) {
			  if(strPrevStat.equals((String)vRetResult.elementAt(i+10))){
    ...
    <tr> 
      <td height="18" class="thinborderNONE"><div align="right"></div></td>
      ...
      <td class="thinborderNONE">&nbsp;</td>
		...
		strPrevStat = (String)vRetResult.elementAt(i+10);		
		if(iNumRec + 16 < vRetResult.size()){
			if(!strPrevColl.equals((String)vRetResult.elementAt(iNumRec+16)) 
						|| !strPrevDept.equals((String)vRetResult.elementAt(iNumRec+17))){
					bolDeptTotal = true;
			}
		}

		if(iNumRec + 15 == vRetResult.size()){
			bolDeptTotal = true;
		}
		if(bolDeptTotal){
			bolDeptTotal = false;
		%>
    <tr>
      <td height="18" colspan="8" class="thinborderNONE">
	   <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="82%" height="25" valign="top" class="thinborderNONE"><div align="right"><strong>Total </strong></div></td>
          <td width="3%" valign="top">&nbsp;</td>
          <td width="15%" valign="top" class="thinborderTOP"><div align="right"><%=WI.getStrValue(CommonUtil.formatFloat(dDeptTotal,true),"&nbsp;")%>&nbsp;</div></td>
        </tr>
      </table></td>
    </tr>
		<%
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td width="3%" height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td width="37%" align="center" bgcolor="#FFFFFF" class="thinborderNONE"><strong>RICARDO O. HIPOLITO </strong></td>
      <td width="15%" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td width="39%" height="18" align="center" bgcolor="#FFFFFF" class="thinborderNONE"><strong>Mr. CONSTANTE P. QUIRINO JR. </strong></td>
      <td width="6%" height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
    </tr>
    <tr>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td align="center" bgcolor="#FFFFFF" class="thinborderNONE">President</td>
      <td bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td height="18" align="center" bgcolor="#FFFFFF" class="thinborderNONE">Executive Vice President </td>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
    </tr>
    <tr>
      <td height="25" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td bgcolor="#FFFFFF" class="thinborderNONE">Verified by: </td>
      <td bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td height="25" align="center" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td height="25" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
    </tr>
    <tr>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td align="center" bgcolor="#FFFFFF" class="thinborderNONE"><strong>Mrs. SISINIA T. QUIZON </strong></td>
      <td bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td height="18" align="center" bgcolor="#FFFFFF" class="thinborderNONE"><strong>Ms. MIRIAM A. MOLINA </strong></td>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
    </tr>
    <tr>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td align="center" bgcolor="#FFFFFF" class="thinborderNONE">Vice President for Administration </td>
      <td bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
      <td height="18" align="center" bgcolor="#FFFFFF" class="thinborderNONE">Finance Manager </td>
      <td height="18" bgcolor="#FFFFFF" class="thinborderNONE">&nbsp;</td>
    </tr>
  </table>
  <%if (bolPageBreak){%>

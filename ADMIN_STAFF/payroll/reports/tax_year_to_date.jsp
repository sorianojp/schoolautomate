...
<html>
<head>
<title>Employee Tax Withheld for the Year</title>
...
<form name="form_" 	method="post" action="tax_year_to_date.jsp">
<%
...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./tax_year_to_date_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Tax Withheld for Year","tax_year_to_date.jsp");
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td width="100%" height="25" align="center" class="footerDynamic"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          PAYROLL - 
      REPORTS - EMPLOYEES TAX CONTRIBUTION FOR THE YEAR PAGE ::::</strong></font></td>
    </tr>
    <tr bgcolor="#FFFFFF">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td width="6%" height="25" align="center" class="thinborder"><font size="1"><strong>COUNT 
      NO.</strong></font></td>
      <td width="16%" align="center" class="thinborder"><font size="1"><strong>EMPLOYEE ID</strong></font></td>
      <td width="59%" align="center" class="thinborder"><font size="1"><strong>EMPLOYEE NAME</strong></font></td>
      <td width="19%" align="center" class="thinborder"><strong><font size="1">TAX WITHELD FOR YEAR </font></strong></td>
    </tr>
    <%
	int iRow = 1;
    ...
    <tr> 
      ...
      <td class="thinborder"><font size="1"><strong>&nbsp;&nbsp;<%=(String)vRetResult.elementAt(i+1)%></strong></font></td>

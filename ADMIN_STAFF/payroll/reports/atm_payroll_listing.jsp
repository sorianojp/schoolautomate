...
function generateCSV( strSalPeriodIdx, strEmpCat, strBankIdx, strEmpStat, strCollIdx, strDeptIdx, strDeptFilter, strAtmOpt){
	var pgLoc = "./atm_payroll_listing_print_csv.jsp?sal_period_index="+strSalPeriodIdx+"&employee_category="+strEmpCat
			+"&bank_index="+strBankIdx+"&pt_ft="+strEmpStat+"&c_index="+strCollIdx+"&d_index="+strDeptIdx+"&dept_filter="+strDeptFilter+"&atm_option="+strAtmOpt;
...
if (WI.fillTextValue("print_page").length() > 0){ 
	if( WI.fillTextValue("bank_index").equals("8") )
		strTemp = "aub";
	else if( WI.fillTextValue("bank_index").equals("9") )
		strTemp = "pbcom"; 

	strTemp = "./atm_payroll_listing_print_eac_" +strTemp+ "_format1.jsp";
   ...
   if(strSchCode.startsWith("CGH")){%>
	...
	<%}else if(strSchCode.startsWith("EAC")) {
		if( WI.fillTextValue("bank_index").matches("9|8")){ 
			if( strSchCode.startsWith("EAC")){				
				if( WI.fillTextValue("print_format").equals("1")){
		%>			<jsp:forward page= "<%=strTemp%>" />
				<%}else{%> 
					<jsp:forward page="./atm_payroll_listing_print_eac_format2.jsp" />
				<%}
			}%>
		<%}else{%> 
    ...
    <tr> 
      ...
      <td height="10" colspan="3">
         ...
         <%=dbOP.loadCombo("BANK_INDEX","BANK_NAME, BRANCH", 
													...
													" and exists(select * from pr_salary_main  " +
													"  where pr_salary_main.BANK_INDEX = FA_BANK_LIST.BANK_INDEX" +
													"  and pr_salary_main.is_valid = 1) order by BANK_NAME", strTemp, false)%> 
			</select></td>
    </tr>
		<tr>
		  <td height="25">&nbsp;</td>
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
	...
	<% try{ %>
	<%if(strSchCode.startsWith("EAC") && vRetResult != null && vRetResult.size() > 1){%> 
		<tr> 
		  <td height="10">&nbsp;</td>
		  <td height="10">&nbsp;</td>
		  <td height="10" colspan="3">
		  	CHAIRMAN OF	THE BOARD :&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input name="chairman_name" size="35" type="text"  class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("chairman_name")%>" />			
            POSITION : &nbsp;
			<input name="chairman_name_pos" size="35" type="text"  class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("chairman_name_pos")%>" />		  </td>
		</tr>
		<tr> 
		  <td height="10">&nbsp;</td>
		  <td height="10">&nbsp;</td>
		  <td height="10" colspan="3">
		  	TREASURER/CORPPORATE SECRETARY : &nbsp;
			<input name="treasurer_name" size="35" type="text" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("treasurer_name")%>" /> 
			POSITION : &nbsp;
			<input name="treasurer_name_pos" size="35" type="text" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("treasurer_name_pos")%>" />		  </td>
		</tr>
		<tr> 
		  <td height="10">&nbsp;</td>
		  <td height="10">&nbsp;</td>
		  <td height="10" colspan="3">
		  	BANK BRANCH MANAGER : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input name="branchmanager_name" size="35" type="text" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("branchmanager_name")%>" /> 
			POSITION : &nbsp;
			<input name="branchmanager_name_pos" size="35" type="text" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("branchmanager_name_pos")%>" />		  </td>
		</tr>
	<%}%>
	<%}catch(Exception e ){ e.printStackTrace(); }%>
    <tr> 
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<div align="right">
			<font size="2">Print Format :</font>
			<select name="print_format"onChange="onSelectFormat()" >
				<%if( WI.fillTextValue("print_format").equals("2")){%>
	...
	<tr>
		<td height="18" colspan="2">
		<div align="right">
			<font size="2">Payroll Date :</font>
        	<input name="payroll_date" type="text"  id="from_date3" size="12" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=WI.fillTextValue("payroll_date")%>"> 
        	<a href="javascript:show_calendar('form_.payroll_date');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a>
		</div>		
		</td>
	</tr>
	<%}%>
      ...
      <td height="18" colspan="2"><div align="right"><font size="2">	    
		Number of Employees Per Page :</font>
		  ...
		  <option value="1000000">Print ALL in One Page</option>
            <% int iDefault = Integer.parseInt(WI.getStrValue(request.getParameter("num_rec_page"),"1000000"));
			for( i =20; i <=45 ; i++) {
				if ( i == iDefault) {%>

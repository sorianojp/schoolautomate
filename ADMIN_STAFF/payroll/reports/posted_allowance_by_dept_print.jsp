...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
      <td colspan="8" class="BOTTOM"  align="right" height="30">Date and time printed : <%=WI.getTodaysDateTime()%></td>
    </tr>
    <tr>
      ...
      <td width="14%" height="33" align="center" class="headerBOTTOMLEFT"><strong>INCOME CODE </strong></td>
      <td width="12%" height="33" align="center" class="headerBOTTOMLEFT"><strong>MONTHLY AMOUNT </strong></td>
      <td width="12%" height="33" align="center" class="headerBOTTOMLEFT"><strong>DEDUCTIONS </strong></td>
      <td width="17%" height="33" align="center" class="headerBOTTOMLEFT"><strong>AMOUNT</strong></td>
	...
	<%
	 ...
	 if(i >= vRetResult.size()){ %>
		  <tr>
			  ...
			  <td colspan="2" align="right" style="border-bottom:double #000000 3px" height="25"><strong>&nbsp; &nbsp;<%=CommonUtil.formatFloat(dNetPayGrand,true)%></strong>&nbsp;&nbsp;</td>
    	</tr>
	<%} //end of last page %>

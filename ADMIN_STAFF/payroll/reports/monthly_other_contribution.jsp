...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./monthly_other_contribution_print.jsp" />
<% return;}

try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
										"Admin/staff-Payroll-REPORTS-Contributions/Plans","monthly_other_contribution.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"monthly_other_contribution.jsp");
...
if(WI.fillTextValue("searchEmployee").equals("1")){
  vRetResult = RptPay.gePeriodOtherContribution(dbOP);
	...
	if(WI.fillTextValue("benefit_index").length() > 0){
...
<form name="form_" method="post" action="./monthly_other_contribution.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr  bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      PAYROLL : MONTHLY SUMMARY OTHER CONTRIBUTIONS PAGE ::::</strong></font></td>
    </tr>
</table>
    ...
    <tr>
	  ...
	  <select name="benefit_index">
        ...
        <%=dbOP.loadCombo("BENEFIT_INDEX","BENEFIT_NAME,sub_type", " from hr_benefit_incentive " + 
			" join hr_preload_benefit_type on (hr_benefit_incentive.benefit_type_index = hr_preload_benefit_type.benefit_type_index) " +
			" where coverage_unit = 2 and is_benefit = 0 and is_incentive = 0 " + 
			" and benefit_name not in ('loan','loans') and is_valid =1 and is_del = 0 order by BENEFIT_NAME",
			strTemp,false)%>
      </select>	  </td>
    </tr>
		 <%if(bolHasTeam){%>
  ...
  <tr>
    <td colspan="5"><div align="center"><strong><%=(WI.getStrValue(strBenefitName,"")).toUpperCase()%> CONTRIBUTION <br>
  ...
  <tr>
    ...
    <td width="18%" class="thinborderBOTTOMLEFTRIGHT"><div align="right"><span class="thinborderBOTTOMLEFT"><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+9),true)%>&nbsp;</span></div></td>
    <td width="10%">&nbsp;</td>
  </tr>
  <%}// end for loop%>
  <tr>

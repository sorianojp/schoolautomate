...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="table2">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" id="table3">
    ...
    <tr>
      ...
      <td width="12%">Salary Period</td>
      <td width="86%" colspan="3"><strong>
...
if(vRetResult != null && vRetResult.size() > 1){%>
  ...
  <br />
   <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  	...
  	<tr>
		<td width="2%" class="thinborderNONE" height="30">&nbsp;</td>
		<td width="38%" align="center" class="thinborderNONE"><strong>NAME</strong></td>
		<td width="20%" align="center" class="thinborderNONE"><strong>AMOUNT DEDUCTED</strong></td>
	</tr>
	...
	<%}//end of bolShowHeader%>	
		<tr>
			<td width="2%" class="thinborderNONE" height="20" align="right"><%=iCtr++%>&nbsp;</td>
			<td width="38%" align="left" class="thinborderNONE">&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+3), (String)vRetResult.elementAt(i+4),
							(String)vRetResult.elementAt(i+5), 4)%></td>
			<%
				strTemp =WI.getStrValue((String)vRetResult.elementAt(i+8),"0");
				dTemp  = Double.parseDouble(strTemp);
			%>				
			<td width="20%" align="right" class="thinborderNONE"><%=CommonUtil.formatFloat(dTemp,true)%>&nbsp;</td>
		</tr>	
	<%}%>
  </table>

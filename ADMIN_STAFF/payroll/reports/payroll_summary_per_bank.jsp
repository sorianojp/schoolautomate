...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Payroll Summary(Per Bank)","payroll_summary_per_bank.jsp");
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="32%" valign="top" class="thinborderTOPLEFT"> <table width="100%" height="55" border="0" cellpadding="0" cellspacing="0">
          <tr> 

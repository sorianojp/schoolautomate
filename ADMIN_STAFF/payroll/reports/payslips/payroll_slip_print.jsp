...
<%
	...
	if(strSchCode.startsWith("CGH")){%>
		<jsp:forward page="./payroll_slip_print11152011.jsp" />
	<%return;}
	
	if(strSchCode.startsWith("EAC")){%>
		<jsp:forward page="./payroll_slip_print_eac.jsp" />
	<% return; }
	if(strSchCode.startsWith("UPH")){%>
		<jsp:forward page="./payroll_slip_print_UPH.jsp" />
	<% return; }
  ...
  <tr>
	...
	<%if(strSchCode.startsWith("DLSHSI")){%>
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr>
			<td width="75px"><img src="../../../../images/logo/<%=strSchCode%>.gif" width="70" height="70"></td>
			<td>
			  <table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td style="font-weight:bold; font-size:16px;" colspan="2"><%=SchoolInformation.getSchoolName(dbOP,true,false)%></td>
				</tr>
				<tr>
					<td style="font-size:9px;" colspan="2"><%=SchoolInformation.getAddressLine1(dbOP,false,false)%></td>
				</tr>
				<tr>
					<td style="font-size:9px;" colspan="2">&nbsp;</td>
				</tr>
				<tr>
					<td class="thinborderNONEcl" width="17%">PAYROLL PERIOD</td>
					<td class="thinborderNONEcl"><%=strPayrollPeriod%></td>
				</tr>
				<tr>
					<td class="thinborderNONEcl">NAME</td>
					<td class="thinborderNONEcl"><strong><u><%=WI.formatName((String)vPersonalDetails.elementAt(1), (String)vPersonalDetails.elementAt(2),
							(String)vPersonalDetails.elementAt(3), 7).toUpperCase()%></u><%=WI.getStrValue(strEmpID,"(",")","")%></strong>

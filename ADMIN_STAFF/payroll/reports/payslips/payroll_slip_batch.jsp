  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
    <tr> 
			<% strTemp = "";
				...
				strTemp = strTemp.toUpperCase();
			%>
      <td height="18" colspan="4">Name : <%=strTemp%>
      <%=WI.getStrValue((String)vRows.elementAt(iMain+60))%>&nbsp;&nbsp;&nbsp; - &nbsp;Gender</td>	
    ...
    <tr>
			<%
				if(vRows.elementAt(iMain+62) == null || vRows.elementAt(iMain+63) == null)
					...
					strTemp = " - ";
			 %>
      <td height="18" colspan="4"><font size="1">Department/<%if(bolIsSchool){%>College<%}else{%>Division<%}%> :&nbsp;<%=WI.getStrValue((String)vRows.elementAt(iMain+62),"")%><%=strTemp%><%=WI.getStrValue((String)vRows.elementAt(iMain+63),"")%></font></td>
      <td height="18" colspan="2">&nbsp;</td>
    </tr>
    <tr> 
          ...
          <tr> 
            <td width="68%" class="thinborderNONE" height="14">&nbsp;Basic salary</td>
						<%
							...
							dGrossSalary = dTemp;
						%>
            <td width="32%" align="right" class="thinborderNONE"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
          </tr> 
          <tr> 
            <td class="thinborderNONE" height="14">&nbsp;Part time/ Extra Salary</td>
						<% 
						// faculty pay 
						strTemp = (String)vRows.elementAt(iMain + 30);
						dTemp = Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));
						dGrossSalary += dTemp;
						dSubTotal = dTemp;

						// overload pay
						strTemp = (String)vRows.elementAt(iMain + 22);
						dTemp = Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));
						dGrossSalary += dTemp;
						dSubTotal += dTemp;

						strTemp = CommonUtil.formatFloat(dSubTotal, 2);
						if(dSubTotal == 0d)
							strTemp = "";
					 %>
            <td align="right" class="thinborderNONE"><%=strTemp%>&nbsp;</td>
          ...
          <tr> 
            ...
            <td align="right" class="thinborderNONE"><%=strTemp%>&nbsp;</td>
         	...
         	<%
 					...
 					%>        
          <tr>
            <td class="thinborderNONE" height="14"><%=(String)vEarnCols.elementAt(iCols)%></td>
					 <%
					strTemp = (String)vEarnings.elementAt(iCols);
					dTemp = Double.parseDouble(strTemp);
					if(dTemp == 0d)
    ...
    <tr> 
      ...
      <td width="17%" height="21" class="thinborderBOTTOMLEFT">&nbsp;</td>
      <td width="20%" class="thinborderBOTTOMLEFT"><font size="1"><strong>&nbsp;&nbsp;TOTAL 
        DEDUCTIONS</strong></font></td>
      <td width="10%" class="thinborderBOTTOMLEFT">&nbsp;</td>

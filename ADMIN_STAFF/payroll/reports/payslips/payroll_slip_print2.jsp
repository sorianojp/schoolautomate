<%@ page language="java" import="utility.*, java.util.Vector, payroll.ReportPayroll, payroll.PRSalary, 
								...
								payroll.PRFaculty, payroll.PRPayslip" %>
...
if (strEmpID.length() > 0) {
  ...
  vPersonalDetails = authentication.operateOnBasicInfo(dbOP,request,"0");		
	...
	if(strSchCode.startsWith("CLDH")){
		...
		vFixedDeductions = rptPayExtn.getYTDInfo(dbOP,strEmployeeIndex);
	}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
    ...
    <tr> 
      ...
      <td width="20%" valign="top" class="thinborderTOPLEFT"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <%  if (vMiscDeduct != null && vMiscDeduct.size() > 0 ){
		  for (i = 1; i < vMiscDeduct.size(); i +=4){
			strTemp = (String)vMiscDeduct.elementAt(i + 2);
			dTemp = Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));
			dTotalDeduction += dTemp;
			%>
          <%if (dTemp > 0){%>
          <tr> 
            <td height="15"><font size="1"><%=WI.getStrValue((String)vMiscDeduct.elementAt(i+1),"")%></font></td>
            <td><div align="right"><font size="1"><%=WI.getStrValue(strTemp,"0")%></font>&nbsp;</div></td>
          </tr>
          <%}%>
          <%}// end for loop here
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
    ...
    <tr> 
      ...
      <td class="thinborderBOTTOMLEFTRIGHT"><font size="1">
        <% 
						if (vDTRDetails != null && vDTRDetails.size() > 0){ 
							strTemp = (String)vDTRDetails.elementAt(17);			
							dGrossSalary += Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));
    ...
    <tr> 
      <td height="18" colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr> 
            ...
            <%
						// this hourly rate is the teaching rate
					 if (vDTRDetails != null && vDTRDetails.size() > 0){ 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0">
	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
          ...
          <% dTemp = 0d;
						...
						%>
          <tr>
            <td height="10" valign="bottom" class="thinborderNONE">Adjustment</td>
            <td align="right" valign="bottom" class="thinborderNONE"><%=WI.getStrValue(strTemp,"")%></td>
          </tr>
          <%}%>
          <% dTemp = 0d;
          ...
          <%if (vVarAllowances != null && vVarAllowances.size() > 2){%>
          <tr>
            <td height="19" valign="bottom" class="thinborderNONE">Other Income </td>
						<% dTemp = 0d;			
						strTemp = WI.getStrValue((String)vVarAllowances.elementAt(0),"0");
						dTemp = Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));			
						dGrossSalary += dTemp; 
						if(dTemp == 0d)
							strTemp = "-";
          ...
          <% dTemp = 0d;
						...
						%>
          <tr>
            <td valign="bottom" class="thinborderNONE">Incentive<font size="1">&nbsp; </font></td>
            <td align="right" valign="bottom" class="thinborderNONE"><%=WI.getStrValue(strTemp,"")%></td>
          </tr>
          <%}%>
					<% 			
          ...
          <tr>
            ...
            <td width="30%" align="right" class="thinborderNONE"><%=strTemp%></td>
			  ...
			  <td align="right" valign="bottom"><font size="2"><%=WI.getStrValue(CommonUtil.formatFloat(dGrossSalary,true),"0")%></font></td>
			  <td valign="bottom">&nbsp;</td>
			</tr>
			<tr>
          ...
          <tr>
            <td width="26%" valign="bottom" class="thinborderNONE">Deductions</td>
            ...
            <td width="67%">&nbsp;<%=strTemp%></td>
					<% dTemp = 0d;			
						...
						if(dTemp == 0d)
							strTemp = "-";
					 %>
            <td width="33%" align="right"><font size="1"><%=WI.getStrValue(strTemp,"")%></font></td>
          </tr>
					<%}// end for%>          
        </table></td>
			  <td valign="top">&nbsp;</td>
	 ...
	 %>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
			<tr> 
				<td width="17%"><font size="1">&nbsp;PAYROLL PERIOD</font></td>
			...
			<tr> 
			 ...
			 <%if(vPersonalDetails.elementAt(13) != null && vPersonalDetails.elementAt(14) != null){
				 ...
				 strTemp = WI.getStrValue((String)vPersonalDetails.elementAt(13),"") + strSlash + WI.getStrValue((String)vPersonalDetails.elementAt(14),"");
			 %>
				<td colspan="2" class="thinborderNONE">&nbsp;DEPARTMENT : <%=strTemp%><font size="1">&nbsp;</font></td>
			</tr>
			<tr> 
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						%>
						<td width="19%" align="right" valign="bottom" class="thinborderNONE"><%=strTemp%>&nbsp;</td>
					</tr>
					<%}// end for loop%>
				</table>
				<%}// end vOTEncoding%>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						%>
						<td class="thinborderNONE" height="20">&nbsp;<%=strTemp%></td>
						<%
							strTemp = (String)vEmpLoans.elementAt(i+3);
						%>					
						<td align="right" class="thinborderNONE"><%=CommonUtil.formatFloat(strTemp,true)%>&nbsp;</td>
						<%
			...
			<tr>
				<td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="17%" align="right" class="thinborderNONE">Salary Rate :&nbsp; </td>
						<td width="12%" class="thinborderNONE">&nbsp;</td>
						<%
							if(vEmpIDs != null && vEmpIDs.size() > 0)
								strTemp = (String)vEmpIDs.elementAt(0);
								...
								strTemp = "";
						%>		
						<td width="18%" align="right" class="thinborderNONE">SSS :&nbsp;</td>
						<td width="16%" class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(strTemp,"&nbsp;")%></strong></td>
						<td width="19%" align="right" class="thinborderNONE">Bank Account&nbsp;:&nbsp;</td>
						<td width="18%" class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(WI.fillTextValue("bank_account"),"")%></strong></td>
					</tr>
					<tr>
						<td align="right" class="thinborderNONE">YTD Basic :&nbsp;</td>					
						<%
							if(vFixedDeductions != null && vFixedDeductions.size() > 0)
								strTemp = (String)vFixedDeductions.elementAt(0);
							else
								strTemp = "";
						%>
						<td align="right" class="thinborderNONE"><strong><%=CommonUtil.formatFloat(strTemp,true)%>&nbsp;</strong></td>
						<%
							if(vEmpIDs != null && vEmpIDs.size() > 0)
								strTemp = (String)vEmpIDs.elementAt(3);
							else
								strTemp = "";
						%>
						<td align="right" class="thinborderNONE">PAGIBIG :&nbsp;</td>
						<td class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(strTemp,"&nbsp;")%></strong></td>
						<td align="right" class="thinborderNONE">Tax Status&nbsp;:&nbsp;</td>
						<%
						if (vDTRDetails != null && vDTRDetails.size() > 0){
						...
						%>
						<td class="thinborderNONE"><strong>&nbsp;<%=astrTaxStatus[iTemp]%>
								<%if (iTemp > 1){%>
								<%=strTemp2%>
								<%}%>
						</strong></td>
					...
					<tr>
						<td align="right" class="thinborderNONE">YTD Taxable :&nbsp;</td>
						<%
							if(vFixedDeductions != null && vFixedDeductions.size() > 0)
								strTemp = (String)vFixedDeductions.elementAt(1);
							else
						...
						<%
							if(vEmpIDs != null && vEmpIDs.size() > 0)
								...
								strTemp = "";
						%>							
						<td align="right" class="thinborderNONE">PHILHEALTH :&nbsp;</td>
						<td class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(strTemp,"&nbsp;")%></strong></td>
						<%
							if(vEmpIDs != null && vEmpIDs.size() > 0)
								strTemp = (String)vEmpIDs.elementAt(4);
								...
								strTemp = "";
						%>							
						<td align="right" class="thinborderNONE">PERAA :&nbsp;</td>
						<td class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(strTemp,"&nbsp;")%></strong></td>
					</tr>
					<tr>
						<td align="right" class="thinborderNONE">YTD Tax Withheld :&nbsp;</td>
						<%
							if(vFixedDeductions != null && vFixedDeductions.size() > 0)
								strTemp = (String)vFixedDeductions.elementAt(2);
							else
						...
						<%
							if(vEmpIDs != null && vEmpIDs.size() > 0)
								...
								strTemp = "";
						%>							
						<td align="right" class="thinborderNONE">TIN :&nbsp;</td>
						<td class="thinborderNONE"><strong>&nbsp;<%=WI.getStrValue(strTemp,"&nbsp;")%></strong></td>
						<td class="thinborderNONE">&nbsp;</td>
						<td class="thinborderNONE">&nbsp;</td>
					</tr>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr valign="bottom"> 
	  <td height="14" colspan="2"><font size="1">Approved by :</font></td>
	  <td width="51%"><font size="1">Payee :</font></td>
	</tr>
	<tr> 
	  <td height="18">&nbsp;</td>
	  <td height="18">&nbsp;</td>
	...
	<tr> 
	  <td height="18">&nbsp;</td>
	  <td height="18"><font size="1"><strong><%=WI.getStrValue((CommonUtil.getNameForAMemberType(dbOP,"Accounting Head",7)),"").toUpperCase()%></strong></font></td>
	  <td>&nbsp;<font size="1"><strong><%=WI.formatName((String)vPersonalDetails.elementAt(1), (String)vPersonalDetails.elementAt(2),

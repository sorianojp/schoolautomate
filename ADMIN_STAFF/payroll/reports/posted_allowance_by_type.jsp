...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./posted_allowance_by_type_print.jsp" />
<% return;}
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","posted_allowance_by_type.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="posted_allowance_by_type.jsp">

...
if (WI.fillTextValue("print_pg").length() > 0){ %>
	<jsp:forward page="./posted_allowance_print.jsp" />
<% return;}
try
	{
...
//end of authenticaion code.
	...
	vRetResult = prAllowances.getAllAllowanceForPeriod(dbOP,request);
	if(vRetResult == null)
...
%>
<body>
<form name="form_" 	method="post" action="posted_allowance.jsp">
...
//					(String)vSalaryPeriod.elementAt(i + 6) +" - "+(String)vSalaryPeriod.elementAt(i + 7);
  ...
  <table  bgcolor="#FFFFFF" width="80%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr>      
     <td width="16%" height="33" align="center" class="headerBOTTOMLEFT"><strong>EMP. ID # </strong></td>
	 <td width="31%" height="33"  align="center" class="headerBOTTOMLEFT"><strong>EMPLOYEE NAME</strong></td> 
	 <td width="16%" height="33"  align="center" class="headerBOTTOMLEFT"><strong>DATE</strong></td>  
	 <td width="22%" height="33" align="center" class="headerBOTTOMLEFT"><strong>INCOME CODE </strong></td>	
	 <td width="15%" height="33" align="center" class="headerBOTTOMLEFTRIGHT" ><strong>AMOUNT</strong></td>	  
   </tr>
    ...
    <tr>
	 ...
	 <%if((i+8) < vRetResult.size() && !strCurrentId.equals(WI.getStrValue((String)vRetResult.elementAt(i+8),"")) ){ %>
	 <tr>
	 	<td colspan="4">&nbsp;</td>

    ...
    <tr> 
	 ...
	 %>
		...
		%>
			...
			<%=strTemp%> Other Income Detail per Department <br />
   ...
   <!-- <tr>
	...
	<%
	 ...
	 if(i >= vRetResult.size()){ %>
		  <tr>
			  <td colspan="2">&nbsp;</td>
			  <td colspan="2" align="right" style="border-bottom:double #000000 3px" height="30"><strong>Grand Total : &nbsp; &nbsp;<%=CommonUtil.formatFloat(dGrandTotal,true)%></strong>&nbsp;</td>
    	</tr>
	<%} //end of last page %>

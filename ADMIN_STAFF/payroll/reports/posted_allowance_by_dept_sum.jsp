...
try
	{
		dbOP = new DBOperation(strUserId,
								"Admin/staff-Payroll-REPORTS-Payroll Register","posted_allowance_by_dept_sum.jsp");
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"posted_allowance_by_dept_sum.jsp");
...
%>
<body>
<form name="form_" 	method="post" action="posted_allowance_by_dept_sum.jsp">

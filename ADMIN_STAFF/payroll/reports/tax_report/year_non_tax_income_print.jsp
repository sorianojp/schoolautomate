...
<html>
<head>
<title>Print non taxable income for the year</title>
...
//end of authenticaion code.
	...
	if(WI.fillTextValue("show_total").length() > 0) 
		bolShowTotal = true;
		//System.out.println(bolShowTotal);
	...
	if (vRetResult != null) {
	    ...
	    if(vRetResult.size() % (16*iMaxRecPerPage) > 0) ++iTotalPages;
...
<tr>
  ...
  To</font></strong></td>
  <td class="thinborderTOP"><strong><font size="1">01/01/<%=WI.fillTextValue("year_of")%><br>12/31/<%=WI.fillTextValue("year_of")%></font></strong></td>
...
<tr> 
    ...
    <% 
		for(iCount = 1; iNumRec<vRetResult.size(); iNumRec+=16,++iIncr, ++iCount){
		i = iNumRec;

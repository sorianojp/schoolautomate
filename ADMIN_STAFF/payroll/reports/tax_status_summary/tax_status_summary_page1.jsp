...
<form name="form_" 	method="post" action="./tax_status_summary_page1.jsp">
<%
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
    ...
    <tr> 
      <td height="18"><div align="right"><font size="2"> Number of Employees Per 
          ...
          <select name="num_rec_page">
			...
			System.out.println(WI.getStrValue(request.getParameter("num_rec_page"),"20"));
			System.out.println("a");
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td width="5%" height="25" align="center" class="thinborder"><font size="1"><strong>COUNT 
      NO.</strong></font></td>
      <td width="12%" align="center" class="thinborder"><font size="1"><strong>EMPLOYEE ID</strong></font></td>
      <td width="42%" align="center" class="thinborder"><font size="1"><strong>EMPLOYEE NAME</strong></font></td>
      <td width="18%" align="center" class="thinborder"><font size="1"><strong>TAX STATUS</strong></font></td>
      <td width="9%" align="center" class="thinborder"><font size="1"><strong>NO. OF ELIGIBLE 
      DEPENDENTS</strong></font></td>
      ...
      <td class="thinborder"><font size="1">&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),
        ...
        <%
				...
				strDependent = (String)vRetResult.elementAt(i+6);
					...
					System.out.println("y");
				%>
      <td class="thinborder">&nbsp;<%=astrTaxStatus[Integer.parseInt(strStatus)]%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue(strDependent,"0")%></td>
      <td align="right" class="thinborder"><%=(String)vRetResult.elementAt(i+7)%>&nbsp;&nbsp;</td>
    </tr>
    <%}%>
  </table>
  <%}%>  

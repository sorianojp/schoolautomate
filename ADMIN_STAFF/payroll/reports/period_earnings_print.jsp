...
int i = 0;	
  ...
  vRetResult = RptPay.getPeriodEarnings(dbOP);
	...
	strEarningName = WI.fillTextValue("earning_name");
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">    
    ...
    <tr>
      <td height="18">&nbsp;</td>
			...
			%>
      <td><div align="center"><strong><%=(WI.getStrValue(strEarningName,"")).toUpperCase()%> <br>
      </strong></div></td>
      <td>&nbsp;</td>
    </tr>		
    ...
    <tr>
		...
		%>
      <td height="18" colspan="3" valign="bottom"><div align="center"><strong><%=WI.getStrValue(strTemp)%></strong></div></td>
    </tr>
  </table>  
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">  
  <tr>
  ...
  <tr>
    <td width="13%">&nbsp;</td>
    <td width="5%" height="21" class="thinborderLEFT"><div align="right"><%=iIncr%>.&nbsp;</div></td>
	<td width="49%">&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),

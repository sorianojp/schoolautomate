...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./report_schedule72old_print.jsp" />
<% return;}
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr > 
      <td height="25" colspan="2"><div align="center"><font color="#000000" size="1" ><strong>Schedule 
          ...
          withholding Tax but subject to Income Tax</strong></font></div></td>
    </tr>
  </table>
...
<%if (vRetResult != null && vRetResult.size() > 1){%>	
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="47%" height="30"> 
        <input type="checkbox" name="BIR_format" value="1">
      Print BIR Format</td>
      <td width="53%">Number of Employees Per Page: 
  ...
  <table bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td style="font-size: 9px;"><div align="right"><%=WI.getStrValue((Double)vRetResult.elementAt(i+6),"&nbsp;")%>&nbsp;</div></td>

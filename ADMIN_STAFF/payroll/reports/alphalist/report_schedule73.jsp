...
<html>
<head>
<title>Report Schedule 7.3</title>
...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./report_schedule73_print.jsp" />
<% return;}
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="100%" height="30" align="right"><font size="2">Number of Employees Per Page: </font>
        ...
        <a href="javascript:PrintPg();"> <img src="../../../../images/print.gif" border="0"></a>        click to print list</td>
    </tr>
  </table>
  <table bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td width="7%" rowspan="3">SEQ<br>
      NO</td>
      <td width="7%" rowspan="3">TIN</td>
    ...
    <tr>
      <td width="6%" height="14" align="center" >13th Month &amp; Other 
          Benefits</td>
      <td width="6%" align="center" >De Minimis Benefits </td>
      ...
      <td width="6%" align="center">Total Non-Taxable/Exempt Compensation Income</td>
    ...
    <%for(int i = 0; i < vRetResult.size(); i +=58, iIncr++){%>
    <tr>
      <td><%=iIncr%></td> 
      <td height="20"><%=WI.getStrValue((String)vRetResult.elementAt(i+2),"&nbsp;")%></td>
    ...
    <%for(int i = 0; i < vRetResult.size(); i +=58, iIncr2++){%>
    <tr>
      <td><%=iIncr2%></td> 
			<%

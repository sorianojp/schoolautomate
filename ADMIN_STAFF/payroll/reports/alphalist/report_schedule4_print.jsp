...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Post Deductions","report_schedule4_print.jsp");
...
<form action="report_schedule4_print.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr > 
      <td height="16" colspan="2" valign="bottom"><div align="center"><font color="#000000" size="1" ><strong>Schedule 
          4   Alphalist of Payees Subject to Expanded Withholding Tax (Reported 
          Under Form 2307)</strong></font></div></td>
    </tr>
  </table>

...
function CancelRecord(){
	location = "report_schedule_4.jsp?emp_id="+document.form_.emp_id.value+"&year_of="+document.form_.year_of.value+"&user_index="+document.form_.user_index.value;
}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-TAX Schedules-Schedule 4","report_schedule_4.jsp");
...
<form action="report_schedule_4.jsp" method="post" name="form_">

...
<html>
<head>
<title>Report Schedule 7.5</title>
...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./report_schedule75_print.jsp" />
<% return;}
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-TAX Schedules-Schedule7.5","report_schedule75.jsp");
...
<%if (vRetResult != null && vRetResult.size() > 1){%>	
    ...
    <tr> 
      <td width="100%" height="30" align="right"><font size="2">Number of Employees Per Page: </font>
        <select name="num_rec_page">
          <% iDefault = Integer.parseInt(WI.getStrValue(request.getParameter("num_rec_page"),"1"));
				for(int i = 2; i <= 45 ; i++) {
					if ( i == iDefault) {%>
  ...
  <table bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="6%" rowspan="4" align="center" nowrap>Region No.<br> 
      where<br>
      Assigned </td>
    ...
    <tr>
      ...
      <td align="center" >Basic/ SMW </td>
      <td align="center" >Holiday Pay </td>
      <td align="center" >Overtime Pay </td>
      <td align="center" >Night Shift Differential </td>
      <td align="center" >Hazard Pay </td>
      ...
      <td width="6%" align="center" >Total Taxable (Previous Employer) </td>
    </tr>
    <%
			int iCount = 1;
			for(int i = 0; i < vRetResult.size(); i +=58, iCount++){
			vPrevEmpSal = (Vector)vRetResult.elementAt(i+50);
			//System.out.println("vPrevEmpSal " + vPrevEmpSal);
		%>
    <tr>
      <td ><%=iCount%></td> 
  ...
  <br>
    ...
    <tr>
      <td width="3%" align="center" >From</td>
      <td width="3%" align="center" >To</td>
      <td width="3%" align="center" >Gross Compensation Income </td>
      <td width="3%" align="center" >Basic SMW Per Day </td>
      <td width="3%" align="center" >Basic SMW Per Month </td>
      <td width="3%" align="center" >Basic SMW Per Year </td>
      <td width="3%" align="center" >Factor Used (No. Of Days/Year) </td>
      <td align="center" >Holiday Pay </td>
      <td align="center" >Overtime Pay </td>
      <td align="center" >Night Shift Differential </td>
      <td align="center" >Hazard Pay </td>
    ...
    <tr>
      <td height="14" ><%=iCount%></td> 
			...
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+51), true)%></td>
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+52), true)%></td>
			<td align="right" >&nbsp;</td>
			<td align="right" >&nbsp;</td>
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+23), true)%></td>
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+24), true)%></td>
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+25), true)%></td>
			<td align="right" ><%=CommonUtil.formatFloat((String)vRetResult.elementAt(i+26), true)%></td>
    ...
    <tr>
      ...
      <td width="6%" rowspan="2" align="center">Premium Paid on Health and/or Hospital Insurance</td>
      <td width="4%" rowspan="2" align="center">Net Taxable Compensation Income </td>
      <td width="4%" rowspan="2" align="center">Tax Due<br>
        (JAN. - DEC.)</td>
      <td width="6%" rowspan="2" align="center" >TAX WITHHELD<br>
        (JAN. - NOV.)</td>
      <td colspan="2" align="center" >YEAR - END ADJUSTMENT</td>
      <td width="6%" rowspan="2" align="center" >Amount of Tax Withheld as Adjusted</td>

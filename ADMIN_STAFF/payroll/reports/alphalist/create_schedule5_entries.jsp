...
function goback(strYearOf){
	location = "report_schedule_5.jsp?year_of="+strYearOf;
}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-REPORTS-Post Deductions","create_schedule5_entries.jsp");
...
<form action="create_schedule5_entries.jsp" method="post" name="form_">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
	  ...
	  %>
      <td width="73%" height="27" colspan="2"> 
			<select name="classification" onChange="reloadPage();">

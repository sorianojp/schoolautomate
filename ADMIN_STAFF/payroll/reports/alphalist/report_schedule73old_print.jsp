...
<%if (vRetResult != null && vRetResult.size() > 0){%>	
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+11),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+4),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+15),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+12),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+5),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=WI.getStrValue((Double)vRetResult.elementAt(iLoop+6),"&nbsp;")%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+7),"&nbsp;"),true)%>&nbsp;</td>
      <%if (WI.fillTextValue("BIR_format").length() == 0){%>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+8),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+9),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+10),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+13),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" class="thinborderBottomLeftRight"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(iLoop+14),"&nbsp;"),true)%>&nbsp;</td>
      <%}%>
    </tr>
    <%}%>
    <%	
    ...
    %>
    <tr> 
      <td  class="thinborderBottom" height="10" colspan="17">&nbsp;</td>
    </tr>
    <tr> 
      ...
      <td class="thinborder">&nbsp;</td>
      <td class="thinborder">&nbsp;</td>
      <td align="right" class="thinborderLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(1),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(0),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(2),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(3),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(4),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(5),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(6),"&nbsp;"),true)%></td>
      <%if (WI.fillTextValue("BIR_format").length() == 0){%>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(7),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(8),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(9),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(10),"&nbsp;"),true)%></td>
      <td align="right" class="thinborderBottomLeft"><%=CommonUtil.formatFloat(WI.getStrValue((String)vTotal.elementAt(11),"&nbsp;"),true)%></td>
      <%}%>
    </tr>
    <tr> 
      <td colspan="17" class="thinborder" ><div align="center"> 
    ...
    <%}else{%>
    <tr> 
      <td  class="thinborder" height="18" colspan="17"><hr color="#000000" size="1" ></td>
    </tr>
    <%}%>
  </table>

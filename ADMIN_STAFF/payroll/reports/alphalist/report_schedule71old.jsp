  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="23" colspan="2" align="center"><font size="1">From Whom 
          Taxes Have Been Witheld for the Taxable Year </font></td>
    </tr>
    <tr> 
...
<%if (vRetResult != null && vRetResult.size() > 1){%>	
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="100%" height="30"><div align="right">Number of Employees Per 
          Page: 
  ...
  <table bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td width="6%" align="right" ><font size="1">13th Month &amp; Other 
          Benefits</font></td>
      <td width="6%" align="right" ><font size="1">SSS, PHIC,Pag-Ibig and 
          Union Dues</font></td>
      <td width="6%" align="right" ><font size="1">Salaries &amp; Other Compensation</font></td>
      <td width="6%" align="right" ><font size="1">13th Month &amp; Other 
          Benefits</font></td>
      <td width="6%" align="right" ><font size="1">Salaries COLA &amp; Others</font></td>
      <td width="5%" align="right" ><font size="1">Amount of Exemption</font></td>
      <td width="6%" align="right" ><font size="1">Health &amp; Hospital 
          Premium</font></td>
      <td width="6%" align="right" ><font size="1">Tax Due (Jan-Dec)</font></td>
      <td width="6%" align="right" ><font size="1">Tax Witheld (Jan-Nov)</font></td>
      <td width="5%" align="right" ><font size="1">Tax Witheld (Dec)</font></td>
      <td width="6%" align="right" ><font size="1">Tax Refund to Employees</font></td>
      <td width="6%" align="right" ><font size="1">Amount of Tax Withheld 
          as Adjusted</font></td>
    </tr>
    <%for(int i = 1; i < vRetResult.size(); i +=18){%>
    <tr> 
      ...
      <td align="right" style="font-size: 9px;"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+6),"&nbsp;"),true)%>&nbsp;</td>
      <td align="right" style="font-size: 9px;"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+17),"&nbsp;"),true)%>&nbsp;</td>
      ...
      <td align="right" style="font-size: 9px;"><%=WI.getStrValue((Double)vRetResult.elementAt(i+8),"&nbsp;")%>&nbsp;</td>
      ...
      <td align="right" style="font-size: 9px;"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+16),"&nbsp;"),true)%>&nbsp;</td>
    </tr>
    <%}%>
  </table>

...
function CancelRecord(){
	location = "schedule_5.jsp?emp_id="+document.form_.emp_id.value+"&year_of="+document.form_.year_of.value+"&user_index="+document.form_.user_index.value;
}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","schedule_5.jsp");
...
%>
<body bgcolor="#D2AE72">
<form action="schedule_5.jsp" method="post" name="form_">

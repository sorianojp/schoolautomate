...
function Cancel(strYearOf) {
	location = "create_schedule4_entries.jsp?year_of="+strYearOf;
}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","create_schedule4_entries.jsp");
...
<form action="create_schedule4_entries.jsp" method="post" name="form_">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="28"><div align="right">Number of Payess Per Page: 

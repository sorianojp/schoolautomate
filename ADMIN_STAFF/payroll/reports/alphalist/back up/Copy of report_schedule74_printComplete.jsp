...
<form name="form_">
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="100%" height="23" colspan="2" valign="top"><div align="center"><font size="1">Form 
...
<%if (vRetResult != null && vRetResult.size() > 0){%>	
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td colspan="3"><div align="center"><font size="1">.... TAXABLE....</font></div></td>
      <td colspan="3">&nbsp;</td>
      <td class="thinborderBottomLeft" colspan="2"><div align="center">Tax Witheld<br>
          (Jan-Nov)</div></td>
      <td colspan="2"><div align="center"><font size="1">Year-end Adjustment</font></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td width="5%" height="14" class="thinborderBottom"><div align="center">TIN</div></td>
      <td class="thinborderBottom" width="5%" ><div align="left">Last Name</div></td>
      <td class="thinborderBottom" width="6%" ><div align="left">First Name</div></td>
      <td class="thinborderBottom" width="6%" ><div align="left">Middle Name</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">13th Month &amp; 
          Other Benefits</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">SSS, PHIC, Pag-Ibig 
          and Union Dues</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Salaries and 
          Other Comp</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">13th Month &amp; 
          Other Benefits</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Salaries COLA 
          &amp; Others</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Total Taxable 
          (Prev Employer)</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">13th Month &amp; 
          Other Benefits</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">SSS, PHIC, Pag-Ibig 
          and Union Dues</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Salaries and 
          Other Comp</div></td>
      <td class="thinborderBottom" width="3%" ><div align="right">13th Month &amp; 
          Other Benefits</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Salaries COLA 
          &amp; Others</div></td>
      <td class="thinborderBottom" width="4%" ><div align="center">Total Taxable 
          (Prev &amp; Present Employer)</div></td>
      <td class="thinborderBottom" width="3%" ><div align="center">Amount of Exemption</div></td>
      <td class="thinborderBottom" width="3%" ><div align="center">Health &amp; 
          Hospital Premium</div></td>
      <td class="thinborderBottom" width="3%" ><div align="right">Tax Due<br>
          (Jan-Dec)</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Previous Employer</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Present Employer</div></td>
      <td class="thinborderBottom" width="3%" ><div align="right">Tax Witheld 
          (Dec)</div></td>
      <td class="thinborderBottom" width="3%" ><div align="right">Tax Refund to 
          Employees</div></td>
      <td class="thinborderBottom" width="4%" ><div align="right">Amount of Tax 
          Withheld as Adjusted</div></td>
    </tr>
    <%for(int i = 0; i < vRetResult.size(); i +=23){%>
    <tr> 
      <td class="thinborderBottomLeft"height="14"><%=WI.getStrValue((String)vRetResult.elementAt(i),"&nbsp;")%></td>
      ...
      <td class="thinborderBottomLeft"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+18),"&nbsp;"),true)%>&nbsp;</div></td>
      ...
      <td class="thinborderBottomLeft"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+20),"&nbsp;"),true)%>&nbsp;</div></td>
      ...
      <td class="thinborderBottomLeft"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+16),"&nbsp;"),true)%>&nbsp;</div></td>
      <td class="thinborderBottomLeft"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+17),"&nbsp;"),true)%>&nbsp;</div></td>
      <td class="thinborderBottomLeft"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+21),"&nbsp;"),true)%>&nbsp;</div></td>
      <td class="thinborderBottomLeftRight"><div align="right"><%=CommonUtil.formatFloat(WI.getStrValue((Double)vRetResult.elementAt(i+22),"&nbsp;"),true)%>&nbsp;</div></td>
    </tr>
    <%}%>
  </table>

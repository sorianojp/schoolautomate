...
function ajaxGetExemption(){
	var vTaxStat = document.form_.tax_status.value;
	var objExemption = document.form_.tot_exemption;
	setEIP(false);
	this.InitXmlHttpObject(objExemption, 1);//I want to get innerHTML in this.retObj
		if(this.xmlHttp == null) {
		alert("Failed to init xmlHttp.");
		return;
	}

	var strURL = "../../../../Ajax/AjaxInterface.jsp?methodRef=313&tax_stat="+vTaxStat+
								"&tax_year="+document.form_.year_of.value;
	this.processRequest(strURL);
}
...
function computeNonTaxableTotal(){
	...
	//document.form_.non_taxable.value = truncateFloat(eval(vNonTaxTotal), 2, false);
	document.form_.non_taxable.value = roundOffFloat(eval(vNonTaxTotal), 2);
...
function computeGross(){
	...
	document.form_.gross_income.value = roundOffFloat(eval(vNonTaxable)+ eval(vTaxable), 2);
...
function computeGrossTaxable(){
	...
	document.form_.gross_taxable.value = roundOffFloat(eval(vPreviousTaxable)+ eval(vPresentTaxable), 2);;
...
function computeNetTaxable(){
	...
	var vNet = "0";
//	alert("vGross " + vGross);
//	alert("vExemption " + vExemption);
//	alert("vHealthPrem " + vHealthPrem);
	...
	document.form_.net_taxable.value = roundOffFloat(eval(vNet), 2);
 	//ajaxComputeTax();
}
...
function computeWithheld(){
	...
	document.form_.total_withheld.value = roundOffFloat(vTotal,2);
}
...
try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","form_2316.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(vEmpInfo == null)
		...
		if(vEditInfo != null && vEditInfo.size() > 0){
			...
			if(((String)vEmpInfo.elementAt(35)).equals("1"))
				bolIsMWE = true;
		}
  }
%>
...
<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="23" colspan="3"><font size="1"><a href="alphalist_main.jsp"><img src="../../../../images/go_back.gif" border="0" ></a></font>&nbsp;<font size="2" color="#FF0000"><%=WI.getStrValue(strErrMsg,"")%></font></td>
    </tr>
    <tr>
	...
	<td width="50%" bgcolor="#999999">
		...
		<%
			if(vEditInfo != null && vEditInfo.size() > 0){
				...
				strTemp = WI.fillTextValue("mmdd_from");
			}
			strTemp = WI.getStrValue(strTemp, "0101");
		%>
		<td width="20%" align="center">
					<input type="text" maxlength="4" size="3" style="font-size:14px;"
					name="mmdd_from" onFocus="style.backgroundColor='#D3EBFF'"
				  value="<%=strTemp%>" onBlur="style.backgroundColor='white'"></td>
		...
		<%
			if(vEditInfo != null && vEditInfo.size() > 0){
				...
				strTemp = WI.fillTextValue("mmdd_to");
			}
			strTemp = WI.getStrValue(strTemp, "1231");
		%>
		<td width="20%" align="center"><input type="text" maxlength="4" size="3" style="font-size:14px;"
					name="mmdd_to" onFocus="style.backgroundColor='#D3EBFF'"
				  value="<%=strTemp%>" onBlur="style.backgroundColor='white'"></td>
		</tr>
		</table>	</td>
</tr>
...
<tr valign="top" bgcolor="#999999">
	...
	<td rowspan="20">
 	<table width="100%" border="0" cellpadding="0" cellspacing="0">
		...
		<tr>
			<td height="29" valign="top"><b>A</b></td>
		...
		<tr valign="top">
		  ...
		  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','basic_sal_ntax');computeNonTaxableTotal();"
			onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','basic_sal_ntax');" style="text-align:right;"></td>
		</tr>
		<tr valign="top">
			<td width="4%" height="32">33</td>
			<td width="49%">Holiday Pay (MWE)</td>
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo && bolIsMWE)
						strTemp = (String)vEmpInfo.elementAt(16);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','holiday_pay');computeNonTaxableTotal();"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','holiday_pay');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo && bolIsMWE)
						strTemp = (String)vEmpInfo.elementAt(17);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','ot_non_taxable');computeNonTaxableTotal();"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','ot_non_taxable');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%" height="34">35</td>
			<td width="49%">Night Shift Differential (MWE)</td>
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo && bolIsMWE)
						strTemp = (String)vEmpInfo.elementAt(18);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','np_pay');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','np_pay');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo && bolIsMWE)
						strTemp = (String)vEmpInfo.elementAt(36);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','hazard_non_tax');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','hazard_non_tax');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(19);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','bonus_non_tax');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','bonus_non_tax');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(20);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','de_minimis');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','de_minimis');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%">39</td>
			<td width="49%">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(21);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','contributions');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','contributions');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNonTaxableTotal();AllowOnlyFloat('form_','other_comp');"
		onKeyUp="computeNonTaxableTotal();AllowOnlyFloat('form_','other_comp');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
          ...
          <tr>
            <td width="85%"><font size="1">Total Non-Taxable/Exempt<br/>
						Compensation Income
						</font></td>
            <td width="15%"><a href="javascript:computeNonTaxableTotal();">Compute</a></td>
          </tr>
        </table>
			</td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','basic_taxable');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','basic_taxable');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					strTemp = (String)vEditInfo.elementAt(41);
 					...
 					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(23);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','representation');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','representation');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					strTemp = (String)vEditInfo.elementAt(42);
 					...
 					if(bolHasEmpInfo && !bolIsMWE)
						strTemp = (String)vEmpInfo.elementAt(24);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','transportation');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','transportation');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(25);
					else
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','cola'); "
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','cola');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%" height="34">46</td>
			<td width="49%">Fixed Housing Allowance</td>
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(26);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','housing_allow');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','housing_allow');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td><b>47</b></td>
		...
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(31);
					else
						strTemp = WI.fillTextValue("regular_desc_a");
				}
			%>
			<td width="49%"><input name="regular_desc_a" type="text" size="20" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
			<td width="5%" align="right">47A</td>
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					strTemp = (String)vEditInfo.elementAt(46);
				}else{
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(32);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','regular_amt_a');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','regular_amt_a');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(33);
					else
						strTemp = WI.fillTextValue("regular_desc_b");
				}
			%>
			<td width="49%"><input name="regular_desc_b" type="text" size="20" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
			<td width="5%" align="right">47B</td>
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					strTemp = (String)vEditInfo.elementAt(48);
				}else{
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(34);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','regular_amt_b');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','regular_amt_b');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
		  <td height="15">&nbsp;</td>
		...
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(27);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','commission');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','commission');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(28);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF';" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','profit_share');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','profit_share');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%" height="33">50</td>
			<td width="49%">
			Fees Including Director's<br/>
			Fees</td>
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(29);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','fees');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','fees');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%" height="33">51</td>
			<td width="49%">
			Taxable 13th Month Pay<br/>
			and Other Benefits</td>
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(30);
					else
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','bonus_taxable');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','bonus_taxable');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','hazard_taxable');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','hazard_taxable');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%">53</td>
			<td width="49%">
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','hazard_taxable');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','ot_taxable');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td height="19"><b>54</b></td>
			<td colspan="3">Others (Specify)</td>
		</tr>
		<tr valign="top">
			...
			%>
			<td width="49%"><input name="sup_desc_a" type="text" size="20" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
			<td width="5%" align="right">54A</td>
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','sup_amt_a');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','sup_amt_a');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			...
			%>
			<td width="49%"><input name="sup_desc_b" type="text" size="20" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
			<td width="5%" align="right">54B</td>
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeTaxableTotal();AllowOnlyFloat('form_','sup_amt_b');"
		onKeyUp="computeTaxableTotal();AllowOnlyFloat('form_','sup_amt_b');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="4%">55</td>
			<td width="49%">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="85%"><font size="1">Total Taxable Compensation<br/>Income</font></td>
            <td width="15%"><a href="javascript:computeTaxableTotal();">Compute</a></td>
          </tr>
        </table>
			</td>
...
<tr bgcolor="#999999">
	...
	<tr>
		...
		<input name="emp_name" type= "text" class="textbox_noborder"  value="<%=WI.getStrValue(strTemp)%>"
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		...
		<%
			...
			if(strTemp == null || strTemp.length() == 0) {
				strTemp = "select rdo_code from pr_form_2316 where form_tax_index = (select max(form_tax_index) from pr_form_2316 where rdo_code is not null)";
...
<tr bgcolor="#999999">
	...
	<tr>
		...
		<td>
		<img src="images/arrow.jpg" width="6" height="7" />
		<input name="reg_address" type= "text" class="textbox"  value="<%=WI.getStrValue(strTemp)%>"
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		size="50" style="font-size:9px;"></td>
		<%
			if(vEditInfo != null && vEditInfo.size() > 0){
...
<tr bgcolor="#999999">
	...
	&nbsp;&nbsp;&nbsp;
	<input name="dob" type="text" size="12" maxlength="12" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	...
	&nbsp;&nbsp;&nbsp;
	<input name="tel_no" type="text" size="20" value="<%=WI.getStrValue(strTemp)%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"></td>
    </tr>
  </table></td>
    </tr>
<tr bgcolor="#999999">
	...
	<tr>
			<%
 			...
 			%>
		<td><select name="tax_status" onChange="ajaxGetExemption();">
      ...
      <tr>
				<%
					if(vEditInfo != null && vEditInfo.size() > 0){
						...
						strTemp = WI.fillTextValue("is_wife_claiming");
					}
					...
					if(strTemp.equals("1"))
						...
						strTemp = "";
				%>
        <td width="34%" align="right"><input type="radio" name="is_wife_claiming" value="1" <%=strTemp%>></td>
        <td width="25%">Yes</td>
				<%
					if(strTemp.length() == 0)
						strTemp = "checked";
						...
						strTemp = "";
				%>
        <td width="8%" align="right"><input type="radio" name="is_wife_claiming" value="0" <%=strTemp%>></td>
        <td width="33%">No</td>
      </tr>
    </table></td>
	  </tr>
	...
	<td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" height="18">			</td>
			...
			if(vDepInfo != null && vDepInfo.size() > 0)
				...
				strTemp = "";
			%>
			<input name="bday_1" type="text" size="10" maxlength="10" value="<%=strTemp%>" class="textbox"
		  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
			<br>
			<%
			if(vDepInfo != null && vDepInfo.size() > 4)
				...
				strTemp = "";
			%>
			<input name="bday_2" type="text" size="10" maxlength="10" value="<%=strTemp%>" class="textbox"
		  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
			  <br>
			  <%
			if(vDepInfo != null && vDepInfo.size() > 8)
				...
				strTemp = "";
			%>
			  <input name="bday_3" type="text" size="10" maxlength="10" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
			  <br>
			  <%
			if(vDepInfo != null && vDepInfo.size() > 12)
				...
				strTemp = "";
			%>
			  <input name="bday_4" type="text" size="10" maxlength="10" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
...
<tr bgcolor="#999999">
	<td>
		...
		<tr valign="top">
			...
			if(strTemp == null || strTemp.length() == 0) {
				strTemp = "select MIN_WAGE_DAY from pr_form_2316 where form_tax_index = (select max(form_tax_index) from pr_form_2316 where MIN_WAGE_DAY > 0)";
				strTemp= dbOP.getResultOfAQuery(strTemp, 0);
			}
		...
		<tr valign="top">
			...
			if(strTemp == null || strTemp.length() == 0) {
				strTemp = "select MIN_WAGE_MONTH from pr_form_2316 where form_tax_index = (select max(form_tax_index) from pr_form_2316 where MIN_WAGE_MONTH > 0)";
				strTemp= dbOP.getResultOfAQuery(strTemp, 0);
			}
				strTemp = CommonUtil.formatFloat(strTemp, true);
				strTemp = ConversionTable.replaceString(strTemp, ",", "");
		...
		<tr valign="top">
			...
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					if(bolHasEmpInfo)
						strTemp = (String)vEmpInfo.elementAt(35);
					else
			...
			%>
			<input type="hidden" name="is_mwe" value="<%=strTemp%>">
			<td width="7%"><%=strTemp2%></td>
...
<tr bgcolor="#999999" valign="top">
	<td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','non_taxable_');" <%=!strSchCode.startsWith("DBTC")?"readonly":""%> onKeyUp="AllowOnlyFloat('form_','non_taxable_');"	style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="3%">23</td>
		...
		%>
		  ...
		  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','present_taxable_');" <%=!strSchCode.startsWith("DBTC")?"readonly":""%> onKeyUp="AllowOnlyFloat('form_','present_taxable_');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="3%">24</td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onKeyUp="AllowOnlyIntegerExtn('form_','prev_taxable', '.');computeGrossTaxable();"
		...
		style="text-align:right;" <%=!strSchCode.startsWith("DBTC")?"readonly":""%> ></td>
		</tr>
		<tr valign="top">
			<td width="3%">25</td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		...
		<tr valign="top">
			...
			%>
			<td width="38%" align="right">
			<input name="health_premium" type="text" size="18" value="<%=strTemp%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';computeNetTaxable();AllowOnlyFloat('form_','health_premium');"
		onKeyUp="AllowOnlyFloat('form_','health_premium');computeNetTaxable();" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="3%">28</td>
	  ...
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AllowOnlyFloat('form_','tax_due');"
		onKeyUp="AllowOnlyFloat('form_','tax_due');" style="text-align:right;" ></td>
		</tr>
		<tr valign="top">
			<td width="3%">30</td>
			<td colspan="3"><font size="1">
...
<tr>
	...
	<%
		if(vEditInfo != null && vEditInfo.size() > 0){
			...
			strTemp = WI.fillTextValue("signatory_ctc");
		}
	%>
	<td width="384">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>56</b>
	  <input name="signatory_ctc" type= "text" class="textbox"  value="<%=WI.getStrValue(strTemp)%>"
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		size="50" style="font-size:9px;">
	  <br/>
	...
	<%
		if(vEditInfo != null && vEditInfo.size() > 0){
			...
			strTemp = WI.fillTextValue("ee_date_sign");
		}
	%>
...
<tr>
	<td colspan="2" align="center"><b>To be accomplished under substituted filing</b>	</td>
</tr>
<tr valign="top">
	<td>
     ...
     <tr>
			<%
				if(vEditInfo != null && vEditInfo.size() > 0){
					...
					strTemp = WI.fillTextValue("signatory_head");
				}
			%>
       <td align="center">58
         <input name="signatory_head" type= "text" class="textbox"  value="<%=WI.getStrValue(strTemp)%>"
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		size="50" style="font-size:9px;"></td>
     </tr>
     <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    click to save form 2316 values of employee
		<%}else{
			strTemp = WI.getStrValue((String)vEditInfo.elementAt(69), "0");
			if(strTemp.equals("0")){
...
to delete saved 2316
		<%}else{%>
			Tax Schedule is already finalized. Update not allowed
		  <%}
			}%>
	...
	<%if(vEditInfo != null && vEditInfo.size() > 0){%>
  <tr>
    <td><a href="javascript:PrintPg();"><img src="../../../../images/print.gif" border="0"></a> click to print form </td>
  </tr>
	<%}%>
</table>
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">

...
function AddEarning(strEarningIndex){
	document.form_.donot_call_close_wnd.value = "1";
	document.form_.add_earning.value = "1";
	document.form_.earning_index.value = strEarningIndex;
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","edit_misc_earning.jsp");
...
PRMiscEarnings MiscEarnings = new PRMiscEarnings(request);
...
String strAddEarning = WI.fillTextValue("add_earning");
String strEarningIndex = WI.fillTextValue("earning_index");

if (strAddEarning.equals("1")){
	if(MiscEarnings.operateOnLateEarnings(dbOP, strEarningIndex) == false)
		strErrMsg = "Operation not successful";
}

vRetResult = MiscEarnings.getLateEncodedEarnings(dbOP,WI.fillTextValue("sal_index"));
if(vRetResult == null && strErrMsg == null)
	strErrMsg = MiscEarnings.getErrMsg();

%>
<body bgcolor="#D2AE72" onUnload="ReloadMain();" class="bgDynamic">
<form action="edit_misc_earning.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" class="footerDynamic"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          PAYROLL: MISC. EARNINGS : POST EARNINGS PAGE ::::</strong></font></div></td>
    </tr>
</table>
...
%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="26" colspan="3" bgcolor="#B9B292" class="thinborder"><div align="center"><strong>LIST 
          OF POSTED MISCELLANEOUS EARNINGS</strong></div></td>
    </tr>
    <tr> 
      <td width="36%" height="28" class="thinborder"><div align="center"><strong><font size="1">EARNING 
          NAME</font></strong></div></td>
      <td width="17%" class="thinborder"><div align="center"><font size="1"><strong>AMOUNT</strong></font></div></td>
      <td width="14%" class="thinborder"><div align="center"><font size="1"><strong>OPTION</strong></font></div></td>
    </tr>
    <% int iRow = 0;
    ...
    <tr> 
      ...
      <td class="thinborder"><div align="center"><font size="1"><a href='javascript:AddEarning("<%=(String)vRetResult.elementAt(i)%>");'><img src="../../../images/add.gif" width="42" height="32" border="0"></a></font></div></td>
    </tr>
    <%} //end for loop%>
  </table>
...
<input type="hidden" name="add_earning">
<input type="hidden" name="earning_index">

...
<html>
<head>
<title>Misc. Deduction posting (Restricted Employees)</title>
...
if( prd.hasRestrictionToMiscDeduction(dbOP,strAuthID) == false){ System.out.println("No Restriction");%>
	<jsp:forward page="post_ded.jsp" />
<%}else
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr bgcolor="#A49A6A">
		<td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>::::
		 MISC. DEDUCTIONS : POST DEDUCTIONS PAGE - RESTRICTED::::</strong></font></td>
	</tr>
</table>	
  ...
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="78%"><select name="deduct_index" id="deduct_index">
          <%	
		  String strDeductionQuery = " from pr_misc_ded_restrict_list join PRELOAD_DEDUCTION on (pr_misc_ded_restrict_list.pre_deduct_index = PRELOAD_DEDUCTION.PRE_DEDUCT_INDEX) where pr_misc_ded_restrict_list.is_del = 0 and user_index = "+strAuthID+" order by pre_deduct_name";	
          ...
          <%=dbOP.loadCombo("PRELOAD_DEDUCTION.PRE_DEDUCT_INDEX","PRE_DEDUCT_NAME", strDeductionQuery,strTemp,false)%>
        </select>
				<%if(iAccessLevel > 1){%>

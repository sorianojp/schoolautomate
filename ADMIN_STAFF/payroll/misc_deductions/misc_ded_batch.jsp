...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions (Batch)","misc_ded_batch.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prEdtrME.operateOnMiscDedByBatch(dbOP, request, Integer.parseInt(strPageAction)) == null){
...
<form action="misc_ded_batch.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        MISCELLANEOUS DEDUCTION SET BY BATCH PAGE ::::</strong></font></td>
    </tr>
</table>
      ...
      <td height="10">&nbsp;</td>
			<%
				if(WI.fillTextValue("inc_resigned").length() > 0)
					...
					strTemp = "";
			%>
      <td height="10" colspan="2"><input name="inc_resigned" type="checkbox" value="1"<%=strTemp%> onClick="ReloadPage();">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr>
      ...
      <td width="10%" align="center" class="thinborder"><strong><font size="1">AMOUNT</font><font size="1"><strong> <br>
    ...
    <% 	int iCount = 1;
	   ...
	   for (i = 0; i < vRetResult.size(); i+=15,iCount++){
		 	if(vRetResult.elementAt(i + 8) != null && ((String)vRetResult.elementAt(i + 8)).equals("1")){
    ...
    <tr <%=strTDColor%>>
      ...
      <td height="25" class="thinborder"><font size="1"><strong>&nbsp;&nbsp;<%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),
			...
			<input type="hidden" name="user_<%=iCount%>" value="<%=(String)vRetResult.elementAt(i)%>">
 			<input type="hidden" name="post_ded_index_<%=iCount%>" value="<%=vRetResult.elementAt(i+9)%>">			

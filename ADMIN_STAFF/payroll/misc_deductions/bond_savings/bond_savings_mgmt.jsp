...
function ViewDetail(strDedIndex, strEmpIndex, strEmpID){
	var loadPg = "recurring_ledger.jsp?misc_ded_index="+strDedIndex+
							 "&deduction_name="+document.form_.deduction_name.value+
							 "&emp_id="+strEmpID+"&user_index="+strEmpIndex+
							 "&view_all=1&popup=1";	
	var win=window.open(loadPg,"recurring_ledger",'dependent=yes,width=650,height=375,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();
}
...
function CopyName(){
	if (document.form_.misc_ded_index.selectedIndex != 0) 
		document.form_.deduction_name.value= 
			document.form_.misc_ded_index[document.form_.misc_ded_index.selectedIndex].text;
}
</script>
<%
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./bond_savings_mgmt_print.jsp"/>
	<% 
return;}
...
<form action="bond_savings_mgmt.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        BOND / SAVINGS BALANCE  PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <%
			...
			%>
      <td width="77%"><select name="misc_ded_index" onChange="ReloadPage();">
    ...
    <tr>
      ...
      <td><input name="emp_id" type="text" size="16"maxlength="128" value="<%=WI.fillTextValue("emp_id")%>"
											onKeyUp="AjaxMapName(1);" class="textbox">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="20" colspan="5" align="center" bgcolor="#B9B292" class="thinborder"><strong>RESULT</strong></td>
    </tr>
    <tr>
      ...
      <td width="12%" align="center" class="thinborder">DETAIL</td>
    </tr>
    <% 	int iCount = 1;
    ...
    <tr>
      ...
      <%
			...
			<td align="center" class="thinborder"><a href="javascript:ViewDetail('<%=WI.fillTextValue("misc_ded_index")%>', 
																																					 '<%=vRetResult.elementAt(i)%>',
																																					 	'<%=vRetResult.elementAt(i+1)%>')"><strong>VIEW</strong></a></td>
    </tr>
    <%} //end for loop%>

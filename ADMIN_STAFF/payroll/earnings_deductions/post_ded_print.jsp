...
<html>
<head>
<title>Print Posted Earnings Deduction</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
  <tr> 
    <td height="26" colspan="6" align="center" class="thinborder"><strong>LIST 
      OF POSTED EARNING DEDUCTIONS</strong></td>
  </tr>
  <tr> 
    <td width="22%" align="center" class="thinborder"><strong><font size="1">DEDUCTION 
    NAME</font></strong></td>
    <td width="25%" height="28" align="center" class="thinborder"><font size="1"><strong>PERIOD</strong></font></td>
  ...
  <tr> 
    ...
    <td width="20%" align="right" class="thinborder"><font size="1"><%=(String)vRetResult.elementAt(i+10)%>&nbsp;</font></td>
    <td width="20%" align="center" class="thinborder"><font size="1"><%=(String)vRetResult.elementAt(i+6)%></font></td>
    <td width="18%" height="25" class="thinborder"><font size="1">&nbsp;<%=(String)vRetResult.elementAt(i+8)%></font></td>
  </tr>
  <%} //end for loop%>
</table>

...
<html>
<head>
<title>View/Earnings Deduction</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-MISC. DEDUCTIONS-Post Deductions","view_edit_ded.jsp");
...
String strSaveMisc = WI.getStrValue(WI.fillTextValue("savemisc"),"0");
String strEmpID = WI.getStrValue(WI.fillTextValue("emp_id"),"0");
String strSalIndex = WI.getStrValue(WI.fillTextValue("sal_index"),"0");
if (strSaveMisc.equals("1")){
	vRetResult = Salary.operateOnEarnDed(dbOP,request);	
}else{
	vRetResult = Salary.getPeriodEarnDed(dbOP,strSalIndex);
	if(vRetResult == null && strErrMsg == null)
		strErrMsg = Salary.getErrMsg();
}
%>
<body bgcolor="#D2AE72" onUnload="ReloadMain();" class="bgDynamic">
<form action="view_edit_ded.jsp" method="post" name="form_">
...
if (vRetResult != null &&  vRetResult.size() > 0) {
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td height="26" colspan="4" align="center" bgcolor="#B9B292" class="thinborder"><strong>LIST 
      OF POSTED EARNING DEDUCTIONS</strong></td>
    </tr>
    <tr> 
      <td width="18%" height="28" align="center" class="thinborder"><strong><font size="1">DEDUCTION 
      NAME</font></strong></td>
      <td width="3%" align="center" class="thinborder"><font size="1"><strong>AMOUNT</strong></font></td>
      <td width="4%" align="center" class="thinborder"><font size="1"><strong>AMOUNT 
      PAYABLE</strong></font></td>
      <td width="7%" align="center" class="thinborder"><font size="1"><strong>AMOUNT 
    ...
    <tr> 
      ...
      <td align="right" class="thinborder"><font size="1"><%=(String)vRetResult.elementAt(i+1)%> 
    ...
    <tr> 
      <td height="25"  colspan="3" bgcolor="#FFFFFF"><div align="center">
	   <a href='javascript:SaveData();'>
	  	<img src="../../../images/save.gif" border="0" id="hide_save">	   </a>

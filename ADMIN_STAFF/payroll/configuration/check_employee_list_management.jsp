<%@ page language="java" import="utility.*,java.util.Vector, payroll.PayrollConfig" buffer="16kb"%>
<%
...
<html>
<head>
<title>Employee List Management</title>
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0){
		vRetResult = prConfig.operateOnEmployeeListForCheck(dbOP, request, Integer.parseInt(strTemp));
		if(vRetResult == null)
	...
	if(WI.fillTextValue("searchEmployee_").length() > 0){
		vRetResult = prConfig.operateOnEmployeeListForCheck(dbOP,request,4);
...
<form action="check_employee_list_management.jsp" name="form_" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
      PAYROLL: EMPLOYEE LIST MANAGEMENT ::::</strong></font></td>
    </tr>
</table>
    ...
    <tr>
	 ...
	 <tr> 
      ...
      <td height="10" colspan="4">
			<%
				strTemp = WI.fillTextValue("without_check");
				...
				if(strTemp.compareTo("1") == 0) 
					...
					strTemp = "";	
			%>
        <input type="radio" name="without_check" value="1"<%=strTemp%> onClick="ReloadPage();">
View Employees with Check 
<%
	if(strTemp.length() == 0) 
		strTemp = " checked";
	else
		strTemp = "";
	%>
<input type="radio" name="without_check" value="0"<%=strTemp%> onClick="ReloadPage();">
View Employees without Check </td>
    </tr>   
    <tr>
			<%
   ...
   <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="25" colspan="7" align="center">
			...
			<%if((WI.fillTextValue("without_check")).equals("1")){
					if(iAccessLevel == 2){%>

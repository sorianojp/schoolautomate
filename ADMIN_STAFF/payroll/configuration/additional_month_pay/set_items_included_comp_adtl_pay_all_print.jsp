...
<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      ...
      <td height="26" class="thinborderBOTTOM"><strong>ITEMS</strong></td>
    </tr>
...
%>
    <tr> 
      <td height="25" colspan="2" class="thinborder" > <font color="#0000FF"> 
        &nbsp; 
        ...
        </font><%=" :: " + astrOBI[Integer.parseInt(WI.getStrValue((String)vRetResult.elementAt(j+3),"3"))]/* O B I */%> 
        <%=WI.getStrValue((String)vRetResult.elementAt(j+5)," (",")","")/*sub - type*/%> 

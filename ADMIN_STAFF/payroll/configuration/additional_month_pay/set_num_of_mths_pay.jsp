...
function CancelRecord(){
	location ="./set_num_of_mths_pay.jsp";
}
...
if (WI.fillTextValue("print_page").length() > 0){ %>
	<jsp:forward page="./set_num_of_mths_pay_print.jsp" />
<% return;}
...
if (strPrepareToEdit.length() > 0){
	vEditInfo = pr.operateOnAddMonthPay(dbOP,request,3);
	if (vEditInfo == null)
		strErrMsg = pr.getErrMsg();
}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" class="footerDynamic"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          PAYROLL: SET ADDITIONAL MONTH PAY PARAMETERS PAGE ::::<br>
          <font size="1">(NUMBER OF MONTHS FOR ADDITIONAL MONTH PAY)</font></strong></font></div></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="25" colspan="3"><a href="addtl_mth_pay_main.jsp"><img src="../../../../images/go_back.gif" border="0"></a> 
    ...
    <tr> 
      <td height="25">&nbsp;</td>
      <td>Number of Months for Additional Month Pay : 
        <%	if(vEditInfo!=null) strTemp= WI.getStrValue((String)vEditInfo.elementAt(3));
	else strTemp= WI.fillTextValue("add_month_pay");%> <input onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" value="<%=strTemp%>" 
	  name="add_month_pay" type="text" size="5" maxlength="5" class="textbox" onKeyUp="AllowOnlyFloat('form_','add_month_pay')"> 
      </td>
      <td width="19%">&nbsp;</td>
    </tr>
    <tr> 
      <td height="35">&nbsp;</td>
      <td width="75%" height="35" valign="bottom"> <div align="center"> 
          <% if (iAccessLevel > 1) {
	  if (vEditInfo == null) {%>
      ...
      <td height="35" valign="bottom"><font size="1">&nbsp;</font></td>
    </tr>
    <tr> 
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="25" colspan="4" align="center" bgcolor="#B9B292">NUMBER 
      OF MONTHS FOR ADDITIONAL MONTH PAY</td>
    </tr>
    <tr> 
      <td width="289" height="26" align="center"><font size="1"><strong>EFFECTIVITY 
      DATE</strong></font></td>
      <td align="center"><strong><font size="1">NUMBER OF MONTHS FOR ADDITIONAL 
      MONTH PAY</font></strong></td>
...
<% for (int i=0; i < vRetResult.size(); i+=4){%>
    <tr> 
      ...
      <td width="341" align="center">&nbsp;<%=WI.getStrValue((String)vRetResult.elementAt(i+3), "", " months","")%></td>
      <td width="67" align="center"> <% if (iAccessLevel > 1) {%>
        ...
        NA 
        <%}%></td>
      <td width="79" align="left"> <% if (iAccessLevel == 2) {%>

...
<html>
<head>
<title>Salary Floor Setting</title>
...
if (WI.fillTextValue("print_page").length() > 0){%>
	<jsp:forward page="./sal_floor_setting_print.jsp" />
	<% 
return;}
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Configuration-Floor Salary","sal_floor_setting.jsp");
...
String[] astrStatus = {"Part-Time","Full-Time",""};
	if(bolIsSchool)
		...
		strTemp = "Division";
String[] astrSortByName    = {"Employee ID","Period name",strTemp, "Department/Office"};
String[] astrSortByVal     = {"id_number","period_name","info_faculty_basic.c_index","info_faculty_basic.d_index"};
int i = 0;
if(strPageAction.length() > 0){
	if(prConfig.operateOnSalaryFloor(dbOP, request, Integer.parseInt(strPageAction)) == null){
		strErrMsg = prConfig.getErrMsg();
	} else {
		if(strPageAction.equals("1"))
			strErrMsg = "Floor setting successfully posted.";		
		if(strPageAction.equals("0")){
			strErrMsg = "Floor setting successfully removed.";		
		}			
	}
}
...
<form name="form_" method="post" action="./sal_floor_setting.jsp">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: FLOOR SALARY  SETTING PAGE ::::</strong></font></td>
    </tr>
</table>
...
View with Salary floor setting
<%
	if(strTemp.length() == 0) 
		strTemp = " checked";
	else
...
View Employees without Salary floor setting</td>
    </tr>
    <tr>
      <td height="11">&nbsp;</td>
      <td height="11" colspan="2"><%
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">    
    ...
    <tr bgcolor="#ffff99" class="thinborder">
      <td width="10%" align="center" class="thinborder"><strong><strong>EMPLOYEE ID </strong></strong></td> 
      ...
      <td align="center" class="thinborder"><strong>AMOUNT<br>
    ...
    <tr bgcolor="#FFFFFF" class="thinborder">
      ...
      <td height="25" class="thinborder" >&nbsp;<font size="1"><strong><%=WI.formatName((String)vRetResult.elementAt(i+2), (String)vRetResult.elementAt(i+3),
			...
			<%
				if(vRetResult.elementAt(i + 5) == null || vRetResult.elementAt(i + 6) == null)
					...
					strTemp = "-";
			%>
      <td width="37%" class="thinborder" ><%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"")%><%=strTemp%><%=WI.getStrValue((String)vRetResult.elementAt(i + 6),"&nbsp;")%> </td>
			<%
				strTemp = "";
      ...
      <td width="9%" align="center" class="thinborder" >        <input type="checkbox" name="save_<%=iCount%>" value="1" checked tabindex="-1">      </td>
    </tr>
    <%} // end for loop%>
    ...
    <tr bgcolor="#A49A6A">
      <td height="24"  colspan="3" class="footerDynamic">&nbsp;</td>
    </tr>
  </table>	

<%@ page language="java" import="utility.*, java.util.Vector, payroll.PRFaculty" %>
<%
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Configuration-Faculty Term Type","faculty_salary_setting.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	PRFaculty prConfig = new PRFaculty();
	int iSearchResult = 0;
	int i = 0;
	if(bolIsSchool)
		strTemp = "College";
	...
	if(strPageAction.length() > 0){
		if(prConfig.operateOnFacultySalarySetting(dbOP, request, Integer.parseInt(strPageAction)) == null){
	...
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prConfig.operateOnFacultySalarySetting(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = prConfig.getErrMsg();
		else
...
<form action="faculty_salary_setting.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: FACULTY SALARY COMPUTATION SETTING PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><select name="search_salary_type" onChange="ReloadPage();">
				<option value="">ALL</option>
        <%if (WI.fillTextValue("search_salary_type").equals("0")){%>
        <option value="0" selected>DEDUCTION BASED</option>
        <%}else{%>
        <option value="0">DEDUCTION BASED</option>
        <%}if (WI.fillTextValue("search_salary_type").equals("1")){%>
        <option value="1" selected>WORK BASED</option>
        <%}else{%>
...
View Employees without  salary type </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="2">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr bgcolor="#ffff99" class="thinborder">
      ...
      <%if(WI.fillTextValue("with_schedule").equals("1")){%>
			<td width="8%" align="center" class="thinborder"><strong>SALARY TYPE </strong></td>
			<%}%>
    ...
    <tr>
      <td height="30" colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="18%">New SALARY TYPE </td>
            <td width="82%"><select name="salary_type">
               <option value="0">DEDUCTION BASED</option>
              <%if (WI.fillTextValue("salary_type").equals("1")){%>
              <option value="1" selected>WORK BASED</option>
              <%}else{%>
              <option value="1">WORK BASED</option>
              <%}%>

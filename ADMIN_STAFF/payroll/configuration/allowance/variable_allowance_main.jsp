...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr> 
    ...
    <td width="71%"><a href="./variable_allowance.jsp?is_cola=0"> 
      Variable Allowances List</a></td>
  </tr>
  <tr> 
    <td height="26">&nbsp;</td>
    <td height="26">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./variable_allowance_set.jsp">Variable 
      Allowances Management</a></td>
  </tr>
  <tr>
    <td height="26">&nbsp;</td>
    <td height="26">&nbsp;</td>
    <td align="center">&nbsp;</td>
    <td><a href="./employee_allowances.jsp">Employee Allowances</a></td>
  </tr>
  <tr> 
    <td height="25">&nbsp;</td>
    <td height="25">&nbsp;</td>

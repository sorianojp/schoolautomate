...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Configuration-Faculty Term Type","faculty_term_type.jsp");
...
else if(iAccessLevel == 0)//NOT AUTHORIZED.
{
	...
	if(strPageAction.length() > 0){
		if(prConfig.operateOnEmpTerm(dbOP, request, Integer.parseInt(strPageAction)) == null){
	...
	if(WI.fillTextValue("searchEmployee").length() > 0){
	  vRetResult = prConfig.operateOnEmpTerm(dbOP,request, 4);
		if(vRetResult == null)
			strErrMsg = prConfig.getErrMsg();
		else
...
<form action="faculty_term_type.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: FACULTY TERM TYPE SETTING PAGE ::::</strong></font></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <%
		String strTermType = WI.fillTextValue("search_term_type");
	%>    
    <tr>
      <td height="24">&nbsp;</td>
      <td>Term Type</td>
      <td><select name="search_term_type" onChange="ReloadPage();">
...
View Employees without  term type </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="2">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr bgcolor="#ffff99" class="thinborder">
      ...
      <%if(WI.fillTextValue("with_schedule").equals("1")){%>
			<td width="8%" align="center" class="thinborder"><strong>TERM TYPE </strong></td>
			<%}%>
    ...
    <tr>
      <td height="30" colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td width="18%">Save Term Type</td>
            <td width="82%"><strong><font size="1">
              <select name="term_type">
                <%if(strTermType == null || strTermType.length() < 1 || strTermType.equals("1")){%>

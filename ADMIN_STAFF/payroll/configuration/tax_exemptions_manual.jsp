...
function CancelRecord(){
	location = "./tax_exemptions_manual.jsp";
}
...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-CONFIGURATION-Tax exemption","tax_exemptions_manual.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	String[] astrExemptionName    = {"Zero", "Single","Head of Family", 
																	 "Head of Family 1 Dependent (HF1)",  "Head of Family 2 Dependents (HF2)",
																	 "Head of Family 3 Dependents (HF3)",  "Head of Family 4 Dependents (HF4)", 
																	 "Married Employed", "Married Employed 1 Dependent (ME1)", 
																	 "Married Employed 2 Dependents (ME2)", "Married Employed 3 Dependents (ME3)", 
																	 "Married Employed 4 Dependents (ME4)", "Dependent"};
	String[] astrExemptionVal     = {"0","1","2","21","22","23","24","3","31","32","33","34","10"};
...
%>
<form name="form_" action="./tax_exemptions_manual.jsp" method="post">
...
%>	  
      <td height="30"> 
			<input name="exempt_amt" type="text" size="16" maxlength="16" value="<%=WI.getStrValue(strTemp,"0")%>">
    ...
    <tr>
      ...
      <td height="30">Maximum Limit </td>
			...
			%>				
      <td height="30"><input name="max_limit" type="text" size="2" maxlength="2" value="<%=WI.getStrValue(strTemp,"0")%>">
    ...
    <tr> 
	  ...
	  <font size="1">click to cancel/clear entries</font>		<font size="1">&nbsp;</font>
		<%}%>
		</td>      
	  </tr>
    <tr> 
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
	...
	for (int i = 0; i < vRetResult.size(); i +=6){
		strDependent = null;
		strTaxStatus = (String)vRetResult.elementAt(i);
	%>
    <tr> 
      <td height="25">&nbsp; 
				        <% 
...
&nbsp;        (maximum = <%=(String)vRetResult.elementAt(i+2) %>)
        ...
        <%
				...
				%>
        <%=astrExemptionType[Integer.parseInt(strTaxStatus)]%><%=WI.getStrValue(strDependent," "," Dependent(s)","")%>
				<%}%>     
      </td>
    ...
    <tr> 
      ...
      <td colspan="2" align="center"><strong><font size="1">OPTIONS</font></strong></td>
		...
		for (int i = 0; i < vHistory.size(); i +=6){
			strDependent = null;
			strTaxStatus = (String)vHistory.elementAt(i);
		%>
    <tr> 
      <td height="25">&nbsp;
        <%

...
<html>
<head>
<title>New Pag Ibig Contribution </title>
...
function CancelRecord(){
	location ="./pagibig_contribution_new.jsp";
}
</script>
<%
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-CONFIGURATION-Pagibig Table","pagibig_contribution_new.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0) {
		if(prConfig.operateOnPBIGTableNew(dbOP, request, Integer.parseInt(strTemp)) == null)
...
if(strPrepareToEdit.compareTo("1") == 0) {
	vEditInfo = prConfig.operateOnPBIGTableNew(dbOP, request,3);
	if(vEditInfo == null)
		strErrMsg = prConfig.getErrMsg();
}

	vRetResult  = prConfig.operateOnPBIGTableNew(dbOP, request,4);
	if(vRetResult == null && strErrMsg == null)
		strErrMsg = prConfig.getErrMsg();
%>
<body bgcolor="#D2AE72" class="bgDynamic">
<form action="./pagibig_contribution_new.jsp" method="post" name="form_">
...
//	strTemp = WI.fillTextValue("tot_contribution");%> 
     <input name="tot_contribution" type="text" size="8" maxlength="10" value="<%=WI.getStrValue(strTemp)%>" 
      ...
      (Percent of Total Monthly Compensation) </td>
    </tr>
	-->
    <tr>
      <td height="25">&nbsp;</td>
      <td height="25" colspan="2">Monthly Compensation <br>
      (Basic Salary + COLA) </td>
      <td height="25">
	  <%
		if(vEditInfo != null && vEditInfo.size() > 0) 
			strTemp = (String)vEditInfo.elementAt(2);
...
<input name="range_2" type="text" size="8" maxlength="10" value="<%=WI.getStrValue(strTemp)%>" 
	...
	<input name="share_e" type="text" size="8" maxlength="10" value="<%=WI.getStrValue(strTemp)%>" 
	   ...
	   <!--
		...
		-->	   <font size="1">(% of monthly Compensation)</font></td>
    </tr>
    <tr> 
      <td height="24">&nbsp;</td>
      <td height="24">&nbsp;</td>
	...
	<input name="max_share_e" type="text" size="8" maxlength="10" value="<%=WI.getStrValue(strTemp)%>" 
		...
		onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;"
		style="text-align : right">
	<font size="1">(Maximum fixed amount)</font></td>
    </tr>
    <tr> 
      <td height="10">&nbsp;</td>
      <td height="10">&nbsp;</td>
	...
	<input name="max_share_self" type="text" size="8" maxlength="10" value="<%=WI.getStrValue(strTemp)%>" 
		class="textbox" onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"
		onKeypress=" if(event.keyCode<46 || event.keyCode== 47 || event.keyCode > 57) event.returnValue=false;"
		style="text-align : right">	 <font size="1">(Maximum fixed amount)</font></td>
    </tr>
    <tr> 
      <td height="10">&nbsp;</td>
      <td height="10" colspan="2">&nbsp;</td>
    ...
    <tr> 
      <td height="35" colspan="4" align="center"><font size="1"> 
        ...
        <%}%>
        <!--
					<a href="./pagibig_contribution_new.jsp"><img src="../../../images/cancel.gif" border="0"></a> 
					-->
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="25" colspan="9" align="center" bgcolor="#B9B292" class="thinborder">PAG-IBIG 
          CONTRIBUTIONS FOR EMPLOYED MEMBERS </td>
    </tr>
    <tr> 
      <td width="14%" height="25" align="center" class="thinborder"><font size="1"><strong>EFFECTIVITY 
      DATE </strong></font></td>
      <td width="15%" align="center" class="thinborder"><font size="1"><strong>MONTHLY COMPENSATION</strong></font></td>
      <td width="15%" align="center" class="thinborder"><font size="1"><strong>TOTAL PAG-IBIG 

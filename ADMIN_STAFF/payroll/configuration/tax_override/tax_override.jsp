...
<html>
<head>
<title>Tax Override Setting</title>
...
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-Configuration-Tax Override","tax_override.jsp");
...
<form action="tax_override.jsp" method="post" name="form_">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" align="center" class="footerDynamic"><font color="#FFFFFF" ><strong>:::: 
        PAYROLL: TAX OVERRIDE SETTING PAGE ::::</strong></font></td>
    </tr>
</table>
...
View Employees w/out tax override setting </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10" colspan="2">
...
if(WI.fillTextValue("sort_by3_con").compareTo("desc") ==0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr bgcolor="#ffff99" class="thinborder">
      ...
      <td width="11%" align="center" class="thinborder"><strong>VALUE<br>
    ...
    <%} //end for loop%>
    <tr>
      <td height="25" colspan="7">Note: <strong><font size="1">Zero tax  is allowed. Just set the value to zero. 
        Blank  fields will be ignored</font></strong></td>
    </tr>
    <tr>
			<%
				strTemp = WI.fillTextValue("is_amount");
				if(strTemp.equals("1"))
					strTemp = "checked";
				else
					strTemp = "";
			%>
      <td height="25" colspan="7"><input type="checkbox" name="is_amount" value="1" <%=strTemp%>>
      Save the value as amount(If unchecked, saved value will be in percent)</td>
    </tr>
    <tr>
      <td height="25" colspan="7">
          ...
          <input type="button" name="cancel" value=" Cancel " style="font-size:11px; height:28px;border: 1px solid #FF0000;" onClick="javascript:CancelRecord();">
						<font size="1"> click to cancel or go previous</font></div>
					<%}%>				
			</td>
    </tr>

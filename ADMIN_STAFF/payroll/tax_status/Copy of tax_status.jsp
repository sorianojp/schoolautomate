...
//add security here.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Payroll-SALARY RATE","salary_rate.jsp");
	...
	if(strTemp.length() > 0) {
		...
		if(prTaxStat.operateOnTaxStatus(dbOP, request, Integer.parseInt(strTemp)) == null)
			...
			if(strTemp.compareTo("1") == 0)
				strErrMsg = "Tax Status Information successfully added.";
			if(strTemp.compareTo("2") == 0)
				strErrMsg = "Tax Status Information successfully edited.";
			if(strTemp.compareTo("0") == 0)
				strErrMsg = "Tax Status Information successfully removed.";
		}
	}
...
<form action="./tax_status.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="2" class="footerDynamic"><div align="center"><font color="#FFFFFF" ><strong>::::
          PAYROLL : TAX STATUS PAGE ::::</strong></font></div></td>
    </tr>
  </table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <input type="button" name="proceed_btn" value=" Proceed " style="font-size:11px; height:28px;border: 1px solid #FF0000;" onClick="javascript:ReloadPage();"><label id="coa_info"></label>
	  </td>
    </tr>
  </table>
<%
...
%>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td height="25" colspan="3"><a href="javascript:UpdateDependentTStat();"><img src="../../../images/update.gif" border="0" ></a>
        <font size="1">click to update dependents eligible for tax exemption</font></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
    ...
    <tr bgcolor="#97ABC1">
      <td height="25" colspan="6"><div align="center"><strong><font color="#FFFFFF">CURRENT
          DEPENDENT TAX STATUS</font></strong></div></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      <%
	  ...
	  %>
      <td height="25" colspan="3">Tax Status : <strong><%=astrConvertTaxStat[Integer.parseInt(strTemp)]%></strong></td>
    ...
    <%
 for(int i = 0; vDependentInfo != null && i < vDependentInfo.size(); i += 5) {%>
    <tr>
      <td height="25">&nbsp;</td>

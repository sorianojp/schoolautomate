...
<script language="javascript">
	...
	function PrintPg(){
		document.form_.for_printing.value = "1";
...
<%
	...
	if(WI.fillTextValue("for_printing").length() > 0){%>
		<jsp:forward page="./print_inventory_property.jsp" />
...
<%}%>
	...
	<input type="hidden" name="for_printing"/>
</form>
</body>
</html>
<%

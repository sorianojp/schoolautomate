		...
		<tr>
			...
			<td width="17%">Type: </td>
				<%
					...
					//else
					strTemp += " and is_book_type = "+WI.fillTextValue("is_book_type");
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="10%" align="center" class="thinborder"><strong>Quantity of Order</strong></td>
			<td width="6%" align="center" class="thinborder"><strong>Available Qty</strong></td>
			<td width="7%" align="center" class="thinborder"><strong>Qty Returned to Prop</strong></td>
			<td width="6%" align="center" class="thinborder"><strong>Defective Qty</strong></td>
			<td width="6%" align="center" class="thinborder"><strong>Unpaid Unreleased</strong></td>

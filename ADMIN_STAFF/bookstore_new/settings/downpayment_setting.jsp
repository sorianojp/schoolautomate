...
<%
	...
	if(WI.fillTextValue("page_action").length() > 0){
		...
		strSQLQuery = " update bs_book_expire_setting set downpayment="+WI.fillTextValue("_limit") +
	...
	if(strSQLQuery == null)		
		strErrMsg = "Book Downpayment not set.";
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./downpayment_setting.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: BOOK DOWNPAYMENT SETTING ::::</strong></font></div></td>
		</tr>
		<tr>
    ...
    <tr>
      <td>&nbsp;</td>
      <td>Current Book Downpayment</td>
      <td>Downpayment Setting</td>
    </tr>
    <tr>
      <td width="13%">&nbsp;</td>
      <td width="34%">&nbsp;<%=strSQLQuery%> %</td>
...
if(iAccessLevel == 2){%>    <tr>
      ...
      <td><input type="image" onClick="UpdateBookExpiration();" src="../../../images/update.gif">
        <font size="1">Click to update downpayment</font></td>
    </tr>
<%}%>
    <tr>
      <td height="22">&nbsp;</td>

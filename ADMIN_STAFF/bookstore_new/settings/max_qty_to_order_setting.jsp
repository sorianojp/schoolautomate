...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"BOOKSTORE-PROPERTY","max_qty_to_order_setting.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(WI.fillTextValue("add_items").length() > 0){
		if(!bl.updateMaxQtyToOrder(dbOP, request))
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./max_qty_to_order_setting.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: MAX QUANTITY TO ORDER SETTINGS ::::</strong></font></div></td>
		</tr>
		<tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="9%" align="center" class="thinborder"><strong>Max Qty</strong></td>
...
<%}%>
	...
	<input type="hidden" name="set_max_qty" value="1" />
</form>
</body>
</html>
<%

...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"BOOKSTORE-BOOK MANAGEMENT","book_supply_log_main.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<form name="form_" action="./book_supply_log_main.jsp" method="post">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="2" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: BOOK SUPPLY LOG ::::</strong></font></div></td>
		</tr>
	</table>
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
		...
		<tr>
		    ...
		    <td width="2%">&nbsp;</td>
		    <td width="68%"><a href="add_books.jsp">Add Books</a></td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		    <td height="25"><a href="view_delete_book_logs.jsp">View/Delete Book Logs</a></td>
		</tr>
		<tr>
			<td height="25" colspan="2">&nbsp;</td>
		    <td height="25"><a href="view_book_logs_history.jsp">Supply Log History</a></td>
		</tr>
		<tr>

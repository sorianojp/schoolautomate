...
<%
	...
	if(bolIsCIT){%>
		<jsp:forward page="./print_orderlist_new.jsp" ></jsp:forward>
	<% return;}
...
<%
	...
	if(vRetResult != null && vRetResult.size() > 0){
		...
		if(strTemp.equals("0")){
			if(!bo.operateOnOrderPrinting(dbOP,request,1,strOrderIndex))
				strErrMsg = bo.getErrMsg();
		}else if(strTemp.equals("1")){
			if(!bo.operateOnOrderPrinting(dbOP,request,2,strOrderIndex))
				strErrMsg = bo.getErrMsg();
		}
		////////////////////////////////////////////////////////////////////////////////
	...
	<%	int iCount = 1;
		...
		<tr>
			...
			<td><%=iQty%></td>
			<%
				//dTotal += Double.parseDouble(WI.fillTextValue("excess"));
				//dDownPayment2 = dTotal;
	...
	<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
		<tr>
			...
			double dPercent = Double.parseDouble(strTemp)/100;			

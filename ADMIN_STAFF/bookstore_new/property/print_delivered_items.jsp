...
<title>Print Delivered Items</title></head>
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"BOOKSTORE-PROPERTY MANAGEMENT","print_delivered_items.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="">
	...
	<tr><td height="20"><div align="center">LIST OF ITEMS DELIVERED</div></td></tr>	
</table>

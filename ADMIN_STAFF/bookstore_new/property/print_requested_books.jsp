...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"BOOKSTORE-PROPERTY MANAGEMENT","print_requested_books.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
...
<%}if(vRetResult != null && vRetResult.size() >0 && strErrMsg==null){%>
	...
	<tr>
		...
		<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			<tr>
				<td height="20" bgcolor="" colspan="10" class=""><div align="center">
					LIST OF REQUESTED BOOKS &nbsp; &nbsp; SY <%=WI.fillTextValue("sy_from")%>-<%=WI.fillTextValue("sy_to")%>
...
%>		
		<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
			...
			<tr>	
				...
				<td align="" class="thinborder"><%=vRetResult.elementAt(i+15)%></td>						

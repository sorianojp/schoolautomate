...
<script language="javascript">
	...
	function MoveInventory(){
		document.form_.move_inventory.value = '1';
		document.form_.search_books.value = '1';
		document.form_.submit();		
	}
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"BOOKSTORE-PROPERTY MANAGEMENT","move_prop_to_dist_inv.jsp");
	}
	catch(Exception exp){
		exp.printStackTrace();
		if(strErrMsg == null)
	...
	if(svhAuth == null)
		...
		iAccessLevel = Integer.parseInt(WI.getStrValue(svhAuth.get("BOOKSTORE-PROPERTY MANAGEMENT"),"0"));
		if(iAccessLevel == 0) {
	...
	if(WI.fillTextValue("move_inventory").length() > 0){
		if(!bm.isMovingQtyToDistribution(dbOP, request))
			strErrMsg = bm.getErrMsg();
		else
			strErrMsg = "Inventory has successfully move";
	}
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./move_prop_to_dist_inv.jsp" method="post">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="3" bgcolor="#A49A6A"><div align="center">
				<font color="#FFFFFF"><strong>:::: PROPERTY MANAGEMENT - MOVE INVENTORY ::::</strong></font></div></td>
		</tr>
		<tr>
...
<%if(vRetResult != null && vRetResult.size() > 0){%>
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="">
	<tr>
			<td align="right" colspan="9">
			<input type="button" name="request_book2" value="MOVE BOOK INVENTORY" 
					onclick="MoveInventory();" style="font-size:11px; height:28px;border: 1px solid #FF0000;" />
			</td>
		</tr>
	...
	<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			...
			<td width="16%" align="center" class="thinborder"><strong>Author</strong></td>
			<td width="17%" align="center" class="thinborder"><strong>Publisher</strong></td>
			<td width="10%" align="center" class="thinborder"><strong>Avail. Qty.</strong></td>			
			<td width="10%" align="center" class="thinborder"><strong>Item Code </strong></td>	
			<td width="10%" align="center" class="thinborder"><strong>Qty to Move</strong></td>
		...
		<tr>
			...
			<td class="thinborder" align="center">
				<input type="text" name="qty_<%=iCount%>" class="textbox" onfocus="style.backgroundColor='#D3EBFF'" 
					...
					onkeyup="AllowOnlyInteger('form_','qty_<%=iCount%>')" size="3" maxlength="5" value=""/></td>
...
<%}%>
	...
	<input type="hidden" name="move_inventory"  />
</form>
</body>
</html>
<%

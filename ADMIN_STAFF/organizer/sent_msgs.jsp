...
{
	location = "./send_msg.jsp?info_index="+strInfoIndex+"&pass_type="+strPassType+"&box_type=2"+"&viewAll=1";
}
</script>
<style>
a:link {
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Organizer-Message Board","sent_msgs.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
   <tr bgcolor="#DBEAF5">
	   <td width="2%" height="25" align="center"><strong><font size="1">	<img src="../../images/prior_h.gif" border="0"></font></strong></td>
	   <td width="25%"><div align="left"><strong><font size="1">To</font></strong></div></td>
	   <td width="30%"><div align="left"><strong><font size="1">Subject</font></strong></div></td>
	   <td width="24%"><div align="left"><strong><font size="1">Date</font></strong></div></td>
	   <td colspan="2">&nbsp;</td>
   </tr>
   <%for (int i = 0; i< vRetResult.size(); i+=12) {%>
   <tr>
	   <td class="thinborderBOTTOM" height="25" valign="top"><div align="center"><%if (((String)vRetResult.elementAt(i+5)).compareTo("1")==0){%>
   	<img src="../../images/prior_h.gif" border="0"><%}else{%>
   	<img src="../../images/prior_l.gif" border="0"><%}%></div></td>
	   <td class="thinborderBOTTOM"><font size="1">
	   <%=WI.getStrValue(((String)vRetResult.elementAt(i+2)),"SchoolBliz Users:&nbsp;","<br>","")%>
	   <%=WI.getStrValue(((String)vRetResult.elementAt(i+3)),"Other Mail:&nbsp;","","&nbsp")%>
	   </font></td>
	   <td class="thinborderBOTTOM"><%if (((String)vRetResult.elementAt(i+7)).compareTo("0")==0){%><strong>
	   <%=CommonUtil.truncateStr((String)vRetResult.elementAt(i+4),20,"...")%></strong><%}else{%>
	  <%=CommonUtil.truncateStr((String)vRetResult.elementAt(i+4),20,"...")%><%}%></td>
	   ...
	   <td width="10%" class="thinborderBOTTOM"><a href='javascript:Send("<%=(String)vRetResult.elementAt(i)%>","2")'>Send</a></td>

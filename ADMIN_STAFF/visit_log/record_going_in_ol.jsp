			...
			<td width="50%" valign="top">
				<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
					<tr>
						...
						strTemp = WI.fillTextValue("visitor_to_visit");
						if(strTemp.equals("1") || strTemp.length() == 0)
							strErrMsg = "checked";
						else
							strErrMsg = "";	
						%>
							<input type="radio" name="visitor_to_visit" value="1" <%=strErrMsg%> onClick="document.form_.submit()">Employee
						<%
						if(strTemp.equals("2")){
							strErrMsg = "checked";
							strVisitType = "2";
							...
							strErrMsg = "";	
						%>
							<input type="radio" name="visitor_to_visit" value="2" <%=strErrMsg%> onClick="document.form_.submit()">Department
						<%
						if(strTemp.equals("3")){
							strErrMsg = "checked";
							strVisitType = "3";
							...
							strErrMsg = "";	
						%>
							<input type="radio" name="visitor_to_visit" value="3" <%=strErrMsg%> onClick="document.form_.submit()">Event						</td>
			  	    </tr>
					<!--<tr>
					  	<td height="25">&nbsp;</td>
			...
			<%}else{%>
				<tr>
							<textarea name="event_name" cols="40" rows="1" class="textbox" onFocus="style.backgroundColor='#D3EBFF'" 
								onBlur="style.backgroundColor='white'"><%=WI.fillTextValue("event_name")%></textarea>
					</td>
				</tr>			

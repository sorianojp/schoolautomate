...
<script language="javascript">
	...
	var objCOA;
	var objCOAInput;
	function AjaxMapName(e, strFieldName, strLabelID) {//alert(e.keyCode);
...
if(bolIsETO)
	...
	String strStudIndex = null;//System.out.println(WI.fillTextValue("get_student_info"));
...
<form name="form_" action="student_personal_data.jsp" method="post">
...
<%if(!bolShowPartial) {%>
		<tr>
			<td height="25">&nbsp;</td>
			<td><a href="javascript:Redirect('student_socio_stat.jsp?stud_id=<%=WI.fillTextValue("stud_id")%>&stud_index=<%=strStudIndex%>')" style="text-decoration:none">Part III: Student's Socio-Economic Status</a></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
			<td><a href="javascript:Redirect('student_interest.jsp?stud_id=<%=WI.fillTextValue("stud_id")%>&stud_index=<%=strStudIndex%>')" style="text-decoration:none">Part IV: Student's Interest - Attitude Inventories</a></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
			<td><a href="javascript:Redirect('other_info.jsp?stud_id=<%=WI.fillTextValue("stud_id")%>&stud_index=<%=strStudIndex%>')" style="text-decoration:none">Pyschological Test Taken/Notes</a></td>
		</tr>
<%}%>
	</table>
<%}%>

...
boolean bolIsETO = new enrollment.SetParameter().bolIsETO(dbOP, (String)request.getSession(false).getAttribute("userIndex"));
	...
	//in here check in the new_application table bec. this is for the temp stud. new applicant
...
<script language="javascript">
	...
	function AjaxUpdateLastSchoolAttended(){	
		...
		var strURL = "../../../../Ajax/AjaxInterface.jsp?methodRef=20403&is_temp=1&user_=<%=strUserIndex%>&lsa="+escape(document.form_.last_school_attended[document.form_.last_school_attended.selectedIndex].value);
		this.processRequest(strURL);
	}
...
function Verify() {
	...
	if(document.form_.high_sch_name.value == "" || document.form_.high_year_grad.value == ""){
		strVerifyMsg += "\r\nSchools Attended(High School)";
		if(objToFocus == ""){
			if(document.form_.high_sch_name.value == "")
				objToFocus = "high_sch_name";
			else if(document.form_.high_year_grad.value == "")
				objToFocus = "high_year_grad";					
		}		
	}		
	
	if(document.form_.elem_sch_name.value == "" || document.form_.elem_year_grad.value == ""){
		strVerifyMsg += "\r\nSchools Attended(Elementary School)";
		
		if(objToFocus == ""){
			if(document.form_.elem_sch_name.value == "")
				objToFocus = "elem_sch_name";
			else if(document.form_.elem_year_grad.value == "")
				objToFocus = "elem_year_grad";						
		}			
	}	
...
<%	
	...
	Vector vRetResult = spd.getPart2InfoTemp(dbOP, request, strUserIndex);
	if(vRetResult == null)
...
<form name="form_" action="student_acad_info.jsp" method="post">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" colspan="4"><div align="center"><font color="#FFFFFF"><strong>:::: PART II: ACADEMIC INFORMATION - TEMPORARY STUDENT ::::</strong></font></div></td>
		</tr>
		<tr> 
					...
					<tr>
						<td height="25" width="40%">Scholarship (If any)
							<input name="scholarship" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(15))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','scholarship','1', document.form_.scholarship);">
						</td>
						<td width="60%">High School General Average: 
							<input name="hs_gen_ave" type="text" size="16" value="<%=WI.getStrValue((String)vRetResult.elementAt(16))%>" class="textbox" maxlength="6"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="AllowOnlyFloat('form_','hs_gen_ave');style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','hs_gen_ave','0', document.form_.hs_gen_ave);"></td>
					</tr>
					<tr>
						<td height="25" colspan="2">Are you working?
							<%
								if(((String)vRetResult.elementAt(0)).equals("1"))
									...
									strErrMsg = "";
							%>
							<input type="radio" name="is_working" value="1" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','is_working','0', document.form_.is_working[0]);">Yes
							<%
								if(((String)vRetResult.elementAt(0)).equals("2"))
									...
									strErrMsg = "";
							%>
							<input type="radio" name="is_working" value="2" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','is_working','0', document.form_.is_working[1]);">No
							&nbsp;&nbsp;
							...
							<input name="company_name" type="text" size="64" value="<%=WI.getStrValue((String)vRetResult.elementAt(1))%>" class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','company_name','1', document.form_.company_name);">
					  </td>
					</tr>
					<tr>
						<td height="25" colspan="2">Company Address 
							<input name="company_addr" type="text" size="64" value="<%=WI.getStrValue((String)vRetResult.elementAt(2))%>" class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','company_addr','1', document.form_.company_addr);">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							Company Tel no. 
							<input name="company_tel" type="text" size="16" value="<%=WI.getStrValue((String)vRetResult.elementAt(3))%>" class="textbox" maxlength="32"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','company_tel','1', document.form_.company_tel);"></td>
					</tr>
				</table>
			</td>
		</tr>
					...
					<tr>
						...
						<td>
							<select name="course_pref1" 
								onChange="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','course_pref1','0', document.form_.course_pref1);">
						...
						<td>
							<select name="course_pref2" 
								onChange="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','course_pref2','0', document.form_.course_pref2);">
								<option value="">Select Course</option>
								<%=dbOP.loadCombo("course_index","course_code"," from course_offered where is_valid = 1 and is_del = 0 "+
												" and is_offered = 1 and is_visible = 1 order by course_code ",strTemp,false)%>
							</select></td>
						...
						<td>
							<select name="course_pref3" 
								onChange="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','course_pref3','0', document.form_.course_pref3);">
								<option value="">Select Course</option>
								<%=dbOP.loadCombo("course_index","course_code"," from course_offered where is_valid = 1 and is_del = 0 "+
												" and is_offered = 1 and is_visible = 1 order by course_code ",strTemp,false)%>
							</select></td>
					...
					<tr>
						<td height="25">School Year:
							<input name="last_sch_yr" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(19))%>" class="textbox" maxlength="32"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','last_sch_yr','1', document.form_.last_sch_yr);"></td>
					</tr>
				</table>
			</td>
		</tr>
			...
			<td>
				<table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" border="0">
					...
					<tr>
						...
						%>
						<td>
							<select name="high_sch_name" style="font-size:10px; width:300px" onChange="javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','high_sch_name','1', document.form_.high_sch_name);">
								<option value=""></option>
						...
						<td>
							<input name="high_year_grad" type="text" size="4" maxlength="4" value="<%=WI.getStrValue((String)vTemp.elementAt(2))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'; javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','high_year_grad','1', document.form_.high_year_grad);"
								onKeypress=" if(event.keyCode<48 || event.keyCode > 57) event.returnValue=false;"></td>
						<td>
							<input name="high_grade_completed" type="text" size="28" maxlength="64" value="<%=WI.getStrValue((String)vTemp.elementAt(3))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','high_grade_completed','1', document.form_.high_grade_completed);"></td>
					</tr>
					<tr>
						<%
						strErrMsg = "";
						...
						%>
						<td>
							<select name="elem_sch_name" style="font-size:10px; width:300px" onChange="javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','elem_sch_name','1', document.form_.elem_sch_name);">
								<option value=""></option>
								<%=dbOP.loadCombo("sch_accredited.sch_name","sch_accredited.sch_name, sch_addr"," from sch_accredited where is_del=0 order by sch_accredited.sch_name",strTemp,false)%>
							</select></td>
						<td>
							<input name="elem_year_grad" type="text" size="4" maxlength="4" value="<%=WI.getStrValue((String)vTemp.elementAt(7))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','elem_year_grad','1', document.form_.elem_year_grad);"
								onKeypress=" if(event.keyCode<48 || event.keyCode > 57) event.returnValue=false;"></td>
						<td>
							<input name="elem_grade_completed" type="text" size="28" maxlength="64" value="<%=WI.getStrValue((String)vTemp.elementAt(8))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','elem_grade_completed','1', document.form_.elem_grade_completed);"></td>
					</tr>
					<tr>
					  <td height="25">Preschool</td>
						...
						%>
						<td>
							<select name="ps_sch_name" style="font-size:10px; width:300px" onChange="javascript:AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','ps_sch_name','1', document.form_.ps_sch_name);">
								<option value=""></option>
								<%=dbOP.loadCombo("sch_accredited.sch_name","sch_accredited.sch_name, sch_addr"," from sch_accredited where is_del=0 order by sch_accredited.sch_name",strTemp,false)%>
							</select></td>
						<td>
							<input name="ps_year_grad" type="text" size="4" maxlength="4" value="<%=WI.getStrValue((String)vTemp.elementAt(12))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','ps_year_grad','1', document.form_.ps_year_grad);"
								onKeypress=" if(event.keyCode<48 || event.keyCode > 57) event.returnValue=false;"></td>
						<td>
							<input name="ps_grade_completed" type="text" size="28" maxlength="64" value="<%=WI.getStrValue((String)vTemp.elementAt(13))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';AjaxUpdateOthers('application_index', '<%=strUserIndex%>','na_other_info','ps_grade_completed','1', document.form_.ps_grade_completed);"></td>
				  </tr>
				</table>
			</td>
		</tr>
					...
					<tr>
						...
						<td height="25" width="50%" <%=strErrMsg%>>Previous Course
							<input name="trans_prev_course" type="text" size="50" value="<%=WI.getStrValue((String)vRetResult.elementAt(17))%>" class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','trans_prev_course','1', document.form_.trans_prev_course);"></td>
						<%
						strErrMsg = "";
						...
						<td width="50%" <%=strErrMsg%>>School Year
							<input name="trans_sy" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(18))%>" class="textbox" maxlength="32"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','trans_sy','1', document.form_.trans_sy);"></td>
					</tr>
				</table>
			</td>
		</tr>
						...
						<td height="25" colspan="3">Have you ever stopped going to school before the end of the school year? 
							<%
								if(((String)vRetResult.elementAt(7)).equals("1"))
									...
									strErrMsg = "";
							%>
							<input type="radio" name="has_stopped" value="1" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','has_stopped','0', document.form_.has_stopped[0]);">Yes
							<%
								if(((String)vRetResult.elementAt(7)).equals("2"))
									...
									strErrMsg = "";
							%>
							<input type="radio" name="has_stopped" value="2" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','has_stopped','0', document.form_.has_stopped[1]);">No</td>
					</tr>
					<tr>
						...
						<td colspan="2">REASON 
							<input name="stop_reason" type="text" size="100" value="<%=WI.getStrValue((String)vRetResult.elementAt(8))%>" class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','stop_reason','1', document.form_.stop_reason);"></td>
					</tr>
					<tr>
						...
						<td width="50%">Grade you were in 
							<input name="stop_grade" type="text" size="48" value="<%=WI.getStrValue((String)vRetResult.elementAt(9))%>" class="textbox" maxlength="64"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','stop_grade','1', document.form_.stop_grade);"></td>
						<td width="35%">School Year
							<input name="stop_sy" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(10))%>" class="textbox" maxlength="64"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','stop_sy','1', document.form_.stop_sy);"></td>
					</tr>
				</table>
			</td>
		</tr>
						...
						<td height="25" colspan="3">Have you been dismissed from any other school or denied readmission? 
							<%
								if(((String)vRetResult.elementAt(11)).equals("1"))
									...
									strErrMsg = "";
							%>
							<input type="radio" name="has_dismissed" value="1" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','has_dismissed','0', document.form_.has_dismissed[0]);">Yes
							<%
								if(((String)vRetResult.elementAt(11)).equals("2"))
									...
									strErrMsg = "";
							%>
					  <input type="radio" name="has_dismissed" value="2" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','has_dismissed','0', document.form_.has_dismissed[1]);">No</td>
					</tr>
					<tr>
						<td height="25" width="15%">If YES, state the: </td>
						<td colspan="2">REASON 
							<input name="dismiss_reason" type="text" size="100" value="<%=WI.getStrValue((String)vRetResult.elementAt(12))%>" class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','dismiss_reason','1', document.form_.dismiss_reason);"></td>
					</tr>
					<tr>
						<td height="25" width="15%">&nbsp;</td>
						<td width="50%">Grade you were in 
							<input name="dismiss_grade" type="text" size="48" value="<%=WI.getStrValue((String)vRetResult.elementAt(13))%>" class="textbox" maxlength="64"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','dismiss_grade','1', document.form_.dismiss_grade);"></td>
						<td width="35%">School Year
							<input name="dismiss_sy" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(14))%>" class="textbox" maxlength="64"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_SPIS_CIT_TEMP','dismiss_sy','1', document.form_.dismiss_sy);"></td>
					</tr>
				</table>
			</td>
		</tr>

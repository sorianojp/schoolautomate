...
<body onLoad="FocusID();window.print();">
<%
	...
	try	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-STUDENT PERSONAL DATA-Student Personal Data","student_data_.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form name="form_" method="post" action="spis_print.jsp">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
		<tr> 
			<td width="30%" height="25"><div align="center"><font size="2"><strong>:::: PART I: STUDENT'S PERSONAL DATA ::::</strong></font></div></td>
		</tr>
	</table>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						...
						<td>
							<input type="text" name="mname" value="<%=WI.getStrValue((String)vRetResult.elementAt(2))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" readonly="yes"></td>
						<td>
							<input type="text" name="nickname" value="<%=WI.getStrValue((String)vRetResult.elementAt(3))%>" class="textbox"
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						...
						%>
					  	<td>
							<select name="nationality" onChange="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PERSONAL','nationality','1', document.form_.nationality);">
						...
						%>
					  	<td>
							<select name="religion" onChange="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PERSONAL','religion','1', document.form_.religion);">
					  	...
					  	<td>
							<input name="place_of_birth" value="<%=WI.getStrValue((String)vRetResult.elementAt(8))%>" type= "text" class="textbox" size="16"
					...
					<tr>
						<td height="25">
							<input type="text" name="native_lan" value="<%=WI.getStrValue((String)vRetResult.elementAt(10))%>" class="textbox"
					  	...
					  	<td colspan="4">
							<input name="contact_mob_no" type="text" size="32" value="<%=WI.getStrValue((String)vRetResult.elementAt(12))%>" class="textbox"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
					  	<td height="25">
							<input name="height" type= "text" value="<%=WI.getStrValue((String)vRetResult.elementAt(13))%>" class="textbox" size="8"
					  	...
					  	<td>
							<input name="weight" type= "text" value="<%=WI.getStrValue((String)vRetResult.elementAt(14))%>" class="textbox" size="8"
					  	...
					  	<td>
							<input name="eye_color" type= "text" value="<%=WI.getStrValue((String)vRetResult.elementAt(15))%>" class="textbox" size="8"
					  	...
					  	<td>
							<input name="hair_color" type= "text" value="<%=WI.getStrValue((String)vRetResult.elementAt(16))%>" class="textbox" size="8"
					  	...
					  	<td>
							<input name="complexion" type= "text" value="<%=WI.getStrValue((String)vRetResult.elementAt(17))%>" class="textbox" size="8"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" colspan="5"><strong>Home Address</strong></td>
					</tr>
					<tr>
					...
					<tr>
					  	<td height="25">
							<input name="res_house_no" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(19))%>" size="24" class="textbox"
					  	...
					  	<td>
							<input name="res_city" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(20))%>" size="24" class="textbox" 
					  	...
					  	<td>
							<input name="res_provience" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(21))%>" class="textbox" size="16"
						...
						%>
					  	...
					  	<td>
							<input name="res_zip" type="text"  value="<%=WI.getStrValue((String)vRetResult.elementAt(23))%>" class="textbox" size="12"
					...
					<tr>
					  	<td height="25" colspan="5">Telephone Nos./Cellphone Nos. </td>
				  	</tr>
					<tr>
					  	<td height="25" colspan="5">
							<input name="res_tel" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(24))%>" size="24" class="textbox"
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						...
						<td width="20%"><input type="radio" name="study_residence" value="1">with parents</td>
						<td width="20%"><input type="radio" name="study_residence" value="2">with guardians</td>
						<td width="20%"><input type="radio" name="study_residence" value="3">boarding</td>	
					</tr>
					<tr>
					  	<td height="25">&nbsp;</td>
					  	<td><input type="radio" name="study_residence" value="4">with relatives</td>
					  	<td colspan="2"><input type="radio" name="study_residence" value="5">others (pls. specify)
							<input name="study_residence_text" type="text" value="<%=strTemp%>" size="32" class="textbox"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" colspan="4"><strong>FATHER'S NAME</strong> </td>
					</tr>
					<tr>
					...
					<tr>
					  	<td height="25">
							<input type="text" name="f_lname" value="<%=WI.getStrValue((String)vRetResult.elementAt(57))%>" class="textbox"
					  	...
					  	<td>
							<input type="text" name="f_fname" value="<%=WI.getStrValue((String)vRetResult.elementAt(58))%>" class="textbox"
					  	...
					  	<td>
							<input type="text" name="f_mname" value="<%=WI.getStrValue((String)vRetResult.elementAt(59))%>" class="textbox"
				  	    ...
				  	    <td>
							<input name="f_dob" type="text" size="10" maxlength="10" value="<%=WI.getStrValue((String)vRetResult.elementAt(60))%>" class="textbox" readonly="yes"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="UpdateAge();style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PARENT','f_dob','2', document.form_.f_dob);"
								onKeyUP="AllowOnlyIntegerExtn('form_','f_dob','/');UpdateAge()">
							<a href="javascript:show_calendar('form_.f_dob',<%=CommonUtil.getMMYYYYForCal()%>);" title="Click to select date" 
								onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;">
							<img src="../../../../images/calendar_new.gif" width="20" height="16" border="0"></a></td>
					</tr>
				</table>
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						<td height="25"><input type="text" name="f_age" value="" class="textbox_noborder" size="8" tabindex="-1"></td>
						<td>
							<input name="f_place_of_birth" value="<%=WI.getStrValue((String)vRetResult.elementAt(61))%>" type= "text" class="textbox" size="16"
						...
						<td>
							<input name="f_dialect" value="<%=WI.getStrValue((String)vRetResult.elementAt(62))%>" type= "text" class="textbox" size="16"
			...
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						...
						<input type="text" name="f_educ_attainment" value="<%=WI.getStrValue((String)vRetResult.elementAt(66))%>" class="textbox" size="36"
					    ...
					    <input type="text" name="f_occupation" value="<%=WI.getStrValue((String)vRetResult.elementAt(67))%>" class="textbox" size="36"
					...
					<tr>
			    		...
			    		<input type="text" name="f_comp_name" value="<%=WI.getStrValue((String)vRetResult.elementAt(68))%>" class="textbox" size="50"
					...
					<tr>
				    	...
				    	<input type="text" name="f_tel" value="<%=WI.getStrValue((String)vRetResult.elementAt(70))%>" class="textbox" size="37"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						...
						<td colspan="2"><input type="radio" name="f_not_working_reason" value="5" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PARENT','f_not_working_reason','0', document.form_.f_not_working_reason[4]);">others (pls. specify)
							<input name="f_not_working_others" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(89))%>" size="32" class="textbox"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" colspan="4"><strong>MOTHER'S NAME</strong> </td>
					</tr>
					<tr>
					  	<td height="25" width="20%">Last Name </td>
				  	    <td width="20%">First Name </td>
					...
					<tr>
					  	<td height="25">
							<input type="text" name="m_lname" value="<%=WI.getStrValue((String)vRetResult.elementAt(73))%>" class="textbox"
					  	...
					  	<td>
							<input type="text" name="m_fname" value="<%=WI.getStrValue((String)vRetResult.elementAt(74))%>" class="textbox"
					  	...
					  	<td>
							<input type="text" name="m_mname" value="<%=WI.getStrValue((String)vRetResult.elementAt(75))%>" class="textbox"
						...
						<td>
							<input name="m_dob" type="text" size="10" maxlength="10" value="<%=WI.getStrValue((String)vRetResult.elementAt(76))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="UpdateAge();style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PARENT','m_dob','2', document.form_.m_dob);"
								onKeyUP="AllowOnlyIntegerExtn('form_','m_dob','/');UpdateAge()">
							<a href="javascript:show_calendar('form_.m_dob',<%=CommonUtil.getMMYYYYForCal()%>);" title="Click to select date" 
								onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;">
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						<td height="25"><input type="text" name="m_age" value="" class="textbox_noborder" size="8" tabindex="-1"></td>
						<td>
							<input name="m_place_of_birth" value="<%=WI.getStrValue((String)vRetResult.elementAt(77))%>" type= "text" class="textbox" size="16"
						...
						<td>
							<input name="m_dialect" value="<%=WI.getStrValue((String)vRetResult.elementAt(78))%>" type= "text" class="textbox" size="16"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" width="50%">Highest Educational Attainment:
						<input type="text" name="m_educ_attainment" value="<%=WI.getStrValue((String)vRetResult.elementAt(82))%>" class="textbox" size="36"
					...
					<tr>
						<td height="25">Company Name: 
				    		<input type="text" name="m_comp_name" value="<%=WI.getStrValue((String)vRetResult.elementAt(84))%>" class="textbox" size="50"
					...
					<tr>
						<td height="25" colspan="2">Company Tel No./Cellphone No. 
					    	<input type="text" name="m_tel" value="<%=WI.getStrValue((String)vRetResult.elementAt(86))%>" class="textbox" size="37"
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
						...
						<td colspan="2"><input type="radio" name="m_not_working_reason" value="5" <%=strErrMsg%> onClick="javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PARENT','m_not_working_reason','0', document.form_.m_not_working_reason[4]);">others (pls. specify)
							<input name="m_not_working_others" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(90))%>" size="32" class="textbox"
					...
					<tr>
						<td height="25">
							<input name="birth_order" type="text" size="10" maxlength="4" value="<%=WI.getStrValue((String)vRetResult.elementAt(53))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onKeyUp="AllowOnlyInteger('form_','birth_rank');"
		...
		<tr>
			<td>
				<%
					Vector vTemp = (Vector)vRetResult.elementAt(91);
				%>
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" width="70%"><strong>In case of Emergency, please contact: </strong>&nbsp;
					      	<input type="text" name="emgn_per_name" value="<%=WI.getStrValue((String)vRetResult.elementAt(34))%>" class="textbox" size="64"
						...
						<td width="30%">Relation&nbsp;
							<input type="text" name="emgn_per_rel" value="<%=WI.getStrValue((String)vRetResult.elementAt(35))%>" class="textbox" size="32"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					...
					<tr>
					  	<td height="25">
							<input name="emgn_house_no" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(36))%>" size="24" class="textbox"
					  	...
					  	<td>
							<input name="emgn_city" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(37))%>" size="24" class="textbox" 
					  	...
					  	<td>
							<input name="emgn_provience" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(38))%>" class="textbox" size="16"
						...
						%>
					  	...
					  	<td>
							<input name="emgn_zip" type="text"  value="<%=WI.getStrValue((String)vRetResult.elementAt(40))%>" class="textbox" size="12"
					...
					<tr>
					  	<td height="25" colspan="5">
							<input name="emgn_tel" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(41))%>" size="24" class="textbox"
		...
		<tr>
			<td>
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>
						<td height="25" colspan="5"><strong>Grades - Mailing Information </strong></td>
					</tr>
					<tr>
						<td height="25" colspan="5">Send To&nbsp;&nbsp;
							<input type="text" name="mail_to" value="<%=WI.getStrValue((String)vRetResult.elementAt(42))%>" class="textbox" size="64"
					...
					<tr>
					  	<td height="25">
							<input name="mail_house_no" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(43))%>" size="24" class="textbox"
					  	...
					  	<td>
							<input name="mail_city" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(44))%>" size="24" class="textbox" 
					  	...
					  	<td>
							<input name="mail_province" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(45))%>" class="textbox" size="16"
						...
						%>
					  	...
					  	<td>
							<input name="mail_zip" type="text"  value="<%=WI.getStrValue((String)vRetResult.elementAt(47))%>" class="textbox" size="12"

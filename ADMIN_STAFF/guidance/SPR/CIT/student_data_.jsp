...
function Verify(strLoad) {
	...
	//alert(document.form_.cityaddr_house_no.value);
					...
					<tr>
						...
						<%if(bolIsRegistrar) {%>
							<input type="text" name="mname" value="<%=WI.getStrValue((String)vRetResult.elementAt(2))%>" class="textbox"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','USER_TABLE','mname','1', document.form_.mname);">
						<%}else{%>
		...
		<tr>
			<td>
				...
				" and HR_INFO_PERSONAL.is_del = 0, and HR_APPL_INFO_PERSONAL.is_del = 0","","religion")'>Update</a> 
					  	...
					  	<td>
						<%if(WI.getStrValue((String)vRetResult.elementAt(7)).length() > 0 && !bolIsRegistrar) {%>
							<font style="font-size:12px; font-weight:bold"><%=vRetResult.elementAt(7)%></font>
						<%}else{
						...
						%>
							<input name="dob" type="text" size="10" maxlength="10" value="<%=strTemp%>" class="textbox"
								...
								javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_PERSONAL','dob','2', document.form_.dob);}"
		...
		<tr>
			<td height="15">
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
						...
						<tr>
							<td height="25">
								<input name="cityaddr_house_no" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(95))%>" size="72" 
								class="textbox" maxlength="128"
								onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';
								javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_CONTACT','cityaddr_house_no','1', document.form_.cityaddr_house_no);">
								</td>
							<%
								strTemp = WI.getStrValue((String)vRetResult.elementAt(96), "", ",", "") + WI.getStrValue((String)vRetResult.elementAt(97), "", " - ", "")+
								WI.getStrValue((String)vRetResult.elementAt(98));
								
							if(strTemp != null && strTemp.length() > 10) {//get index.
								strTemp = "select BLOCK_INDEX from preload_zip where city = "+WI.getInsertValueForDB((String)vRetResult.elementAt(96), true, null)+
										" and city_info = "+WI.getInsertValueForDB((String)vRetResult.elementAt(97), true, null)+
										" and ZIP_CODE_INFO = "+WI.getInsertValueForDB((String)vRetResult.elementAt(98), true, null);
							...
							<a href='javascript:UpdatePreloadAddr("<%//=strUserIndex%>","5")'>Update</a>-->
							<select name="_city_addr_" style="width:300px" onBlur="UpdatePreloadAddrDropDown('<%=strUserIndex%>','5', document.form_._city_addr_, '_city_addr')">
							<option value=""></option>
						...
						<tr>
							<td height="25" colspan="2">
								<input name="cityaddr_tel" type="text" value="<%=WI.getStrValue((String)vRetResult.elementAt(99))%>" size="24" class="textbox" maxlength="32"
									onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white';javascript:AjaxUpdateOthers('user_index', '<%=strUserIndex%>','INFO_CONTACT','cityaddr_tel','1', document.form_.cityaddr_tel);"></td>
						</tr>
					</table>
...
-->
					...
					<tr>
						...
						<a href='javascript:UpdatePreloadAddr("<%=strUserIndex%>","1")'>Update</a>-->
							<select name="_res_addr_" style="width:300px" onBlur="UpdatePreloadAddrDropDown('<%=strUserIndex%>','1', document.form_._res_addr_, '_res_addr')">
							<option value=""></option>
							<%for(int i =0; i < vAddressInfo.size(); i += 4) {
		...
		<tr>
			<td>
				<%//for(int i =0; i < vRetResult.size(); ++i) 
					//System.out.println("i :"+Integer.toString(i)+": "+vRetResult.elementAt(i));
					Vector vTemp = (Vector)vRetResult.lastElement();
				%>
...
-->
					...
					<tr>
						...
						-->
							<select name="_con_addr_" style="width:300px" onBlur="UpdatePreloadAddrDropDown('<%=strUserIndex%>','2', document.form_._con_addr_, '_con_addr')">
							<option value=""></option>
							<%for(int i =0; i < vAddressInfo.size(); i += 4) {
...
-->
					...
					<tr>
						...
						<a href='javascript:UpdatePreloadAddr("<%=strUserIndex%>","3")'>Update</a>-->
							<select name="_emgn_addr_" style="width:300px" onBlur="UpdatePreloadAddrDropDown('<%=strUserIndex%>','3', document.form_._emgn_addr_, '_emgn_addr')">
							<option value=""></option>
							<%for(int i =0; i < vAddressInfo.size(); i += 4) {
...
-->
					...
					<tr>
						...
						<a href='javascript:UpdatePreloadAddr("<%=strUserIndex%>","4")'>Update</a>-->
							<select name="_mail_addr_" style="width:300px" onBlur="UpdatePreloadAddrDropDown('<%=strUserIndex%>','4', document.form_._mail_addr_, '_mail_addr')">
							<option value=""></option>
							<%for(int i =0; i < vAddressInfo.size(); i += 4) {

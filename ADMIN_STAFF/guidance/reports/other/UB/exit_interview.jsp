...
//authenticate this user.
	...
	int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
										"Guidance","REPORTS",request.getRemoteAddr(),"exit_interview.jsp");
	...
	if(vStudInfo != null && vStudInfo.size() > 0) {			
		...
		if(strTemp.length() > 0){
            if(gdExitInterview.opearateGDExitInterview(dbOP, request, Integer.parseInt(strTemp),strStudIndex,strSYFrom,strSemester) == null)
...
<table  width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr><td colspan="8" height="25"><hr size="1" noshade> </td></tr>
	<tr>
		...
		<td height="25" colspan="5"><div align="center">
			<%if(iAccessLevel > 1){
					if(vRetResult!=null){%>
						...
						&nbsp;&nbsp;
						<a href="javascript:PrintPg('<%=(String)vRetResult.elementAt(0)%>');">

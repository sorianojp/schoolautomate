...
function PrintCertification() {
	...
	pgLoc = "./common_cert_print_cdd.jsp?stud_id="+document.form_.stud_id.value+
	...
	"&purpose="+escape(document.form_.purpose.value);
	var win=window.open(pgLoc,"PrintWindow",'width=800,height=600,top=10,left=10,scrollbars=yes,toolbar=no,location=no,directories=no,status=no,menubar=no');
	win.focus();
}
</script>
...
%>
    ...
    <tr>
      ...
      <td height="10"><input name="position" type="text"  value="<%=WI.fillTextValue("position")%>" class="textbox"
	   onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" size="32"></td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
      <td height="10">Purposes</td>
      <td height="10"><input name="purpose" type="text"  value="<%=WI.fillTextValue("purpose")%>" class="textbox"
	   onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'" size="32"></td>
    </tr>
    <tr>

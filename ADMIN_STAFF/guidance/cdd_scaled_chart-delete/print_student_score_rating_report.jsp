...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-GRADES-IQ Score Rating","print_student_score_rating_report.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<tr><td colspan="5" height="25"><strong><font size="2"><%=WI.fillTextValue("test_name")%><%=WI.getStrValue(WI.fillTextValue("exam_name")," - ","","")%></font></strong></td></tr>

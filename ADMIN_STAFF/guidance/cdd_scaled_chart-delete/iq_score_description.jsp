...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Registrar Management-GRADES-IQ Score Rating","iq_score_description.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" class="thinborder">
	<tr>
		<td height="25" class="thinborder" colspan="5" align="center"><strong>LIST OF I.Q. SCORE DESCRIPTION</strong></td>
	</tr>
	...
	<tr>
		...
		<td class="thinborder" align="center" width="20%"><strong>Description Code</strong></td>

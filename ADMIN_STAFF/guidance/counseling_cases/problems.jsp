...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Guidance & Counseling-Counseling Cases","problems.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0) {
		if(GDCounsel.operateOnProblems(dbOP, request, Integer.parseInt(strTemp)) != null ) {
	...
	vRetResult = GDCounsel.operateOnProblems(dbOP, request, 4);
	if (strErrMsg == null)
		strErrMsg = GDCounsel.getErrMsg();
...
<form action="./problems.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          COUNSELING CASES - PROBLEMS PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="15%" height="28">Problem :</td>
      <%strTemp = WI.fillTextValue("prob_index");%>
      <td width="25%" height="28"><select name="prob_index">
      ...
      <a href='javascript:viewList("GD_COUNSEL_PROB_TYPE","PROB_TYPE_INDEX","PROBLEM_NAME","PROBLEM",
	"GD_COUNSEL_PROB","PROB_TYPE_INDEX"," AND COUNSELING_INDEX IS NOT NULL ","")'><img src="../../../images/update.gif" border="0"></a><font size="1">click 
        to update list of problems</font>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <%if (vRetResult != null && vRetResult.size()>0){%>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: PROBLEMS ::::</strong></font></div></td>
    </tr>
    <tr>
    <td width="14%">&nbsp;</td>
    <td width="64%" height="25"><div align="center"><font size="2"><strong>Problem Name</strong></font></div></td>
    <td width="10%">&nbsp;</td>
    <td width="12%">&nbsp;</td>
    </tr>

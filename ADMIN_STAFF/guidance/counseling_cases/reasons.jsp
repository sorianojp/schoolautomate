...
<%@ page language="java" import="utility.*,osaGuidance.GDCounseling ,java.util.Vector " %>
<%
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Guidance & Counseling-Counseling Cases","reasons.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0) {
		if(GDCounsel.operateOnRefReason(dbOP, request, Integer.parseInt(strTemp)) != null )
				strErrMsg = "Operation successful.";
		else
				strErrMsg = GDCounsel.getErrMsg();
	}
	vRetResult = GDCounsel.operateOnRefReason(dbOP, request, 4);
	if (strErrMsg == null)
		strErrMsg = GDCounsel.getErrMsg();
%>
<body bgcolor="#663300">

<form action="./reasons.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          COUNSELING CASES - REFERRAL REASONS PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="15%" height="28">Reason :</td>
      <%strTemp = WI.fillTextValue("prob_index");%>
      <td width="25%" height="28"><select name="reason_index">
      ...
      <a href='javascript:viewList(" GD_COUNSEL_REF_REASON_TYPE","REF_REASON_TYPE_INDEX","REASON_NAME","REFERRAL REASON",
	"GD_COUNSEL_REF_REASON","REF_REASON_TYPE_INDEX"," AND COUNSELING_INDEX IS NOT NULL ","")'><img src="../../../images/update.gif" border="0"></a><font size="1">click 
  ...
  <%if (vRetResult != null && vRetResult.size()>0){%>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: REFERRAL REASONS ::::</strong></font></div></td>
    </tr>
    <tr>
    <td width="14%">&nbsp;</td>
    <td width="64%" height="25"><div align="center"><font size="2"><strong>Reason</strong></font></div></td>
    <td width="10%">&nbsp;</td>
    <td width="12%">&nbsp;</td>
    </tr>
...
<input type="hidden" name="counsel_res_index" value="<%=WI.fillTextValue("counsel_res_index")%>">

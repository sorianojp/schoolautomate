...
function PrintPg() {
	...
	document.getElementById('myADTable1').deleteRow(0);
	document.getElementById('myADTable1').deleteRow(0);
	document.getElementById('myADTable1').deleteRow(0);//14 rows removed.

	document.getElementById('myADTable2').deleteRow(0);//1 row removed.
...
%>
<form action="./search_listings.jsp" method="post" name="form_">
    ...
    <tr> 
      ...
      <td>
        ...
        <%= studReferral.constructGenericDropList(WI.fillTextValue("fname_con"),astrDropListEqual,astrDropListValEqual)%> </select>&nbsp;&nbsp;
	  	...
	  	onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">	  </td>
      <td><%if(!bolIsBasic){%>Year Level<%}%></td>
      <td><%if(!bolIsBasic){%><select name="year_level">
        <option value="">N/A</option>
        <%
...
<%}%>    
    <tr> 
      ...
      <td height="26" colspan="3" style="font-size:9px; color:#0000FF; font-weight:bold">&nbsp; 
	  	<input name="show_new" type="checkbox" value="checked" <%=WI.fillTextValue("show_new")%>>
		Show Lists without any action/follow up.	</td>
    </tr>
    <tr> 
      <td height="26">&nbsp;</td>
      ...
      <td height="26" colspan="3" valign="bottom">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		Date Referred: 
			  <input name="refer_date_fr" type="text" size="12" maxlength="12" readonly="yes" value="<%=WI.fillTextValue("refer_date_fr")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('form_.refer_date_fr');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a>
		
		- 
		
	  <input name="refer_date_to" type="text" size="12" maxlength="12" readonly="yes" value="<%=WI.fillTextValue("refer_date_to")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'">
        <a href="javascript:show_calendar('form_.refer_date_to');" title="Click to select date" onMouseOver="window.status='Select date';return true;" onMouseOut="window.status='';return true;"><img src="../../../images/calendar_new.gif" border="0"></a>
...
-->    
    <tr> 
	  ...
	  <input type="image" src="../../../images/form_proceed.gif" border="0" onClick="document.form_.search_.value='1'">        </td>
    </tr>

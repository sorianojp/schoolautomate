...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Guidance & Counseling-Psychological Cases","tests.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//end of authenticaion code.
	...
	if(strTemp.length() > 0) {
		if(GDPsych.operateOnTests(dbOP, request, Integer.parseInt(strTemp)) != null )
				strErrMsg = "Operation successful.";			
		else				
				strErrMsg = GDPsych.getErrMsg();
	}
	
	vRetResult = GDPsych.operateOnTests(dbOP, request, 4);
	if (strErrMsg == null)
		strErrMsg = GDPsych.getErrMsg();
%>
<body bgcolor="#663300">
<form action="./tests.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          PSYCHOLOGICAL CASES - TESTS ADMINISTERED PAGE ::::</strong></font></div></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="15%" height="28">Test administered :</td>
      <%strTemp = WI.fillTextValue("test_index");%>
      <td width="25%" height="28"><select name="test_index">
      ...
      <a href='javascript:viewList("GD_PSY_TEST_TYPE","PSY_TEST_TYPE_INDEX","TEST_NAME","TESTS",
	"GD_PSY_TEST_ADMINISTERED","PSY_TEST_TYPE_INDEX"," AND PSY_RESULT_INDEX IS NOT NULL ","")'><img src="../../../images/update.gif" border="0"></a><font size="1">click 
        to update list of tests</font>
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <%if (vRetResult != null && vRetResult.size()>0){%>
   <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td height="28" colspan="4" bgcolor="A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: TESTS TAKEN ::::</strong></font></div></td>
    </tr>
    <tr>
    <td width="14%">&nbsp;</td>
    <td width="64%" height="25"><div align="center"><font size="2"><strong>Test Name</strong></font></div></td>
    <td width="10%">&nbsp;</td>
    <td width="12%">&nbsp;</td>
    </tr>

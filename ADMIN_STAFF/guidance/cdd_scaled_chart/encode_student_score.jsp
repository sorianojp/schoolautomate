...
function AjaxGetIQDescription(){		
	...
	var strRatingExamIndex = document.form_.rating_main_index.value; 
	...
	var strURL = "../../../Ajax/AjaxInterface.jsp?methodRef=30003&raw_score="+strRawScore+
		"&rating_main_index="+strRatingExamIndex+"&stud_age="+document.form_.stud_age.value;	
	this.processRequest(strURL);
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Guidance & Counseling-IQ Test","encode_student_score.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();

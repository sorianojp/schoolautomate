...
<jsp:forward page="./test_reports_UB.jsp"></jsp:forward>
<%return;}
%>
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./test_reports.jsp" method="post">
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable1">
	...
	<tr>
	  ...
	  <td colspan="4" valign="middle">
	  	<select name="course_index" style="width:400px;">
			<%=dbOP.loadCombo("course_index"," course_code + ' ::: '+ course_name"," from course_offered where is_valid =1 and is_offered = 1 order by course_name", WI.fillTextValue("course_index"), false)%>
		</select>	  </td>
    </tr>
	<tr>
	  <td height="30">&nbsp;</td>
	...
	<%
		...
		if(strTemp.equals("1"))
			...
			strErrMsg = "";
	%>
		<input type="checkbox" name="show_total" value="1" <%=strErrMsg%>>Total
	  </td>
    </tr>
	<%	
...
<table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr><td align="center">
		Frequency and Percentage Distribution of First Year <%=strCourseName%> Students According to their <%=(String)vPsyTestList.elementAt(i+3)%>
	</td></tr>
</table>

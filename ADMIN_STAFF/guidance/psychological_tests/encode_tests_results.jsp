...
function Encode(strIndex){
	location = "./encode_tests_results_page2.jsp?sy_from="+document.form_.sy_from.value+"&sy_to="+document.form_.sy_to.value+"&semester="+document.form_.semester.value+"&sched_idx="+strIndex;
}
</script>
</head>
<%
	...
	DBOperation dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"GUIDANCE & COUNSELING-PSYCHOLOGICAL TESTS","encode_tests_results.jsp");
...
%>
<body bgcolor="#D2AE72">
<form name="form_" action="./encode_tests_results.jsp" method="post" >
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#A49A6A"> 
      <td height="25" colspan="5" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          GUIDANCE &amp; COUNSELING - ENCODE PSYCHOLOGICAL TESTS RESULTS PAGE 
          ::::</strong></font></div></td>
    </tr>
</table>
  <table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
   ...
   <tr> 
	...
	<input name="sy_to" type="text" size="4" maxlength="4" value="<%=strTemp%>" class="textbox"
      ...
      <td width="44%" valign="middle"><a href="javascript:ReloadPage();"><img src="../../../images/form_proceed.gif" border="0"></a></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    ...
    <tr> 
      <td width="10%" class="thinborder"><div align="center"><font size="1"><strong>SCHEDULE CODE</strong></font></div></td>
      <td width="23%" height="28" class="thinborder"><div align="center"><font size="1"><strong>TEST 
          NAME </strong></font></div></td>
      <td width="14%" class="thinborder"><div align="center"><font size="1"><strong>ADMINISTERED 
          BY </strong></font></div></td>
      <td width="7%" class="thinborder"><div align="center"><strong><font size="1">DATE GIVEN</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><font size="1"><strong>TIME <font size="1"> 
          GIVEN</font></strong></font></div></td>
      <td width="8%" class="thinborder"><div align="center"><strong><font size="1">DURATION</font></strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong><font size="1">VENUE</font></strong></div></td>
    ...
    <tr> 
      ...
      <a href='javascript:Encode("<%=(String)vRetResult.elementAt(i)%>");'><img src="../../../images/openfile.gif" border="0"></a> 
      </td>
    </tr>
    <%}%>
    <tr> 

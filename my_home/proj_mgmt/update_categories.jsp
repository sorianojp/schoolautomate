...
<script language="javascript">
	...
	function RefreshPage() {
		...
		location = "./update_categories.jsp";
	}
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Project Management-Update Categories","update_categories.jsp");
	}
	catch(Exception exp) {
		exp.printStackTrace();
		%>
	...
	if(strTemp.length() > 0) {
		if(proj.operateOnProjCatg(dbOP, request, Integer.parseInt(strTemp)) == null)
			strErrMsg = proj.getErrMsg();
		else {
			if(strTemp.equals("0"))
				strErrMsg = "Category successfully removed.";
			if(strTemp.equals("1"))
				strErrMsg = "Category successfully recorded.";
			if(strTemp.equals("2"))
	...
	vRetResult = proj.operateOnProjCatg(dbOP, request,4);	
	//get vEditInfoIf it is called.
	if(strPrepareToEdit.equals("1")) {
		vEditInfo = proj.operateOnProjCatg(dbOP, request,3);
		if(vEditInfo == null)
			strErrMsg = proj.getErrMsg();		
	}
%>
...
<form name="form_" method="post" action="update_categories.jsp">
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" align="center" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: UPDATE CATEGORIES PAGE ::::</strong></font></td>
		</tr>
	</table>
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="80%">
				...
				%>
				<input type="text" name="catg_name" value="<%=strTemp%>" class="textbox"  maxlength="128" size="64"
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="3" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: LIST OF CATEGORIES CREATED ::: </strong></div></td>
		</tr>
		<tr>
			<td height="25" width="5%" align="center" class="thinborder"><strong>Count</strong></td>
			<td width="75%" align="center" class="thinborder"><strong>Category Name</strong></td>

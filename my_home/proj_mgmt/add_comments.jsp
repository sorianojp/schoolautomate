...
<script language="javascript">
	...
	function RefreshPage() {
		document.form_.donot_call_close_wnd.value = "1";
		document.form_.comment.value = "";	
		location = "./add_comments.jsp?info_index="+document.form_.info_index.value;
	}
	
	function FocusField(){
		document.form_.comment.focus();
	}
...
<%
	...
	try{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Project Management-Add Comments","add_comments.jsp");
	}
	catch(Exception exp) {
		exp.printStackTrace();
		%>
	...
	if(strTemp.length() > 0) {
		if(proj.operateOnProjectTodoProgress(dbOP, request, Integer.parseInt(strTemp)) == null)
			strErrMsg = proj.getErrMsg();
		else {
			if(strTemp.equals("0"))
				strErrMsg = "Progress comment successfully removed.";
			if(strTemp.equals("1"))
				strErrMsg = "Progress comment successfully recorded.";
		}
	}

	vRetResult = proj.operateOnProjectTodoProgress(dbOP, request,4);
%>
<body bgcolor="#D2AE72" onLoad="FocusField();" onUnload="ReloadParentWnd();">
<form name="form_" method="post" action="add_comments.jsp">

	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr bgcolor="#A49A6A"> 
			<td height="25" align="center" class="footerDynamic">
				<font color="#FFFFFF" ><strong>:::: TODO PROGRESS PAGE ::::</strong></font></td>
		</tr>
	</table>
	...
	<table bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<tr>
			...
			<td width="80%">
				<textarea name="comment" style="font-size:12px" cols="80" rows="3" class="textbox" 
					onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='white'"><%=WI.fillTextValue("comment")%></textarea></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				...
				<font size="1">Click to save comment.</font>
				&nbsp;				    
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0"  bgcolor="#FFFFFF" class="thinborder">
		<tr> 
		  	<td height="20" colspan="4" bgcolor="#B9B292" class="thinborder">
				<div align="center"><strong>::: COMMENTS ::: </strong></div></td>
		</tr>
		<tr>
			<td height="25" width="5%" align="center" class="thinborder"><strong>Count</strong></td>
			<td width="60%" align="center" class="thinborder"><strong>Comment</strong></td>

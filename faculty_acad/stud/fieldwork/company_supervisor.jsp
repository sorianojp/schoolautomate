...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-FacultyAcad-Student Performance","company_supervisor.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(cmsStudP.operateOnSupervisor(dbOP, request, Integer.parseInt(strTemp)) == null)
...
vRetResult = cmsStudP.operateOnSupervisor(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null)
	strErrMsg = cmsStudP.getErrMsg();
	
if(strPreparedToEdit.equals("1"))
	vEditInfo = cmsStudP.operateOnSupervisor(dbOP, request, 3);

%>
<form action="./company_supervisor.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td width="100%" height="25" bgcolor="#6A99A2"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          MANAGE SUPERVISOR INFORMATION ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="75%" style="font-size:11px; font-weight:bold; color:#0000FF">
	  <%	  	strTemp = "select company_name from CM_STUD_COMPANY_LIST where COMPANY_INDEX = "+WI.fillTextValue("company_index");
...
%>
<input type="text" size="45" maxlength="64" name="name" style="font-size:11px" class="textbox" 
...
%>
      <input type="text" size="45" maxlength="64" name="position" style="font-size:11px" class="textbox" 
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='#FFFFFF'" value="<%=strTemp%>"></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
...
%>
        <input type="text" size="45" maxlength="64" name="department" style="font-size:11px" class="textbox" 
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='#FFFFFF'" value="<%=strTemp%>"></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
...
<input type="submit" name="12" value=" Cancel " style="font-size:11px; height:28px;border: 1px solid #FF0000;"
		 onClick="PageAction('','');document.form_.company_name.value='';document.form_.address.value=''; document.form_.con_person.value=''">      </td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
      <td colspan="2">&nbsp;</td>
...
<%if(vRetResult != null && vRetResult.size() > 0) {%>
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="thinborder">
    <tr bgcolor="#FFCC99"> 
	  ...
	  <!-- company name -->
	  :: SUPERVISOR LIST :: </font></strong></div></td>
    </tr>
    <tr> 
      <td width="25%" class="thinborder"><strong><font size="1">SUPERVISOR  NAME</font></strong></td>
      <td width="25%" class="thinborder" height="25"><strong><font size="1">POSITION</font></strong></td>
      <td width="30%" class="thinborder" style="font-weight:bold">DEPARTMENT</td>
...
<input type="hidden" name="company_index" value="<%=WI.fillTextValue("company_index")%>">

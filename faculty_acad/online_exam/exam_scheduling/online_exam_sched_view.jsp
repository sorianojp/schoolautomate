...
function ShowSchedule()
{
	...
	document.question.action="./online_exam_sched_view.jsp";
}
function ReloadPage()
{
	document.question.action="./online_exam_sched_view.jsp";
...
{
	document.question.exam_period_name.value = document.question.exam_period[document.question.exam_period.selectedIndex].text;
	document.question.college_name.value = document.question.college[document.question.college.selectedIndex].text;

	document.question.action="./online_exam_sched_print.jsp";
}
</script>
<body bgcolor="#D2AE72">
...
{%>  
  <table  bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <input type="image" src="../../../images/print.gif" onClick="PrintPage();"><font size="1">click 
  ...
  <table bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="12%" height="21"><div align="center"><font size="1">EXAMINER NAME</font></div></td>
      ...
      <td width="10%"><div align="center"><font size="1">DATE OF EXAM (mm/dd/yyyy)</font></div></td>
...
<input type="hidden" name="showSchedule" value="0">
 </form>
</body>
</html>
<%

...
%>
	<jsp:forward page="./cm_attendance_per_period_print.jsp" />
<%	return;} 
try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Faculty/Acad. Admin-Class Management-Attendance","cm_attendance_per_period.jsp");
	}
catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<body bgcolor="#93B5BB">
<form action="cm_attendance_per_period.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
...
%> <input name="sy_to" type="text" size="4" maxlength="4" value="<%=strTemp%>" class="textbox"
	  ...
	  readonly="yes"> </td>
      <td>
	  	<select name="pmt_sch_index" style="font-size:11px; font-weight:bold; color:#990000">
...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
    <tr> 
      <td width="12%" height="27" rowspan="2" align="center" class="thinborder"><font size="1"><strong>STUDENT ID</strong></font></td>
      <td height="21" colspan="3" align="center" class="thinborder"><strong><font size="1">STUDENT NAME</font></strong></td>
      ...
      <td width="15%" rowspan="2" align="center" class="thinborder" style="font-size:9px; font-weight:bold">DAYS ABSENT </td>
      <td width="21%" rowspan="2" align="center" class="thinborder"><font size="1"><strong>REMARKS</strong></font></td>
    </tr>
    <tr> 
      <td width="14%" height="19" align="center" class="thinborder"><font size="1"><strong>LASTNAME</strong></font></td>
    ...
    <tr> 
      ...
      <td class="thinborder"><div align="center">
        <input name="absent<%=iCtr%>" type="text" size="4" maxlength="4" value="<%=WI.getStrValue(WI.fillTextValue("absent"+iCtr),"0")%>" class="textbox"
	  onfocus="style.backgroundColor='#D3EBFF'" onBlur="AllowOnlyInteger('form_','absent<%=iCtr%>');style.backgroundColor='white'"
	  onKeyUp="AllowOnlyInteger('form_','absent<%=iCtr%>')">
      </div></td>
      <td class="thinborder"><div align="center">
          <input name="remarks<%=iCtr%>" type="text" class="textbox"
...
<%}// end of for loop%>
  ...
  <table width="100%" border="0" cellpadding="2" cellspacing="0" dwcopytype="CopyTableCell">
    ...
    <tr bgcolor="#6A99A2"> 
      <td height="25" bgcolor="#FFFFFF"><div align="center"> <a href="javascript:AddRecord()"></a>
        <input type="submit" name="122" value=" Save Attendance " style="font-size:11px; height:22px;border: 1px solid #FF0000;"
		 onClick="document.form_.print_page.value='';document.form_.page_action.value='1'">
      </div></td>
    </tr>
    <tr bgcolor="#6A99A2">
      <td height="20" bgcolor="#FFFFFF">&nbsp;</td>
...
<%} if (vRecorded.size() > 1){%>
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      <td width="12%" height="27" rowspan="2" align="center"><font size="1"><strong>STUDENT ID</strong></font></td>
      <td height="27" colspan="3" align="center"><strong><font size="1">STUDENT NAME</font></strong></td>
      ...
      <td width="14%" rowspan="2" align="center"><font size="1"><strong>DAYS ABSENT </strong></font></td>
    ...
    <tr> 
      ...
      <td align="center" style="font-size:9px;"><%=vRecorded.elementAt(k+7)%></td>
 ...
 <table width="100%" border="0" cellpadding="2" cellspacing="0" dwcopytype="CopyTableCell">
    ...
    <tr bgcolor="#6A99A2"> 
      <td height="25" bgcolor="#FFFFFF"><div align="center"> <a href="javascript:DeleteRecord()"></a> 
          <font size="1">
          <input type="button" name="123" value=" Delete selected Record " style="font-size:11px; height:22px;border: 1px solid #FF0000;"

...
function CloseWindow(){
	...
	window.opener.document.form_.focus_field.value = "focusMaterial";
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Accounting-Administration","materials_needed.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
if(strTemp.length() > 0) {
	if(cmsNew.operateOnMaterial(dbOP, request, Integer.parseInt(strTemp)) == null)
...
vRetResult = cmsNew.operateOnMaterial(dbOP, request, 4);
if(vRetResult == null && strErrMsg == null)
	strErrMsg = cmsNew.getErrMsg();
	
if(strPreparedToEdit.equals("1"))
	vEditInfo = cmsNew.operateOnMaterial(dbOP, request, 3);

%>
<form action="./materials_needed.jsp" method="post" name="form_" onSubmit="SubmitOnceButton(this);">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A"> 
      <td width="100%" height="25" bgcolor="#6A99A2"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>:::: 
          SYLLABUS MAINTENANCE -  MATERIALS NEEDED PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr> 
      ...
      <td width="10%">Material(s): </td>
      <td width="78%">
<%
if(vEditInfo != null && vEditInfo.size() > 0) 
	strTemp = (String)vEditInfo.elementAt(1);
else	
	strTemp = WI.fillTextValue("material");
%>	  <textarea name="material" cols="60" rows="3" style="font-size:10px" class="textbox" 
...
%>	  <textarea name="remark" cols="60" rows="3" style="font-size:10px" class="textbox" 
		onFocus="style.backgroundColor='#D3EBFF'" onBlur="style.backgroundColor='#FFFFFF'"><%=strTemp%></textarea></td>
    </tr>
    <tr> 
      <td height="25">&nbsp;</td>
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="thinborder">
    <tr bgcolor="#FFCC99"> 
	  ...
	  <div align="center"><strong><font color="#0000FF">:: 
          MATERIALS NEEDED :: </font></strong></div></td>
    </tr>
    <tr> 
      <td width="40%" class="thinborder"><div align="left"><strong><font size="1">MATERIALS</font></strong></div></td>
      <td width="40%" class="thinborder" height="25"><div align="left"><strong><font size="1">REMARKS</font></strong></div></td>

...
<body onLoad="window.print();">
  <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      ...
      <td width="28%" >Date of Checking</td>
...
%>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      <td>&nbsp;</td>
      <td height="25"><strong>TOTAL STUDENTS ENROLLED IN THIS CLASS : <%=Integer.parseInt((String)vRecorded.elementAt(0)) + Integer.parseInt((String)vUnrecorded.elementAt(0))%> </strong> <div align="right"></div></td>
    </tr>	
  </table>

...
<form name="cm_op" method="post" action="">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#6A99A2">
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::
          OBJECTIVES MAINTENANCE PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="0">
    <tr>
      <td width="19%"><strong>GOALS<br>
        </strong><font size="1">(Aims/Outcomes) </font></td>
      <td width="81%"><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">To know the status of the Pinoy now</textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong>OBJECTIVES<br>
        </strong><font size="1">(Performance/ Behavioral Indicators)</font><strong><br>
        </strong></td>
      <td><p>
    ...
    <tr>
      <td><strong>MATERIALS<br>
        </strong><font size="1">(Aids/AV/<br>
        Technology)</font><strong><font size="1"><br>
        </font> </strong></td>
      <td><p>

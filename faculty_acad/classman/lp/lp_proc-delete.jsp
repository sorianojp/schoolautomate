...
<form name="cm_op" method="post" action="">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#6A99A2">
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::
          PROCEDURE/METHODS MAINTENANCE PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="0">
    <tr>
      <td width="19%"><strong>INTRODUCTION<br>
        </strong><font size="1">(Focusing Event ) </font></td>
      <td width="81%"><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">To know the status of the Pinoy now</textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong>DEVELOPMENT<br>
        </strong><font size="1">(Modeling/Explanation Demonstration)</font><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">How are we doing today</textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong> PRACTICE<br>
        </strong><font size="1">(Guided/Monitored Activity)</font><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">Who is isko?</textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong>INDEPENDENT PRACTICE<br>
        </strong><font size="1">(Assignments to Measure Progress )</font><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">Who is isko?</textarea>
        </p></td>
    ...
    <tr>
      <td><strong>ACCOMODATIONS<br>
        </strong><font size="1">(Differentiated Instruction )</font><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">Who is isko?</textarea>
        </p></td>
    ...
    <tr>
      <td><strong>CHECKING FOR UNDERSTANDING<br>
        </strong><font size="1">(Assessment/Feedback )</font><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL"></textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong>CLOSURE<br>
        </strong><font size="1">(Wrapping it up )</font><strong><font size="1"><br>
        </font> </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">Cash, bus, permit to travel</textarea>
        </p></td>
    </tr>
    <tr>

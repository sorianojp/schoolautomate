...
<form name="cm_op" method="post" action="">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#6A99A2">
      <td height="25" colspan="4"><div align="center"><font color="#FFFFFF" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>::::
          EVALUATIONS MAINTENANCE PAGE ::::</strong></font></div></td>
    </tr>
    <tr bgcolor="#FFFFFF">
  ...
  <table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="2" cellspacing="0">
    <tr>
      <td width="19%"><strong>EVALUATION<br>
        </strong><font size="1">(Aims/Outcomes) </font></td>
      <td width="81%"><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">The student's love to travel but they don't care about the subject. </textarea>
        </p></td>
    </tr>
    <tr>
      <td><strong>TEACHER'S REFLECTION<br>
        </strong><strong><br>
        </strong></td>
      <td><p>
          <textarea name="textarea" cols="64" rows="5" wrap="VIRTUAL">I don't know who i am</textarea>
        </p></td>
    </tr>
    <tr>

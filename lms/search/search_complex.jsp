...
// if this page is calling print page, i have to forward page to print page.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"LMS-Search-Complex","search_complex.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form method="POST" name="form_" action="./search_complex.jsp" >
...
%>
    ...
    <tr> 
      ...
      <td colspan="2"><select name="LOC_INDEX" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size: 10;">          
          <%if(!bolIsDBTC){%><option value="">Any</option><%}%>
...
if(vRetResult != null && vRetResult.size() > 0){%>
  ...
  <table width="100%" height="102" border="0" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td width="10%" height="25" class="thinborder"><div align="center"><font size="1"><strong>COLLECTION 
          TYPE </strong></font></div></td>
      <td width="10%" class="thinborder"><div align="center"><font size="1"><strong>ACCESSION 
          NO. / BARCODE</strong></font></div></td>
	  <td width="12%" class="thinborder"><div align="center"><font size="1"><strong>CALL NUMBER</strong></font></div></td>
      <td width="25%" class="thinborder"><div align="center"><font size="1"><strong>::: 
          TITLE ::: <br>
          SUB TITILE</strong></font></div></td>
      <td width="12%" class="thinborder"><div align="center"><font size="1"><strong>AUTHOR</strong></font></div></td>
	  <td width="7%" class="thinborder"><div align="center"><font size="1"><strong>EDITION</strong></font></div></td>
...
for(int i = 0; i < vRetResult.size(); i += 12){
    ...
    <tr<%=strCheckOutColor%>> 
      ...
      <td class="thinborder" align="center"> <%if(bolIsLoggedIn){%> <a href='javascript:MyCollection("<%=(String)vRetResult.elementAt(i + 1)%>");'><img src="../images/my_collection.gif" border="0"></a> 
        ...
        &nbsp;
        <%}%> </td>
      <td class="thinborder" align="center"> <%if(bolIsLoggedIn){%> <a href='javascript:Reserve("<%=(String)vRetResult.elementAt(i + 1)%>");'><img src="../images/reserve.gif" border="0"></a> 
        <%}else if(i == 0){%>
        <strong>Log in reqd.</strong>
        <%}else{%>
        &nbsp;

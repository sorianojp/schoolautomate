...
function viewDtls(strCollSection, strCollegeCode){
	var strIsTotal = "0";
	if(strCollSection.length == 0)
		strIsTotal = "1";
	...
	var pgLoc = "./circ_by_collection_section_by_subject_area_view.jsp?report_type="+strReportType+"&date_fr="+strDateFrom+
		...
		"&collection_section="+strCollSection+"&c_code="+strCollegeCode+
		"&is_total="+strIsTotal;
	...
	String strCollegeCode = null;
	 for(int i = 0; i < vRowDetail.size(); i += 2) {
		...
		<tr> 
		  ...
		  for(int p =0; p < vColumnDetail.size(); p += 2){
			  ...
			  <td class="thinborder" align="center"><%if(iCountPerCell > 0){%> 
				...
				<%}else{%> - <%}%></td>
		  <%}//show count here.%>
		  <td class="thinborder" align="center"> <%if(iRowTotal > 0){%> <font size="1"><%=iRowTotal%></font> <%}else{%>
			- 
			<%}iRowTotal = 0;%> </td>
		</tr>
		<%}%>
		<tr> 
		  ...
		  <%
		  for(int i =0; i < vColumnDetail.size(); i += 2){%>
		  <td class="thinborder" align="center"><strong><font size="1"><%=iColTotal[i/2]%></font></strong></td>
		  <%}//show totalcount here.%>
		  <td class="thinborder" align="center"> <strong> 
			<%if(iGT > 0){%> <font size="1"><%=iGT%></font>  <%}else{%> - <%}%>
			</strong></td>
		</tr>
  </table>  

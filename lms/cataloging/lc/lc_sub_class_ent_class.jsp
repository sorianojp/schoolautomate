...
function CancelOperation() {
	document.form_.SCE_CLASS.value = "";
	document.form_.lc_class_code.value = "";
	this.ReloadPage();
}
</script>
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"LIB_Cataloging-DDC-Sub-Category ENTRY CLASS","lc_sub_class_ent_class.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
//view all. 
if(WI.fillTextValue("GEN_CATG_INDEX").length() > 0 && WI.fillTextValue("SUB_CATG_INDEX").length() > 0 && WI.fillTextValue("SUB_CATG_ENTRY_INDEX").length() > 0) {
...
<body bgcolor="#DEC9CC">
<form action="./lc_sub_class_ent_class.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#A8A8D5">
    <tr>
      <td height="25"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          LC CREATE : SUB-CLASS ENTRY CLASS PAGE :::: </strong></font></div></td>
    </tr>
  </table>
...
%> <input type="text" name="SCE_CLASS" value="<%=strTemp%>" 
    ...
    <tr> 
      <td height="25">&nbsp;&nbsp;SCE Class Code</td>
      <td> <%
if(vEditInfo != null && vEditInfo.size() > 0) 
	strTemp = (String)vEditInfo.elementAt(3);
else	
	strTemp = WI.fillTextValue("lc_class_code");
%> <input type="text" name="lc_class_code" size="20" maxlength="32" class="textbox"
  ...
  <table width="100%" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td height="25" colspan="3" bgcolor="#DDDDEE" class="thinborder"><div align="center"><font color="#FF0000"> 
          <strong>LIST OF EXISTING SUB-CLASS ENTRY CLASS</strong></font></div></td>
    </tr>
    <tr> 

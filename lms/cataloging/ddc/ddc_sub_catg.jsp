...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"LIB_Cataloging-DDC-Sub-Category","ddc_sub_catg.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
	...
	if(strTemp.length() > 0) {
		if(ctlgDDC.operateOnSubCatg(dbOP, request, Integer.parseInt(strTemp)) == null)
			...
			if(strTemp.compareTo("0") == 0)
				strErrMsg = "DDC General sub-category information successfully removed.";
			if(strTemp.compareTo("1") == 0)
				strErrMsg = "DDC General sub-category information successfully added.";
			if(strTemp.compareTo("2") == 0)
				strErrMsg = "DDC General sub-category information successfully edited.";
...
<body bgcolor="#DEC9CC">
<form action="./ddc_sub_catg.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#A8A8D5">
    <tr>
      <td height="25"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          DDC CREATE : SUB-CATEGORY PAGE :::: </strong></font></div></td>
    </tr>
  </table>
...
<%}%>
    ...
    <tr> 
      <td width="21%" height="25">&nbsp;&nbsp;Sub-Category</td>
      <td width="79%"> <%
...
if(iAccessLevel > 1) {%>
    <tr> 
      ...
      <td><font size="1"> 
        ...
        Click to edit event 
        <%}%>
        <a href="./ddc_sub_catg.jsp"><img src="../../images/cancel.gif" border="0"></a> 
  ...
  <table width="100%" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td height="25" colspan="3" bgcolor="#DDDDEE" class="thinborder"><div align="center"><font color="#FF0000"> 
          <strong>LIST OF EXISTING SUB-CATEGORIES</strong></font></div></td>
    </tr>
    <tr> 

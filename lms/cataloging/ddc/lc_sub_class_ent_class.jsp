...
<link href="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/css/fontstyle.css" rel="stylesheet" type="text/css">
<link href="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/css/tableBorder.css" rel="stylesheet" type="text/css">
...
<body bgcolor="#DEC9CC">
<form action="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/cataloging/ddc/./ddc_sub_cat_ent_class.jsp" method="post" name="form_">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td height="25" colspan="2"> <a href="lc_main.htm"><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/go_back.gif" border="0"></a>&nbsp;&nbsp;<font size="3" color="#FF0000"><strong> 
    ...
    <tr> 
      ...
      <td><select name="GEN_CATG_INDEX" onChange="ReloadPageGC();">
          ...
          <%=dbOP.loadCombo("GEN_CATG_INDEX","GEN_CATG"," from LMS_DDC_GEN_CATG where is_valid = 1 and is_del = 0 order by RANGE_FR asc",
...
if(astrCodeRange != null){%>
        <b> CLASS CODE : </b><strong>$CLASS_CODE</strong></td>
    </tr>
    <tr> 
      <td>&nbsp;&nbsp;Sub-Class</td>
      <td><select name="SUB_CATG_INDEX" onChange="ReloadPage();">
          ...
          <%=dbOP.loadCombo("SUB_CATG_INDEX","SUB_CATG"," from LMS_DDC_SUB_CATG WHERE GEN_CATG_INDEX = "+
			  ...
			  " and is_valid = 1 and is_del = 0 order by RANGE_FR asc",
		  	WI.fillTextValue("SUB_CATG_INDEX"), false)%> </select> 
        <%
astrCodeRange = ctlgDDC.getCodeRange(dbOP, WI.fillTextValue("SUB_CATG_INDEX"),2);
if(astrCodeRange != null){%>
        <b>SUB-CLASS CODE : </b><strong>$SUB_CLASS_CODE</strong></td>
    </tr>
    <tr> 
      <td width="21%">&nbsp;&nbsp;Sub-Class Entry</td>
      <td><select name="SUB_CATG_ENTRY_INDEX" onChange="ReloadPage();">
          ...
          <%=dbOP.loadCombo("SUB_CATG_ENTRY_INDEX","SUB_CATG_ENTRY"," from LMS_DDC_SUB_CATG_ENTRY WHERE SUB_CATG_INDEX = "+
			  WI.getStrValue(WI.fillTextValue("SUB_CATG_INDEX"),"0")+" and is_valid = 1 and is_del = 0 order by SUB_CATG_CODE asc",
...
if(WI.fillTextValue("SUB_CATG_ENTRY_INDEX").length() > 0) {
	...
	if(strTemp != null){%>
        <b>RANGE : <%=CommonUtil.formatInt(Integer.parseInt(strTemp),3)%></b> 
        <%}
	}%>
      </td>
    </tr>
...
%>
        <input type="text" name="SCE_CLASS_CODE" size="4" maxlength="4" class="textbox"
...
if(iAccessLevel > 1) {%>
    <tr> 
      ...
      <td><font size="1"> 
        <%if(strPrepareToEdit.compareTo("1") != 0) {%>
        <a href='javascript:PageAction(1,"");'><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/save.gif" border="0" name="hide_save"></a> 
        Click to save entries 
        <%}else{%>
        <a href='javascript:PageAction(2, "");'><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/edit.gif" border="0"></a> 
        Click to edit event 
        <%}%>
        <a href="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/cataloging/ddc/./ddc_sub_cat_ent_class.jsp"><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/cancel.gif" border="0"></a> 
...
for(int i = 0; i < vRetResult.size(); i += 3){%>
    <tr> 
      ...
      <td class="thinborder"><div align="center"> 
          <%
if(iAccessLevel > 1){%>
          <a href='javascript:PrepareToEdit("<%=(String)vRetResult.elementAt(i)%>");'><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/edit.gif" width="53" height="28" border="0"></a> 
          <%}if(iAccessLevel == 2){%>
          <a href='javascript:PageAction("0","<%=(String)vRetResult.elementAt(i)%>");'><img src="file:///D|/ApacheTomcat4.1.31/webapps/schoolbliz_vmuf_03_30_2006/lms/images/delete.gif" width="53" height="26" border="0"></a> 
          <%}%>
          </div></td>
    </tr>
<%}%>

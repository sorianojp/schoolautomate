...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"LIB_Cataloging-DDC-Sub-Category","ddc_sub_cat_ent.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
<body bgcolor="#DEC9CC">
<form action="./ddc_sub_cat_ent.jsp" method="post" name="form_">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#A8A8D5">
    <tr>
      <td height="25"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          DDC CREATE : SUB-CATEGORY ENTRY PAGE :::: </strong></font></div></td>
    </tr>
  </table>
    ...
    <tr>
      ...
      <td><select name="SUB_CATG_INDEX" onChange="ReloadPage();">
          ...
          <%=dbOP.loadCombo("SUB_CATG_INDEX","SUB_CATG"," from LMS_DDC_SUB_CATG WHERE GEN_CATG_INDEX = "+
			  ...
			  " and is_valid = 1 and is_del = 0 and is_lc = 0 order by RANGE_FR asc",
...
if(astrCodeRange != null){%>
    ...
    <tr> 
      <td width="21%" height="25">&nbsp;&nbsp;Sub-Category Entry</td>
      <td width="79%"> <%
...
if(vEditInfo != null && vEditInfo.size() > 0) 
	...
	strTemp = WI.fillTextValue("SUB_CATG_CODE");
%> <input type="text" name="SUB_CATG_CODE" size="4" maxlength="4" class="textbox"
...
if(iAccessLevel > 1) {%>
    <tr> 
      ...
      <td><font size="1"> 
        ...
        Click to edit event 
        <%}%>
        <a href="./ddc_sub_cat_ent.jsp"><img src="../../images/cancel.gif" border="0"></a> 
  ...
  <table width="100%" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td height="25" colspan="3" bgcolor="#DDDDEE" class="thinborder"><div align="center"><font color="#FF0000"> 
          <strong>LIST OF EXISTING SUB-CATEGORY ENTRY</strong></font></div></td>
    </tr>
    <tr> 

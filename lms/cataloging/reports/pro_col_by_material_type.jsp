...
//authenticate this user.
	...
	if(strSchCode.startsWith("DBTC")){		
		dbOP.cleanUP();
		response.sendRedirect("./pro_col_by_material_type_dbtc.jsp");
		return;
	}
...
String[] astrSortByName    = {"Call Number","Author","Title","Copyright", 
		"Collection Location", "Book Location", "Barcode", "Subject Code"};
String[] astrSortByVal     = {"CALL_NUMBER","AUTHOR_NAME","BOOK_TITLE","PUBLISHER_DATE",
		"location", "loc_name","barcode_no","sub_code"};	
...
%>
<form action="./pro_col_by_material_type.jsp" method="post" name="form_">
...
<%}//end of report type.%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="myADTable3">
		<tr>
		  	...
		  	<td width="20%">
				<select name="sort_by1">
					...
					<%=CR.constructSortByDropList(WI.fillTextValue("sort_by1"),astrSortByName,astrSortByVal)%>
				</select></td>
		    <td width="20%">
				<select name="sort_by2">
              		<option value="">N/A</option>
             		<%=CR.constructSortByDropList(WI.fillTextValue("sort_by2"),astrSortByName,astrSortByVal)%>
				</select></td>
		    <td>
				<select name="sort_by3">
					<option value="">N/A</option>
              		<%=CR.constructSortByDropList(WI.fillTextValue("sort_by3"),astrSortByName,astrSortByVal)%>
           	 </select></td>
		</tr>
		<tr>
			<td height="25">&nbsp;</td>
		...
		<tr>
			...
			<td colspan="4">
				<a href="javascript:ViewReport();"><img src="../../images/form_proceed.gif" border="0"></a></td>
		</tr>
		<tr>
...
String strCollLocation = null;
String strBookLocation = null;
...
strMatTypeIndex = (String)vMatType.elementAt(i);%>  
  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="thinborder">
    <tr> 
      <td height="25" colspan="11" bgcolor="#DDDDEE" class="thinborder"><font color="#FF0000"><strong>
    ...
    <tr> 
      <td width="8%" height="25" class="thinborder"><div align="center"><strong><font size="1">CALL 
          NO.</font></strong></div></td>
      <td width="18%" class="thinborder"><div align="center"><strong><font size="1">AUTHOR</font></strong></div></td>
      <td width="32%" class="thinborder"><div align="center"><strong><font size="1">TITLE</font></strong></div></td>
      <td width="13%" class="thinborder"><div align="center"><strong><font size="1">PLACE OF PUBLICATION</font></strong></div></td>
      <td width="20%" class="thinborder"><div align="center"><strong><font size="1">PUBLISHER</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">COPYRIGHT DATE</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">COLLECTION LOCATION</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">BOOK LOCATION</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">BARCODE</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">SUBJECT</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">CIRC TYPE</font></strong></div></td>
    </tr>
...
%>
    <tr> 
      <td height="25" class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%><%=WI.getStrValue((String)vRetResult.remove(0),"::","","")%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
		<%
		vRetResult.remove(0);//accession no
		strBookLocation = (String)vRetResult.remove(0);
		strBarcode      = (String)vRetResult.remove(0);
		strCollLocation = (String)vRetResult.remove(0);
		strSubject      = (String)vRetResult.remove(0);
		%>
      <td class="thinborder">&nbsp;<%=WI.getStrValue(strCollLocation)%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue(strBookLocation)%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue(strBarcode)%></td>
      <td class="thinborder">&nbsp;<%=WI.getStrValue(strSubject)%></td>
      <%
		vRetResult.remove(0);
		vRetResult.remove(0);
		%>

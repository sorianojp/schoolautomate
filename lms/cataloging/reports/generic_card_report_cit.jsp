...
function searchRange(){
	...
	else if(document.form_.sel_all.checked)
		searchConCSV = "";
...
// if this page is calling print page, i have to forward page to print page.
	if(WI.fillTextValue("print_pg").equals("1")) {
		...
		if(strReportType.equals("1")){//biblographic report.%>
			<jsp:forward page="./bibiography_print.jsp" />
	<%		return;
	 ...
	 <tr> 
      ...
      <td height="28" colspan="2">
	   <select name="report_location">
		...
		<option value="0" selected>Elementary</option>
		<%}else{%>
...
<!--<img src="../../images/search.gif" border="0" id="im" onMouseOver="high(this);" onMouseOut="low(this);">-->		</a></td>
	...
	<tr> 
      <td height="28">&nbsp;</td>
      <td height="28">Location Symbol</td>
      <td height="28" colspan="2">
	  <select name="location_symbol">
		<%=dbOP.loadCombo("BOOK_LOC_INDEX","LOCATION"," from LMS_BOOK_LOC order by  BOOK_LOC_INDEX asc",WI.fillTextValue("location_symbol"), false)%> 
	  </select>
	  </td>
    </tr>
...
if(strTemp.equals("CALL_NUMBER"))
	...
	strErrMsg = "";
%>	  
	<input type="radio" name="sort_by" value="CALL_NUMBER"<%=strErrMsg%>>Call Number &nbsp;&nbsp;
<%if(strTemp.length() == 0 || strTemp.equals("copyright"))
	strErrMsg = " checked";
else 
	strErrMsg = "";
%>  
	  	<input type="radio" name="sort_by" value="copyright"<%=strErrMsg%>>Copyright</td>
		
    </tr>
	
	<tr> 
      <td height="20" colspan="2" align="right"><input type="button" name="cmdCreate" value="CREATE REPORT" onClick="PageAction('1','')" /> </td>	  
    <tr> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
	<td width="60%" height="35" valign="bottom"><div align="left">Name</div></td>
	<td width="10%" height="35" valign="bottom"><div align="left">Size</div></td>
	<td width="10%" height="35" valign="bottom"><div align="left">Type</div></td>
	<td width="10%" height="35" valign="bottom"><div align="left">Date Modified</div></td>
	<td width="10%" height="35" valign="bottom"><div align="left">...</div></td>
	</tr>

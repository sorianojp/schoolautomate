...
//authenticate this user.
	...
	Vector vBookStatus= null;
	
	if(WI.fillTextValue("view_report").equals("1")){
		vRetResult = CR.genCollectionStatus(dbOP, request);
		if(vRetResult == null) 
			strErrMsg = CR.getErrMsg();
		else	
			vBookStatus  = (Vector)vRetResult.remove(0);
	}
	
String strReportName = "Report Type : ";
if(WI.fillTextValue("report_type").length() == 0) {
	strReportName += " As of today.";
}
...
%>
<form action="./collection_status.jsp" method="post" name="form_">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" id="myADTable1">
    <tr bgcolor="#A8A8D5">
      <td height="25" colspan="3"><div align="center"><font color="#FFFFFF" ><strong>:::: 
        CATALOGING : REPORT PER BOOK COLLECTOIN STATUS ::::</strong></font></div></td>
    </tr>
    <tr valign="top">
      <td height="42" colspan="3"><a href="main_page.jsp" target="_self"><img src="../../images/go_back.gif" border="0" ></a> &nbsp;&nbsp; <font size="3" color="#FF0000"><%=WI.getStrValue(strErrMsg)%></font></td>
    </tr>
    <tr>
      <td height="25">&nbsp;</td>
      <td>Collection Status </td>
      <td><select name="book_status" style="font-family:Verdana, Arial, Helvetica, sans-serif;font-size: 14;">
        <option value="">------ ALL Status ------</option>
		<%=dbOP.loadCombo("BS_REF_INDEX","STATUS"," from LMS_BOOK_STAT_REF WHERE BS_REF_INDEX > 2 order by BS_REF_INDEX asc",
	  WI.fillTextValue("book_status"), false)%>
      </select></td>
    </tr>
    <tr>
      <td width="6%" height="25">&nbsp;</td>
      <td width="19%">Freq. of Report</td>
...
if(strTemp.equals("0"))
	...
	strErrMsg = "";
%>
          <option value="0"<%=strErrMsg%>>Daily or Weekly</option>
<%
if(strTemp.equals("1"))
	strErrMsg = " selected";
else	
...
%>
    ...
    <%if(strTemp.equals("0")) {//Daily or weekly. report%>
    <tr>
      <td height="25">&nbsp;</td>
      <td>&nbsp;</td>
      <td><%
...
%>
    ...
    <%}else if(strTemp.equals("2")){//yearly or year range...%>
    <tr>
      <td height="25">&nbsp;</td>
      <td>&nbsp;</td>
      <td>From
...
this.ShowProcessing();
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="myADTable2">
    ...
    <tr> 
	  ...
	  <strong><em>:::: CATALOGING : REPORTS - PER BOOK COLLECTOIN STATUS ::::</em></strong><br>
...
float fTotal = 0f;
for(int i = 0; i < vBookStatus.size(); i +=3 ){
strMatTypeIndex = (String)vBookStatus.elementAt(i);%>  
  ...
  %>
    <tr>
        ...
        <td height="18" colspan="5" align="right" bgcolor="#CCCCCC" class="thinborder"><strong>TOTAL</strong></td>
        <td height="18" colspan="2" align="right" bgcolor="#CCCCCC" class="thinborderBOTTOM"><%=CommonUtil.formatFloat(fTotal,true)%></td>
		</tr>
<%fTotal = 0f;}%>
    <tr> 
      <td height="25" colspan="7" bgcolor="#DDDDEE" class="thinborder"><font color="#FF0000"><strong>
	  Total Count : <%=CommonUtil.formatFloat((String)vBookStatus.elementAt(i + 2),false)%>
	  &nbsp;&nbsp;COLLECTION STATUS : <%=(String)vBookStatus.elementAt(i + 1)%> </strong></font></td>
    </tr>
    <tr> 
      <td width="8%" height="25" class="thinborder"><div align="center"><strong><font size="1">CALL NO.</font></strong></div></td>
      <td width="15%" class="thinborder"><div align="center"><strong><font size="1">AUTHOR</font></strong></div></td>
      <td class="thinborder"><div align="center"><strong><font size="1">TITLE</font></strong></div></td>
      <td width="13%" class="thinborder"><div align="center"><strong><font size="1">PLACE OF PUBLICATION</font></strong></div></td>
      <td width="15%" class="thinborder"><div align="center"><strong><font size="1">PUBLISHER</font></strong></div></td>
      <td width="9%" class="thinborder"><div align="center"><strong><font size="1">COPYRIGHT DATE</font></strong></div></td>
	  <%if(bolIsVMA){%>
	  <td class="thinborder" width="8%"><div align="center"><strong><font size="1">PRICE</font></strong></div></td>
	  <%}%>
    </tr>
    ...
    <tr> 
      ...
      <td class="thinborder">&nbsp;<%=WI.getStrValue((String)vRetResult.remove(0))%></td>
	   ...
	   strTemp = (String)vRetResult.remove(0);
	   	fTotal += Float.parseFloat(ConversionTable.replaceString(strTemp,",",""));
	   }catch(Exception e){}
	   %>
...
<%}//for(int i = 0; i < vBookStatus.size(); i += )
}%>

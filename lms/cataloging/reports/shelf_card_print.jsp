...
vANum = (Vector)vRetResult.elementAt(i + 20);
%>
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
...
<%if(strSchCode.startsWith("UI")){%>
	  ...
	  <%=WI.getStrValue((String)vRetResult.elementAt(i + 22))%>
<%}else{%>
	  <%//=WI.getStrValue((String)vRetResult.elementAt(i),"","<br>","")%>
	  <%=WI.getStrValue((String)vRetResult.elementAt(i + 1),"","<br>","")%>
...
<%}%>	 
      ...
      <td width="85%" valign="top"><%=WI.getStrValue((String)vRetResult.elementAt(i + 5),"",".&nbsp;","")%><br>

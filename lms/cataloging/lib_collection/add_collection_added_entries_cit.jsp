...
function viewList(table,indexname,colname,labelname,tablelist, 
									...
									strFormField){	
	var loadPg = "../../../ADMIN_STAFF/HR/hr_updatelist.jsp?tablename="+table+"&indexname="+indexname+"&colname="+colname+"&label="+escape(labelname)+
...
<body bgcolor="#F2DFD2">
<form action="./add_collection_added_entries_cit.jsp?ACCESSION_NO=<%=WI.fillTextValue("ACCESSION_NO")%>" method="post" name="form_">
...
<%=dbOP.loadCombo("AUTHOR_RELATOR_INDEX","RELATOR"," from LMS_LC_BI_AE_RELATOR order by  RELATOR asc",strTemp, false)%> </select>
		<a href='javascript:viewList("LMS_LC_BI_AE_RELATOR","AUTHOR_RELATOR_INDEX","RELATOR","RELATOR","LMS_LC_BI_AE","author_relator_index",
		" and is_valid = 1","","relator");'><img src="../../images/update_rec.gif" border="0"></a> 
...
<input type="hidden" name="ACCESSION_NO" value="<%=strAccessionNo%>" >

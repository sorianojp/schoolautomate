...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"LIB_Cataloging-LIBRARY COLLECTION","add_collection_other_entries.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
int iAccessLevel = comUtil.isUserAuthorizedForURL(dbOP,(String)request.getSession(false).getAttribute("userId"),
														...
														"add_collection_other_entries.jsp");
...
<body bgcolor="#F2DFD2">
<form action="./add_collection_other_entries.jsp" method="post" name="form_">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr bgcolor="#A8A8D5"> 
      <td height="25" colspan="8" bgcolor="#A8A8D5"><div align="center"><font color="#FFFFFF" ><strong>:::: 
          CATALOGING - LIBRARY COLLECTION - ADD TITLE - OTHER ENTRIES PAGE ::::</strong></font></div></td>
    </tr>
  </table>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="29">&nbsp;</td>
      <td height="29"><font size="3" color="#FF0000"><strong><%=WI.getStrValue(strErrMsg,"Message : ","","")%></strong></font></td>
    </tr>
    <tr> 
      <td width="4%" height="29">&nbsp;</td>
      <td width="96%" height="29"><strong>BOOK ACCESSION NUMBER : <%=WI.fillTextValue("ACCESSION_NO")%></strong></td>
    </tr>
  </table>
<%
if(strBookIndex != null){%>
...
<%=dbOP.loadCombo("OE_PROJ_INDEX","PROJ_NAME"," from LMS_LC_OE_PROJ order by PROJ_NAME asc", strTemp, false)%> 
	  ...
	  <img src="../../images/update_rec.gif" border="0"></a><font size="1"> 
        update list of project</font></td>
    </tr>
    <tr> 
      <td height="30">&nbsp;</td>
...
<%=dbOP.loadCombo("supplier_index","supplier_code + ' ('+supplier_name+')'",
	" from LMS_ACQ_SUPPLIER WHERE is_active = 1 order by supplier_code asc", strTemp, false)%> 
      </select> &nbsp;<a href='javascript:updateSupplier();'><img src="../../images/update_rec.gif" border="0"></a></td>
    </tr>
    <tr> 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      ...
      <td width="80%" valign="bottom"><font size="1">
        ...
        Click to edit event 
        <%}%>
        <a href="./add_collection_other_entries.jsp?ACCESSION_NO=

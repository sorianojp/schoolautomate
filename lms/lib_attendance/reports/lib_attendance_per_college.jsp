...
iLimit = iStart + 5;
	...
	//for(int i = iStart; i < iLimit; i++){
		strSQLQuery = "select college.c_index,college.c_code from college "+
							...
							" where stud_curriculum_hist.sy_from >= "+iStart+" "+
							" group by college.c_index,c_code "+
							" order by c_code"; 
	
						rs = dbOP.executeQuery(strSQLQuery);
				
						while(rs.next()) {							
							vRetResult.addElement(rs.getString(1)); // [0] c_index
							vRetResult.addElement(rs.getString(2)); // [1] c_code	
							//Year 1
							...
							//second sem							
							vRetResult.addElement(null);// [5] semester		   		  6		
							vRetResult.addElement("0"); // [6] student population.	  7
							
							//summer							
							vRetResult.addElement(null);// [7] semester			  10			
							vRetResult.addElement("0"); // [8] student population.   11
							
							
							//Year 2
							vRetResult.addElement(null);// [9] school year 		  14  
							//first sem							
							vRetResult.addElement(null);// [10] semester				  15			
							vRetResult.addElement("0"); // [11] student population.    16
							
							//second sem							
							vRetResult.addElement(null);// [12] semester				  19			
							vRetResult.addElement("0"); // [13] student population.    20
											
							//summer							
							vRetResult.addElement(null);// [14] semester			  23	
							vRetResult.addElement("0"); // [15] student population.   24
							
							
							//Year 3
							vRetResult.addElement(null);// [16] school year 			  27
							//first sem							
							vRetResult.addElement(null);// [17] semester				  28	
							vRetResult.addElement("0"); // [18] student population.    29
							
							//second sem							
							vRetResult.addElement(null);// [19] semester				  32	
							vRetResult.addElement("0"); // [20] student population.    33
											
							//summer							
							vRetResult.addElement(null);// [21] semester			  36		
							vRetResult.addElement("0"); // [22] student population.   37
							
							
							//Year 4
							vRetResult.addElement(null);// [23] school year 			  40
							//first sem							
							vRetResult.addElement(null);// [24] semester				  41	
							vRetResult.addElement("0"); // [25] student population.    42
							
							//second sem							
							vRetResult.addElement(null);// [26] semester				  45
							vRetResult.addElement("0"); // [27] student population.    46
									
							//summer							
							vRetResult.addElement(null);// [28] semester			  49	
							vRetResult.addElement("0"); // [29] student population.   50
							
							
							//Year 5
							vRetResult.addElement(null);// [30] school year			  53
							//first sem							
							vRetResult.addElement(null);// [31] semester				  54
							vRetResult.addElement("0"); // [32] student population.    55
							
							//second sem							
							vRetResult.addElement(null);// [33] semester			      58		
							vRetResult.addElement("0"); // [34] student population.    59
									
							//summer							
							vRetResult.addElement(null);// [35] semester			  62	
							vRetResult.addElement("0"); // [36] student population.   63
...
%>
<form action="lib_attendance_per_college.jsp" method="post" name="form_">
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr><td align="center" height="20">&nbsp;</td></tr>
 	...
 	<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" class="thinborder">
		...
		<tr>
			<td class="thinborder" width="10%" rowspan="3">College</td>
			<!----mag loop dinhe ang department--->
			<%for(int i=0;i<5;i++){%>
			<td class="thinborder" align="center" width="10%" colspan="3"><%=vRetResult.elementAt(i)%></td>
			<%}%>
		</tr>
		<tr>
			<%for(int i=0;i<5;i++){%>
			<td align="center" class="thinborder">1st Sem.</td>
			<td align="center" class="thinborder">2nd Sem.</td>
			<td align="center" class="thinborder">Summer</td>
			<%}%>
		</tr>
		<tr>
			<%for(int i=0;i<5;i++){%>
			<td align="center" class="thinborder">no. of days</td>
			<td align="center" class="thinborder">no. of days</td>
			<td align="center" class="thinborder">no. of days</td>
			<%}%>
		</tr>

...
if(WI.fillTextValue("finalize").length() > 0){
  if(!salary.FinalizeSalary(dbOP,request,strSalIndex)){
		strErrMsg = "Error";
  }	
  ...
  if(vSalIndex != null && vSalIndex.size() > 0){
    for(i = 1;i < vSalIndex.size(); i++){	
      if(!salary.FinalizeSalary(dbOP,request,(String)vSalIndex.elementAt(i), strSalIndex)){
	    strErrMsg = "Error";
	  }	
	}
...
<%if(strSchCode.startsWith("VMUF") || strSchCode.startsWith("CLDH")){%>
  ...
  <%if(strSchCode.startsWith("CGH")){%>
   <table width="50%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr > 
      <td height="54" align="center" class="thinborderNONE"> <strong><%=SchoolInformation.getSchoolName(dbOP,true,false)%></strong><br>
  ...
  <table width="50%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" >
    <tr> 
      <td height="20" align="center" class="thinborderNONE">PAY PERIOD <u><strong><%=WI.getStrValue(strCutOff,"&nbsp;")%></strong></u></td>
    </tr>
  </table>
  <table width="50%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
    <tr> 
      <td width="40%" class="thinborderNONE">Employee Name:</td>
      <td width="60%" class="thinborderNONE">&nbsp;<%=WI.formatName((String)vPersonalDetails.elementAt(1), (String)vPersonalDetails.elementAt(2),
    ...
    <%if(vPersonalDetails.elementAt(13) != null && vPersonalDetails.elementAt(14) != null){
		...
		%>
      <td height="20" class="thinborderNONE">College/ Department</td>
      <td height="20" class="thinborderNONE">&nbsp;<%=WI.getStrValue((String)vPersonalDetails.elementAt(13),"")%><%=strTemp%> 
        <%=WI.getStrValue((String)vPersonalDetails.elementAt(14),"")%></td>
    </tr>
    <tr> 
      <td height="18" colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          <tr> 
            <td height="10">&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
          <%if(strPtFt.equals("0")){%>
          <tr> 
            <td height="10" class="thinborderNONE">&nbsp;&nbsp;RATE PER HOUR</td>
            <td class="thinborderNONE"><div align="right"><%=strHourlyRate%>&nbsp;</div></td>
          </tr>
          <tr> 
            <td height="10" class="thinborderNONE">&nbsp;&nbsp;NO. OF HOURS</td>
            <%
          ...
          <tr> 
            <td height="10" class="thinborderNONE">&nbsp;&nbsp;BASIC PAY</td>
		...
		%>
          ...
          <%if(!strPtFt.equals("0")){%>
          <tr> 
            <td width="68%" height="10" class="thinborderNONE">&nbsp;&nbsp;BASIC</td>
          ...
          <tr> 
            <td height="10" class="thinborderNONE">&nbsp;&nbsp;OVERLOAD</td>
          ...
          <tr> 
		   ...
		   %>
            <%=WI.getStrValue(strTemp,"")%>&nbsp;&nbsp;</td>
					...
					<!--
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;ECOLA-DISTORTION</td>
            <td align="right" class="thinborderNONE"> 
              <% 
							//dTemp = 0d;							
						//if (vDTRManual != null && vDTRManual.size() > 0){ 
          ...
          <tr>
            ...
            <td align="right" class="thinborderNONE"><%=strTemp%>&nbsp;&nbsp;</td>
					...
					<%if(!strPtFt.equals("0")){%>
          <tr valign="bottom"> 
            <td height="24" class="thinborderNONE">&nbsp;&nbsp;LESS :</td>
            <td align="right">&nbsp;
              &nbsp;
              <div align="right"></div></td>
          </tr>
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;&nbsp;ABSENCES/TARDINESS</td>
            <td align="right" class="thinborderBOTTOM">&nbsp; 
              <% dAbsenceAmt = 0d;			
			if (vDTRManual != null && vDTRManual.size() > 0){ 
			// leave without pay			
          ...
          <tr valign="bottom"> 
            <td height="24" class="thinborderNONE">&nbsp;&nbsp;TOTAL GROSS PAY</td>
            <td align="right" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.formatFloat(dGrossSalary,true),"0")%>&nbsp;&nbsp;</td>
          </tr>
          <%}//if(!strPtFt.equals("0"))%>
          <tr> 
          ...
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;DEDUCTIONS :</td>
            <td>&nbsp;</td>
          </tr>
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;WITHHOLDING TAX</td>
            <td align="right" class="thinborderNONE"> 
              <% 
			if (vDTRManual != null && vDTRManual.size() > 0){ 				
          ...
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;HDMF</td>
            <td align="right" class="thinborderNONE"> 
              <% 
						if (vDTRManual != null && vDTRManual.size() > 0){ 
          ...
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;MEDICARE</td>
            <td align="right" class="thinborderNONE"> 
              <% 
		if (vDTRManual != null && vDTRManual.size() > 0){ 
	   ...
	   %>
            <%=WI.getStrValue(strTemp,"")%>&nbsp;&nbsp;</td></tr>
					...
					if(vDeductions != null && vDeductions.size() > 1){
						...
						%>
          <tr> 
            <td class="thinborderNONE">&nbsp;&nbsp;<%=WI.getStrValue(strTemp,"")%></td>
            <td align="right" class="thinborderNONE">
              <% 
							strTemp = CommonUtil.formatFloat(dTemp,true);
							dTotalDeduction += dTemp; 
          ...
          <tr valign="bottom"> 
            <td height="24" class="thinborderNONE">&nbsp;&nbsp;TOTAL DEDUCTIONS</td>
            <td align="right" class="thinborderBOTTOM"><%=WI.getStrValue(CommonUtil.formatFloat(dTotalDeduction,true),"0")%>&nbsp;</td>
          </tr>
          <tr valign="bottom"> 
            <td height="24" class="thinborderNONE">&nbsp;&nbsp;NET PAY</td>
            <%
				dNetSalary += dGrossSalary - dTotalDeduction;
			%>
            <td align="right" class="thinborderBOTTOM"><u><font size="2"><strong><%=WI.getStrValue(CommonUtil.formatFloat(dNetSalary,true),"0")%>&nbsp;</strong></font></u></td>
          </tr>
          <tr> 
            <td>&nbsp;</td>
            <td>&nbsp;</td>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">		
		<tr>
		  <td height="17" colspan="3" class="thinborderNONEcl"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		...
		<tr> 
			<td width="47%" height="18" valign="top">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          <tr>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
          ...
          <tr>
            <td><font size="1"><!--Overload--></font></td>
					<% dTemp = 0d;
						if (vDTRManual != null && vDTRManual.size() > 0){ 
						// faculty pay
						strTemp = (String) vDTRManual.elementAt(44);
          ...
          <tr>
            ...
            <td align="right"> <%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
					...
					<tr>
					  <td><font size="1"><!--Honorarium--></font></td>
					<% dTemp = 0d;
						if (vDTRManual != null && vDTRManual.size() > 0){ 
							// Honorarium
					...
					<tr>
						<td width="51%"><!--<font size="1">Other Allowances </font>--></td>
						<% dOtherEarning = 0d;
							if(vEarnings != null && vEarnings.size() > 1)
							...
							dGrossSalary += dOtherEarning;
						%>							
						<td width="49%" align="right"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
					</tr>
          <tr>
            <td><!--<font size="1">Adjustments</font>--></td>				
 				    <% dTemp = 0d;
					if (vDTRManual != null && vDTRManual.size() > 0){ 
						strTemp =(String) vDTRManual.elementAt(20);
						dTemp = Double.parseDouble(ConversionTable.replaceString(WI.getStrValue(strTemp,"0"),",",""));
            ...
            <td align="right"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
				   ...
				   %>	
					<tr>
					  <td class="thinborderNONE"><!--Less : Absences --></td>
					  <td align="right"><%=WI.getStrValue(strTemp,"(",")","")%>&nbsp;</td>
					  </tr>
 					<tr>
					  <td class="thinborderNONE"><!--Gross Pay--></td>
			...
			<td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <%
 				if(vDeductions != null && vDeductions.size() > 1){
					dOtherDeduction = 0d;
					for(i = 1; i < vDeductions.size(); i += 2) {
        ...
        <tr>
          <td valign="bottom"><!--<font size="1">&nbsp;&nbsp;OTHER/Misc.</font>--></td>
          <% 
					if (vDTRManual != null && vDTRManual.size() > 0){ 	
        ...
        <tr>
          <td width="51%"><!--Total Ded.--></td>
          <td width="49%" align="right">&nbsp;<%=WI.getStrValue(CommonUtil.formatFloat(dTotalDeduction,true),"0")%>&nbsp;</td>
        </tr>
        <tr>
          <td><!--NET PAY --></td>
					<%
						dNetSalary += dGrossSalary - dTotalDeduction;
					%>					
          <td align="right"><u><strong>**<%=WI.getStrValue(CommonUtil.formatFloat(dNetSalary,true),"0")%>&nbsp;</strong></u></td>
        </tr>
      </table></td>
		</tr>
		<tr>
		  <td height="18" colspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        <tr>
		...
		<%
			...
			dTotalDeduction	= 0d;	
		%>
    <td width="48%"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
      <tr>
        <td height="17" colspan="3" class="thinborderNONEcl"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
            <tr>
              <td width="43%"><strong><%=WI.getStrValue(strEmpID,"","","")%></strong></td>
      ...
      <tr>
        <td width="47%" height="18" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              <td width="49%"><!--<font size="1">Other Allowances </font>--></td>
              <% dOtherEarning = 0d;
							if(vEarnings != null && vEarnings.size() > 1)
								dOtherEarning = Double.parseDouble((String)vEarnings.elementAt(0));
							...
							dGrossSalary += dOtherEarning;
						%>
              <td width="51%" align="right"><%=WI.getStrValue(strTemp,"")%>&nbsp;</td>
            </tr>
            <tr>
              <td><!--<font size="1">Adjustments</font>--></td>
              <% dTemp = 0d;
        ...
        <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
            ...
            <tr>
              ...
              <td width="50%" align="right">&nbsp;<%=WI.getStrValue(CommonUtil.formatFloat(dTotalDeduction,true),"0")%>&nbsp;</td>
            </tr>
            <tr>
              <td><!--NET PAY --></td>
              <%
   ...
   <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
     ...
     <tr>
       <td colspan="8"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           <tr>
     ...
     <tr>
       <td colspan="2" valign="top" class="thinborderLEFT"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           <tr>
      ...
      <% 			
       ...
       <td colspan="2" valign="top" class="thinborderLEFTRIGHT"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           <tr>
...
<%}else if(strSchCode.startsWith("PIT")){%>
   <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
     ...
     <tr>
       <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
           <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
     <tr>
       <td colspan="5" class="thinborderNONE"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
         <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
     ...
     <tr>
       <td colspan="4" class="thinborderBOTTOM"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
         <tr>
     ...
     <tr>
       ...
       <td valign="top" class="thinborderNONE"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
 ...
 <%if(vPersonalDetails.elementAt(13) != null && vPersonalDetails.elementAt(14) != null){
			 ...
			 %>		
      <td height="18" colspan="4"><font size="1">Department/<%if(bolIsSchool){%>College<%}else{%>Division<%}%> :&nbsp;<%=strTemp%></font></td>
      <td height="18" colspan="2">&nbsp;</td>
    </tr>
    <tr> 
      <td height="18" colspan="2" valign="top" class="thinborderBOTTOMLEFT"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          <tr> 
      ...
      <td colspan="2" valign="top" class="thinborderBOTTOMLEFT"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
          <tr> 
	...
	<%}%>		
	 ...
	 <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
          ...
          <% dTemp = 0d;
			...
			<tr>
			  <td height="18" colspan="3" valign="top" class="thinborderBOTTOM"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
        ...
        <% 
          ...
          <tr>
            ...
            <td align="right" valign="bottom"><font size="1"><%=WI.getStrValue(strTemp,"")%></font></td>
			  ...
			  <td valign="top" class="thinborderBOTTOM"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#E8E8E8">
		...
		<tr> 
			<td height="18" colspan="2" valign="top" class="thinborderTOP"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr valign="bottom"> 
	   ...
	   //} // end if vVarAllowances != null %>
			...
			<td colspan="2" valign="top" class="thinborderTOPLEFT"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr valign="bottom"> 
		...
		<tr>
			<td height="19" colspan="2" valign="top" class="thinborderBOTTOM"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
				<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
			...
			<tr>
				<td colspan="2" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF">
					<tr>

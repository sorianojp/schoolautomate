...
// if this page is calling print page, i have to forward page to print page.
	...
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Students Affairs-SEARCH-Students","srch_stud_temp_basic.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
...
%>
<form action="./srch_stud_temp_basic.jsp" method="post" name="search_util">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="4" bgcolor="#697A8F"><div align="center"><font color="#FFFFFF"><strong>:::: 
...
%>
	  ...
	  onKeyUp='DisplaySYTo("search_util","sy_from","sy_to")' value="<%=strTemp%>" size="4" maxlength="4">
        to 
<% 
...
if(strTemp.compareTo("1") == 0){%> <input type="checkbox" name="is_enrolled" value="1" checked> 
        <%}else{%> <input type="checkbox" name="is_enrolled" value="1"> 
        <%}%>
        Show Enrolled Student 
        <%
strTemp = WI.fillTextValue("is_advised");
if(strTemp.compareTo("1") == 0){%> <input type="checkbox" name="is_advised" value="1" checked> 
        <%}else{%> <input type="checkbox" name="is_advised" value="1"> 
        <%}%>
        Show Advised Student 
        <%
strTemp = WI.fillTextValue("is_downpmt_paid");
if(strTemp.compareTo("1") == 0){%> <input type="checkbox" name="is_downpmt_paid" value="1" checked> 
        <%}else{%> <input type="checkbox" name="is_downpmt_paid" value="1"> 
        <%}%>
        Show Student with Downpayment</td>
    </tr>
    <tr> 
...
<!--    <tr>
  ...
  <table  bgcolor="#FFFFFF" width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr> 
      <td  width="16%" height="25" ><div align="center"><strong><font size="1">STUDENT 
          ID</font></strong></div></td>
      <td width="11%"><div align="center"><strong><font size="1">START DATE OF 
          ENROLLMENT </font></strong></div></td>
      <td width="22%"><div align="center"><strong><font size="1">LNAME, FNAME, 
          MI </font></strong></div></td>
      <td width="5%"><div align="center"><strong><font size="1">GEN</font></strong></div></td>
      <td width="6%"><div align="center"><font size="1"><strong>APPL CATG</strong></font></div></td>
      <td width="9%"><div align="center"><strong><font size="1"> ENROLLED</font></strong></div></td>
      <td width="8%"><div align="center"><strong><font size="1"> ADVISED</font></strong></div></td>
      <td width="6%"><div align="center"><strong><font size="1">NO. OF PMT</font></strong></div></td>
      <td width="8%"><div align="center"><strong><font size="1">VIEW ADVISED SUBJ</font></strong></div></td>
      <td width="9%"><font size="1"><strong>REMOVE ADVISING</strong></font></td>
    </tr>
    <%
for(int i=0; i<vRetResult.size(); i+=14){%>
    <tr> 
      ...
      <td> <%if(WI.fillTextValue("is_enrolled").compareTo("1") != 0 && 
			Integer.parseInt(WI.getStrValue(vRetResult.elementAt(i+11),"0")) > 0){%> <a href='javascript:InvalidateAdvising("<%=(String)vRetResult.elementAt(i+1)%>");'> 
...
<input name="is_basic" type="hidden" value="1">
<input name="course_index" type="hidden" value="0">
</form>
</body>
</html>
<%

...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(function() {
				...
				$('#container-1').disableTab(3); // disables third tab
            });
        </script>
    ...
    <body>
        ...
        <div id="container-1">
            <ul>
                <li><a href="file1.jsp"><span>One</span></a></li>
                <li><a href="file2.jsp"><span>Two</span></a></li>
                <li><a href="file3.jsp"><span>Three</span></a></li>

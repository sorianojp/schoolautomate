...
function ReloadPage()
{
	document.advising.action="./advising_cross_enrollee.jsp";
	document.advising.submit();
}
...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Enrollment-Cross Enrollee","advising_cross_enrollee.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="8" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
          CROSS-ENROLEE STUDENT ADVISING PAGE ::::</strong></font></div></td>
    </tr>
    <tr>
...
if(bolShowAdviseList && vAdviseList != null && vAdviseList.size() > 0){%>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr bgcolor="#B9B292">
      <td height="25" colspan="4"><div align="center">LIST OF SUBJECTS
          THE STUDENT MAY TAKE</div></td>
    </tr>
    <tr>
      <td width="2%"  height="25">&nbsp;</td>
      <td>Max units the student can take : <strong><%=strMaxAllowedLoad%></strong></td>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="6%" align="center"><font size="1"><strong><font size="1">SELECT
        </font></strong></font></td>
...
%>
	  ...
	  onFocus="style.backgroundColor='#D3EBFF'; javascript:SaveInputUnit(<%=j%>);" onBlur="style.backgroundColor='white'"
...
<input type="hidden" name="stud_type" value="Cross Enrollee">

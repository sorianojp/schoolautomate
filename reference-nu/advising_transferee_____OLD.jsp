...
//add security here.
	try
	{
		dbOP = new DBOperation((String)request.getSession(false).getAttribute("userId"),
								"Admin/staff-Enrollment-advising-transferee","advising_transferee.jsp");
	}
	catch(Exception exp)
	{
		exp.printStackTrace();
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr bgcolor="#A49A6A">
      <td height="25" colspan="8" bgcolor="#A49A6A"><div align="center"><font color="#FFFFFF"><strong>::::
          TRANSFEREE STUDENT ADVISING PAGE ::::</strong></font></div></td>
    </tr>
    <tr>
...
if(bolShowAdviseList && vAdviseList != null && vAdviseList.size() > 0){%>
  ...
  <table width="100%" border="1" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    <tr>
      ...
      <td width="8%" align="center"><strong><font size="1">SELECT ALL</font></strong>
...
strStudID = WI.fillTextValue("nstp_val");%>
        <select name="nstp_val<%=j%>" style="font-weight:bold;">
          <option value="CWTS">CWTS</option>
          <%
if(strStudID.compareTo("LTS") ==0){%>
          <option value="LTS" selected>LTS</option>
          <%}else{%>
          <option value="LTS">LTS</option>
          <%}if(strStudID.compareTo("ROTC") ==0){%>
...
<input type="hidden" name="stud_type" value="Transferee">

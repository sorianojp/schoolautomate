...
%>
<form name="stud_ledg" action="../../ADMIN_STAFF/fee_assess_pay/student_ledger/student_ledger_viewall.jsp" method="post">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" id="myADTable">
	...
	<input name="stud_id" type="hidden" size="16" value="<%=WI.fillTextValue("stud_id")%>">
<% if(vBasicInfo != null && vBasicInfo.size() > 0 
		&& vCurHistInfo != null && vCurHistInfo.size() > 0){%>
...
if(strErrMsg != null){%>
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td align="center">&nbsp;
		...
		if(bolShowUpdate && (dNewBalance - dPrevBalance) !=0f && strLedgHistIndex != null ){%>

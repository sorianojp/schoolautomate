...
<body>
<%@ page language="java" import="utility.*,java.util.Vector, java.util.Date,enrollment.NAApplicationForm" %>
<%
...
if(bolLoggedIn)
{
	...
	Vector[] vEditInfo = napplForm.viewTempStudInfo(dbOP, strTempID);
	...
	{
		if( ((String)vEditInfo[0].elementAt(4)).compareTo("0") ==0)//semester.
			strSem = "Summer";
		else
...
if(!bolLoggedIn)
{%>  <tr>
    <td><font size="3"><strong>Please Login to view your GSPIS form.</strong></font></td>
  </tr>
 <%return;}
 if(strErrMsg != null)
{%>  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="15" colspan="3"><strong>TEMP. STUDENT ID # : </strong><%=strTempID%>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3"><strong>COURSE/YEAR : </strong><%=(String)vEditInfo[0].elementAt(5)%>
      / <%=(String)vEditInfo[0].elementAt(3)%> Year</td>
  </tr>
  <tr>
    <td height="15" colspan="3"><strong>CURRICULUM YEAR : </strong><%=(String)vEditInfo[0].elementAt(0)%>
      - <%=(String)vEditInfo[0].elementAt(1)%></td>
  </tr>
  <tr>
    <td height="5" colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td height="20" colspan="3"><strong>I A - PERSONAL DATA</strong></td>
  </tr>
  <tr>
    <td width="26%" height="15">Last Name :<strong><%=(String)vEditInfo[0].elementAt(9)%></strong>
    </td>
    <td width="27%">First Name :<strong><%=(String)vEditInfo[0].elementAt(7)%>
      </strong></td>
    <td width="47%">Middle Name: <strong><%=WI.getStrValue(vEditInfo[0].elementAt(8))%>
      </strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15">Gender :
      <%if( ((String)vEditInfo[0].elementAt(11)).compareTo("M") == 0){%>
      <strong>Male</strong>
      <%}else{%>
  ...
  <tr>
    <td height="15">Age : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(21))%></strong>
      yrs. old &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <%
//show only if the gender is female
if( ((String)vEditInfo[0].elementAt(11)).compareTo("M") != 0){%>
  <tr>
    <td height="15" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      Maiden's Name : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(17))%></strong></td>
  </tr>
  <%}else{%>
  <tr>
    <td height="15" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name
      of Spouse &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(18))%></strong></td>
  </tr>
  <%}%>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3">House No./Street/Barangay : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(25))%></strong>
      City/Municipality : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(26))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Province/State : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(27))%></strong>
      Country : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(28))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Zipcode : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(29))%>
      </strong>Telephone Nos.: <strong><%=WI.getStrValue(vEditInfo[0].elementAt(30))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td height="15" colspan="3">Contact Person/Guardian Name : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(31))%></strong>
      Relation : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(32))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Apartment Name/House No./Street/Barangay : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(33))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">City/Municipality :<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(34))%></strong>
      Province/State :<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(35))%></strong>
      Country :<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(36))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Zipcode : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(37))%></strong>
      Telephone Nos.:<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(38))%></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3"><font color="#0000FF"><u>Emergency Contact Data:</u>
      (if not same as above)</font></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Contact Person Name <strong>: <%=WI.getStrValue(vEditInfo[0].elementAt(40))%></strong>
      Relation :<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(41))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Apartment Name/House No./Street/Barangay <strong><%=WI.getStrValue(vEditInfo[0].elementAt(42))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">City/Municipality :<strong> <%=WI.getStrValue(vEditInfo[0].elementAt(43))%></strong><strong>emergency</strong>
      Province/State :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(44))%></strong>
      Country <strong>: <%=WI.getStrValue(vEditInfo[0].elementAt(45))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Zipcode : <strong><%=WI.getStrValue(vEditInfo[0].elementAt(46))%></strong>
      Telephone Nos.:<strong><%=WI.getStrValue(vEditInfo[0].elementAt(47))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td height="15" colspan="3">Height :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(48))%>
      </strong> Weight :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(49))%></strong>
      Built :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(50))%></strong>
      Eyes :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(51))%></strong> Hair
      :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(52))%></strong> Complexion
      :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(53))%></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3">Father&#8217;s Name :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(56))%></strong>
      Occupation :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(57))%></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3">Mother&#8217;s Name :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(62))%></strong>
      Occupation :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(63))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3">Company Name :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(64))%></strong>
      Telephone Nos. :<strong><%=WI.getStrValue(vEditInfo[0].elementAt(65))%></strong></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="15" colspan="3"><font color="#0000FF"><u>Skills :</u></font><strong>
      <%=WI.getStrValue(vEditInfo[0].elementAt(114))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3"><font color="#0000FF"><u>Talents :</u></font><strong>
      <%=WI.getStrValue(vEditInfo[0].elementAt(115))%></strong></td>
  </tr>
  <tr>
    <td height="15" colspan="3"><font color="#0000FF"><u>Sports :</u></font> <strong>
      <%=WI.getStrValue(vEditInfo[0].elementAt(116))%></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td height="15" colspan="3">Write two or three references who can vouch or guarantee for your total behavior.</td>
  </tr>
  <tr>

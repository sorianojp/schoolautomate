...
if(strAuthTypeIndex == null || strAuthTypeIndex.equals("4")){%>
		<p style="font-size:16px; font-weight:bold; color:#FF0000">Page Not available for viewing</p>
<%return;}%>
...
<table width="100%" border="0" bgcolor="#FFFFFF" cellpadding="0" cellspacing="0">
    <tr bgcolor="#47768F">
      <td height="25" align="center" bgcolor="#BECED3"><font color="#FFFFFF"><strong>:: ESTIMATED
        FEE :: </strong></font></td>
    </tr>
</table>
  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<td width="8%" class="thinborder"><div align="center">SELECT</div></td>
      ...
      <td width="28%" class="thinborder"><div align="center">SUBJECT NAME</div></td>

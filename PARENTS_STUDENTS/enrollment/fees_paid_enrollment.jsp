...
//I have to get here the or number.. 
	FAAssessment faAssessment = new FAAssessment();
	String strORNumber = faAssessment.getORToReprintAssessment(dbOP, strStudID, astrSchYrInfo[0], astrSchYrInfo[2]);
	if(strORNumber == null)
		strErrMsg = faAssessment.getErrMsg();

dbOP.cleanUP();
	response.sendRedirect("../../ADMIN_STAFF/fee_assess_pay/payment/enrollment_receipt_print.jsp?view_=1&or_number="+strORNumber);

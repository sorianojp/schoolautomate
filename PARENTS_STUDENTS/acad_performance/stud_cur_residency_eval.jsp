...
if(strSchCode.startsWith("UB")){%>
 <p style="font-size:14px; color:#FF0000;">Page content is empty.</p>
<%return;}
%>
...
<%if(!strSchCode.startsWith("AUF")){%>
    <tr>
      ...
      <td height="25"><% if (!((String)vTemp.elementAt(11)).equals("1") || !((String)vTemp.elementAt(11)).equals("2")){%><strong><%=dGWA%></strong><%}%>&nbsp;</td>
    </tr>
<%}%>
  </table>

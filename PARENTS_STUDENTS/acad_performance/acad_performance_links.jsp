...
{%>
  ...
  <tr>
    ...
    <td colspan="2" class="admissionmainmenu"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif"><a href="./stud_cur_residency_eval.jsp" target="rightFrame">Check List</a></font></strong></td>
  </tr>
  <%}%>
 <!--
  <tr>
    <td height="25"><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif"><a href="../enrollment/schedule.htm" target="rightFrame">Exam
      Results </a></font></strong></td>
  </tr>
 -->
<%//strSchCode = "AUF";
if(strSchCode.startsWith("AUF")){
//I must find if there are any new assignment left out.. 
java.util.Vector vRetResult = null;
ClassMgmt.CMAssignment cma = new ClassMgmt.CMAssignment();
utility.DBOperation dbOP = new utility.DBOperation();
vRetResult = cma.getStudentAssignment(dbOP, request, 4, null, null, true);
int iNewAssign = -1;
if(vRetResult != null && vRetResult.size() > 0) {
	iNewAssign = vRetResult.size() / 13;
}
...
%>
  <tr>
    ...
    <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
      <a href="cm_assignment.jsp" target="rightFrame">Class Assignment <%if(iNewAssign > -1){%> (<%=iNewAssign%> New )<%}%></a></font></strong></td>
  </tr>
<%}%>
  <tr>
    <td height="25"><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif"><a href="class_attendance.jsp" target="rightFrame">Student Class Attendance</a></font></strong></td>
  </tr>
  <tr>
    <td height="25"><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
      <a href="campus_attendance.jsp" target="rightFrame">Campus Attendance</a></font></strong></td>
  </tr>
  <tr>
    <td height="25"><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
      <a href="../../faculty_acad/stud/stud_acad.jsp?is_student=1" target="rightFrame">Awards/Achievements</a></font></strong></td>
  </tr>
  <tr>
    <td><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td height="10" colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
		<a href="./fieldwork_ojt.jsp" target="rightFrame">Field Work Profile/OJT</a></font></strong></td>
  </tr>
<%
if(!strSchCode.startsWith("EAC") || true){%>
  <tr>
    <td><img src="../../images/small_white_box.gif" width="4" height="6">&nbsp;</td>
    <td height="10" colspan="2"><strong><font color="#FFFFFF" size="2" face="Geneva, Arial, Helvetica, sans-serif">
		<a href="./grade_release.jsp" target="rightFrame">Grading Per Exam Period</a></font></strong></td>
  </tr>
<%}%>
</table>
</body>
